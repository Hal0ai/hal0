...
CURATED_MODELS: list[CuratedModel] = [
    ...
    CuratedModel(
        id="qwen3.6-27b",
        display_name="Qwen3.6 27B (MTP ROCmFP4)",
        description="General-purpose chat with built-in MTP and vision support for Strix Halo.",
        family="qwen",
        size_gb=16.9,
        vram_gb_min=22.0,
        license="other",
        ...
        notes="ROCmFP4 build from plunderstruck; needs the bundled chat template + mmproj sidecar.",
    ),
    CuratedModel(
        id="gpt-oss-20b",
    ...
    # ── Custom GGUF chat picks referenced by seed/shared stacks ────────────
    # These ids are referenced by exported stacks but were originally
    # auto-scanned into the registry with EMPTY hf_repo/hf_file. Registering
    # their HF coordinates here makes pull-by-id, scan-backfill, and stack
    # export all resolve (fix/stack-model-pull-coords). The jcbtc builds are
    ...
    CuratedModel(
        ...
        hf_repo="jcbtc/chadrock3.6-27b-pi-agent-rocmfp4-mtp",
    ...
    CuratedModel(
        ...
        display_name="CHADROCK3.6 35B Uncensored (MTP STRIX)",
        description="35B uncensored chat build with MTP, packed for Strix Halo.",
        family="qwen",
        size_gb=19.0,
        vram_gb_min=20.0,
        license="apache-2.0",
        license_url="https://huggingface.co/jcbtc/CHADROCK3.6-35B-UNCENSORED-MTP-STRIX-LEAN",
        hf_repo="jcbtc/CHADROCK3.6-35B-UNCENSORED-MTP-STRIX-LEAN",
        hf_file="CHADROCK3.6-35B-UNCENSORED-MTP-STRIX-LEAN.gguf",
        context_length=65536,
        recommended_slot="chat",
        tags=["chat", "mtp", "rocmfp4"],
        notes="Strix-Halo ROCmFP4/MTP build (35B uncensored STRIX-LEAN).",
        capability="chat",
        backend="llamacpp",
    ),
    CuratedModel(
        id="qwen3-6-35b-a3b-halostrix-dyn-mtp-v7",
        display_name="Qwen3.6 35B-A3B HaloStrix Dyn (MTP v7)",
        description="35B-A3B HaloStrix dynamic-quant chat build with MTP.",
        family="qwen",
        size_gb=22.6,
        vram_gb_min=23.0,
        license="apache-2.0",
        license_url="https://huggingface.co/jcbtc/qwen3.6-35b-a3b-crown-halo-mtp-dynamic",
        hf_repo="jcbtc/qwen3.6-35b-a3b-crown-halo-mtp-dynamic",
        hf_file="Qwen3.6-35B-A3B-HaloStrix-Dyn-MTP-v7.gguf",
        context_length=65536,
        recommended_slot="chat",
        tags=["chat", "mtp", "rocmfp4"],
        notes="Strix-Halo ROCmFP4/MTP build (HaloStrix dynamic v7).",
        capability="chat",
        backend="llamacpp",
    ),
    CuratedModel(
        id="qwopus3-6-27b-v2-mtp-bf16-to-rocmfp4-strix-lean",
        display_name="Qwopus3.6 27B v2 (ROCmFP4 STRIX)",
        description="27B Qwopus v2 chat build with MTP, packed for Strix Halo.",
        family="qwen",
        size_gb=14.8,
        vram_gb_min=15.0,
        license="apache-2.0",
        license_url="https://huggingface.co/jcbtc/qwopus3.6-27b-v2-chadrock-rocmfp4-mtp",
        hf_repo="jcbtc/qwopus3.6-27b-v2-chadrock-rocmfp4-mtp",
        hf_file="Qwopus3.6-27B-v2-MTP-BF16-to-ROCmFP4-STRIX_LEAN.gguf",
        context_length=65536,
        recommended_slot="chat",
        tags=["chat", "mtp", "rocmfp4"],
        notes="Strix-Halo ROCmFP4/MTP build (Qwopus v2 BF16-to-ROCmFP4 STRIX_LEAN).",
        capability="chat",
        backend="llamacpp",
    ),
    CuratedModel(
        id="qwopus3-6-27b-coder-mtp-q6-k",
        display_name="Qwopus3.6 27B Coder (MTP Q6_K)",
        description="27B Qwopus coder GGUF build with MTP.",
        family="qwen",
        size_gb=22.4,
        vram_gb_min=23.0,
        license="apache-2.0",
        license_url="https://huggingface.co/Jackrong/Qwopus3.6-27B-Coder-MTP-GGUF",
        hf_repo="Jackrong/Qwopus3.6-27B-Coder-MTP-GGUF",
        hf_file="Qwopus3.6-27B-Coder-MTP-Q6_K.gguf",
        context_length=65536,
        recommended_slot="chat",
        tags=["chat", "coder", "mtp"],
        notes="GGUF MTP coder build (Q6_K).",
        capability="chat",
        backend="llamacpp",
    ),
    CuratedModel(
        id="qwopus3-5-9b-coder-mtp-q6-k",
        display_name="Qwopus3.5 9B Coder (MTP Q6_K)",
        description="9B Qwopus coder GGUF build with MTP.",
        family="qwen",
        size_gb=7.6,
        vram_gb_min=8.0,
        license="apache-2.0",
        license_url="https://huggingface.co/Jackrong/Qwopus3.5-9B-Coder-MTP-GGUF",
        hf_repo="Jackrong/Qwopus3.5-9B-Coder-MTP-GGUF",
        hf_file="Qwopus3.5-9B-Coder-MTP-Q6_K.gguf",
        context_length=65536,
        recommended_slot="chat",
        tags=["chat", "coder", "mtp"],
        notes="GGUF MTP coder build (Q6_K).",
    ...
    CuratedModel(
        ...
        display_name="Qwopus3.5 4B Coder (MTP Q6_K)",
        description="4B Qwopus coder GGUF build with MTP.",
        family="qwen",
        size_gb=3.6,
        vram_gb_min=4.0,
        license="apache-2.0",
        license_url="https://huggingface.co/Jackrong/Qwopus3.5-4B-Coder-MTP-GGUF",
        hf_repo="Jackrong/Qwopus3.5-4B-Coder-MTP-GGUF",
        hf_file="Qwopus3.5-4B-Coder-MTP-Q6_K.gguf",
        context_length=32768,
        recommended_slot="chat",
        tags=["chat", "coder", "mtp"],
        notes="GGUF MTP coder build (Q6_K).",
    ...
    CuratedModel(
        id="qwen3-5-9b-deepseek-v4-flash-mtp-q6-k",
        display_name="Qwen3.5 9B DeepSeek V4 Flash (MTP Q6_K)",
        description="9B DeepSeek V4 Flash GGUF chat build with MTP.",
        family="qwen",
        size_gb=7.6,
        vram_gb_min=8.0,
        license="apache-2.0",
        license_url="https://huggingface.co/Jackrong/Qwen3.5-9B-DeepSeek-V4-Flash-MTP-GGUF",
        hf_repo="Jackrong/Qwen3.5-9B-DeepSeek-V4-Flash-MTP-GGUF",
        hf_file="Qwen3.5-9B-DeepSeek-V4-Flash-MTP-Q6_K.gguf",
        context_length=65536,
        recommended_slot="chat",
        tags=["chat", "mtp"],
        notes="GGUF MTP build (DeepSeek V4 Flash, Q6_K).",
        capability="chat",
        backend="llamacpp",
    ),
    CuratedModel(
        id="gemma-4-12b-it-ud-q4-k-xl",
        display_name="Gemma 4 12B IT (UD Q4_K_XL)",
        description="Gemma 4 12B instruct GGUF chat build (unsloth dynamic).",
        family="gemma",
        size_gb=7.4,
        vram_gb_min=8.0,
        license="apache-2.0",
        license_url="https://huggingface.co/unsloth/gemma-4-12b-it-GGUF",
        hf_repo="unsloth/gemma-4-12b-it-GGUF",
        hf_file="gemma-4-12b-it-UD-Q4_K_XL.gguf",
        context_length=65536,
        recommended_slot="chat",
        tags=["chat", "mtp"],
        notes="GGUF MTP build (Gemma 4 12B IT, UD Q4_K_XL).",
        capability="chat",
        backend="llamacpp",
    ),
