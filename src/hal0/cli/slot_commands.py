...
def slot_create(
    ...
    # HAL0-SUNSET: v0.10.0 — --backend renamed to --provider in v0.2; use --provider.
...
# HAL0-SUNSET: v0.10.0 — alias for `slot create`; drop the alias.
...
# HAL0-SUNSET: v0.10.0 — alias for `slot delete`; drop the alias.
