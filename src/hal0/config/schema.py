...
#: exists, as a backward-compat shim so every existing
...
#: (re)assigned at the bottom of this module as a backward-compat shim.
...
# backward-compat shim so every existing
