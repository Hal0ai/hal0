...
Write flow lives in hal0.profiles.ProfileCatalog so seed semantics,
resolved flags, runtime-family classification, and in-use scans stay
...
from hal0.profiles import ProfileCatalog, ProfilePatch, ResolvedProfile
...
def _serialize_profile(profile: ResolvedProfile) -> dict[str, Any]:
...
def list_profiles() -> list[dict[str, Any]]:
    ...
    """
    return [_serialize_profile(profile) for profile in catalog.list()]
