# Graph Report - memory-error-branches  (2026-07-30)

## Corpus Check
- 1652 files · ~2,097,454 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29985 nodes · 57009 edges · 1392 communities (1234 shown, 158 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 7030 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1abf2f19`
...
- _shared.py
- test_container_gate.py
- test_chat_normalization.py
- test_brain_resilience.py
- test_admin_route_map_nested.py
- mockFixtures.ts
...
- useLogs.ts
- model-drawer-dirty-baseline-v3.spec.ts
- KeyError
- mcp_mount.py
...
- test_degrade_live.py
- _Client
- test_fail_watcher_warming.py
- test_exposure.py
- test_hindsight_boot_probe.py
- SingleFlightGroup
- run_tool_loop
...
- _client
- BootReport
- put_dashboard_layout
- _probe_power
- test_secrets_protected_keys.py
...
- test_seeds_data.py
- test_memory_delete_auth.py
- test_logs_keepalive.py
- Changelog
- hal0 installer
- `hal0.toml`
...
- Path
- test_bootstrap_cosign_fetch.py
- Path
- _stores
- _seed_id_keyed
- _store
- test_seam_agent_units.py
...
- test_eligibility.py
- test_model_less_capability_slot_is_not_woken
- Security review — v1.0 auth surface (2026-05-21)
- _write_fake_python
- test_seam_verification.py
- _CtxToken
...
- _stub_bin
- FakeSlotManager
- test_hal0_update_wrapper.py
- test_pull_refcount_rows.py
- test_store_concurrency.py
- _write_slot
- test_load_converges_config.py
- test_agents_unit_liveness.py
...
- test_pool_bounds.py
- _by_target
- test_api_restart_on_upgrade.py
...
- test_image_pin.py
- test_flm_store_link.py
- conftest.py
- test_reinstall_into_venv_does_not_pass_no_deps
...
- test_events_fixes.py
- test_harness_matrix.py
- TestSeamWhitelist
...
- test_post_activation_migrations.py
...
- capabilities-and-profiles.mdx
- Admin tools (`/mcp/admin`)
- providers-profiles-devices.mdx
- slot-lifecycle.mdx
...
- _patch_dropin_to_tmp
- _ServerThread
- TestStatusTelemetry
- test_mcp_mount_health.py
- TestClient
- test_startup_persona_seed.py
...
- useToastStore.ts
- slot-drawer-dirty-baseline-v3.spec.ts
- slot-drawer-field-wiring-v3.spec.ts
- apply_capability
...
- _run_script
- test_gp15_no_hermes.py
- conftest.py
- test_browser_server.py
...
- test_slot_rename.py
- test_paths_stub.py
- _reject_privileged_systemctl
- test_voice_roundtrip.py
- 10. Troubleshooting
- test_owui_pin_consistency.py
- memory-graph.jsx
- drawer-save-errors-v3.spec.ts
...
- test_delete_cascade_clears_slot_default_and_emits_model_deleted_last
- _CapturingClient
- cli-test.sh
...
- buildMemFactGraph
- hf-add-mmproj-gate.spec.ts
- npu-chat-model-seed-v3.spec.ts
- slot-drawer-profile-v3.spec.ts
- slot-drawer-sunset-removal-v3.spec.ts
- [0.9.3] — 2026-07-06
- [0.9.6] — 2026-07-10
- [0.9.7.3] — 2026-07-12
...
- TestRenderCancel
- test_distro.sh
- test_migration_convergence.py
- _FakeRegistry
- test_cancel.py
- bankFrom
- graphForBank
- comfyui-arbiter-v3.spec.ts
- diagnostics-doctor-feed-v3.spec.ts
- memory-bank-error-branches.spec.ts
...
- conftest.py
- test_seed_parity.py
- test_destructive_ops_land_audit_rows
- test_store.py
- .handler
- _delegate_fakes.py
...
- runtime-test.sh
- test_seed_order.py
- test_agent_unit_argv_defaults_to_real_euid
- hal0 dashboard E2E (Playwright)
- footer-update-chip-v3.spec.ts
- memory-tools-v3.spec.ts
- model-drawer-reset-profile-v3.spec.ts
- model-edit-identity-v3.spec.ts
- settings-v3.spec.ts
- AGENTS.md
- CLAUDE.md
- extraction-spec.md
...
- rocmfpx-pipeline.sh
- rocmfpx-quantize.sh
- check-service-env.sh
- inject-system-state.sh
- set_extra_paths.sh
- hal0-agentenv
- hal0-hermes
- hermes
...
- __init__.py
- __init__.py
- test_hal0_hermes_wrapper_default_home_is_dot_hermes
- test_hermes_wrapper_does_not_pin_hermes_home
- test_put_adding_vision_to_projectorless_row_rejected
- test_put_adding_vision_alongside_mmproj_accepted
- test_put_unrelated_field_on_preexisting_broken_row_accepted
- test_create_with_nonexistent_mmproj_rejected
- test_scan_with_rows_falls_back_to_detection_for_missing_fields
- test_put_profile_change_does_not_rematerialize_extra_args
- test_create_screens_managed_extra_args
- test_put_partial_defaults_preserves_unsent_siblings
- test_put_explicit_null_sub_key_still_clears
- test_put_unparseable_context_size_is_400_not_500
- test_put_out_of_range_context_size_rejected
- test_create_rejects_out_of_range_context_size
- __init__.py
- __init__.py
- __init__.py
- harness-cleanup.sh
...
- test_registry_files_get_explicit_rows_matching_each_writer
...
1. `SlotManager` - 288 edges
2. `ENDPOINTS` - 141 edges
3. `connect()` - 128 edges
4. `create_app()` - 126 edges
5. `ApprovalQueue` - 125 edges
6. `ContainerProvider` - 125 edges
7. `SlotState` - 121 edges
8. `BadRequest` - 119 edges
9. `BoardStore` - 114 edges
10. `apiGet()` - 104 edges

## Surprising Connections (you probably didn't know these)
- `test_successful_mount_leaves_no_error_recorded()` --calls--> `create_app()`  [INFERRED]
  tests/api/test_mcp_mount_health.py → src/hal0/api/__init__.py
...
- `test_resolve_read_tool_paths()` --calls--> `_resolve_read_tool()`  [INFERRED]
  tests/board/test_board_chat.py → src/hal0/brain/chat.py
- `test_compact_board_shapes()` --calls--> `_compact_board()`  [INFERRED]
  tests/board/test_board_chat.py → src/hal0/brain/chat.py

## Import Cycles
- None detected.

## Communities (1392 total, 158 thin omitted)

### Community 0 - "test_updater.py"
Cohesion: 0.03
Nodes (172): _atomic_symlink_swap(), _current_symlink(), _parse_manifest(), Return ``<usr_lib>/hal0-<version>/`` — where this release's tree lives., Return ``<usr_lib>/current`` — the atomic-swap target., Release manifest is missing required fields or has the wrong shape., Atomic self-update with cosign-verified releases and one-step rollback.      All, Initialise the updater.          Args:             channel: Release channel — "s (+164 more)

### Community 1 - "die"
Cohesion: 0.04
Nodes (120): agent_install(), agent_peers(), approvals_approve(), approvals_deny(), _install_hermes(), Approve a pending agent action., Deny a pending agent action., List discoverable agent identity cards.      Thin wrapper over ``memory_search`` (+112 more)

### Community 2 - "useSlots.ts"
Cohesion: 0.03
Nodes (120): ADR-0022, useModels(), useNpuOccupancy(), deviceBackend(), DEFAULT_METRICS, fetchSlotsUnion(), FlagProvenance, IMAGE_PULL_TERMINAL (+112 more)

### Community 3 - "Slot"
Cohesion: 0.02
Nodes (116): container_provider(), Return the process-wide ContainerProvider singleton., flm_id_to_tag(), Resolve a hal0 ``<tag>-FLM`` id back to FLM's native ``family:size`` tag.      I, Atomically write a slot TOML.      THE byte-level write path for ``/etc/hal0/slo, Hold the coarse cross-process lock for ALL slots/*.toml writes.      Historicall, slot_write_lock(), write_slot_toml() (+108 more)

### Community 4 - "SlotManager"
Cohesion: 0.05
Nodes (77): FakeContainerProvider, MonkeyPatch, Path, Tests for hal0.slots.manager.SlotManager (container-only dispatch).  Phase E (#6, Write an img-group (ComfyUI) slot TOML carrying [image].idle_restore_minutes., Editing [image].idle_restore_minutes pushes the new value into the     already-c, 0 is valid (#599 manual-only restore) and must propagate, not fall back., Write a typed slot TOML for routing tests.      ``model=""`` writes an INACTIVE (+69 more)

### Community 5 - "dashboard-redesign.jsx"
Cohesion: 0.05
Nodes (69): formatUptime(), Hardware, normalizeHardware(), shortKernel(), useHardware(), useProxmoxSettings(), useSlots(), StatsHardware (+61 more)

### Community 6 - "ApprovalQueue"
Cohesion: 0.03
Nodes (121): ApprovalQueue, Async-safe pending-approval queue with dedup + SSE fan-out.      One instance pe, list_transport(), mock_transport(), _policy(), Any, MonkeyPatch, queue() (+113 more)

### Community 7 - "updater.py"
Cohesion: 0.04
Nodes (85): _cache_dir(), _decode_release_manifest(), _download(), _editable_install_path(), exact_manifest_identity(), _extract_tarball(), fetch_release_manifest(), _fetch_release_manifest_bytes() (+77 more)

### Community 8 - "ProfileConfig"
Cohesion: 0.04
Nodes (50): ProfileConfig, One ``[profile.<name>]`` entry in profiles.toml.      A profile is a reusable ba, Return the full flag string for *profile*, expanding MTP when set.      When the, resolve_profile_flags(), Return the canonical llama-server argv for a container slot.      Used by the AP, resolved_command_for_slot(), §7.1a / ML-5: profile.mtp is informational only — resolve_profile_flags, profile.mtp=True alone (no explicit mtp_override) no longer         expands the (+42 more)

### Community 9 - "client.ts"
Cohesion: 0.04
Nodes (62): ADR-0004, ADR-0013, ADR-0023, COMFYUI_FALLBACK, ComfyuiArbiter, ComfyuiEngineState, ComfyuiMemory, ComfyuiMode (+54 more)

### Community 10 - "test_memory_hindsight_plugin.py"
Cohesion: 0.02
Nodes (33): _FakeHttpClient, _FakeResponse, Any, Exception, MonkeyPatch, hal0-memory Hermes plugin (canonical src copy) — hermetic unit coverage.  ``src/, Duck-typed stand-in for ``httpx.Response`` — no network involved., Duck-typed stand-in for ``httpx.Client`` — records calls, no sockets. (+25 more)

### Community 11 - "doctor_commands.py"
Cohesion: 0.04
Nodes (98): NextStep, check_hermes_ownership(), check_tree_group_share(), _dangling_registry_entries(), _deepest_mountpoint(), detect_editable_root(), _diagnose_audit_rows(), _diagnose_migration() (+90 more)

### Community 12 - "model-drawer.jsx"
Cohesion: 0.03
Nodes (119): URL-safe lowercase identifier used by the REST surface., api(), serialiseBody(), useBackends(), useComfyuiPin(), useComfyuiSwitchover(), useComfyuiWorkflowLaunch(), useMeta() (+111 more)

### Community 13 - "SettingsShell.jsx"
Cohesion: 0.05
Nodes (75): CapabilitiesBag, CapabilityBackend, CapabilityCatalogItem, CapabilityRow, CapabilitySelection, useCapabilities(), useCapabilityApply(), useCapabilityPatch() (+67 more)

### Community 14 - "main.tsx"
Cohesion: 0.04
Nodes (18): AGENT_TAB_DEFS, _agentRoute(), _agentTabs(), AgentView(), ADR-0023, Markdown(), mdInline(), BOARD_LANES (+10 more)

### Community 15 - "slots.py"
Cohesion: 0.04
Nodes (100): _cache_slot_enrichment(), _config_field_enrichment(), _container_state_enrichment(), create_slot(), delete_slot(), _device_backend(), _fit_check_warning(), get_slot() (+92 more)

### Community 16 - "ENDPOINTS"
Cohesion: 0.03
Nodes (118): apiDelete(), apiGet(), ApiOptions, apiPut(), Hal0Error, ENDPOINTS, AgentMCPClientList, AgentMCPClientView (+110 more)

### Community 17 - "probe.py"
Cohesion: 0.05
Nodes (77): _amd_drm_device(), _amd_drm_devices(), _amd_gpu_info(), _derive_unified_memory_mb(), _detect_aie_columns(), _detect_amd(), _detect_amd_gpus(), _detect_gpu() (+69 more)

### Community 18 - "FLMProvider"
Cohesion: 0.04
Nodes (62): FLMProvider, Provider for the AMD NPU FLM backend.      Two-tier readiness (Option A — NPU do, _mock_response(), model_info(), provider(), Any, Unit tests for FLMProvider.  Two-tier readiness (Option A — NPU double-free avoi, Bundled default when no slot override / env / manifest pin applies.      §7.1b / (+54 more)

### Community 19 - "Any"
Cohesion: 0.03
Nodes (84): _artefact_token(), _best_effort_model_info(), _binary_runner(), _container_runtime(), _effective_backend_and_device_class(), _effective_parallel(), _effective_runner(), _native_ctx() (+76 more)

### Community 20 - "run_pull"
Cohesion: 0.07
Nodes (78): hf_download_url(), make_job(), Build the canonical HuggingFace download URL.      ``resolve/main`` (not ``raw/m, Create a fresh job record for ``model_id``., Background-task body: stream the file(s), hash, install, register.      ML-2/ML-, run_pull(), A pull without comfyui_subdir keeps the legacy models/<id>/ layout., test_run_pull_default_subdir_unchanged() (+70 more)
...
### Community 22 - "useModels.ts"
Cohesion: 0.04
Nodes (82): AddFromPathRequest, fmtBytes(), HfSearchResponse, HfSearchResult, Model, ModelDefaultResult, ModelDeleteResponse, ModelDuplicateRequest (+74 more)

### Community 23 - "Dispatcher"
Cohesion: 0.06
Nodes (76): LegacyResolutionFailed, Raised when the capability/path heuristics find no slot to serve a request., Dispatcher, DispatchError, NoRouteFound, Look up a registry binding for a model id.          Returns (upstream_name, upst, Base for any failure the dispatcher itself raises.      All subclasses use the `, No upstream could be found for the requested model id. (+68 more)

### Community 24 - "ConfigParseError"
Cohesion: 0.04
Nodes (67): OSError, config_validate(), Validate all config files against the current schema., ConfigError, ConfigNotFound, _drop_dead_keys(), _find_manifest_path(), _flatten_slot_toml() (+59 more)

### Community 25 - "test_probe.py"
Cohesion: 0.05
...
### Community 26 - "ContainerProvider"
Cohesion: 0.04
Nodes (62): ContainerProvider, Podman-container-per-slot inference backend.      One instance is shared across, Not applicable — systemd starts the container., Probe GET /health on the container port.          For llama-server slots /health, Poll /health until 200 or HEALTH_TIMEOUT_S exceeded.          Raises:, _make_provider_with_tmp_unit(), Path, Tests for stale legacy drop-in cleanup in _write_and_start_unit (closes #694). (+54 more)

### Community 27 - "UpdateSeam"
Cohesion: 0.04
Nodes (101): ConfigParseError, A config file is present but contains invalid TOML or fails validation., _main(), Tag-based release-policy derivation — the single source of truth for classifying, Return a ``key=value``-compatible dict for GitHub Actions outputs.          All, Raised when a tag does not match any supported release pattern., Immutable policy derived from a parsed release tag., ReleasePolicy (+93 more)

### Community 28 - "test_migrate_model_layout.py"
Cohesion: 0.06
...
### Community 29 - "HermesDriver"
Cohesion: 0.05
Nodes (79): HermesDriver, Driver for the Hermes-Agent bundled agent., HermesUpstreamMissingError, Raised by the Hermes driver when the hal0-owned ``hal0-hermes``     wrapper is n, driver(), _FakeCompleted, _FakeRunner, _prober_missing() (+71 more)

### Community 30 - "useBoard.ts"
Cohesion: 0.06
Nodes (78): apiPatch(), apiPost(), readErrorEnvelope(), normaliseActor(), normaliseAssignee, normaliseProfile, pickName(), BoardAssignee (+70 more)

### Community 31 - "ModelDefaults"
Cohesion: 0.05
Nodes (45): _derive_ns(), Model, ModelCapabilities, ModelDefaults, Model — registry entry pydantic model.  The Model class is the typed representat, A model entry in the hal0 registry.      All fields are optional at construction, # NOTE: revisit in Phase 1 — extend as providers surface new capabilities., Launch/runtime typed flags — §7.1d / ML-6.      Distinct from :attr:`Model.capab (+37 more)

### Community 32 - "FakeManager"
Cohesion: 0.08
...
### Community 33 - "Model"
Cohesion: 0.04
Nodes (97): NamedTuple, FileSetEntry, FileSetPlan, One file of a planned file-set, ready for ``model_file`` insertion., The full set of files one model pull should download + register., _comfyui_models_dir(), _dir_size(), _discard_partial() (+89 more)

### Community 34 - "create_app"
Cohesion: 0.04
Nodes (80): create_app(), Lifespan wiring for the GpuArbiter idle-restore loop (Phase D, Task D6).  The ap, test_lifespan_starts_and_cancels_arbiter_idle_loop(), Cutover: app.state exposes memory_provider (P2)., test_app_state_has_memory_provider(), test_health_memory_enabled_reads_provider(), app(), client() (+72 more)

### Community 35 - "test_plugin_manifest_proxy.py"
Cohesion: 0.05
...
### Community 36 - "comfyui.py"
Cohesion: 0.08
Nodes (42): aclose_client(), _arbiter_api_mode(), _as_pct(), _bytes_to_gb(), _comfyui_container(), _comfyui_data_dir(), _comfyui_models_dir(), comfyui_status() (+34 more)

### Community 37 - "NotFound"
Cohesion: 0.04
Nodes (43): _coerce_board_list(), _coerce_card_list(), _new_card_id(), _now(), Any, Connection, Row, hal0-owned Operator Board repository — the store behind ``/api/board/*``.  hal0 (+35 more)

### Community 38 - "load_profiles_config"
Cohesion: 0.05
Nodes (33): load_profiles_config(), Load and validate /etc/hal0/profiles.toml.      Returns a :class:`ProfilesConfig, Look up a named profile in the profiles.toml catalog.      Shared by every provi, resolve_profile(), ProfilesConfig, Parsed profiles.toml — top-level ``[profile]`` table.      Each key under ``[pro, Path, Tests for save_profiles_config — round-trip + atomicity.  Targeted file run: (+25 more)

### Community 39 - "hermes_provision.py"
Cohesion: 0.04
Nodes (94): _active_persona_render(), bootstrap_cli(), BootstrapState, _brain_profile_config_path(), _copy_plugin_tree(), _copy_wrapper(), _default_mcp_servers(), _dirs_identical() (+86 more)

### Community 40 - "HindsightProvider"
Cohesion: 0.04
Nodes (45): _agent_of(), bank_to_namespace(), _decode_cursor(), _encode_cursor(), _http_status(), namespace_to_bank(), _now(), _parse_stamp() (+37 more)

### Community 41 - "SlotConfig"
Cohesion: 0.04
Nodes (43): MemoryEmbeddingConfig, NpuConfig, Any, [npu] table in a slot TOML — FLM trio modality toggles.      Maps to ``flm serve, [memory.embedding] section of hal0.toml — Hindsight-era rerank knobs.      ADR-0, Pydantic model for a single slot's TOML config (slots/<name>.toml).      Fields, Pull a `[server]` TOML table out of the loader's `extra` catch-all.          ``h, Pull a `[npu]` TOML table out of the loader's `extra` catch-all.          Mirror (+35 more)

### Community 42 - "UpstreamCall"
Cohesion: 0.05
Nodes (44): _default_fetch_models(), _default_is_online(), _filter_response_headers(), _join_url(), Any, AsyncClient, Request, Response (+36 more)

### Community 43 - "Upstream"
Cohesion: 0.03
Nodes (108): _fields_for_dataclass(), _fields_for_entry(), _filters_to_config(), _filters_to_runtime(), Any, AsyncClient, Lock, Path (+100 more)

### Community 44 - "test_updater_routes.py"
Cohesion: 0.05
...
### Community 46 - "ComfyUIProvider"
Cohesion: 0.04
Nodes (78): Provider, Any, ContainerSpec, Abstract base for a hal0 inference backend.      Concrete implementations: Conta, Compute the EnvironmentFile contents for a slot.          Returns a mapping of H, Return the argv list for spawning this backend outside systemd.          Mirrors, Run a health check against the backend on *port*.          Returns {"ok": bool,, Passthrough inference against the provider's OpenAI-compatible API.          Thi (+70 more)

### Community 47 - "chat.py"
Cohesion: 0.07
Nodes (61): _admin_tool_names(), _admin_tool_schemas(), _brain_chat_config(), _brain_tool_policy(), _chat_stream(), _compact_board(), _context_exceeded_error(), _dispatch_admin_tool() (+53 more)

### Community 48 - "ModelRegistry"
Cohesion: 0.06
Nodes (32): ModelAlreadyExists, Base error for registry operations., add() called but the model id is already present., RegistryError, test_duplicate_conflicting_new_id_raises(), _model(), ModelRegistry, Path (+24 more)
...
### Community 50 - "v1.py"
Cohesion: 0.10
Nodes (45): DispatcherDep, _aggregate_models(), audio_speech(), audio_transcriptions(), _capability_slot_for_path(), chat_completions(), completions(), _dispatch_and_forward() (+37 more)

### Community 51 - "AgentManager"
Cohesion: 0.07
...
### Community 52 - "CapabilityOrchestrator"
Cohesion: 0.07
...
### Community 53 - "UpstreamRegistry"
Cohesion: 0.13
Nodes (14): _model_info(), Any, Regression guard for the 2026-06-15 chat@4096 incident: a slot whose     TOML pi, Test shim: render a plan to Quadlet ``.container`` text (was ``_render_unit_from, Loopback publish is derived from port + empty network_mode by the         render, Absent a publish_host override the renderer keeps the safe default., [slots].publish_host=0.0.0.0 → the slot publishes on all interfaces., network_mode must be empty (not 'host') so loopback publish is used. (+6 more)

### Community 54 - "resolve_by_capability"
Cohesion: 0.05
Nodes (62): Any, Capability/path routing heuristics — dispatcher resolution Step 4.  Extracted fr, Resolve a request to a slot Upstream using path+name heuristics.      The last-r, resolve_by_capability(), _container_remote_img(), _FakeModelRegistry, Routing rules for image-gen requests in capability/path routing (Step 4).  These, Path pin selects 'img', missing 'img' upstream → typed legacy error. (+54 more)

### Community 55 - "primitives.jsx"
Cohesion: 0.04
Nodes (49): react, bundleNameOr(), InstallState, InstallStateBundle, useInstallState(), RestartSlotsResult, SlotDrift, SlotDriftEntry (+41 more)

### Community 56 - "load_slot_config"
Cohesion: 0.04
Nodes (51): list_slot_layout(), load_slot_config(), Load and validate /etc/hal0/slots/<slot_name>.toml.      The on-disk shape (per, Atomically write a slot config TOML.      The pydantic SlotConfig is flat; we re, Classify every slots/*.toml stem as ``"id"`` or ``"name"``.      The bilingual e, save_slot_config(), ImageGenConfig, [image] table in a slot TOML — persisted image-gen settings (#599).      Carried (+43 more)

### Community 57 - "_spec_provider_for"
Cohesion: 0.04
Nodes (59): Return the freshly-rendered runtime command for drift checks.          This is t, Provider for a slot, or None for the GPU/llama-server default.      The runtime, _spec_provider_for(), KokoroHealthError, KokoroInferError, KokoroProvider, Any, ContainerSpec (+51 more)

### Community 58 - "PreloadEvictHost"
Cohesion: 0.05
Nodes (61): The model registry could not be consulted (outage, not a miss).      Raised by t, RegistryUnavailableError, admit(), CandidateSlot, _estimate_incoming_footprint_mb(), EvictionStep, _gather_candidates(), PreloadEvictHost (+53 more)

### Community 59 - "plan_fileset"
Cohesion: 0.07
Nodes (42): _dirname(), _entry_bytes(), enumerate_repo(), FilesetEmpty, FilesetError, FilesetVariantNotFound, _hf_headers(), HFUpstreamError (+34 more)

### Community 60 - "SlotState"
Cohesion: 0.05
Nodes (55): Async generator yielding every slot state transition as it happens.          Use, is_transition_legal(), Any, Path, Slot lifecycle state machine.  Defines the canonical SlotState enum used by Slot, Return True if the transition from_state → to_state is allowed., Slot exists but is not in READY/SERVING/IDLE state., systemctl start (or env write) failed. (+47 more)

### Community 61 - "errors.py"
Cohesion: 0.05
Nodes (58): RuntimeFamily, SlotType, create_profile(), delete_profile(), export_profile(), get_profile(), import_profile_route(), list_profiles() (+50 more)

### Community 62 - "SystemCtlSeam"
Cohesion: 0.06
Nodes (58): agent_unit_argv(), agent_unit_name(), Hal0SeamMissing, is_hal0_service_user(), privileged_systemctl(), CompletedProcess, Path, SystemCtlSeam — the one narrow privileged seam hal0-api needs post-flip.  P3-per (+50 more)

### Community 63 - "StubWrapper"
Cohesion: 0.06
...
### Community 64 - "test_board_chat.py"
Cohesion: 0.15
Nodes (44): _final_response(), _make_app(), _multi_tool_response(), _PlatformRecorder, Any, Like _Recorder but for hal0-api's OWN routes (no kanban prefix)., Attach a Hal0Config carrying a [brain_chat] override to app.state., Pops a canned chat-completion response per call. (+36 more)

### Community 65 - "hardware.py"
Cohesion: 0.08
Nodes (51): _background_revalidate(), _cached_snapshot(), _clear_in_flight(), get_hardware(), _gpu_sample(), _local_image_repos(), _local_live_stats(), models_health_endpoint() (+43 more)

### Community 66 - "_RecordingSlotManager"
Cohesion: 0.07
Nodes (62): The chosen upstream couldn't be reached (timeout, connection refused, etc.)., The target slot encountered a hard load failure (``SlotState.ERROR``).      Rais, SlotLoadFailed, UpstreamUnavailable, See :meth:`hal0.slots.watchdog.SlotWatchdog.update`., is_dispatchable_state(), Return True when *state* is in the dispatchable ready-set.      Accepts a :class, Lifecycle states for a hal0 inference slot.      Each value is also its JSON/SSE (+54 more)

### Community 67 - "test_argv.py"
Cohesion: 0.05
Nodes (61): _canon(), _dedup(), _deny_managed_flags(), _deny_slot_hardware_flags(), FlagProvenance, _is_flag(), normalize_argv(), NormalizedArgv (+53 more)
...
### Community 69 - "load_capabilities_config"
Cohesion: 0.06
...
### Community 71 - "Path"
Cohesion: 0.10
Nodes (23): _ensure_hermes_config(), _ensure_supported_python(), _hal0_service_home(), _hal0_subprocess_env(), _persist_hermes_python(), _provision_python_via_uv(), Run ``hermes config migrate`` so hermes owns + schema-migrates the file.      No, Execute *path* and require the exact Hermes Python policy version. (+15 more)

### Community 72 - "catalog.py"
Cohesion: 0.07
Nodes (48): available_backends(), _backend_variants(), catalogs_by_slot(), _entry_to_row(), _flat_rows_for_capability(), _flm_image_present(), _flm_rows_for_capability(), get_backend() (+40 more)

### Community 73 - "test_npu_swap_status.py"
Cohesion: 0.10
Nodes (28): _container_npu_cfg(), SlotState.STARTING → in_progress=True (container restarting for model swap)., SlotState.PULLING → in_progress=True., SlotState.UNLOADING → in_progress=True (transition still in flight)., SlotState.READY → in_progress=False, to_model populated from config., SlotState.IDLE → in_progress=False (warm but quiet)., SlotState.OFFLINE → in_progress=False (slot is not running)., SlotState.ERROR → in_progress=False (swap not in progress). (+20 more)

### Community 74 - "FakeSlotManager"
Cohesion: 0.07
Nodes (52): active_tools_for(), chat_slot_has_tool_calling(), Dynamic per-request tool filtering — plan §7.3.  Given the active chat slot and, Return True iff the chat slot's model is allowed to see tools.      Per plan §7., Return the filtered tool list for a chat slot, per plan §7.3.      Args:, FakeSlotManager, _loaded_slot_from_config(), _model_id_of() (+44 more)

### Community 75 - "models_service.py"
Cohesion: 0.05
Nodes (68): Model ids referenced by any configured slot or any stack.      Union of: each sl, referenced_model_ids(), add_from_path(), auto_scan_and_register(), cascade_delete_model(), clear_slot_default(), comfyui_category(), commit_scan_rows() (+60 more)

### Community 76 - "test_mcp_routes.py"
Cohesion: 0.06
...
### Community 78 - "load_hal0_config"
Cohesion: 0.06
Nodes (56): MigrationPlan, get_models_config(), Any, Return the current [models] section (roots / auto-scan / extensions).      Route, Replace the [models] section, persist hal0.toml, then re-scan.      Body shape:, update_models_config(), _apply_store_change(), _config_to_dict() (+48 more)

### Community 79 - "test_memory.py"
Cohesion: 0.07
Nodes (57): dispatcher(), _FakeWrapper, Any, Unit tests for :mod:`hal0.mcp.memory` schema + dispatcher.  Covers each tool's a, Per ADR-0005 §5, source is server-injected and clients cannot lie., Known-namespace list entries (spec §3 closed table) pass through., Diagnosis #8: a ``dataset`` list containing a foreign/unrecognized     namespace, Promoting to private:<client_id> requires an actual client_id. (+49 more)

### Community 80 - "__init__.py"
Cohesion: 0.05
Nodes (43): ChangeSet, FileState, fold_ctx_size_alias(), _known_field_names(), Any, Path, SlotConfigStore — one reconciled truth for capability + slot config (issue #697), Fold the legacy ``[model].ctx_size`` alias into the canonical     ``context_size (+35 more)

### Community 81 - "_ArbiterSlotManager"
Cohesion: 0.07
...
### Community 82 - "Path"
Cohesion: 0.06
Nodes (69): InstallIO, Injectable IO seams :func:`install_hermes` touches.      Defaults bind the real, fake_hermes_run(), A stand-in for ``subprocess.run`` that applies hermes config verbs., _patch_dropin_to_tmp(), MonkeyPatch, Path, First-run posture: no ready slot + no mcp_wire checkpoint → both     fallback si (+61 more)

### Community 83 - "AgentMCPClient"
Cohesion: 0.14
Nodes (9): AgentMCPClient, Load by canonical agent name (``/etc/hal0/agents/<name>.toml``)., Return the outbound bearer token for ``server`` or None.          Tokens load at, Raised when filesystem-style MCP args try to escape the workspace.      Tool arg, Per-agent policy layer over the MCP wire client.      One instance per agent pro, WorkspaceEscapeError, ``enabled=false`` removes the server from enabled_servers()., TestClassify (+1 more)

### Community 84 - "paths.py"
Cohesion: 0.06
Nodes (60): activity_db(), agent_workspace_dir(), agents_config_dir(), api_env(), bundle_chosen_marker(), _covers(), db_path(), default_flm_models_dir() (+52 more)

### Community 85 - "endpoints.ts"
Cohesion: 0.03
Nodes (91): useActivityRecent(), useApprovalList(), useConfigUrls(), CELL_DEFS, CELL_MAP, CellDef, CellId, DashLayout (+83 more)

### Community 86 - "test_hermes_provision.py"
Cohesion: 0.04
Nodes (32): _build_overlay_keys(), Unit tests for :mod:`hal0.agents.hermes_provision`.  Pins the linear ``install_h, display.show_reasoning: true is required for thinking-model TUI visibility     (, display.streaming: true is required alongside show_reasoning — without it     th, model.max_tokens must be a positive int — Qwen3 thinking models silently     dra, model.base_url is always set. Hermes's bare ``provider: custom`` requires     it, Delegation → `agent` MoE slot (thinking-off); chat stays on main model.      Thi, The legacy ``hal0`` model-provider plugin is gone (PR-1-bundle R4 H4).      It h (+24 more)

### Community 87 - "__init__.py"
Cohesion: 0.05
Nodes (76): AbstractEventLoop, _auto_resume_interrupted_pulls(), _boot_audit_store(), _boot_background_tasks(), _boot_capabilities(), _boot_dispatcher(), _boot_mcp_memory_call(), _boot_memory_dispatch() (+68 more)

### Community 88 - "test_models_routes.py"
Cohesion: 0.08
Nodes (52): _hf_handler(), inspect_app(), inspect_client(), _patch_httpx_transport(), Any, Exception, FastAPI, MonkeyPatch (+44 more)

### Community 89 - ".uninstall"
Cohesion: 0.06
...
### Community 90 - "cli.py"
Cohesion: 0.07
Nodes (56): build_parser(), cmd_devices(), cmd_eval(), cmd_history(), cmd_import_v1(), cmd_plan(), cmd_publish(), cmd_reindex() (+48 more)

### Community 91 - "test_pull_routes.py"
Cohesion: 0.07
Nodes (57): app_isolated(), client_isolated(), fake_run_pull(), Any, FastAPI, MonkeyPatch, Path, TestClient (+49 more)

### Community 92 - "test_typed_bodies.py"
Cohesion: 0.08
Nodes (57): container_stub(), models_app(), models_client(), preview_client(), Any, FastAPI, MonkeyPatch, Path (+49 more)

### Community 93 - "connections.jsx"
Cohesion: 0.07
Nodes (52): CatalogEntry, isManagedRemote(), UpstreamCreateBody, UpstreamEntry, UpstreamModelFilters, UpstreamPatchBody, UpstreamTestResult, useProviderCredentialSet() (+44 more)

### Community 94 - "json"
Cohesion: 0.06
Nodes (16): json(), hermes(), IDLE_PRIMARY, mockAgents(), AuthOpts, installAuth(), CAPS_MOCK, routeLayout() (+8 more)

### Community 95 - "models.py"
Cohesion: 0.05
...
### Community 100 - "test_profile_derive.py"
Cohesion: 0.06
Nodes (53): derive_device(), derive_profile(), npu_takes_utility(), Auto-derive a slot's device + profile from the hardware probe (design D4).  Maps, Return a ``SEED_PROFILES`` name for a (capability, device) pair.      Reads the, True when the NPU claims the ``utility`` role on this box.      When True, the f, Return a ``DeviceLiteral`` for the capability, or None to skip it.      None mea, Parity/regression lock for the device→profile derivations (finding PS-4).  The p (+45 more)

### Community 101 - "make_slot"
Cohesion: 0.11
Nodes (53): DispatchContext, Carrier for the per-loop dependencies a handler needs.      Bundled into one obj, make_http_client(), make_slot(), AsyncClient, Build a slot config dict for tests.      Pass ``model=""`` for an INACTIVE slot, Build an httpx.AsyncClient backed by ``httpx.MockTransport``.      The ``handler, _ctx() (+45 more)

### Community 102 - "test_contract_compatibility.py"
Cohesion: 0.06
...
### Community 103 - "test_unified_bank.py"
Cohesion: 0.06
...
### Community 104 - "Any"
Cohesion: 0.06
Nodes (57): _apply_config_set(), _build_brain_identity_card(), _build_identity_card(), _collect_capability_rollup(), _collect_chat_slots(), _detect_foreign_gateways(), _fetch_slots(), _find_named_ready_slot() (+49 more)

### Community 105 - "LlamaServerProvider"
Cohesion: 0.08
Nodes (28): LlamaServerProvider, ProviderHealthError, ProviderInferError, Any, llama.cpp HTTP-client surface — NOT a launcher.  This module used to own the lla, Passthrough /v1/chat/completions to llama-server., Parse llama.cpp /metrics Prometheus text into a flat dict.          Whitelisted, Provider health probe failed (typed for the error envelope). (+20 more)

### Community 106 - "useAgents.ts"
Cohesion: 0.08
Nodes (37): AgentList, AgentRecord, AgentRestartResult, AgentSkill, AgentSkillsResponse, ApprovalEntry, ApprovalList, BUNDLED_MCP_IDS (+29 more)

### Community 107 - "test_redact.py"
Cohesion: 0.12
Nodes (18): Any, Shared config-echo redaction (issue #553).  A single helper that scrubs sensitiv, Recursively scrub sensitive-keyed values from a config tree.      - ``dict``: wa, Project a sensitive *value* into the masked ``{value, set}`` shape.      ``set``, redact_config(), redact_value(), Nested dicts are scrubbed: any sensitive key at any depth is masked., Lists of dicts are walked element-by-element.      Note the container key (``ups (+10 more)

### Community 108 - "portable.py"
Cohesion: 0.07
Nodes (38): _checksum(), export_envelope(), import_stack(), ModelResolution, parse_envelope(), Any, ModelRegistry, Path (+30 more)

### Community 109 - "load_answers"
Cohesion: 0.11
...
### Community 110 - "test_update_cosign_pin.py"
Cohesion: 0.13
Nodes (41): _checksums(), _current_checksums(), Harness, _next_checksums(), _pinned(), CompletedProcess, Path, The pinned cosign in bootstrap.sh gets bumped by a tool, never by hand.  ``insta (+33 more)

### Community 111 - "test"
Cohesion: 0.04
Nodes (23): Fixtures, MockState, test, LIVE_BOARD, HERMES_ACTORS, MOCK_MCP_SERVERS, MOBILE, CURATED (+15 more)

### Community 112 - "record_action"
Cohesion: 0.14
...
### Community 113 - "test_registry_import.py"
Cohesion: 0.05
...
### Community 114 - "test_providers_routes.py"
Cohesion: 0.10
Nodes (51): Atomically write upstreams.toml.      Uses ``exclude_none=True`` so optional fie, save_upstreams_config(), Parsed upstreams.toml., UpstreamsConfig, Path, TestClient, Tests for /api/upstreams and /api/providers routes., Write a minimal upstreams.toml containing only the 'openrouter' entry.      The (+43 more)

### Community 115 - "test_orchestrate.py"
Cohesion: 0.07
Nodes (37): The full set of first-run choices to apply., Selections, _FakeSlotManager, _Job, A non-empty absolute ``storage_dir`` is written to ``[models].store`` so     the, A custom ``storage_dir`` also seeds ``[models].flm_store`` co-located     under, A relative ``storage_dir`` leaves ``flm_store`` untouched too (mirrors     the e, A pytest tmp_path is essentially never the same device as ``/`` in CI     sandbo (+29 more)

### Community 116 - "test_hindsight_provider.py"
Cohesion: 0.08
Nodes (41): Hal0Reranker, HindsightProvider, Async reranker over hal0-api's OpenAI surface (Cohere-style ``/v1/rerankings``)., True when a memory WRITE was recently observed to fail.          Distinct from :, Fake404HindsightClient, FakeHindsightClient, FakeReranker, HindsightProvider unit tests — bank mapping + fan-out (P1). (+33 more)

### Community 117 - "PgVectorProvider"
Cohesion: 0.08
Nodes (23): True when the Hindsight daemon is NOT answering.          The BOOT-time degrade, _now(), PgVectorProvider, PgVectorProvider — the documented boot fallback (spec P1 degrade ladder).  Minim, _cfg(), #613 — PgVectorProvider degrade-safety: warn on writes, expose degraded flag.  V, Subsequent add() calls must NOT repeat the write warning (log-once throttle)., The warning must not prevent the write — data IS stored in memory. (+15 more)

### Community 118 - "test_pve.py"
Cohesion: 0.07
...
### Community 120 - "BadRequest"
Cohesion: 0.05
Nodes (31): child_to_slot(), Resolve a (slot, child) tuple to its underlying slot name.      Raises :class:`B, BadRequest, 400 — the request was syntactically or semantically invalid.      Use this for c, 400 when a slot-config write body carries a MODEL-owned key.      ``mtp`` / ``en, reject_model_owned_slot_keys(), Bare double-quoted JSON whose quotes shlex strips is rejected with the     singl, test_screen_extra_args_json_rejects_shell_stripped_json() (+23 more)

### Community 121 - "HardwareStats"
Cohesion: 0.05
Nodes (50): HardwareStats, _port_in_use(), Any, Path, Take a typed GPU memory + utilization sample (issue #703).          Delegates to, Return current GPU compute utilisation as a fraction [0.0, 1.0].          AMD: r, Return current GPU VRAM usage in MiB.          On AMD UMA (Strix Halo) returns m, Return total GPU VRAM in MiB (or GTT pool on UMA). (+42 more)

### Community 122 - "get_runner"
Cohesion: 0.05
...
### Community 123 - "SlotConfigError"
Cohesion: 0.08
Nodes (32): See :func:`hal0.slots.routing.loaded_slot_from_config`., See :func:`hal0.slots.routing.loaded_slot`., See :func:`hal0.slots.routing.resolve_for_request`., add_slot(), default_slot_for(), loaded_slot(), loaded_slot_from_config(), LoadedSlot (+24 more)

### Community 124 - "test_seam_check.py"
Cohesion: 0.07
Nodes (48): _check_file(), _default_stat(), grant_probe_argv(), probe_seam(), probe_seams(), Path, RunFn, stat_result (+40 more)

### Community 125 - "test_agent_install_hermes.py"
Cohesion: 0.05
...
### Community 126 - "hal0 rework plan — reader's copy"
Cohesion: 0.04
...
### Community 127 - "run_migrations"
Cohesion: 0.08
Nodes (29): config_migrate(), Migrate hal0.toml forward to the latest config schema version.      Reads ``meta, _deep_copy_dict(), latest_version(), MigrationError, Any, hal0.config.migrations — versioned config migration transforms.  # TIER3: config, # NOTE: downgrade migrations are explicitly unsupported in v1. (+21 more)

### Community 128 - "test_auth_rotate.py"
Cohesion: 0.09
Nodes (47): _mcp_memory_call(), _probe_mcp_server(), List the tools an MCP server advertises. Returns shape:     ``{"ok": bool, "tool, Call the hal0-memory surface. Returns ``{ok, result?, error?}``.      **Was** a, _key_from_api_env(), Best-effort read of an API key from /etc/hal0/api.env (admin preferred).      Th, generate_service_key(), key_fingerprint() (+39 more)

### Community 129 - "SlotInterface"
Cohesion: 0.07
...
### Community 132 - "§21.4 `hal0 doctor` rework + support bundle — implementation spec"
Cohesion: 0.04
...
### Community 135 - "test_notes.py"
Cohesion: 0.06
Nodes (44): _git(), _git_changelog(), main(), _prev_tag(), Run a git command, returning trimmed stdout or ``""`` on any failure., Most recent release tag before *tag* (nightly picks the prior nightly)., Fallback markdown: a commit log since the previous relevant tag., extract_changelog_section() (+36 more)

### Community 136 - "images"
Cohesion: 0.07
Nodes (41): _backend_state(), _image_repo(), Strip the tag/digest → the bare ``registry/repo`` of an image ref.      Mirrors, ``"installed"`` / ``"installable"`` / ``"unavailable"`` for one runner.      Loc, images(), _parse_repos(), PodmanImagesResult, CompletedProcess (+33 more)

### Community 137 - "schema.py"
Cohesion: 0.09
Nodes (43): _compact_ts_to_iso(), _import_v1_index(), _norm_v1_model_id(), Convert generate_results_json.py's index.json records to schema-2., Canonicalise a v1 model id so the same model measured under inconsistent     nam, server-ab stamps are compact UTC (``20260704T212506Z``); normalise to the     IS, Normalize a v1 timestamp to a run_id (UTC stamp + suffix). Keeps chrono     sort, _sa_generative_record() (+35 more)

### Community 138 - "install_openwebui"
Cohesion: 0.08
...
### Community 139 - "Mount"
Cohesion: 0.06
Nodes (52): assert_under_store(), by_id_dir(), entry_pointer(), file_dest(), finalize_perms(), _fstype_from_proc_mounts(), is_nfs_path(), model_dir() (+44 more)

### Community 140 - "test_comfyui_proxy.py"
Cohesion: 0.15
...
### Community 141 - "test_board_chat_tool_use_e2e.py"
Cohesion: 0.13
Nodes (42): _collect(), _collect_with_payload(), _fake_request(), _fast_approval_wait(), _final(), _parse(), _persona_root(), Any (+34 more)

### Community 142 - "SecurityPage.jsx"
Cohesion: 0.04
Nodes (49): KeyTier, RequireAuthResponse, RotateKeyResponse, useLogout(), useRotateKey(), useSetRequireAuth(), ExposureAllowlistEntry, ExposureRule (+41 more)

### Community 143 - "apiMock.ts"
Cohesion: 0.09
...
### Community 144 - "PART 0 — current-state map of scattered metrics (file:line)"
Cohesion: 0.04
...
### Community 145 - "slot_flags_fold.py"
Cohesion: 0.06
Nodes (44): RuntimeError, list_slots(), Return all configured slot *stems* of /etc/hal0/slots/*.toml, sorted.      NAME-, apply_fold_plan(), _canon(), _chat_template_or_none(), collect_inputs(), compute_folded_tune() (+36 more)

### Community 146 - ".apply"
Cohesion: 0.05
Nodes (33): Fire-and-forget trigger to refresh the Hermes live-context files.  Called from t, Spawn a detached ``hal0-agent <agent_id> render-context``. Never raises., spawn_context_refresh(), Return the TTS slot profile a device selection implies.      The engine switch:, tts_profile_for_device(), legal_children(), Any, CapabilitySelection (+25 more)

### Community 147 - "mcp.py"
Cohesion: 0.07
...
### Community 148 - "agent_commands.py"
Cohesion: 0.05
Nodes (53): agent_list(), agent_log(), _agent_provision_state_file(), agent_reprovision(), agent_status(), agent_uninstall(), agent_upgrade(), _approval_summary() (+45 more)

### Community 149 - "build_auto_selections"
Cohesion: 0.07
...
### Community 150 - "schema.py"
Cohesion: 0.05
Nodes (27): ActivityConfig, AgentConfig, Pydantic v2 schema models for hal0 configuration.  All TOML files under /etc/hal, # NOTE: ``map_backend_to_device`` now lives in ``hal0.model_meta`` (imported, One (slot, child) capability selection carried by a stack slot entry.      Mirro, One slot's contribution to a stack: which model/profile/caps it carries.      Re, Optional [upstream.model_filters] table — curates /v1/models advertising.      A, One [[upstream]] entry in upstreams.toml.      ``extra="forbid"`` (P3-schema Par (+19 more)

### Community 151 - "GPUMemorySample"
Cohesion: 0.09
...
### Community 152 - "admin.py"
Cohesion: 0.09
Nodes (37): _audit(), build_server(), _call_rest(), _declared_path_args(), dispatch(), _execute_tool(), _format_url(), is_gated() (+29 more)

### Community 153 - "_llama_launch_plan"
Cohesion: 0.06
...
### Community 155 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.04
...
### Community 156 - "Hal0MemoryProvider"
Cohesion: 0.08
Nodes (15): Hal0MemoryClientError, Raised when a hal0-memory REST call fails.      Wraps the upstream status code +, hal0-memory — Hermes ``MemoryProvider`` plugin (canonical, shipped source).  Imp, Plugin entry point — register the provider with the loader., register(), Hal0MemoryProvider, _hindsight_config_path(), MemoryProvider (+7 more)

### Community 157 - "orchestrate.py"
Cohesion: 0.07
Nodes (43): _activate_slot_model(), apply_setup(), _build_slot_cfg(), _clamp_context_size(), _colocated_flm_store(), _ensure_registry_entry(), _free_space_gib(), install_extension() (+35 more)

### Community 158 - "pull_jobs.py"
Cohesion: 0.07
Nodes (54): build_stream_response(), cancel(), delete(), emit_terminal_pull_event(), enqueue(), enqueue_update(), eta_s(), list_all() (+46 more)

### Community 159 - "Hal0Error"
Cohesion: 0.10
Nodes (47): Hal0Error, _agent_id(), _augment_build_counters(), _bank_failed_op_ids(), _enabled_llm_slots(), graph_status(), _is_private(), memory_add() (+39 more)

### Community 160 - "_dispatcher"
Cohesion: 0.06
Nodes (40): _ensure_backend_for_model(), #430: load a slot-backed model under its DECLARED backend before routing.      W, lane_slot_pin(), preferred_slot(), Any, rank_slot_name(), Which slot a request actually asked for, and how to choose between slots (#1418), Record that this request resolved to the ``slot_name`` lane. (+32 more)

### Community 161 - "evalrun.py"
Cohesion: 0.09
...
### Community 162 - "hal0 R5 live install-validation — findings (stamp r5v1)"
Cohesion: 0.05
...
### Community 163 - "§7.1d — Capability / Modality Taxonomy untangle (ML-6)"
Cohesion: 0.05
...
### Community 164 - "Hal0MemoryProvider"
Cohesion: 0.08
Nodes (13): hal0-memory — Hermes ``MemoryProvider`` plugin (canonical, shipped source).  Imp, Plugin entry point — register the provider with the loader., register(), Hal0MemoryProvider, _hindsight_config_path(), MemoryProvider, Any, Hal0MemoryClient (+5 more)

### Community 165 - "BoardStore"
Cohesion: 0.08
Nodes (41): BoardStore, Path, SQLite repository for the Operator Board.      The documented interface is exact, _FakeClient, Path, BoardStore — hal0-owned board repository (KB-4).  Covers CRUD against the frozen, Stub HermesKanbanClient.request_json for import tests., A board whose /board fetch fails still imports as an empty board — the     impor (+33 more)

### Community 166 - "connect"
Cohesion: 0.04
Nodes (55): connect(), db_path(), Connection, Path, SQLite connection + transaction helpers — the hal0 ``db/`` foundation.  One conn, Return the default hal0 SQLite database path.      Thin wrapper over :func:`hal0, Switch to WAL journal mode, retrying through transient contention.      The *fir, Open one PRAGMA-configured connection to the hal0 database.      ``isolation_lev (+47 more)
...
### Community 168 - "FakeContainerProvider"
Cohesion: 0.08
Nodes (30): client_factory(), fake_container(), FakeContainerProvider, _hermetic_port_listeners(), make_create_body(), AbstractContextManager, Any, MonkeyPatch (+22 more)

### Community 169 - "providers.py"
Cohesion: 0.07
...
### Community 170 - "AgentMetadataConfig"
Cohesion: 0.06
...
### Community 171 - "test_hal0_provider_plugin.py"
Cohesion: 0.09
...
### Community 172 - "_write_fixture"
Cohesion: 0.12
Nodes (20): Unit tests for hal0.registry.detect.detect()., MR-3: routing detect's filename heuristic through the shared token     table mus, ROCmFPX-family quant detection (ciru-ai/ROCmFPX custom GGUF formats).      These, TestGgufChat, TestGgufEmbed, TestMr3ConsolidationPreservesDetectContract, TestRocmfpxQuant, _build_gguf() (+12 more)

### Community 173 - "FakeMemoryProvider"
Cohesion: 0.06
...
### Community 174 - "_write_diagnostics_section"
Cohesion: 0.10
...
### Community 176 - "StackApplyEngine"
Cohesion: 0.07
...
### Community 178 - "parsers.py"
Cohesion: 0.09
Nodes (39): One server_ab timed run → a schema-2 Rep. Returns None for an errored run     (n, _sa_run_to_rep(), llama_bench_row_kind(), _med(), parse_llama_bench(), parse_server_ab(), Parsed, parsers.py — engine output → schema-2 results (DESIGN §3.2, the P2 parsers).  Th (+31 more)

### Community 179 - "runner.py"
Cohesion: 0.09
Nodes (40): Cell, One planned unit of work: a fully-resolved identity + the suite context     the, _assemble(), _classify(), _clear_stale_sweep(), describe_worklist(), _friendly_gpu(), _gpu_slot_serving() (+32 more)

### Community 180 - "test_agent_uninstall_memory.py"
Cohesion: 0.09
...
### Community 181 - "plan_fold"
Cohesion: 0.10
Nodes (39): apply_fold_plan(), _apply_model_folds(), CapFoldPlan, collect_inputs(), DeployWindowRequired, DivergentCap, ModelCapFold, plan_fold() (+31 more)

### Community 182 - "build_workflow"
Cohesion: 0.14
Nodes (26): build_workflow(), Resolve a model_class string to a template stem.      Falls back to ``sdxl_turbo, Materialise a ComfyUI prompt graph for one image-gen request.      Args:, template_for_model_class(), _baseline_body(), Any, Unit tests for the OpenAI → ComfyUI workflow translator.  The translator is a pu, Two calls without an explicit seed produce different seeds (probabilistically). (+18 more)

### Community 183 - "test_kb1_hardening_tail.py"
Cohesion: 0.07
...
### Community 184 - "container_enrichment"
Cohesion: 0.12
Nodes (15): container_enrichment(), Per-slot live container state.      For each slot, probes two live sources:, _container_cfg(), FakeContainerProvider, MapContainerProvider, _npu_anchor_cfg(), Any, Duck-typed stand-in for ContainerProvider (sync + async mix matches). (+7 more)

### Community 185 - "test_personas.py"
Cohesion: 0.08
...
### Community 187 - "test_slots_image_pull.py"
Cohesion: 0.09
...
### Community 188 - "test_update_commands.py"
Cohesion: 0.07
...
### Community 191 - "HardwareInfo"
Cohesion: 0.04
Nodes (63): _flatten_for_ui(), Project HardwareInfo into the fields the Vue Hardware view expects.      The das, load_hardware_info(), Load /etc/hal0/hardware.json and return a validated HardwareInfo.      Returns t, Atomically write hardware.json.      Uses the same tmpfile+fsync+rename pattern, save_hardware_info(), HardwareInfo, NPUInfo (+55 more)

### Community 192 - "suites.py"
Cohesion: 0.10
Nodes (38): _load_suite(), Resolve a --suite argument: a filesystem path to a .toml, else an id     looked, Build the suite for one queued item: a named suite id, or a single model     (an, _worklist_suite(), Cells, _default_configs(), load_suite_file(), load_suites() (+30 more)

### Community 193 - "import_profile"
Cohesion: 0.09
Nodes (25): _checksum(), export_envelope(), import_profile(), parse_envelope(), ProfileEnvelope, Any, Path, Portable profiles — export/import (mirrors stacks/portable.py, simpler).  Export (+17 more)

### Community 194 - "test_hermes_provision_mcp_auth.py"
Cohesion: 0.10
...
### Community 195 - "test_v1_npu_trio_routing.py"
Cohesion: 0.09
Nodes (39): _make_capture_transport(), _pin_npu_ready(), Any, MockTransport, Path, TestClient, End-to-end routing tests for the NPU trio dispatch (containerized npu slot).  A, MockTransport that records every request to the npu container port. (+31 more)

### Community 196 - "test_slot_aliases.py"
Cohesion: 0.06
...
### Community 198 - "R5 sync assessment — how far every surface is from "back in sync" (2026-07-19)"
Cohesion: 0.05
...
### Community 199 - "preflight.sh"
Cohesion: 0.09
Nodes (33): _container_run_smoke_test(), _container_runtime_gate(), _hindsight_py_autoinstall(), _main_py_autoinstall(), _network_helper_major(), _node_autoinstall(), preflight_all(), preflight_arch() (+25 more)
...
### Community 201 - "migrate_slot_toml"
Cohesion: 0.07
Nodes (32): One-shot: drop the removed ``enabled`` key from slot TOMLs (#1369).      A slot, slot_migrate_enabled_removal(), _is_trio_shadow(), migrate_slot_dir(), migrate_slot_toml(), Any, Path, One-shot migration: sweep ``enabled`` off slot TOMLs (#1369).  ``SlotConfig.enab (+24 more)

### Community 202 - "test_model_store.py"
Cohesion: 0.10
...
### Community 204 - "test_store.py"
Cohesion: 0.13
Nodes (38): _etc(), Any, MonkeyPatch, Path, SlotSelection, SlotConfigStore — invariant + behaviour tests (issue #697).  The store owns BOTH, device=npu → slot TOML device=npu (P2-device: device is the sole     persisted t, [model] sibling keys survive; the legacy ctx_size alias folds (#585). (+30 more)

### Community 205 - "BaseModel"
Cohesion: 0.09
Nodes (36): BaseModel, PersonaApprovalUpdate, Partial ``[persona.approval]`` patch. Omitted fields are unchanged., exposure(), ExposureAllowlistEntry, ExposureResponse, ExposureRule, login() (+28 more)

### Community 206 - "tui.py"
Cohesion: 0.08
...
### Community 207 - "plan_slot_flags_fold"
Cohesion: 0.10
Nodes (35): plan_slot_flags_fold(), Compute the fold plan without touching disk or the registry.      Args:, _FakeRegistry, Tests for the FLAGS-own one-shot migrator (spec-flags-ownership §5).  Covers: so, Two slots sharing one model with conflicting templates → refuse, don't     silen, One slot with chat_template='auto' and one absent both normalize to None     → c, Re-running with the model already carrying the folded template → no-op., Multiple slots that fold to the IDENTICAL tune auto-fold (not divergent). (+27 more)

### Community 208 - "Path"
Cohesion: 0.09
Nodes (24): applied_versions(), _discover_migrations(), _ensure_migrations_table(), migrate(), Connection, Path, Forward-only SQLite schema migration runner.  This is the concrete implementatio, Create the bookkeeping table if absent. Idempotent. (+16 more)

### Community 209 - "recommend_primary_slot"
Cohesion: 0.10
...
### Community 210 - "SlotIdentityStore"
Cohesion: 0.12
Nodes (20): Connection, Path, Row, Slot identity store — the id ⇄ name bridge (rework §11.1).  Every slot gets a st, Insert a new slot row and return it (id assigned by SQLite).          ``slot.ena, Change a slot's display label. References key off id, so this is         the *en, Drop the slot row. ``slot_link`` children cascade; ``port_claim``         rows k, ``name → id`` or raise :class:`SlotNotFound`. (+12 more)

### Community 211 - "test_typed_errors.py"
Cohesion: 0.10
Nodes (37): app(), app_with_slot(), client(), _Color, FastAPI, Hal0Error, MonkeyPatch, TestClient (+29 more)

### Community 212 - "_RecordingProvider"
Cohesion: 0.11
Nodes (14): _cfg(), Any, The query half of the artefact seam must key on the SAME token as the lifecycle, A pre-migration slot (no id) is unchanged — the token IS the name., Back-compat: an already-resolved token passes straight through., Records what each probe path was keyed on., Narrow WatchdogHost stub — only ``_maybe_load_config`` is exercised., The stopped-vs-crashed discriminator is a raw ``systemctl`` call —         it by (+6 more)

### Community 213 - "MonkeyPatch"
Cohesion: 0.09
...
### Community 216 - "SlotWatchdog"
Cohesion: 0.09
Nodes (19): ModelCacheCheck, PullRunner, Lock, Any, Lock, Slot, Push-driven failure detector (P3-slots §1b-watchdog).  ``SlotWatchdog`` polls a, Push-driven failure detector, against a narrow host seam. (+11 more)

### Community 217 - "test_openrouter_auth_loopback.py"
Cohesion: 0.09
...
### Community 218 - "test_mtp_override.py"
Cohesion: 0.09
Nodes (37): build_mtp_flag_bundle(), Bench-tuned MTP draft-speculation flag bundle, with the draft device     derived, model_is_mtp_eligible(), True when a model should speculate with MTP / NextN draft heads.      §7.1a / ML, _effective_mtp(), Resolve whether MTP speculative decoding is on for this slot launch.      spec-h, _mtp_model(), _plain_model() (+29 more)

### Community 219 - "_resolve_llama_scalars"
Cohesion: 0.10
Nodes (41): family_flags(), model_family(), Best-effort model family, preferring the registry's ``architecture``.      §7.1a, The :data:`FAMILY_DEFAULTS` flag string for the model's family, else ''., Resolve every llama-server launch scalar for a slot+model+profile.      SINGLE S, _resolve_llama_scalars(), _cuda_profile(), _extra_args() (+33 more)

### Community 220 - "test_memory_graph_route.py"
Cohesion: 0.13
Nodes (31): _build_app(), client(), hal0_home(), _HindsightyWrapper, Any, FastAPI, MonkeyPatch, Path (+23 more)

### Community 221 - "TestClient"
Cohesion: 0.11
Nodes (17): app(), client(), _create_custom(), FastAPI, TestClient, Tests for the portable profile routes — export/import over HTTP.  Mirrors tests/, The checksum covers the profile body, so editing the body without         restam, `force` is the documented escape hatch for a deliberately hand-edited         en (+9 more)

### Community 222 - "test_pulling_serving_idle.py"
Cohesion: 0.11
...
### Community 224 - "§17 installer/setup overhaul — edit-plan (thin shell + thick Python, one profile authority, one slot roster)"
Cohesion: 0.06
...
### Community 225 - "P3 slot-identity + ports — implementation spec"
Cohesion: 0.06
...
### Community 226 - "hal0 — Plan"
Cohesion: 0.06
Nodes (36): 11. Dev environment + migration plan, 12. Toolbox images, 13. CLI surface, 14. Telemetry, 15. Phased milestones, 16. Deferred decisions (track explicitly), 17. Risks + mitigations, 18. Definition of done — v1.0 (+28 more)

### Community 227 - "driver.py"
Cohesion: 0.07
Nodes (23): _as_text(), _probe_hermes_provisioned(), _probe_systemd_unit_active(), _probe_tcp_port(), _probe_wrapper_installed(), Any, Path, Hermes-Agent driver.  Hermes is user-owned upstream — and crucially, the user ca (+15 more)

### Community 228 - "Persona"
Cohesion: 0.12
Nodes (33): activate(), build_prompt_addendum(), get_active(), hermes_reload(), list_personas(), load_persona(), Persona, PersonaError (+25 more)

### Community 229 - "resolve_role_slots"
Cohesion: 0.13
...
### Community 231 - "provision_comfyui_downloads"
Cohesion: 0.08
...
### Community 232 - "secrets.py"
Cohesion: 0.10
Nodes (35): _api_env(), delete_secret(), _emit(), list_secrets(), Any, Path, Request, Response (+27 more)

### Community 233 - "orchestrate_models"
Cohesion: 0.09
...
### Community 234 - "test_slot_migrate_id_keying.py"
Cohesion: 0.09
Nodes (32): _active_hal0_units(), _backup_slot_state(), _migrate_id_keying_dry_run_plan(), Any, CompletedProcess, Path, One-shot: unwind the flags-fold — hardware sticks to SLOTS (spec-hw-slot-ownersh, Every hal0-owned systemd unit currently active: ``hal0-api.service``     plus an (+24 more)

### Community 235 - "TestUpstreamEntry"
Cohesion: 0.07
...
### Community 237 - "test_route_to_chat.py"
Cohesion: 0.09
Nodes (34): _build_delegation_messages(), build_delegation_messages_for_slot(), _is_chat_slot(), _model_of(), Any, ``route_to_chat`` dispatch — plan §7.4.  One-shot delegation: the calling LLM ha, Build the messages array for a delegation chat request.      Per plan §7.4 step, Build delegation messages from a typed ``LoadedSlot`` view. (+26 more)

### Community 238 - "PortAuthority"
Cohesion: 0.09
...
### Community 239 - "_resolve_image_ref"
Cohesion: 0.10
...
### Community 240 - "Qwen3TTSProvider"
Cohesion: 0.07
Nodes (37): _cache_dir(), Any, ContainerSpec, Qwen3TTSHealthError, Qwen3TTSInferError, Qwen3TTSProvider, Qwen3TTSProvider — GPU (ROCm) multilingual TTS inference backend.  The GPU sibli, Informational env block (container is self-contained). (+29 more)

### Community 241 - "test_update_check.py"
Cohesion: 0.09
...
### Community 242 - "test_installer_routes.py"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (35): TestClient, Regression: the slot-edit Save's ``PATCH /defaults`` must not wipe the     model, idle_timeout_s / workers / llamacpp_args ride along on /api/slots.      The on-d, rope_freq_base set on disk → exposed in /api/slots payload., PUT /api/slots/{name}/config with model.rope_freq_base persists the value     an, #863: single-slot status includes argv drift without burdening list()., A failing container health probe doesn't break /api/slots.      The enrichment s, A slot carries declared_backend (normalized token) derived from its     configur (+27 more)

### Community 244 - "test_store.py"
Cohesion: 0.07
...
### Community 246 - "test_hf_token_secrets.py"
Cohesion: 0.06
...
### Community 250 - "hw_slot_ownership.py"
Cohesion: 0.11
Nodes (30): _apply_slot_fold(), apply_unfold_plan(), collect_inputs(), DeployWindowRequired, _ngl_set(), plan_unfold(), ProfileAction, Any (+22 more)

### Community 251 - "RealtimeSession"
Cohesion: 0.14
...
### Community 252 - "test_hermes_provision_idempotency.py"
Cohesion: 0.11
Nodes (31): install_io(), A deterministic :class:`hp.InstallIO` for hermetic ``install_hermes`` runs., _config(), _install(), Path, Convergence contract: ``install_hermes`` is idempotent.  The promise: re-running, install_hermes drops a flat last-run report `hal0 agent status` can render., The render carries the active persona's system_prompt_prelude + label. (+23 more)

### Community 253 - "test_slots_container_state.py"
Cohesion: 0.09
...
### Community 255 - "FakeContainerProvider"
Cohesion: 0.08
Nodes (22): probe_slot_name(), Any, Shared helper for ContainerProvider probe doubles (#1417).  Production hands the, The slot name a probe argument refers to (config mapping or bare token)., container_stub(), FakeContainerProvider, Any, MonkeyPatch (+14 more)

### Community 256 - "MemoryProvider"
Cohesion: 0.07
...
### Community 257 - "benchmarks.py"
Cohesion: 0.09
Nodes (33): _api_base(), delete_queue(), get_cells(), get_events(), get_history(), get_plan(), get_queue(), get_run() (+25 more)

### Community 258 - "HermesBoardExecutor"
Cohesion: 0.11
Nodes (19): _err(), HermesBoardExecutor, _HermesGateway, _is_configured(), _map_state(), Any, Concrete Hermes :class:`~hal0.board.dispatch.BoardExecutor` (HP-executor, KB-5)., Minimal SYNC HTTP client for the Hermes worker/run surface.      Same auth shape (+11 more)

### Community 259 - "import_toml_to_sqlite"
Cohesion: 0.12
...
### Community 260 - "memory.py"
Cohesion: 0.12
Nodes (33): build_server(), _iso_now(), make_dispatcher(), _memory_add(), _memory_delete(), _memory_list(), _memory_recall(), _memory_search() (+25 more)

### Community 261 - "detect"
Cohesion: 0.11
Nodes (24): detect(), DetectionResult, _filename_capability(), _heuristic_only(), _hf_repo_name_from_path(), Any, Path, quant_from_file_type() (+16 more)

### Community 262 - "test_metrics_prometheus_route.py"
Cohesion: 0.09
...
### Community 263 - "SlotReaper"
Cohesion: 0.10
Nodes (16): is_pinned(), Any, Slot, Idle demotion + TTL/pressure eviction loops (P3-slots §1b).  ``SlotReaper`` owns, Narrow seam :class:`SlotReaper` needs from ``SlotManager``.      Deviation from, Idle demotion + TTL/pressure eviction, against a narrow host seam., Start the background sweeper. Idempotent while the task is alive., Cancel the idle-monitor task if running. Idempotent. (+8 more)

### Community 264 - "test_hf_routes.py"
Cohesion: 0.13
Nodes (33): hf_app(), hf_client(), _hf_search_handler(), _patch_httpx_transport(), Any, Exception, FastAPI, MonkeyPatch (+25 more)

### Community 265 - "test_stacks_routes.py"
Cohesion: 0.14
...
### Community 267 - "_slot"
Cohesion: 0.13
Nodes (15): Serialise a real Slot snapshot into the API shape.      Adds ``kind="local"`` so, serialize_slot(), _agg(), FakeSlotManager, no_mem(), MonkeyPatch, Slot, Unit tests for hal0.slot_view — SlotViewAggregator + per-concern functions.  Iss (+7 more)

### Community 268 - "browser_server.py"
Cohesion: 0.10
...
### Community 269 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.06
...
### Community 274 - "Hal0HermesClient"
Cohesion: 0.11
Nodes (23): _decode_response(), _error_code(), Hal0HermesClient, Any, Response, Synchronous authenticated transport shared by hal0 Hermes adapters., Small policy-free wrapper around the hal0 HTTP API., Close the underlying connection pool. (+15 more)

### Community 275 - "profile.py"
Cohesion: 0.09
Nodes (21): hal0-provider — Hermes ``ProviderProfile`` plugin (canonical, shipped source)., Register the hal0 provider profile.      Prefers a ``PluginContext`` seam if one, register(), assemble_stream(), Hal0ProviderProfile, is_alias(), iter_sse_data(), parse_sse_chunks() (+13 more)

### Community 276 - "MemoryConfig"
Cohesion: 0.08
Nodes (29): MemoryConfig, [memory] section of hal0.toml.      Container for the per-subsystem memory tunab, _build(), TestClient, #613 — /api/status must expose memory_degraded for operator visibility.  Verifie, /api/status always carries a memory_degraded field., memory_degraded=None when no memory provider is wired., memory_degraded=True when PgVectorProvider (in-memory fallback) is wired. (+21 more)

### Community 277 - "ModelsConfig"
Cohesion: 0.08
Nodes (15): ModelsConfig, [models] section of hal0.toml — discovery + auto-detect., Empty means "env var / FLM default cache"; non-empty must be absolute., Roots the discovery scan actually walks: declared ``roots`` plus the         eff, Reject relative paths — discovery walks must start from an absolute root., Empty means "use pull_root"; non-empty must be absolute., Return the resolved model-store path consumers should point at.          Precede, MonkeyPatch (+7 more)

### Community 278 - "StackConfig"
Cohesion: 0.25
Nodes (9): StackCapabilityRow, Records capability apply() calls., RecordingOrchestrator, _engine(), Tests for converge() capability-child routing pass.  Targeted file run:     cd /, Canary: the hardcoded child maps must exactly reverse the orchestrator's     _CH, _row(), test_child_maps_mirror_orchestrator_source_of_truth() (+1 more)

### Community 279 - "build_request_metric_row"
Cohesion: 0.12
...
### Community 280 - "test_memory_admin_routes.py"
Cohesion: 0.15
Nodes (32): _OtherEngineProvider, TestClient, Tests for the Hindsight admin surface — /api/memory/engine + /api/memory/banks/*, #1024: an unconfirmed bank delete surfaces a dry-run item-count preview., Captures upstream requests; serves canned responses by (method, path)., A provider with no hindsight client (e.g. pgvector fallback)., _Recorder, test_bank_create_put_and_delete_forward() (+24 more)

### Community 281 - "test_brain_injection.py"
Cohesion: 0.17
...
### Community 282 - "test_crash_loop_breaker.py"
Cohesion: 0.15
Nodes (30): _BusStub, _fail_load_once(), _pairs(), Any, FakeContainerProvider, Path, SlotManager, Crash-loop breaker: load() from ERROR is throttled, parked, and resettable.  Iss (+22 more)

### Community 283 - "Platform-wide cron/automation management — design"
Cohesion: 0.06
...
### Community 285 - "hal0 ROCmFPX quantization"
Cohesion: 0.06
...
### Community 286 - "test_board_chat_admin_tools.py"
Cohesion: 0.12
...
### Community 287 - "test_upstream_dedup.py"
Cohesion: 0.10
Nodes (26): _hal0_model_cache_clear(), Punch the composite catalogue's cached model list.      Exposed so slot-swap / s, _FakeSlotManager, Any, R4 H2 regression + P2-composite rebuild — direct-read model catalogue.  The bug:, If ``hal0`` is already registered (operator override via     upstreams.toml) pri, ``_fetch_hal0_composite_models`` returns the deduped union of     every chat-cap, Within the TTL window, ``_fetch_hal0_composite_models`` returns     the cached l (+18 more)

### Community 288 - "planner.py"
Cohesion: 0.11
Nodes (31): get_roster(), Per-model current decode/prefill/acc + config chip data.      The core is the ro, _apply_flags(), _build_identity(), fetch_registry_models(), _flag_tokens(), _is_tier_a_incompatible(), _model_caps() (+23 more)

### Community 289 - "memory_admin.py"
Cohesion: 0.14
Nodes (32): bank_document_transfer_export(), bank_document_transfer_import(), bank_subgraph(), _client(), delete_bank(), delete_bank_memories(), _delete_preview(), engine_status() (+24 more)

### Community 290 - "resolve_bench_devices"
Cohesion: 0.21
Nodes (11): _is_char_device(), _node_allowed(), _override_devices(), _probe_snapshot(), _probed_gpu(), GPU device-node resolution for the benchmark harness (issue #1303).  Why this mo, True when ``node`` is inside one of the permitted device roots.      The roots a, Validate one operator-supplied node path, or raise with the details. (+3 more)

### Community 291 - "_shared.py"
Cohesion: 0.09
Nodes (32): chat_command(), Terminal chat REPL over ``/v1/chat/completions`` (or the brain steward with ``--, graph_disable_cmd(), Turn graph extraction OFF; cancels any in-flight build., _api_reachable(), api_get_bytes(), api_patch(), api_put() (+24 more)

### Community 292 - "test_container_gate.py"
Cohesion: 0.11
...
### Community 293 - "test_chat_normalization.py"
Cohesion: 0.07
Nodes (36): _make_request(), _OmniRequest, Request that flows through chat_completions -> _read_json_body -> omni branch., The omni branch returns before _dispatch_and_forward, so chat_completions     mu, The loaded set is read from the cached upstream catalogs only —     no live /v1/, Build a minimal request stand-in.      ``loaded`` materialises as a container-ba, The loaded set derives from container-backed upstreams (``slot_name``     set):, O21 regression: SlotManager registers LOCAL container slots as     kind="slot" ( (+28 more)

### Community 294 - "test_brain_resilience.py"
Cohesion: 0.16
...
### Community 295 - "test_admin_route_map_nested.py"
Cohesion: 0.09
Nodes (29): _FakeIncludedRouter, _FakeLeaf, _OpaqueRoute, Any, The route-map walker must survive FastAPI's include_router restructuring.  Found, An unknown wrapper shape degrades to "not a tool", never to a crash., Depth-bounded: a cycle must not hang the boot path., Gap-2 excludes must not be bypassed just because a route was wrapped. (+21 more)

### Community 296 - "mockFixtures.ts"
Cohesion: 0.06
Nodes (16): BIG_HUBS, BIG_LINK_TYPES, BIG_TOPICS, buildCapabilities(), Builder, capabilityRow(), CONFIG_ENRICHMENT_KEYS, MEM_ENTITIES (+8 more)

### Community 297 - "ML-2 (file-set pulling) + ML-3 (unified store) — implementation spec"
Cohesion: 0.06
...
### Community 298 - "manifest.py"
Cohesion: 0.12
Nodes (30): HttpFetcher, IPv4Address, IPv6Address, _coerce_int(), _default_fetcher(), _enforce_safe_url(), _ip_is_safe(), _is_safe_url() (+22 more)

### Community 299 - "Hal0MemoryClient"
Cohesion: 0.10
Nodes (16): Hal0MemoryClient, Hal0MemoryClientError, Any, Thin synchronous REST client for the hal0-memory REST surface.  Design notes: (1, POST /api/memory/add. ``private=True`` → hermes-private, else shared., POST /api/memory/search — semantic retrieval (union of both banks)., POST /api/memory/recall — token-budgeted consolidated recall (union)., GET /api/memory/list — page through stored items. (+8 more)
...
Cohesion: 0.06
Nodes (32): DiagnosisOut, DoctorResponse, EvidenceOut, get_doctor(), NextStepOut, Diagnosis, Request, T (+24 more)

### Community 302 - "ChatSession"
Cohesion: 0.11
...
### Community 303 - "test_api_env_mode.py"
Cohesion: 0.08
Nodes (26): MonkeyPatch, Path, Issue #1466: one mode for ``api.env``, honoured by every writer.  The live box c, The FIXME(phase4) row. While it said 0644 the engine reverted every     fix the, install.sh:919 ``chmod 0644 "${API_ENV_TMP}"`` — on the refresh branch     that, Both branches — the initial write and the idempotent refresh — must     land the, install.sh warned "api.env is 0644, world-readable" *while* pointing     the ope, Independent of the perms table — if a fifth writer appears, or the     row is wi (+18 more)

### Community 304 - "EventBus"
Cohesion: 0.05
Nodes (54): Re-fetch ``model_cache[slot]`` whenever a slot transitions to ready.      The ca, _refresh_model_cache_on_ready(), EventBus, make_event(), _now_iso(), Any, Queue, In-process event bus + ring buffer for the dashboard footer.  The footer status (+46 more)

### Community 305 - "test_model_fallback.py"
Cohesion: 0.10
...
### Community 306 - ".from_tag"
Cohesion: 0.09
Nodes (27): base_matches(), base_version(), channel_for_tag(), nightlies_to_prune(), nightly_tag(), nightly_version(), Release-channel helpers shared by the release + nightly workflows.  Pure functio, Return the release channel implied by a git tag.      Delegates to :class:`hal0. (+19 more)

### Community 307 - "test_npu_exclusivity.py"
Cohesion: 0.11
Nodes (28): NpuExclusivityViolation, Two ``device=npu, type=llm, enabled=true`` slots cannot coexist.      The AMDXDN, Path, NPU exclusivity validation in SlotManager (PR-11, plan §5.3, ADR-0008 §5).  The, The operator-facing text must describe the real remedy: clear the model., A model-less second NPU LLM slot may coexist with the bound anchor., A model-less peer isn't an anchor, so it can't be the conflicting slot.      The, device=gpu-rocm slots are unaffected by NPU exclusivity. (+20 more)

### Community 308 - "ModelFilters"
Cohesion: 0.19
Nodes (9): apply_filters(), is_advertised(), ModelFilters, Per-upstream model-advertising filters.  Implements docs/superpowers/specs/2026-, Immutable runtime form of an [upstream.model_filters] table., Build from plain lists (e.g. a parsed UpstreamModelFilters dump)., Return True when `model_id` should appear in /v1/models., Filter an iterable of model ids, preserving order. (+1 more)

### Community 309 - "test_doctor_all.py"
Cohesion: 0.06
Nodes (21): _c(), MonkeyPatch, Tests for ``hal0 doctor all`` — the read-only evidence roll-up (§21.4).  The ext, A failed fetch must not claim the endpoint is unreachable.      None only means, Every other failing row names a drill-down; this one must too (#1501)., A wrong-shaped body is a different fault than no body at all.      ``check_model, The slots aggregator is the slowest read-only route — give it room.      It merg, The command the warn row points at has to actually resolve (#1501).      Before (+13 more)

### Community 310 - "test_preflight_gpu_gate.py"
Cohesion: 0.10
...
### Community 311 - "useLogs.ts"
Cohesion: 0.10
Nodes (21): appendEntry(), entryKey(), parseRawLevel(), buildJournalQuery(), JournalEntry, JournalLevel, JournalSource, LogEntry (+13 more)

### Community 312 - "model-drawer-dirty-baseline-v3.spec.ts"
Cohesion: 0.10
Nodes (10): MonkeyPatch, Sandbox every host path constant under tmp_path; return (hermes_home, venv)., target(), SEEDED, seedModel(), PRODUCTION_MODEL, seedProductionModel(), BASE_MODEL (+2 more)

### Community 313 - "KeyError"
Cohesion: 0.12
...
### Community 315 - "test_curated_image_models.py"
Cohesion: 0.11
Nodes (19): MonkeyPatch, Tests for the curated image-gen entries + ComfyUI-subdir pull routing.  Two surf, A malicious comfyui_subdir can't escape the comfyui/models tree., An empty/whitespace subdir lands in checkpoints/ as the safe default., End-to-end: a pull with comfyui_subdir lands under the right tree., The named v1 image-gen picks must always be present., Every image-gen entry needs model_class + comfyui_subdir + capability., The chat picks must still default capability='chat' (no model_class). (+11 more)

### Community 316 - "test_agents_personas.py"
Cohesion: 0.15
...
### Community 317 - "test_chat_templates.py"
Cohesion: 0.12
...
### Community 318 - "test_board_routes.py"
Cohesion: 0.10
...
### Community 319 - "test_uninstall.py"
Cohesion: 0.10
...
### Community 320 - "test_bootstrap_prereq_parity.py"
Cohesion: 0.11
...
### Community 321 - "test_degrade_live.py"
Cohesion: 0.11
Nodes (25): _cfg(), _closed_port_url(), _FakeClient, _HttpError, Exception, MonkeyPatch, SimpleNamespace, #1301 (runtime half) — ``degraded`` must track the engine's LIVE state.  ``tests (+17 more)

### Community 322 - "_Client"
Cohesion: 0.08
Nodes (30): _clean_env(), MonkeyPatch, CLI→API auth attachment (halo150 O2): _api_request sends a bearer token discover, test_api_request_attaches_bearer(), test_api_request_respects_caller_authorization(), test_auth_headers_empty_when_nothing_discoverable(), test_auth_headers_falls_back_to_client_env(), test_auth_headers_prefers_admin_env() (+22 more)

### Community 323 - "test_fail_watcher_warming.py"
Cohesion: 0.15
Nodes (28): _await_state(), fast_fail_watch(), _load_into_warming(), Any, FakeContainerProvider, MonkeyPatch, Path, SlotManager (+20 more)

### Community 324 - "test_exposure.py"
Cohesion: 0.10
Nodes (28): BaseRoute, app_routes(), _classify_method(), _enumerate_routes(), _iter_effective(), FastAPI, MonkeyPatch, Path (+20 more)

### Community 325 - "test_hindsight_boot_probe.py"
Cohesion: 0.07
Nodes (41): BaseTransport, HindsightUnreachable, probe_health(), _probe_timeout(), Async REST client for the shared hindsight-api (brain-redesign P1).  Talks to ``, The Hindsight daemon did not answer a health probe.      Raised by :func:`probe_, Synchronously confirm the daemon answers, or raise.      Deliberately synchronou, _build_hindsight_client() (+33 more)

### Community 326 - "SingleFlightGroup"
Cohesion: 0.08
...
### Community 327 - "run_tool_loop"
Cohesion: 0.12
Nodes (28): DispatchFn, OnEvent, assistant_message(), assistant_text(), assistant_thinking(), build_tool_message(), _coerce_args(), extract_tool_calls() (+20 more)

### Community 328 - "P3-slots: Decomposition Spec for `slots/manager.py`"
Cohesion: 0.07
...
### Community 329 - "config.py"
Cohesion: 0.13
Nodes (23): _api_port(), _behind_proxy(), _comfyui_link(), ConfigInvalidError, get_urls(), _host_without_port(), _openwebui_is_active(), Request (+15 more)

### Community 330 - "test_diagnosis.py"
Cohesion: 0.08
Nodes (25): doctor_migrations(), Surface a pending v0.1→v0.2 model-layout migration (read-only).      The canonic, exit_code_for(), Diagnosis, ``hal0 doctor``'s CLI-side ``Diagnosis`` re-export + adapters (§21.4).  The data, The stable ``--json`` shape every doctor subcommand prints.      ``json.dumps(.., The §4.2 generic ``--json`` exit-code translation: critical->2,     fail/warn->1, render_json() (+17 more)

### Community 331 - "update"
Cohesion: 0.09
Nodes (31): _dev_mode(), _fetch_slot_drift(), _interactive(), _poll_job(), _print_check(), _print_drift_banner(), Context, Path (+23 more)

### Community 332 - "tx"
Cohesion: 0.13
Nodes (16): _null_model_hw_columns(), NULL the ``n_gpu_layers``/``preferred_runner`` columns for ``model_ids``.      B, Wrap a write in an explicit ``BEGIN IMMEDIATE`` … ``COMMIT``/``ROLLBACK``., tx(), db_path(), Path, hal0.registry.gc — refcounted blob orphan prune + guarded delete (ML-3).  Covers, A blob_path outside the configured store root must never be         unlinked — a (+8 more)

### Community 333 - "repository.py"
Cohesion: 0.10
...
### Community 337 - "test_hal0_memory_client.py"
Cohesion: 0.06
Nodes (35): _client_class(), _FakeHttpClient, _FakeResponse, hal0_memory_module(), hal0-memory Hermes plugin — REST client contract.  The shipped plugin (``install, Records the last request the client issued; never hits the network., #317: ``add`` sends no ``dataset`` key; the private bank uses     ``X-hal0-Priva, ``private=False`` routes the write to the shared bank. (+27 more)

### Community 338 - "test_config_urls.py"
Cohesion: 0.10
...
### Community 339 - "FakeUpstreamRegistry"
Cohesion: 0.12
...
### Community 340 - "test_workflow_contract.py"
Cohesion: 0.15
Nodes (27): _executable_scalars(), _job(), Any, Static contracts for immutable release publication.  These tests inspect every e, The nightly trigger-shape gate must be satisfiable by nightly.yml.      Under ``, Yield every ``run`` and ``uses`` string via recursive YAML traversal., _shell_function(), _step() (+19 more)

### Community 341 - "Tier 2 — medium (one PR each)"
Cohesion: 0.07
...
### Community 342 - "PART 0 — Current registry, mapped (file:line)"
Cohesion: 0.07
...
### Community 343 - "bootstrap.sh"
Cohesion: 0.17
Nodes (20): banner(), cosign_verify(), die(), ensure_cosign(), err(), fetch_and_hash_check(), fetch_manifest(), fetch_sidecar() (+12 more)

### Community 344 - "compute_config_drift"
Cohesion: 0.09
...
### Community 345 - "doctor_all.py"
Cohesion: 0.07
Nodes (52): build_all_checks(), check_auth_posture(), check_hal0_target(), check_migrations(), check_model_store(), check_ports(), check_secret_file_modes(), doctor_all_cmd() (+44 more)

### Community 346 - "Conflict"
Cohesion: 0.10
...
### Community 347 - "get_curated"
Cohesion: 0.09
Nodes (25): get_curated(), Return the curated entry by id, or ``None`` if not in the catalogue., TDD: curated catalogue includes sdxl-lightning and esrgan-4x entries.  Task 2.5, sdxl-lightning must be in the curated catalogue., esrgan-4x must be in the curated catalogue., test_esrgan_4x_capability_image(), test_esrgan_4x_comfyui_subdir(), test_esrgan_4x_model_class_image() (+17 more)

### Community 348 - "merge_slot_config"
Cohesion: 0.11
Nodes (27): merge_slot_config(), Project ``updates`` onto a slot-config ``base`` dict, copy-safe.      THE one sh, _etc(), Path, SC-11: the one shared slot-projection merge primitive.  Both the store (:meth:`S, Even when updates DO carry a model sub-table, the base's model dict     must not, A pure disable carries NO ``[model]`` update, yet the slot's inherited     ``[mo, SC-1 parity: a disable selection clears ``[model].default`` and does     NOT rew (+19 more)

### Community 349 - "test_chat_proxy.py"
Cohesion: 0.15
Nodes (23): _authorise_client(), client(), FakeHermes, MonkeyPatch, Path, TestClient, Functional tests for the chat-proxy WS + REST surface.  A small in-process fake, Send one event frame from upstream → proxy → browser. (+15 more)

### Community 350 - "test_v1_audio.py"
Cohesion: 0.13
...
### Community 351 - "test_pressure_eviction.py"
Cohesion: 0.20
...
### Community 352 - "useDiagnoses.ts"
Cohesion: 0.08
Nodes (32): Confidence, CONFIDENCES, Diagnosis, DoctorFeed, Evidence, hardwareEvidence(), mb(), NextStep (+24 more)

### Community 353 - "Recommended hal0 ideas"
Cohesion: 0.07
...
### Community 354 - "hal0 Hermes Integration Suite Implementation Plan"
Cohesion: 0.07
...
### Community 355 - "Hal0Error"
Cohesion: 0.06
Nodes (51): activate_agent_persona(), get_agent_persona(), list_agent_personas(), _persona_detail(), _persona_summary(), PersonaUpdateBody, Any, Exception (+43 more)

### Community 356 - "services.py"
Cohesion: 0.11
Nodes (23): list_services(), mdns_apply(), mdns_status(), _mdns_url(), _probe_http_env(), _public_url(), Any, Request (+15 more)

### Community 357 - "installed.py"
Cohesion: 0.14
Nodes (25): get_installed(), _harden_registry_perms(), install(), InstalledServer, list_installed(), patch_config(), Any, Path (+17 more)

### Community 358 - "RequestSeam"
Cohesion: 0.22
...
### Community 359 - "test_discover.py"
Cohesion: 0.09
Nodes (38): find_candidates(), Walk each root and return :class:`CandidateModel`s not already registered., model_root(), Path, Tests for hal0.registry.discover — filesystem scan + auto-register., A discovered file whose name matches a curated entry's hf_file     must surface, Files already in known_paths must not appear in the candidate list., A Model with no sidecar carries mmproj=None (the registry contract     the llama (+30 more)

### Community 360 - "scan_and_register"
Cohesion: 0.11
Nodes (25): backfill_coordless(), Repair existing registry rows that have empty HF coordinates.      A row auto-re, Discover candidates under ``cfg.roots`` and register the new ones.      Returns, scan_and_register(), ModelRegistry, End-to-end: a NON-curated reranker gguf under a scan root registers with     cap, End-to-end: the registered main model resolves its mmproj path, and     no stand, An existing registry row with empty coords whose on-disk filename matches     a (+17 more)

### Community 361 - "test_config_drift_aliases.py"
Cohesion: 0.08
Nodes (35): _argv_values(), compute_config_drift(), _config_drift_values_equal(), DriftHost, Any, Config-drift comparator (P3-slots §1c).  Compares a slot's *live* container argv, Canonicalize the id-bearing drift flags the way the renderer does.      ``--mode, Compare live container argv to the command a restart would render.      Returns (+27 more)

### Community 362 - "test_agent_restart_endpoint.py"
Cohesion: 0.18
...
### Community 363 - "test_models_add_from_path.py"
Cohesion: 0.14
Nodes (26): add_path_client(), _hub_layout(), Path, TestClient, Tests for POST /api/models/add-from-path — single-file registry add.  The endpoi, A file whose extension isn't in file_extensions must 400., Re-adding the same path without overwrite=true is a 409., overwrite=true replaces the existing entry in place. (+18 more)

### Community 364 - "test_models_default.py"
Cohesion: 0.15
...
### Community 365 - "test_npu_occupancy.py"
Cohesion: 0.15
...
### Community 366 - "test_stats_requests_route.py"
Cohesion: 0.13
Nodes (21): app(), _build_app(), client(), _FakeDispatcher, _FakeMetricsService, _FakeSingleFlight, _FakeWriter, _isolated_home() (+13 more)

### Community 367 - "test_v1_slot_alias_models.py"
Cohesion: 0.12
Nodes (20): _FakeDefaults, _FakeModel, _FakeModelRegistry, _FakeSlotManager, Any, MonkeyPatch, GET /v1/models per-slot alias entries (hermes-role-slots).  Each LOADED chat slo, Every chat slot (type=="llm") with a model appears —     both warm and cold — be (+12 more)

### Community 368 - "test_bootstrap_contract.py"
Cohesion: 0.10
Nodes (28): _dispatch_via_npu_trio(), _extract_multipart_model(), _forward_multipart(), _instrument_streaming_throughput(), _is_npu_trio_request(), Any, StreamingResponse, Detect whether this request should go through the FLM trio router.      PR-19. W (+20 more)

### Community 369 - "RealShapeClient"
Cohesion: 0.13
Nodes (21): _NotFound, _provider(), Issue #1456: one id contract across list, recall and delete.  ``MemoryProvider``, The two read surfaces disagreeing is the defect; assert they can't., Back-compat: an engine (or fixture) that only returns ``id`` must keep     worki, The headline repro: ``{deleted: 0}`` before the fix, in both modes., ``_deletable_ids`` matched on the fact-id field, so even a caller who     alread, Callers holding a pre-fix fact id (or one read from     ``metadata.fact_id``) re (+13 more)

### Community 370 - "test_router_loop.py"
Cohesion: 0.19
...
### Community 371 - "test_event_contract.py"
Cohesion: 0.15
...
### Community 372 - "test_migrate_haloai.py"
Cohesion: 0.15
...
### Community 373 - "agents.mdx"
Cohesion: 0.08
Nodes (20): Agent memory, Hermes, the bundled agent, Personas: the agent's character and limits, Spending budgets, The approval queue: a human in the loop, The hal0-brain steward: driving the platform from chat, Where to go next, Why it runs on a 1B model (+12 more)

### Community 374 - "cli.mdx"
Cohesion: 0.08
Nodes (25): `hal0 agent approvals`, `hal0 agent bootstrap`, `hal0 agent` — bundled agents, `hal0 agent personas`, `hal0 app` — optional apps, `hal0 auth` — API authentication, `hal0 bench` — model + hardware benchmarking, `hal0 board` — operator board (+17 more)

### Community 375 - "ML-4 (runner-image registry) + ML-5 (flag resolution) — implementation-ready spec"
Cohesion: 0.08
...
### Community 376 - "R5 — Surface + launch"
Cohesion: 0.08
...
### Community 378 - "moonshine_server.py"
Cohesion: 0.10
Nodes (22): _decode_audio(), _detect_local_format(), _load_model(), main(), JSONResponse, ndarray, Path, WebSocket (+14 more)

### Community 379 - "_client"
Cohesion: 0.21
Nodes (24): RequestError, hal0 could not complete the request., Unavailable, _client(), MonkeyPatch, Request, Response, Behavioral contract for the shared hal0 Hermes transport. (+16 more)

### Community 380 - "BootReport"
Cohesion: 0.13
Nodes (13): BootPhaseRecord, BootReport, One boot phase's outcome — surfaced via ``app.state.boot_report``., Structured, additive record of what each boot phase did.      Attached to ``app., Run one boot phase, recording its outcome + timing on ``report``.      Re-raises, _run_boot_phase(), MemoryDispatcher, Any (+5 more)

### Community 381 - "put_dashboard_layout"
Cohesion: 0.11
Nodes (20): DashLayout, DashLayoutV3, get_dashboard_layout(), _get_slot_names(), _is_valid_layout_key(), LayoutInvalidError, put_dashboard_layout(), Any (+12 more)

### Community 382 - "_probe_power"
Cohesion: 0.15
...
### Community 383 - "test_secrets_protected_keys.py"
Cohesion: 0.12
Nodes (24): is_protected_secret(), True when ``name`` is hal0's own config/auth surface, not an operator     secret, _api_env(), Path, TestClient, Issue #1450: the Secrets page is not a generic editor for ``api.env``.  ``/etc/h, The headline defect: one unconfirmed click returned 204 and removed     the line, Overwriting ``HAL0_ADMIN_KEY`` with an attacker-chosen value is a     worse outc (+16 more)

### Community 384 - "test_slot_config_validation.py"
Cohesion: 0.17
Nodes (24): Pick a free port in the configured slot range.          Delegates to the shared, Path, TestClient, Boundary validation on slot-config writes (PUT config / PATCH defaults / POST cr, ``""`` persists an empty override — the reason #1372 clears with null., default_voice (voice settings) and string image override keep working., The auto-allocation pool deliberately ends at 8099 (#1036).      The pool defaul, [server].env (schema-derived, not hardcoded) + extra_args pass. (+16 more)

### Community 385 - "test_doctor_profiles.py"
Cohesion: 0.10
...
### Community 386 - "test_doctor.py"
Cohesion: 0.07
Nodes (73): ExceptionInfo, Exit, doctor(), _locate_preflight(), Context, Re-run pre-flight checks (systemd, python, docker, disk, ports).      ``hal0 doc, Verify each pinned toolbox image is anonymously pullable from ghcr.io.      Walk, Find ``installer/lib/preflight.sh`` for the current install.      Returns ``None (+65 more)

### Community 387 - "test_emit_answers.py"
Cohesion: 0.14
...
### Community 388 - "perms.py"
Cohesion: 0.12
Nodes (22): _apply_one(), audit_rows(), _child_mode_for(), commit(), _expand_row(), _group_name(), observe(), _owner_name() (+14 more)

### Community 389 - "HindsightRestClient"
Cohesion: 0.11
Nodes (11): HindsightRestClient, Any, AsyncClient, The resolved daemon root — read-only; callers must not retarget         a live c, Generic authenticated forward to any Hindsight REST path.          The admin sur, HindsightRestClient REST-path tests against a MockTransport (P1)., A deterministic ``<agent>:<session_id>`` document id (colon) must be     percent, test_delete_document_percent_encodes_id_in_path() (+3 more)

### Community 390 - "evaluate_model_fit"
Cohesion: 0.13
...
### Community 392 - "test_hermes_executor.py"
Cohesion: 0.18
...
### Community 393 - "test_agent_approvals_list.py"
Cohesion: 0.09
...
### Community 394 - "test_slot_create_flags.py"
Cohesion: 0.11
...
### Community 396 - "test_env_writer.py"
Cohesion: 0.13
...
### Community 399 - "test_id_keying.py"
Cohesion: 0.20
...
### Community 401 - "test_prewire_smoke.py"
Cohesion: 0.10
...
### Community 402 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 403 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 404 - "hal0 benchmarking system — full design (batch runs, rich run detail, display, auto-update)"
Cohesion: 0.08
...
### Community 406 - "read_gguf_header"
Cohesion: 0.18
...
### Community 407 - "migrate-haloai.py"
Cohesion: 0.16
Nodes (24): AllowEntry, build_model(), _build_parser(), _ensure_empty_or_force(), _hub_dirname(), load_allowlist(), main(), migrate() (+16 more)

### Community 408 - "control.py"
Cohesion: 0.17
Nodes (21): dequeue(), enqueue(), _path(), pop_next(), Any, control.py — web-driven run queue + worker control state.  The dashboard lets an, Return (and remove) the head of the queue, or None if empty., True iff the worker may drive a session right now (Start pressed). (+13 more)

### Community 409 - "TestHal0Config"
Cohesion: 0.10
Nodes (11): DispatcherConfig, MetaConfig, [meta] section in hal0.toml.  Tracks config schema version for migrations., [slots] section in hal0.toml.  Global slot policy.      ``extra="forbid"`` (P3-s, Reject shapes that would break the rendered ``--publish`` token.          The va, Allow only the modes the renderer actually couples a fence to.          ``""`` (, [dispatcher] section in hal0.toml.      ``extra="forbid"`` (P3-schema Part C): a, [telemetry] section in hal0.toml.      ``extra="forbid"`` (P3-schema Part C): a (+3 more)

### Community 410 - "probes.py"
Cohesion: 0.20
...
### Community 413 - "unknown_slot_config_keys"
Cohesion: 0.11
Nodes (26): _arbiter_unavailable(), comfyui_invalid_workflow_launch(), comfyui_logs(), comfyui_models_fetch(), comfyui_pin(), comfyui_restart(), comfyui_switchover(), comfyui_workflow_launch() (+18 more)

### Community 414 - "GpuImageMode"
Cohesion: 0.18
...
### Community 415 - "migrate_slot_id_keying"
Cohesion: 0.15
Nodes (20): One-shot: flip every name-keyed slot artefact to id-keyed (P3-runtime-db §11.1 M, slot_migrate_id_keying(), migrate_slot_id_keying(), _migrate_state(), MigrationReport, Any, Collection, Path (+12 more)

### Community 416 - "parse_text_tool_calls"
Cohesion: 0.13
Nodes (24): parse_text_tool_calls(), Best-effort extraction of text-embedded tool calls.      Dialects recognised: ``, #1419 — attribute-style XML tool calls (the hal0-brain dialect).  ``hal0-brain-s, Verbatim from #1419's live capture against slot ``brain`` on :8087.      ``finis, The mangled shape has no tag anchor at all, so the known-names gate is     the O, Regression guard: the pre-existing ``<function=NAME>{json}</function>``     dial, ``<|tool_call>call:NAME{...}<tool_call|>`` — pipes INSIDE both     delimiters, s, The template specifies CDATA for multi-line / ``<``-containing values. (+16 more)

### Community 417 - "test_dashboard_layout.py"
Cohesion: 0.11
...
### Community 418 - "test_logs_routes.py"
Cohesion: 0.11
...
### Community 419 - "_seed_slot_toml"
Cohesion: 0.08
Nodes (25): npu_trio_slot_root(), coresident_group must key off device==npu, not the legacy slot names.      Deplo, Lay down the NPU FLM trio (agent + stt-npu + embed-npu) on disk., A model-less NPU LLM anchor → no trio markers on the siblings (#1369).      This, #1369: membership follows the anchor, with no per-sibling opt-out.      The shad, spec-hw-slot-ownership §1: a stray slot-level ``enable_thinking`` (pre-     migr, Slot with no [server] table → payload's llamacpp_args is null.      Mirror the e, rope_freq_base absent on disk → payload carries null (not 0.0). (+17 more)

### Community 420 - "test_v1_models_filters.py"
Cohesion: 0.20
...
### Community 421 - "test_brain_read_only.py"
Cohesion: 0.08
Nodes (26): BrainChatConfig, ``[brain_chat]`` — the dashboard's agent-chat steward (hal0-brain).      Guardra, No ApprovalQueue wired -> a gated admin call returns a typed error and     NOTHI, test_gated_call_fails_closed_without_queue(), _fake_request(), Any, Path, Read-only-default posture for the hal0-brain steward chat (KB-2/3 §4).  The ``[b (+18 more)

### Community 422 - "test_brain_unrouteable_model.py"
Cohesion: 0.19
Nodes (22): _client_class(), _collect_frames(), _ExplodingClient, _parse(), Any, Exception, MonkeyPatch, Response (+14 more)

### Community 423 - "test_upstream_commands.py"
Cohesion: 0.15
...
### Community 424 - "test_seeds_data.py"
Cohesion: 0.08
...
### Community 425 - "test_memory_delete_auth.py"
Cohesion: 0.11
Nodes (23): armed_client(), memory_routes(), MonkeyPatch, TempPathFactory, TestClient, Issues #1024 / #1302 (1): the memory delete surface is ADMIN, provably.  #1024's, The threat the pinning exists for, simulated.      #1024's follow-up comment pro, A real ``create_app()`` with ``AuthEnforcementMiddleware`` enforcing.      Not a (+15 more)

### Community 426 - "test_logs_keepalive.py"
Cohesion: 0.12
Nodes (21): _drain(), _FakeProc, MonkeyPatch, Keepalive plumbing for the per-slot journal tail (#1472).  ``tail_journal`` yiel, journalctl exiting ends the stream rather than ticking forever., Closing the consumer (client disconnect) must not leak the pump task., journalctl succeeded and printed nothing → say why, don't return a bare     empt, The hint is strictly for the empty case — real output stays hint-free. (+13 more)

### Community 427 - "Changelog"
Cohesion: 0.08
Nodes (23): [0.9.4.1] — 2026-07-08, [0.9.4] — 2026-07-08, [0.9.5.2] — 2026-07-09, Added, Added, Added, Changed, Changed (+15 more)

### Community 428 - "hal0 installer"
Cohesion: 0.08
...
### Community 430 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.08
...
### Community 431 - "hal0 1.0 — Seeded profile rework"
Cohesion: 0.08
...
### Community 432 - "Hermes Python 3.12 Cross-Distro Installation Design"
Cohesion: 0.08
...
### Community 434 - "Hal0MemoryClient"
Cohesion: 0.13
Nodes (11): Hal0MemoryClient, Any, Thin synchronous REST client for the hal0-memory REST surface.  Design notes: (1, POST /api/memory/add. ``private=True`` → hermes-private, else shared., POST /api/memory/search — semantic retrieval (union of both banks)., POST /api/memory/recall — token-budgeted consolidated recall (union)., GET /api/memory/list — page through stored items., POST /api/memory/delete — remove memory items by id. (+3 more)

### Community 435 - "test_slots_routes.py"
Cohesion: 0.13
Nodes (23): SSE stream of state transitions for ``name`` (and only ``name``).      The SlotM, slot_state_stream(), isolated_app(), isolated_client(), FastAPI, Tests for the /api/slots route surface (container runtime).  Covers:   - list-me, The synthetic composite ``hal0`` slot must derive ``status`` from     the live l, Counterpart to the offline case: when a dispatchable slot holds the     catalogu (+15 more)

### Community 436 - "MonkeyPatch"
Cohesion: 0.16
Nodes (14): One ``[stack.<slug>]`` entry in stacks.toml.      A curated bundle of slots + em, StackConfig, Pre-apply sanity check: flag entries whose profile/model won't resolve., TestStackConfig, _engine(), PS-5: StackApplyEngine.validate flags unresolved profile/model refs.  A stack ca, A slot entry carrying no profile/model ref can't diverge — no warning., test_validate_clean_when_all_refs_resolve() (+6 more)

### Community 437 - "test_hw_slot_ownership_migration.py"
Cohesion: 0.22
...
### Community 438 - "resolved_command_for_slot"
Cohesion: 0.15
Nodes (20): _Recorder, TestClient, Issue #1457: the #1024 incident class, one route over.  #1024 was ``DELETE /api/, A preview is a convenience, never a gate., ``delete_bank`` reads the echo from the query string or the body;     the siblin, Upstream filter params still ride; ``confirm`` is hal0's own gate and     must n, The audit row survived the rewrite (it was the one guard this route     already, The claim the constant makes, checked against the live app: naming a     route h (+12 more)

### Community 439 - "seed_static_slots"
Cohesion: 0.17
...
### Community 440 - "_container_cgroup_mem_bytes"
Cohesion: 0.13
...
### Community 441 - "test_run_as_hal0_guard.py"
Cohesion: 0.13
...
### Community 442 - "_FakeClient"
Cohesion: 0.15
Nodes (19): _FakeClient, _provider(), Any, MonkeyPatch, #1420 — the retain pipeline needs its own health signal.  ``HindsightProvider.de, Every retain returns 200 + operation_id; extraction fails behind it., A historic backlog on an otherwise healthy box must stay green — the     counter, /api/status is polled every few seconds — the probe must not be. (+11 more)

### Community 443 - "test_npu_columns.py"
Cohesion: 0.15
...
### Community 444 - "test_cli_docs_parity.py"
Cohesion: 0.12
Nodes (22): Command, _bench_verbs(), _documented(), Typer, Guard: docs/reference/cli.mdx must document every real CLI command.  Issue #501, Parity walk over the argparse-based ``hal0 bench`` surface (GH #1474).      ``_w, Keep ``ALLOWED_MISSING`` honest: every entry must still exist.      If a depreca, Split a markdown table row into cells, treating ``\\|`` as a literal pipe. (+14 more)

### Community 445 - "Enum"
Cohesion: 0.11
Nodes (24): Enum, auth_require(), auth_rotate(), auth_status(), KeyTier, hal0 auth subcommands — thin HTTP client to /api/auth/*.  §5.2 of the R5 sync as, Persist the [security].require_auth posture (PUT /api/auth/require)., Show the current auth posture (GET /api/auth/status). (+16 more)

### Community 446 - "journal.py"
Cohesion: 0.15
Nodes (25): LevelFilter, _bus(), _collect(), get_journal(), _hal0_event_to_entry(), JournalEntry, _passes_filters(), Any (+17 more)

### Community 447 - "README.md"
Cohesion: 0.09
Nodes (21): Auth posture, Backends, Bundled agents, Contributing, Exploring (v1.x +), Hardware, License, Open-source home AI inference platform (+13 more)

### Community 448 - "_phase_config_write"
Cohesion: 0.08
Nodes (36): _build_brain_profile_mcp_servers(), _deep_merge(), _live_resolve_enabled(), _merge_config_yaml_layers(), _phase_brain_profile_mcp_wire(), _phase_brain_profile_seed(), _phase_config_write(), _phase_env_probe() (+28 more)

### Community 449 - "_auth.py"
Cohesion: 0.12
...
### Community 450 - "hal0_slot_alias_models"
Cohesion: 0.38
...
### Community 451 - "redact_log_line"
Cohesion: 0.19
Nodes (15): journalctl_sse(), list_logs(), LogsError, Any, StreamingResponse, Log endpoints (mounted under /api/logs).  Tail and stream journald entries for h, Map a level alias to a journalctl --priority value., Async generator that yields SSE frames tailing ``journalctl -f -u <unit>``. (+7 more)

### Community 452 - "map_backend_to_device"
Cohesion: 0.13
...
### Community 453 - "Check"
Cohesion: 0.18
Nodes (20): get_provider(), hal0.providers — Inference backend abstraction layer.  Each Provider is a statel, Return the singleton Provider for ``name``.      Raises:         KeyError: If no, MonkeyPatch, TestClient, Wiring tests for ``POST /v1/images/generations`` + the image cache.  The provide, Regression test for #725: ensure_img() must run BEFORE dispatcher.dispatch()., Register a fake `img` slot upstream so the dispatcher resolves to it. (+12 more)

### Community 454 - ".__init__"
Cohesion: 0.18
...
### Community 455 - "apply_thinking_policy"
Cohesion: 0.15
...
### Community 457 - "read_stack_state"
Cohesion: 0.15
...
### Community 458 - "embed_references"
Cohesion: 0.18
...
### Community 459 - "test_agent_memory_stats_endpoint.py"
Cohesion: 0.16
...
### Community 460 - "test_backends_npu_canonical_fields.py"
Cohesion: 0.13
...
### Community 462 - "test_memory_subgraph.py"
Cohesion: 0.18
Nodes (16): _build_app(), client(), _HindsightStubProvider, The preview degrades gracefully when the stats probe fails — still 400., Duck-typed provider exposing the hindsight client like HindsightProvider., test_unconfirmed_bank_delete_preview_failsoft_when_stats_unreachable(), _client_for(), Any (+8 more)

### Community 463 - "test_secrets.py"
Cohesion: 0.15
...
### Community 464 - "test_settings_models_store.py"
Cohesion: 0.17
...
### Community 465 - "Path"
Cohesion: 0.09
Nodes (23): Path, #585: the dashboard writes ``ctx_size``; it must persist as the canonical     ``, When the NPU LLM anchor has a model bound, every trio slot gets coresident_group, GET /api/slots/{name} is enriched same shape as the list endpoint., Labels list is omitted (not empty) when the slot config has no     ``model.label, The enriched body must be valid JSON (no exotic types leaked)., An explicit upstreams.toml entry for ``hal0`` survives startup unchanged.      O, Loading a slot with no TOML returns the typed slot.not_found envelope. (+15 more)

### Community 466 - "test_probes.py"
Cohesion: 0.15
...
### Community 467 - "test_unified_project_scope.py"
Cohesion: 0.17
Nodes (22): _legacy(), #1300 — ``project:<id>`` isolation must survive the unified-bank collapse.  Unde, Mirrors legacy bank isolation: shared is not a superset of projects., A private doc in a project is still private to its owner — the two     filters c, Delete enforces the same scope the read paths do (fail-closed)., Legacy mode isolates by bank; the tag is a unified-mode compensator     and must, The headline bug: project:foo write → project:bar recall returned it., test_caller_supplied_project_tag_is_not_duplicated() (+14 more)

### Community 468 - "Dashboard Overhaul — FROZEN DATA CONTRACT (v1)"
Cohesion: 0.09
Nodes (22): 0. Hard rules, 1. Read endpoints that ALREADY EXIST (FE: wrap in hooks, do not ask BE to build), 2. NEW backend endpoints the Backend team MUST build, 2a. Throughput history (feeds default "Combined throughput" card), 2b. CPU utilization (feeds default "Utilization" card), 2c. Dashboard layout persistence (feeds the whole grid), 2d. Service health (feeds default "Services" card) — pending §5 spike, 3. Status-dot state contract (THE core fix — applies everywhere a dot renders) (+14 more)

### Community 469 - "useActivity.ts"
Cohesion: 0.14
...
### Community 470 - "services.jsx"
Cohesion: 0.15
Nodes (18): _gpu_slot(), _make_slot(), _noncontainer_npu_cfg(), Any, MonkeyPatch, npu_swap_status: container slot lifecycle state drives the swap signal.  ``fetch, Legacy/unmigrated NPU record → no live container to observe.      The snapshot i, Non-NPU peer slots don't affect the swap signal. (+10 more)

### Community 471 - "CliRunner"
Cohesion: 0.16
...
### Community 472 - "UI drawers — slot/model/profile editors"
Cohesion: 0.09
...
### Community 473 - "hal0 Settings Menu — Wireframe / IA"
Cohesion: 0.09
...
### Community 475 - "test_hermes_upgrade.py"
Cohesion: 0.20
...
### Community 476 - "_client_ip"
Cohesion: 0.16
Nodes (20): _config_trust_forwarded_for(), Should caller-IP attribution (the login/rotate rate limiter) read     ``X-Forwar, Return the persisted ``[security].trust_forwarded_for`` value, or     ``None`` i, trust_forwarded_for_enabled(), _client_ip(), Best-effort caller IP for the login rate-limit key.      Falls back to a constan, _isolate_config(), MonkeyPatch (+12 more)

### Community 477 - "test_tts_request_defaults.py"
Cohesion: 0.15
...
### Community 478 - "memory_bank_commands.py"
Cohesion: 0.13
Nodes (26): bank_consolidate_cmd(), bank_delete_cmd(), bank_export_cmd(), bank_import_cmd(), bank_list_cmd(), bank_stats_cmd(), _emit(), profile_get_cmd() (+18 more)

### Community 479 - "apply_preferred_profile"
Cohesion: 0.16
...
### Community 481 - "gc.py"
Cohesion: 0.14
Nodes (16): fetch_npu_swap_status(), _npu_llm_anchor(), NpuSwapStatus, Any, NPU trio chat-model swap-in-progress detection.  When the operator picks a new N, Snapshot of the NPU trio swap state.      Attributes:         in_progress: True, Return the (at most one) model-bound NPU LLM slot config, or None.      The NPU-, Return the swap snapshot from the npu container slot's state.      Transitional (+8 more)

### Community 482 - "config_enrichment"
Cohesion: 0.21
Nodes (7): config_enrichment(), Per-slot TOML-derived fields for slot snapshots. Pure.      Lifts the edit-drawe, _llm_cfg(), No NPU LLM anchor with a model bound → no trio (#1369)., The seeded model-less ``flm`` anchor doesn't make a trio real., #1369: the shadow's ON/OFF pill reads the ANCHOR's [npu] table.          The sha, TestConfigEnrichment

### Community 483 - "_reconcile_device_profile"
Cohesion: 0.20
...
### Community 484 - "test_hermes_env_seam.py"
Cohesion: 0.15
...
### Community 486 - "Path"
Cohesion: 0.09
Nodes (22): crud_models_root(), Path, The mirror image: nulling the projector on a row that still advertises     visio, A save that touches neither field must not re-litigate the invariant —     other, A directory is not a projector sidecar — same envelope., A JSON value whose double quotes the shell would strip is rejected with     the, POST create rejects a grid-owned hardware flag (--threads) in     defaults.extra, The optional ``profile`` materializes that profile's flags into the new     row' (+14 more)

### Community 487 - "TestClient"
Cohesion: 0.09
Nodes (22): TestClient, The dry-run screen carries the same envelope so the drawer renders one     error, Dropping BOTH halves is the sanctioned way off a vision row — no     existence c, The correctly single-quoted JSON value survives shlex-splitting and is     accep, /validate is a dry run: it screens with the same envelope as create/PUT     and, A real device-agnostic tune (batch/flash-attn/KV-quant) with no hardware     fla, The drawer's dry-run screen surfaces the range violation inline instead     of r, Opt-out from cascade surfaces a 409 + the slot list for UI confirm. (+14 more)

### Community 488 - "test_providers.py"
Cohesion: 0.14
...
### Community 489 - "test_services_page.py"
Cohesion: 0.14
...
### Community 490 - "test_v1_proxy.py"
Cohesion: 0.14
...
### Community 491 - "test_virtual_models.py"
Cohesion: 0.17
...
### Community 492 - "test_brain_framing.py"
Cohesion: 0.23
...
### Community 493 - "test_trio_status_inheritance.py"
Cohesion: 0.18
...
### Community 494 - "test_tts_capability_switch.py"
Cohesion: 0.12
Nodes (19): Any, voice.tts capability switch — Kokoro (CPU) vs Qwen3-TTS (GPU/ROCm).  The deferre, Write the canonical single ``tts`` slot in a known engine state., Picking qwen3 / gpu-rocm rewrites the ``tts`` slot's profile to qwen3-tts., Picking kokoro / cpu reverts the ``tts`` slot to the Kokoro profile.      Starti, A disabled selection clears the model but never rewrites the engine.      Post-S, Regression: a non-tts child's slot reconciliation never injects a profile., _read_tts_slot() (+11 more)

### Community 495 - "test_doctor_verify.py"
Cohesion: 0.12
...
### Community 496 - "Path"
Cohesion: 0.11
Nodes (17): Tests for hal0.api._redact — shared config-echo redaction (#553).  Every config-, Acceptance criterion #1: a known token-bearing key comes back masked,     with `, A non-sensitive key (e.g. ``ctx_size``) is echoed verbatim., An empty sensitive value is masked with ``set=false`` so the UI can     render t, The input dict is not mutated — redaction is a pure projection., A sensitive *container* key over-redacts its whole value (by design).      ``re., A list of scalars is not masked — only keyed containers are scrubbed., An empty string is treated as 'unset' so the UI can render a blank slot. (+9 more)

### Community 497 - "test_bootstrap_cosign_fetch.py"
Cohesion: 0.21
Nodes (18): _cosign_env(), _pinned(), CompletedProcess, Path, Bootstrap self-acquires a digest-pinned cosign when the host has none.  ``instal, Hermetic PATH that records every curl URL and every cosign invocation.      ``fa, _run_bootstrap(), test_arch_detection_requests_the_matching_release_asset() (+10 more)
...
### Community 501 - "_store"
Cohesion: 0.24
Nodes (21): Path, SlotIdentityStore (rework §11.1) — opaque id ⇄ name bridge.  Pins the core §11.1, The load-bearing §11.1 guarantee: rename changes only the label., _store(), test_coresident_group_set(), test_create_assigns_opaque_id_and_roundtrips(), test_create_rejects_enabled_kwarg(), test_duplicate_name_rejected_on_create() (+13 more)

### Community 502 - "test_seam_agent_units.py"
Cohesion: 0.10
Nodes (17): Agent-unit verbs on the hal0-systemctl privilege seam (#453 follow-up).  ``Herme, Root needs no seam — and the installer/uninstaller runs at moments when     the, The two validators are copies; keep them provably in sync.      A drift here is, Read-only verbs need no authorization and several probes legitimately     use th, A malformed agent id never becomes a unit name., ...and never becomes an argv either — validation happens before routing,     so, Only stop/disable exist. A typo is a caller bug, caught before exec., THE regression. Off root the argv must be the ``sudo -n`` seam call —     never (+9 more)

### Community 503 - "memory-graph-engine.jsx"
Cohesion: 0.12
Nodes (12): degreeByType(), fmtMemDate(), Hovercard(), MEM_FACT_COLORS, MEM_LINK_COLORS, MEM_LINK_LABEL, MG_PALETTE, neighborsOf() (+4 more)

### Community 504 - "PART 2 — FIRST-CLASS DESIGN"
Cohesion: 0.10
...
### Community 505 - "P2-config: Collapse capabilities.toml double-bookkeeping"
Cohesion: 0.10
...
### Community 506 - "__init__.py"
Cohesion: 0.20
Nodes (13): _coerce_float(), _coerce_int(), _load_template(), _parse_size(), Any, OpenAI ``/v1/images/generations`` → ComfyUI prompt-graph translator.  ComfyUI ex, Parse OpenAI-style ``"1024x1024"`` → ``(1024, 1024)``.      Tolerates capital ``, # NOTE: Flux model classes (e.g. flux-klein) want their own template (+5 more)

### Community 507 - "set-version.py"
Cohesion: 0.17
...
### Community 508 - "health.py"
Cohesion: 0.13
Nodes (21): _disk_free_mb(), get_status(), health(), health_system(), list_features(), _memory_degraded(), _memory_write_health(), metrics_prometheus() (+13 more)

### Community 509 - "npu_occupancy"
Cohesion: 0.14
...
### Community 510 - "slots_config_dir"
Cohesion: 0.25
...
### Community 513 - "test_fetch_ws_g.py"
Cohesion: 0.14
...
### Community 515 - "huggingface.py"
Cohesion: 0.14
Nodes (20): _extract_readme_excerpt(), fetch_repo(), _format_size(), _hf_headers(), HFUpstreamError, _looks_like_flm_repo(), normalise_repo_slug(), _normalise_search_row() (+12 more)

### Community 516 - "test_memory_admin_document_transfer.py"
Cohesion: 0.19
Nodes (18): _build_app(), client(), _HindsightStubProvider, Any, FastAPI, Request, Response, TestClient (+10 more)

### Community 517 - "test_pull_shutdown.py"
Cohesion: 0.17
...
### Community 518 - "test_throughput_history.py"
Cohesion: 0.19
...
### Community 519 - "test_eligibility.py"
Cohesion: 0.10
...
### Community 520 - "test_model_less_capability_slot_is_not_woken"
Cohesion: 0.20
...
### Community 521 - "Security review — v1.0 auth surface (2026-05-21)"
Cohesion: 0.10
...
### Community 522 - "_write_fake_python"
Cohesion: 0.20
...
### Community 523 - "test_seam_verification.py"
Cohesion: 0.17
Nodes (15): _call(), CompletedProcess, Path, #1465 — install.sh must fail loud when a privileged seam does not install.  Befo, Preflight runs BEFORE the seams exist; asserting them there would always fail., Source preflight.sh (+ its ui.sh deps) and invoke one function., sudo silently ignores a drop-in that is not 0440 root — a total failure., A grant written for `hal0` cannot be exercised from another account. (+7 more)

### Community 524 - "_CtxToken"
Cohesion: 0.12
Nodes (15): _CtxToken, _make_request(), Any, Request, Regression test for issue #413 — MCP ``--private`` namespace promotion.  The bug, ``private_resolver`` honours X-hal0-Private off the live request.      Fails on, A Bearer token on the live request yields the raw bearer (for auth)     plus a H, End-to-end: the dispatcher wired with the production resolvers honors     ``X-ha (+7 more)

### Community 525 - "test_manager_npu_container.py"
Cohesion: 0.20
...
### Community 526 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.10
...
### Community 535 - "MemoryGraphConfig"
Cohesion: 0.13
...
### Community 537 - "network.py"
Cohesion: 0.15
Nodes (19): _coerce_port(), _dedupe(), derive_allowed_origins(), detect_lan_ips(), _is_lan_ipv4(), main(), network_env(), _origin_of() (+11 more)

### Community 538 - "test_model_meta.py"
Cohesion: 0.06
Nodes (30): capability_from_filename(), classify(), DeviceMeta, labels_of(), model_capabilities_of(), Any, model_meta — the one home for model classification + device→backend resolution., Return the primary modality bucket for a model.      Reads the model's ``capabil (+22 more)

### Community 539 - "Modality"
Cohesion: 0.10
...
### Community 540 - "TestSlotHardwareSegment"
Cohesion: 0.14
Nodes (11): _llama_argv_segments(), Build the ordered, labelled llama-server argv segments (SINGLE SOURCE).      Bot, _FakeProfile, Golden path #5 (pull→assign→infer) — launch-time profile-read invariant.  spec-f, FLAGS-own: even handed the (now-inert) profile/slot flag params, the argv     bu, spec §8: assert the profile flag resolver is NOT called on the launch     path —, Minimal stand-in for a resolved profile (image/device axis only)., test_launch_builder_emits_no_profile_or_slot_flag_segment() (+3 more)

### Community 541 - "classify_layout"
Cohesion: 0.16
...
### Community 543 - "test_journal_routes.py"
Cohesion: 0.13
...
### Community 544 - "_source_config"
Cohesion: 0.14
Nodes (14): _cpu_roots(), Source config.sh with the given roots and run ``body`` after it., ``BACKENDS`` must carry a ``cpu`` lane in the same 5-field shape., The gap this change closes: no ``cpu`` key = no CPU tier at all., A ``-dev`` pin on the CPU lane would name a device that is not         passed th, Regression guard for moving ``-ngl`` out of ``COMMON_BENCH_ARGS``., llama-bench APPENDS repeated ``-ngl`` values into a sweep         dimension rath, The default sweep set follows the tier the resolver reports. (+6 more)

### Community 545 - "test_capabilities_commands.py"
Cohesion: 0.18
Nodes (16): _illegal_selection(), _NullLock, CapabilitySelection, MonkeyPatch, Tests for ``hal0 capabilities`` — list/set (live API) + migrate (footgun fix)., Stub load/save so migrate never touches a real capabilities.toml., The old ``--dry-run`` flag is hidden but harmless — still previews., stub_config() (+8 more)

### Community 546 - "test_memory_bank_commands.py"
Cohesion: 0.10
Nodes (3): MonkeyPatch, Tests for ``hal0 memory bank {list,stats,profile,export,import,delete,consolidat, stub_api()

### Community 547 - "test_model_first_run_commands.py"
Cohesion: 0.17
...
### Community 548 - "test_model_store_root.py"
Cohesion: 0.14
...
### Community 549 - "conftest.py"
Cohesion: 0.13
Nodes (19): app(), _auth_dev_open_by_default(), client(), _no_real_systemctl(), _no_static_slot_seed(), FastAPI, MonkeyPatch, TempPathFactory (+11 more)

### Community 550 - "TestEarlyHal0User"
Cohesion: 0.10
...
### Community 552 - "test_fail_watcher.py"
Cohesion: 0.18
...
### Community 553 - "0. Research-grounded findings that drive the matrix"
Cohesion: 0.11
...
### Community 555 - "exposure.py"
Cohesion: 0.13
Nodes (17): Matcher, classify(), _exact(), match_rule(), _outside_api_v1_mcp(), _prefix(), Route -> :class:`AuthClass` classification table (KB-1 / §1, seam S9).  Single s, Return the first :class:`_Rule` matching ``(method, path)``, or ``None``.      ` (+9 more)

### Community 556 - "hal0.sh"
Cohesion: 0.26
Nodes (15): create_lxc(), die(), header(), install_inside_lxc(), locate_template(), main(), msg_error(), msg_info() (+7 more)

### Community 557 - "agents.py"
Cohesion: 0.24
...
### Community 559 - "test_board_dispatch.py"
Cohesion: 0.22
Nodes (17): NoopExecutor, Register the executor that services ``target`` (idempotent overwrite)., Reference no-op executor: accepts a dispatch but does no external work.      Not, register_executor(), Path, Board executor dispatch seam (KB-5) — interface, registry, no-op default.  Run t, The writeback appends runs/events only — the card's lane is unchanged by     a d, _store() (+9 more)

### Community 560 - "chat_commands.py"
Cohesion: 0.16
Nodes (16): _iter_brain_sse_events(), _iter_stream_events(), _post_completions(), Any, ``hal0 chat`` — terminal REPL over the local ``/v1/chat/completions`` (§21.14)., Split reasoning out of a completed reply; fold only the stripped         visible, One non-streaming ``POST /v1/chat/completions`` call → parsed JSON., Consume one OpenAI-style SSE chat-completion stream.      Mirrors the ``data: .. (+8 more)

### Community 561 - "build_admin_route_map"
Cohesion: 0.11
Nodes (18): _apply_route_map(), build_admin_route_map(), install_admin_route_map(), _is_spa_catchall(), _is_transport_excluded(), _iter_leaf_routes(), _normalize_path(), Strip Starlette path-converter suffixes (``{id:path}`` -> ``{id}``).      route_ (+10 more)

### Community 562 - "_register"
Cohesion: 0.25
...
### Community 563 - "test_port_registry.py"
Cohesion: 0.23
...
### Community 565 - "test_settings_routes.py"
Cohesion: 0.15
...
### Community 566 - "Any"
Cohesion: 0.11
Nodes (19): container_stub(), Any, A slot's [model].n_gpu_layers rides along in the payload., v0.1.x clients consuming /api/slots see every legacy key unchanged., PR-18: each entry carries ``type`` + ``model_default``.      The dashboard's per, A slot with no ``device`` in TOML carries no declared_backend key., POST /api/slots/chat/load goes through ContainerProvider.load_sync., PUT /config has no lifecycle side effect — a running slot stays running.      Th (+11 more)

### Community 567 - "_lxc_dri"
Cohesion: 0.14
Nodes (15): BenchDeviceError, _override_group_ids(), A benchmark device setting could not be resolved into a usable node., Resolve the GPU passthrough for a benchmark container.      See the module docst, resolve_bench_devices(), _lxc_dri(), Path, Subdirectories and regular files under /dev/dri are never passed. (+7 more)

### Community 568 - "_stub_bin"
Cohesion: 0.23
Nodes (13): _dry_run_argv(), _env(), _model(), Path, The podman argv the harness printed for ``backend`` in ``--dry-run``.      ``--d, The acceptance criterion: a CPU-tier cell asks podman for no         ``--device`, One ``-ngl`` word, and its value is 0 — a second occurrence would         become, ``--backends cpu`` measures the CPU baseline on hardware that also         has a (+5 more)

### Community 569 - "FakeSlotManager"
Cohesion: 0.18
...
### Community 570 - "test_hal0_update_wrapper.py"
Cohesion: 0.20
Nodes (17): installed(), Path, #1464 — argv contract of ``installer/wrappers/hal0-update``.  The sudoers grant, A non-default HAL0_PREFIX install must work — no hardcoded /usr/lib., The shell copy is a fail-fast convenience; drift makes it a lie., Lay the wrapper out exactly as install.sh does: <lib>/bin + <lib>/venv., `-I` drops PYTHON* env vars, user site, and the CWD from sys.path.      Without, _run() (+9 more)

### Community 571 - "test_pull_refcount_rows.py"
Cohesion: 0.20
Nodes (18): _multi_handler(), _payload(), _pull(), MockTransport, #1412 — the SINGLE-FILE pull path must do the same blob/file accounting the file, The WS-11 mmproj sidecar is a second installed file — it gets its own     blob +, The store GC's fs-walk must recognise freshly pulled bytes as tracked.      Befo, Refcount counts *referents*, not pull attempts. Re-pulling the same     model mu (+10 more)

### Community 572 - "test_store_concurrency.py"
Cohesion: 0.19
...
### Community 574 - "test_load_converges_config.py"
Cohesion: 0.24
Nodes (18): _load_to_ready(), FakeContainerProvider, MonkeyPatch, Path, SlotManager, #1224 part 2 — a load must converge the unit onto the slot's current config.  ``, The teardown half is best-effort; the re-spawn must still run., A blocking stop must hand control back inside the timeout. (+10 more)

### Community 575 - "test_agents_unit_liveness.py"
Cohesion: 0.21
Nodes (15): AgentRecord, agents_client(), _FakeManager, _hermes(), MonkeyPatch, TestClient, GET /api/agents must report systemd unit liveness, not just install state (#1459, The seam itself degrades rather than raising when systemctl is absent. (+7 more)

### Community 576 - "hal0 architecture & reference"
Cohesion: 0.11
...
### Community 577 - "FakeDelegateRunner"
Cohesion: 0.16
...
### Community 578 - "2. Bugs (correctness — ordered by impact)"
Cohesion: 0.11
...
### Community 579 - "manage-slots.mdx"
Cohesion: 0.11
...
### Community 580 - "Defects"
Cohesion: 0.11
Nodes (17): 1. `chat_template` removal wrote nothing — #1372, **fixed** (#1377), 2. The flags migrator dropped every slot's `extra_args` — #1396, **fixed** (#1397), 3. Model Context size corrupted or deleted the stored value — #1378, fix in flight (#1386), 4. vision↔mmproj guard was decorative — #1380, fix in flight (#1392), 5. Display name could not be cleared — #1381, fix in flight (#1392), 6. NPU toggles clobber the configured FLM tag — #1388, **unfixed**, 7. Save silently dead on an NPU slot with malformed persisted `extra_args` — #1389, **unfixed**, 8. Dirty-baselines track a live-polled prop — #1390 / #1391, **unfixed**, root cause filed as #1398 (+9 more)

### Community 581 - "spec-kb23 — hal0-brain chat tool-tier, approval-gate & injection-resistance"
Cohesion: 0.11
...
### Community 582 - "hal0-admin tools"
Cohesion: 0.11
...
### Community 583 - "kokoro_server.py"
Cohesion: 0.14
...
### Community 585 - "ensure_podman_apparmor_usable"
Cohesion: 0.19
...
### Community 586 - "ProgressCoalescer"
Cohesion: 0.14
...
### Community 589 - "check_seams"
Cohesion: 0.28
Nodes (12): check_seams(), The privileged sudo seams every slot op and self-update runs through (#1465)., #1465 — ``hal0 doctor all`` must render the privileged-seam verdict.  The defect, The install.sh warn-only path, now visible instead of silently green., Running `hal0 doctor` as a random user cannot prove the hal0 grant., _status(), test_a_grant_that_does_not_apply_is_a_fail_even_when_both_files_exist(), test_all_seams_proved_passes() (+4 more)

### Community 590 - "test_setup_install.py"
Cohesion: 0.06
...
### Community 591 - "slot_migrate_flags"
Cohesion: 0.32
Nodes (17): One-shot: fold each slot's flag/tune surface onto its bound MODEL.      Material, slot_migrate_flags(), MonkeyPatch, Path, ``hal0 slot migrate-flags`` — the operator-run deploy-window flags fold (spec-fl, Two slots, one model, different tunes → refuse the whole run.      Folding what-, A preview of a conflicted tree must also exit non-zero, cleanly.      ``apply_fo, Rewriting the registry under a live runtime split-brains it. (+9 more)

### Community 592 - "default_variant"
Cohesion: 0.14
...
### Community 593 - "is_activated"
Cohesion: 0.27
Nodes (12): claims_npu_anchor(), is_activated(), npu_anchor_config(), npu_modality_active(), Any, The slot activation predicate — one owner for "is this slot live config?".  #136, True when the NPU anchor is live AND ``slot_type``'s modality is on.      The on, Return the slot's bound model id, or ``""`` when none is bound.      Absorbs the (+4 more)

### Community 594 - ".emit"
Cohesion: 0.19
Nodes (5): MemDocuments(), MemRecallConsole(), mtDocTitle(), mtDocWhen(), mtFactColor()

### Community 595 - "aggregate_hour"
Cohesion: 0.20
...
### Community 596 - "test_modality.py"
Cohesion: 0.17
...
### Community 597 - "CuratedModel"
Cohesion: 0.18
Nodes (11): _match_curated(), Return the curated entry whose ``hf_file`` equals ``filename``., Tests for the custom-GGUF curated coords added in fix/stack-model-pull-coords., The new ids do not collide with any existing curated id., Each new id resolves via get_curated() to the EXACT hf_repo/hf_file.      This i, The on-disk filename resolves back to the curated entry (scan-backfill)., The three seed-stack files match their curated entries by filename., test_get_curated_resolves_exact_coords() (+3 more)

### Community 598 - "mdns.py"
Cohesion: 0.18
...
### Community 600 - "CapacityProbeError"
Cohesion: 0.10
Nodes (23): CapacityProbeError, CapacitySnapshot, _ctx_tokens_for(), estimate_file_size_kv_mb(), _kv_estimate_mb(), Any, Slot capacity snapshot.  CapacitySnapshot is the single-source view of available, Best-effort KV-cache size in MiB for a given context window. (+15 more)

### Community 601 - "test_hermes_security_deliverables.py"
Cohesion: 0.15
...
### Community 604 - "_build"
Cohesion: 0.18
Nodes (13): _AcceptingClient, _build(), Any, TestClient, #1420 — ``/api/status`` must surface retain-pipeline health, not just daemon rea, The PgVector fallback and any third-party provider have no retain     pipeline t, A daemon that accepts every retain and serves recalls — while its     extraction, THE regression: every retain fails, ``memory_degraded`` stays false. (+5 more)

### Community 605 - "FakeUpstreamRegistry"
Cohesion: 0.23
Nodes (12): _build_client(), _comfyui_base_url(), comfyui_preview(), comfyui_render_cancel(), _fetch_json(), _get_client(), AsyncClient, Timeout (+4 more)

### Community 606 - "test_models_preview.py"
Cohesion: 0.19
...
### Community 608 - "test_settings_apply.py"
Cohesion: 0.11
...
### Community 609 - "test_v1_dispatch.py"
Cohesion: 0.16
...
### Community 610 - "test_brain_self_auth.py"
Cohesion: 0.18
...
### Community 611 - "test_doctor_perms.py"
Cohesion: 0.19
...
### Community 612 - "test_memory_migrate_unify.py"
Cohesion: 0.11
Nodes (3): MonkeyPatch, Tests for ``hal0 memory migrate unify``.  The ``migrate`` default callback (reti, stub_api()

### Community 613 - "test_fetch_paths.py"
Cohesion: 0.18
...
### Community 614 - "FakeLocalBackend"
Cohesion: 0.17
...
### Community 615 - "test_logs_tail_redaction.py"
Cohesion: 0.11
...
### Community 616 - "3. Proposed seed catalog (one per type)"
Cohesion: 0.12
...
### Community 617 - "Slot config — capabilities ↔ slots reconciliation"
Cohesion: 0.12
...
### Community 618 - "hal0 Adoption Candidates — Lemonade + ODS (combined)"
Cohesion: 0.12
...
### Community 619 - "spec-hp-realtime — OpenAI Realtime WebSocket endpoint for hal0"
Cohesion: 0.12
...
### Community 620 - "P3-schema — `config/schema.py` decomposition: implementation-ready spec"
Cohesion: 0.12
...
### Community 621 - "Prerelease Preview Pipeline Hardening"
Cohesion: 0.12
...
### Community 624 - "suggest_models"
Cohesion: 0.19
Nodes (18): _is_coder(), _ram_gb(), Hardware-driven curated-model suggestions per capability (spec §6.5).  Generaliz, Return up to ``limit`` curated picks for ``capability`` that fit the     detecte, suggest_models(), Suggestion, CuratedModel, Every curated model must have a deployable source: either HF pull         coordi (+10 more)

### Community 625 - "apply_extraction_slot"
Cohesion: 0.18
...
### Community 627 - "normalize_system_messages"
Cohesion: 0.18
...
### Community 630 - "metrics_collect.py"
Cohesion: 0.15
...
### Community 631 - "snapshot_live_stack"
Cohesion: 0.30
...
### Community 632 - "test_hermes_state_render.py"
Cohesion: 0.12
...
### Community 633 - "_Headers"
Cohesion: 0.22
Nodes (5): _FakeDispatcher, _Headers, _NonChatRequest, _dispatch_and_forward must NOT invoke _normalize_chat_body — that would     rewr, test_dispatch_and_forward_does_not_normalize_non_chat()

### Community 634 - "test_cli_auth_streamtest.py"
Cohesion: 0.21
...
### Community 635 - "Findings from the 2026-05-16 hal0-test deep-probe round"
Cohesion: 0.12
...
### Community 636 - "DelegateTaskSpec"
Cohesion: 0.18
...
### Community 637 - "test_preflight_ports_own_service.py"
Cohesion: 0.29
...
### Community 638 - "agents-overview.jsx"
Cohesion: 0.20
...
### Community 639 - "test_ttft_samples.py"
Cohesion: 0.12
...
### Community 641 - "halo (LXC 150) — R3 deploy issues report"
Cohesion: 0.12
...
### Community 642 - "hal0_gpu_gate.py"
Cohesion: 0.16
...
### Community 643 - "qwen3tts_server.py"
Cohesion: 0.16
...
### Community 646 - "system_info_command.py"
Cohesion: 0.18
...
### Community 648 - "layout_store.py"
Cohesion: 0.20
Nodes (15): _layout_path(), load(), Any, Path, Persistent file-backed store for the operator's dashboard layout.  Single-operat, Write *layout* to disk atomically.      Callers should call :func:`reconcile` be, Return a defensively-normalised copy of *layout*, per its own version.      A v3, Return a defensively-normalised copy of a pre-#1061 v2 *layout*.      Rules appl (+7 more)

### Community 649 - "test_perms.py"
Cohesion: 0.33
...
### Community 651 - ".container_spec"
Cohesion: 0.11
Nodes (18): Build the GPU/llama-server :class:`RuntimeLaunchPlan` for a slot.          This, _device_node_for_group(), gpu_visibility_env(), is_nvidia_gpu_device(), nvidia_cdi_devices(), _probed_gpu_group_gids(), Shared helpers for GPU device + group exposure to provider containers.  Lives he, Return numeric GIDs for the host's GPU access groups (render, video).      ``nod (+10 more)

### Community 652 - "audio.py"
Cohesion: 0.12
...
### Community 654 - "RecordingSlotArtifactOps"
Cohesion: 0.22
...
### Community 655 - "_hermes_fakes.py"
Cohesion: 0.16
Nodes (15): apply_hermes_config_cli(), apply_kanban_db_init_cli(), _coerce(), default_fake_slots(), Any, Shared test fakes for the hermes_provision config-set redesign.  ``apply_hermes_, Redirect every host path constant under ``tmp_path``; return (home, venv)., Ready chat/agent/utility slots + an embed slot that must never alias. (+7 more)

### Community 656 - "test_hermes_provision_install_artifacts.py"
Cohesion: 0.17
...
### Community 657 - "test_agents_routes.py"
Cohesion: 0.21
...
### Community 658 - "test_mcp_identity.py"
Cohesion: 0.18
...
### Community 659 - "test_models_crud.py"
Cohesion: 0.15
Nodes (15): crud_app(), crud_client(), FastAPI, Tests for the /api/models CRUD surface — register, update, delete cascade.  Cove, PUT rejects -ngl in defaults.extra_args with the slot-hardware envelope     (not, /validate dry-run screens slot-hardware flags too, without writing., An app with a model root + no slots wired by default.      Tests that need a slo, A typed 404 envelope, not a silent ``deleted: false``. (+7 more)

### Community 660 - "_events_since"
Cohesion: 0.18
Nodes (16): _events_since(), _max_event_id(), User-edited rows override detection — not the other way around., Empty body falls back to the legacy auto-scan path., The optional ``source`` body field tags the emitted event., A PUT that re-sends the same values lists no changed_fields., A duplicate is a new registry id pointing at the SAME path, copying     metadata, Deleting a model with no referrers: short-circuit, affected_slots=[]. (+8 more)

### Community 661 - "_StubSlotManager"
Cohesion: 0.28
...
### Community 662 - "test_catalog_backends.py"
Cohesion: 0.21
...
### Community 663 - "FakeDockerBackend"
Cohesion: 0.16
...
### Community 664 - "hal0 test harness — internal contributor guide"
Cohesion: 0.12
...
### Community 665 - "_build_spec"
Cohesion: 0.28
Nodes (10): _build_spec(), _model_info(), _moe_profile(), Any, Model-owned `vision` tri-state gates the --mmproj emit (#901, spec-hw-slot-owner, No explicit defaults.vision opinion + sidecar present → --mmproj emitted., defaults.vision=false → text-only, no --mmproj even though a sidecar exists., A stray legacy ``vision`` key still on a slot TOML (pre-migration,         toler (+2 more)

### Community 666 - "test_npu_trio_shadow.py"
Cohesion: 0.08
Nodes (27): Protocol, The non-filesystem side effects of the migration.      Split behind a protocol s, SlotArtifactOps, is_npu_trio_shadow(), NpuTrioHost, Any, NPU FLM-trio shadow reconciler (P3-slots §1d).  The NPU runs a single ``flm serv, True if *cfg* is an NPU FLM trio **shadow** (stt/embed), not the anchor.      Th (+19 more)

### Community 667 - "memory.jsx"
Cohesion: 0.16
Nodes (8): fmtWhen(), MEM_FACT_COLORS, MEM_FACT_TYPES, MemBankCard(), MemOperations(), MemoryView(), MemTimeseries(), memToast()

### Community 668 - "Model registry — registry, pulls, classification"
Cohesion: 0.13
...
### Community 669 - "Handoff: qwen3tts standalone → hal0-slot migration"
Cohesion: 0.13
...
### Community 670 - "Container Image System Overhaul"
Cohesion: 0.13
...
### Community 671 - "hal0 rework plan — de-scarring the launch"
Cohesion: 0.13
...
### Community 672 - "Handoff — brain + embed slot/agent cleanup on halo150"
Cohesion: 0.13
...
### Community 673 - "Handoff — γ-suite (chromium) persistently red on main (#1333)"
Cohesion: 0.13
...
### Community 674 - "Handoff — fold rework→main merge/meld/fix follow-ups into the R5 docs"
Cohesion: 0.13
...
### Community 675 - "Handoff — hal0 R5 endgame (paste-in brief for a new session)"
Cohesion: 0.13
...
### Community 676 - "Findings (O-series)"
Cohesion: 0.13
...
### Community 678 - "hal0 Hermes Integration Suite Design"
Cohesion: 0.13
...
### Community 679 - "PR #1330 CI Repair Design"
Cohesion: 0.13
...
### Community 681 - "test_route_collisions.py"
Cohesion: 0.19
...
### Community 682 - "test_hermes_live_resolve_render.py"
Cohesion: 0.19
Nodes (14): _build_config_overlay(), Ordered ``(dotted_key, value)`` overlay applied via ``hermes config set``., _overlay(), Live-resolve behaviour of the config-set overlay builder.  Post config-set redes, Under live-resolve, providers.custom carries api_key + discover_models so     He, #1148: under live-resolve, providers.custom.extra_headers carries the     X-hal0, With live-resolve OFF, base_url is a single physical slot backend, so     live d, A non-8080 primary backend_url must NOT leak into either base_url under     live (+6 more)

### Community 683 - "upsert_env_value"
Cohesion: 0.21
...
### Community 684 - "create_chat_template"
Cohesion: 0.24
...
### Community 685 - "test_slots_policy.py"
Cohesion: 0.26
...
### Community 687 - "upstream_commands.py"
Cohesion: 0.17
Nodes (14): create_upstream(), credentials_set(), _filters_summary(), list_upstreams(), _print_json(), Any, hal0 upstream subcommands — thin HTTP client to the hal0 API.  Provides ``hal0 u, Register a new upstream LLM provider (always kind=remote). (+6 more)

### Community 688 - "profiles_toml"
Cohesion: 0.29
...
### Community 689 - "write_openwebui_env"
Cohesion: 0.18
...
### Community 690 - "rerender_slot_units"
Cohesion: 0.29
Nodes (11): Re-render every existing container slot unit through current code.      A slot's, rerender_slot_units(), _mk_slot(), rerender_slot_units — the update-time slot-unit re-render sweep.  Slot units bak, Sandbox the systemd dir, container runtime, profile lookup, and     systemctl ca, rerender_env(), test_per_slot_failure_does_not_wedge_sweep(), test_slot_without_unit_file_skipped() (+3 more)

### Community 691 - "npu_columns.py"
Cohesion: 0.19
...
### Community 692 - "systemd.py"
Cohesion: 0.21
Nodes (14): Shared systemctl helpers for the companion-service management layer.  Until now, Return a ``.timer`` unit's calendar expression + last/next trigger.      Shape (, True when ``systemctl is-active <unit>`` reports ``active``., Run one allow-listed lifecycle verb against ``unit``.      Returns ``{"ok": bool, True when ``unit`` is a plausible systemd unit name., Run ``systemctl <args>``; (rc, stdout, stderr), rc=None on no-systemd/timeout., Return the unit's systemd state for display.      Shape (all values fail-soft)::, _run() (+6 more)

### Community 693 - "test_hermes_provision_kanban_db_init.py"
Cohesion: 0.20
...
### Community 694 - "test_persona_update.py"
Cohesion: 0.25
...
### Community 695 - "test_slots_npu_fields.py"
Cohesion: 0.20
...
### Community 696 - "test_devices.py"
Cohesion: 0.16
Nodes (10): _no_host_hardware_json(), Tests for benchmark GPU device-node resolution (issue #1303).  The harness used, CDI injects nodes + permissions itself; --group-add would be wrong., So a run is never mislabelled with another tier's GPU string., Never read the developer box's real /etc/hal0/hardware.json., Pin the render/video GIDs so assertions don't depend on /etc/group., _stub_group_ids(), TestNvidiaTier (+2 more)

### Community 697 - "test_brain_ctx_precheck.py"
Cohesion: 0.23
...
### Community 700 - "test_pool_bounds.py"
Cohesion: 0.15
...
### Community 702 - "test_api_restart_on_upgrade.py"
Cohesion: 0.28
Nodes (14): _fake_systemctl(), MonkeyPatch, Path, An in-place upgrade must put the NEW code into service.  Observed on halo 2026-0, Restarting must not cost the boot-time enable — the unit still has to     come b, A systemctl that reports ``is_active`` and logs every invocation., Source install.sh's function definitions and call the unit under test.      ``in, The regression: an upgrade over a live box must bounce the service. (+6 more)

### Community 703 - "test_admin_route_map.py"
Cohesion: 0.17
...
### Community 704 - "test_container_mmproj.py"
Cohesion: 0.31
...
### Community 705 - "test_release_check.py"
Cohesion: 0.37
...
### Community 706 - "test_device_profile_coherence.py"
Cohesion: 0.18
...
### Community 707 - "test_mtp_defuse.py"
Cohesion: 0.29
...
### Community 709 - "test_integrations.py"
Cohesion: 0.13
...
### Community 710 - "[Unreleased]"
Cohesion: 0.14
Nodes (14): Added, Added, Breaking, Changed, Fixed, Fixed, Fixed, Fixed (+6 more)

### Community 711 - "Contributing to hal0"
Cohesion: 0.14
...
### Community 712 - "Toolbox Repo Consolidation"
Cohesion: 0.14
...
### Community 713 - "obtain-models.mdx"
Cohesion: 0.14
...
### Community 714 - "Deploy halves of the "CI here" scenarios"
Cohesion: 0.14
...
### Community 715 - "PART 2 — DELIVERABLES"
Cohesion: 0.14
...
### Community 716 - "0. EXACT Honcho footprint (file:line)"
Cohesion: 0.14
...
### Community 717 - "P2-device: make `device` the sole truth, delete the `backend` dual-write"
Cohesion: 0.14
...
### Community 718 - "Handoff — R5 drive 2: put it back together (paste-in prompt, Fable orchestrator)"
Cohesion: 0.14
...
### Community 719 - "hal0 1.0 Seeded Profile Rework — Implementation Plan"
Cohesion: 0.14
...
### Community 721 - "Phase 4 handoff — halo143 deploy window"
Cohesion: 0.14
...
### Community 722 - "logs.py"
Cohesion: 0.19
Nodes (13): _pump(), Read text frames from ``source_recv`` and write to ``sink_send``.      Returns c, is_log_noise(), journalctl-backed per-slot log access.  Extracted from ``routes/slots.py`` (P3-r, Follow ``unit``'s journal output, yielding filtered lines.      ``backfill_n`` r, :func:`tail_journal`, plus a ``None`` yield every ``keepalive_s`` of silence., True for high-frequency heartbeat lines with no diagnostic value., Suppress the narrow set of errors raised killing a dead subprocess. (+5 more)

### Community 723 - "image_cache.py"
Cohesion: 0.21
...
### Community 725 - "BenchDeviceSpec"
Cohesion: 0.21
Nodes (9): BenchDeviceSpec, _first_node(), The GPU passthrough a benchmark container should be launched with.      ``device, The DRM card/KMS node, or "" — used for sysfs telemetry lookups., The DRM render node (``renderD*``), or ""., The exact ``--device=`` / ``--group-add=`` argv for this spec.          Empty on, ``KEY=VALUE`` lines for shell consumers (parsed, never ``eval``ed).          One, Render a resolved spec in one of the three output formats. (+1 more)

### Community 726 - "dispatch.py"
Cohesion: 0.18
Nodes (13): clear_executors(), dispatch(), DispatchResult, get_executor(), Board executor dispatch seam (KB-5) — interface + registry, no-op default.  hal0, Drop all registered executors (test isolation / teardown)., Dispatch one attempt for ``card_id`` to ``target``'s executor.      Returns a :c, Outcome of a :func:`dispatch` call. (+5 more)

### Community 727 - "_Runner"
Cohesion: 0.14
Nodes (13): _Runner, O15: uv must not inherit a leaked HOME=/root.      On a py3.14-only host the pro, O15 (same leak class): venv + pip subprocesses also get a sane HOME., test_ensure_python_prefers_system_interpreter_over_uv(), test_ensure_python_provisions_via_uv_when_no_system_interpreter(), test_ensure_python_returns_none_when_uv_fetch_fails(), test_install_venv_keeps_supported_venv(), test_install_venv_rebuilds_venv_on_unsupported_interpreter() (+5 more)

### Community 728 - "MetricsRetention"
Cohesion: 0.18
...
### Community 729 - "discover.py"
Cohesion: 0.12
Nodes (23): CandidateModel, _is_mmproj_sidecar(), _is_skippable(), _maybe_register_shard_files(), _normalise_id(), prune_missing(), Model, ModelRegistry (+15 more)

### Community 730 - "heal_missing_llm_type"
Cohesion: 0.20
...
### Community 731 - "provider_requires_model"
Cohesion: 0.22
...
### Community 732 - "test_hermes_provision_context.py"
Cohesion: 0.14
...
### Community 733 - "test_dashboard_layout_v3.py"
Cohesion: 0.22
Nodes (13): layout_client(), TestClient, PUT/GET /api/user/dashboard-layout must speak v3 (#1460).  The dashboard moved t, A stale cached bundle emitting v2 must not start 422-ing., A widget outside the cell's `accepts` list falls back to that cell's default., `heatmap` is whitelisted for c1 but not built yet — must not be persisted., test_put_unknown_version_is_422(), test_put_v3_fills_in_a_missing_cell() (+5 more)

### Community 734 - "_FakeSM"
Cohesion: 0.29
Nodes (11): _FakeSM, Slot, TestClient, B2: /api/health/system must report degraded when a slot is in ERROR.  Previously, Every check reports a boolean ``ok`` and NO per-check ``status``., A failing check carries its reason in ``detail`` and/or ``errored``.      slot_m, _slot(), test_health_system_degraded_when_slot_errored() (+3 more)

### Community 735 - "test_middleware.py"
Cohesion: 0.21
...
### Community 736 - "test_services_health.py"
Cohesion: 0.27
...
### Community 737 - "_patch_httpx"
Cohesion: 0.23
Nodes (13): _patch_httpx(), MonkeyPatch, n_prompt_tokens can briefly exceed n_ctx during shift; clamp the     synthesised, Minimal httpx.Response stand-in for the scrape tests.      Implements just the s, Patch httpx.AsyncClient used inside slots._scrape_llama_metrics.      Routes the, Newer llama-server (b9279+) drops kv_cache_usage_ratio from     /metrics but sti, If a future llama.cpp reintroduces ``llamacpp:kv_cache_usage_ratio``     we use, Idle /slots payload (no n_prompt_tokens on any sub-slot) leaves     ``kv_cache_u (+5 more)

### Community 738 - "test_board_etag.py"
Cohesion: 0.32
...
### Community 739 - "test_brain_chat.py"
Cohesion: 0.23
...
### Community 740 - "test_auth_commands.py"
Cohesion: 0.23
...
### Community 741 - "test_memory_ops_commands.py"
Cohesion: 0.16
...
### Community 742 - "test_slot_verb_aliases.py"
Cohesion: 0.16
...
### Community 743 - "test_hal0_gpu_gate.py"
Cohesion: 0.22
...
### Community 744 - "test_image_pin.py"
Cohesion: 0.14
...
### Community 745 - "test_flm_store_link.py"
Cohesion: 0.26
...
### Community 747 - "test_reinstall_into_venv_does_not_pass_no_deps"
Cohesion: 0.20
Nodes (11): container_enrichment's stopped-vs-crashed escalation shells out         to a rea, _FakeCompletedProcess, MonkeyPatch, Path, #12 regression: ``_reinstall_into_venv`` must install the release's full depende, The pip invocation must never carry ``--no-deps``., Removing --no-deps must not also drop --force-reinstall., Dropping --no-deps must not change the failure contract. (+3 more)

### Community 748 - "test_adopted_slot_eviction.py"
Cohesion: 0.23
...
### Community 749 - "test_dispatchable_ready_set_single_source.py"
Cohesion: 0.14
...
### Community 750 - "test_restart_errored_slot.py"
Cohesion: 0.26
...
### Community 753 - "activity-log.spec.ts"
Cohesion: 0.11
Nodes (19): emitSse(), emitSseTyped(), installSseHarness(), waitForSse(), emitAndAwait(), ERR_REC, frame(), OK_REC (+11 more)

### Community 754 - "Contributor Covenant Code of Conduct"
Cohesion: 0.15
Nodes (12): 1. Correction, 2. Warning, 3. Temporary Ban, 4. Permanent Ban, Attribution, Contributor Covenant Code of Conduct, Enforcement, Enforcement Guidelines (+4 more)

### Community 755 - "3. Recommendation: how hal0 should support ONNX"
Cohesion: 0.15
...
### Community 756 - "Dispatch / runtime — routing, arbiter, lifecycle"
Cohesion: 0.15
...
### Community 759 - "pull-and-register-models.mdx"
Cohesion: 0.15
...
### Community 760 - "hal0 rework — handoff: single primary orchestrator (R3-B / R4 / R5 + finish line)"
Cohesion: 0.15
...
### Community 761 - "Changes Applied (then rolled back)"
Cohesion: 0.15
...
### Community 762 - "hal0 codebase map"
Cohesion: 0.15
...
### Community 763 - "hal0 service management"
Cohesion: 0.15
...
### Community 764 - "restart_agent"
Cohesion: 0.23
Nodes (12): Request, Restart endpoint for bundled agents (v0.3 PR-11).  ``POST /api/agents/{agent_id}, Identify the caller for the audit log.      There is no Bearer token store (auth, Restart the systemd unit backing ``agent_id``.      Returns ``{status, detail}``, Resolve ``systemctl`` on PATH.      Returns ``None`` on hosts that don't have sy, Compose the unit name for an agent id.      Matches ``installer/systemd/hal0-age, Probe ``systemctl is-active hal0-agent@{agent_id}.service``.      The liveness h, _resolve_actor() (+4 more)

### Community 765 - "QueryStringScrubber"
Cohesion: 0.18
...
### Community 766 - "stream_journal"
Cohesion: 0.18
Nodes (8): Return an exact supported updater version or raise ``ValueError``.      ReleaseP, Schema-validated release-manifest payload.      Mirrors the on-disk JSON shape d, Cross-field validation for preview/release-kind consistency.          Rules:, ReleaseManifest, validate_release_version(), A full alpha preview manifest parses with new fields., test_manifest_schema_accepts_alpha_preview(), test_manifest_schema_accepts_canonical_release_versions()

### Community 767 - "migrate_unify_cmd"
Cohesion: 0.21
Nodes (12): _derived_tags(), _document_ids(), migrate_default(), migrate_unify_cmd(), _poll_operation(), Context, ``hal0 memory migrate`` — Hindsight bank unify.  ``migrate unify`` folds one or, Read-merge-write ``tags`` onto each of ``doc_ids`` in ``bank``.      PATCH .../d (+4 more)

### Community 768 - "setup_install.py"
Cohesion: 0.22
...
### Community 770 - "resolve_gpu_group_ids"
Cohesion: 0.20
...
### Community 771 - "resolve_servable_model"
Cohesion: 0.28
Nodes (6): _matches(), One persona's tool-policy overlay, resolved at dispatch time.      Field semanti, Build from a :class:`hal0.agents.personas.Persona` (duck-typed         so this m, Whether the tool is on this persona's surface at all., Resolve one call → ``run`` | ``gated`` | ``denied`` | ``refused``.          ``de, ToolPolicy

### Community 772 - "image_pull.py"
Cohesion: 0.19
...
### Community 773 - "test_containers_apparmor.py"
Cohesion: 0.37
...
### Community 774 - "conftest.py"
Cohesion: 0.18
Nodes (12): _hermetic_port_listeners(), isolated_app_client(), isolated_client(), FastAPI, MonkeyPatch, TestClient, Shared pytest fixtures for ``tests/api/`` — module-level state isolation.  The c, Clear ``_HAL0_MODEL_CACHE`` before and after every api test. (+4 more)

### Community 775 - "test_activity.py"
Cohesion: 0.31
...
### Community 776 - "test_activity_routes_instrumented.py"
Cohesion: 0.38
...
### Community 777 - "test_comfyui_fetch_route.py"
Cohesion: 0.15
...
### Community 778 - "test_events_fixes.py"
Cohesion: 0.19
...
### Community 779 - "test_harness_matrix.py"
Cohesion: 0.21
Nodes (9): _gpu_roots(), The benchmark harness's CPU hardware tier — matrix, argv, and metadata.  PLAN's, ``GPU_LABEL`` is stamped into every ``.meta.json`` — it must not name a     GPU, The realistic way the CPU baseline gets measured: pin the tier on a         box, Documentation-as-assertion: nothing above may reach a real GPU node., Discovery roots that look like an AMD box (kfd + card1 + renderD128)., test_no_test_here_needed_real_hardware(), TestGpuLabel (+1 more)

### Community 780 - "TestSeamWhitelist"
Cohesion: 0.18
Nodes (7): CompletedProcess, Call ``hal0-benchctl``'s whitelist directly.      Sourcing runs the script's dis, Without this the matrix entry is unreachable: ``hal0-benchctl         sweep <mod, Adding one key must not turn the check into a rubber stamp — this         is the, The telemetry tier hint is a positional argument to a root-run         seam, so, TestSeamWhitelist, _validate_backend()

### Community 781 - "test_memory_graph_commands.py"
Cohesion: 0.15
...
### Community 782 - "test_model_verbs.py"
Cohesion: 0.26
...
### Community 785 - "_RecordingProvider"
Cohesion: 0.24
Nodes (10): _mount(), Any, Mount-level regression for issue #1302 — the ``/mcp/memory`` bulk-delete gate., Run ``mount_mcp_servers`` against a bare app, skipping route-map install.      T, Minimal memory provider — records deletes so we can prove none ran., The server ``mount_mcp_servers`` builds must carry the queue., Admin gates first; its in-process memory callable must not re-gate.      If it d, _RecordingProvider (+2 more)

### Community 786 - "test_seed_profiles.py"
Cohesion: 0.24
Nodes (12): _load_seed_profiles(), Seed profile catalog validation.  Per docs/superpowers/specs/2026-07-20-seeded-p, §21.7 regression tripwire: a seed's flags must never carry a flag hal0     owns, Catalog parses as TOML and contains [profile.*] tables., 1.0 catalog is exactly 16 profiles (11 kept + 5 new)., test_all_profiles_have_intent(), test_all_profiles_have_no_hardware_flags(), test_all_profiles_have_no_managed_or_hardware_flags() (+4 more)

### Community 787 - "_run_wrapper"
Cohesion: 0.19
Nodes (13): fake_systemctl(), CompletedProcess, Path, A ``systemctl`` that records its argv instead of talking to systemd.      Placed, The seam re-validates server-side — client-side validation is a     convenience,, The caller passes a bare id; the seam concatenates the prefix + suffix., The two id namespaces stay separate: an agent verb always produces a     ``hal0-, The verb allow-list is the case statement; nothing else gets through. (+5 more)

### Community 788 - "react-hooks-order.test.mjs"
Cohesion: 0.23
Nodes (12): checkFile(), DASH_DIR, fail(), files, HERE, HOOK_NAMES, LOOP_METHODS, loopCallbackDepth() (+4 more)

### Community 789 - "test_worker_eval.py"
Cohesion: 0.29
...
### Community 790 - "Slot pin + drawer field-wiring audit — session handoff (2026-07-30)"
Cohesion: 0.17
Nodes (11): Addendum — final state + lxc105 deploy (2026-07-30, session close), Decisions, Issues, Local e2e results across parallel worktrees were fiction, Open items, Pull requests, Scope, Slot pin + drawer field-wiring audit — session handoff (2026-07-30) (+3 more)

### Community 791 - "Recently added endpoints"
Cohesion: 0.17
...
### Community 792 - "HW-slot-ownership — hardware sticks to slots, logical tune sticks to models"
Cohesion: 0.17
...
### Community 793 - "Design — 3-tier, deny-by-default, single classification source"
Cohesion: 0.17
...
### Community 794 - "hal0 UI/UX design brief — post-R3 surface rework"
Cohesion: 0.17
...
### Community 796 - "Exception"
Cohesion: 0.24
Nodes (6): Exception, Raised by :meth:`AgentMCPClient.guard` for hard-blocked tools.      Maps to the, ToolNotPermittedError, PortAuthorityError, Base class for port-authority errors., TestGuard

### Community 797 - "hermes-prereqs.sh"
Cohesion: 0.42
Nodes (11): die(), ensure_interpreter_path(), ensure_uv(), have_pip(), have_pipx(), have_system_hermes_py(), have_uv(), have_venv() (+3 more)

### Community 798 - "v0.3 (active — the next user-visible milestone)"
Cohesion: 0.17
...
### Community 799 - "Release pipeline — prototype findings + blockers"
Cohesion: 0.17
...
### Community 802 - "_apply_in_process"
Cohesion: 0.28
...
### Community 805 - "serialize_slot"
Cohesion: 0.25
Nodes (7): Slot lifecycle manager (container runtime).  SlotManager owns every aspect of sl, # NOTE: ``extra=`` MUST NOT use "message" as a key — that's, # NOTE: fail-watch tunables (_FAIL_WATCH_INTERVAL_S, _FAIL_WATCH_LIVE_STATES,, # NOTE: idle-monitor tunables (_IDLE_AFTER_S, _IDLE_MONITOR_INTERVAL_S,, # NOTE: callers wire this through ``Dispatcher.forward``; the, # NOTE: _argv_values / _resolve_drift_flags / _config_drift_values_equal /, # NOTE: _cfg_effective_backend / _base_profile_for_backend /

### Community 806 - "test_startup_slot_seed.py"
Cohesion: 0.20
Nodes (11): _no_static_slot_seed(), Path, Startup slot seeding — the lifespan hook that ships agent/brain/etc.  install.sh, Override tests/conftest.py's global no-op — this module tests the     REAL seedi, A blank box grows every static seed at startup., GH #1475: a slot the boot seeder adds this boot must get an identity     row THI, The upgrade case: an old box has agent (operator-edited), no     brain — startup, _slots_dir() (+3 more)

### Community 807 - "TestTelemetrySampler"
Cohesion: 0.17
Nodes (7): Static guards on ``hal0-benchctl telemetry``.      Not executed: the sampler's o, The telemetry verb's CODE, with comments stripped — the comments         quote t, A CPU run on a box that has a GPU must not log that idle GPU's         busy/temp, The sudoers grant has no env_keep, so an env-only hint would never         survi, 0 reads as "the GPU sat idle", which is a different claim from         "there is, The old glob cat'd every sensor: multi-line output produced         malformed JS, TestTelemetrySampler

### Community 808 - "test_board_ws.py"
Cohesion: 0.32
...
### Community 809 - "test_agent_status.py"
Cohesion: 0.23
...
### Community 811 - "test_system_info.py"
Cohesion: 0.12
Nodes (18): Shared types for the hal0 Hermes transport., _resolve_pull_capability — capability + comfyui_subdir for a pull (P3).  The hel, _Reg, _req(), test_body_capability_wins(), test_curated_capability_and_subdir_fallback(), test_registry_capability_used_when_no_body(), test_unknown_model_returns_none() (+10 more)

### Community 812 - "test_comfyui_scripts_shipped.py"
Cohesion: 0.17
...
### Community 813 - "test_static_seeds.py"
Cohesion: 0.17
...
### Community 814 - "test_post_activation_migrations.py"
Cohesion: 0.26
Nodes (11): Any, MonkeyPatch, ``run_post_activation_migrations`` (GH #1475) — the single sequence both ``Updat, Unlike the four data-cleanup passes, a schema-migration failure is     NOT swall, Replace all five passes with recording stubs so tests assert call     order/coun, install.sh has no release manifest to read min_data_version from —     the defau, _stub_every_pass(), test_a_failing_non_fatal_pass_does_not_block_the_others() (+3 more)

### Community 815 - "board-chat-v3.spec.ts"
Cohesion: 0.21
Nodes (4): emitWs(), installWsHarness(), waitForWs(), NOTE: addInitScript serialises the function — it must not close over

### Community 816 - "`hal0-setup.yaml` — headless answer-file spec (2026-07-05)"
Cohesion: 0.18
...
### Community 817 - "Findings → fixes, by tier"
Cohesion: 0.18
...
### Community 818 - "Handoff: model-pipeline plan — finish-out pass"
Cohesion: 0.18
...
### Community 819 - "Hal0 Upstream Controls — Epic Plan (2026-07-06)"
Cohesion: 0.18
...
### Community 820 - "capabilities-and-profiles.mdx"
Cohesion: 0.18
...
### Community 821 - "Admin tools (`/mcp/admin`)"
Cohesion: 0.18
...
### Community 822 - "providers-profiles-devices.mdx"
Cohesion: 0.18
...
### Community 823 - "slot-lifecycle.mdx"
Cohesion: 0.18
...
### Community 824 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
...
### Community 825 - "Both-boxes deploy-validation runbook — rework-R4-stage"
Cohesion: 0.18
...
### Community 826 - "P3-brain — Implementation-Ready Spec: hal0-brain as a first-class module"
Cohesion: 0.18
...
### Community 827 - "PART D — Edit plan (files, order, delegators/shims)"
Cohesion: 0.18
...
### Community 828 - "hal0 Hermes Plugin Suite — BUILD Spec (verified vs code @ `rework/descar`)"
Cohesion: 0.18
...
### Community 829 - "Hermes Agent official integration research for the hal0 rework"
Cohesion: 0.18
...
### Community 830 - "2. Proposed hal0 plugin suite"
Cohesion: 0.18
...
### Community 831 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
Nodes (10): Board row = the machine-readable record, Checkpoint (R1–R5) → main, hal0 rework — board tracking protocol (paste-in prompt), Hard rules (never violate), Lifecycle of a lane (how a row moves), Migration-window lanes, Monitor, Reusable agent-dispatch prompt skeleton (+2 more)

### Community 832 - "check_sunset.py"
Cohesion: 0.38
Nodes (10): Match, current_version(), _fmt(), main(), overdue_markers(), ProjectVersion, _py_files(), Path (+2 more)

### Community 833 - "update-cosign-pin.sh"
Cohesion: 0.36
Nodes (9): checksum_for_asset(), ensure_verifier(), err(), info(), is_release_tag(), is_sha256(), read_pin(), resolve_latest_version() (+1 more)

### Community 834 - "deps.py"
Cohesion: 0.36
...
### Community 835 - "services_health"
Cohesion: 0.17
Nodes (15): _queue_counts(), _openwebui_url(), _probe_comfyui(), _probe_hermes(), _probe_openwebui(), Any, GET /api/services/health — dashboard services health aggregator.  Returns a stab, Real reachability probe — GET <loopback>/health on OpenWebUI.      SpikeB §5.4 c (+7 more)

### Community 836 - "regress.py"
Cohesion: 0.27
...
### Community 837 - "store.py"
Cohesion: 0.25
Nodes (4): A CPU-tier run must not demand a DRI device — no raise, no flags., No /dev/dri at all (a plain CPU box / CI runner) is still fine., ``resolve_gpu_device_paths`` degrades to ``["/dev/kfd", "/dev/dri"]``         on, TestCpuTier

### Community 838 - "eligibility.py"
Cohesion: 0.22
...
### Community 841 - "test_hermes_provision_collect.py"
Cohesion: 0.25
...
### Community 842 - "test_config_model_roots.py"
Cohesion: 0.29
...
### Community 844 - "test_features_health.py"
Cohesion: 0.25
...
### Community 845 - "test_meta_enums.py"
Cohesion: 0.42
...
### Community 847 - "test_server_ab_helpers.py"
Cohesion: 0.22
...
### Community 848 - "test_board_commands.py"
Cohesion: 0.27
...
### Community 849 - "test_model_import_backup.py"
Cohesion: 0.29
Nodes (7): Replace Bearer / HAL0_BEARER_TOKEN / long client_id / ``*_KEY=``     secrets in, redact_log_line(), No false positives on lines that don't carry secrets — including     KEY-shaped, The hashed client_id label (12 hex chars) and short agent ids stay     visible —, test_redact_log_line_does_not_mask_short_client_id_labels(), test_redact_log_line_masks_known_secret_shapes(), test_redact_log_line_passes_through_safe_content()

### Community 850 - "test_serve_bind_host.py"
Cohesion: 0.31
...
### Community 851 - "test_fetch_scripts.py"
Cohesion: 0.18
...
### Community 856 - "test_admin_stacks.py"
Cohesion: 0.24
...
### Community 857 - "test_api_wiring.py"
Cohesion: 0.24
...
### Community 858 - "_write_slot"
Cohesion: 0.40
Nodes (10): Path, An empty ``[model].default`` is the sole "not activated" signal (#1369)., A pre-#1369 ``enabled = false`` must not suppress a slot that has a model., test_loaded_slot_returns_typed_slot(), test_model_less_slot_is_not_routable(), test_resolve_for_request_applies_label_overlay(), test_resolve_for_request_returns_default_loaded_slot(), test_route_for_request_keeps_name_compatibility() (+2 more)

### Community 859 - "test_npu_trio_reconcile.py"
Cohesion: 0.45
Nodes (10): _anchor(), Path, Tests for SlotManager.reconcile_npu_trio_slots (FLM-trio shadow canon).  The rec, _slots_dir(), test_creates_missing_shadows_with_placeholder_models(), test_idempotent_on_second_run(), test_noop_without_container_npu_anchor(), test_rename_skipped_when_canon_exists() (+2 more)

### Community 860 - "test_pin_semantics.py"
Cohesion: 0.18
Nodes (9): Unit tests for the §21.10 operator-pin resolution (`reaper.is_pinned`).  The pin, ``pinned = false`` in the TOML un-pins a default anchor like utility., No ``pinned`` key at all → the anchor set decides (raw-TOML presence)., Missing/unreadable config (None) keeps the fail-open anchor default., A ``pinned = None`` value (defensive) behaves like an absent key., test_absent_key_falls_back_to_default_anchor_set(), test_explicit_pinned_false_overrides_default_anchor(), test_explicit_pinned_none_is_treated_as_absent() (+1 more)

### Community 861 - "compilerOptions"
Cohesion: 0.18
Nodes (10): compilerOptions, allowSyntheticDefaultImports, lib, module, moduleResolution, noEmit, skipLibCheck, strict (+2 more)

### Community 862 - ".classify"
Cohesion: 0.20
...
### Community 863 - "Profiles / stacks — profile/stack/bundle layering"
Cohesion: 0.20
...
### Community 865 - "7. Product-shaped reworks (from the six field notes)"
Cohesion: 0.20
...
### Community 866 - "FLAGS-own — llama.cpp flags stick to models; profiles become templates"
Cohesion: 0.20
...
### Community 867 - "hal0 SETTINGS rework — implementation-ready spec"
Cohesion: 0.20
...
### Community 868 - "Slot / Model / Profile / Flags / Image — reworked runtime model (R3)"
Cohesion: 0.20
...
### Community 869 - "Global Constraints"
Cohesion: 0.20
...
### Community 871 - "Dashboard Plugin JS Loading Internals"
Cohesion: 0.20
...
### Community 879 - "get_agent_memory_stats"
Cohesion: 0.29
...
### Community 883 - "slot_migrate_caps"
Cohesion: 0.42
Nodes (9): One-shot: mtp/enable_thinking/vision stick to MODELS (spec-hw-slot-ownership §1), slot_migrate_caps(), MonkeyPatch, Path, ``hal0 slot migrate-caps`` — the operator-run deploy-window model-ownership fold, test_apply_folds_slot_mtp_to_model_and_backs_up(), test_apply_is_idempotent(), test_dry_run_by_default_does_not_write() (+1 more)

### Community 884 - "slot_migrate_enabled_removal"
Cohesion: 0.29
...
### Community 885 - "resolve_chat_template"
Cohesion: 0.27
...
### Community 886 - "resolve_gpu_device_paths"
Cohesion: 0.24
Nodes (6): Return explicit GPU device-node paths to pass via ``--device=``.      Docker rec, resolve_gpu_device_paths(), Tests for GPU device-path resolution (podman/docker passthrough).  Podman cannot, Char-device nodes under /dev/dri are listed explicitly; the bare         directo, When neither /dev/kfd nor /dev/dri exist (CI / no-GPU dev box),         return t, TestResolveGpuDevicePaths

### Community 887 - "backfill_coordless"
Cohesion: 0.48
Nodes (3): FakeUpstreams, SimpleNamespace, TestSyntheticEntries

### Community 889 - "collect_port_claims"
Cohesion: 0.29
...
### Community 891 - "_brain_profile_state"
Cohesion: 0.20
...
### Community 892 - "_patch_dropin_to_tmp"
Cohesion: 0.38
Nodes (4): LiveAgentCard(), RESTART_LABELS, useFlip(), useTilt()

### Community 893 - "_ServerThread"
Cohesion: 0.22
Nodes (7): fake_hermes(), _free_port(), FastAPI, Grab an ephemeral port the OS isn't already using., Runs uvicorn in a background thread for the fake hermes., Spin up FakeHermes on a free port + point the proxy at it., _ServerThread

### Community 894 - "TestStatusTelemetry"
Cohesion: 0.29
...
### Community 895 - "test_mcp_mount_health.py"
Cohesion: 0.24
Nodes (9): MonkeyPatch, TestClient, A failed MCP mount must be visible, not just logged and forgotten.  The fastapi-, A mount failure must flip /api/health/system to degraded and say why., create_app must stash the reason, not only log it., test_failed_mount_degrades_health_and_names_the_reason(), test_healthy_app_reports_mcp_mounted(), test_mount_failure_is_recorded_on_app_state() (+1 more)

### Community 896 - "TestClient"
Cohesion: 0.20
...
### Community 897 - "test_startup_persona_seed.py"
Cohesion: 0.27
Nodes (9): _personas_root(), Path, Startup persona seeding — the lifespan hook that ships hal0-brain.  The dashboar, A blank box grows both seeds + the active pointer at startup., Fresh-install: the startup seed populates HERMES_HOME before     `hal0 agent ins, The upgrade case: an old box has hermes (operator-edited) + a     pristine retir, test_lifespan_seed_converges_old_box_without_touching_edits(), test_lifespan_seeds_default_personas() (+1 more)

### Community 899 - "test_catalog_npu_stt.py"
Cohesion: 0.27
...
### Community 900 - "test_shared_auth.py"
Cohesion: 0.33
Nodes (4): captureDuplicate(), confirmBtn(), dialog(), PROFILES

### Community 902 - "test_validate_catalog.py"
Cohesion: 0.24
...
### Community 904 - "_configure_project"
Cohesion: 0.56
...
### Community 905 - "mock.ts"
Cohesion: 0.29
Nodes (9): AllowRow, buildMockPayload(), jsonResponse(), matchAllowlist(), MOCK_ALLOWLIST, mockFetch(), parsePath(), passthroughRequested() (+1 more)

### Community 906 - "buildBankSubgraphRoute"
Cohesion: 0.36
...
### Community 907 - "useToastStore.ts"
Cohesion: 0.24
Nodes (7): queryClient, installToastGlobal(), timers, Toast, ToastKind, ToastState, useToastStore

### Community 908 - "slot-drawer-dirty-baseline-v3.spec.ts"
Cohesion: 0.20
Nodes (3): COLD, CONFIGURED, HOT

### Community 909 - "slot-drawer-field-wiring-v3.spec.ts"
Cohesion: 0.20
Nodes (4): EMBED, OFFLINE_PRIMARY, PRIMARY, NOTE: this file deliberately does not touch the drawer HEADER toggle — that

### Community 910 - "apply_capability"
Cohesion: 0.28
...
### Community 911 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 912 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 913 - "ROCmFPX bench — RESULTS + next-session handoff (2026-07-05)"
Cohesion: 0.22
...
### Community 914 - "architecture.mdx"
Cohesion: 0.22
Nodes (8): Data flow of a chat request, hal0-api: the control plane, Slots: where models actually run, Stacks: applying a slot set as one unit, The dispatcher: routing a request, The front ends, The pieces, Where to go next

### Community 915 - "security.mdx"
Cohesion: 0.22
Nodes (8): Agent chat: origin allowlist + session cookie, Agent identity and gated actions, MCP host and origin allowlists, Practical checklist, The reverse-proxy pattern, What `X-hal0-Agent` is and is not, Where to go next, Why no built-in auth?

### Community 916 - "connect-clients.mdx"
Cohesion: 0.22
...
### Community 917 - "connect-external-providers.mdx"
Cohesion: 0.22
...
### Community 918 - "realtime-voice.mdx"
Cohesion: 0.22
...
### Community 919 - "openai-compat.mdx"
Cohesion: 0.22
...
### Community 920 - "slot-as-model.mdx"
Cohesion: 0.22
...
### Community 921 - "env-vars.mdx"
Cohesion: 0.22
Nodes (8): Install & update, Memory & MCP, Models & providers, Paths, Runtime, See also, Server, Services

### Community 922 - "Handoff prompt — hal0-brain / template / profile changes on lxc105 (hal0, 10.0.1.142)"
Cohesion: 0.22
...
### Community 923 - "PART B — Target: Quadlet `.container` per slot (and per companion)"
Cohesion: 0.22
...
### Community 924 - "Slot-pin-lifecycle — the operator pin is the residency control, and the only one"
Cohesion: 0.22
Nodes (8): 1. Decision, 2. Effective-pin resolution, 3. Guarded verbs, 4. Payload lift, 5. UI surface, 6. Verification, 7. Relationship to `enabled` (staged), Slot-pin-lifecycle — the operator pin is the residency control, and the only one

### Community 925 - "SWEEP inventory — the overlooked surface (R5 release-prep)"
Cohesion: 0.22
...
### Community 928 - "Hindsight pi Extension Design"
Cohesion: 0.22
...
### Community 929 - "Dashboard plugin "Could not load this plugin's script""
Cohesion: 0.22
...
### Community 930 - "Strix Halo Benchmark Harness (hal0)"
Cohesion: 0.22
Nodes (8): ⚠️ GPU contention, GPU device passthrough (issue #1303), Layout & privilege model (D hardened-perms), Profile-matrix (seed-profile re-tune), Scope & roadmap, Strix Halo Benchmark Harness (hal0), Tuning / extending (operator, edits config.sh), Usage

### Community 931 - "install.sh"
Cohesion: 0.36
Nodes (6): _confirm_cpu_only(), _confirm_launch_setup(), _seed_bank(), install.sh script, start_or_restart_api(), wait_active()

### Community 932 - "error_codes.py"
Cohesion: 0.28
...
### Community 933 - "release-check.sh"
Cohesion: 0.39
Nodes (7): fail(), info(), run_repo_python(), release-check.sh script, step(), usage(), warn()

### Community 934 - "_proxy_ws"
Cohesion: 0.33
Nodes (8): events_ws(), _proxy_ws(), WebSocket, Final flush + cancel any pending timer., Bridge a browser WS to a hermes WS at ``upstream_path``.      ``coalesce_progres, Server→browser mirror of hermes's JSON-RPC event bus.      Subscribes to upstrea, Browser→hermes JSON-RPC submit channel.      Bidi WS on top of hermes ``/api/ws`, submit_ws()

### Community 935 - "memory_commands.py"
Cohesion: 0.24
Nodes (10): _add_write_rows(), disable_cmd(), enable_cmd(), hal0 memory subcommands — graph-extraction gate.  Mirrors the slot / model CLI s, Render the retain-pipeline rows for ``hal0 memory status`` (#1420)., Enable the memory subsystem (persists [memory].enabled=true)., Disable the memory subsystem (persists [memory].enabled=false)., Show whether the memory subsystem is enabled and live. (+2 more)

### Community 936 - "mm_history_cmd"
Cohesion: 0.09
Nodes (29): doctor_ports(), Show which port each slot has bound, and flag collisions.      The drill-down fo, mm_history_cmd(), mm_list_cmd(), mm_refresh_cmd(), ``hal0 memory mm`` — mental-model admin (list / refresh / history)., List a bank's mental models., Trigger a refresh of a mental model (async). (+21 more)

### Community 937 - "ServerConfig"
Cohesion: 0.31
...
### Community 938 - "layout_v3.py"
Cohesion: 0.25
Nodes (8): CellDef, default_layout(), Any, The v3 dashboard layout model — fixed bands, swap-in-place (#1460).  The free-fo, One fixed cell. ``accepts`` is the swap whitelist, in display order., The layout an install starts from — every cell holding its default., Return a normalised v3 layout. Pure — never raises, never mutates.      Mirrors, reconcile()

### Community 939 - "migrate_cognee_to_hindsight_dryrun"
Cohesion: 0.25
...
### Community 940 - "TestImageMismatch"
Cohesion: 0.33
...
### Community 942 - "sanitize_model_extra_args"
Cohesion: 0.40
Nodes (4): is_container_npu_cfg(), Any, Shared NPU-slot helpers for dispatcher modules (Phase A container cutover)., True when this slot config describes a live containerized NPU slot.      Detecti

### Community 944 - "test_hermes_stale_dropin_cleanup.py"
Cohesion: 0.47
...
### Community 945 - "isolated_client_with_root"
Cohesion: 0.33
...
### Community 947 - "TestHarnessConfig"
Cohesion: 0.22
Nodes (5): The literal regression guard for #1303.          ``COMMON_RUN_FLAGS`` — the arra, End-to-end: source config.sh with the discovery roots pointed at a         fake, A CPU-tier sweep sources cleanly and asks podman for no devices., Invalid device settings fail at source time — before any cell runs., TestHarnessConfig

### Community 949 - "test_catalog_flm_blacklist.py"
Cohesion: 0.28
...
### Community 950 - "test_config_show_edit_selector.py"
Cohesion: 0.50
...
### Community 951 - "_stub"
Cohesion: 0.44
Nodes (8): Any, MonkeyPatch, #1420 — ``hal0 memory status`` must be able to tell a box whose retains are all, _stub(), test_failing_retains_are_visible(), test_healthy_box_reads_differently(), test_json_output_carries_the_write_fields(), test_provider_without_a_retain_pipeline_prints_no_write_rows()

### Community 952 - "test_slot_metrics_capacity.py"
Cohesion: 0.36
...
### Community 954 - "test_gp15_no_hermes.py"
Cohesion: 0.22
Nodes (8): _hermes_removed(), MonkeyPatch, Golden path #15 — core operation with Hermes disabled or removed.  REWORK.md §Go, Model a box where Hermes is disabled / never installed., The core chat engine + core route modules import zero hermes modules.      Run i, test_brain_chat_surface_is_exposed_without_hermes(), test_brain_engine_import_graph_pulls_in_no_hermes(), test_core_routes_live_without_hermes()

### Community 955 - "conftest.py"
Cohesion: 0.22
Nodes (7): _admin_route_map_source(), _install_admin_route_map(), _install_stub(), Test fixtures for the hal0.mcp package.  The MCP server modules (:mod:`hal0.mcp., Re-install the known-good route map before every ``tests/mcp/`` test.      Funct, Insert a minimal ``mcp.server.fastmcp`` stub into sys.modules.      Installed at, Build the admin route map once from the live app (route-id keyed).      ``_REST_

### Community 956 - "test_browser_server.py"
Cohesion: 0.25
Nodes (7): _playwright_installed(), MonkeyPatch, Regression coverage for :mod:`hal0.mcp.browser_server` (diagnosis #10).  This se, Import must succeed even when ``playwright`` isn't installed.      Force a fresh, If playwright truly isn't importable, launching must fail with a     clear, acti, test_ensure_browser_raises_clear_error_without_playwright(), test_module_imports_without_playwright_installed()

### Community 957 - "TestContainerRuntimeProbe"
Cohesion: 0.22
...
### Community 959 - "test_halo143_reboot_no_split_brain"
Cohesion: 0.36
...
### Community 960 - "test_model_preferred_profile.py"
Cohesion: 0.50
...
### Community 961 - "port.ts"
Cohesion: 0.33
Nodes (5): PORT, derivePort(), parsePort(), resolveE2EPort(), ResolveE2EPortOptions

### Community 962 - "data"
Cohesion: 0.25
Nodes (9): buildBackends(), buildHardware(), buildModels(), buildNpuOccupancy(), buildSlots(), buildStatus(), data(), slotsDegraded() (+1 more)

### Community 963 - "useBannerStore.ts"
Cohesion: 0.22
Nodes (8): BANNER_CATALOG, BannerAction, BannerEntry, BannerKind, BannerScope, BannerState, CATALOG_BY_ID, useBannerStore

### Community 964 - "Issue tracker: GitHub"
Cohesion: 0.25
Nodes (7): Conventions, Issue tracker: GitHub, Linear (read-only mirror), Pull requests as a triage surface, Wayfinding operations, When a skill says "fetch the relevant ticket", When a skill says "publish to the issue tracker"

### Community 965 - "Local-session prompt: run the profile re-tune bench matrix and apply the results"
Cohesion: 0.25
...
### Community 969 - "generate-images.mdx"
Cohesion: 0.25
...
### Community 970 - "update-and-rollback.mdx"
Cohesion: 0.25
Nodes (7): Apply an update, Channels, Check for an update, Editable/dev installs, How the atomic update works, Roll back, See also

### Community 971 - "voice-stt-tts.mdx"
Cohesion: 0.25
...
### Community 973 - "paths-and-files.mdx"
Cohesion: 0.25
...
### Community 975 - "13. Observability & metrics baseline (ships in every box)"
Cohesion: 0.25
...
### Community 976 - "15. Hermes plugin — standalone repo + native update path"
Cohesion: 0.25
...
### Community 977 - "PART C — Coordination contracts (cross-lane seams)"
Cohesion: 0.25
...
### Community 978 - "halo143 deploy-validation runbook — rework-R3"
Cohesion: 0.25
...
### Community 979 - "Handoff — R5 Phase 4: deploy window → release cut (paste-in prompt)"
Cohesion: 0.25
...
### Community 980 - "mock-prod-gate verification (Phase 0 launch-blocker #3)"
Cohesion: 0.25
...
### Community 981 - "Podman on the hal0 slot substrate — findings & cleaner solutions"
Cohesion: 0.25
...
### Community 988 - "TASK_0002.md"
Cohesion: 0.25
Nodes (7): grill Q&A, phase timings, raw prompt, refined prompt, research, spec, verified tooling

### Community 989 - "fresh-test-ct.sh"
Cohesion: 0.50
Nodes (7): cleanup(), emit(), log(), PVE(), fresh-test-ct.sh script, SSH(), usage()

### Community 990 - "ensure_gateway_api_server_key"
Cohesion: 0.33
Nodes (6): ApiServerKeyResult, ensure_gateway_api_server_key(), _is_strong_api_server_key(), True iff ``value`` is a real, cryptographically-strong gateway key., Outcome of :func:`ensure_gateway_api_server_key`.      ``outcome`` is ``"generat, Idempotently ensure a strong ``API_SERVER_KEY`` in the gateway vault.      Reads

### Community 991 - "write_gateway_secrets_dropin"
Cohesion: 0.13
Nodes (16): _atomic_write(), _atomic_write_if_changed(), content_hash(), _disable_honcho_hermes_host(), _gateway_dropin_body(), GatewayDropinResult, _privileged_systemctl(), Stable content hash steps use to detect "inputs unchanged".      Steps that prod (+8 more)

### Community 992 - "hermes_requirement_is_vetted"
Cohesion: 0.25
Nodes (8): hermes_pinned_ref(), hermes_requirement_floor(), hermes_requirement_is_vetted(), _hermes_requirement_line(), The single active ``hermes-agent`` requirement line (comments skipped)., The ``>=X.Y.Z`` version floor of a requirement line, or ``None``.      ``None``, The git commit/tag a requirement pins to, or ``None`` for a version spec., Whether the shipped requirement forecloses the broken 0.15.2 build.      Accepta

### Community 993 - "_settings_apply.py"
Cohesion: 0.29
...
### Community 994 - "resolve_default_image"
Cohesion: 0.40
...
### Community 995 - "_pull_jobs_dir"
Cohesion: 0.22
Nodes (10): Garbage-collect stale terminal pull-job snapshots (#MR-8).      Reap on-disk sna, sweep_pull_jobs(), Test that ``_pull_root`` honours [models].store with pull_root fallback., Drop a snapshot for ``model_id`` in ``state`` with an aged mtime., Old terminal snapshot is reaped; fresh terminal + old running survive., A missing jobs directory is a no-op, not an error., test_effective_store_prefers_explicit_store(), test_sweep_pull_jobs_missing_dir_returns_zero() (+2 more)

### Community 996 - "test_auth_exposure_route.py"
Cohesion: 0.32
...
### Community 998 - "TestCpuCellEndToEnd"
Cohesion: 0.25
Nodes (4): A real (non-dry) CPU cell against a stub ``$RUNTIME``: result JSON,     ``.meta., No fake GPU name, and the tier is explicit so a CPU cell and an         iGPU cel, ``index.json`` carries the tier and the v2 export stops calling         every ho, TestCpuCellEndToEnd
...
### Community 1000 - "test_app_list_uninstall.py"
Cohesion: 0.36
...
### Community 1004 - "test_slot_enabled_removed.py"
Cohesion: 0.25
Nodes (7): Guards for the #1369 removal of ``SlotConfig.enabled``.  A slot is activated by, The field is gone from the schema — not merely defaulted or deprecated., An older TOML carrying ``enabled = false`` must not fail validation.      Operat, Shipped seeds express activation only through ``[model].default``., test_no_seed_toml_declares_enabled(), test_slot_config_has_no_enabled_field(), test_stale_enabled_key_still_loads()

### Community 1005 - "FINDINGS.md"
Cohesion: 0.25
...
### Community 1006 - "_BackendContract"
Cohesion: 0.25
...
### Community 1007 - "BackendInvocation"
Cohesion: 0.32
Nodes (3): BackendInvocation, Any, One ``execute()`` call captured for assertions.

### Community 1008 - "test_route_sync.py"
Cohesion: 0.32
Nodes (6): _live_route_ids(), Route-sync check: every classified admin tool resolves to a live route.  Since s, ``"<METHOD>:<path-template>"`` ids the live app registers (normalized).      Enu, The reconstructed tool -> (method, path) view still points at live routes., test_every_classified_route_id_resolves_to_a_live_route(), test_rest_map_targets_resolve_to_live_routes()

### Community 1009 - "test_store_on_change.py"
Cohesion: 0.39
...
### Community 1010 - "test_slot_create_conflict.py"
Cohesion: 0.29
...
### Community 1011 - "test_slot_schema.py"
Cohesion: 0.32
Nodes (7): _load_slot(), Every static seed slot TOML validates against SlotConfig and matches the spec-p3, Every static seed populates n_gpu_layers and threads (per spec §3.1 + §3.3)., brain.toml docstring recommends `[brain_chat] model = "hal0/agent"` as the     t, test_brain_slot_docstring_recommends_hal0_agent(), test_static_seed_slot_matches_mapping(), test_static_seed_slot_populates_hw_grid()

### Community 1012 - "test_transition_guard.py"
Cohesion: 0.25
...
### Community 1013 - "useTweaksStore.ts"
Cohesion: 0.29
Nodes (5): APPEARANCE_KEYS, DEFAULTS, TweaksState, TweaksStore, useTweaksStore

### Community 1014 - "board-chat-tool-use-v3.spec.ts"
Cohesion: 0.29
Nodes (3): GATED_FRAMES, mockChat(), sse()

### Community 1015 - "Agent skills"
Cohesion: 0.29
Nodes (6): Agent skills, Domain docs, graphify, hindsight, Issue tracker, Triage labels

### Community 1016 - "Concurrency & continuous-batching optimization plan"
Cohesion: 0.29
...
### Community 1017 - "ROCmFPX exploratory bench — RESULTS (2026-07-05)"
Cohesion: 0.29
...
### Community 1023 - "P3-perms: declarative OwnershipStore as the single ownership authority"
Cohesion: 0.29
...
### Community 1024 - "PART B — Target: OwnershipStore default `service_user="hal0"`"
Cohesion: 0.29
...
### Community 1025 - "PART C — The LOAD-BEARING contract: born-owned"
Cohesion: 0.29
...
### Community 1026 - "PART 0 — EXACT MAP (file:line)"
Cohesion: 0.29
...
### Community 1027 - "P3-quadlet: migrate slot + companion units to Podman Quadlet `.container`"
Cohesion: 0.29
...
### Community 1028 - "PART A — Current scars (in plain English)"
Cohesion: 0.29
...
### Community 1029 - "4. Delivery plan and gates"
Cohesion: 0.29
...
### Community 1033 - "Gateway connectivity quirks — hal0"
Cohesion: 0.29
...
### Community 1042 - "_resolve_tool"
Cohesion: 0.09
Nodes (27): Map a tool name + args → (method, upstream path, query params, body, target)., _resolve_tool(), _FakeRequest, Tests for the board chat orchestrator — src/hal0/api/routes/board_chat.py.  The, R1-style chat templates prefill the opening <think>, so the completion     can c, test_compact_board_shapes(), test_extract_tool_calls_empty_when_none(), test_extract_tool_calls_parses_string_args() (+19 more)

### Community 1043 - "write_env_atomic"
Cohesion: 0.33
...
### Community 1044 - "seed_chat_templates"
Cohesion: 0.38
...
### Community 1046 - "test_slot_logs_stream_redacts_secret_bearing_lines"
Cohesion: 0.33
...
### Community 1047 - "test_config_hardware_probe.py"
Cohesion: 0.43
...
### Community 1051 - "test_paths_stub.py"
Cohesion: 0.29
...
### Community 1052 - "_reject_privileged_systemctl"
Cohesion: 0.33
Nodes (7): _isolate_hal0_home(), Path, Keep tests away from host FHS state, including non-API unit tests., Drop a leading ``sudo``/``doas``/``pkexec`` and its option words., Raise if ``argv`` is a systemctl invocation that would need polkit.      Called, _reject_privileged_systemctl(), _strip_sudo()

### Community 1053 - "test_voice_roundtrip.py"
Cohesion: 0.43
...
### Community 1054 - "10. Troubleshooting"
Cohesion: 0.29
...
### Community 1055 - "test_owui_pin_consistency.py"
Cohesion: 0.43
...
### Community 1056 - "memory-graph.jsx"
Cohesion: 0.38
Nodes (5): ALL_LENSES, DIRECTIONS, FACT_TYPES, GraphLensed(), MemGraphExplorer()

### Community 1058 - "slot-create-default-v3.spec.ts"
Cohesion: 0.29
Nodes (3): CHAT_DEFAULT, CHAT_OTHER, EMBED_MODEL

### Community 1059 - "[0.9.1] — 2026-07-05"
Cohesion: 0.33
Nodes (6): [0.9.1] — 2026-07-05, Added, Changed, Highlights, Migrations, Removed

### Community 1060 - "[0.9.5] — 2026-07-08"
Cohesion: 0.33
Nodes (6): [0.9.5] — 2026-07-08, Added, Breaking, Changed, Highlights, Migrations

### Community 1061 - "[0.9.7.1] — 2026-07-11"
Cohesion: 0.33
Nodes (6): [0.9.7.1] — 2026-07-11, Added, Changed, Fixed, Highlights, Migrations

### Community 1062 - "[0.9.7] — 2026-07-11"
Cohesion: 0.33
Nodes (6): [0.9.7] — 2026-07-11, Added, Changed, Fixed, Highlights, Migrations

### Community 1063 - "[0.9.8] — 2026-07-13"
Cohesion: 0.33
Nodes (6): [0.9.8] — 2026-07-13, Added, Changed, Fixed, Highlights, Migrations

### Community 1064 - "[v0.3.2-alpha.1] — 2026-05-29"
Cohesion: 0.33
Nodes (6): Added, Deferred, Docs, Fixed, Tests, [v0.3.2-alpha.1] — 2026-05-29

### Community 1065 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 1066 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 1067 - "Domain Docs"
Cohesion: 0.33
Nodes (5): Before exploring, read these, Domain Docs, File structure, Flag ADR conflicts, Use the glossary's vocabulary

### Community 1068 - "Hal0 Installer Setup — Redesign Plan (2026-07-05)"
Cohesion: 0.33
...
### Community 1070 - "logs-and-activity.mdx"
Cohesion: 0.33
...
### Community 1075 - "24. Execution waves / rollout program (session 3, 2026-07-18)"
Cohesion: 0.33
...
### Community 1077 - "§4.4 addendum — MCP admin route-map autogen (the 3 gaps)"
Cohesion: 0.33
...
### Community 1078 - "Verification strategy"
Cohesion: 0.33
Nodes (6): Lifecycle and security, Live acceptance, Memory, Provider, Verification strategy, Voice

### Community 1079 - "Dashboard permission mismatch (root vs hal0)"
Cohesion: 0.33
...
### Community 1080 - "run_benchmarks.sh"
Cohesion: 0.40
Nodes (3): MODELS, run_benchmarks.sh script, usage()

### Community 1081 - "get_qwen_image.sh"
Cohesion: 0.47
Nodes (5): dl(), HF_HOME, HF_HUB_ENABLE_HF_TRANSFER, _require_hf(), get_qwen_image.sh script

### Community 1082 - "get_sdxl.sh"
Cohesion: 0.47
Nodes (5): download_if_missing(), HF_HOME, HF_HUB_ENABLE_HF_TRANSFER, _require_hf(), get_sdxl.sh script

### Community 1083 - "hal0-update"
Cohesion: 0.80
Nodes (5): hal0-update script, die(), validate_channel(), validate_dir_name(), validate_version()

### Community 1084 - "hal0 fresh-install test template (CT 200)"
Cohesion: 0.33
...
### Community 1094 - "throughput_history"
Cohesion: 0.33
...
### Community 1097 - "_guess_capability"
Cohesion: 0.33
...
### Community 1098 - "ttft_samples.py"
Cohesion: 0.33
...
### Community 1099 - "avg_ttft_across"
Cohesion: 0.33
...
### Community 1100 - "samples_from_events"
Cohesion: 0.33
...
### Community 1101 - "test_activity_instrumentation.py"
Cohesion: 0.60
...
### Community 1102 - "test_models_catalogue.py"
Cohesion: 0.47
...
### Community 1103 - "test_delete_cascade_clears_slot_default_and_emits_model_deleted_last"
Cohesion: 0.33
Nodes (6): container_stub(), Any, MonkeyPatch, Stub out ContainerProvider's systemd/podman surface.      SlotManager dispatches, Cascade ordering: slot.state events fire BEFORE model.deleted.      Drive the sl, test_delete_cascade_clears_slot_default_and_emits_model_deleted_last()

### Community 1105 - "cli-test.sh"
Cohesion: 0.60
Nodes (5): run_capabilities_migrate_dry_row(), run_doctor_row(), run_row(), run_update_check_row(), cli-test.sh script

### Community 1107 - "test_now_iso.py"
Cohesion: 0.33
...
### Community 1108 - "test_curation_drift.py"
Cohesion: 0.40
...
### Community 1109 - "test_family_defaults_empty.py"
Cohesion: 0.33
...
### Community 1110 - "buildMemFactGraph"
Cohesion: 0.33
Nodes (6): buildBankRecall(), buildBankTimeseries(), buildMemFactGraph(), ISO(), MEM_CAUSAL, MEM_FACTS

### Community 1113 - "slot-drawer-profile-v3.spec.ts"
Cohesion: 0.10
...
### Community 1126 - "first-chat.mdx"
Cohesion: 0.40
Nodes (4): Beyond chat, Next, With curl, With OpenWebUI

### Community 1127 - "setup.mdx"
Cohesion: 0.40
Nodes (4): Flags, Model suggestions, Next, The flow

### Community 1128 - "benchmarks.mdx"
Cohesion: 0.40
Nodes (4): GPU device nodes are probed, never assumed, Scheduled runs are polite, What the installer sets up, Where results go

### Community 1129 - "enable-memory.mdx"
Cohesion: 0.40
Nodes (4): Destructive ops are audited, Related, The graph-extraction gate, Turn it on

### Community 1130 - "let the content column fill the full pane width (page-scoped via head style)."
Cohesion: 0.40
...
### Community 1131 - "14. Kanban board — ownership inversion + security hardening"
Cohesion: 0.40
...
### Community 1132 - "16. Hermes Python library (`AIAgent`) for the brain — evaluated, rejected for core"
Cohesion: 0.40
...
### Community 1133 - "21.A Mapping table — every candidate by disposition"
Cohesion: 0.40
...
### Community 1134 - "8. SQLite adoption — setup plan"
Cohesion: 0.40
...
### Community 1135 - "PART A — Current-state map (the scars, in plain English)"
Cohesion: 0.40
...
### Community 1136 - "PART D — The one narrow privileged helper: `hal0-systemctl`"
Cohesion: 0.40
...
### Community 1137 - "PART G — Sequencing: P3-perms BEFORE hermes-provision slim and P3-quadlet"
Cohesion: 0.40
...
### Community 1138 - "PART 0 — Current-state map (the hand-rendered ExecStart scars, file:line)"
Cohesion: 0.40
...
### Community 1139 - "hal0-bench-autopilot"
Cohesion: 0.40
Nodes (4): Commands, hal0-bench-autopilot, Output, Regression Detection

### Community 1140 - "Architecture"
Cohesion: 0.40
Nodes (5): Architecture, Plugin API endpoint, Plugin discovery (server-side), Plugin rescan, Static asset serving

### Community 1141 - "profile-matrix.sh"
Cohesion: 0.70
Nodes (4): has_cell(), run_sweep(), profile-matrix.sh script, usage()

### Community 1142 - "hal0-systemctl"
Cohesion: 0.90
Nodes (4): hal0-systemctl script, die(), validate_agent_id(), validate_slot_id()

### Community 1143 - "10. Test strategy"
Cohesion: 0.40
Nodes (5): 10. Test strategy, E2E (γ, Playwright), Harness (δ, local end-to-end smoke), Integration (β, CI), Unit (pytest)

### Community 1144 - "fork-pi-mono.sh"
Cohesion: 0.70
Nodes (4): die(), info(), fork-pi-mono.sh script, warn()

### Community 1145 - "NOTES — answers from the prototype session"
Cohesion: 0.40
...
### Community 1151 - "TestRenderCancel"
Cohesion: 0.40
...
### Community 1152 - "test_distro.sh"
Cohesion: 0.90
Nodes (4): bad(), ok(), test_distro.sh script, want()

### Community 1153 - "test_migration_convergence.py"
Cohesion: 0.40
Nodes (3): GH #1475: install.sh's repair/upgrade-in-place path must run the SAME post-activ, The old two-heredoc block imported ensure_seed_profiles and     clear_stale_mtp_, test_install_sh_no_longer_hand_picks_a_migration_subset()

### Community 1156 - "bankFrom"
Cohesion: 0.40
Nodes (5): bankFrom(), buildBankOperations(), buildBankStats(), buildMemFactGraphRoute(), MEM_BANKS

### Community 1157 - "graphForBank"
Cohesion: 0.40
Nodes (5): buildBigMemFactGraph(), buildDenseFactGraph(), buildMemEntityGraph(), buildMemEntityGraphRoute(), graphForBank()

### Community 1163 - "slot-card-container-v3.spec.ts"
Cohesion: 0.40
...
### Community 1164 - "slot-edit-controls-v3.spec.ts"
Cohesion: 0.40
Nodes (3): EMBED, PRIMARY, NOTE: the per-card enable toggle, the fade modifier, and the

### Community 1165 - "slot"
Cohesion: 0.50
Nodes (4): group, slot, slot inventory, user-defined slots

### Community 1166 - "[0.9.5.1] — 2026-07-09"
Cohesion: 0.50
Nodes (4): [0.9.5.1] — 2026-07-09, Added, Fixed, Highlights

### Community 1167 - "[0.9.6.1] — 2026-07-11"
Cohesion: 0.50
Nodes (4): [0.9.6.1] — 2026-07-11, Added, Changed, Fixed

### Community 1168 - "[v0.8.3b1] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.3b1] — 2026-07-04

### Community 1169 - "[v0.8.2b3] — 2026-06-29"
Cohesion: 0.50
Nodes (4): Added, Docs, Fixed, [v0.8.2b3] — 2026-06-29

### Community 1170 - "[v0.8.0-beta.1] — 2026-06-21"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.0-beta.1] — 2026-06-21

### Community 1171 - "[v0.7.3-beta.2] — 2026-06-19"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.7.3-beta.2] — 2026-06-19

### Community 1172 - "[v0.5.1-alpha.1] — 2026-06-15"
Cohesion: 0.50
Nodes (4): Added, Changed, Removed, [v0.5.1-alpha.1] — 2026-06-15

### Community 1173 - "[v0.5.0-alpha.1] — 2026-06-14"
Cohesion: 0.50
Nodes (4): Added, Fixed, Internal, [v0.5.0-alpha.1] — 2026-06-14

### Community 1174 - "[v0.9.0] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.9.0] — 2026-07-04

### Community 1175 - "[v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)"
Cohesion: 0.50
Nodes (4): Internal contracts, Known follow-up, New / improved, [v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)

### Community 1176 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1177 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1178 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
...
### Community 1185 - "PART E — `hal0-api` User flip + UMask removal"
Cohesion: 0.50
...
### Community 1186 - "PART F — Edit plan (files, order, delegators/shims)"
Cohesion: 0.50
...
### Community 1187 - "PART H — Risks + capped verification"
Cohesion: 0.50
...
### Community 1188 - "PART E — Migration of running units (the live-box transition)"
Cohesion: 0.50
...
### Community 1189 - "PART F — Risks + capped verification"
Cohesion: 0.50
...
### Community 1201 - "test_destructive_ops_land_audit_rows"
Cohesion: 0.67
Nodes (4): _build_app_with_audit(), Any, FastAPI, test_destructive_ops_land_audit_rows()

### Community 1202 - "test_store.py"
Cohesion: 0.67
...
### Community 1204 - "_delegate_fakes.py"
Cohesion: 0.50
...
### Community 1205 - "test_comfyui_path.py"
Cohesion: 0.50
...
### Community 1216 - "[0.9.2] — 2026-07-05"
Cohesion: 0.67
Nodes (3): [0.9.2] — 2026-07-05, Fixed, Highlights

### Community 1217 - "[v0.8.5b2] — 2026-07-04"
Cohesion: 0.67
Nodes (3): Added, Fixed, [v0.8.5b2] — 2026-07-04

### Community 1218 - "[v0.8.0-beta.3] — 2026-06-23"
Cohesion: 0.67
Nodes (3): Breaking, Changed, [v0.8.0-beta.3] — 2026-06-23

### Community 1219 - "[v0.8.2b2] — 2026-06-24"
Cohesion: 0.67
Nodes (3): Changed, Fixed, [v0.8.2b2] — 2026-06-24

### Community 1237 - "_find_server"
Cohesion: 0.30
Nodes (4): _find_server(), Any, Case-insensitive server-id lookup in the servers list., ``hal0 memory recall`` — debug recall through the ACL front door.  Hits ``POST /

### Community 1248 - "test_agent_unit_argv_defaults_to_real_euid"
Cohesion: 0.67
Nodes (3): MonkeyPatch, ``euid=None`` (the production call) reads the live euid., test_agent_unit_argv_defaults_to_real_euid()

## Knowledge Gaps
- **3330 isolated node(s):** `runlog.sh script`, `rocmfpx-build.sh script`, `rocmfpx-env.sh script`, `rocmfpx-pipeline.sh script`, `rocmfpx-quantize.sh script` (+3325 more)
...
- **Why does `create_app()` connect `create_app` to `test_auth_rotate.py`, `TestClient`, `test_auth_core.py`, `test_startup_persona_seed.py`, `test_pull_shutdown.py`, `ApprovalQueue`, `conftest.py`, `test_hf_routes.py`, `test_comfyui_fetch_route.py`, `test_events_fixes.py`, `test_stacks_routes.py`, `test_models_crud.py`, `seed_chat_templates`, `MemoryConfig`, `_StubSlotManager`, `test_memory_admin_routes.py`, `GpuImageMode`, `test_dashboard_layout.py`, `conftest.py`, `test_startup_slot_seed.py`, `test_admin_route_map_nested.py`, `test_route_collisions.py`, `test_memory_delete_auth.py`, `test_updater_routes.py`, `test_slots_policy.py`, `EventBus`, `isolated_client_with_root`, `test_slots_routes.py`, `test_settings_routes.py`, `test_kb1_hardening_tail.py`, `test_slots_npu_fields.py`, `mcp_mount.py`, `TestClient`, `test_slots_image_pull.py`, `test_chat_templates.py`, `conftest.py`, `test_v1_npu_trio_routing.py`, `test_exposure.py`, `test_hindsight_boot_probe.py`, `migrate_slot_toml`, `test_config_model_roots.py`, `test_chat_proxy_auth.py`, `load_hal0_config`, `test_settings_models_store.py`, `Path`, `test_typed_errors.py`, `__init__.py`, `test_models_routes.py`, `test_pull_routes.py`, `_build`, `test_dashboard_layout_v3.py`, `test_chat_proxy.py`, `test_models_preview.py`, `TestClient`, `test_tts_request_defaults.py`, `test_typed_bodies.py`, `FakeWsServer`, `auth.py`, `conftest.py`, `test_models_add_from_path.py`, `test_models_default.py`, `test_v1_slot_alias_models.py`, `test_route_sync.py`, `test_installer_routes.py`, `test_event_contract.py`, `slot_migrate_enabled_removal`, `test_v1_chat_slot_alias.py`, `test_cli_auth_streamtest.py`, `BootReport`, `test_slots_container_state.py`, `test_mcp_mount_health.py`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `SlotManager` connect `Slot` to `Path`, `SlotInterface`, `SlotManager`, `SlotReaper`, `test_manager_npu_container.py`, `FLMProvider`, `build_auto_selections`, `Dispatcher`, `test_npu_trio_shadow.py`, `FakeManager`, `serialize_slot`, `GpuArbiter`, `test_model_fallback.py`, `rerender_slot_units`, `test_npu_exclusivity.py`, `CapabilityOrchestrator`, `PreloadEvictHost`, `SlotState`, `_write_slot`, `test_load_converges_config.py`, `test_model_preferred_profile.py`, `_RecordingSlotManager`, `test_device_profile_coherence.py`, `test_mtp_defuse.py`, `test_slot_aliases.py`, `SlotIdentityStore`, `SlotWatchdog`, `_write_slot`, `test_npu_trio_reconcile.py`, `heal_missing_llm_type`, `test_pulling_serving_idle.py`, `test_config_drift_aliases.py`, `test_adopted_slot_eviction.py`, `test_slot_create_conflict.py`, `test_transition_guard.py`, `SlotConfigError`, `agents-overview.jsx`, `FakeContainerProvider`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `SlotState` connect `_RecordingSlotManager` to `BrainChatConfig`, `SlotInterface`, `Slot`, `test_metrics_prometheus_route.py`, `SlotReaper`, `_slot`, `StackConfig`, `Dispatcher`, `test_crash_loop_breaker.py`, `_GpuStatsStub`, `_dispatcher`, `test_container_gate.py`, `test_fail_watcher.py`, `UpstreamCall`, `GpuArbiter`, `StackApplyEngine`, `MonkeyPatch`, `container_enrichment`, `PreloadEvictHost`, `SlotState`, `Enum`, `test_fail_watcher_warming.py`, `read_stack_state`, `test_backends_npu_canonical_fields.py`, `Any`, `_ArbiterSlotManager`, `services.jsx`, `arbiter.py`, `SlotWatchdog`, `FakeSnap`, `_FakeSM`, `gc.py`, `config_enrichment`, `test_npu_occupancy.py`, `backfill_coordless`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Are the 182 inferred relationships involving `SlotManager` (e.g. with `_build_offline_deps()` and `FLMProvider`) actually correct?**
  _`SlotManager` has 182 INFERRED edges - model-reasoned connections that need verification._
- **Are the 122 inferred relationships involving `connect()` (e.g. with `.__init__()` and `._read()`) actually correct?**
  _`connect()` has 122 INFERRED edges - model-reasoned connections that need verification._
- **Are the 123 inferred relationships involving `create_app()` (e.g. with `AuthEnforcementMiddleware` and `lifespan()`) actually correct?**
  _`create_app()` has 123 INFERRED edges - model-reasoned connections that need verification._
- **Are the 46 inferred relationships involving `ApprovalQueue` (e.g. with `create_app()` and `ApprovalAlreadyResolved`) actually correct?**
  _`ApprovalQueue` has 46 INFERRED edges - model-reasoned connections that need verification._