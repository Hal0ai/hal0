# Graph Report - prerelease-channel  (2026-07-20)

## Corpus Check
- 1665 files · ~2,292,231 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27806 nodes · 52571 edges · 1314 communities (1168 shown, 146 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 6382 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `320d14d7`
...
- hal0-podman-ro
- provision.sh
- Task for reviewer-local
- Task for reviewer-local
- Task for scout-local
- Task for worker
- Task for worker
- Task for reviewer
- Task for reviewer
...
- _scrub_detail
- .__init__
- test_screen_extra_args_json_ignores_non_json_flags
- .enqueue
- test_probe_strips_warning_preamble_and_reads_installed
- test_async_spawn_demotes_via_setpriv_not_kwargs
- test_is_installed_flm_id_matches_installed_tag
...
- test_manifest_schema_accepts_alpha_preview
...
6. `create_app()` - 112 edges
7. `BadRequest` - 110 edges
8. `SlotState` - 108 edges
9. `apiGet()` - 107 edges
10. `die()` - 106 edges
...
## Communities (1314 total, 146 thin omitted)

### Community 0 - "useSlots.ts"
Cohesion: 0.03
Nodes (141): ChatTemplate, useChatTemplates(), useMeta(), useMetaEnums(), useAddModelFromPath(), useModelDuplicate(), useModelInspect(), useModels() (+133 more)

### Community 1 - "hermes_provision.py"
Cohesion: 0.05
Nodes (62): _apply_config_set(), _build_config_overlay(), _copy_plugin_tree(), _copy_wrapper(), _dirs_identical(), _disable_honcho_hermes_host(), _ensure_hermes_config(), _ensure_honcho_sdk() (+54 more)

### Community 2 - "SlotConfigError"
Cohesion: 0.03
Nodes (79): ModelCacheCheck, PullRunner, container_provider(), Return the process-wide ContainerProvider singleton., flm_id_to_tag(), Resolve a hal0 ``<tag>-FLM`` id back to FLM's native ``family:size`` tag.      I, _cfg_port(), _cfg_provider() (+71 more)

### Community 3 - "ENDPOINTS"
Cohesion: 0.03
Nodes (129): apiDelete(), apiGet(), ApiOptions, apiPut(), Hal0Error, serialiseBody(), ENDPOINTS, ADR-0004 (+121 more)

### Community 4 - "SlotManager"
Cohesion: 0.03
Nodes (118): Return ``True`` when *name* is in the dispatchable ready-set.          Ready set, See :meth:`hal0.slots.watchdog.SlotWatchdog._fail_watch_loop`., See :meth:`hal0.slots.watchdog.SlotWatchdog.probe_health`., See :meth:`hal0.slots.watchdog.SlotWatchdog.readiness_check`., See :func:`hal0.slots.routing.default_slot_for`., See :func:`hal0.slots.routing.route_for_request`., See :func:`hal0.slots.routing.add_slot`., See :func:`hal0.slots.routing.remove_slot`. (+110 more)

### Community 5 - "useModels.ts"
Cohesion: 0.07
Nodes (39): ADR-0022, DEFAULT_METRICS, fetchSlotsUnion(), FlagProvenance, IMAGE_PULL_TERMINAL, ImagePullSnapshot, ImagePullState, inferSlotShape() (+31 more)

### Community 6 - "test_hermes_provision.py"
Cohesion: 0.03
...
### Community 7 - "test_memory_hindsight_plugin.py"
Cohesion: 0.02
...
### Community 8 - "Model"
Cohesion: 0.08
Nodes (44): FileSetEntry, FileSetPlan, One file of a planned file-set, ready for ``model_file`` insertion., The full set of files one model pull should download + register., Model, A model entry in the hal0 registry.      All fields are optional at construction, _download_one(), _expected_sha256_from_response() (+36 more)

### Community 9 - "SettingsShell.jsx"
Cohesion: 0.05
Nodes (80): CapabilitiesBag, CapabilityRow, useCapabilities(), useCapabilityApply(), useCapabilityPatch(), useServiceRepair(), APPLY_PLAN_KEY, ApplyPlanEntry (+72 more)

### Community 10 - "slots.py"
Cohesion: 0.04
...
### Community 11 - "test_updater.py"
Cohesion: 0.05
Nodes (91): MonkeyPatch, _current_symlink(), Atomic self-update with cosign-verified releases and one-step rollback.      All, Return ``<usr_lib>/hal0-<version>/`` — where this release's tree lives., Return ``<usr_lib>/current`` — the atomic-swap target., Updater, _versioned_install_dir(), _build_release_tarball() (+83 more)

### Community 12 - "BaseModel"
Cohesion: 0.03
Nodes (40): ActivityConfig, AgentConfig, DispatcherConfig, MetaConfig, NpuConfig, Pydantic v2 schema models for hal0 configuration.  All TOML files under /etc/hal, # NOTE: ``map_backend_to_device`` now lives in ``hal0.model_meta`` (imported, One (slot, child) capability selection carried by a stack slot entry.      Mirro (+32 more)
...
### Community 14 - "primitives.jsx"
Cohesion: 0.05
Nodes (41): _fields_for_dataclass(), _fields_for_entry(), _filters_to_config(), _filters_to_runtime(), Any, AsyncClient, Lock, Path (+33 more)

### Community 15 - "Dispatcher"
Cohesion: 0.06
Nodes (66): LegacyResolutionFailed, Raised when the capability/path heuristics find no slot to serve a request., DispatchError, NoRouteFound, Base for any failure the dispatcher itself raises.      All subclasses use the `, No upstream could be found for the requested model id., Registry binds the model to an upstream that is not registered., Reading the registry raised — surface it instead of silently swallowing.      Re (+58 more)

### Community 16 - "SqliteModelRegistry"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (77): AbstractEventLoop, _auto_resume_interrupted_pulls(), _boot_audit_store(), _boot_background_tasks(), _boot_brain_lane(), _boot_capabilities(), _boot_dispatcher(), _boot_mcp_memory_call() (+69 more)

### Community 18 - "ConfigParseError"
Cohesion: 0.10
Nodes (35): BaseModel, The supplied credential was rejected., Unauthorized, PersonaApprovalUpdate, Partial ``[persona.approval]`` patch. Omitted fields are unchanged., _client_ip(), exposure(), ExposureAllowlistEntry (+27 more)
...
### Community 21 - "_api_base"
Cohesion: 0.06
Nodes (65): agent_peers(), List discoverable agent identity cards.      Thin wrapper over ``memory_search``, board_add(), board_list(), board_show(), hal0 board subcommands — thin HTTP client to /api/board/* (§5.2).  A small opera, Create a task (POST /api/board/tasks)., List tasks by lane (GET /api/board/board). (+57 more)

### Community 22 - "SlotConfig"
Cohesion: 0.02
Nodes (76): list_slot_layout(), load_slot_config(), Load and validate /etc/hal0/slots/<slot_name>.toml.      The on-disk shape (per, Atomically write a slot config TOML.      The pydantic SlotConfig is flat; we re, Classify every slots/*.toml stem as ``"id"`` or ``"name"``.      The bilingual e, save_slot_config(), ImageGenConfig, Any (+68 more)
...
### Community 24 - "ProfileConfig"
Cohesion: 0.05
Nodes (43): ProfileConfig, One ``[profile.<name>]`` entry in profiles.toml.      A profile is a reusable ba, Return the full flag string for *profile*, expanding MTP when set.      When the, resolve_profile_flags(), test_vulkan_profile_drafts_on_vulkan_device(), Unit tests for the profile catalog — schema, loader, and flag resolver.  Targete, §7.1a / ML-5: profile.mtp is informational only — resolve_profile_flags, profile.mtp=True alone (no explicit mtp_override) no longer         expands the (+35 more)

### Community 25 - "GpuArbiter"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (89): Preflight: hard-refuse an update on an editable/dev install (audit 4.1).      Th, _refuse_if_editable(), Die early on an editable/dev install — `hal0 update` can't swap the FHS tree., _refuse_if_editable(), _atomic_symlink_swap(), _cache_dir(), _download(), _editable_install_path() (+81 more)
...
### Community 29 - "test_plugin_manifest_proxy.py"
Cohesion: 0.05
...
### Community 30 - "chrome.jsx"
Cohesion: 0.04
Nodes (92): ConfigUrls, useConfigUrls(), useLogsStream(), useMemoryEnabled(), AddFromPathRequest, fmtBytes(), fmtEta(), fmtSpeed() (+84 more)

### Community 31 - "comfyui.py"
Cohesion: 0.07
Nodes (54): aclose_client(), _arbiter_api_mode(), _arbiter_unavailable(), _as_pct(), _bytes_to_gb(), _comfyui_container(), _comfyui_models_dir(), comfyui_models_fetch() (+46 more)
...
### Community 35 - "Upstream"
Cohesion: 0.07
Nodes (25): _default_fetch_models(), _default_is_online(), _join_url(), Any, Request, Dispatcher — registry-aware request router.  The :class:`Dispatcher` reads the m, Look up a registry binding for a model id.          Returns (upstream_name, upst, # NOTE: treated as "no binding" rather than fatal so the dispatcher (+17 more)

### Community 36 - "ContainerProvider"
Cohesion: 0.04
Nodes (67): _container_runtime(), ContainerProvider, Podman-container-per-slot inference backend.      One instance is shared across, Not applicable — systemd starts the container., Probe GET /health on the container port.          For llama-server slots /health, Poll /health until 200 or HEALTH_TIMEOUT_S exceeded.          Raises:, Return True if ``image`` is in the local container image store.          Uses ``, Return the image ref of the running container for *slot_name* (#663).          D (+59 more)

### Community 37 - "ComfyUIProvider"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (56): Registry of all routing targets (slots + remote upstreams).      Loaded at start, Register a new upstream.          Raises UpstreamAlreadyExists if `upstream.name, UpstreamAlreadyExists, UpstreamRegistry, _async_false(), _async_true(), Any, LogCaptureFixture (+48 more)

### Community 43 - "hardware.py"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (72): apply_update(), _body_version(), check_updates(), _collect_slot_drift(), commit_update(), _current_channel(), _flm_toolbox_image(), get_channel() (+64 more)

### Community 46 - "doctor_commands.py"
Cohesion: 0.08
...
### Community 47 - "resolve_by_capability"
Cohesion: 0.05
...
### Community 48 - "get_curated"
Cohesion: 0.08
Nodes (46): build_stream_response(), cancel(), delete(), emit_terminal_pull_event(), enqueue(), enqueue_update(), eta_s(), list_all() (+38 more)

### Community 49 - "_ArbiterSlotManager"
Cohesion: 0.07
...
### Community 51 - "CapabilityOrchestrator"
Cohesion: 0.06
...
### Community 52 - "stacks.jsx"
Cohesion: 0.03
Nodes (92): URL-safe lowercase identifier used by the REST surface., api(), ComfyuiArbiter, ComfyuiEngineState, ComfyuiMemory, ComfyuiMode, ComfyuiStatus, ComfyuiSwitchover (+84 more)

### Community 53 - "load_slot_config"
Cohesion: 0.12
Nodes (15): OSError, load_manifest(), manifest_image_ref(), Load the release manifest.      `scripts/update-toolbox-digests.sh` patches `too, Return the pinned image reference for a toolbox image, if any.      Resolution:, Path, If os.replace fails the tmpfile is unlinked in the finally., Covers the toolbox-image manifest reader used at slot-spawn time.      The manif (+7 more)

### Community 54 - ".create"
Cohesion: 0.09
Nodes (29): Protocol, device_to_backend(), Map hal0's ``device`` enum onto the recipe+backend pair.      Args:         devi, Atomically write a slot TOML.      THE byte-level write path for ``/etc/hal0/slo, Hold the coarse cross-process lock for ALL slots/*.toml writes.      Historicall, slot_write_lock(), write_slot_toml(), Write ``[model] default = <model_id>`` into the slot's TOML.          Preserves (+21 more)
...
Cohesion: 0.07
Nodes (69): ExceptionInfo, Exit, doctor(), _locate_preflight(), Context, Re-run pre-flight checks (systemd, python, docker, disk, ports).      ``hal0 doc, Find ``installer/lib/preflight.sh`` for the current install.      Returns ``None, _exit_code() (+61 more)
...
### Community 61 - "dashboard-redesign.jsx"
Cohesion: 0.03
Nodes (126): useActivityRecent(), useBackends(), CELL_DEFS, CELL_MAP, CellDef, CellId, DashLayout, DEFAULT_LAYOUT (+118 more)

### Community 62 - "test_registry_import.py"
Cohesion: 0.06
...
### Community 63 - "container.py"
Cohesion: 0.05
Nodes (48): _best_effort_model_info(), _binary_runner(), _effective_backend_and_device_class(), _effective_parallel(), _effective_runner(), _image_mismatch(), _native_ctx(), _profile_runtime_family() (+40 more)

### Community 64 - "RuntimeLaunchPlan"
Cohesion: 0.06
...
### Community 65 - "test_updater_routes.py"
Cohesion: 0.06
...
### Community 66 - "Hal0Error"
Cohesion: 0.05
Nodes (89): Hal0Error, _agent_id(), _augment_build_counters(), _bank_failed_op_ids(), _enabled_llm_slots(), get_memory_provider(), graph_status(), _honcho_probe_json() (+81 more)
...
### Community 69 - "ModelRegistry"
Cohesion: 0.06
Nodes (29): ModelAlreadyExists, Base error for registry operations., add() called but the model id is already present., RegistryError, test_duplicate_conflicting_new_id_raises(), _model(), ModelRegistry, Path (+21 more)

### Community 70 - "test_mcp_routes.py"
Cohesion: 0.06
Nodes (58): app(), _build_app(), client(), _FakeAnn, _FakeMcpServer, _FakeTool, _filesystem_manifest_dict(), Any (+50 more)

### Community 71 - "_FakeWrapper"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (19): AGENT_TAB_DEFS, _agentRoute(), _agentTabs(), AgentView(), ADR-0023, BOARD_LANES, BoardView(), KIT_GLYPHS (+11 more)
...
### Community 74 - "HindsightProvider"
Cohesion: 0.08
Nodes (23): _agent_of(), bank_to_namespace(), HindsightProvider, _http_status(), namespace_to_bank(), _now(), Any, Exception (+15 more)

### Community 75 - "ModelRegistry"
Cohesion: 0.07
...
### Community 76 - "FakeSlotManager"
Cohesion: 0.09
Nodes (46): active_tools_for(), Return the filtered tool list for a chat slot, per plan §7.3.      Args:, FakeSlotManager, Any, Shared fixtures for the OmniRouter test suite.  The OmniRouter only talks to two, Tiny stub that satisfies :class:`SlotManagerLike`.      Tests build it with a li, _caller_no_tools_label(), _caller_with_tools_label() (+38 more)

### Community 77 - "EventBus"
Cohesion: 0.11
...
### Community 79 - "_spec_provider_for"
Cohesion: 0.04
Nodes (57): Provider for a slot, or None for the GPU/llama-server default.      The runtime, _spec_provider_for(), KokoroHealthError, KokoroInferError, KokoroProvider, Any, ContainerSpec, KokoroProvider — CPU TTS inference backend (kokoro-onnx).  Image API surface: (+49 more)

### Community 80 - "connections.jsx"
Cohesion: 0.06
...
### Community 82 - "load_hal0_config"
Cohesion: 0.03
Nodes (103): Set the update channel.      Body::          {"channel": "stable"}   # or "night, set_channel(), config_validate(), Validate all config files against the current schema., ConfigError, ConfigNotFound, ConfigParseError, _find_manifest_path() (+95 more)

### Community 83 - ".uninstall"
Cohesion: 0.06
...
### Community 85 - "test_typed_bodies.py"
Cohesion: 0.08
...
### Community 87 - "connect"
Cohesion: 0.05
Nodes (56): Path, connect(), db_path(), Connection, Path, SQLite connection + transaction helpers — the hal0 ``db/`` foundation.  One conn, Wrap a write in an explicit ``BEGIN IMMEDIATE`` … ``COMMIT``/``ROLLBACK``., Return the default hal0 SQLite database path.      Thin wrapper over :func:`hal0 (+48 more)

### Community 88 - "load_capabilities_config"
Cohesion: 0.07
...
### Community 89 - "agent_commands.py"
Cohesion: 0.04
Nodes (62): agent_install(), agent_list(), agent_log(), _agent_provision_state_file(), agent_reprovision(), agent_status(), agent_uninstall(), agent_upgrade() (+54 more)

### Community 90 - "paths.py"
Cohesion: 0.06
...
### Community 98 - "TestUpstreamEntry"
Cohesion: 0.05
...
### Community 99 - "LlamaServerProvider"
Cohesion: 0.06
...
### Community 100 - "test_profiles_crud.py"
Cohesion: 0.06
...
### Community 104 - "StackApplyEngine"
Cohesion: 0.10
Nodes (22): StackApplyEngine — translate a StackConfig into an atomic slot-config change.  P, Reconcile a StackConfig onto slot TOMLs as one ChangeSet., Commit ``plan.change_set`` to disk atomically.          Delegates to ``SlotConfi, The slot→after-dict projection a plan would write (keyed by slot name)., Record ``plan``'s stack as active, fingerprinting what it wrote.          Call A, Drive SlotManager/orchestrator so live runtime matches ``stack``.          Three, Route each enabled capability row through ``orchestrator.apply``.          A sta, Unload every dispatchable slot not touched by this stack.          Declarative r (+14 more)
...
### Community 109 - "models_service.py"
Cohesion: 0.07
Nodes (52): _normalise_id(), Turn a basename stem into a registry-friendly id., Model ids referenced by any configured slot or any stack.      Union of: each sl, referenced_model_ids(), add_from_path(), auto_scan_and_register(), cascade_delete_model(), clear_slot_default() (+44 more)
...
### Community 111 - "FakeContainerProvider"
Cohesion: 0.06
...
### Community 115 - "useLogs.ts"
Cohesion: 0.05
Nodes (32): react, appendEntry(), entryKey(), parseRawLevel(), buildJournalQuery(), JournalEntry, JournalLevel, JournalSource (+24 more)
...
### Community 117 - "load_profiles_config"
Cohesion: 0.07
Nodes (25): load_profiles_config(), Load and validate /etc/hal0/profiles.toml.      Returns a :class:`ProfilesConfig, Atomically write the operator (non-seed) profile catalog to profiles.toml., Look up a named profile in the profiles.toml catalog.      Shared by every provi, resolve_profile(), save_profiles_config(), ProfilesConfig, Parsed profiles.toml — top-level ``[profile]`` table.      Each key under ``[pro (+17 more)

### Community 118 - "test_hermes_wrapper.py"
Cohesion: 0.07
...
### Community 119 - "test_container.py"
Cohesion: 0.13
...
### Community 121 - "_resolve_llama_scalars"
Cohesion: 0.08
Nodes (43): _llama_argv_segments(), Resolve every llama-server launch scalar for a slot+model+profile.      SINGLE S, Build the ordered, labelled llama-server argv segments (SINGLE SOURCE).      Bot, _resolve_llama_scalars(), _FakeProfile, Golden path #5 (pull→assign→infer) — launch-time profile-read invariant.  spec-f, FLAGS-own: even handed the (now-inert) profile/slot flag params, the argv     bu, spec §8: assert the profile flag resolver is NOT called on the launch     path — (+35 more)

### Community 122 - "test_npu_swap_status.py"
Cohesion: 0.08
...
### Community 124 - "hal0 rework plan — reader's copy"
Cohesion: 0.04
...
### Community 125 - "build_auto_selections"
Cohesion: 0.07
...
### Community 127 - "build_request_metric_row"
Cohesion: 0.12
...
### Community 135 - "SlotConfigStore"
Cohesion: 0.05
Nodes (39): ModelRegistry, Path, SlotManager, ChangeSet, FileState, _known_field_names(), Any, Path (+31 more)
...
### Community 138 - "test_board_chat_tool_use_e2e.py"
Cohesion: 0.13
Nodes (42): _collect(), _collect_with_payload(), _fake_request(), _fast_approval_wait(), _final(), _parse(), _persona_root(), Any (+34 more)

### Community 139 - "test_discover.py"
Cohesion: 0.09
Nodes (36): Discover candidates under ``cfg.roots`` and register the new ones.      Returns, scan_and_register(), model_root(), Path, Tests for hal0.registry.discover — filesystem scan + auto-register., End-to-end: a NON-curated reranker gguf under a scan root registers with     cap, A discovered file whose name matches a curated entry's hf_file     must surface, Files already in known_paths must not appear in the candidate list. (+28 more)
...
### Community 144 - "slot_instance_token"
Cohesion: 0.07
...
### Community 147 - "RoutingHost"
Cohesion: 0.09
Nodes (29): See :func:`hal0.slots.routing.loaded_slot_from_config`., See :func:`hal0.slots.routing.loaded_slot`., See :func:`hal0.slots.routing.resolve_for_request`., add_slot(), default_slot_for(), loaded_slot(), loaded_slot_from_config(), LoadedSlot (+21 more)

### Community 148 - "test_auth_core.py"
Cohesion: 0.07
...
### Community 150 - "Qwen3TTSProvider"
Cohesion: 0.05
Nodes (49): Provider, Any, ContainerSpec, Abstract base for a hal0 inference backend.      Concrete implementations: Conta, Compute the EnvironmentFile contents for a slot.          Returns a mapping of H, Return the argv list for spawning this backend outside systemd.          Mirrors, Run a health check against the backend on *port*.          Returns {"ok": bool,, Passthrough inference against the provider's OpenAI-compatible API.          Thi (+41 more)

### Community 151 - "evalrun.py"
Cohesion: 0.09
...
### Community 154 - "test"
Cohesion: 0.04
Nodes (27): Fixtures, HONCHO_STATS_ENABLED, HONCHO_SYNC_DEFAULT, MEMORY_PROVIDER_DEFAULT, MemoryProviderMockOptions, MockState, test, LIVE_BOARD (+19 more)
...
### Community 158 - "Hal0MemoryProvider"
Cohesion: 0.10
...
### Community 161 - "test_setup_install.py"
Cohesion: 0.07
...
### Community 164 - "SecurityPage.jsx"
Cohesion: 0.08
...
### Community 165 - "test_exposure.py"
Cohesion: 0.06
Nodes (40): BaseRoute, Matcher, classify(), _exact(), match_rule(), _outside_api_v1_mcp(), _prefix(), Route -> :class:`AuthClass` classification table (KB-1 / §1, seam S9).  Single s (+32 more)

### Community 166 - "HermesDriver"
Cohesion: 0.07
...
### Community 169 - "test_hal0_provider_plugin.py"
Cohesion: 0.09
...
### Community 174 - "test_notes.py"
Cohesion: 0.09
Nodes (31): extract_changelog_section(), extract_structured(), Changelog / release-notes helpers shared by the release + nightly workflows.  Pu, Return the body of the ``## [<version>]`` section of a Keep-a-Changelog     docu, Pull the optional ``### Highlights`` / ``### Breaking`` / ``### Migrations``, Unit tests for hal0.release.notes — the CHANGELOG section extractor., v0.5.1 must NOT match ## [v0.5.10-alpha.1]., Querying v0.5.10 must NOT match ## [v0.5.1-alpha.1]. (+23 more)
...
### Community 176 - "plan_slot_flags_fold"
Cohesion: 0.11
...
### Community 178 - "test_agent_uninstall_memory.py"
Cohesion: 0.12
...
### Community 181 - "_llama_launch_plan"
Cohesion: 0.07
...
### Community 182 - "test_kb1_hardening_tail.py"
Cohesion: 0.07
...
### Community 190 - "_write_diagnostics_section"
Cohesion: 0.11
...
### Community 192 - "test_profile_derive.py"
Cohesion: 0.06
...
### Community 199 - "test_doctor_json_diagnoses.py"
Cohesion: 0.09
...
### Community 202 - "test_mtp_override.py"
Cohesion: 0.09
...
### Community 203 - "test_hindsight_provider.py"
Cohesion: 0.09
...
### Community 204 - "resolve_gpu_group_ids"
Cohesion: 0.07
Nodes (26): Build the GPU/llama-server :class:`RuntimeLaunchPlan` for a slot.          This, _device_node_for_group(), gpu_visibility_env(), is_nvidia_gpu_device(), nvidia_cdi_devices(), _probed_gpu_group_gids(), Shared helpers for GPU device + group exposure to provider containers.  Lives he, Return numeric GIDs for the host's GPU access groups (render, video).      Fallb (+18 more)
...
Cohesion: 0.11
Nodes (31): _admin_key(), AuthPrincipal, _client_key(), _config_require_auth(), _consteq(), _cookie_value(), _decide(), _env_key() (+23 more)
...
### Community 211 - "test_model_meta.py"
Cohesion: 0.12
...
### Community 212 - "test_modality.py"
Cohesion: 0.14
...
### Community 213 - "test_contract_compatibility.py"
Cohesion: 0.06
...
### Community 214 - "test_v1_npu_trio_routing.py"
Cohesion: 0.09
...
### Community 216 - "apiMock.ts"
Cohesion: 0.09
Nodes (12): BOARD_ASSIGNEES, BOARD_BOARDS, BOARD_CONFIG, BOARD_ORCH_DEFAULT, BOARD_PROFILES, BOARD_STATS, BOARD_TASKS, BOARD_TENANTS (+4 more)
...
### Community 218 - "test_openrouter_auth_loopback.py"
Cohesion: 0.09
...
### Community 219 - "run_migrations"
Cohesion: 0.06
Nodes (39): Migration, config_migrate(), Migrate hal0.toml forward to the latest config schema version.      Reads ``meta, _deep_copy_dict(), latest_version(), MigrationError, Any, hal0.config.migrations — versioned config migration transforms.  # TIER3: config (+31 more)

### Community 220 - "_profile"
Cohesion: 0.09
...
### Community 226 - "§17 installer/setup overhaul — edit-plan (thin shell + thick Python, one profile authority, one slot roster)"
Cohesion: 0.06
...
### Community 227 - "P3 slot-identity + ports — implementation spec"
Cohesion: 0.06
...
### Community 230 - "die"
Cohesion: 0.11
Nodes (28): board_move(), Move a task to a different lane (PATCH /api/board/tasks/{id})., _api_reachable(), api_get_bytes(), api_patch(), _api_request(), api_stream(), api_unreachable_exit() (+20 more)

### Community 231 - "slot_flags_fold.py"
Cohesion: 0.08
...
### Community 233 - "_resolve_image_ref"
Cohesion: 0.10
...
### Community 234 - "test_update_check.py"
Cohesion: 0.09
...
### Community 235 - "compute_config_drift"
Cohesion: 0.09
...
### Community 236 - "test_installer_routes.py"
Cohesion: 0.09
...
### Community 237 - "test_typed_errors.py"
Cohesion: 0.10
...
### Community 238 - "test_update_commands.py"
Cohesion: 0.08
...
### Community 240 - "test_hf_token_secrets.py"
Cohesion: 0.06
...
### Community 242 - "test_v1_chat_slot_alias.py"
Cohesion: 0.13
...
### Community 243 - "hw_slot_ownership.py"
Cohesion: 0.10
...
### Community 245 - "test_chat_normalization.py"
Cohesion: 0.11
...
### Community 246 - "test_slots_container_state.py"
Cohesion: 0.09
...
### Community 247 - "test_brain_injection.py"
Cohesion: 0.17
...
### Community 250 - "Hal0MemoryClient"
Cohesion: 0.09
...
### Community 259 - "test_metrics_prometheus_route.py"
Cohesion: 0.09
...
### Community 262 - "test_stacks_routes.py"
Cohesion: 0.14
...
### Community 265 - "browser_server.py"
Cohesion: 0.10
...
### Community 266 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.06
...
### Community 274 - "Platform-wide cron/automation management — design"
Cohesion: 0.06
...
### Community 276 - "hal0 ROCmFPX quantization"
Cohesion: 0.06
...
### Community 280 - "store.py"
Cohesion: 0.08
Nodes (36): assert_under_store(), by_id_dir(), entry_pointer(), file_dest(), finalize_perms(), _fstype_from_proc_mounts(), is_nfs_path(), model_dir() (+28 more)

### Community 281 - "find_candidates"
Cohesion: 0.11
...
### Community 282 - "test_brain_resilience.py"
Cohesion: 0.16
...
### Community 283 - "ML-2 (file-set pulling) + ML-3 (unified store) — implementation spec"
Cohesion: 0.06
...
### Community 288 - "import_toml_to_sqlite"
Cohesion: 0.12
...
### Community 292 - "test_doctor_all.py"
Cohesion: 0.08
...
### Community 293 - "test_preflight_gpu_gate.py"
Cohesion: 0.10
...
### Community 298 - "Hal0Error"
Cohesion: 0.06
Nodes (49): RequestValidationError, Request, Restart endpoint for bundled agents (v0.3 PR-11).  ``POST /api/agents/{agent_id}, Restart the systemd unit backing ``agent_id``.      Returns ``{status, detail}``, Resolve ``systemctl`` on PATH.      Returns ``None`` on hosts that don't have sy, Compose the unit name for an agent id.      Matches ``installer/systemd/hal0-age, Identify the caller for the audit log.      There is no Bearer token store (auth, _resolve_actor() (+41 more)

### Community 299 - "api_get"
Cohesion: 0.12
Nodes (31): Uninstall a user-installed MCP server. Bundled servers reject 409., uninstall_cmd(), bank_consolidate_cmd(), bank_delete_cmd(), bank_export_cmd(), bank_import_cmd(), bank_list_cmd(), bank_stats_cmd() (+23 more)
...
### Community 301 - "load_stacks_config"
Cohesion: 0.10
Nodes (16): Atomically write the full stack catalog to stacks.toml.      The written file is, save_stacks_config(), Path, StacksCatalog — read and mutate the stack catalog through one interface.  A stac, A stack plus derived fields (slug + seed flag) for API/UI consumption., Read and mutate the stack catalog through one interface., Replace the stack body wholesale (PUT semantics)., ResolvedStack (+8 more)

### Community 302 - "ModelsConfig"
Cohesion: 0.09
Nodes (12): ModelsConfig, [models] section of hal0.toml — discovery + auto-detect., Empty means "env var / FLM default cache"; non-empty must be absolute., Roots the discovery scan actually walks: declared ``roots`` plus the         eff, Reject relative paths — discovery walks must start from an absolute root., Empty means "use pull_root"; non-empty must be absolute., Return the resolved model-store path consumers should point at.          Precede, Tests for ModelsConfig — schema defaults + absolute-path validator. (+4 more)

### Community 303 - "memory.py"
Cohesion: 0.23
Nodes (21): _iso_now(), _memory_add(), _memory_delete(), _memory_list(), _memory_recall(), _memory_search(), MemorySchemaError, _normalise_tags() (+13 more)

### Community 304 - "tools_by_name"
Cohesion: 0.28
...
### Community 305 - "flm_served_models"
Cohesion: 0.07
...
### Community 307 - "test_agents_personas.py"
Cohesion: 0.15
...
### Community 316 - "P3-slots: Decomposition Spec for `slots/manager.py`"
Cohesion: 0.07
...
### Community 317 - "config.py"
Cohesion: 0.08
Nodes (37): _openwebui_url(), _probe_comfyui(), _probe_hermes(), _probe_openwebui(), Any, GET /api/services/health — dashboard services health aggregator.  Returns a stab, Real reachability probe — GET <loopback>/health on OpenWebUI.      SpikeB §5.4 c, Aggregate health of the four known hal0 companion services.      Response shape: (+29 more)

### Community 318 - "orchestrate_models"
Cohesion: 0.11
...
### Community 320 - "test_auth_rotate.py"
Cohesion: 0.09
...
### Community 323 - "test_hal0_memory_client.py"
Cohesion: 0.10
...
### Community 324 - "test_config_urls.py"
Cohesion: 0.10
...
### Community 325 - "FakeUpstreamRegistry"
Cohesion: 0.05
Nodes (56): Dispatcher, _filter_response_headers(), AsyncClient, Response, StreamingResponse, Emit one structured log line per dispatch decision (Tier 2)., Drop hop-by-hop and length headers so Starlette can recompute them., A fully-resolved routing decision ready to be forwarded.      Mirrors the shape (+48 more)

### Community 326 - "Tier 2 — medium (one PR each)"
Cohesion: 0.07
...
### Community 327 - "PART 0 — Current registry, mapped (file:line)"
Cohesion: 0.07
...
### Community 333 - "merge_slot_config"
Cohesion: 0.06
Nodes (56): _comfyui_models_dir(), _dir_size(), _discard_partial(), _final_path(), _final_path_for_entry(), _flm_install_path(), list_persisted_jobs(), _maybe_hardlink_from_blob() (+48 more)

### Community 334 - "_fake_run"
Cohesion: 0.08
...
### Community 335 - "test_v1_audio.py"
Cohesion: 0.13
...
### Community 336 - "test_pressure_eviction.py"
Cohesion: 0.20
...
### Community 338 - "Recommended hal0 ideas"
Cohesion: 0.07
...
### Community 339 - "hal0 Hermes Integration Suite Implementation Plan"
Cohesion: 0.07
...
### Community 340 - "Hal0MemoryClient"
Cohesion: 0.09
...
Cohesion: 0.17
Nodes (16): _cd_to_tmp(), _load_set_version(), _populate_project(), Path, Tests for scripts/set-version.py — atomic version synchronization.  Hermetic: us, Replace the PEP 440 version line for ``name = "hal0ai"``., Tests for set_version() core logic., set_version writes SemVer to all public files, PEP 440 to hal0ai         lock pa (+8 more)
...
### Community 348 - "test_agent_restart_endpoint.py"
Cohesion: 0.18
...
### Community 349 - "test_memory_subgraph.py"
Cohesion: 0.09
...
### Community 352 - "test_npu_occupancy.py"
Cohesion: 0.15
...
### Community 358 - "main.jsx"
Cohesion: 0.04
Nodes (53): useComfyui(), bundleNameOr(), InstallState, InstallStateBundle, useInstallState(), DEMO_MIGRATION_REPORT, EMPTY_MIGRATION_REPORT, MigrationFlagConflict (+45 more)

### Community 359 - "Request"
Cohesion: 0.06
Nodes (76): DispatcherDep, _aggregate_models(), audio_speech(), audio_transcriptions(), _capability_slot_for_path(), chat_completions(), completions(), _dispatch_and_forward() (+68 more)

### Community 360 - "ML-4 (runner-image registry) + ML-5 (flag resolution) — implementation-ready spec"
Cohesion: 0.08
...
### Community 361 - "R5 — Surface + launch"
Cohesion: 0.08
...
### Community 364 - "HermesBoardExecutor"
Cohesion: 0.15
...
### Community 365 - "test_doctor_profiles.py"
Cohesion: 0.17
Nodes (20): _main(), _no_duplicate_keys(), Path, object_pairs_hook that rejects duplicate keys., Write *data* as pretty-printed JSON to *path*., Replace the version of the ``hal0ai`` editable package in uv.lock., Write *content* to a tempfile in *tmpdir*, return the temp path., Atomically update all version fields to *version*.      Args:         root: Repo (+12 more)

### Community 366 - "test_emit_answers.py"
Cohesion: 0.14
...
### Community 377 - "test_id_keying.py"
Cohesion: 0.20
...
### Community 379 - "test_prewire_smoke.py"
Cohesion: 0.10
...
### Community 380 - "What You Must Do When Invoked"
Cohesion: 0.08
...
### Community 382 - "hal0 benchmarking system — full design (batch runs, rich run detail, display, auto-update)"
Cohesion: 0.08
...
### Community 385 - "read_gguf_header"
Cohesion: 0.18
...
### Community 391 - "test_dashboard_layout.py"
Cohesion: 0.11
...
### Community 392 - "test_logs_routes.py"
Cohesion: 0.11
...
### Community 393 - "_seed_slot_toml"
Cohesion: 0.08
Nodes (25): npu_trio_slot_root(), coresident_group must key off device==npu, not the legacy slot names.      Deplo, A disabled sibling slot doesn't claim coresident membership., Lay down the NPU FLM trio (agent + stt-npu + embed-npu) on disk., No enable_thinking in TOML → payload reports it as null (effective OFF)., rope_freq_base set on disk → exposed in /api/slots payload., PUT /api/slots/{name}/config with model.rope_freq_base persists the value     an, PR-18: ``labels`` is lifted from ``[model] labels = [...]``.      The dashboard' (+17 more)

### Community 394 - "test_v1_models_filters.py"
Cohesion: 0.20
...
### Community 397 - "Changelog"
Cohesion: 0.08
Nodes (23): [0.9.2] — 2026-07-05, [0.9.4.1] — 2026-07-08, [0.9.5.2] — 2026-07-09, Added, Changed, Changed, Changed, Changelog (+15 more)

### Community 398 - "hal0 installer"
Cohesion: 0.08
...
### Community 400 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.08
...
### Community 401 - "hal0 1.0 — Seeded profile rework"
Cohesion: 0.08
...
### Community 402 - "test_hw_slot_ownership_migration.py"
Cohesion: 0.23
...
### Community 403 - "applied_versions"
Cohesion: 0.11
...
### Community 404 - "seed_static_slots"
Cohesion: 0.17
...
### Community 406 - "_container_cgroup_mem_bytes"
Cohesion: 0.13
...
### Community 408 - "test_run_as_hal0_guard.py"
Cohesion: 0.13
...
### Community 413 - "test_installed.py"
Cohesion: 0.11
...
### Community 414 - "test_npu_columns.py"
Cohesion: 0.15
...
### Community 418 - "map_backend_to_device"
Cohesion: 0.13
...
### Community 419 - "provision_comfyui_downloads"
Cohesion: 0.13
...
### Community 420 - "HindsightRestClient"
Cohesion: 0.12
...
### Community 421 - "MemoryNamespaceError"
Cohesion: 0.10
...
### Community 422 - "apply_thinking_policy"
Cohesion: 0.15
...
### Community 424 - "container_enrichment"
Cohesion: 0.22
...
### Community 425 - "NpuExclusivityViolation"
Cohesion: 0.12
Nodes (22): NpuExclusivityViolation, Two ``device=npu, type=llm, enabled=true`` slots cannot coexist.      The AMDXDN, ConvergeReport, What converge() did, per slot. Failures are recorded, not raised., Path, NPU exclusivity validation in SlotManager (PR-11, plan §5.3, ADR-0008 §5).  The, A disabled second NPU LLM slot may coexist with an enabled one., device=gpu-rocm slots are unaffected by NPU exclusivity. (+14 more)

### Community 426 - "read_stack_state"
Cohesion: 0.14
Nodes (14): Report the active stack and whether live config has drifted from it.          ``, Any, Path, Active-stack pointer + content hashing for drift detection (spec §7).  Mirrors t, Which stack is applied, the hash of what it wrote, and whether converge     brou, sha256 over the canonical slot→TOML-dict projection.      Canonical serializatio, Persist the active-stack pointer atomically (tmpfile + fsync + replace)., Read the active-stack pointer, or ``None`` when absent or corrupt.      A missin (+6 more)

### Community 427 - "embed_references"
Cohesion: 0.16
...
### Community 428 - "test_agent_memory_stats_endpoint.py"
Cohesion: 0.16
...
### Community 429 - "test_backends_npu_canonical_fields.py"
Cohesion: 0.13
...
### Community 432 - "test_settings_models_store.py"
Cohesion: 0.17
...
### Community 433 - "Path"
Cohesion: 0.09
Nodes (23): Path, When NPU LLM anchor is enabled, all three trio slots get coresident_group., GET /api/slots/{name} is enriched same shape as the list endpoint., Labels list is omitted (not empty) when the slot config has no     ``model.label, A failing container health probe doesn't break /api/slots.      The enrichment s, device=npu slots surface declared_backend='flm' (the FLM recipe)., POST /api/slots/chat/load goes through ContainerProvider.load_sync., GET /api/slots/doesntexist/config → 404 slot.not_found.      Pre-issue-#35 the r (+15 more)

### Community 434 - "_RecordingSlotManager"
Cohesion: 0.14
...
### Community 437 - "FakeContainerProvider"
Cohesion: 0.10
...
### Community 441 - "UI drawers — slot/model/profile editors"
Cohesion: 0.09
...
### Community 442 - "hal0 Settings Menu — Wireframe / IA"
Cohesion: 0.09
...
### Community 444 - "test_hermes_upgrade.py"
Cohesion: 0.20
...
### Community 445 - "dashboard_layout.py"
Cohesion: 0.12
...
### Community 446 - "test_tts_request_defaults.py"
Cohesion: 0.15
...
### Community 447 - "test_slot_config_validation.py"
Cohesion: 0.20
...
### Community 448 - "test_profile_derivation_parity.py"
Cohesion: 0.19
Nodes (12): _build_gguf(), _enc_kv(), Path, Unit tests for hal0.registry.gguf_header.  We fabricate minimal GGUF headers in-, Header claims 5 KVs but file ends before any are present., First KV parses, second is truncated., Assemble a GGUF header with the given KV list.      Tensor info / data sections, TestArchitectureAndContextLength (+4 more)

### Community 449 - "run_verify"
Cohesion: 0.15
...
### Community 450 - "memory_commands.py"
Cohesion: 0.11
Nodes (22): advertise_upstream(), create_upstream(), credentials_set(), _do_set_credentials(), _filters_summary(), list_upstreams(), _print_json(), Any (+14 more)

### Community 451 - "migrate_unify_cmd"
Cohesion: 0.15
Nodes (21): honcho_render_env_cmd(), Sync Honcho conclusions → Hindsight (resumes from the saved watermark).      Equ, Render ``/etc/hal0/honcho.env`` from ``hal0.toml [honcho]`` and (best-effort) re, sync_graph_cmd(), _derived_tags(), _document_ids(), _load_honcho_cli_config(), migrate_default() (+13 more)

### Community 452 - "__init__.py"
Cohesion: 0.15
...
### Community 455 - "test_hermes_env_seam.py"
Cohesion: 0.15
...
### Community 457 - "test_providers.py"
Cohesion: 0.14
...
### Community 458 - "test_services_page.py"
Cohesion: 0.14
...
### Community 459 - "test_v1_proxy.py"
Cohesion: 0.14
...
### Community 460 - "test_virtual_models.py"
Cohesion: 0.17
...
### Community 461 - "test_brain_framing.py"
Cohesion: 0.23
...
### Community 462 - "test_trio_status_inheritance.py"
Cohesion: 0.18
...
### Community 463 - "test_doctor_verify.py"
Cohesion: 0.12
...
### Community 467 - "Dashboard Overhaul — FROZEN DATA CONTRACT (v1)"
Cohesion: 0.09
...
### Community 470 - "P2-config: Collapse capabilities.toml double-bookkeeping"
Cohesion: 0.10
...
### Community 472 - "slots_config_dir"
Cohesion: 0.24
...
### Community 473 - "ModelVariant"
Cohesion: 0.15
Nodes (21): _api_port(), _behind_proxy(), _comfyui_link(), get_urls(), _host_without_port(), _openwebui_is_active(), Request, ValidationError (+13 more)

### Community 474 - "test_fetch_ws_g.py"
Cohesion: 0.14
...
### Community 475 - "unknown_slot_config_keys"
Cohesion: 0.14
...
### Community 476 - "migrate_slot_id_keying"
Cohesion: 0.14
...
### Community 477 - "test_hermes_provision_honcho.py"
Cohesion: 0.16
...
### Community 478 - "test_memory_admin_document_transfer.py"
Cohesion: 0.20
...
### Community 479 - "test_pull_shutdown.py"
Cohesion: 0.17
...
### Community 480 - "TestClient"
Cohesion: 0.13
Nodes (21): isolated_client(), FastAPI, TestClient, Real SlotManager entries appear alongside synthetic upstream-backed ones., When a real slot and a synthetic share a name, the real one wins., P2-composite rebuild: no ``hal0`` Upstream is registered at startup.      Chat d, An explicit upstreams.toml entry for ``hal0`` survives startup unchanged.      O, Driving a state change through the manager pushes a frame to the stream.      Su (+13 more)

### Community 481 - "test_throughput_history.py"
Cohesion: 0.19
...
### Community 482 - "test_eligibility.py"
Cohesion: 0.10
...
### Community 483 - "test_disabled_capability_slot_is_not_woken"
Cohesion: 0.20
...
### Community 484 - "Security review — v1.0 auth surface (2026-05-21)"
Cohesion: 0.10
...
### Community 485 - "_write_fake_python"
Cohesion: 0.20
...
### Community 486 - "test_approval_queue.py"
Cohesion: 0.13
...
### Community 487 - "test_manager_npu_container.py"
Cohesion: 0.20
...
### Community 488 - "ModelRegistry"
Cohesion: 0.12
Nodes (21): disable_cmd(), enable_cmd(), graph_disable_cmd(), graph_enable_cmd(), graph_status_cmd(), provider_list_cmd(), provider_set_cmd(), Any (+13 more)

### Community 489 - "HealthStatsPage.jsx"
Cohesion: 0.12
...
### Community 490 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.10
...
### Community 496 - "MemoryGraphConfig"
Cohesion: 0.13
...
### Community 501 - "Any"
Cohesion: 0.10
Nodes (19): container_stub(), Any, A slot's enable_thinking + [model].n_gpu_layers ride along in the payload., rope_freq_base absent on disk → payload carries null (not 0.0)., #863: single-slot status includes argv drift without burdening list()., v0.1.x clients consuming /api/slots see every legacy key unchanged., The enriched body must be valid JSON (no exotic types leaked)., Loading a slot with no TOML returns the typed slot.not_found envelope. (+11 more)

### Community 502 - "test_memory_bank_commands.py"
Cohesion: 0.10
Nodes (3): MonkeyPatch, Tests for ``hal0 memory bank {list,stats,profile,export,import,delete,consolidat, stub_api()

### Community 503 - "test_memory_provider_commands.py"
Cohesion: 0.15
...
### Community 504 - "test_model_first_run_commands.py"
Cohesion: 0.17
...
### Community 505 - "test_model_store_root.py"
Cohesion: 0.14
...
### Community 506 - "TestEarlyHal0User"
Cohesion: 0.10
...
### Community 508 - "test_fail_watcher.py"
Cohesion: 0.18
...
### Community 509 - "profiles-crud-v3.spec.ts"
Cohesion: 0.10
...
### Community 510 - "0. Research-grounded findings that drive the matrix"
Cohesion: 0.11
...
### Community 518 - "test_models_add_from_path.py"
Cohesion: 0.20
...
### Community 520 - "test_port_registry.py"
Cohesion: 0.23
...
### Community 522 - "test_settings_routes.py"
Cohesion: 0.15
...
### Community 523 - ".json"
Cohesion: 0.11
Nodes (18): Slot with no [server] table → payload's llamacpp_args is null.      Mirror the e, PR-18: each entry carries ``type`` + ``model_default`` + ``enabled``.      The d, A slot carries declared_backend (normalized token) derived from its     configur, spec-hw-slot-ownership §4: a (device, BINARY) pair whose device backend     is n, An EXISTING slot with malformed TOML still surfaces 400 slot.config_error., DELETE ?force=true binds + forwards to the manager and echoes ``forced``.      ', Enabling a 2nd NPU LLM anchor → 409 with the exclusivity message, no write., Regression: the slot-edit Save's ``PATCH /defaults`` must not wipe the     model (+10 more)

### Community 524 - "FakeSlotManager"
Cohesion: 0.18
...
### Community 525 - "test_capabilities_commands.py"
Cohesion: 0.19
...
### Community 526 - "test_store_concurrency.py"
Cohesion: 0.19
...
### Community 531 - "2. Bugs (correctness — ordered by impact)"
Cohesion: 0.11
...
### Community 532 - "manage-slots.mdx"
Cohesion: 0.11
...
### Community 533 - "spec-kb23 — hal0-brain chat tool-tier, approval-gate & injection-resistance"
Cohesion: 0.11
...
### Community 534 - "hal0-admin tools"
Cohesion: 0.11
...
### Community 535 - "kokoro_server.py"
Cohesion: 0.14
...
### Community 537 - "ensure_podman_apparmor_usable"
Cohesion: 0.19
...
### Community 539 - "ProgressCoalescer"
Cohesion: 0.14
...
### Community 545 - "test_hermes_security_deliverables.py"
Cohesion: 0.15
...
### Community 546 - "test_mcp_client.py"
Cohesion: 0.18
...
### Community 549 - "test_models_preview.py"
Cohesion: 0.19
...
### Community 551 - "test_settings_apply.py"
Cohesion: 0.11
...
### Community 552 - "test_v1_dispatch.py"
Cohesion: 0.16
...
### Community 553 - "test_doctor_perms.py"
Cohesion: 0.19
...
### Community 558 - "test_logs_tail_redaction.py"
Cohesion: 0.11
...
### Community 559 - "_render_from_spec"
Cohesion: 0.26
...
### Community 560 - "test_curated_image_models.py"
Cohesion: 0.12
...
### Community 561 - "MapContainerProvider"
Cohesion: 0.20
...
### Community 563 - "board-chat-v3.spec.ts"
Cohesion: 0.14
...
### Community 564 - "3. Proposed seed catalog (one per type)"
Cohesion: 0.12
...
### Community 565 - "Slot config — capabilities ↔ slots reconciliation"
Cohesion: 0.12
...
### Community 566 - "hal0 Adoption Candidates — Lemonade + ODS (combined)"
Cohesion: 0.12
...
### Community 567 - "spec-hp-realtime — OpenAI Realtime WebSocket endpoint for hal0"
Cohesion: 0.12
...
### Community 568 - "P3-schema — `config/schema.py` decomposition: implementation-ready spec"
Cohesion: 0.12
...
### Community 569 - "bootstrap.sh"
Cohesion: 0.31
Nodes (14): banner(), cosign_verify(), die(), err(), fetch_and_hash_check(), fetch_manifest(), fetch_sidecar(), info() (+6 more)

### Community 570 - "agents.py"
Cohesion: 0.10
Nodes (23): _empty_stats(), get_agent_memory_stats(), _namespace_for(), Any, Request, Per-agent memory stats endpoint (v0.3 PR-11).  ``GET /api/agents/{agent_id}/memo, Return memory counters for the agent's private namespace.      Shape (documented, Compose the per-agent private dataset name.      Matches the resolver pattern :m (+15 more)

### Community 571 - "control.py"
Cohesion: 0.19
...
### Community 573 - "mcp_commands.py"
Cohesion: 0.12
Nodes (18): catalog_list_cmd(), catalog_refresh_cmd(), _find_server(), install_cmd(), list_cmd(), Any, hal0 mcp subcommands — thin HTTP client to /api/mcp/*.  Issue #504: ``hal0 mcp {, Show detail for one MCP server. (+10 more)

### Community 574 - "seeds.py"
Cohesion: 0.17
...
### Community 576 - "apply_extraction_slot"
Cohesion: 0.18
...
### Community 578 - "normalize_system_messages"
Cohesion: 0.18
...
### Community 580 - "config_enrichment"
Cohesion: 0.29
...
### Community 581 - "metrics_collect.py"
Cohesion: 0.15
...
### Community 582 - "snapshot_live_stack"
Cohesion: 0.17
...
### Community 583 - "test_mtp_defuse.py"
Cohesion: 0.29
...
### Community 584 - "test_hermes_state_render.py"
Cohesion: 0.12
...
### Community 585 - "test_slots_routes.py"
Cohesion: 0.21
...
### Community 586 - "_StubSlotManager"
Cohesion: 0.26
...
### Community 587 - "test_cli_auth_streamtest.py"
Cohesion: 0.21
...
### Community 588 - "Findings from the 2026-05-16 hal0-test deep-probe round"
Cohesion: 0.12
...
### Community 589 - "DelegateTaskSpec"
Cohesion: 0.18
...
### Community 590 - "test_preflight_ports_own_service.py"
Cohesion: 0.29
...
### Community 591 - "agents-overview.jsx"
Cohesion: 0.20
...
### Community 592 - "test_ttft_samples.py"
Cohesion: 0.12
...
### Community 597 - "hal0_gpu_gate.py"
Cohesion: 0.16
...
### Community 598 - "qwen3tts_server.py"
Cohesion: 0.16
...
### Community 599 - "AgentMCPClient"
Cohesion: 0.16
Nodes (13): MonkeyPatch, Test that ``_pull_root`` honours [models].store with pull_root fallback., persist_pull_job fsyncs the snapshot's parent dir after os.replace., A failed directory fsync stays fail-soft — the snapshot still lands., Backward compat — PR-#313 installs without `store` keep working., Drop a snapshot for ``model_id`` in ``state`` with an aged mtime., Old terminal snapshot is reaped; fresh terminal + old running survive., test_effective_store_picks_pull_root_fallback() (+5 more)

### Community 600 - "events.py"
Cohesion: 0.19
Nodes (15): _bus(), EventsInvalidQuery, EventsUnavailable, list_events(), _normalise_severity(), Any, Request, StreamingResponse (+7 more)

### Community 601 - "systemd.py"
Cohesion: 0.26
Nodes (11): Shared systemctl helpers for the companion-service management layer.  Until now, Return a ``.timer`` unit's calendar expression + last/next trigger.      Shape (, True when ``systemctl is-active <unit>`` reports ``active``., True when ``unit`` is a plausible systemd unit name., Run ``systemctl <args>``; (rc, stdout, stderr), rc=None on no-systemd/timeout., Return the unit's systemd state for display.      Shape (all values fail-soft)::, _run(), timer_schedule() (+3 more)

### Community 602 - "system_info_command.py"
Cohesion: 0.20
...
### Community 603 - "fetch.py"
Cohesion: 0.14
Nodes (20): _build_client(), _comfyui_base_url(), comfyui_invalid_workflow_launch(), comfyui_logs(), comfyui_preview(), comfyui_render_cancel(), comfyui_workflow_launch(), _get_client() (+12 more)

### Community 604 - "test_perms.py"
Cohesion: 0.33
...
### Community 605 - "route_to_chat.py"
Cohesion: 0.19
...
### Community 606 - "service_identity.py"
Cohesion: 0.14
...
### Community 607 - "RecordingSlotArtifactOps"
Cohesion: 0.22
...
### Community 608 - "test_hermes_provision_install_artifacts.py"
Cohesion: 0.17
...
### Community 609 - "test_agents_routes.py"
Cohesion: 0.21
...
### Community 610 - "test_mcp_identity.py"
Cohesion: 0.18
...
### Community 611 - "FakeDockerBackend"
Cohesion: 0.16
...
### Community 612 - "hal0 test harness — internal contributor guide"
Cohesion: 0.12
...
### Community 614 - "test_npu_trio_shadow.py"
Cohesion: 0.17
...
### Community 615 - "Model registry — registry, pulls, classification"
Cohesion: 0.13
...
### Community 616 - "Handoff: qwen3tts standalone → hal0-slot migration"
Cohesion: 0.13
...
### Community 617 - "Container Image System Overhaul"
Cohesion: 0.13
...
### Community 618 - "hal0 rework plan — de-scarring the launch"
Cohesion: 0.13
...
### Community 619 - "Handoff — fold rework→main merge/meld/fix follow-ups into the R5 docs"
Cohesion: 0.13
...
### Community 620 - "Handoff — hal0 R5 endgame (paste-in brief for a new session)"
Cohesion: 0.13
...
### Community 621 - "Findings (O-series)"
Cohesion: 0.13
...
### Community 623 - "hal0 Hermes Integration Suite Design"
Cohesion: 0.13
...
### Community 625 - "test_route_collisions.py"
Cohesion: 0.19
...
### Community 626 - "upsert_env_value"
Cohesion: 0.21
...
### Community 627 - "create_chat_template"
Cohesion: 0.24
...
### Community 628 - "test_slots_policy.py"
Cohesion: 0.20
...
### Community 633 - "write_openwebui_env"
Cohesion: 0.14
...
### Community 636 - "test_hermes_provision_kanban_db_init.py"
Cohesion: 0.20
...
### Community 637 - "test_persona_update.py"
Cohesion: 0.25
...
### Community 638 - "test_slots_npu_fields.py"
Cohesion: 0.15
...
### Community 639 - "test_brain_ctx_precheck.py"
Cohesion: 0.12
Nodes (13): BrainChatConfig, ``[brain_chat]`` — the dashboard's agent-chat steward (hal0-brain).      Guardra, _drive(), _FakeKanban, Any, Pre-flight context guard: a prompt over the resolved slot's context window emits, _RecordingLLM, _request() (+5 more)

### Community 640 - "test_tiers.py"
Cohesion: 0.13
...
### Community 642 - "test_pool_bounds.py"
Cohesion: 0.15
...
### Community 644 - "test_admin_route_map.py"
Cohesion: 0.17
...
### Community 645 - "test_container_mmproj.py"
Cohesion: 0.31
...
### Community 646 - "test_device_profile_coherence.py"
Cohesion: 0.18
...
### Community 647 - "test_integrations.py"
Cohesion: 0.13
...
### Community 650 - "Toolbox Repo Consolidation"
Cohesion: 0.14
...
### Community 651 - "obtain-models.mdx"
Cohesion: 0.14
...
### Community 652 - "Deploy halves of the "CI here" scenarios"
Cohesion: 0.14
...
### Community 653 - "PART 2 — DELIVERABLES"
Cohesion: 0.14
...
### Community 654 - "0. EXACT Honcho footprint (file:line)"
Cohesion: 0.14
...
### Community 655 - "P2-device: make `device` the sole truth, delete the `backend` dual-write"
Cohesion: 0.14
...
### Community 656 - "Handoff — R5 drive 2: put it back together (paste-in prompt, Fable orchestrator)"
Cohesion: 0.14
...
### Community 657 - "hal0 1.0 Seeded Profile Rework — Implementation Plan"
Cohesion: 0.14
...
### Community 659 - "Phase 4 handoff — halo143 deploy window"
Cohesion: 0.14
...
### Community 660 - "test_ports_command.py"
Cohesion: 0.28
...
### Community 661 - "test_moonshine_server.py"
Cohesion: 0.22
...
### Community 666 - "heal_missing_llm_type"
Cohesion: 0.20
...
### Community 667 - "provider_requires_model"
Cohesion: 0.22
...
### Community 668 - "test_hermes_provision_context.py"
Cohesion: 0.14
...
### Community 669 - "test_middleware.py"
Cohesion: 0.21
...
### Community 670 - "test_services_health.py"
Cohesion: 0.27
...
### Community 671 - "test_board_etag.py"
Cohesion: 0.18
...
### Community 672 - "test_brain_chat.py"
Cohesion: 0.23
...
### Community 673 - "test_catalog_backends.py"
Cohesion: 0.19
...
### Community 674 - "test_auth_commands.py"
Cohesion: 0.23
...
### Community 675 - "test_memory_ops_commands.py"
Cohesion: 0.16
...
### Community 676 - "test_slot_verb_aliases.py"
Cohesion: 0.16
...
### Community 677 - "test_hal0_gpu_gate.py"
Cohesion: 0.22
...
### Community 678 - "test_image_pin.py"
Cohesion: 0.14
...
### Community 680 - "test_flm_store_link.py"
Cohesion: 0.26
...
### Community 682 - "test_adopted_slot_eviction.py"
Cohesion: 0.23
...
### Community 683 - "test_dispatchable_ready_set_single_source.py"
Cohesion: 0.14
...
### Community 684 - "test_restart_errored_slot.py"
Cohesion: 0.26
...
### Community 687 - "Contributor Covenant Code of Conduct"
Cohesion: 0.15
Nodes (12): 1. Correction, 2. Warning, 3. Temporary Ban, 4. Permanent Ban, Attribution, Contributor Covenant Code of Conduct, Enforcement, Enforcement Guidelines (+4 more)

### Community 688 - "3. Recommendation: how hal0 should support ONNX"
Cohesion: 0.15
...
### Community 689 - "Dispatch / runtime — routing, arbiter, lifecycle"
Cohesion: 0.15
...
### Community 692 - "pull-and-register-models.mdx"
Cohesion: 0.15
...
### Community 693 - "hal0 rework — handoff: single primary orchestrator (R3-B / R4 / R5 + finish line)"
Cohesion: 0.15
...
### Community 694 - "Changes Applied (then rolled back)"
Cohesion: 0.15
...
### Community 695 - "hal0 codebase map"
Cohesion: 0.15
...
### Community 696 - "hal0 service management"
Cohesion: 0.15
...
### Community 697 - "Code Context — PR #1324 Test-Failure Archaeology (Workload-Profile Renames + Slot-Owned Image/Device Changes)"
Cohesion: 0.15
...
### Community 698 - "Code Context — PR #1324 Test-Failure Archaeology (Workload-Profile Renames + Slot-Owned Image/Device Changes)"
Cohesion: 0.15
Nodes (12): Architecture, Code Context — PR #1324 Test-Failure Archaeology (Workload-Profile Renames + Slot-Owned Image/Device Changes), Constraints & Risks, Directly Reusable Test-Fix Commits, Files Retrieved, FLAGS-own architecture (d4253f8f), Key Code, Reusability Summary (+4 more)

### Community 699 - "QueryStringScrubber"
Cohesion: 0.18
...
### Community 700 - "proxy_board_events"
Cohesion: 0.21
...
### Community 704 - "test_containers_apparmor.py"
Cohesion: 0.37
...
### Community 705 - "test_hermes_live_resolve_render.py"
Cohesion: 0.23
...
### Community 706 - "test_activity.py"
Cohesion: 0.31
...
### Community 707 - "test_activity_routes_instrumented.py"
Cohesion: 0.38
...
### Community 708 - "test_comfyui_fetch_route.py"
Cohesion: 0.15
...
### Community 709 - "test_events_fixes.py"
Cohesion: 0.16
...
### Community 710 - "test_memory_graph_commands.py"
Cohesion: 0.15
...
### Community 711 - "test_model_verbs.py"
Cohesion: 0.26
...
### Community 717 - "Recently added endpoints"
Cohesion: 0.17
...
### Community 718 - "HW-slot-ownership — hardware sticks to slots, logical tune sticks to models"
Cohesion: 0.17
...
### Community 719 - "Design — 3-tier, deny-by-default, single classification source"
Cohesion: 0.17
...
### Community 720 - "hal0 UI/UX design brief — post-R3 surface rework"
Cohesion: 0.17
...
### Community 723 - "Release pipeline — prototype findings + blockers"
Cohesion: 0.17
...
### Community 724 - "release-test.sh"
Cohesion: 0.35
Nodes (9): add_row(), cleanup(), log_err(), log_info(), log_step(), log_warn(), remote_slot_create(), release-test.sh script (+1 more)

### Community 725 - ".__init__"
Cohesion: 0.18
Nodes (17): find_candidates(), _is_mmproj_sidecar(), _is_skippable(), _match_curated(), Path, Model discovery — scan filesystem roots and auto-register found models.  The sca, Return the curated entry whose ``hf_file`` equals ``filename``., True for a multimodal-projector (mmproj) sidecar file.      Matched by filename (+9 more)

### Community 726 - "BundleManifest"
Cohesion: 0.21
...
### Community 727 - "MemoryDispatcher"
Cohesion: 0.09
...
### Community 729 - "ModelCapabilities"
Cohesion: 0.16
...
### Community 732 - "test_agent_status.py"
Cohesion: 0.23
...
### Community 734 - "test_system_info.py"
Cohesion: 0.26
...
### Community 735 - "test_stacks_schema.py"
Cohesion: 0.12
...
### Community 736 - "test_stats_gpu_view_delegation.py"
Cohesion: 0.17
Nodes (16): config_edit(), config_hardware(), _config_path(), config_reload(), config_show(), ConfigFile, _hal0_toml_path(), Path (+8 more)

### Community 737 - "test_comfyui_scripts_shipped.py"
Cohesion: 0.17
...
### Community 739 - "memory-tools.jsx"
Cohesion: 0.21
Nodes (5): MemDocuments(), MemRecallConsole(), mtDocTitle(), mtDocWhen(), mtFactColor()

### Community 740 - "`hal0-setup.yaml` — headless answer-file spec (2026-07-05)"
Cohesion: 0.18
...
### Community 741 - "Findings → fixes, by tier"
Cohesion: 0.18
...
### Community 742 - "Handoff: model-pipeline plan — finish-out pass"
Cohesion: 0.18
...
### Community 743 - "Hal0 Upstream Controls — Epic Plan (2026-07-06)"
Cohesion: 0.18
...
### Community 744 - "capabilities-and-profiles.mdx"
Cohesion: 0.18
...
### Community 745 - "Admin tools (`/mcp/admin`)"
Cohesion: 0.18
...
### Community 746 - "providers-profiles-devices.mdx"
Cohesion: 0.18
...
### Community 747 - "slot-lifecycle.mdx"
Cohesion: 0.18
...
### Community 748 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
...
### Community 749 - "Both-boxes deploy-validation runbook — rework-R4-stage"
Cohesion: 0.18
...
### Community 750 - "P3-brain — Implementation-Ready Spec: hal0-brain as a first-class module"
Cohesion: 0.18
...
### Community 751 - "PART D — Edit plan (files, order, delegators/shims)"
Cohesion: 0.18
...
### Community 752 - "hal0 Hermes Plugin Suite — BUILD Spec (verified vs code @ `rework/descar`)"
Cohesion: 0.18
...
### Community 753 - "Hermes Agent official integration research for the hal0 rework"
Cohesion: 0.18
...
### Community 754 - "2. Proposed hal0 plugin suite"
Cohesion: 0.18
...
### Community 755 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
Nodes (10): Board row = the machine-readable record, Checkpoint (R1–R5) → main, hal0 rework — board tracking protocol (paste-in prompt), Hard rules (never violate), Lifecycle of a lane (how a row moves), Migration-window lanes, Monitor, Reusable agent-dispatch prompt skeleton (+2 more)

### Community 756 - "check_sunset.py"
Cohesion: 0.38
Nodes (10): Match, current_version(), _fmt(), main(), overdue_markers(), ProjectVersion, _py_files(), Path (+2 more)

### Community 757 - "types.py"
Cohesion: 0.12
...
### Community 765 - "rerender_slot_units"
Cohesion: 0.29
...
### Community 766 - "test_hermes_provision_collect.py"
Cohesion: 0.25
...
### Community 768 - "test_config_model_roots.py"
Cohesion: 0.29
...
### Community 769 - "test_doctor_route.py"
Cohesion: 0.24
...
### Community 770 - "test_features_health.py"
Cohesion: 0.25
...
### Community 771 - "test_meta_enums.py"
Cohesion: 0.42
...
### Community 773 - "test_server_ab_helpers.py"
Cohesion: 0.22
...
### Community 774 - "test_board_commands.py"
Cohesion: 0.27
...
### Community 775 - "test_serve_bind_host.py"
Cohesion: 0.31
...
### Community 776 - "test_fetch_scripts.py"
Cohesion: 0.18
...
### Community 777 - "hal0 test-harness — findings"
Cohesion: 0.18
...
### Community 780 - "test_api_wiring.py"
Cohesion: 0.24
...
### Community 781 - "test_npu_trio_reconcile.py"
Cohesion: 0.45
...
### Community 785 - "honcho-memory.mdx"
Cohesion: 0.20
...
### Community 786 - "7. Product-shaped reworks (from the six field notes)"
Cohesion: 0.20
...
### Community 787 - "FLAGS-own — llama.cpp flags stick to models; profiles become templates"
Cohesion: 0.20
...
### Community 788 - "hal0 SETTINGS rework — implementation-ready spec"
Cohesion: 0.20
...
### Community 789 - "Slot / Model / Profile / Flags / Image — reworked runtime model (R3)"
Cohesion: 0.20
...
### Community 790 - "Global Constraints"
Cohesion: 0.20
...
### Community 791 - "Dashboard Plugin JS Loading Internals"
Cohesion: 0.20
...
### Community 799 - "_normalize_chat_body"
Cohesion: 0.14
...
### Community 802 - "ops_retry_cmd"
Cohesion: 0.10
Nodes (26): doctor_logs(), Print or follow hal0-api's own systemd journal.      ``hal0 slot logs`` covers p, mm_history_cmd(), mm_list_cmd(), mm_refresh_cmd(), ``hal0 memory mm`` — mental-model admin (list / refresh / history)., List a bank's mental models., Trigger a refresh of a mental model (async). (+18 more)

### Community 803 - "resolve_chat_template"
Cohesion: 0.27
...
### Community 805 - "collect_port_claims"
Cohesion: 0.29
...
### Community 807 - "TestStatusTelemetry"
Cohesion: 0.17
...
### Community 809 - "test_models_pull_capability.py"
Cohesion: 0.18
Nodes (11): capability_from_filename(), classify(), DeviceMeta, model_capabilities_of(), Any, model_meta — the one home for model classification + device→backend resolution., Return the primary modality bucket for a model.      Reads the model's ``capabil, Best-effort capability token inferred from a model filename.      Returns one of (+3 more)

### Community 810 - "TestClient"
Cohesion: 0.20
...
### Community 812 - "test_catalog_npu_stt.py"
Cohesion: 0.27
...
### Community 813 - "test_shared_auth.py"
Cohesion: 0.33
...
### Community 815 - "test_validate_catalog.py"
Cohesion: 0.24
...
### Community 818 - "test_curated_pull_coords.py"
Cohesion: 0.20
...
### Community 819 - "_configure_project"
Cohesion: 0.56
...
### Community 824 - "apply_capability"
Cohesion: 0.28
...
### Community 825 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 826 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 827 - "ROCmFPX bench — RESULTS + next-session handoff (2026-07-05)"
Cohesion: 0.22
...
### Community 828 - "connect-clients.mdx"
Cohesion: 0.22
...
### Community 829 - "connect-external-providers.mdx"
Cohesion: 0.22
...
### Community 830 - "realtime-voice.mdx"
Cohesion: 0.22
...
### Community 832 - "openai-compat.mdx"
Cohesion: 0.22
...
### Community 833 - "slot-as-model.mdx"
Cohesion: 0.22
...
### Community 834 - "env-vars.mdx"
Cohesion: 0.22
Nodes (8): Install & update, Memory & MCP, Models & providers, Paths, Runtime, See also, Server, Services

### Community 835 - "Handoff prompt — hal0-brain / template / profile changes on lxc105 (hal0, 10.0.1.142)"
Cohesion: 0.22
...
### Community 836 - "PART B — Target: Quadlet `.container` per slot (and per companion)"
Cohesion: 0.22
...
### Community 837 - "SWEEP inventory — the overlooked surface (R5 release-prep)"
Cohesion: 0.22
...
### Community 839 - "Dashboard plugin "Could not load this plugin's script""
Cohesion: 0.22
...
### Community 842 - "model_store_root"
Cohesion: 0.20
...
### Community 843 - "migrate_cognee_to_hindsight_dryrun"
Cohesion: 0.25
...
### Community 844 - "TestImageMismatch"
Cohesion: 0.36
...
### Community 845 - "test_hermes_stale_dropin_cleanup.py"
Cohesion: 0.47
...
### Community 846 - "isolated_client_with_root"
Cohesion: 0.33
...
### Community 848 - "test_catalog_flm_blacklist.py"
Cohesion: 0.28
...
### Community 850 - "test_config_show_edit_selector.py"
Cohesion: 0.50
...
### Community 851 - "test_slot_metrics_capacity.py"
Cohesion: 0.36
...
### Community 854 - "test_halo143_reboot_no_split_brain"
Cohesion: 0.36
...
### Community 855 - "test_model_preferred_profile.py"
Cohesion: 0.50
...
### Community 864 - "generate-images.mdx"
Cohesion: 0.25
...
### Community 865 - "update-and-rollback.mdx"
Cohesion: 0.25
...
### Community 866 - "voice-stt-tts.mdx"
Cohesion: 0.25
...
### Community 867 - "paths-and-files.mdx"
Cohesion: 0.25
...
### Community 868 - "13. Observability & metrics baseline (ships in every box)"
Cohesion: 0.25
...
### Community 869 - "15. Hermes plugin — standalone repo + native update path"
Cohesion: 0.25
...
### Community 870 - "PART C — Coordination contracts (cross-lane seams)"
Cohesion: 0.25
...
### Community 871 - "halo143 deploy-validation runbook — rework-R3"
Cohesion: 0.25
...
### Community 872 - "Handoff — R5 Phase 4: deploy window → release cut (paste-in prompt)"
Cohesion: 0.25
...
### Community 873 - "mock-prod-gate verification (Phase 0 launch-blocker #3)"
Cohesion: 0.25
...
### Community 874 - "Podman on the hal0 slot substrate — findings & cleaner solutions"
Cohesion: 0.25
...
### Community 889 - "hermes_requirement_is_vetted"
Cohesion: 0.25
...
### Community 890 - "ToolNotPermittedError"
Cohesion: 0.18
...
### Community 892 - "_settings_apply.py"
Cohesion: 0.29
...
### Community 895 - "screen_extra_args_json"
Cohesion: 0.20
...
### Community 897 - "._img_idle_restore_minutes"
Cohesion: 0.20
Nodes (10): _is_newer(), Parse a dotted version string into a sortable tuple.      Mirrors the route laye, Return True if PEP 440 version ``candidate`` is strictly newer than ``current``., _version_tuple(), A 14-digit UTC timestamp nightly sorts strictly above a date-only nightly., Regression: a pip-normalised beta (``0.8.0b3``) must order *below* the next, Nightly tags are not valid PEP 440, so ``_is_newer`` falls back to the     digit, test_is_newer_beta_across_patch_boundary() (+2 more)

### Community 898 - "test_auth_exposure_route.py"
Cohesion: 0.32
...
### Community 902 - "test_cli_docs_parity.py"
Cohesion: 0.36
...
### Community 907 - "_BackendContract"
Cohesion: 0.25
...
### Community 910 - "test_slot_create_conflict.py"
Cohesion: 0.40
...
### Community 911 - "test_transition_guard.py"
Cohesion: 0.25
...
### Community 912 - "useTweaksStore.ts"
Cohesion: 0.29
Nodes (5): APPEARANCE_KEYS, DEFAULTS, TweaksState, TweaksStore, useTweaksStore

### Community 913 - "board-chat-tool-use-v3.spec.ts"
Cohesion: 0.29
Nodes (3): GATED_FRAMES, mockChat(), sse()

### Community 914 - "Concurrency & continuous-batching optimization plan"
Cohesion: 0.29
...
### Community 915 - "ROCmFPX exploratory bench — RESULTS (2026-07-05)"
Cohesion: 0.29
...
### Community 921 - "P3-perms: declarative OwnershipStore as the single ownership authority"
Cohesion: 0.29
...
### Community 922 - "PART B — Target: OwnershipStore default `service_user="hal0"`"
Cohesion: 0.29
...
### Community 923 - "PART C — The LOAD-BEARING contract: born-owned"
Cohesion: 0.29
...
### Community 924 - "PART 0 — EXACT MAP (file:line)"
Cohesion: 0.29
...
### Community 925 - "P3-quadlet: migrate slot + companion units to Podman Quadlet `.container`"
Cohesion: 0.29
...
### Community 926 - "PART A — Current scars (in plain English)"
Cohesion: 0.29
...
### Community 927 - "4. Delivery plan and gates"
Cohesion: 0.29
...
### Community 931 - "Gateway connectivity quirks — hal0"
Cohesion: 0.29
...
### Community 943 - "_FakeSlotManager"
Cohesion: 0.38
...
### Community 944 - "test_slot_logs_stream_redacts_secret_bearing_lines"
Cohesion: 0.33
...
### Community 945 - "test_config_hardware_probe.py"
Cohesion: 0.43
...
### Community 948 - "test_paths_stub.py"
Cohesion: 0.29
...
### Community 949 - "test_voice_roundtrip.py"
Cohesion: 0.43
...
### Community 950 - "10. Troubleshooting"
Cohesion: 0.29
...
### Community 951 - "test_owui_pin_consistency.py"
Cohesion: 0.43
...
### Community 971 - "24. Execution waves / rollout program (session 3, 2026-07-18)"
Cohesion: 0.33
...
### Community 973 - "§4.4 addendum — MCP admin route-map autogen (the 3 gaps)"
Cohesion: 0.33
...
### Community 974 - "Verification strategy"
Cohesion: 0.33
Nodes (6): Lifecycle and security, Live acceptance, Memory, Provider, Verification strategy, Voice

### Community 975 - "Dashboard permission mismatch (root vs hal0)"
Cohesion: 0.33
...
### Community 981 - "push-dev.sh"
Cohesion: 0.60
Nodes (5): die(), info(), push-dev.sh script, step(), warn()

### Community 982 - "release-check.sh"
Cohesion: 0.60
Nodes (5): fail(), info(), release-check.sh script, step(), warn()

### Community 983 - "verify-roundtrip.sh"
Cohesion: 0.60
Nodes (5): fail(), info(), verify-roundtrip.sh script, step(), warn()

### Community 984 - "update-toolbox-digests.sh"
Cohesion: 0.47
Nodes (3): patch_digest(), update-toolbox-digests.sh script, sync_version()

### Community 985 - "hal0-memory"
Cohesion: 0.33
Nodes (5): ABC surface implemented, Contract summary, hal0-memory, Settings, Why no `dataset` field

### Community 986 - "ensure_gateway_api_server_key"
Cohesion: 0.39
Nodes (7): _git(), _git_changelog(), main(), _prev_tag(), Run a git command, returning trimmed stdout or ``""`` on any failure., Most recent release tag before *tag* (nightly picks the prior nightly)., Fallback markdown: a commit log since the previous relevant tag.

### Community 987 - "TypedDict"
Cohesion: 0.47
...
### Community 990 - "throughput_history"
Cohesion: 0.33
...
### Community 993 - "_guess_capability"
Cohesion: 0.32
...
### Community 996 - "samples_from_events"
Cohesion: 0.33
...
### Community 997 - "test_activity_instrumentation.py"
Cohesion: 0.60
...
### Community 998 - "test_models_catalogue.py"
Cohesion: 0.47
...
### Community 1003 - "test_curation_drift.py"
Cohesion: 0.40
...
### Community 1018 - "14. Kanban board — ownership inversion + security hardening"
Cohesion: 0.40
...
### Community 1019 - "16. Hermes Python library (`AIAgent`) for the brain — evaluated, rejected for core"
Cohesion: 0.40
...
### Community 1020 - "21.A Mapping table — every candidate by disposition"
Cohesion: 0.40
...
### Community 1021 - "8. SQLite adoption — setup plan"
Cohesion: 0.40
...
### Community 1022 - "PART A — Current-state map (the scars, in plain English)"
Cohesion: 0.40
...
### Community 1023 - "PART D — The one narrow privileged helper: `hal0-systemctl`"
Cohesion: 0.40
...
### Community 1024 - "PART G — Sequencing: P3-perms BEFORE hermes-provision slim and P3-quadlet"
Cohesion: 0.40
...
### Community 1025 - "PART 0 — Current-state map (the hand-rendered ExecStart scars, file:line)"
Cohesion: 0.40
...
### Community 1031 - "fork-pi-mono.sh"
Cohesion: 0.70
Nodes (4): die(), info(), fork-pi-mono.sh script, warn()

### Community 1032 - "NOTES — answers from the prototype session"
Cohesion: 0.40
...
### Community 1040 - "TestRenderCancel"
Cohesion: 0.40
...
### Community 1042 - "test_distro.sh"
Cohesion: 0.90
Nodes (4): bad(), ok(), test_distro.sh script, want()

### Community 1046 - "slot-card-container-v3.spec.ts"
Cohesion: 0.40
...
### Community 1047 - "slot-edit-controls-v3.spec.ts"
Cohesion: 0.40
...
### Community 1049 - "[0.9.5.1] — 2026-07-09"
Cohesion: 0.50
Nodes (4): [0.9.5.1] — 2026-07-09, Added, Fixed, Highlights

### Community 1050 - "[0.9.6.1] — 2026-07-11"
Cohesion: 0.50
Nodes (4): [0.9.6.1] — 2026-07-11, Added, Changed, Fixed

### Community 1051 - "[1.0.0] — unreleased (R5 · the rework release)"
Cohesion: 0.50
Nodes (4): [1.0.0] — unreleased (R5 · the rework release), Breaking, Highlights, Migrations

### Community 1052 - "[v0.8.2b3] — 2026-06-29"
Cohesion: 0.50
Nodes (4): Added, Docs, Fixed, [v0.8.2b3] — 2026-06-29

### Community 1053 - "[v0.8.0-beta.1] — 2026-06-21"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.0-beta.1] — 2026-06-21

### Community 1054 - "[v0.7.3-beta.2] — 2026-06-19"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.7.3-beta.2] — 2026-06-19

### Community 1055 - "[v0.5.1-alpha.1] — 2026-06-15"
Cohesion: 0.50
Nodes (4): Added, Changed, Removed, [v0.5.1-alpha.1] — 2026-06-15

### Community 1056 - "[v0.5.0-alpha.1] — 2026-06-14"
Cohesion: 0.50
Nodes (4): Added, Fixed, Internal, [v0.5.0-alpha.1] — 2026-06-14

### Community 1057 - "[v0.9.0] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.9.0] — 2026-07-04

### Community 1058 - "[v0.8.4b1] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.4b1] — 2026-07-04

### Community 1059 - "[v0.8.3b1] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.3b1] — 2026-07-04

### Community 1060 - "[v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)"
Cohesion: 0.50
Nodes (4): Internal contracts, Known follow-up, New / improved, [v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)

### Community 1061 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1062 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1063 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1064 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1065 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1066 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1067 - "benchmarks.mdx"
Cohesion: 0.50
Nodes (3): Scheduled runs are polite, What the installer sets up, Where results go

### Community 1068 - "hal0 docs"
Cohesion: 0.50
Nodes (3): `docs/internal/` — repo-only architecture docs, hal0 docs, Top-level `docs/*.mdx` — user docs

### Community 1069 - "streaming.mdx"
Cohesion: 0.50
Nodes (3): Client example, See also, Wire format

### Community 1070 - "11. Product reworks — round 2 (slot identity, ports, profile org)"
Cohesion: 0.50
...
### Community 1071 - "PART E — `hal0-api` User flip + UMask removal"
Cohesion: 0.50
...
### Community 1072 - "PART F — Edit plan (files, order, delegators/shims)"
Cohesion: 0.50
...
### Community 1073 - "PART H — Risks + capped verification"
Cohesion: 0.50
...
### Community 1074 - "PART E — Migration of running units (the live-box transition)"
Cohesion: 0.50
...
### Community 1075 - "PART F — Risks + capped verification"
Cohesion: 0.50
...
### Community 1091 - "_delegate_fakes.py"
Cohesion: 0.50
...
### Community 1092 - "test_comfyui_path.py"
Cohesion: 0.50
...
### Community 1093 - "test_backfill_coordless_is_idempotent"
Cohesion: 0.22
...
### Community 1099 - "slot-rename-delete-v3.spec.ts"
Cohesion: 0.06
Nodes (31): Slot lifecycle manager (container runtime).  SlotManager owns every aspect of sl, # NOTE: ``extra=`` MUST NOT use "message" as a key — that's, The model registry could not be consulted (outage, not a miss).      Raised by t, # NOTE: fail-watch tunables (_FAIL_WATCH_INTERVAL_S, _FAIL_WATCH_LIVE_STATES,, # NOTE: idle-monitor tunables (_IDLE_AFTER_S, _IDLE_MONITOR_INTERVAL_S,, # NOTE: callers wire this through ``Dispatcher.forward``; the, # NOTE: _argv_values / _resolve_drift_flags / _config_drift_values_equal /, # NOTE: _cfg_effective_backend / _base_profile_for_backend / (+23 more)

### Community 1101 - "[0.9.4] — 2026-07-08"
Cohesion: 0.67
Nodes (3): [0.9.4] — 2026-07-08, Added, Fixed

### Community 1102 - "[v0.8.5b2] — 2026-07-04"
Cohesion: 0.67
Nodes (3): Added, Fixed, [v0.8.5b2] — 2026-07-04

### Community 1103 - "[v0.8.0-beta.3] — 2026-06-23"
Cohesion: 0.67
Nodes (3): Breaking, Changed, [v0.8.0-beta.3] — 2026-06-23

### Community 1138 - "TestVenvRefreshIsCommitAgnostic"
Cohesion: 0.29
Nodes (7): ConfigInvalidError, get_models_config(), Any, Return the current [models] section (roots / auto-scan / extensions).      Route, Replace the [models] section, persist hal0.toml, then re-scan.      Body shape:, Schema validation failure for the [models] section., update_models_config()

### Community 1141 - "footer-update-chip-v3.spec.ts"
Cohesion: 0.29
...
### Community 1142 - "npu-occupancy-v3.spec.ts"
Cohesion: 0.32
...
### Community 1159 - "_fetch_model_contexts"
Cohesion: 0.06
...
### Community 1160 - "_generate_api_server_key"
Cohesion: 0.29
...
### Community 1221 - "test_is_installed_flm_id_matches_installed_tag"
Cohesion: 0.29
...
### Community 1222 - "test_curated_match_by_filename"
Cohesion: 0.40
...
### Community 1223 - "test_known_paths_short_circuit"
Cohesion: 0.50
...
### Community 1224 - "test_model_mmproj_defaults_none"
Cohesion: 0.50
Nodes (3): FoldPlan, Result of :func:`plan_slot_flags_fold`., True when nothing was refused — safe to apply the whole plan.

### Community 1225 - "test_backfill_coordless_no_curated_match_left_alone"
Cohesion: 0.43
Nodes (3): parse_json_object(), Best-effort JSON object parse. Returns None on any failure/non-dict., TestParseJsonObject

### Community 1286 - "memory_recall_commands.py"
Cohesion: 0.09
Nodes (28): ``hal0 memory recall`` — debug recall through the ACL front door.  Hits ``POST /, Debug recall — see what an agent would get back for a query., recall_cmd(), _fmt_size(), model_add(), model_assign(), model_default(), model_list() (+20 more)

### Community 1287 - "ports_command.py"
Cohesion: 0.33
Nodes (6): _comfyui_data_dir(), _comfyui_workflows_dir(), _find_workflow(), Primary workflow directory — env override for tests; default is the bind-mount p, Root of the ComfyUI data directory (for fallback user/default/workflows path)., Locate <name>.json, trying primary then user/default fallback. None if absent.

### Community 1288 - "isolated_client"
Cohesion: 0.29
...
### Community 1293 - "list_ports"
Cohesion: 0.40
Nodes (5): build_server(), make_dispatcher(), FastMCP, Return an async dispatcher closure bound to ``wrapper``.      The admin server p, Construct a focused memory-only FastMCP server.      Mounted at ``/mcp/memory``

### Community 1295 - "_OtherEngineProvider"
Cohesion: 0.67
...
### Community 1299 - "ReleaseManifest"
Cohesion: 0.40
Nodes (3): Schema-validated release-manifest payload.      Mirrors the on-disk JSON shape d, Cross-field validation for preview/release-kind consistency.          Rules:, ReleaseManifest

### Community 1300 - "_FakeRegistry"
Cohesion: 0.40
Nodes (3): _FakeRegistry, MonkeyPatch, test_is_resolvable()

### Community 1302 - "_scrub_detail"
Cohesion: 0.67
Nodes (3): Exception, Client-safe error detail: engine URLs (httpx repeats the full     internal reque, _scrub_detail()

## Knowledge Gaps
- **3192 isolated node(s):** `runlog.sh script`, `rocmfpx-build.sh script`, `rocmfpx-env.sh script`, `rocmfpx-pipeline.sh script`, `rocmfpx-quantize.sh script` (+3187 more)
...
- **Why does `create_app()` connect `create_app` to `manager.py`, `test_config_model_roots.py`, `test_hf_routes.py`, `test_memory_admin_routes.py`, `test_models_add_from_path.py`, `test_dashboard_layout.py`, `isolated_client`, `test_stacks_routes.py`, `test_settings_routes.py`, `__init__.py`, `test_ports_command.py`, `test_auth_core.py`, `test_models_routes.py`, `ApprovalQueue`, `test_models_preview.py`, `test_exposure.py`, `mcp_mount.py`, `TestClient`, `conftest.py`, `conftest.py`, `_render_from_spec`, `test_settings_models_store.py`, `_RecordingSlotManager`, `test_chat_proxy.py`, `test_chat_templates.py`, `test_kb1_hardening_tail.py`, `test_models_crud.py`, `TestClient`, `test_slots_image_pull.py`, `test_tts_request_defaults.py`, `test_auth_rotate.py`, `test_updater_routes.py`, `test_comfyui_fetch_route.py`, `test_slots_routes.py`, `_StubSlotManager`, `test_cli_auth_streamtest.py`, `EventBus`, `isolated_client_with_root`, `test_chat_proxy_auth.py`, `load_hal0_config`, `test_typed_bodies.py`, `test_v1_npu_trio_routing.py`, `MemoryDispatcher`, `FakeWsServer`, `test_models_default.py`, `test_pull_shutdown.py`, `TestClient`, `test_profiles_crud.py`, `test_event_contract.py`, `test_pull_routes.py`, `test_installer_routes.py`, `test_typed_errors.py`, `PgVectorProvider`, `TestClient`, `test_route_collisions.py`, `test_v1_chat_slot_alias.py`, `test_v1_slot_alias_models.py`, `types.py`, `test_slots_container_state.py`, `npu-occupancy-v3.spec.ts`, `deps.py`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `SlotManager` connect `SlotManager` to `SlotInterface`, `SlotConfigError`, `test_device_profile_coherence.py`, `rerender_slot_units`, `test_npu_trio_reconcile.py`, `test_slot_create_conflict.py`, `_write_slot`, `test_manager_readiness_api.py`, `test_transition_guard.py`, `._load_state`, `RoutingHost`, `.list`, `GpuArbiter`, `heal_missing_llm_type`, `test_model_fallback.py`, `NpuExclusivityViolation`, `test_adopted_slot_eviction.py`, `.create`, `_write_slot`, `FakeSlotManager`, `test_slot_aliases.py`, `FLMProvider`, `test_mtp_defuse.py`, `slot-rename-delete-v3.spec.ts`, `SlotIdentityStore`, `agents-overview.jsx`, `Path`, `test_model_preferred_profile.py`, `test_pulling_serving_idle.py`, `test_npu_trio_shadow.py`, `Request`, `test_manager_npu_container.py`, `compute_config_drift`, `build_auto_selections`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `connect()` connect `connect` to `Model`, `MetricsWriter`, `SqliteModelRegistry`, `applied_versions`, `NotFound`, `PortAuthority`, `Path`, `chrome.jsx`, `import_toml_to_sqlite`, `OrchestrationResult`, `useActivity.ts`, `_shared.py`, `_safe_query`, `gc.py`, `ModelRegistry`, `merge_slot_config`, `SlotIdentityStore`, `Path`, `aggregate_hour`, `test_stats_requests_route.py`, `hw_slot_ownership.py`, `useLogs.ts`?**
...
- **What connects `Run a git command, returning trimmed stdout or ``""`` on any failure.`, `Most recent release tag before *tag* (nightly picks the prior nightly).`, `Fallback markdown: a commit log since the previous relevant tag.` to the rest of the system?**
  _10271 weakly-connected nodes found - possible documentation gaps or missing edges._