# Graph Report - media-polish  (2026-07-30)

## Corpus Check
- 1636 files · ~2,075,168 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29645 nodes · 56320 edges · 1373 communities (1224 shown, 149 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 6915 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1af3394c`
...
- test_models_pull_capability.py
- TestClient
...
- runtime-test.sh
- conftest.py
- TestMr3ConsolidationPreservesDetectContract
...
- test_sanitise_id_blocks_path_traversal
- globals.d.ts
...
- triage-labels.md
- .__init__
- test_spawn_kwargs_sets_home_and_skips_user_when_not_root
- test_async_spawn_passes_through_when_not_root
- test_parse_flm_progress_terabytes
...
- test_backfill_coordless_fills_from_curated
- test_find_candidates_groups_complete_shard_set
- test_find_candidates_drops_incomplete_shard_set
...
- test_version_tuple_timestamp_nightly_beats_date_only_same_base
...
## Communities (1373 total, 149 thin omitted)

### Community 0 - "dashboard-redesign.jsx"
Cohesion: 0.02
Nodes (139): useActivityRecent(), CELL_DEFS, CELL_MAP, CellDef, CellId, DashLayout, DEFAULT_LAYOUT, LAYOUT_QUERY_KEY (+131 more)

### Community 1 - "useSlots.ts"
Cohesion: 0.03
Nodes (125): ADR-0022, useModels(), deviceBackend(), parseImageRef(), RunnerState, RuntimeRow, SystemInfo, SystemInfoBackend (+117 more)

### Community 2 - "stacks.jsx"
Cohesion: 0.03
Nodes (127): URL-safe lowercase identifier used by the REST surface., api(), useChatTemplates(), useMeta(), useMetaEnums(), useAddModelFromPath(), useModelDuplicate(), useModelInspect() (+119 more)

### Community 3 - "SlotManager"
Cohesion: 0.03
Nodes (114): Return ``True`` when *name* is in the dispatchable ready-set.          Ready set, See :meth:`hal0.slots.watchdog.SlotWatchdog._fail_watch_loop`., See :meth:`hal0.slots.watchdog.SlotWatchdog.probe_health`., See :meth:`hal0.slots.watchdog.SlotWatchdog.readiness_check`., See :func:`hal0.slots.routing.default_slot_for`., See :func:`hal0.slots.routing.route_for_request`., See :func:`hal0.slots.routing.add_slot`., See :func:`hal0.slots.routing.remove_slot`. (+106 more)

### Community 4 - "test_updater.py"
Cohesion: 0.04
Nodes (125): _current_symlink(), Return ``<usr_lib>/hal0-<version>/`` — where this release's tree lives., Return ``<usr_lib>/current`` — the atomic-swap target., Atomic self-update with cosign-verified releases and one-step rollback.      All, Updater, _versioned_install_dir(), _build_release_tarball(), cosign_skip() (+117 more)
...
Cohesion: 0.05
Nodes (69): _background_revalidate(), _cached_snapshot(), _clear_in_flight(), _flatten_for_ui(), get_hardware(), _gpu_sample(), _local_image_repos(), _local_live_stats() (+61 more)

### Community 8 - "SlotState"
Cohesion: 0.03
Nodes (95): The model registry could not be consulted (outage, not a miss).      Raised by t, See :meth:`hal0.slots.watchdog.SlotWatchdog.update`., RegistryUnavailableError, admit(), CandidateSlot, _estimate_incoming_footprint_mb(), EvictionStep, _gather_candidates() (+87 more)

### Community 9 - "test_memory_hindsight_plugin.py"
Cohesion: 0.02
...
### Community 10 - "ConfigParseError"
Cohesion: 0.03
Nodes (123): ConfigParseError, A config file is present but contains invalid TOML or fails validation., Tag-based release-policy derivation — the single source of truth for classifying, Raised when a tag does not match any supported release pattern., Immutable policy derived from a parsed release tag., ReleasePolicy, ReleaseTagError, _atomic_symlink_swap() (+115 more)

### Community 11 - "ApprovalQueue"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (102): apiDelete(), apiGet(), ApiOptions, apiPut(), Hal0Error, serialiseBody(), ENDPOINTS, AgentMCPClientList (+94 more)

### Community 13 - "SettingsShell.jsx"
Cohesion: 0.04
Nodes (87): useBackends(), CapabilitiesBag, CapabilityBackend, CapabilityCatalogItem, CapabilityRow, CapabilitySelection, useCapabilities(), useCapabilityApply() (+79 more)

### Community 14 - "useModels.ts"
Cohesion: 0.04
Nodes (81): useApprovalList(), useLogsStream(), useMemoryEnabled(), AddFromPathRequest, fmtBytes(), fmtEta(), fmtSpeed(), HfSearchResponse (+73 more)

### Community 15 - "primitives.jsx"
Cohesion: 0.03
Nodes (76): ADR-0004, ADR-0013, ADR-0023, COMFYUI_FALLBACK, ComfyuiArbiter, ComfyuiEngineState, ComfyuiMemory, ComfyuiMode (+68 more)

### Community 16 - "ProfileConfig"
Cohesion: 0.03
Nodes (84): RuntimeFamily, SlotType, create_profile(), delete_profile(), export_profile(), get_profile(), import_profile_route(), list_profiles() (+76 more)
...
### Community 18 - "Any"
Cohesion: 0.03
Nodes (83): _artefact_token(), _best_effort_model_info(), _binary_runner(), _container_runtime(), _effective_backend_and_device_class(), _effective_parallel(), _effective_runner(), _llama_argv_segments() (+75 more)

### Community 19 - "test_discover.py"
Cohesion: 0.09
Nodes (43): model_root(), ModelRegistry, Path, Tests for hal0.registry.discover — filesystem scan + auto-register., End-to-end: a NON-curated reranker gguf under a scan root registers with     cap, A checkpoint under the ComfyUI models tree registers as image/comfyui,     not t, A model directory laid out like the real chat model + mmproj sidecar., End-to-end: the registered main model resolves its mmproj path, and     no stand (+35 more)

### Community 20 - "Dispatcher"
Cohesion: 0.05
Nodes (68): Any, Capability/path routing heuristics — dispatcher resolution Step 4.  Extracted fr, Resolve a request to a slot Upstream using path+name heuristics.      The last-r, resolve_by_capability(), A chat request that reaches the legacy fallback selects the ``chat``     default, test_resolve_by_capability_chat_default_raises_typed_legacy_error(), _container_remote_img(), _FakeModelRegistry (+60 more)

### Community 21 - "test_registry_import.py"
Cohesion: 0.05
...
### Community 23 - "probe.py"
Cohesion: 0.04
Nodes (81): _amd_drm_device(), _amd_drm_devices(), _amd_gpu_info(), _derive_unified_memory_mb(), _detect_aie_columns(), _detect_amd(), _detect_amd_gpus(), _detect_gpu() (+73 more)
...
Cohesion: 0.07
Nodes (55): _compact_ts_to_iso(), _import_v1_server_ab(), _median(), Import hal0's standalone ``server-ab/*.json`` sessions into schema-2.      Each, One server_ab timed run → a schema-2 Rep. Returns None for an errored run     (n, server-ab stamps are compact UTC (``20260704T212506Z``); normalise to the     IS, _sa_generative_record(), _sa_latency_record() (+47 more)

### Community 26 - "test_migrate_model_layout.py"
Cohesion: 0.12
Nodes (50): _classify_registry_entry(), _pick_capability(), Pick the strongest registered capability, or ``None`` if none usable., Return ``(recipe, capability)`` for a registry entry, or ``None``.      Resoluti, _invoke(), _make_tree(), Path, Tests for ``hal0 migrate model-layout`` (v0.2 PR-7).  Covers the behaviour contr (+42 more)

### Community 27 - "main.tsx"
Cohesion: 0.03
Nodes (39): react, AGENT_TAB_DEFS, _agentRoute(), _agentTabs(), AgentView(), ADR-0023, Markdown(), mdInline() (+31 more)

### Community 28 - "FakeManager"
Cohesion: 0.06
Nodes (75): _base_configs(), _cancel_loop(), comfyui_http(), fake_mgr(), FakeManager, _fast_drain(), _img_mode_arbiter(), Any (+67 more)

### Community 29 - "pull.py"
Cohesion: 0.03
...
### Community 36 - "slots.py"
Cohesion: 0.04
Nodes (102): _cache_slot_enrichment(), _config_field_enrichment(), _container_state_enrichment(), create_slot(), delete_slot(), _device_backend(), _fit_check_warning(), get_slot() (+94 more)

### Community 37 - "_api_base"
Cohesion: 0.04
Nodes (99): agent_install(), agent_peers(), approvals_approve(), approvals_deny(), _install_hermes(), Approve a pending agent action., Deny a pending agent action., List discoverable agent identity cards.      Thin wrapper over ``memory_search`` (+91 more)

### Community 38 - "Upstream"
Cohesion: 0.04
Nodes (47): _fields_for_dataclass(), _fields_for_entry(), _filters_to_config(), _filters_to_runtime(), Any, AsyncClient, Lock, Path (+39 more)

### Community 39 - "ComfyUIProvider"
Cohesion: 0.03
Nodes (79): Provider, Any, ContainerSpec, Abstract base for a hal0 inference backend.      Concrete implementations: Conta, Compute the EnvironmentFile contents for a slot.          Returns a mapping of H, Return the argv list for spawning this backend outside systemd.          Mirrors, Run a health check against the backend on *port*.          Returns {"ok": bool,, Passthrough inference against the provider's OpenAI-compatible API.          Thi (+71 more)

### Community 40 - "ModelDefaults"
Cohesion: 0.05
...
### Community 42 - "run_pull"
Cohesion: 0.05
Nodes (89): hf_download_url(), make_job(), pull_job_file(), Build the canonical HuggingFace download URL.      ``resolve/main`` (not ``raw/m, Create a fresh job record for ``model_id``., Path of the durable snapshot for ``model_id``'s pull job., Background-task body: stream the file(s), hash, install, register.      ML-2/ML-, run_pull() (+81 more)

### Community 43 - "updater.py"
Cohesion: 0.06
Nodes (69): apply_update(), _body_version(), check_updates(), _collect_slot_drift(), commit_update(), _current_channel(), _flm_toolbox_image(), get_channel() (+61 more)

### Community 44 - "ModelRegistry"
Cohesion: 0.06
Nodes (33): ModelAlreadyExists, ModelNotFound, Base error for registry operations., The requested model id is not in the registry., add() called but the model id is already present., RegistryError, _model(), ModelRegistry (+25 more)

### Community 45 - "AgentMCPClient"
Cohesion: 0.06
Nodes (33): ClassificationLiteral, AgentMCPClient, classify_many(), AgentConfig, Path, MCP client surface for bundled agents.  Reads ``/etc/hal0/agents/<name>.toml``,, Load + validate the on-disk TOML, return a ready client., Return the servers the agent is allowed to *connect* to.          Server-axis de (+25 more)

### Community 46 - "AgentManager"
Cohesion: 0.07
...
### Community 47 - "cli.py"
Cohesion: 0.05
Nodes (74): build_parser(), cmd_devices(), cmd_eval(), cmd_history(), cmd_import_v1(), cmd_plan(), cmd_publish(), cmd_reindex() (+66 more)

### Community 48 - "test_hermes_provision.py"
Cohesion: 0.03
...
### Community 50 - "connect"
Cohesion: 0.03
Nodes (72): _QueueItem, Path, connect(), db_path(), Connection, Path, SQLite connection + transaction helpers — the hal0 ``db/`` foundation.  One conn, Wrap a write in an explicit ``BEGIN IMMEDIATE`` … ``COMMIT``/``ROLLBACK``. (+64 more)

### Community 51 - "test_doctor.py"
Cohesion: 0.07
...
### Community 52 - "test_board_chat.py"
Cohesion: 0.16
Nodes (43): _final_response(), _make_app(), _multi_tool_response(), _PlatformRecorder, Any, Like _Recorder but for hal0-api's OWN routes (no kanban prefix)., Attach a Hal0Config carrying a [brain_chat] override to app.state., Pops a canned chat-completion response per call. (+35 more)

### Community 53 - "doctor_commands.py"
Cohesion: 0.05
Nodes (67): check_hermes_ownership(), check_tree_group_share(), _dangling_registry_entries(), _deepest_mountpoint(), detect_editable_root(), flm_mount_guard(), flm_store_divergence(), flm_store_writability() (+59 more)
...
### Community 55 - "ContainerProvider"
Cohesion: 0.03
Nodes (79): ContainerProvider, Podman-container-per-slot inference backend.      One instance is shared across, Not applicable — systemd starts the container., Probe GET /health on the container port.          For llama-server slots /health, Poll /health until 200 or HEALTH_TIMEOUT_S exceeded.          Raises:, _make_provider_with_tmp_unit(), Path, Tests for stale legacy drop-in cleanup in _write_and_start_unit (closes #694). (+71 more)

### Community 56 - "test_models_routes.py"
Cohesion: 0.06
...
### Community 61 - "_RecordingSlotManager"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (65): Any, Connection, Model, Path, Row, SqliteModelRegistry — SQLite-backed model catalog (ML-1 pilot).  Drop-in replace, Resolved registry directory (override or paths.registry_dir())., Derived TOML export path.          ``registry.toml`` is no longer the source of (+57 more)

### Community 63 - "connections.jsx"
Cohesion: 0.06
...
### Community 64 - "Hal0Config"
Cohesion: 0.07
Nodes (51): MigrationPlan, _apply_store_change(), _config_to_dict(), ConfigInvalidError, _deep_merge(), get_apply_plan(), get_model_store(), get_settings() (+43 more)

### Community 65 - "load_capabilities_config"
Cohesion: 0.06
...
### Community 66 - "test_argv.py"
Cohesion: 0.05
Nodes (63): Validate the launch-affecting fields of a model create/update/validate body., screen_model_write(), _canon(), _dedup(), _deny_managed_flags(), _deny_slot_hardware_flags(), FlagProvenance, _is_flag() (+55 more)

### Community 67 - "v1.py"
Cohesion: 0.20
Nodes (24): DispatcherDep, audio_speech(), audio_transcriptions(), chat_completions(), completions(), _dispatch_and_forward(), embeddings(), _extract_port_from_upstream_url() (+16 more)

### Community 68 - "Store"
Cohesion: 0.07
Nodes (51): datetime, DESIGN §6 --scheduled gate: (a) inside the maintenance window, (b) no     active, _scheduled_politeness(), Cell, One planned unit of work: a fully-resolved identity + the suite context     the, _assemble(), _classify(), _clear_stale_sweep() (+43 more)

### Community 69 - "SlotConfig"
Cohesion: 0.04
...
### Community 71 - "FLMProvider"
Cohesion: 0.05
Nodes (56): FLMProvider, Provider for the AMD NPU FLM backend.      Two-tier readiness (Option A — NPU do, _mock_response(), model_info(), provider(), Any, Unit tests for FLMProvider.  Two-tier readiness (Option A — NPU double-free avoi, Bundled default when no slot override / env / manifest pin applies.      §7.1b / (+48 more)
...
### Community 75 - "HindsightProvider"
Cohesion: 0.05
...
### Community 76 - "RuntimeLaunchPlan"
Cohesion: 0.05
...
### Community 77 - "FakeUpstreamRegistry"
Cohesion: 0.04
Nodes (104): CachedModelsFn, FetchModelsFn, IsOnlineFn, LegacyResolutionFailed, Raised when the capability/path heuristics find no slot to serve a request., Dispatcher, DispatchError, _filter_response_headers() (+96 more)

### Community 78 - "admin.py"
Cohesion: 0.09
...
### Community 80 - "endpoints.ts"
Cohesion: 0.07
Nodes (33): KeyTier, RequireAuthResponse, RotateKeyResponse, useLogout(), useRotateKey(), useSetRequireAuth(), ExposureAllowlistEntry, ExposureRule (+25 more)

### Community 81 - "_spec_provider_for"
Cohesion: 0.04
Nodes (56): Provider for a slot, or None for the GPU/llama-server default.      The runtime, _spec_provider_for(), KokoroHealthError, KokoroInferError, KokoroProvider, Any, ContainerSpec, KokoroProvider — CPU TTS inference backend (kokoro-onnx).  Image API surface: (+48 more)

### Community 82 - "StackApplyEngine"
Cohesion: 0.07
...
### Community 83 - "_ArbiterSlotManager"
Cohesion: 0.07
...
### Community 84 - "Any"
Cohesion: 0.07
Nodes (51): _build_brain_identity_card(), _build_identity_card(), _collect_capability_rollup(), _collect_chat_slots(), _fetch_slots(), _find_named_ready_slot(), _find_slot(), _hal0_version_string() (+43 more)

### Community 85 - "create_app"
Cohesion: 0.20
...
### Community 88 - "models_service.py"
Cohesion: 0.06
Nodes (60): _normalise_id(), Turn a basename stem into a registry-friendly id., Model ids referenced by any configured slot or any stack.      Union of: each sl, referenced_model_ids(), add_from_path(), auto_scan_and_register(), cascade_delete_model(), clear_slot_default() (+52 more)

### Community 89 - "test_profiles_crud.py"
Cohesion: 0.04
...
### Community 91 - "HardwareStats"
Cohesion: 0.06
Nodes (47): HardwareStats, _port_in_use(), Any, Path, Hardware runtime stats — GPU utilisation, RAM usage, slot port occupancy.  Hardw, Return current GPU compute utilisation as a fraction [0.0, 1.0].          AMD: r, Return current GPU VRAM usage in MiB.          On AMD UMA (Strix Halo) returns m, Return total GPU VRAM in MiB (or GTT pool on UMA). (+39 more)
...
### Community 93 - "hermes_provision.py"
Cohesion: 0.06
Nodes (56): _active_persona_render(), ApiServerKeyResult, BootstrapState, _brain_profile_config_path(), _default_mcp_servers(), ensure_gateway_api_server_key(), _fetch_model_contexts(), _generate_api_server_key() (+48 more)

### Community 94 - "Path"
Cohesion: 0.06
Nodes (44): _apply_config_set(), _copy_plugin_tree(), _copy_wrapper(), _dirs_identical(), _ensure_hermes_config(), _fmt_config_value(), _hal0_service_home(), _hal0_subprocess_env() (+36 more)

### Community 95 - "agent_commands.py"
Cohesion: 0.06
Nodes (40): agent_list(), agent_log(), _agent_provision_state_file(), agent_reprovision(), agent_status(), agent_uninstall(), agent_upgrade(), _approval_summary() (+32 more)

### Community 96 - "paths.py"
Cohesion: 0.06
Nodes (61): activity_db(), agent_workspace_dir(), agents_config_dir(), api_env(), bundle_chosen_marker(), _covers(), db_path(), default_flm_models_dir() (+53 more)
...
### Community 102 - "load_profiles_config"
Cohesion: 0.07
Nodes (24): load_profiles_config(), Load and validate /etc/hal0/profiles.toml.      Returns a :class:`ProfilesConfig, Path, Unit tests for the profile catalog — schema, loader, and flag resolver.  Targete, Absent file → seed defaults; no fixture needed., Non-MTP profiles stay False; MTP-capable family profiles are True., Canonical GPU seeds do not pin a backend or runner image., spec-hw-slot-ownership §3: ``image`` is optional/inert now — a profile         w (+16 more)

### Community 103 - "pull_jobs.py"
Cohesion: 0.05
Nodes (68): get_curated(), Return the curated entry by id, or ``None`` if not in the catalogue., build_stream_response(), cancel(), delete(), emit_terminal_pull_event(), enqueue(), enqueue_update() (+60 more)

### Community 104 - "test_redact.py"
Cohesion: 0.05
...
### Community 105 - "BadRequest"
Cohesion: 0.07
Nodes (20): MonkeyPatch, Unit tests for :mod:`hal0.mcp.manifest` — #224 install-from-URL resolver., Loopback hostnames + 127.0.0.1 literals must short-circuit pre-fetch., RFC 1918 ranges (10/8, 172.16/12, 192.168/16) must reject pre-fetch., Link-local (incl. AWS/GCP IMDS at 169.254.169.254) must reject., ``*.local`` mDNS hostnames are rejected without a DNS lookup., The default fetcher must run with ``follow_redirects=False``.      A 30x to an i, A manifest with a runaway tools list must not 500 on Pydantic ``le``. (+12 more)

### Community 106 - "api_get"
Cohesion: 0.19
Nodes (12): catalog_list_cmd(), _find_server(), list_cmd(), Any, hal0 mcp subcommands — thin HTTP client to /api/mcp/*.  Issue #504: ``hal0 mcp {, Show detail for one MCP server., List installable MCP servers from the catalog., Case-insensitive server-id lookup in the servers list. (+4 more)

### Community 107 - "StacksCatalog"
Cohesion: 0.07
...
### Community 109 - "test_pull_routes.py"
Cohesion: 0.05
...
### Community 111 - "test"
Cohesion: 0.03
Nodes (15): test, MOBILE, CURATED, ROWS, UPSTREAM_ROW, NPU_SERVING_SLOT, SECTIONS, ADR-0012 (+7 more)

### Community 112 - "__init__.py"
Cohesion: 0.07
Nodes (32): ModelRegistry, Path, SlotManager, ChangeSet, FileState, _known_field_names(), Any, Path (+24 more)

### Community 113 - "loader.py"
Cohesion: 0.13
...
### Community 114 - "get_runner"
Cohesion: 0.06
Nodes (46): Default container image for a slot lane with no explicit image pin.      Precede, resolve_default_image(), Return the FLM toolbox image reference.          Resolution (§7.1b / ML-4): ``sl, Return the Kokoro toolbox image reference.          Resolution (§7.1b / ML-4): `, Return the Qwen3-TTS toolbox image reference.          Resolution (§7.1b / ML-4), get_runner(), RUNNER_IMAGES — the runner-image registry (plan §7.1b / ML-4).  Before this modu, Look up a runner by key, or raise :class:`~hal0.errors.NotFound`. (+38 more)

### Community 115 - "NpuTrioRouter"
Cohesion: 0.06
...
### Community 117 - "test_setup_install.py"
Cohesion: 0.06
...
### Community 118 - "test_profile_derive.py"
Cohesion: 0.06
...
### Community 119 - "portable.py"
Cohesion: 0.07
Nodes (38): _checksum(), export_envelope(), import_stack(), ModelResolution, parse_envelope(), Any, ModelRegistry, Path (+30 more)

### Community 120 - "test_hermes_provision_idempotency.py"
Cohesion: 0.07
Nodes (46): apply_hermes_config_cli(), apply_kanban_db_init_cli(), _coerce(), default_fake_slots(), install_io(), Any, Shared test fakes for the hermes_provision config-set redesign.  ``apply_hermes_, Redirect every host path constant under ``tmp_path``; return (home, venv). (+38 more)

### Community 121 - "test_pve.py"
Cohesion: 0.07
...
### Community 122 - "Check"
Cohesion: 0.06
Nodes (63): build_all_checks(), check_auth_posture(), check_hal0_target(), check_migrations(), check_model_store(), check_ports(), check_secret_file_modes(), doctor_all_cmd() (+55 more)

### Community 123 - "__init__.py"
Cohesion: 0.08
...
### Community 126 - "errors.py"
Cohesion: 0.15
Nodes (16): agent_activity(), install_agent(), list_agents(), list_skills(), _manager(), persona_enums(), Bundled-agent lifecycle endpoints (mounted under /api/agents).  Phase 8. Thin wr, Catalogue for the dashboard's Agent → Skills tab (#227).      Static for v0.3 — (+8 more)

### Community 127 - "test_auth_rotate.py"
Cohesion: 0.09
...
### Community 129 - "migrate_slot_toml"
Cohesion: 0.07
...
### Community 130 - "router.py"
Cohesion: 0.07
Nodes (28): _default_fetch_models(), _default_is_online(), _join_url(), Any, Request, Dispatcher — registry-aware request router.  The :class:`Dispatcher` reads the m, # NOTE: treated as "no binding" rather than fatal so the dispatcher, # NOTE: until ModelRegistry exposes (upstream_name, upstream_model) (+20 more)

### Community 131 - "SlotInterface"
Cohesion: 0.07
...
### Community 139 - "Qwen3TTSProvider"
Cohesion: 0.07
...
### Community 140 - "test_auth_core.py"
Cohesion: 0.07
...
### Community 141 - "test_comfyui_proxy.py"
Cohesion: 0.15
...
### Community 142 - "test_providers_routes.py"
Cohesion: 0.10
...
### Community 143 - "PART 0 — current-state map of scattered metrics (file:line)"
Cohesion: 0.04
...
### Community 144 - "slot_flags_fold.py"
Cohesion: 0.07
Nodes (42): RuntimeError, apply_fold_plan(), _canon(), _chat_template_or_none(), collect_inputs(), compute_folded_tune(), DeployWindowRequired, DivergentRefusal (+34 more)

### Community 145 - "mcp.py"
Cohesion: 0.07
...
### Community 146 - "build_auto_selections"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (54): BaseModel, exposure(), ExposureAllowlistEntry, ExposureResponse, ExposureRule, login(), LoginRequest, logout() (+46 more)
...
### Community 149 - "PreloadEvictHost"
Cohesion: 0.26
...
### Community 152 - "Hal0MemoryProvider"
Cohesion: 0.08
...
Cohesion: 0.08
Nodes (24): Fire-and-forget trigger to refresh the Hermes live-context files.  Called from t, Spawn a detached ``hal0-agent <agent_id> render-context``. Never raises., spawn_context_refresh(), CapabilityApplyFailed, legal_children(), Any, CapabilitySelection, CapabilityOrchestrator — bridge between capability children and slots.  The dash (+16 more)
...
### Community 160 - "PortAuthority"
Cohesion: 0.10
Nodes (21): AuthorityClaim, PortAuthority, Any, Connection, Path, Row, Ports in LISTEN state inside the pool (best-effort psutil scan)., Lowest free port in the pool, honouring ``preferred`` when free. (+13 more)

### Community 161 - "hal0 R5 live install-validation — findings (stamp r5v1)"
Cohesion: 0.05
...
### Community 162 - "§7.1d — Capability / Modality Taxonomy untangle (ML-6)"
Cohesion: 0.05
...
### Community 166 - "FakeContainerProvider"
Cohesion: 0.07
...
### Community 167 - "json"
Cohesion: 0.05
Nodes (18): json(), AuthOpts, installAuth(), LIVE_BOARD, HERMES_ACTORS, CAPS_MOCK, comfyV2Idle(), comfyV2Status() (+10 more)

### Community 168 - "stacks.py"
Cohesion: 0.09
...
### Community 169 - "AgentMetadataConfig"
Cohesion: 0.06
...
### Community 170 - "test_hal0_provider_plugin.py"
Cohesion: 0.09
...
### Community 171 - "Hal0MemoryProvider"
Cohesion: 0.08
...
### Community 172 - "FakeMemoryProvider"
Cohesion: 0.06
...
### Community 175 - "install_openwebui"
Cohesion: 0.11
...
### Community 177 - ".json"
Cohesion: 0.07
Nodes (42): npu_trio_slot_root(), TestClient, coresident_group must key off device==npu, not the legacy slot names.      Deplo, Lay down the NPU FLM trio (agent + stt-npu + embed-npu) on disk., A model-less NPU LLM anchor → no trio markers on the siblings (#1369).      This, #1369: membership follows the anchor, with no per-sibling opt-out.      The shad, A slot's [model].n_gpu_layers rides along in the payload., spec-hw-slot-ownership §1: a stray slot-level ``enable_thinking`` (pre-     migr (+34 more)

### Community 178 - "plan_fold"
Cohesion: 0.10
...
### Community 180 - "test_kb1_hardening_tail.py"
Cohesion: 0.07
...
### Community 181 - "compute_config_drift"
Cohesion: 0.08
...
### Community 182 - "test_personas.py"
Cohesion: 0.08
...
### Community 184 - "test_slots_image_pull.py"
Cohesion: 0.09
...
### Community 185 - "test_agent_install_hermes.py"
Cohesion: 0.05
...
### Community 189 - "test_hindsight_provider.py"
Cohesion: 0.08
...
Cohesion: 0.07
Nodes (41): Path, Regression: the slot-edit Save's ``PATCH /defaults`` must not wipe the     model, #585: the dashboard writes ``ctx_size``; it must persist as the canonical     ``, When the NPU LLM anchor has a model bound, every trio slot gets coresident_group, GET /api/slots/{name} is enriched same shape as the list endpoint., #863: single-slot status includes argv drift without burdening list()., v0.1.x clients consuming /api/slots see every legacy key unchanged., PR-18: each entry carries ``type`` + ``model_default``.      The dashboard's per (+33 more)

### Community 193 - "test_v1_npu_trio_routing.py"
Cohesion: 0.09
...
### Community 195 - "test_unit_files.py"
Cohesion: 0.05
...
### Community 196 - "Benchmarks.tsx"
Cohesion: 0.09
Nodes (36): BENCH_OPTIONS, Benchmarks(), BenchOption, CAP_ALIAS, CAP_COLOR, CAP_SVG, CellRow, cellTd (+28 more)

### Community 197 - "R5 sync assessment — how far every surface is from "back in sync" (2026-07-19)"
Cohesion: 0.05
...
### Community 201 - "TestUpstreamEntry"
Cohesion: 0.07
...
### Community 202 - "resolve_gpu_group_ids"
Cohesion: 0.11
...
### Community 203 - "test_model_store.py"
Cohesion: 0.10
...
### Community 210 - "plan_slot_flags_fold"
Cohesion: 0.10
...
### Community 211 - "test_mtp_override.py"
Cohesion: 0.09
...
### Community 212 - "recommend_primary_slot"
Cohesion: 0.10
...
### Community 214 - "SlotIdentityStore"
Cohesion: 0.12
...
### Community 216 - "test_contract_compatibility.py"
Cohesion: 0.06
...
### Community 217 - "test_typed_errors.py"
Cohesion: 0.10
...
### Community 218 - "_RecordingProvider"
Cohesion: 0.08
Nodes (42): BoardStore, SQLite repository for the Operator Board.      The documented interface is exact, Conflict, 409 — the request conflicts with current resource state.      Use for duplicate-, _FakeClient, Path, BoardStore — hal0-owned board repository (KB-4).  Covers CRUD against the frozen, Stub HermesKanbanClient.request_json for import tests. (+34 more)

### Community 219 - "MonkeyPatch"
Cohesion: 0.09
...
### Community 220 - "Appendix: raw area reports"
Cohesion: 0.05
...
### Community 223 - "test_openrouter_auth_loopback.py"
Cohesion: 0.09
...
### Community 224 - "test_model_meta.py"
Cohesion: 0.06
Nodes (33): capability_from_filename(), classify(), DeviceMeta, is_resolvable(), labels_of(), model_capabilities_of(), Any, model_meta — the one home for model classification + device→backend resolution. (+25 more)

### Community 225 - "_resolve_llama_scalars"
Cohesion: 0.10
Nodes (42): Resolve every llama-server launch scalar for a slot+model+profile.      SINGLE S, _resolve_llama_scalars(), _FakeProfile, Golden path #5 (pull→assign→infer) — launch-time profile-read invariant.  spec-f, FLAGS-own: even handed the (now-inert) profile/slot flag params, the argv     bu, spec §8: assert the profile flag resolver is NOT called on the launch     path —, Minimal stand-in for a resolved profile (image/device axis only)., test_launch_builder_emits_no_profile_or_slot_flag_segment() (+34 more)

### Community 226 - "test_memory_graph_route.py"
Cohesion: 0.13
Nodes (31): _build_app(), client(), hal0_home(), _HindsightyWrapper, Any, FastAPI, MonkeyPatch, Path (+23 more)

### Community 227 - "test_pulling_serving_idle.py"
Cohesion: 0.11
...
### Community 229 - "§17 installer/setup overhaul — edit-plan (thin shell + thick Python, one profile authority, one slot roster)"
Cohesion: 0.06
...
### Community 230 - "P3 slot-identity + ports — implementation spec"
Cohesion: 0.06
...
### Community 233 - "resolve_role_slots"
Cohesion: 0.13
...
### Community 234 - "provision_comfyui_downloads"
Cohesion: 0.08
...
### Community 235 - "orchestrate_models"
Cohesion: 0.09
...
### Community 236 - "test_doctor_json_diagnoses.py"
Cohesion: 0.09
...
### Community 238 - "test_route_to_chat.py"
Cohesion: 0.09
...
### Community 240 - "test_update_check.py"
Cohesion: 0.09
...
### Community 243 - "test_installer_routes.py"
Cohesion: 0.09
...
### Community 248 - "SlotWatchdog"
Cohesion: 0.06
Nodes (31): ModelCacheCheck, PullRunner, container_provider(), Return the process-wide ContainerProvider singleton., ImagePullJob, inspect_image_state(), Any, Container-image pull orchestration for slots (extracted from routes/slots.py). (+23 more)

### Community 249 - "write_toml_atomic"
Cohesion: 0.04
Nodes (56): OSError, Load by canonical agent name (``/etc/hal0/agents/<name>.toml``)., ConfigError, ConfigNotFound, _drop_dead_keys(), _find_manifest_path(), _flatten_slot_toml(), list_agent_configs() (+48 more)

### Community 250 - "test_v1_chat_slot_alias.py"
Cohesion: 0.13
...
### Community 251 - "hw_slot_ownership.py"
Cohesion: 0.10
...
### Community 252 - "resolve_by_capability"
Cohesion: 0.07
Nodes (35): load_hardware_info(), Path, Load /etc/hal0/hardware.json and return a validated HardwareInfo.      Returns t, Atomically write hardware.json.      Uses the same tmpfile+fsync+rename pattern, save_hardware_info(), HardwareInfo, NPUInfo, One detected NPU (AMD XDNA / future vendors). (+27 more)

### Community 253 - "test_admin_route_map_nested.py"
Cohesion: 0.10
...
### Community 255 - "test_slots_container_state.py"
Cohesion: 0.09
...
### Community 257 - "FakeContainerProvider"
Cohesion: 0.11
Nodes (13): container_stub(), FakeContainerProvider, Any, MonkeyPatch, Path, pytest_configure(), Pytest fixtures and marker registration for the slots subtree.  Phase E (#687):, Replace the process-wide ContainerProvider with the in-memory fake.      SlotMan (+5 more)
...
### Community 259 - "Hal0MemoryClient"
Cohesion: 0.09
...
### Community 260 - "test_upstream_dedup.py"
Cohesion: 0.13
...
### Community 262 - "test_agent_uninstall_memory.py"
Cohesion: 0.12
...
### Community 264 - "PgVectorProvider"
Cohesion: 0.06
...
### Community 267 - "test_metrics_prometheus_route.py"
Cohesion: 0.09
...
### Community 271 - "browser_server.py"
Cohesion: 0.10
...
### Community 272 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.06
...
### Community 277 - "test_tts_capability_switch.py"
Cohesion: 0.07
...
### Community 280 - "LlamaServerProvider"
Cohesion: 0.06
Nodes (54): get_provider(), hal0.providers — Inference backend abstraction layer.  Each Provider is a statel, Return the singleton Provider for ``name``.      Raises:         KeyError: If no, LlamaServerProvider, ProviderHealthError, ProviderInferError, Any, llama.cpp HTTP-client surface — NOT a launcher.  This module used to own the lla (+46 more)

### Community 281 - "test_memory_admin_routes.py"
Cohesion: 0.17
...
### Community 282 - "test_brain_injection.py"
Cohesion: 0.17
...
### Community 283 - "test_crash_loop_breaker.py"
Cohesion: 0.15
...
### Community 284 - "Platform-wide cron/automation management — design"
Cohesion: 0.06
...
### Community 286 - "hal0 ROCmFPX quantization"
Cohesion: 0.06
...
### Community 291 - "test_container_gate.py"
Cohesion: 0.11
...
### Community 292 - "test_brain_resilience.py"
Cohesion: 0.16
...
### Community 294 - "ML-2 (file-set pulling) + ML-3 (unified store) — implementation spec"
Cohesion: 0.06
...
### Community 295 - "manifest.py"
Cohesion: 0.07
Nodes (39): HttpFetcher, IPv4Address, IPv6Address, child_to_slot(), Resolve a (slot, child) tuple to its underlying slot name.      Raises :class:`B, BadRequest, 400 — the request was syntactically or semantically invalid.      Use this for c, _coerce_int() (+31 more)

### Community 296 - "profile.py"
Cohesion: 0.09
Nodes (21): hal0-provider — Hermes ``ProviderProfile`` plugin (canonical, shipped source)., Register the hal0 provider profile.      Prefers a ``PluginContext`` seam if one, register(), assemble_stream(), Hal0ProviderProfile, is_alias(), iter_sse_data(), parse_sse_chunks() (+13 more)

### Community 297 - "chat_proxy.py"
Cohesion: 0.11
...
### Community 298 - "get_doctor"
Cohesion: 0.06
Nodes (32): DiagnosisOut, DoctorResponse, EvidenceOut, get_doctor(), NextStepOut, Diagnosis, Request, T (+24 more)

### Community 299 - "_shared.py"
Cohesion: 0.10
Nodes (32): board_move(), Move a task to a different lane (PATCH /api/board/tasks/{id})., Uninstall a user-installed MCP server. Bundled servers reject 409., uninstall_cmd(), graph_disable_cmd(), Turn graph extraction OFF; cancels any in-flight build., _api_reachable(), api_delete() (+24 more)

### Community 300 - "test_diagnosis.py"
Cohesion: 0.11
...
### Community 301 - "EventBus"
Cohesion: 0.07
Nodes (39): EventBus, make_event(), _now_iso(), Any, Queue, In-process event bus + ring buffer for the dashboard footer.  The footer status, Append an event to the ring and fan it out to every subscriber.          Never b, Push to a subscriber queue, dropping oldest on overflow.          A slow consume (+31 more)

### Community 302 - "update"
Cohesion: 0.06
Nodes (44): Enum, config_edit(), config_migrate(), _config_path(), config_show(), ConfigFile, _hal0_toml_path(), Path (+36 more)

### Community 303 - "repository.py"
Cohesion: 0.10
...
### Community 304 - "build_request_metric_row"
Cohesion: 0.10
...
### Community 307 - "test_chat_normalization.py"
Cohesion: 0.07
...
### Community 308 - "test_doctor_all.py"
Cohesion: 0.08
...
### Community 309 - "test_preflight_gpu_gate.py"
Cohesion: 0.10
...
### Community 310 - "useLogs.ts"
Cohesion: 0.10
Nodes (20): appendEntry(), entryKey(), parseRawLevel(), buildJournalQuery(), JournalEntry, JournalLevel, JournalSource, LogEntry (+12 more)

### Community 311 - "useRuntimes.ts"
Cohesion: 0.11
Nodes (23): Confidence, CONFIDENCES, Diagnosis, DoctorFeed, Evidence, hardwareEvidence(), mb(), NextStep (+15 more)

### Community 312 - "mcp_mount.py"
Cohesion: 0.11
...
### Community 314 - "flm_served_models"
Cohesion: 0.09
...
### Community 315 - "test_agents_personas.py"
Cohesion: 0.15
...
### Community 316 - "test_chat_proxy.py"
Cohesion: 0.14
...
### Community 318 - "test_journal_routes.py"
Cohesion: 0.13
...
### Community 319 - "test_board_chat_admin_tools.py"
Cohesion: 0.12
...
### Community 320 - "test_board_routes.py"
Cohesion: 0.10
...
### Community 321 - "test_uninstall.py"
Cohesion: 0.10
...
### Community 322 - "test_bootstrap_prereq_parity.py"
Cohesion: 0.11
...
### Community 323 - "test_degrade_live.py"
Cohesion: 0.11
...
### Community 324 - "test_fail_watcher_warming.py"
Cohesion: 0.15
...
Cohesion: 0.20
Nodes (9): Unit tests for ``hal0.dispatcher.single_flight.SingleFlightGroup``.  Core invari, In-flight map evicts after completion so a later call runs again., 100 concurrent ``do(key, fn)`` calls → fn is invoked exactly once.      This is, On error, every waiter sees the same exception — no retry storm., test_100_concurrent_identical_calls_share_one_invocation(), test_distinct_keys_run_independently(), test_exception_is_shared_with_all_waiters(), test_kwargs_and_args_pass_through() (+1 more)
...
### Community 329 - "hal0_slot_alias_models"
Cohesion: 0.12
...
### Community 332 - "slot_write_lock"
Cohesion: 0.08
Nodes (31): Protocol, device_to_backend(), Map hal0's ``device`` enum onto the recipe+backend pair.      Args:         devi, Atomically write a slot TOML.      THE byte-level write path for ``/etc/hal0/slo, Hold the coarse cross-process lock for ALL slots/*.toml writes.      Historicall, slot_write_lock(), write_slot_toml(), Write ``[model] default = <model_id>`` into the slot's TOML.          Preserves (+23 more)

### Community 333 - "resolve_chain"
Cohesion: 0.13
...
### Community 334 - "import_toml_to_sqlite"
Cohesion: 0.12
...
### Community 335 - "test_npu_exclusivity.py"
Cohesion: 0.11
...
### Community 339 - "test_workflow_contract.py"
Cohesion: 0.15
...
### Community 340 - "Tier 2 — medium (one PR each)"
Cohesion: 0.07
...
### Community 341 - "PART 0 — Current registry, mapped (file:line)"
Cohesion: 0.07
...
### Community 345 - "test_v1_images.py"
Cohesion: 0.07
Nodes (38): _build_brain_profile_mcp_servers(), _live_resolve_enabled(), path_is_writable(), _phase_brain_profile_mcp_wire(), _phase_brain_profile_seed(), _phase_config_write(), _phase_env_probe(), _phase_gateway_secrets_wire() (+30 more)

### Community 346 - "get_curated"
Cohesion: 0.10
Nodes (33): _atomic_symlink(), _ensure_canonical_dirs(), _entry_disk_path(), execute_plan(), _iter_files(), _migrate_callback(), MigrationReport, model_layout() (+25 more)

### Community 347 - "merge_slot_config"
Cohesion: 0.11
...
### Community 351 - "_container_npu_cfg"
Cohesion: 0.10
...
### Community 352 - "test_pressure_eviction.py"
Cohesion: 0.20
...
### Community 353 - "Changelog"
Cohesion: 0.08
Nodes (23): [0.9.2] — 2026-07-05, [0.9.4.1] — 2026-07-08, [0.9.5.2] — 2026-07-09, [0.9.6.1] — 2026-07-11, Added, Added, Breaking, Changed (+15 more)

### Community 354 - "Recommended hal0 ideas"
Cohesion: 0.07
...
### Community 355 - "hal0 Hermes Integration Suite Implementation Plan"
Cohesion: 0.07
...
### Community 359 - "Provider"
Cohesion: 0.13
Nodes (29): backfill_coordless(), CandidateModel, find_candidates(), _is_mmproj_sidecar(), _is_skippable(), _match_curated(), _maybe_register_shard_files(), prune_missing() (+21 more)

### Community 360 - "Any"
Cohesion: 0.11
Nodes (20): loaded_model_names_from_slots(), _metrics_view(), Any, slot_view — stateless read-model aggregation for the slots dashboard (issue #698, Model ids currently served by dispatchable slots.      Derives the loaded set fr, Injected provider or the process-wide real one (lazy import)., Build virtual slot entries from configured upstreams.      Until every upstream, Eagerly compose the full ``/api/slots`` read model.      Constructor deps mirror (+12 more)

### Community 361 - "test_agent_restart_endpoint.py"
Cohesion: 0.18
...
### Community 367 - "test_router_loop.py"
Cohesion: 0.19
...
### Community 368 - "test_event_contract.py"
Cohesion: 0.15
...
### Community 369 - "test_migrate_haloai.py"
Cohesion: 0.15
...
### Community 370 - "main.jsx"
Cohesion: 0.04
Nodes (53): bundleNameOr(), InstallState, InstallStateBundle, useInstallState(), DEMO_MIGRATION_REPORT, EMPTY_MIGRATION_REPORT, MigrationFlagConflict, MigrationReport (+45 more)

### Community 371 - "agents.mdx"
Cohesion: 0.08
Nodes (20): Data flow of a chat request, hal0-api: the control plane, Slots: where models actually run, Stacks: applying a slot set as one unit, The dispatcher: routing a request, The front ends, The pieces, Where to go next (+12 more)

### Community 372 - "ML-4 (runner-image registry) + ML-5 (flag resolution) — implementation-ready spec"
Cohesion: 0.08
...
### Community 373 - "R5 — Surface + launch"
Cohesion: 0.08
...
### Community 377 - "HermesBoardExecutor"
Cohesion: 0.15
...
### Community 378 - "test_doctor_profiles.py"
Cohesion: 0.10
...
### Community 379 - "Path"
Cohesion: 0.09
Nodes (25): applied_versions(), _discover_migrations(), _ensure_migrations_table(), migrate(), Connection, Path, Forward-only SQLite schema migration runner.  This is the concrete implementatio, Create the bookkeeping table if absent. Idempotent. (+17 more)

### Community 380 - "perms.py"
Cohesion: 0.12
Nodes (22): _apply_one(), audit_rows(), _child_mode_for(), commit(), _expand_row(), _group_name(), observe(), _owner_name() (+14 more)

### Community 381 - "HindsightRestClient"
Cohesion: 0.10
...
### Community 382 - "evaluate_model_fit"
Cohesion: 0.47
...
Cohesion: 0.11
Nodes (24): Unit tests for :mod:`hal0.mcp.installed` — #305 registry layer., Registry TOMLs hold env blocks (API keys); they must be 0o600 + dir 0o700., Calling ``installed.uninstall("hal0-admin")`` rejects before disk lookup.      B, ``id="../evil"`` must reject at the registry validator, not after stat.      Eve, #382: patch_config wraps its read-modify-write in an advisory lock.      Functio, _record(), test_get_installed_missing_raises_not_found(), test_install_and_list_round_trip() (+16 more)
...
### Community 392 - "test_flm_container_spec.py"
Cohesion: 0.17
...
### Community 394 - "test_id_keying.py"
Cohesion: 0.20
...
### Community 398 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 399 - "hal0 benchmarking system — full design (batch runs, rich run detail, display, auto-update)"
Cohesion: 0.08
...
### Community 402 - "read_gguf_header"
Cohesion: 0.18
...
### Community 407 - "chat_commands.py"
Cohesion: 0.14
...
### Community 412 - "migrate_slot_id_keying"
Cohesion: 0.14
...
### Community 413 - "parse_text_tool_calls"
Cohesion: 0.13
...
### Community 414 - "test_dashboard_layout.py"
Cohesion: 0.11
...
### Community 415 - "test_logs_routes.py"
Cohesion: 0.11
...
### Community 416 - "test_v1_models_filters.py"
Cohesion: 0.20
...
### Community 419 - "test_upstream_commands.py"
Cohesion: 0.15
...
### Community 420 - "test_seeds_data.py"
Cohesion: 0.08
...
### Community 421 - "test_memory_delete_auth.py"
Cohesion: 0.11
...
### Community 424 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.08
...
### Community 425 - "hal0 1.0 — Seeded profile rework"
Cohesion: 0.08
...
### Community 426 - "Hermes Python 3.12 Cross-Distro Installation Design"
Cohesion: 0.08
...
### Community 427 - "hal0_llm_slot_views"
Cohesion: 0.11
...
### Community 428 - "test_slots_routes.py"
Cohesion: 0.13
...
### Community 429 - "die"
Cohesion: 0.12
Nodes (28): board_list(), board_show(), hal0 board subcommands — thin HTTP client to /api/board/* (§5.2).  A small opera, List tasks by lane (GET /api/board/board)., Show one task (GET /api/board/tasks/{id})., bank_consolidate_cmd(), bank_delete_cmd(), bank_export_cmd() (+20 more)
...
### Community 432 - "seed_static_slots"
Cohesion: 0.17
...
### Community 433 - "_container_cgroup_mem_bytes"
Cohesion: 0.13
...
### Community 434 - "test_run_as_hal0_guard.py"
Cohesion: 0.13
...
### Community 435 - "test_slot_config_validation.py"
Cohesion: 0.19
...
### Community 436 - "test_brain_self_auth.py"
Cohesion: 0.18
...
### Community 438 - "test_npu_columns.py"
Cohesion: 0.15
...
### Community 441 - "_phase_preflight"
Cohesion: 0.14
...
### Community 443 - "personas.py"
Cohesion: 0.08
Nodes (35): activate_agent_persona(), get_agent_persona(), list_agent_personas(), _persona_detail(), _persona_summary(), PersonaApprovalUpdate, PersonaUpdateBody, Any (+27 more)

### Community 444 - "redact_log_line"
Cohesion: 0.12
...
### Community 451 - "embed_references"
Cohesion: 0.18
...
### Community 453 - "test_backends_npu_canonical_fields.py"
Cohesion: 0.13
...
### Community 457 - "test_brain_read_only.py"
Cohesion: 0.12
...
### Community 462 - "services.jsx"
Cohesion: 0.15
Nodes (22): canonical_json(), cell_key(), Identity, Any, What was driven at the engine: kind (pp/tg/chat/batch/embed/rerank/reuse),     t, The full identity block — the sole input to ``cell_key()``. Grouping the     fiv, One schema-2 record: one cell x one run. This is the exact object     appended (, Plain-dict JSON shape for the store. ``outcome`` is flattened to its         str (+14 more)

### Community 463 - "CliRunner"
Cohesion: 0.16
...
### Community 464 - "UI drawers — slot/model/profile editors"
Cohesion: 0.09
...
### Community 465 - "hal0 Settings Menu — Wireframe / IA"
Cohesion: 0.09
...
### Community 466 - "Enum"
Cohesion: 0.11
Nodes (27): auth_rotate(), auth_status(), KeyTier, hal0 auth subcommands — thin HTTP client to /api/auth/*.  §5.2 of the R5 sync as, Show the current auth posture (GET /api/auth/status)., Rotate the admin or client box key (POST /api/auth/rotate).      Mints a fresh k, RequireToggle, model_assign() (+19 more)

### Community 467 - "test_hermes_upgrade.py"
Cohesion: 0.20
...
### Community 468 - "dashboard_layout.py"
Cohesion: 0.11
...
### Community 469 - "test_tts_request_defaults.py"
Cohesion: 0.15
...
### Community 473 - "__init__.py"
Cohesion: 0.19
Nodes (20): claimed_by_other(), collect_claims(), _config_claims(), conflicts(), _listener_claims(), next_free(), _owners(), port_report() (+12 more)

### Community 474 - "gc.py"
Cohesion: 0.12
Nodes (19): MemoryConfig, [memory] section of hal0.toml.      Container for the per-subsystem memory tunab, _build(), TestClient, #613 — /api/status must expose memory_degraded for operator visibility.  Verifie, /api/status always carries a memory_degraded field., memory_degraded=None when no memory provider is wired., memory_degraded=True when PgVectorProvider (in-memory fallback) is wired. (+11 more)

### Community 475 - "config_enrichment"
Cohesion: 0.21
...
### Community 476 - "test_hermes_env_seam.py"
Cohesion: 0.15
...
### Community 478 - "test_providers.py"
Cohesion: 0.14
...
### Community 479 - "test_services_page.py"
Cohesion: 0.14
...
### Community 480 - "test_v1_proxy.py"
Cohesion: 0.14
...
### Community 481 - "test_virtual_models.py"
Cohesion: 0.17
...
### Community 482 - "test_brain_framing.py"
Cohesion: 0.23
...
### Community 483 - "test_trio_status_inheritance.py"
Cohesion: 0.18
...
### Community 484 - "test_doctor_verify.py"
Cohesion: 0.12
...
### Community 485 - "test_bootstrap_cosign_fetch.py"
Cohesion: 0.21
...
### Community 488 - "test_curated_image_models.py"
Cohesion: 0.12
...
### Community 491 - "test_seam_agent_units.py"
Cohesion: 0.10
...
### Community 492 - "Dashboard Overhaul — FROZEN DATA CONTRACT (v1)"
Cohesion: 0.09
...
### Community 495 - "P2-config: Collapse capabilities.toml double-bookkeeping"
Cohesion: 0.10
...
### Community 499 - "slots_config_dir"
Cohesion: 0.18
...
### Community 501 - "test_fetch_ws_g.py"
Cohesion: 0.14
...
### Community 504 - "container_enrichment"
Cohesion: 0.12
...
### Community 505 - "read_stack_state"
Cohesion: 0.15
...
### Community 506 - "test_memory_admin_document_transfer.py"
Cohesion: 0.20
...
### Community 507 - "test_pull_shutdown.py"
Cohesion: 0.13
...
### Community 508 - "test_throughput_history.py"
Cohesion: 0.19
...
### Community 509 - "test_eligibility.py"
Cohesion: 0.10
...
### Community 510 - "test_model_less_capability_slot_is_not_woken"
Cohesion: 0.20
...
### Community 511 - "Security review — v1.0 auth surface (2026-05-21)"
Cohesion: 0.10
...
### Community 512 - "_write_fake_python"
Cohesion: 0.20
...
### Community 513 - "test_approval_queue.py"
Cohesion: 0.18
...
### Community 515 - "test_manager_npu_container.py"
Cohesion: 0.20
...
### Community 517 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.10
...
### Community 522 - "_refresh_model_cache_on_ready"
Cohesion: 0.11
...
### Community 527 - "MemoryGraphConfig"
Cohesion: 0.13
...
### Community 529 - "network.py"
Cohesion: 0.15
Nodes (19): _coerce_port(), _dedupe(), derive_allowed_origins(), detect_lan_ips(), _is_lan_ipv4(), main(), network_env(), _origin_of() (+11 more)

### Community 530 - "TestSlotHardwareSegment"
Cohesion: 0.06
Nodes (25): _model_info(), Any, Unit tests for ``hal0.providers.container.ContainerProvider``.  Issue #655 — tra, Registry-miss contract (Phase C final review): model_info without a     ``path``, Regression guard for the 2026-06-15 chat@4096 incident: a slot whose     TOML pi, halo150/143 O8+O11: ONE render for every substrate — no version branch.      Nat, spec-hw-slot-ownership §2: the slot owns NGL + THREADS; the model no     longer, ``_container_runtime`` resolves podman wherever PATH puts it (snap,     /usr/loc (+17 more)

### Community 531 - "_reconcile_device_profile"
Cohesion: 0.20
...
### Community 534 - "test_capabilities_commands.py"
Cohesion: 0.18
...
### Community 537 - "test_model_store_root.py"
Cohesion: 0.14
...
### Community 539 - "TestEarlyHal0User"
Cohesion: 0.10
...
### Community 541 - "test_fail_watcher.py"
Cohesion: 0.18
...
### Community 542 - "0. Research-grounded findings that drive the matrix"
Cohesion: 0.11
...
### Community 549 - "test_board_dispatch.py"
Cohesion: 0.22
...
### Community 550 - "model_commands.py"
Cohesion: 0.09
Nodes (26): mm_history_cmd(), mm_list_cmd(), mm_refresh_cmd(), ``hal0 memory mm`` — mental-model admin (list / refresh / history)., List a bank's mental models., Trigger a refresh of a mental model (async)., Show a mental model's revision history., _require_api() (+18 more)

### Community 551 - "_register"
Cohesion: 0.25
...
### Community 552 - "test_port_registry.py"
Cohesion: 0.23
...
### Community 554 - "test_settings_routes.py"
Cohesion: 0.15
...
### Community 555 - "Any"
Cohesion: 0.11
Nodes (19): container_stub(), Any, Labels list is omitted (not empty) when the slot config has no     ``model.label, The enriched body must be valid JSON (no exotic types leaked)., An explicit upstreams.toml entry for ``hal0`` survives startup unchanged.      O, PUT /config has no lifecycle side effect — a running slot stays running.      Th, Patch ``container_provider()`` with a stateful fake; yield its state.      The f, A legacy ``{"enabled": ...}`` write is refused loudly, not silently kept.      A (+11 more)

### Community 556 - "_stub_bin"
Cohesion: 0.23
...
### Community 558 - "test_npu_swap_status.py"
Cohesion: 0.15
...
### Community 559 - "test_pull_refcount_rows.py"
Cohesion: 0.20
...
### Community 560 - "test_store_concurrency.py"
Cohesion: 0.19
...
### Community 562 - "test_load_converges_config.py"
Cohesion: 0.24
...
### Community 563 - "test_manager_readiness_api.py"
Cohesion: 0.08
Nodes (30): Push a record onto every active SSE subscriber queue., Async generator yielding every slot state transition as it happens.          Use, Any, Path, Serialisable snapshot of a slot's lifecycle state on disk.      Stored as JSON a, Persist a SlotStateRecord atomically.      Tier 1 fix: matches the env-file patt, SlotStateRecord, write_state_atomic() (+22 more)

### Community 564 - "hal0 architecture & reference"
Cohesion: 0.11
...
### Community 565 - "FakeDelegateRunner"
Cohesion: 0.16
...
### Community 566 - "2. Bugs (correctness — ordered by impact)"
Cohesion: 0.11
...
### Community 567 - "manage-slots.mdx"
Cohesion: 0.11
...
### Community 569 - "spec-kb23 — hal0-brain chat tool-tier, approval-gate & injection-resistance"
Cohesion: 0.11
...
### Community 570 - "hal0-admin tools"
Cohesion: 0.11
...
### Community 571 - "kokoro_server.py"
Cohesion: 0.14
...
### Community 573 - "ensure_podman_apparmor_usable"
Cohesion: 0.19
...
### Community 574 - "write_gateway_secrets_dropin"
Cohesion: 0.08
Nodes (24): bootstrap_cli(), _detect_foreign_gateways(), _gateway_dropin_body(), GatewayDropinResult, _privileged_systemctl(), Render the gateway secrets drop-in body.      Mirrors the live drop-in: a why-co, Outcome of :func:`write_gateway_secrets_dropin`.      ``outcome`` is one of ``"w, Idempotently write the gateway secrets drop-in + ``daemon-reload`` (#437). (+16 more)

### Community 575 - "ProgressCoalescer"
Cohesion: 0.14
...
### Community 579 - "api_put"
Cohesion: 0.28
Nodes (8): _add_write_rows(), disable_cmd(), enable_cmd(), hal0 memory subcommands — graph-extraction gate.  Mirrors the slot / model CLI s, Render the retain-pipeline rows for ``hal0 memory status`` (#1420)., Enable the memory subsystem (persists [memory].enabled=true)., Disable the memory subsystem (persists [memory].enabled=false)., _set_enabled()

### Community 580 - "slot_migrate_flags"
Cohesion: 0.32
...
### Community 582 - "fetch_npu_swap_status"
Cohesion: 0.14
...
### Community 584 - "provider_from_config"
Cohesion: 0.23
...
### Community 588 - "unknown_slot_config_keys"
Cohesion: 0.12
Nodes (11): fold_ctx_size_alias(), Fold the legacy ``[model].ctx_size`` alias into the canonical     ``context_size, Dotted paths of payload keys the slot-config schema does not know.      ``SlotCo, unknown_slot_config_keys(), Unit tests for the slot-config write helpers added in the guarded-writes wave: `, The 'before' snapshot sharing the [model] object is never mutated., #1369: ``enabled`` is no longer a declared field, so the boundary         must f, Every declared ServerConfig field passes without a hardcoded list —         this (+3 more)

### Community 589 - "arbiter.py"
Cohesion: 0.12
...
### Community 590 - "CapacityProbeError"
Cohesion: 0.13
...
### Community 591 - "test_hermes_security_deliverables.py"
Cohesion: 0.15
...
### Community 595 - "test_models_preview.py"
Cohesion: 0.19
...
### Community 597 - "test_settings_apply.py"
Cohesion: 0.11
...
### Community 598 - "test_v1_dispatch.py"
Cohesion: 0.16
...
### Community 599 - "test_doctor_perms.py"
Cohesion: 0.19
...
### Community 602 - "FakeLocalBackend"
Cohesion: 0.17
...
### Community 603 - "test_logs_tail_redaction.py"
Cohesion: 0.11
...
### Community 604 - "_render_from_spec"
Cohesion: 0.21
...
### Community 605 - "3. Proposed seed catalog (one per type)"
Cohesion: 0.12
...
### Community 606 - "Slot config — capabilities ↔ slots reconciliation"
Cohesion: 0.12
...
### Community 607 - "hal0 Adoption Candidates — Lemonade + ODS (combined)"
Cohesion: 0.12
...
### Community 608 - "spec-hp-realtime — OpenAI Realtime WebSocket endpoint for hal0"
Cohesion: 0.12
...
### Community 609 - "P3-schema — `config/schema.py` decomposition: implementation-ready spec"
Cohesion: 0.12
...
### Community 610 - "Prerelease Preview Pipeline Hardening"
Cohesion: 0.12
...
### Community 614 - "test_schema_seeds_c5.py"
Cohesion: 0.18
...
### Community 616 - "apply_extraction_slot"
Cohesion: 0.18
...
### Community 618 - "normalize_system_messages"
Cohesion: 0.18
...
### Community 621 - "metrics_collect.py"
Cohesion: 0.15
...
### Community 622 - "snapshot_live_stack"
Cohesion: 0.30
...
### Community 623 - "test_hermes_state_render.py"
Cohesion: 0.12
...
### Community 625 - "test_cli_auth_streamtest.py"
Cohesion: 0.21
...
### Community 626 - "Findings from the 2026-05-16 hal0-test deep-probe round"
Cohesion: 0.12
...
### Community 627 - "DelegateTaskSpec"
Cohesion: 0.18
...
### Community 628 - "test_preflight_ports_own_service.py"
Cohesion: 0.29
...
### Community 629 - "agents-overview.jsx"
Cohesion: 0.20
...
### Community 630 - "test_npu_trio_shadow.py"
Cohesion: 0.18
Nodes (15): _anchor(), _gpu_slot(), patched_spawn(), MonkeyPatch, Path, NPU FLM trio *shadow* handling in SlotManager (shape-consolidation Unit 0).  The, Loading an stt/embed shadow must NOT spawn a child (would 500 on NPU)., The chat anchor (device=npu type=llm) is NOT a shadow — it must spawn. (+7 more)

### Community 631 - "test_ttft_samples.py"
Cohesion: 0.12
...
### Community 640 - "RecordingSlotArtifactOps"
Cohesion: 0.22
...
### Community 641 - "test_hermes_provision_install_artifacts.py"
Cohesion: 0.17
...
### Community 642 - "test_agents_routes.py"
Cohesion: 0.21
...
### Community 643 - "test_mcp_identity.py"
Cohesion: 0.18
...
### Community 644 - "_StubSlotManager"
Cohesion: 0.26
...
### Community 645 - "test_catalog_backends.py"
Cohesion: 0.19
...
### Community 646 - "FakeDockerBackend"
Cohesion: 0.16
...
### Community 647 - "hal0 test harness — internal contributor guide"
Cohesion: 0.12
...
### Community 649 - "Model registry — registry, pulls, classification"
Cohesion: 0.13
...
### Community 650 - "Handoff: qwen3tts standalone → hal0-slot migration"
Cohesion: 0.13
...
### Community 651 - "Container Image System Overhaul"
Cohesion: 0.13
...
### Community 652 - "hal0 rework plan — de-scarring the launch"
Cohesion: 0.13
...
### Community 653 - "Handoff — brain + embed slot/agent cleanup on halo150"
Cohesion: 0.13
...
### Community 654 - "Handoff — γ-suite (chromium) persistently red on main (#1333)"
Cohesion: 0.13
...
### Community 655 - "Handoff — fold rework→main merge/meld/fix follow-ups into the R5 docs"
Cohesion: 0.13
...
### Community 656 - "Handoff — hal0 R5 endgame (paste-in brief for a new session)"
Cohesion: 0.13
...
### Community 657 - "Findings (O-series)"
Cohesion: 0.13
...
### Community 659 - "hal0 Hermes Integration Suite Design"
Cohesion: 0.13
...
### Community 660 - "PR #1330 CI Repair Design"
Cohesion: 0.13
...
### Community 662 - "test_route_collisions.py"
Cohesion: 0.19
...
### Community 663 - "test_hermes_live_resolve_render.py"
Cohesion: 0.19
...
### Community 664 - "upsert_env_value"
Cohesion: 0.06
Nodes (40): _atomic_write(), delete_env_value(), _escape(), _line_targets_key(), list_env_keys(), Path, Atomic ``api.env`` secret store shared by the providers + secrets routers.  ``/e, Remove every line setting ``key`` from ``api_env`` atomically.      Returns ``Tr (+32 more)

### Community 665 - "create_chat_template"
Cohesion: 0.24
...
### Community 666 - "test_slots_policy.py"
Cohesion: 0.26
...
### Community 670 - "write_openwebui_env"
Cohesion: 0.18
...
### Community 672 - "systemd.py"
Cohesion: 0.16
Nodes (17): clear_executors(), Drop all registered executors (test isolation / teardown)., Shared systemctl helpers for the companion-service management layer.  Until now, Return a ``.timer`` unit's calendar expression + last/next trigger.      Shape (, True when ``systemctl is-active <unit>`` reports ``active``., Run one allow-listed lifecycle verb against ``unit``.      Returns ``{"ok": bool, True when ``unit`` is a plausible systemd unit name., Run ``systemctl <args>``; (rc, stdout, stderr), rc=None on no-systemd/timeout. (+9 more)

### Community 673 - "test_hermes_provision_kanban_db_init.py"
Cohesion: 0.20
...
### Community 674 - "test_persona_update.py"
Cohesion: 0.25
...
### Community 676 - "test_brain_ctx_precheck.py"
Cohesion: 0.23
...
### Community 679 - "test_pool_bounds.py"
Cohesion: 0.15
...
### Community 681 - "test_api_restart_on_upgrade.py"
Cohesion: 0.28
...
### Community 682 - "test_admin_route_map.py"
Cohesion: 0.17
...
### Community 683 - "test_container_mmproj.py"
Cohesion: 0.31
...
### Community 684 - "test_release_check.py"
Cohesion: 0.37
...
### Community 685 - "test_device_profile_coherence.py"
Cohesion: 0.18
...
### Community 686 - "test_mtp_defuse.py"
Cohesion: 0.34
...
### Community 687 - "test_integrations.py"
Cohesion: 0.13
...
### Community 691 - "Toolbox Repo Consolidation"
Cohesion: 0.14
...
### Community 692 - "obtain-models.mdx"
Cohesion: 0.14
...
### Community 693 - "Deploy halves of the "CI here" scenarios"
Cohesion: 0.14
...
### Community 694 - "PART 2 — DELIVERABLES"
Cohesion: 0.14
...
### Community 695 - "0. EXACT Honcho footprint (file:line)"
Cohesion: 0.14
...
### Community 696 - "P2-device: make `device` the sole truth, delete the `backend` dual-write"
Cohesion: 0.14
...
### Community 697 - "Handoff — R5 drive 2: put it back together (paste-in prompt, Fable orchestrator)"
Cohesion: 0.14
...
### Community 698 - "hal0 1.0 Seeded Profile Rework — Implementation Plan"
Cohesion: 0.14
...
### Community 700 - "Phase 4 handoff — halo143 deploy window"
Cohesion: 0.14
...
### Community 701 - "test_ports_command.py"
Cohesion: 0.22
...
### Community 702 - "test_moonshine_server.py"
Cohesion: 0.22
...
Cohesion: 0.14
Nodes (12): AttemptHandle, dispatch(), DispatchResult, Any, Board executor dispatch seam (KB-5) — interface + registry, no-op default.  hal0, Dispatch one attempt for ``card_id`` to ``target``'s executor.      Returns a :c, One immutable dispatch attempt + its cross-system correlation.      hal0 owns ``, Return a copy advanced to ``status`` with any new correlation ids. (+4 more)
...
### Community 713 - "heal_missing_llm_type"
Cohesion: 0.20
...
### Community 714 - "provider_requires_model"
Cohesion: 0.22
...
### Community 715 - "test_hermes_provision_context.py"
Cohesion: 0.14
...
### Community 716 - "test_middleware.py"
Cohesion: 0.21
...
### Community 717 - "test_services_health.py"
Cohesion: 0.27
...
Cohesion: 0.17
Nodes (5): Drift guard: the dispatchable ready-set has a single source of truth (DR-8).  Fi, #791: a serving slot with health_ok False reports up=0., #792/#31: a model-requiring serving slot with empty cache surfaces idle., test_metrics_health_ok_false_forces_down(), test_slot_view_serving_empty_cache_downgrades_to_idle()
...
### Community 748 - "_instrument_streaming_throughput"
Cohesion: 0.10
Nodes (33): _comfyui_renderable_builtin_ids(), _dispatch_via_npu_trio(), _extract_multipart_model(), _forward_multipart(), _instrument_streaming_throughput(), _is_comfyui_checkpoint_renderable(), _is_npu_trio_request(), Any (+25 more)

### Community 749 - "main.py"
Cohesion: 0.15
...
### Community 778 - "Release pipeline — prototype findings + blockers"
Cohesion: 0.17
...
### Community 782 - "TestTelemetrySampler"
Cohesion: 0.17
...
### Community 783 - "test_board_ws.py"
Cohesion: 0.32
...
### Community 784 - "test_agent_status.py"
Cohesion: 0.23
...
### Community 786 - "test_comfyui_scripts_shipped.py"
Cohesion: 0.17
...
### Community 787 - "test_static_seeds.py"
Cohesion: 0.17
...
### Community 788 - "board-chat-v3.spec.ts"
Cohesion: 0.29
...
### Community 789 - "[Unreleased]"
Cohesion: 0.15
Nodes (13): Added, Added, Breaking, Changed, Fixed, Fixed, Fixed, Fixed (+5 more)

### Community 790 - "`hal0-setup.yaml` — headless answer-file spec (2026-07-05)"
Cohesion: 0.18
...
### Community 791 - "Findings → fixes, by tier"
Cohesion: 0.18
...
### Community 792 - "Handoff: model-pipeline plan — finish-out pass"
Cohesion: 0.18
...
### Community 793 - "Hal0 Upstream Controls — Epic Plan (2026-07-06)"
Cohesion: 0.18
...
### Community 794 - "capabilities-and-profiles.mdx"
Cohesion: 0.18
...
### Community 795 - "Admin tools (`/mcp/admin`)"
Cohesion: 0.18
...
### Community 796 - "providers-profiles-devices.mdx"
Cohesion: 0.18
...
### Community 797 - "slot-lifecycle.mdx"
Cohesion: 0.18
...
### Community 798 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
...
### Community 799 - "Both-boxes deploy-validation runbook — rework-R4-stage"
Cohesion: 0.18
...
### Community 800 - "P3-brain — Implementation-Ready Spec: hal0-brain as a first-class module"
Cohesion: 0.18
...
### Community 801 - "PART D — Edit plan (files, order, delegators/shims)"
Cohesion: 0.18
...
### Community 802 - "hal0 Hermes Plugin Suite — BUILD Spec (verified vs code @ `rework/descar`)"
Cohesion: 0.18
...
### Community 803 - "Hermes Agent official integration research for the hal0 rework"
Cohesion: 0.18
...
### Community 804 - "2. Proposed hal0 plugin suite"
Cohesion: 0.18
...
### Community 805 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
Nodes (10): Board row = the machine-readable record, Checkpoint (R1–R5) → main, hal0 rework — board tracking protocol (paste-in prompt), Hard rules (never violate), Lifecycle of a lane (how a row moves), Migration-window lanes, Monitor, Reusable agent-dispatch prompt skeleton (+2 more)

### Community 806 - "check_sunset.py"
Cohesion: 0.38
Nodes (10): Match, current_version(), _fmt(), main(), overdue_markers(), ProjectVersion, _py_files(), Path (+2 more)

### Community 807 - "Protocol"
Cohesion: 0.27
...
### Community 814 - "test_schema_seeds_d1.py"
Cohesion: 0.31
...
### Community 817 - "rerender_slot_units"
Cohesion: 0.38
...
### Community 818 - "ReleaseManifest"
Cohesion: 0.15
Nodes (10): Return an exact supported updater version or raise ``ValueError``.      ReleaseP, Schema-validated release-manifest payload.      Mirrors the on-disk JSON shape d, Cross-field validation for preview/release-kind consistency.          Rules:, ReleaseManifest, validate_release_version(), An authenticated channel manifest cannot be staged under a caller label., A full alpha preview manifest parses with new fields., test_manifest_schema_accepts_alpha_preview() (+2 more)

### Community 819 - "test_hermes_provision_collect.py"
Cohesion: 0.25
...
### Community 820 - "test_config_model_roots.py"
Cohesion: 0.29
...
### Community 821 - "test_doctor_route.py"
Cohesion: 0.22
Nodes (8): Agent memory, Hermes, the bundled agent, Personas: the agent's character and limits, Spending budgets, The approval queue: a human in the loop, The hal0-brain steward: driving the platform from chat, Where to go next, Why it runs on a 1B model

### Community 822 - "test_features_health.py"
Cohesion: 0.25
...
### Community 823 - "test_meta_enums.py"
Cohesion: 0.42
...
### Community 825 - "test_server_ab_helpers.py"
Cohesion: 0.22
...
### Community 826 - "test_board_commands.py"
Cohesion: 0.27
...
### Community 827 - "test_serve_bind_host.py"
Cohesion: 0.31
...
### Community 828 - "test_fetch_scripts.py"
Cohesion: 0.18
...
### Community 829 - "test_migrate_board.py"
Cohesion: 0.28
...
### Community 830 - "hal0 test-harness — findings"
Cohesion: 0.18
...
### Community 833 - "test_admin_stacks.py"
Cohesion: 0.24
...
### Community 834 - "test_api_wiring.py"
Cohesion: 0.24
...
### Community 836 - "test_npu_trio_reconcile.py"
Cohesion: 0.45
...
### Community 837 - "test_pin_semantics.py"
Cohesion: 0.18
...
### Community 841 - "7. Product-shaped reworks (from the six field notes)"
Cohesion: 0.20
...
### Community 842 - "FLAGS-own — llama.cpp flags stick to models; profiles become templates"
Cohesion: 0.20
...
### Community 843 - "hal0 SETTINGS rework — implementation-ready spec"
Cohesion: 0.20
...
### Community 844 - "Slot / Model / Profile / Flags / Image — reworked runtime model (R3)"
Cohesion: 0.20
...
### Community 845 - "Global Constraints"
Cohesion: 0.20
...
### Community 847 - "Dashboard Plugin JS Loading Internals"
Cohesion: 0.20
...
### Community 855 - "get_agent_memory_stats"
Cohesion: 0.29
...
### Community 860 - "slot_migrate_caps"
Cohesion: 0.42
...
### Community 861 - "resolve_chat_template"
Cohesion: 0.27
...
### Community 863 - ".arbiter"
Cohesion: 0.13
Nodes (17): _capability_slot_for_path(), _ensure_backend_for_model(), #430: load a slot-backed model under its DECLARED backend before routing.      W, Resolve a path-pinned capability slot name (embed/rerank/tts/img).      Mirrors, DR-1: wake an idle-EVICTED path-pinned capability slot before dispatch.      The, _wake_capability_slot(), lane_slot_pin(), preferred_slot() (+9 more)
...
### Community 868 - "test_mcp_mount_health.py"
Cohesion: 0.24
...
### Community 869 - "test_models_pull_capability.py"
Cohesion: 0.39
...
### Community 875 - "test_validate_catalog.py"
Cohesion: 0.24
...
### Community 878 - "test_curated_pull_coords.py"
Cohesion: 0.20
...
### Community 879 - "test_model_capabilities.py"
Cohesion: 0.22
...
### Community 880 - "_configure_project"
Cohesion: 0.56
...
### Community 888 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 889 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 890 - "ROCmFPX bench — RESULTS + next-session handoff (2026-07-05)"
Cohesion: 0.22
...
### Community 891 - "architecture.mdx"
Cohesion: 0.25
...
### Community 893 - "connect-clients.mdx"
Cohesion: 0.22
...
### Community 894 - "connect-external-providers.mdx"
Cohesion: 0.22
...
### Community 895 - "realtime-voice.mdx"
Cohesion: 0.22
...
### Community 896 - "openai-compat.mdx"
Cohesion: 0.22
...
### Community 897 - "slot-as-model.mdx"
Cohesion: 0.22
...
### Community 898 - "env-vars.mdx"
Cohesion: 0.22
Nodes (8): Install & update, Memory & MCP, Models & providers, Paths, Runtime, See also, Server, Services

### Community 899 - "Handoff prompt — hal0-brain / template / profile changes on lxc105 (hal0, 10.0.1.142)"
Cohesion: 0.22
...
### Community 900 - "PART B — Target: Quadlet `.container` per slot (and per companion)"
Cohesion: 0.22
...
### Community 901 - "Slot-pin-lifecycle — the operator pin is the residency control, and the only one"
Cohesion: 0.22
...
### Community 902 - "SWEEP inventory — the overlooked surface (R5 release-prep)"
Cohesion: 0.22
...
### Community 905 - "Hindsight pi Extension Design"
Cohesion: 0.22
...
### Community 906 - "Dashboard plugin "Could not load this plugin's script""
Cohesion: 0.22
...
### Community 907 - "Strix Halo Benchmark Harness (hal0)"
Cohesion: 0.22
...
### Community 922 - "test_catalog_flm_blacklist.py"
Cohesion: 0.28
...
### Community 923 - "_Rec"
Cohesion: 0.33
Nodes (6): Exception, PortAuthorityError, PortPoolExhausted, PortAuthority — the single writer of port ownership (rework §11.2).  Where :mod:, Base class for port-authority errors., No free port remains in the configured pool.
...
### Community 926 - "test_slot_metrics_capacity.py"
Cohesion: 0.36
...
### Community 928 - "test_gp15_no_hermes.py"
Cohesion: 0.22
...
### Community 936 - "useBannerStore.ts"
Cohesion: 0.22
Nodes (8): BANNER_CATALOG, BannerAction, BannerEntry, BannerKind, BannerScope, BannerState, CATALOG_BY_ID, useBannerStore

### Community 937 - "Local-session prompt: run the profile re-tune bench matrix and apply the results"
Cohesion: 0.25
...
### Community 941 - "generate-images.mdx"
Cohesion: 0.25
...
### Community 942 - "update-and-rollback.mdx"
Cohesion: 0.25
...
### Community 943 - "voice-stt-tts.mdx"
Cohesion: 0.25
...
### Community 945 - "paths-and-files.mdx"
Cohesion: 0.25
...
### Community 947 - "13. Observability & metrics baseline (ships in every box)"
Cohesion: 0.25
...
### Community 948 - "15. Hermes plugin — standalone repo + native update path"
Cohesion: 0.25
...
### Community 949 - "PART C — Coordination contracts (cross-lane seams)"
Cohesion: 0.25
...
### Community 950 - "halo143 deploy-validation runbook — rework-R3"
Cohesion: 0.25
...
### Community 951 - "Handoff — R5 Phase 4: deploy window → release cut (paste-in prompt)"
Cohesion: 0.25
...
### Community 952 - "mock-prod-gate verification (Phase 0 launch-blocker #3)"
Cohesion: 0.25
...
### Community 953 - "Podman on the hal0 slot substrate — findings & cleaner solutions"
Cohesion: 0.25
...
### Community 963 - "_settings_apply.py"
Cohesion: 0.29
...
### Community 964 - "sweep_orphaned_partials"
Cohesion: 0.33
Nodes (6): _aggregate_models(), list_models(), _parse_bool_param(), Parse a query-param string as a bool; missing/unrecognised → False.      Mirrors, Aggregate ``/v1/models`` across every configured upstream.      Returns the Open, Build the ``/v1/models`` ``data`` list (see :func:`list_models`).      Split out

### Community 965 - "manager.py"
Cohesion: 0.25
...
### Community 966 - "test_auth_exposure_route.py"
Cohesion: 0.32
...
### Community 970 - "TestCpuCellEndToEnd"
Cohesion: 0.25
...
### Community 971 - "test_app_list_uninstall.py"
Cohesion: 0.36
...
### Community 972 - "test_cli_docs_parity.py"
Cohesion: 0.12
...
### Community 976 - "test_slot_enabled_removed.py"
Cohesion: 0.25
...
### Community 978 - "_BackendContract"
Cohesion: 0.25
...
### Community 981 - "test_store_on_change.py"
Cohesion: 0.39
...
### Community 982 - "test_slot_create_conflict.py"
Cohesion: 0.29
...
### Community 983 - "test_slot_schema.py"
Cohesion: 0.32
...
### Community 984 - "test_transition_guard.py"
Cohesion: 0.25
...
### Community 985 - "useTweaksStore.ts"
Cohesion: 0.29
Nodes (5): APPEARANCE_KEYS, DEFAULTS, TweaksState, TweaksStore, useTweaksStore

### Community 986 - "board-chat-tool-use-v3.spec.ts"
Cohesion: 0.29
Nodes (3): GATED_FRAMES, mockChat(), sse()

### Community 987 - "Concurrency & continuous-batching optimization plan"
Cohesion: 0.29
...
### Community 988 - "ROCmFPX exploratory bench — RESULTS (2026-07-05)"
Cohesion: 0.29
...
### Community 994 - "P3-perms: declarative OwnershipStore as the single ownership authority"
Cohesion: 0.29
...
### Community 995 - "PART B — Target: OwnershipStore default `service_user="hal0"`"
Cohesion: 0.29
...
### Community 996 - "PART C — The LOAD-BEARING contract: born-owned"
Cohesion: 0.29
...
### Community 997 - "PART 0 — EXACT MAP (file:line)"
Cohesion: 0.29
...
### Community 998 - "P3-quadlet: migrate slot + companion units to Podman Quadlet `.container`"
Cohesion: 0.29
...
### Community 999 - "PART A — Current scars (in plain English)"
Cohesion: 0.29
...
### Community 1000 - "4. Delivery plan and gates"
Cohesion: 0.29
...
### Community 1004 - "Gateway connectivity quirks — hal0"
Cohesion: 0.29
...
### Community 1013 - "write_env_atomic"
Cohesion: 0.33
...
### Community 1018 - "test_slot_logs_stream_redacts_secret_bearing_lines"
Cohesion: 0.33
...
### Community 1021 - "test_memory_mm_commands.py"
Cohesion: 0.29
Nodes (3): MonkeyPatch, Tests for ``hal0 memory mm {list,refresh,history}``., stub_api()

### Community 1022 - "test_slot_rename.py"
Cohesion: 0.33
...
### Community 1023 - "test_paths_stub.py"
Cohesion: 0.29
...
### Community 1024 - "_reject_privileged_systemctl"
Cohesion: 0.33
...
### Community 1025 - "test_voice_roundtrip.py"
Cohesion: 0.43
...
### Community 1026 - "10. Troubleshooting"
Cohesion: 0.29
...
### Community 1027 - "test_owui_pin_consistency.py"
Cohesion: 0.43
...
### Community 1028 - "test_extra_args_sanitize.py"
Cohesion: 0.12
Nodes (23): clear_stale_mtp_overrides(), Run every post-activation migration pass hal0 ships, in order.      The single s, Clear crash-only ``mtp = true`` slot overrides (upgrade migration).      An expl, Strip hal0-managed flags from model ``defaults.extra_args`` (upgrade migration)., run_post_activation_migrations(), sanitize_model_extra_args(), sanitize_model_extra_args — the managed-flag registry-heal migration.  ``default, --model_path/--threads-batch are not --model/--threads; --threads itself     is (+15 more)

### Community 1029 - "agent-card.jsx"
Cohesion: 0.38
...
### Community 1031 - "slot-create-default-v3.spec.ts"
Cohesion: 0.29
Nodes (3): CHAT_DEFAULT, CHAT_OTHER, EMBED_MODEL

### Community 1032 - "slot-rename-delete-v3.spec.ts"
Cohesion: 0.40
...
### Community 1056 - "hal0 fresh-install test template (CT 200)"
Cohesion: 0.33
...
### Community 1065 - "throughput_history"
Cohesion: 0.33
...
### Community 1068 - "ttft_samples.py"
Cohesion: 0.33
...
### Community 1069 - "avg_ttft_across"
Cohesion: 0.33
...
### Community 1070 - "samples_from_events"
Cohesion: 0.33
...
### Community 1071 - "test_activity_instrumentation.py"
Cohesion: 0.60
...
### Community 1073 - "test_models_catalogue.py"
Cohesion: 0.47
...
### Community 1077 - "test_now_iso.py"
Cohesion: 0.33
...
### Community 1078 - "test_curation_drift.py"
Cohesion: 0.40
...
### Community 1079 - "test_family_defaults_empty.py"
Cohesion: 0.33
...
### Community 1124 - "test_distro.sh"
Cohesion: 0.90
Nodes (4): bad(), ok(), test_distro.sh script, want()

### Community 1126 - "bankFrom"
Cohesion: 0.40
Nodes (5): bankFrom(), buildBankOperations(), buildBankStats(), buildMemFactGraphRoute(), MEM_BANKS

### Community 1127 - "graphForBank"
Cohesion: 0.40
Nodes (5): buildBigMemFactGraph(), buildDenseFactGraph(), buildMemEntityGraph(), buildMemEntityGraphRoute(), graphForBank()

### Community 1128 - "comfyui-arbiter-v3.spec.ts"
Cohesion: 0.40
Nodes (5): FakeContainerProvider, MonkeyPatch, Path, A slot whose unit reads inactive during warmup must still land READY     when th, test_load_survives_concurrent_fail_watch()

### Community 1129 - "imagegen-v2.spec.ts"
Cohesion: 0.60
Nodes (3): comfyV2Empty(), comfyV2Status(), gotoImageTab()

### Community 1130 - "model-drawer-save-info-v3.spec.ts"
Cohesion: 0.10
...
### Community 1131 - "profiles-crud-v3.spec.ts"
Cohesion: 0.50
Nodes (3): hermes(), IDLE_PRIMARY, mockAgents()
...
### Community 1145 - "[v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)"
Cohesion: 0.50
Nodes (4): Internal contracts, Known follow-up, New / improved, [v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)

### Community 1146 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1147 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1148 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1149 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1150 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1151 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1152 - "hal0 docs"
Cohesion: 0.50
Nodes (3): `docs/internal/` — repo-only architecture docs, hal0 docs, Top-level `docs/*.mdx` — user docs

### Community 1153 - "streaming.mdx"
Cohesion: 0.50
Nodes (3): Client example, See also, Wire format

### Community 1154 - "11. Product reworks — round 2 (slot identity, ports, profile org)"
Cohesion: 0.50
...
### Community 1155 - "PART E — `hal0-api` User flip + UMask removal"
Cohesion: 0.50
...
### Community 1156 - "PART F — Edit plan (files, order, delegators/shims)"
Cohesion: 0.50
...
### Community 1157 - "PART H — Risks + capped verification"
Cohesion: 0.50
...
### Community 1158 - "PART E — Migration of running units (the live-box transition)"
Cohesion: 0.50
...
### Community 1159 - "PART F — Risks + capped verification"
Cohesion: 0.50
...
### Community 1172 - "test_destructive_ops_land_audit_rows"
Cohesion: 0.67
Nodes (4): _build_app_with_audit(), Any, FastAPI, test_destructive_ops_land_audit_rows()

### Community 1173 - "test_store.py"
Cohesion: 0.67
...
### Community 1175 - "_delegate_fakes.py"
Cohesion: 0.50
...
### Community 1176 - "test_comfyui_path.py"
Cohesion: 0.50
...
### Community 1183 - "[0.9.2] — 2026-07-05"
Cohesion: 0.67
Nodes (4): get_executor(), MonkeyPatch, test_register_active_when_configured(), test_register_inert_without_config()

### Community 1184 - "[v0.8.5b2] — 2026-07-04"
Cohesion: 0.67
Nodes (3): Added, Fixed, [v0.8.5b2] — 2026-07-04

### Community 1185 - "[v0.8.2b2] — 2026-06-24"
Cohesion: 0.67
Nodes (3): Changed, Fixed, [v0.8.2b2] — 2026-06-24

### Community 1186 - "CLAUDE.md"
Cohesion: 0.29
Nodes (6): Agent skills, Domain docs, graphify, hindsight, Issue tracker, Triage labels

### Community 1207 - "_OtherEngineProvider"
Cohesion: 0.67
...
### Community 1213 - "conftest.py"
Cohesion: 0.50
Nodes (3): Request coalescing / single-flight for cold-cache prefetch.  When multiple concu, # NOTE: Fast path — an existing in-flight Future for this key means, # NOTE: catch BaseException so CancelledError and KeyboardInterrupt

### Community 1214 - "TestMr3ConsolidationPreservesDetectContract"
Cohesion: 0.13
...
### Community 1215 - "test_agent_unit_argv_defaults_to_real_euid"
Cohesion: 0.67
Nodes (3): MonkeyPatch, ``euid=None`` (the production call) reads the live euid., test_agent_unit_argv_defaults_to_real_euid()

### Community 1217 - "footer-update-chip-v3.spec.ts"
Cohesion: 0.50
Nodes (3): Any, T, Execute fn(*args, **kwargs) for key, or wait for the in-flight call.          Ar

### Community 1218 - "model-drawer-reset-profile-v3.spec.ts"
Cohesion: 0.50
Nodes (4): container_stub(), Any, MonkeyPatch, Stub out ContainerProvider's systemd/podman surface.      SlotManager dispatches

### Community 1274 - "test_split_thinking_closing_tag_only"
Cohesion: 0.09
Nodes (28): Map a tool name + args → (method, upstream path, query params, body, target)., _resolve_tool(), _FakeRequest, Tests for the board chat orchestrator — src/hal0/api/routes/board_chat.py.  The, R1-style chat templates prefill the opening <think>, so the completion     can c, test_compact_board_shapes(), test_config_accessor_defaults_when_absent(), test_extract_tool_calls_empty_when_none() (+20 more)

### Community 1291 - "test_probe_strips_warning_preamble_and_reads_installed"
Cohesion: 0.33
Nodes (4): A leading [WARNING] line must not null the catalog; installed flags survive., A non-zero exit means the binary ran but validation failed (NPU absent)., test_flm_validate_false_on_nonzero_rc(), test_probe_strips_warning_preamble_and_reads_installed()

### Community 1293 - "test_is_installed_flm_id_matches_installed_tag"
Cohesion: 0.67
Nodes (3): [0.9.4] — 2026-07-08, Added, Fixed

### Community 1294 - "test_sanitise_id_blocks_path_traversal"
Cohesion: 0.67
Nodes (3): Changed, Fixed, [v0.8.2b4] — 2026-06-30

## Knowledge Gaps
- **3325 isolated node(s):** `runlog.sh script`, `rocmfpx-build.sh script`, `rocmfpx-env.sh script`, `rocmfpx-pipeline.sh script`, `rocmfpx-quantize.sh script` (+3320 more)
...
- **Why does `create_app()` connect `test_profiles_crud.py` to `TestClient`, `migrate_slot_toml`, `test_slots_container_state.py`, `_StubSlotManager`, `test_exposure.py`, `PgVectorProvider`, `ApprovalQueue`, `test_auth_core.py`, `test_hf_routes.py`, `model_store_root`, `test_stacks_routes.py`, `test_route_collisions.py`, `isolated_client_with_root`, `test_memory_admin_routes.py`, `test_slots_policy.py`, `GpuImageMode`, `conftest.py`, `test_dashboard_layout.py`, `test_models_crud.py`, `test_memory_delete_auth.py`, `Protocol`, `test_updater_routes.py`, `test_settings_routes.py`, `Any`, `test_slots_routes.py`, `EventBus`, `test_kb1_hardening_tail.py`, `test_config_model_roots.py`, `TestClient`, `mcp_mount.py`, `test_models_routes.py`, `test_slots_image_pull.py`, `test_chat_proxy.py`, `test_chat_templates.py`, `Hal0Config`, `test_v1_npu_trio_routing.py`, `.emit`, `test_settings_models_store.py`, `hal0_slot_alias_models`, `test_chat_proxy_auth.py`, `auth.py`, `_build`, `test_models_preview.py`, `test_route_sync.py`, `create_app`, `test_tts_request_defaults.py`, `conftest.py`, `test_typed_errors.py`, `gc.py`, `test_typed_bodies.py`, `FakeWsServer`, `.uninstall`, `test_mcp_mount_health.py`, `TestClient`, `test_redact.py`, `test_models_add_from_path.py`, `test_models_default.py`, `test_pull_routes.py`, `test_model_capabilities.py`, `image_pull.py`, `test_cli_auth_streamtest.py`, `conftest.py`, `test_installer_routes.py`, `test_event_contract.py`, `test_comfyui_fetch_route.py`, `MemoryConfig`, `BootReport`, `test_v1_chat_slot_alias.py`, `__init__.py`, `test_admin_route_map_nested.py`, `test_auth_rotate.py`?**
  _High betweenness centrality (0.110) - this node is a cross-community bridge._
- **Why does `SlotManager` connect `SlotManager` to `SlotInterface`, `test_manager_npu_container.py`, `Slot`, `SlotState`, `build_auto_selections`, `PreloadEvictHost`, `FakeManager`, `test_model_fallback.py`, `test_model_preferred_profile.py`, `test_device_profile_coherence.py`, `test_mtp_defuse.py`, `GpuArbiter`, `_write_slot`, `test_load_converges_config.py`, `test_manager_readiness_api.py`, `rerender_slot_units`, `compute_config_drift`, `FakeSlotManager`, `_write_slot`, `test_npu_trio_reconcile.py`, `manager.py`, `FLMProvider`, `heal_missing_llm_type`, `slot_write_lock`, `FakeUpstreamRegistry`, `test_npu_exclusivity.py`, `SlotIdentityStore`, `RoutingHost`, `test_slot_create_conflict.py`, `test_transition_guard.py`, `test_adopted_slot_eviction.py`, `test_slot_aliases.py`, `.arbiter`, `test_pulling_serving_idle.py`, `comfyui-arbiter-v3.spec.ts`, `Path`, `agents-overview.jsx`, `test_npu_trio_shadow.py`, `SlotWatchdog`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `SlotState` connect `SlotState` to `SlotInterface`, `SlotManager`, `Slot`, `test_metrics_prometheus_route.py`, `StackConfig`, `GpuImageMode`, `test_crash_loop_breaker.py`, `test_fail_watcher.py`, `_dispatcher`, `test_npu_swap_status.py`, `GpuArbiter`, `test_manager_readiness_api.py`, `_RecordingSlotManager`, `test_fail_watcher_warming.py`, `test_backends_npu_canonical_fields.py`, `fetch_npu_swap_status`, `._post`, `arbiter.py`, `FakeUpstreamRegistry`, `FakeSnap`, `Enum`, `StackApplyEngine`, `_ArbiterSlotManager`, `config_enrichment`, `test_drift.py`, `_FakeSM`, `container_enrichment`, `Any`, `test_npu_occupancy.py`, `_slot`, `SlotWatchdog`, `read_stack_state`?**
