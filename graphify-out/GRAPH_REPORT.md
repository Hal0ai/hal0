# Graph Report - agent-a02f86bb28bdfb633  (2026-07-19)

## Corpus Check
- 1493 files · ~1,818,094 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26586 nodes · 50480 edges · 1245 communities (1100 shown, 145 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 6092 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b5ac6b08`
...
- __init__.py
- __init__.py
- test_list_slots_emits_coresident_group_for_npu_trio
- test_list_slots_skips_coresident_for_disabled_sibling
- test_list_slots_exposes_enable_thinking_and_n_gpu_layers
- test_list_slots_enable_thinking_null_when_unset
- test_list_slots_exposes_idle_timeout_workers_llamacpp_args
- test_list_slots_llamacpp_args_none_when_server_table_absent
- test_list_slots_exposes_rope_freq_base
- test_config_profile_change_drives_device_via_route
- test_delete_forwards_force_query_param
...
- ports_command.py
- test_list_slots_coresident_group_uses_device_not_legacy_names
- test_models_store_row_heals_root_owned_tree
- test_health_rejects_empty_models
- test_verify_inference_requires_round_trip
- test_verify_inference_rejects_models_ok_but_inference_failing

## God Nodes (most connected - your core abstractions)
1. `SlotManager` - 277 edges
2. `ENDPOINTS` - 136 edges
3. `BoardStore` - 114 edges
4. `connect()` - 114 edges
5. `ContainerProvider` - 113 edges
6. `BadRequest` - 107 edges
7. `create_app()` - 106 edges
8. `die()` - 106 edges
9. `ApprovalQueue` - 105 edges
10. `SlotState` - 105 edges
...
## Communities (1245 total, 145 thin omitted)

### Community 0 - "HardwareInfo"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (88): formatUptime(), Hardware, normalizeHardware(), shortKernel(), useHardware(), ProxmoxFullStatus, ProxmoxSettings, ProxmoxTenant (+80 more)

### Community 2 - "die"
Cohesion: 0.04
Nodes (104): agent_install(), agent_peers(), approvals_approve(), approvals_deny(), _install_hermes(), Approve a pending agent action., Deny a pending agent action., List discoverable agent identity cards.      Thin wrapper over ``memory_search`` (+96 more)

### Community 3 - "ENDPOINTS"
Cohesion: 0.04
Nodes (91): apiDelete(), apiGet(), apiPut(), ENDPOINTS, useAgentPersonaEnums(), usePersonaUpdate(), Backend, NOTE: there is no useBackendInstall — the backend exposes no generic (+83 more)
...
Cohesion: 0.04
Nodes (48): _fields_for_dataclass(), _fields_for_entry(), _filters_to_config(), _filters_to_runtime(), Any, AsyncClient, Lock, Path (+40 more)

### Community 6 - "SlotConfig"
Cohesion: 0.04
Nodes (39): MemoryEmbeddingConfig, Any, [memory.embedding] section of hal0.toml — Hindsight-era rerank knobs.      ADR-0, Pydantic model for a single slot's TOML config (slots/<name>.toml).      Fields, Pull a `[server]` TOML table out of the loader's `extra` catch-all.          ``h, Pull a `[npu]` TOML table out of the loader's `extra` catch-all.          Mirror, Pull an `[image]` TOML table out of the loader's `extra` catch-all.          Mir, Read-only promotion shim: derive ``device`` from a legacy         on-disk ``back (+31 more)

### Community 7 - "Slot"
Cohesion: 0.03
Nodes (75): ModelCacheCheck, PullRunner, container_provider(), Return the process-wide ContainerProvider singleton., Atomically write a slot TOML.      THE byte-level write path for ``/etc/hal0/slo, write_slot_toml(), _cfg_port(), _cfg_provider() (+67 more)

### Community 8 - "useSlots.ts"
Cohesion: 0.03
Nodes (151): ChatTemplate, useChatTemplates(), useMeta(), useMetaEnums(), useAddModelFromPath(), useModelInspect(), useModels(), useModelSetDefault() (+143 more)

### Community 9 - "BaseModel"
Cohesion: 0.03
Nodes (41): ActivityConfig, AgentConfig, DispatcherConfig, MetaConfig, Pydantic v2 schema models for hal0 configuration.  All TOML files under /etc/hal, # NOTE: ``map_backend_to_device`` now lives in ``hal0.model_meta`` (imported, One (slot, child) capability selection carried by a stack slot entry.      Mirro, One slot's contribution to a stack: which model/profile/caps it carries.      Re (+33 more)

### Community 10 - "doctor_commands.py"
Cohesion: 0.04
Nodes (77): check_hermes_ownership(), check_tree_group_share(), _dangling_registry_entries(), _deepest_mountpoint(), detect_editable_root(), doctor_migrations(), doctor_models(), doctor_verify_cmd() (+69 more)

### Community 11 - "_resolve_llama_scalars"
Cohesion: 0.04
Nodes (104): _best_effort_model_info(), _effective_backend_and_device_class(), _effective_parallel(), _effective_runner(), _llama_argv_segments(), _native_ctx(), _preferred_runner_if_fits(), _profile_image_and_flags() (+96 more)

### Community 12 - "load_hal0_config"
Cohesion: 0.05
Nodes (54): config_validate(), Validate all config files against the current schema., ConfigError, ConfigNotFound, ConfigParseError, _find_manifest_path(), list_agent_configs(), list_slots() (+46 more)

### Community 13 - "ContainerProvider"
Cohesion: 0.03
Nodes (88): _container_runtime(), ContainerProvider, CompletedProcess, Path, Podman-container-per-slot inference backend.      One instance is shared across, Informational env block (not written to disk — container is self-contained)., Not applicable — systemd starts the container., Direct inference passthrough (used by tests; dispatcher is primary path). (+80 more)
...
### Community 15 - "useSlots"
Cohesion: 0.04
Nodes (102): useBackends(), CapabilitiesBag, CapabilityRow, useCapabilities(), useCapabilityApply(), useCapabilityPatch(), useMemoryGraphStatus(), useRetryFailedExtractions() (+94 more)

### Community 16 - "useModels.ts"
Cohesion: 0.06
Nodes (52): AddFromPathRequest, fmtBytes(), fmtEta(), fmtSpeed(), HfSearchResponse, HfSearchResult, Model, ModelDefaultResult (+44 more)

### Community 17 - "stacks.jsx"
Cohesion: 0.04
Nodes (64): COMFYUI_FALLBACK, ComfyuiArbiter, ComfyuiEngineState, ComfyuiMemory, ComfyuiMode, ComfyuiStatus, ComfyuiSwitchover, ComfyuiV2PaneData (+56 more)

### Community 18 - "SlotState"
Cohesion: 0.03
Nodes (80): NotImplementedYet, Push a record onto every active SSE subscriber queue., Async generator yielding every slot state transition as it happens.          Use, See :meth:`hal0.slots.watchdog.SlotWatchdog.update`., The model registry could not be consulted (outage, not a miss).      Raised by t, Return the current :class:`SlotState` for *name*.          Locked public interfa, Return ``True`` when *name* is in the dispatchable ready-set.          Ready set, RegistryUnavailableError (+72 more)

### Community 19 - "Model"
Cohesion: 0.03
Nodes (112): FileSetEntry, FileSetPlan, One file of a planned file-set, ready for ``model_file`` insertion., The full set of files one model pull should download + register., Model, A model entry in the hal0 registry.      All fields are optional at construction, _comfyui_models_dir(), _dir_size() (+104 more)
...
Cohesion: 0.04
Nodes (68): _QueueItem, connect(), db_path(), Connection, Path, SQLite connection + transaction helpers — the hal0 ``db/`` foundation.  One conn, Wrap a write in an explicit ``BEGIN IMMEDIATE`` … ``COMMIT``/``ROLLBACK``., Return the default hal0 SQLite database path.      Thin wrapper over :func:`hal0 (+60 more)
...
Cohesion: 0.09
Nodes (29): Return the full flag string for *profile*, expanding MTP when set.      When the, resolve_profile_flags(), Return numeric GIDs for the host's GPU access groups (render, video).      Fallb, resolve_gpu_group_ids(), _exec_line(), _moe_profile(), _mtp_profile(), §7.1a / ML-5: profile.mtp is informational only now — the caller         must pa (+21 more)

### Community 26 - "updater.py"
Cohesion: 0.05
Nodes (75): _atomic_symlink_swap(), _cache_dir(), clear_stale_mtp_overrides(), _download(), _editable_install_path(), _extract_tarball(), fetch_release_manifest(), _is_editable_install() (+67 more)

### Community 27 - "test_updater.py"
Cohesion: 0.06
Nodes (89): _current_symlink(), Atomic self-update with cosign-verified releases and one-step rollback.      All, Return ``<usr_lib>/hal0-<version>/`` — where this release's tree lives., Return ``<usr_lib>/current`` — the atomic-swap target., Updater, _versioned_install_dir(), _build_release_tarball(), cosign_skip() (+81 more)
...
### Community 29 - "Dispatcher"
Cohesion: 0.06
Nodes (71): LegacyResolutionFailed, Raised when the capability/path heuristics find no slot to serve a request., Dispatcher, DispatchError, NoRouteFound, Base for any failure the dispatcher itself raises.      All subclasses use the `, No upstream could be found for the requested model id., Registry binds the model to an upstream that is not registered. (+63 more)

### Community 30 - "slots.py"
Cohesion: 0.05
Nodes (84): get_status(), Overall liveness + dashboard summary.      The Vue dashboard polls this every fe, _config_field_enrichment(), _container_state_enrichment(), create_slot(), delete_slot(), get_slot(), get_slot_by_id() (+76 more)
...
### Community 33 - "HindsightProvider"
Cohesion: 0.05
Nodes (38): _agent_of(), bank_to_namespace(), HindsightProvider, _http_status(), namespace_to_bank(), _now(), Any, Exception (+30 more)
...
### Community 38 - "v1.py"
Cohesion: 0.06
Nodes (78): DispatcherDep, _aggregate_models(), audio_speech(), audio_transcriptions(), _capability_slot_for_path(), chat_completions(), completions(), _dispatch_and_forward() (+70 more)
...
### Community 40 - "FLMProvider"
Cohesion: 0.04
Nodes (60): _mock_response(), model_info(), provider(), Any, Unit tests for FLMProvider.  Two-tier readiness (Option A — NPU double-free avoi, Bundled default when no slot override / env / manifest pin applies.      §7.1b /, §7.1b / ML-4 fix: FLM previously ignored slot.image entirely., The image bundles FLM; do not host-mount a binary tree on top of it.      Earlie (+52 more)
...
### Community 44 - "resolve_by_capability"
Cohesion: 0.05
Nodes (66): Any, Capability/path routing heuristics — dispatcher resolution Step 4.  Extracted fr, Resolve a request to a slot Upstream using path+name heuristics.      The last-r, resolve_by_capability(), _container_remote_img(), _FakeModelRegistry, Routing rules for image-gen requests in capability/path routing (Step 4).  These, Path pin selects 'img', missing 'img' upstream → typed legacy error. (+58 more)

### Community 45 - "ProfileCatalog"
Cohesion: 0.03
Nodes (70): RuntimeFamily, SlotType, create_profile(), delete_profile(), export_profile(), get_profile(), import_profile_route(), list_profiles() (+62 more)

### Community 46 - "CapabilityOrchestrator"
Cohesion: 0.07
Nodes (55): _anchor_npu_writes(), drifted_state(), FakeSlotManager, npu_orchestrator(), orchestrator(), Any, MonkeyPatch, Path (+47 more)
...
### Community 49 - "_RecordingSlotManager"
Cohesion: 0.07
...
### Community 50 - "_spec_provider_for"
Cohesion: 0.04
...
### Community 52 - "ModelRegistry"
Cohesion: 0.05
Nodes (44): ModelDefaults, Per-model default knobs surfaced as launcher defaults.      All fields optional., ModelAlreadyExists, Base error for registry operations., add() called but the model id is already present., RegistryError, _model(), ModelRegistry (+36 more)

### Community 53 - "StackApplyEngine"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (70): list_transport(), mock_transport(), _policy(), Any, MonkeyPatch, queue(), Unit tests for :mod:`hal0.mcp.admin` tool catalog + dispatch.  * Tool registrati, Every tool registered with FastMCP must carry the four MCP hints     (readOnly / (+62 more)

### Community 57 - "Hal0Error"
Cohesion: 0.07
...
### Community 59 - "get_runner"
Cohesion: 0.06
Nodes (55): Default container image for a slot lane with no explicit image pin.      Precede, resolve_default_image(), Return the FLM toolbox image reference.          Resolution (§7.1b / ML-4): ``sl, Return the Kokoro toolbox image reference.          Resolution (§7.1b / ML-4): `, Return the Qwen3-TTS toolbox image reference.          Resolution (§7.1b / ML-4), get_runner(), RUNNER_IMAGES — the runner-image registry (plan §7.1b / ML-4).  Before this modu, Look up a runner by key, or raise :class:`~hal0.errors.NotFound`. (+47 more)

### Community 60 - "unknown_slot_config_keys"
Cohesion: 0.06
Nodes (35): ModelRegistry, Path, SlotManager, ChangeSet, FileState, fold_ctx_size_alias(), _known_field_names(), Any (+27 more)

### Community 61 - "test_models_crud.py"
Cohesion: 0.07
Nodes (65): container_stub(), crud_app(), crud_client(), crud_models_root(), _events_since(), _max_event_id(), Any, FastAPI (+57 more)

### Community 62 - "test_updater_routes.py"
Cohesion: 0.06
...
### Community 65 - "apiMock.ts"
Cohesion: 0.04
Nodes (21): Fixtures, HONCHO_STATS_ENABLED, HONCHO_SYNC_DEFAULT, MEMORY_PROVIDER_DEFAULT, MemoryProviderMockOptions, MockState, test, LIVE_BOARD (+13 more)

### Community 66 - "catalog.py"
Cohesion: 0.06
...
### Community 67 - "test_registry_import.py"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (58): ADR-0014, ADR-0004, ADR-0013, ADR-0023, AgentMCPClientList, AgentMCPClientView, fetchOrMock(), MCPClientAuth (+50 more)

### Community 70 - "Check"
Cohesion: 0.06
Nodes (66): build_all_checks(), check_auth_posture(), check_hal0_target(), check_migrations(), check_model_store(), check_ports(), doctor_all_cmd(), _exit_code() (+58 more)

### Community 71 - "test_hermes_provision.py"
Cohesion: 0.04
Nodes (45): _Runner, _build_overlay_keys(), Unit tests for :mod:`hal0.agents.hermes_provision`.  Pins the linear ``install_h, display.show_reasoning: true is required for thinking-model TUI visibility     (, display.streaming: true is required alongside show_reasoning — without it     th, model.max_tokens must be a positive int — Qwen3 thinking models silently     dra, model.base_url is always set. Hermes's bare ``provider: custom`` requires     it, Delegation → `agent` MoE slot (thinking-off); chat stays on main model.      Thi (+37 more)

### Community 72 - "load_profiles_config"
Cohesion: 0.05
Nodes (38): load_slot_config(), Load and validate /etc/hal0/slots/<slot_name>.toml.      The on-disk shape (per, Atomically write a slot config TOML.      The pydantic SlotConfig is flat; we re, save_slot_config(), ImageGenConfig, [image] table in a slot TOML — persisted image-gen settings (#599).      Carried, PLAN.md §5 Tier 1: device = 'gpu-rcom' must raise with field path., A legacy on-disk ``backend``-only slot TOML (no ``device``) must         still r (+30 more)

### Community 73 - "UpstreamCall"
Cohesion: 0.05
...
### Community 74 - "_ArbiterSlotManager"
Cohesion: 0.07
...
### Community 75 - "manager.py"
Cohesion: 0.06
Nodes (38): AgentAlreadyInstalledError, AgentDriver, AgentError, AgentNotFoundError, AgentRecord, AgentUninstallIncompleteError, _all_known_drivers(), _driver_for() (+30 more)

### Community 76 - "BoardStore"
Cohesion: 0.07
Nodes (54): BoardStore, Path, SQLite repository for the Operator Board.      The documented interface is exact, client(), _make(), TestClient, ETag / If-Match optimistic concurrency on board task routes (KB-6).  hal0 uses 4, store() (+46 more)

### Community 77 - "paths.py"
Cohesion: 0.06
...
### Community 78 - "Path"
Cohesion: 0.06
Nodes (60): _apply_config_set(), _build_config_overlay(), _copy_plugin_tree(), _copy_wrapper(), _dirs_identical(), _disable_honcho_hermes_host(), _ensure_hermes_config(), _ensure_honcho_sdk() (+52 more)

### Community 79 - "ModelRegistry"
Cohesion: 0.06
Nodes (29): ModelNotFound, The requested model id is not in the registry., _model(), LogCaptureFixture, ModelRegistry, MonkeyPatch, Path, Unit tests for hal0.registry.store.ModelRegistry.  Covers:   * CRUD round-trips (+21 more)

### Community 80 - "Any"
Cohesion: 0.05
Nodes (63): _build_brain_identity_card(), _build_identity_card(), _collect_capability_rollup(), _collect_chat_slots(), _detect_foreign_gateways(), _fetch_slots(), _find_named_ready_slot(), _find_slot() (+55 more)

### Community 81 - "TomlModelRegistry"
Cohesion: 0.06
Nodes (38): _fsync_dir(), merge_update(), _model_to_toml(), model_to_toml_dict(), AbstractContextManager, Any, Model, Path (+30 more)

### Community 82 - "FakeWsServer"
Cohesion: 0.06
Nodes (47): authorised_client(), fake_hermes(), FakeWsServer, _free_port(), harness_client(), FastAPI, MonkeyPatch, Path (+39 more)

### Community 83 - "AuditStore"
Cohesion: 0.10
...
### Community 84 - "test_unified_bank.py"
Cohesion: 0.10
...
### Community 86 - "auto_migrate_capabilities_file"
Cohesion: 0.09
...
### Community 87 - "Mount"
Cohesion: 0.07
Nodes (32): HealthCheck, Mount, Provider abstract base class.  A Provider encapsulates the logic for a single in, Normalise a ``Mount`` or a legacy ``(src, dst)`` tuple to ``Mount``.          A, A podman ``--health-*`` override for a slot container.      The toolbox images b, Return the ``--health-*`` podman-run flags in a stable order., Return the Podman Quadlet ``Health*=`` keys in a stable order.          The decl, Typed launch plan for a container-per-slot Quadlet unit.      Carries everything (+24 more)

### Community 88 - "LlamaServerProvider"
Cohesion: 0.06
...
### Community 89 - "test_redact.py"
Cohesion: 0.05
Nodes (50): is_sensitive_key(), Any, Shared config-echo redaction (issue #553).  A single helper that scrubs sensitiv, True if ``key`` (the *name*, not the value) matches a sensitive pattern.      Ca, Project a sensitive *value* into the masked ``{value, set}`` shape.      ``set``, Recursively scrub sensitive-keyed values from a config tree.      - ``dict``: wa, redact_config(), redact_value() (+42 more)

### Community 90 - "StacksCatalog"
Cohesion: 0.07
...
### Community 93 - "test_pull_routes.py"
Cohesion: 0.05
Nodes (73): app_isolated(), client_isolated(), fake_run_pull(), Any, FastAPI, MonkeyPatch, Path, TestClient (+65 more)

### Community 94 - "connections.jsx"
Cohesion: 0.05
Nodes (69): Hal0Error, ConfigUrls, useConfigUrls(), _fetchServers(), McpServer, McpServerActivity, McpServerState, McpTool (+61 more)

### Community 95 - "cli.py"
Cohesion: 0.06
Nodes (76): build_parser(), cmd_eval(), cmd_history(), cmd_import_v1(), cmd_plan(), cmd_publish(), cmd_reindex(), cmd_results() (+68 more)

### Community 96 - "NpuTrioRouter"
Cohesion: 0.09
Nodes (42): NpuTrioRouter, Resolves the npu container's static port and dispatches STT/embed to it.      He, _mock_transport(), Any, AsyncClient, NpuTrioRouter: container-only static-port dispatch (Phase E).  Covers:   - ready, SERVING (inference in flight) still resolves — a concurrent STT/embed     reques, IDLE npu container → static port.      IDLE = "warm but quiet" (no in-flight inf (+34 more)

### Community 97 - "FakeContainerProvider"
Cohesion: 0.06
...
### Community 99 - "test_profile_derive.py"
Cohesion: 0.06
...
### Community 101 - "PgVectorProvider"
Cohesion: 0.08
...
### Community 102 - "make_slot"
Cohesion: 0.08
Nodes (48): Run all four guardrails. Returns an error string on rejection,     or ``None`` i, validate_delegation(), make_http_client(), make_slot(), AsyncClient, Shared fixtures for the OmniRouter test suite.  The OmniRouter only talks to two, Build a slot config dict for tests.      ``tool_calling`` (optional) sets ``[mod, Build an httpx.AsyncClient backed by ``httpx.MockTransport``.      The ``handler (+40 more)

### Community 103 - "models_service.py"
Cohesion: 0.07
Nodes (50): add_from_path(), auto_scan_and_register(), cascade_delete_model(), clear_slot_default(), comfyui_category(), commit_scan_rows(), _copy_model_files_refcounted(), dispatch_type() (+42 more)

### Community 104 - "test_hermes_wrapper.py"
Cohesion: 0.07
...
### Community 105 - "Hal0Config"
Cohesion: 0.05
Nodes (62): MigrationPlan, get_models_config(), Any, Return the current [models] section (roots / auto-scan / extensions).      Route, Replace the [models] section, persist hal0.toml, then re-scan.      Body shape:, update_models_config(), _apply_store_change(), _config_to_dict() (+54 more)

### Community 106 - "runner.py"
Cohesion: 0.07
...
### Community 107 - "test_npu_swap_status.py"
Cohesion: 0.11
Nodes (39): fetch_npu_swap_status(), Return the swap snapshot from the npu container slot's state.      Transitional, _container_npu_cfg(), npu_swap_status: container slot lifecycle state drives the swap signal.  ``fetch, No slot_manager wired → all-None settled snapshot (test bypass)., SlotState.STARTING → in_progress=True (container restarting for model swap)., SlotState.PULLING → in_progress=True., SlotState.WARMING → in_progress=True. (+31 more)

### Community 108 - "test_discover.py"
Cohesion: 0.12
Nodes (29): find_candidates(), Walk each root and return :class:`CandidateModel`s not already registered., model_root(), Path, Tests for hal0.registry.discover — filesystem scan + auto-register., A discovered file whose name matches a curated entry's hf_file     must surface, Files already in known_paths must not appear in the candidate list., A Model with no sidecar carries mmproj=None (the registry contract     the llama (+21 more)

### Community 109 - "test_auth_core.py"
Cohesion: 0.07
...
### Community 110 - "test_profiles_crud.py"
Cohesion: 0.07
Nodes (49): app(), client(), CaptureFixture, FastAPI, LogCaptureFixture, Path, TestClient, Tests for Profile CRUD API — POST/PUT/DELETE /api/profiles.  Run targeted:     ~ (+41 more)

### Community 111 - "hal0 rework plan — reader's copy"
Cohesion: 0.04
...
### Community 116 - "§21.4 `hal0 doctor` rework + support bundle — implementation spec"
Cohesion: 0.04
...
### Community 120 - "models.py"
Cohesion: 0.07
Nodes (47): add_model_from_path(), check_model_updates(), create_model(), delete_model(), delete_pull(), duplicate_model(), get_model(), inspect_model() (+39 more)

### Community 121 - "Record"
Cohesion: 0.17
...
### Community 122 - "install_openwebui"
Cohesion: 0.06
...
### Community 123 - "write_openwebui_env"
Cohesion: 0.07
...
### Community 124 - "test_comfyui_proxy.py"
Cohesion: 0.15
...
### Community 125 - "test_providers_routes.py"
Cohesion: 0.10
...
### Community 130 - "test_agent_uninstall_memory.py"
Cohesion: 0.12
...
### Community 131 - "build_auto_selections"
Cohesion: 0.07
...
### Community 132 - "SlotConfigError"
Cohesion: 0.12
Nodes (25): device_to_backend(), Map hal0's ``device`` enum onto the recipe+backend pair.      Args:         devi, Hold the coarse cross-process lock for ALL slots/*.toml writes.      Historicall, slot_write_lock(), apply_preferred_profile(), apply_preferred_runner(), defuse_stale_mtp_on_swap(), preferred_profile_for() (+17 more)

### Community 133 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.04
...
### Community 135 - "hermes_provision.py"
Cohesion: 0.06
Nodes (56): _active_persona_render(), BootstrapState, _brain_profile_config_path(), _default_mcp_servers(), _fetch_model_contexts(), _generate_api_server_key(), _hal0_service_home(), _http_get() (+48 more)

### Community 136 - "lifespan"
Cohesion: 0.09
Nodes (42): _auto_resume_interrupted_pulls(), _coerce_ctx(), _fetch_hal0_composite_models(), hal0_apply_registry_detail(), hal0_chat_slot_alias_map(), hal0_chat_slot_model_ids(), hal0_llm_slot_views(), _hal0_model_cache_clear() (+34 more)

### Community 137 - "evalrun.py"
Cohesion: 0.09
...
### Community 138 - "test_setup_install.py"
Cohesion: 0.07
...
### Community 140 - "primitives.jsx"
Cohesion: 0.03
Nodes (101): useActivityRecent(), useApprovalList(), useDenyApproval(), CELL_DEFS, CELL_MAP, CellDef, CellId, DashLayout (+93 more)

### Community 141 - "§7.1d — Capability / Modality Taxonomy untangle (ML-6)"
Cohesion: 0.05
...
### Community 143 - "MemoryProvider"
Cohesion: 0.06
Nodes (27): AddResult, DeleteResult, GraphStatus, ListPage, MemoryItem, MemoryProvider, Mode, Any (+19 more)

### Community 144 - "get_curated"
Cohesion: 0.05
Nodes (53): get_curated(), Return the curated entry by id, or ``None`` if not in the catalogue., emit_terminal_pull_event(), eta_s(), load_persisted(), Any, PullJob, Request (+45 more)

### Community 145 - "test_model_fallback.py"
Cohesion: 0.17
Nodes (29): fallback_local_model(), Model, Pick a locally-registered model (file on disk) to stand in for a     non-servabl, _add_model(), _llm_cfg(), _mgr(), SlotManager, Load-time capability fallback for a non-servable slot ``model.default``.  A seed (+21 more)

### Community 146 - "FakeSnap"
Cohesion: 0.19
Nodes (11): Any, Records capability apply() calls., RecordingOrchestrator, _engine(), StackCapabilityRow, Tests for converge() capability-child routing pass.  Targeted file run:     cd /, Canary: the hardcoded child maps must exactly reverse the orchestrator's     _CH, _row() (+3 more)

### Community 147 - "errors.py"
Cohesion: 0.05
Nodes (52): RequestValidationError, activate_agent_persona(), get_agent_persona(), list_agent_personas(), _persona_detail(), _persona_summary(), PersonaUpdateBody, Any (+44 more)

### Community 148 - "stacks.py"
Cohesion: 0.09
...
### Community 149 - "agent_commands.py"
Cohesion: 0.05
Nodes (52): agent_list(), agent_log(), agent_reprovision(), agent_status(), agent_uninstall(), agent_upgrade(), _approval_summary(), approvals_list() (+44 more)

### Community 150 - "test_diagnosis.py"
Cohesion: 0.10
Nodes (20): exit_code_for(), Diagnosis, ``hal0 doctor``'s CLI-side ``Diagnosis`` re-export + adapters (§21.4).  The data, Map one ``doctor_verify.Check`` row to a ``Diagnosis`` row.      ``status`` -> `, The stable ``--json`` shape every doctor subcommand prints.      ``json.dumps(.., The §4.2 generic ``--json`` exit-code translation: critical->2,     fail/warn->1, render_json(), to_diagnosis() (+12 more)

### Community 151 - "AgentMetadataConfig"
Cohesion: 0.11
Nodes (9): AgentMCPConfig, MCPServerConfig, One ``[mcp.servers.<name>]`` entry in an agent TOML.      Server-axis default-de, External (non-builtin) servers must declare a URL., ``[mcp]`` block container.      Holds the ``servers`` map. Lives as its own mode, ADR-0013 agent-config schema tests.  Pins:    - schema_version field exists + re, test_full_round_trip(), TestMCPServerConfig (+1 more)

### Community 152 - "GpuArbiter"
Cohesion: 0.09
...
### Community 153 - "FakeMemoryProvider"
Cohesion: 0.06
...
### Community 155 - "CapabilitySelection"
Cohesion: 0.05
Nodes (50): Fire-and-forget trigger to refresh the Hermes live-context files.  Called from t, Spawn a detached ``hal0-agent <agent_id> render-context``. Never raises., spawn_context_refresh(), CapabilitySelection, One operator-facing selection for a (slot, child) tuple.      Mirrors the dashbo, CapabilityApplyFailed, CapabilityOrchestrator, legal_children() (+42 more)

### Community 156 - "hal0 — Plan"
Cohesion: 0.05
Nodes (41): 10. Test strategy, 11. Dev environment + migration plan, 12. Toolbox images, 13. CLI surface, 14. Telemetry, 15. Phased milestones, 16. Deferred decisions (track explicitly), 17. Risks + mitigations (+33 more)

### Community 157 - "HermesDriver"
Cohesion: 0.07
...
### Community 160 - "ApprovalQueue"
Cohesion: 0.08
Nodes (37): ApprovalQueue, Async-safe pending-approval queue with dedup + SSE fan-out.      One instance pe, The annotation table must actually reach FastMCP's tool list —     not just sit, tools/list must carry the shared per-tool schema under the nested     ``args`` o, Single-id memory_delete must run through the dispatcher, not enqueue., mock_transport(), Any, MonkeyPatch (+29 more)

### Community 161 - "test_hermes_provision_idempotency.py"
Cohesion: 0.07
Nodes (51): apply_hermes_config_cli(), apply_kanban_db_init_cli(), _coerce(), default_fake_slots(), install_io(), Any, Shared test fakes for the hermes_provision config-set redesign.  ``apply_hermes_, Redirect every host path constant under ``tmp_path``; return (home, venv). (+43 more)

### Community 162 - "test_personas.py"
Cohesion: 0.08
...
### Community 164 - "test_slots_image_pull.py"
Cohesion: 0.09
...
Cohesion: 0.09
Nodes (33): AgentList, AgentRecord, AgentRestartResult, AgentSkill, AgentSkillsResponse, ApprovalEntry, ApprovalList, BUNDLED_MCP_IDS (+25 more)

### Community 166 - "_write_diagnostics_section"
Cohesion: 0.11
...
### Community 168 - "orchestrate.py"
Cohesion: 0.06
Nodes (47): apply_setup(), _build_slot_cfg(), _clamp_context_size(), _colocated_flm_store(), _ensure_registry_entry(), _free_space_gib(), install_extension(), _install_extensions() (+39 more)

### Community 169 - "test_model_meta.py"
Cohesion: 0.06
...
### Community 170 - "flm.py"
Cohesion: 0.06
Nodes (46): _classify_flm_model(), _ensure_flm_models_dir(), ensure_host_flm_store_link(), _extract_json_object(), flm_host_async_spawn(), flm_host_spawn_kwargs(), flm_id_to_tag(), flm_pull_command() (+38 more)

### Community 171 - "test_slot_aliases.py"
Cohesion: 0.06
...
### Community 172 - "test_unit_files.py"
Cohesion: 0.05
...
### Community 173 - "R5 sync assessment — how far every surface is from "back in sync" (2026-07-19)"
Cohesion: 0.05
...
### Community 176 - "test_mtp_override.py"
Cohesion: 0.08
Nodes (40): build_mtp_flag_bundle(), Bench-tuned MTP draft-speculation flag bundle, with the draft device     derived, model_is_mtp_eligible(), True when a model should speculate with MTP / NextN draft heads.      §7.1a / ML, _effective_mtp(), Resolve whether MTP speculative decoding is on for this slot launch.      §7.1a, _mtp_model(), _plain_model() (+32 more)

### Community 177 - "test_model_store.py"
Cohesion: 0.10
...
### Community 178 - "SlotIdentityStore"
Cohesion: 0.12
...
### Community 179 - "test_chat_proxy_auth.py"
Cohesion: 0.07
...
### Community 180 - "Hal0MemoryProvider"
Cohesion: 0.09
Nodes (10): hal0-memory — Hermes ``MemoryProvider`` plugin (canonical, shipped source).  Imp, Plugin entry point — register the provider with the loader., register(), Hal0MemoryProvider, MemoryProvider, Any, Hal0MemoryClient, REST-backed memory provider — wraps hal0-memory (private + shared banks). (+2 more)

### Community 181 - "tui.py"
Cohesion: 0.08
...
### Community 184 - "recommend_primary_slot"
Cohesion: 0.10
...
### Community 187 - "test_typed_errors.py"
Cohesion: 0.10
Nodes (37): app(), app_with_slot(), _Body, client(), _Color, FastAPI, Hal0Error, TestClient (+29 more)

### Community 188 - "test_v1_npu_trio_routing.py"
Cohesion: 0.09
...
### Community 192 - "test_openrouter_auth_loopback.py"
Cohesion: 0.09
...
### Community 193 - "FakeSlotManager"
Cohesion: 0.13
Nodes (34): active_tools_for(), Return the filtered tool list for a chat slot, per plan §7.3.      Args:, FakeSlotManager, Any, Tiny stub that satisfies :class:`SlotManagerLike`.      Tests build it with a li, _caller_no_tools_label(), _caller_with_tools_label(), Filter matrix tests — plan §7.3.  Covers the dynamic-filtering decision tree: (+26 more)

### Community 194 - "_profile"
Cohesion: 0.09
...
### Community 197 - "test_pulling_serving_idle.py"
Cohesion: 0.11
...
### Community 199 - "§17 installer/setup overhaul — edit-plan (thin shell + thick Python, one profile authority, one slot roster)"
Cohesion: 0.06
...
### Community 200 - "P3 slot-identity + ports — implementation spec"
Cohesion: 0.06
...
### Community 201 - "resolve_role_slots"
Cohesion: 0.12
Nodes (38): BaseModel, candidate_from_slot_mapping(), _capability_values(), _entry(), _llm_capable(), _main_candidate(), _matches(), Any (+30 more)

### Community 202 - "pve.py"
Cohesion: 0.09
...
### Community 203 - "test_update_check.py"
Cohesion: 0.09
...
### Community 205 - "compute_config_drift"
Cohesion: 0.09
...
### Community 206 - "test_installer_routes.py"
Cohesion: 0.09
...
### Community 207 - "test_update_commands.py"
Cohesion: 0.08
...
### Community 209 - "test_hf_token_secrets.py"
Cohesion: 0.06
...
### Community 210 - "Hal0HermesClient"
Cohesion: 0.11
...
### Community 211 - "test_v1_chat_slot_alias.py"
Cohesion: 0.13
...
### Community 213 - "test_slots_container_state.py"
Cohesion: 0.09
...
### Community 216 - "MemoryProvider"
Cohesion: 0.08
Nodes (10): ABC, MemoryProvider, Any, Contract surface required by the hal0 memory provider., Config-only readiness check — no network (design: is_available())., Per-session init; kwargs carry server-derived identity/context., Memory tool schemas (search/recall/add/...)., ABC shape tests — the explicit MemoryProvider contract (P0). (+2 more)

### Community 217 - "Hal0MemoryClient"
Cohesion: 0.09
...
### Community 222 - "test_metrics_prometheus_route.py"
Cohesion: 0.09
...
### Community 223 - "SlotReaper"
Cohesion: 0.09
Nodes (20): is_pinned(), Any, Slot, Idle demotion + TTL/pressure eviction loops (P3-slots §1b).  ``SlotReaper`` owns, Narrow seam :class:`SlotReaper` needs from ``SlotManager``.      Deviation from, Idle demotion + TTL/pressure eviction, against a narrow host seam., Start the background sweeper. Idempotent while the task is alive., Cancel the idle-monitor task if running. Idempotent. (+12 more)

### Community 224 - "test_hf_routes.py"
Cohesion: 0.13
Nodes (33): hf_app(), hf_client(), _hf_search_handler(), _patch_httpx_transport(), Any, Exception, FastAPI, MonkeyPatch (+25 more)

### Community 225 - "test_memory_admin_routes.py"
Cohesion: 0.16
...
### Community 226 - "TestClient"
Cohesion: 0.09
Nodes (31): TestClient, Disabled NPU LLM anchor → no trio markers on the sibling slots., rope_freq_base absent on disk → payload carries null (not 0.0)., PUT /api/slots/{name}/config with model.rope_freq_base persists the value     an, #863: single-slot status includes argv drift without burdening list()., Labels list is omitted (not empty) when the slot config has no     ``model.label, A failing container health probe doesn't break /api/slots.      The enrichment s, A slot carries declared_backend (normalized token) derived from its     configur (+23 more)

### Community 227 - "test_stacks_routes.py"
Cohesion: 0.14
...
### Community 228 - "test_agent_install_hermes.py"
Cohesion: 0.07
Nodes (29): `hal0 agent install hermes` foreground-provision flow.  Regression for the clean, A non-zero bootstrap rc must stop the flow before the API register —     we don', Records calls in order so the test can assert sequencing., Root writes anywhere — the guard must not even probe the filesystem., Dev / rootless install already owns the trees — proceed silently., `hal0 agent install hermes` (no flags) enables the gateway — parity     with ins, No provisioned hermes binary → nothing to wire the gateway onto., Happy path: gateway install runs, the unit file lands, systemctl     enables + c (+21 more)

### Community 229 - "test_tools.py"
Cohesion: 0.06
...
### Community 230 - "browser_server.py"
Cohesion: 0.10
...
### Community 231 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.06
...
### Community 237 - "profile.py"
Cohesion: 0.09
Nodes (21): hal0-provider — Hermes ``ProviderProfile`` plugin (canonical, shipped source)., Register the hal0 provider profile.      Prefers a ``PluginContext`` seam if one, register(), assemble_stream(), Hal0ProviderProfile, is_alias(), iter_sse_data(), parse_sse_chunks() (+13 more)

### Community 238 - "test_tts_capability_switch.py"
Cohesion: 0.18
Nodes (10): Return the TTS slot profile a device selection implies.      The engine switch:, tts_profile_for_device(), profile_name_for_fit(), Shared picker/apply profile-fit inference (device → runtime profile name).  Sing, Infer the runtime profile name implied by a picker/apply selection.      Keeps i, test_tts_profile_for_device_mapping(), The resolved catalog profile name equals the shared helper's name., The picker/apply fit path NEVER forces an MTP image on ROCm — dense     chat/cod (+2 more)

### Community 239 - "build_request_metric_row"
Cohesion: 0.12
...
### Community 240 - "_llama_launch_plan"
Cohesion: 0.09
Nodes (31): _llama_launch_plan(), Build the GPU/llama-server :class:`RuntimeLaunchPlan`.      Single source of the, _gpu_profile(), _ngl(), _parval(), Any, Single-assembler tests: launch/preview parity, model-default precedence, GPU gat, Shim so call sites barely change: the Quadlet renderer no longer takes a     run (+23 more)

### Community 241 - "portable.py"
Cohesion: 0.10
...
### Community 242 - "test_contract_compatibility.py"
Cohesion: 0.07
Nodes (8): Compatibility freeze for the supported official Hermes release.  Every assertion, test_memory_loader_layout_and_registration_collector(), test_memory_provider_roster_is_frozen(), test_sdk_diff_pin_matches_frozen_commit(), test_sdk_diff_tracks_full_adapter_contract_surface(), _upstream_pin(), _ProviderCollector, Loader context that captures ``register_memory_provider`` calls.

### Community 243 - "test_brain_injection.py"
Cohesion: 0.17
...
### Community 244 - ".dispatch_tool"
Cohesion: 0.12
Nodes (30): _ctx(), Any, Per-tool dispatch handler tests — plan §7.  Each handler validates args, routes, Image slot without ``edit`` label is rejected by route_for_request., Build a DispatchContext wired against a single-response mock., httpx ConnectError → tool_result error, not raise., A truly unexpected exception inside a handler is caught at the     dispatch_tool, test_analyze_image_happy_path() (+22 more)

### Community 245 - "TestContainerSpec"
Cohesion: 0.07
Nodes (23): _model_info(), Any, Unit tests for ``hal0.providers.container.ContainerProvider``.  Issue #655 — tra, halo150/143 O8+O11: ONE render for every substrate — no version branch.      Nat, ``_container_runtime`` resolves podman wherever PATH puts it (snap,     /usr/loc, podman installed somewhere other than /usr/bin/ (snap, nix, ...)         must st, Docker is unsupported: even when only docker is on PATH, resolution         must, Test shim: render a plan to Quadlet ``.container`` text (was ``_render_unit_from (+15 more)

### Community 246 - "Platform-wide cron/automation management — design"
Cohesion: 0.06
...
### Community 248 - "hal0 ROCmFPX quantization"
Cohesion: 0.06
...
### Community 250 - "test_board_chat_admin_tools.py"
Cohesion: 0.12
...
### Community 253 - "DispatchContext"
Cohesion: 0.19
Nodes (30): dispatch_tool(), DispatchContext, handle_analyze_image(), handle_edit_image(), handle_embed_text(), handle_generate_image(), handle_rerank_documents(), handle_route_to_chat() (+22 more)

### Community 254 - "scan_and_register"
Cohesion: 0.18
...
### Community 255 - "test_brain_resilience.py"
Cohesion: 0.16
...
### Community 256 - "_render_from_spec"
Cohesion: 0.22
...
### Community 257 - "json"
Cohesion: 0.08
Nodes (12): HONCHO_STATS_DISABLED, installMemoryProviderMocks(), json(), AuthOpts, installAuth(), routeHistory(), comfyV2Empty(), comfyV2Status() (+4 more)

### Community 258 - "README.md"
Cohesion: 0.07
...
### Community 259 - "ML-2 (file-set pulling) + ML-3 (unified store) — implementation spec"
Cohesion: 0.06
...
### Community 261 - "memory_commands.py"
Cohesion: 0.14
Nodes (23): honcho_render_env_cmd(), Sync Honcho conclusions → Hindsight (resumes from the saved watermark).      Equ, Render ``/etc/hal0/honcho.env`` from ``hal0.toml [honcho]`` and (best-effort) re, sync_graph_cmd(), _derived_tags(), _document_ids(), _load_honcho_cli_config(), migrate_default() (+15 more)

### Community 262 - "EventBus"
Cohesion: 0.10
...
### Community 265 - "import_toml_to_sqlite"
Cohesion: 0.12
...
### Community 266 - "build_per_slot"
Cohesion: 0.06
Nodes (36): build_per_slot(), CapacitySnapshot, _container_cgroup_mem_bytes(), _ctx_tokens_for(), _kv_estimate_mb(), Any, Slot capacity snapshot.  CapacitySnapshot is the single-source view of available, Best-effort KV-cache size in MiB for a given context window. (+28 more)

### Community 267 - "ModelFilters"
Cohesion: 0.12
...
### Community 268 - "TestClient"
Cohesion: 0.13
Nodes (31): _hf_handler(), _patch_httpx_transport(), Any, Exception, MonkeyPatch, TestClient, Build an httpx MockTransport handler for the inspect tests., Patch ``httpx.AsyncClient`` so the inspect route uses our mock transport.      T (+23 more)

### Community 269 - "test_board_routes.py"
Cohesion: 0.10
...
### Community 270 - "FakeManager"
Cohesion: 0.06
Nodes (45): NextStep, _diagnose_audit_rows(), _diagnose_migration(), _diagnose_models(), _diagnose_profiles(), Diagnosis, Assemble the §21.4 ``HAL0-MODEL-*`` Diagnosis rows from the evidence     ``docto, One ``HAL0-MIGRATION-PENDING`` row (always ``warn`` — operator-initiated),     o (+37 more)

### Community 271 - "useLogs.ts"
Cohesion: 0.10
Nodes (21): appendEntry(), entryKey(), parseRawLevel(), buildJournalQuery(), JournalEntry, JournalLevel, JournalSource, LogEntry (+13 more)

### Community 272 - "KeyError"
Cohesion: 0.12
...
### Community 275 - "memory.py"
Cohesion: 0.14
Nodes (30): build_server(), _iso_now(), make_dispatcher(), _memory_add(), _memory_delete(), _memory_list(), _memory_recall(), _memory_search() (+22 more)

### Community 276 - "test_agents_personas.py"
Cohesion: 0.15
...
### Community 279 - "test_journal_routes.py"
Cohesion: 0.13
...
### Community 280 - "test_uninstall.py"
Cohesion: 0.10
...
### Community 281 - "test_seeds_data.py"
Cohesion: 0.07
Nodes (13): Tests for hal0.config.seeds — the shipped-TOML seed-data loader (P3-schema).  Co, The schema.py module-level names must be exactly what seeds.* returns,     so `f, Regression guard for spec risk R2 (schema<->seeds circular import).      The rea, Every ``@NAME`` placeholder in the shipped TOML must resolve to a         real i, Profiles that reference the ROCmFPX sentinel must resolve to the         SAME li, flm/kokoro/qwen3tts/the upstream CUDA image/the comfyui digest are         NOT p, The ``@embed_rerank`` TOML marker must expand into the shared         embed+rera, TestColdImportOrder (+5 more)

### Community 282 - "FakeUpstreamRegistry"
Cohesion: 0.12
...
### Community 283 - "test_bootstrap_prereq_parity.py"
Cohesion: 0.11
...
### Community 284 - "_write_fixture"
Cohesion: 0.15
Nodes (18): Path, Parse the GGUF header and return a dict of interesting KV pairs.      Returns ``, read_gguf_header(), ROCmFPX-family quant detection (ciru-ai/ROCmFPX custom GGUF formats).      These, TestRocmfpxQuant, _build_gguf(), _enc_kv(), _enc_str() (+10 more)

### Community 285 - "test_fail_watcher_warming.py"
Cohesion: 0.15
Nodes (28): _await_state(), fast_fail_watch(), _load_into_warming(), Any, FakeContainerProvider, MonkeyPatch, Path, SlotManager (+20 more)

### Community 286 - "mock-data.ts"
Cohesion: 0.09
...
### Community 287 - "SingleFlightGroup"
Cohesion: 0.08
Nodes (23): CachedModelsFn, FetchModelsFn, IsOnlineFn, ModelRegistry, SlotManager, Any, Request coalescing / single-flight for cold-cache prefetch.  When multiple concu, Return a snapshot of currently in-flight keys (for diagnostics). (+15 more)

### Community 288 - "P3-slots: Decomposition Spec for `slots/manager.py`"
Cohesion: 0.07
...
### Community 289 - "Hal0MemoryProvider"
Cohesion: 0.09
Nodes (10): hal0-memory — Hermes ``MemoryProvider`` plugin (canonical, shipped source).  Imp, Plugin entry point — register the provider with the loader., register(), Hal0MemoryProvider, MemoryProvider, Any, Hal0MemoryClient, REST-backed memory provider — wraps hal0-memory (private + shared banks). (+2 more)

### Community 290 - "_StepCtx"
Cohesion: 0.14
Nodes (16): _atomic_write(), _atomic_write_if_changed(), _build_brain_profile_mcp_servers(), content_hash(), _deep_merge(), _merge_config_yaml_layers(), _phase_brain_profile_mcp_wire(), Stable content hash steps use to detect "inputs unchanged".      Steps that prod (+8 more)
...
### Community 292 - "map_backend_to_device"
Cohesion: 0.10
Nodes (13): migrate_capabilities_v1_to_v2(), Any, Extract the ``schema_version`` from a raw capabilities dict.      Missing or non, Pure-dict v1 → v2 migration. Idempotent on v2 inputs.      Transforms applied:, Read-only promotion shim: derive ``device`` from a legacy         on-disk ``back, read_schema_version(), map_backend_to_device(), Map a legacy ``backend`` value to the v0.2 ``device`` enum.      Unknown values (+5 more)

### Community 293 - "orchestrate_models"
Cohesion: 0.11
...
### Community 294 - "test_auth_rotate.py"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (29): detect(), DetectionResult, _filename_capability(), _heuristic_only(), _hf_repo_name_from_path(), Any, Path, quant_from_file_type() (+21 more)

### Community 297 - "test_hal0_memory_client.py"
Cohesion: 0.10
...
Cohesion: 0.11
Nodes (28): _make_request(), Build a minimal request stand-in.      ``loaded`` materialises as a container-ba, The loaded set is read from the cached upstream catalogs only —     no live /v1/, The loaded set derives from container-backed upstreams (``slot_name``     set):, O21 regression: SlotManager registers LOCAL container slots as     kind="slot" (, End-to-end O21 repro: [brain_chat] model="hal0/brain" with the brain     slot lo, Container slots register as kind='remote' (with slot_name) but are LOCAL —     t, The dashboard bug repro: a system message mid-array used to leave     `_normaliz (+20 more)

### Community 299 - "test_config_urls.py"
Cohesion: 0.10
...
### Community 300 - "Tier 2 — medium (one PR each)"
Cohesion: 0.07
...
### Community 301 - "PART 0 — Current registry, mapped (file:line)"
Cohesion: 0.07
...
### Community 302 - "test_mcp_transport_security.py"
Cohesion: 0.11
...
### Community 306 - "merge_slot_config"
Cohesion: 0.11
...
### Community 307 - "SystemCtlSeam"
Cohesion: 0.08
Nodes (43): CompletedProcess, Path, Write a ``hal0-slot@<id>.service`` unit file., Delete a ``hal0-slot@<id>.service`` unit file (no-op if absent)., Write a ``hal0-slot@<token>.container`` Quadlet source file (P3-quadlet)., Delete a ``hal0-slot@<token>.container`` Quadlet file (no-op if absent)., Run ``systemctl <args...>``, routing daemon-reload + hal0-slot@         unit ver, ``systemctl restart hal0-api.service`` — the self-update path. (+35 more)

### Community 308 - "test_v1_audio.py"
Cohesion: 0.13
...
### Community 309 - "test_pressure_eviction.py"
Cohesion: 0.20
...
### Community 310 - "profiles.jsx"
Cohesion: 0.05
Nodes (57): URL-safe lowercase identifier used by the REST surface., api(), ApiOptions, serialiseBody(), ProfileBody, ProfileEnvelope, ProfileImportDryResult, useProfileCreate() (+49 more)

### Community 311 - "run_tool_loop"
Cohesion: 0.14
...
### Community 312 - "hal0 Hermes Integration Suite Implementation Plan"
Cohesion: 0.07
...
### Community 313 - "hardware.py"
Cohesion: 0.06
Nodes (63): _background_revalidate(), _cached_snapshot(), _clear_in_flight(), get_hardware(), _gpu_sample(), _local_image_repos(), _local_live_stats(), models_health_endpoint() (+55 more)

### Community 314 - "services.py"
Cohesion: 0.11
Nodes (23): list_services(), mdns_apply(), mdns_status(), _mdns_url(), _probe_http_env(), _public_url(), Any, Request (+15 more)

### Community 315 - "model_store_root"
Cohesion: 0.15
Nodes (18): model_store_root(), Resolve the model-store directory that slot containers bind-mount.      THIN SHI, _build_spec(), _model_info(), _moe_profile(), Any, Tests: container emits --chat-template-file from resolved chat_template.  Task 3, container_spec emits --chat-template-file from resolved slot/model template. (+10 more)

### Community 316 - "installed.py"
Cohesion: 0.14
Nodes (25): get_installed(), _harden_registry_perms(), install(), InstalledServer, list_installed(), patch_config(), Any, Path (+17 more)

### Community 317 - "RequestSeam"
Cohesion: 0.19
...
### Community 319 - "test_agent_restart_endpoint.py"
Cohesion: 0.18
...
### Community 321 - "test_memory_subgraph.py"
Cohesion: 0.16
...
### Community 324 - "test_npu_occupancy.py"
Cohesion: 0.15
...
### Community 326 - "test_installed.py"
Cohesion: 0.11
...
### Community 327 - "test_router_loop.py"
Cohesion: 0.19
...
### Community 328 - "test_event_contract.py"
Cohesion: 0.15
...
### Community 329 - "test_migrate_haloai.py"
Cohesion: 0.15
...
### Community 330 - "_slot"
Cohesion: 0.19
Nodes (12): _agg(), FakeSlotManager, no_mem(), MonkeyPatch, Slot, Unit tests for hal0.slot_view — SlotViewAggregator + per-concern functions.  Iss, Stub out the capacity probe so snapshot() never touches systemd., Just enough surface for the aggregator: list() + iter_configs(). (+4 more)

### Community 331 - "test_exposure.py"
Cohesion: 0.10
Nodes (25): BaseRoute, app_routes(), _classify_method(), _enumerate_routes(), _iter_effective(), FastAPI, MonkeyPatch, §21.11 exposure-CI ratchet (KB-1 / §1, seam S9).  Walks the *real* mounted route (+17 more)

### Community 332 - "ML-4 (runner-image registry) + ML-5 (flag resolution) — implementation-ready spec"
Cohesion: 0.08
...
### Community 334 - "journal.py"
Cohesion: 0.15
Nodes (25): LevelFilter, _bus(), _collect(), get_journal(), _hal0_event_to_entry(), JournalEntry, _passes_filters(), Any (+17 more)

### Community 335 - "moonshine_server.py"
Cohesion: 0.09
Nodes (25): Exception, _decode_audio(), _detect_local_format(), _load_model(), main(), JSONResponse, ndarray, Path (+17 more)

### Community 336 - "migrate_hindsight_to_honcho"
Cohesion: 0.07
...
### Community 338 - "comfyui.py"
Cohesion: 0.08
Nodes (47): aclose_client(), _arbiter_api_mode(), _arbiter_unavailable(), _as_pct(), _bytes_to_gb(), _comfyui_container(), _comfyui_models_dir(), comfyui_models_fetch() (+39 more)

### Community 339 - "HermesBoardExecutor"
Cohesion: 0.15
...
### Community 340 - "test_doctor_profiles.py"
Cohesion: 0.11
Nodes (22): check_profile_images_present(), check_slot_profile_refs(), doctor_profiles(), _image_repo(), _local_image_repos(), Flag slots whose ``profile = "..."`` names a profile not in the catalog.      ``, Strip the tag/digest → the bare ``registry/repo`` of an image ref., Warn when an *in-use* profile's image repo isn't present locally.      ``local_r (+14 more)

### Community 341 - "evaluate_model_fit"
Cohesion: 0.13
...
### Community 343 - "test_v1_slot_alias_models.py"
Cohesion: 0.13
...
### Community 344 - "test_hermes_executor.py"
Cohesion: 0.18
...
### Community 345 - "test_agent_approvals_list.py"
Cohesion: 0.09
...
### Community 346 - "test_slot_create_flags.py"
Cohesion: 0.11
...
### Community 348 - "test_flm_container_spec.py"
Cohesion: 0.16
...
### Community 349 - "test_id_keying.py"
Cohesion: 0.20
...
### Community 351 - "test_prewire_smoke.py"
Cohesion: 0.10
...
### Community 352 - "hal0 benchmarking system — full design (batch runs, rich run detail, display, auto-update)"
Cohesion: 0.08
...
### Community 353 - "read_gguf_header"
Cohesion: 0.17
Nodes (13): mmap, GGUFParseError, Any, GGUF header parser — read-only metadata extraction.  Parses the GGUF v1-v3 magic, Raised on a truncated / malformed GGUF header.      Callers usually convert this, Cursor over a bytes-like blob with bounds-checked reads., Read and return a GGUF value of ``vtype``. Used for keys we want., Skip a GGUF value of ``vtype`` without materialising it. (+5 more)

### Community 354 - "images"
Cohesion: 0.07
Nodes (39): _RunFn, _backend_state(), _image_repo(), Strip the tag/digest → the bare ``registry/repo`` of an image ref.      Mirrors, ``"installed"`` / ``"installable"`` / ``"unavailable"`` for one runner.      Loc, images(), _parse_repos(), PodmanImagesResult (+31 more)

### Community 355 - "migrate-haloai.py"
Cohesion: 0.16
Nodes (24): AllowEntry, build_model(), _build_parser(), _ensure_empty_or_force(), _hub_dirname(), load_allowlist(), main(), migrate() (+16 more)

### Community 356 - "personas.py"
Cohesion: 0.10
...
### Community 357 - "test_doctor.py"
Cohesion: 0.10
Nodes (22): OSError, _flatten_slot_toml(), load_manifest(), manifest_image_ref(), Any, Normalise both slot-TOML shapes into the flat SlotConfig shape.      Two on-disk, Inverse of _flatten_slot_toml — produce the on-disk shape.      Writes only ``de, Write a TOML file atomically.      Mirrors hal0.config.env.write_env_atomic but (+14 more)

### Community 358 - "applied_versions"
Cohesion: 0.10
...
### Community 361 - "test_hal0_provider_plugin.py"
Cohesion: 0.13
Nodes (16): _delta(), MonkeyPatch, hal0-provider Hermes plugin (canonical src copy) — hermetic unit coverage.  ``sr, _sse(), test_assemble_stream_backfills_content_and_role(), test_assemble_stream_orders_sparse_tool_call_indices(), test_assemble_stream_preserves_reasoning_content(), test_assemble_stream_reassembles_tool_calls_across_gaps() (+8 more)

### Community 362 - "test_dashboard_layout.py"
Cohesion: 0.11
...
### Community 363 - "test_v1_models_filters.py"
Cohesion: 0.20
...
### Community 364 - "test_brain_read_only.py"
Cohesion: 0.12
...
### Community 367 - "test_upstream_commands.py"
Cohesion: 0.15
...
### Community 368 - "test_honcho_migrate.py"
Cohesion: 0.06
Nodes (16): BIG_HUBS, BIG_LINK_TYPES, BIG_TOPICS, buildBankRecall(), buildBankTimeseries(), Builder, ISO(), MEM_ENTITIES (+8 more)

### Community 369 - "hal0 installer"
Cohesion: 0.08
...
### Community 371 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.08
...
### Community 373 - "test_slots_routes.py"
Cohesion: 0.13
Nodes (23): SSE stream of state transitions for ``name`` (and only ``name``).      The SlotM, slot_state_stream(), isolated_app(), isolated_client(), FastAPI, Tests for the /api/slots route surface (container runtime).  Covers:   - list-me, A FastAPI app whose lifespan resolves paths under tmp_hal0_home.      The shared, Real SlotManager entries appear alongside synthetic upstream-backed ones. (+15 more)

### Community 374 - "memory_bank_commands.py"
Cohesion: 0.17
...
### Community 375 - "_Runner"
Cohesion: 0.09
Nodes (16): ModelConfig, NpuConfig, [model] section in a slot TOML.      Specifies which model the slot loads by def, [npu] table in a slot TOML — FLM trio modality toggles.      Maps to ``flm serve, [server] section in a slot TOML.      Currently carries only ``extra_args`` — a, Reject non-env-var-name keys and multi-line values.          A stray newline in, ServerConfig, Dotted paths of payload keys the slot-config schema does not know.      ``SlotCo (+8 more)

### Community 376 - "test_channel.py"
Cohesion: 0.12
Nodes (22): base_matches(), base_version(), channel_for_tag(), nightlies_to_prune(), nightly_tag(), nightly_version(), Release-channel helpers shared by the release + nightly workflows.  Pure functio, Return the release channel implied by a git tag.      A version carrying a ``-ni (+14 more)

### Community 377 - "_container_cgroup_mem_bytes"
Cohesion: 0.07
Nodes (17): react, CI(), Ic(), MemDocuments(), MemRecallConsole(), mtDocTitle(), mtDocWhen(), mtFactColor() (+9 more)

### Community 378 - "test_run_as_hal0_guard.py"
Cohesion: 0.13
...
### Community 379 - "test_models_routes.py"
Cohesion: 0.09
Nodes (23): inspect_app(), inspect_client(), FastAPI, Tests for the /api/models surface added in the v3 wireup.  Covers two pieces:, GET /api/models/{id} carries the same ``ns`` derivation., Local registry rows expose ``type`` in the DISPATCHER vocabulary     (llm/embedd, Either ``hf_repo`` or ``hf_url`` must be present + non-empty., Single-token inputs like 'qwen' are rejected as not org/name. (+15 more)

### Community 380 - "test_brain_self_auth.py"
Cohesion: 0.18
...
### Community 381 - "test_npu_columns.py"
Cohesion: 0.15
...
### Community 385 - "_run_nonstreaming_turn"
Cohesion: 0.14
...
### Community 387 - "provision_comfyui_downloads"
Cohesion: 0.13
...
### Community 388 - "HindsightRestClient"
Cohesion: 0.12
...
### Community 389 - "MemoryNamespaceError"
Cohesion: 0.16
...
### Community 390 - "apply_thinking_policy"
Cohesion: 0.15
...
### Community 392 - "container_enrichment"
Cohesion: 0.22
...
### Community 393 - "NpuExclusivityViolation"
Cohesion: 0.15
...
### Community 394 - "read_stack_state"
Cohesion: 0.15
...
### Community 395 - "test_agent_memory_stats_endpoint.py"
Cohesion: 0.16
...
### Community 396 - "test_backends_npu_canonical_fields.py"
Cohesion: 0.13
...
### Community 398 - "test_settings_models_store.py"
Cohesion: 0.17
...
### Community 401 - "FakeContainerProvider"
Cohesion: 0.10
...
### Community 402 - "useActivity.ts"
Cohesion: 0.14
Nodes (20): ActivityEnvelope, activityExportUrl(), ActivityFilters, ActivityRecord, ActivitySeverity, ActivityStreamResult, buildActivityQuery(), _epochCache (+12 more)

### Community 403 - "UI drawers — slot/model/profile editors"
Cohesion: 0.09
...
### Community 404 - "hal0 Settings Menu — Wireframe / IA"
Cohesion: 0.09
...
### Community 405 - "test_hermes_upgrade.py"
Cohesion: 0.20
...
### Community 406 - "dashboard_layout.py"
Cohesion: 0.12
...
### Community 407 - "test_tts_request_defaults.py"
Cohesion: 0.16
Nodes (19): Fill omitted /v1/audio/speech params from the slot's persisted defaults., _seed_tts_defaults(), isolated_app(), isolated_client(), FastAPI, SimpleNamespace, TestClient, TTS request-default injection + voices proxy (Settings → Voice, Phase 3).  ``/v1 (+11 more)

### Community 408 - "test_slot_config_validation.py"
Cohesion: 0.20
...
### Community 411 - "resolve_argv"
Cohesion: 0.10
Nodes (21): FlagProvenance, One surviving flag and the input segment it was resolved from., Resolve ordered ``(source_label, tokens)`` segments into one deduped argv., resolve_argv(), Golden path #5 (pull→assign→infer) — launch-time profile-read invariant.  spec-f, CURRENT behaviour (increment 1): even when the model carries a stamped     ``def, When the stamp and the live profile set the SAME flag, the model tune     wins (, test_stamped_model_defaults_win_over_profile_on_flag_collision() (+13 more)

### Community 412 - "test_hermes_env_seam.py"
Cohesion: 0.15
...
### Community 414 - "test_providers.py"
Cohesion: 0.14
...
### Community 415 - "test_services_page.py"
Cohesion: 0.14
...
### Community 416 - "test_v1_proxy.py"
Cohesion: 0.14
...
### Community 417 - "test_virtual_models.py"
Cohesion: 0.17
...
### Community 418 - "test_brain_framing.py"
Cohesion: 0.23
...
### Community 419 - "test_trio_status_inheritance.py"
Cohesion: 0.18
...
### Community 420 - "test_doctor_verify.py"
Cohesion: 0.12
...
### Community 422 - "test_curated_image_models.py"
Cohesion: 0.12
...
### Community 423 - "test_kb1_hardening_tail.py"
Cohesion: 0.07
...
### Community 424 - "Dashboard Overhaul — FROZEN DATA CONTRACT (v1)"
Cohesion: 0.09
...
### Community 425 - "services.jsx"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 426 - "memory-graph-engine.jsx"
Cohesion: 0.12
...
Cohesion: 0.10
Nodes (20): [0.9.4] — 2026-07-08, [0.9.5.2] — 2026-07-09, Added, Added, Added, Changed, Changelog, Fixed (+12 more)

### Community 428 - "migrate_slot_id_keying"
Cohesion: 0.17
Nodes (18): Collection, migrate_slot_id_keying(), _migrate_state(), MigrationReport, Any, Path, One-shot M5 migration: name-keyed slot artefacts → id-keyed (rework §3.1).  Incr, One slot that was migrated name → id in this run. (+10 more)

### Community 429 - "PART 2 — FIRST-CLASS DESIGN"
Cohesion: 0.10
...
### Community 430 - "P2-config: Collapse capabilities.toml double-bookkeeping"
Cohesion: 0.10
...
### Community 431 - "test_system_info_route.py"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 432 - "Request"
Cohesion: 0.11
Nodes (23): api_patch(), advertise_upstream(), create_upstream(), credentials_set(), delete_upstream(), _do_set_credentials(), _filters_summary(), list_upstreams() (+15 more)
...
### Community 441 - ".container_spec"
Cohesion: 0.50
Nodes (3): _flm_shadow_role_args(), Build the ``--embed`` / ``--asr`` argv tail.      Shared by :meth:`FLMProvider.s, Return argv for the native ``flm serve`` invocation.          Used by tests and

### Community 442 - "test_model_preferred_profile.py"
Cohesion: 0.14
Nodes (19): CapacityProbeError, Return True if the requested memory would fit within current headroom., /proc/meminfo unreadable, or DRM sysfs not enumerable., Return (total_mib, available_mib) from /proc/meminfo.      Raises CapacityProbeE, _read_meminfo(), probe_host_free_mb(), probe_host_total_mb(), Return free host memory in MiB, GTT-aware where possible (§21.10).      Prefers (+11 more)

### Community 443 - "embed_references"
Cohesion: 0.18
...
### Community 444 - "test_hermes_provision_honcho.py"
Cohesion: 0.16
...
### Community 445 - "test_memory_admin_document_transfer.py"
Cohesion: 0.20
...
### Community 446 - "test_pull_shutdown.py"
Cohesion: 0.13
Nodes (17): Kind, ActionRecorder, _dump(), _now_iso(), Any, Durable activity / audit store — hal0's source of truth for change.  The footer, ISO-8601 UTC timestamp with microsecond precision (matches EventBus)., Recursively replace secret-looking values so they never hit disk. (+9 more)

### Community 447 - "test_throughput_history.py"
Cohesion: 0.19
...
### Community 448 - "test_eligibility.py"
Cohesion: 0.10
...
### Community 449 - "test_disabled_capability_slot_is_not_woken"
Cohesion: 0.20
...
### Community 450 - "Security review — v1.0 auth surface (2026-05-21)"
Cohesion: 0.10
...
### Community 451 - "test_preflight_gpu_gate.py"
Cohesion: 0.14
Nodes (20): Path, Contract tests for ``preflight_gpu``'s install-time gate (WS-B, #1104).  ``prefl, Device present + gid maps to a real group → proceed (0)., Only an LXC miswire blocks — a bare-metal unmapped gid still proceeds., Without the gate flag (doctor), the same broken LXC stays soft (0)., Without the gate flag, a no-device LXC also stays soft (0)., Source preflight.sh and run ``preflight_gpu``, returning its rc.      ``set -euo, A glob that matches a fake render node, so 'device present' is testable. (+12 more)

### Community 452 - "_write_fake_python"
Cohesion: 0.20
...
### Community 453 - "test_manager_npu_container.py"
Cohesion: 0.20
...
### Community 455 - "activity-log.spec.ts"
Cohesion: 0.15
Nodes (17): emitSse(), emitSseTyped(), installSseHarness(), waitForSse(), emitAndAwait(), ERR_REC, frame(), OK_REC (+9 more)

### Community 456 - "CliRunner"
Cohesion: 0.18
Nodes (19): CliRunner, O14: `--adopt` is spec-retired — the CLI parser must reject the flag.      The s, test_install_hermes_no_longer_accepts_adopt(), cli_runner(), isolated_personas(), MonkeyPatch, Path, CLI tests for ``hal0 agent personas {list,show,activate}`` (PR-3, v0.3).  These (+11 more)

### Community 457 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.10
...
### Community 458 - "Enum"
Cohesion: 0.13
Nodes (17): Matcher, AuthClass, classify(), _exact(), match_rule(), _outside_api_v1_mcp(), _prefix(), Route -> :class:`AuthClass` classification table (KB-1 / §1, seam S9).  Single s (+9 more)

### Community 459 - "generate_results_json.py"
Cohesion: 0.16
Nodes (19): _cell_metrics(), collect(), collect_server_ab(), fmt_ts(), _fnum(), load_meta(), main(), normalize() (+11 more)

### Community 460 - "migrate-qwen3tts-to-slot.sh"
Cohesion: 0.40
...
### Community 461 - "MemoryProvider"
Cohesion: 0.13
Nodes (22): backfill_coordless(), Repair existing registry rows that have empty HF coordinates.      A row auto-re, Discover candidates under ``cfg.roots`` and register the new ones.      Returns, scan_and_register(), ModelRegistry, End-to-end: a NON-curated reranker gguf under a scan root registers with     cap, End-to-end: the registered main model resolves its mmproj path, and     no stand, An existing registry row with empty coords whose on-disk filename matches     a (+14 more)

### Community 462 - "approvals.py"
Cohesion: 0.18
...
### Community 465 - "file_lock"
Cohesion: 0.11
Nodes (24): _classify_pair(), migrate(), ModelRegistry, ``hal0 capabilities`` subcommands.  Operator tooling for the capability-slot sur, Return ``(verdict, legal_backends)`` for one (capability, model, backend) tuple., Rewrite persisted selections that are illegal against the live catalog.      Wal, _depths(), file_lock() (+16 more)

### Community 466 - "MemoryGraphConfig"
Cohesion: 0.13
...
### Community 467 - "network.py"
Cohesion: 0.15
Nodes (19): _coerce_port(), _dedupe(), derive_allowed_origins(), detect_lan_ips(), _is_lan_ipv4(), main(), network_env(), _origin_of() (+11 more)

### Community 468 - "resolve_gpu_device_paths"
Cohesion: 0.11
Nodes (15): gpu_visibility_env(), is_nvidia_gpu_device(), nvidia_cdi_devices(), _probed_gpu_group_gids(), Shared helpers for GPU device + group exposure to provider containers.  Lives he, True when a slot's declared device/profile selects the NVIDIA path.      Decided, CDI device names for NVIDIA GPU passthrough.      ``--device nvidia.com/gpu=all`, Visibility env a pinned slot needs, keyed by device family.      Returns ``{}`` (+7 more)

### Community 469 - "_reconcile_device_profile"
Cohesion: 0.20
...
### Community 471 - "_RecordingSlotManager"
Cohesion: 0.14
...
### Community 474 - "test_model_first_run_commands.py"
Cohesion: 0.17
...
### Community 475 - "test_model_store_root.py"
Cohesion: 0.14
...
### Community 476 - "Path"
Cohesion: 0.10
Nodes (22): applied_versions(), _discover_migrations(), _ensure_migrations_table(), migrate(), Connection, Path, Forward-only SQLite schema migration runner.  This is the concrete implementatio, Create the bookkeeping table if absent. Idempotent. (+14 more)

### Community 477 - "TestEarlyHal0User"
Cohesion: 0.10
...
### Community 479 - "test_comfyui_workflows.py"
Cohesion: 0.15
...
### Community 480 - "test_container_mmproj.py"
Cohesion: 0.31
...
### Community 481 - "test_fail_watcher.py"
Cohesion: 0.18
...
### Community 482 - "profiles-crud-v3.spec.ts"
Cohesion: 0.10
...
### Community 483 - "0. Research-grounded findings that drive the matrix"
Cohesion: 0.11
...
### Community 484 - "hal0.sh"
Cohesion: 0.26
Nodes (15): create_lxc(), die(), header(), install_inside_lxc(), locate_template(), main(), msg_error(), msg_info() (+7 more)

### Community 485 - "auth.py"
Cohesion: 0.16
Nodes (18): _client_ip(), login(), LoginRequest, logout(), Request, Response, KB-1 / §1 auth surface: ``POST /api/auth/login`` + ``GET /api/auth/status``.  Bo, Persist the ``[security].require_auth`` enforcement toggle. ADMIN-gated.      Wr (+10 more)

### Community 486 - "comfyui_switchover"
Cohesion: 0.17
...
### Community 487 - "seeds.py"
Cohesion: 0.15
Nodes (18): _embed_rerank_rows(), family_defaults(), profile_bench(), Any, Loader for hal0's shipped seed data (profiles, stacks, bench, family defaults)., Raw seed-profile dicts (image sentinels resolved), keyed by slug.      Same shap, Built-in seed stacks, validated into :class:`StackConfig` instances., Static bench numbers for seed profiles (card hero metric). (+10 more)
...
### Community 489 - "seed_static_slots"
Cohesion: 0.20
Nodes (17): Path, Static slot-config seeds shipped in ``installer/etc-hal0/slots/``.  ``install.sh, Copy any missing static seed TOML into the slots config dir.      Idempotent and, seed_static_slots(), _fake_installer_root(), Path, Unit tests for :mod:`hal0.install.static_seeds`.  Closes the same fresh-install-, A partially-shipped installer tree (missing one seed source) must     not abort (+9 more)

### Community 490 - "SlidingWindowRateLimiter"
Cohesion: 0.12
...
### Community 491 - "test_models_add_from_path.py"
Cohesion: 0.20
...
### Community 493 - "test_port_registry.py"
Cohesion: 0.23
...
### Community 495 - "test_settings_routes.py"
Cohesion: 0.15
...
### Community 497 - "test_capabilities_commands.py"
Cohesion: 0.19
...
### Community 499 - "test_store_concurrency.py"
Cohesion: 0.19
...
### Community 502 - "FakeDelegateRunner"
Cohesion: 0.16
...
### Community 505 - "manage-slots.mdx"
Cohesion: 0.11
...
### Community 506 - "spec-kb23 — hal0-brain chat tool-tier, approval-gate & injection-resistance"
Cohesion: 0.11
...
### Community 507 - "hal0-admin tools"
Cohesion: 0.11
...
### Community 508 - "kokoro_server.py"
Cohesion: 0.14
...
### Community 511 - "ensure_podman_apparmor_usable"
Cohesion: 0.19
...
### Community 512 - "Hal0MemoryClient"
Cohesion: 0.11
...
### Community 513 - "ProgressCoalescer"
Cohesion: 0.14
...
### Community 515 - "TestFamilyDefaults"
Cohesion: 0.12
Nodes (12): family_flags(), model_family(), The :data:`FAMILY_DEFAULTS` flag string for the model's family, else ''., Best-effort model family, preferring the registry's ``architecture``.      §7.1a, §7.1a / ML-5: family_flags/model_family re-keyed off Model.architecture     firs, test_family_flags_prefers_architecture_over_filename_scan(), A hand-authored [server].extra_args overrides the family default., The vulkan seed ships minimal flags with NO forced KV quant.          The 2026-0 (+4 more)
...
### Community 520 - "detect.py"
Cohesion: 0.15
Nodes (16): _fmt_size(), model_assign(), model_list(), model_pull(), model_register(), model_show(), model_update(), _poll_pull_progress() (+8 more)

### Community 521 - "mdns.py"
Cohesion: 0.18
...
### Community 523 - "_hermes_fakes.py"
Cohesion: 0.20
...
### Community 524 - "_FakeHttpClient"
Cohesion: 0.20
Nodes (13): _FakeHttpClient, _FakeResponse, _models_body(), Any, Restart-free hot-swap: re-reading inventory reflects a role retarget with     no, Duck-typed ``httpx.Client`` stand-in — records calls, never sockets., test_fetch_models_agent_id_from_env(), test_fetch_models_bad_json_falls_back() (+5 more)

### Community 525 - "ProviderProfile"
Cohesion: 0.16
...
### Community 526 - "test_hermes_security_deliverables.py"
Cohesion: 0.15
...
### Community 527 - "test_mcp_client.py"
Cohesion: 0.15
Nodes (14): Raised when filesystem-style MCP args try to escape the workspace.      Tool arg, WorkspaceEscapeError, client(), AgentConfig, MonkeyPatch, Path, ADR-0013 MCP client tests.  Cover:   - schema-validation envelope (overlap, miss, Write a TOML the way installer/agents/hermes.sh would, load it. (+6 more)

### Community 528 - "test_approvals.py"
Cohesion: 0.21
Nodes (17): app(), _build_app(), client(), _noop_executor(), Any, FastAPI, TestClient, queue() (+9 more)

### Community 529 - "_Headers"
Cohesion: 0.11
...
### Community 530 - "test_comfyui_phase4.py"
Cohesion: 0.13
...
### Community 531 - "FakeUpstreamRegistry"
Cohesion: 0.17
...
### Community 532 - "test_models_preview.py"
Cohesion: 0.19
...
### Community 534 - "test_settings_apply.py"
Cohesion: 0.11
...
### Community 535 - "Path"
Cohesion: 0.12
Nodes (18): npu_trio_slot_root(), Path, Lay down the NPU FLM trio (agent + stt-npu + embed-npu) on disk., PR-18: each entry carries ``type`` + ``model_default`` + ``enabled``.      The d, An explicit upstreams.toml entry for ``hal0`` survives startup unchanged.      O, POST /api/slots/chat/load goes through ContainerProvider.load_sync., GET /api/slots/doesntexist/config → 404 slot.not_found.      Pre-issue-#35 the r, Enabling a 2nd NPU LLM anchor → 409 with the exclusivity message, no write. (+10 more)

### Community 536 - "test_v1_dispatch.py"
Cohesion: 0.16
...
### Community 537 - "test_doctor_perms.py"
Cohesion: 0.19
...
### Community 541 - "FakeLocalBackend"
Cohesion: 0.17
...
### Community 542 - "MapContainerProvider"
Cohesion: 0.20
...
### Community 546 - "Slot config — capabilities ↔ slots reconciliation"
Cohesion: 0.12
...
### Community 547 - "hal0 Adoption Candidates — Lemonade + ODS (combined)"
Cohesion: 0.12
...
### Community 548 - "spec-hp-realtime — OpenAI Realtime WebSocket endpoint for hal0"
Cohesion: 0.12
...
### Community 549 - "P3-schema — `config/schema.py` decomposition: implementation-ready spec"
Cohesion: 0.12
...
### Community 555 - "suggest_models"
Cohesion: 0.12
Nodes (26): _is_coder(), _ram_gb(), Hardware-driven curated-model suggestions per capability (spec §6.5).  Generaliz, Return up to ``limit`` curated picks for ``capability`` that fit the     detecte, suggest_models(), Suggestion, _build_curated(), CuratedModel (+18 more)

### Community 556 - "apply_extraction_slot"
Cohesion: 0.18
...
### Community 557 - "normalize_system_messages"
Cohesion: 0.18
...
### Community 560 - "test_argv.py"
Cohesion: 0.20
Nodes (15): normalize_argv(), Dedup ``tokens`` keeping the last occurrence of each scalar/bool flag.      Effe, Unit + golden-parity tests for hal0.slots.argv.normalize_argv.  The golden fixtu, Last value following ``flag`` in ``tokens`` (the effective value)., test_agent_live_dedups_but_preserves_effective_values(), test_alias_dedups_short_against_long(), test_append_flags_are_never_deduped(), test_bare_positionals_preserved() (+7 more)

### Community 561 - "metrics_collect.py"
Cohesion: 0.15
...
### Community 562 - "test_hermes_state_render.py"
Cohesion: 0.12
...
### Community 563 - "test_logs_routes.py"
Cohesion: 0.16
Nodes (16): TestClient, Tests for /api/logs and /api/logs/stream.  journalctl is rarely available in CI,, Validation runs before the SSE generator starts., GET /api/logs?unit=... returns the lines+count shape.      On hosts without jour, Missing unit query param yields a 422 in the hal0 envelope shape.      The ``Req, A shell-special char in unit name rejects with the typed envelope., An unknown ?level= value returns the typed logs error envelope., ?n=0 is below the validator floor and yields the hal0 envelope.      Pydantic-dr (+8 more)

### Community 564 - "Any"
Cohesion: 0.12
Nodes (17): container_stub(), Any, GET /api/slots/{name} is enriched same shape as the list endpoint., v0.1.x clients consuming /api/slots see every legacy key unchanged., PR-18: ``labels`` is lifted from ``[model] labels = [...]``.      The dashboard', device=npu slots surface declared_backend='flm' (the FLM recipe)., The enriched body must be valid JSON (no exotic types leaked)., ADR-0023: POST /api/slots/agent-hermes/load resolves via the surviving     hidde (+9 more)

### Community 565 - "_StubSlotManager"
Cohesion: 0.26
...
### Community 566 - "Findings from the 2026-05-16 hal0-test deep-probe round"
Cohesion: 0.12
...
### Community 567 - "DelegateTaskSpec"
Cohesion: 0.18
...
### Community 568 - "test_preflight_ports_own_service.py"
Cohesion: 0.29
...
### Community 569 - "agents-overview.jsx"
Cohesion: 0.20
...
### Community 570 - "test_npu_trio_shadow.py"
Cohesion: 0.17
...
### Community 571 - "test_ttft_samples.py"
Cohesion: 0.12
...
### Community 577 - "qwen3tts_server.py"
Cohesion: 0.16
...
### Community 578 - "AgentMCPClient"
Cohesion: 0.10
Nodes (17): ClassificationLiteral, AgentMCPClient, classify_many(), MCP client surface for bundled agents.  Reads ``/etc/hal0/agents/<name>.toml``,, Load by canonical agent name (``/etc/hal0/agents/<name>.toml``)., Return the servers the agent is allowed to *connect* to.          Server-axis de, Return the verdict for one (server, tool) pair.          Verdicts:          - ``, Same as :meth:`classify` but raise on hard-reject verdicts.          Used at cal (+9 more)

### Community 579 - "events.py"
Cohesion: 0.19
Nodes (15): _bus(), EventsInvalidQuery, EventsUnavailable, list_events(), _normalise_severity(), Any, Request, StreamingResponse (+7 more)

### Community 580 - "logs.py"
Cohesion: 0.19
Nodes (15): journalctl_sse(), list_logs(), LogsError, Any, StreamingResponse, Log endpoints (mounted under /api/logs).  Tail and stream journald entries for h, Async generator that yields SSE frames tailing ``journalctl -f -u <unit>``., Return the last ``n`` journal entries for ``unit``.      Best-effort: on hosts w (+7 more)

### Community 581 - "_shared.py"
Cohesion: 0.12
Nodes (26): Uninstall a user-installed MCP server. Bundled servers reject 409., uninstall_cmd(), _api_reachable(), api_delete(), api_get_bytes(), _api_request(), api_stream(), api_unreachable_exit() (+18 more)

### Community 582 - "system_info_command.py"
Cohesion: 0.18
...
### Community 584 - "route_to_chat.py"
Cohesion: 0.19
...
### Community 585 - "service_identity.py"
Cohesion: 0.21
...
### Community 586 - "RecordingSlotArtifactOps"
Cohesion: 0.22
...
### Community 587 - "snapshot_live_stack"
Cohesion: 0.30
...
### Community 588 - "test_hermes_provision_install_artifacts.py"
Cohesion: 0.17
...
### Community 589 - "test_agents_routes.py"
Cohesion: 0.21
...
### Community 590 - "test_mcp_identity.py"
Cohesion: 0.18
...
### Community 591 - "TestUpstreamEntry"
Cohesion: 0.06
Nodes (12): ProviderEntry, One [[provider]] entry in providers.toml.      ``extra="forbid"`` (P3-schema Par, _declared_provider(), Path, Unit tests for hal0.config.schema pydantic models.  Each validator gets exercise, Pull the provider a seeded slot TOML declares, if any.      Container slots (e.g, Regression guard for #650.      Every provider a seeded slot TOML declares must, Every shipped seed slot's `profile` must resolve to a live SEED_PROFILES key. (+4 more)

### Community 592 - "test_seeds_parity.py"
Cohesion: 0.15
Nodes (9): _golden_embed_rerank_rows(), _golden_seed_stacks(), StackCapabilityRow, Byte-identical parity test: hal0.config.seeds.* vs the pre-refactor hardcoded SE, Golden SEED_STACKS (pre-refactor schema.py, verbatim)., TestFamilyDefaultsParity, TestProfileBenchParity, TestSeedProfilesParity (+1 more)

### Community 593 - "FakeDockerBackend"
Cohesion: 0.16
...
### Community 594 - "hal0 test harness — internal contributor guide"
Cohesion: 0.12
...
### Community 597 - "Model registry — registry, pulls, classification"
Cohesion: 0.13
...
### Community 598 - "Handoff: qwen3tts standalone → hal0-slot migration"
Cohesion: 0.13
...
### Community 599 - "Container Image System Overhaul"
Cohesion: 0.13
...
### Community 600 - "hal0 rework plan — de-scarring the launch"
Cohesion: 0.13
...
### Community 601 - "Handoff — hal0 R5 endgame (paste-in brief for a new session)"
Cohesion: 0.13
...
### Community 602 - "Findings (O-series)"
Cohesion: 0.13
...
### Community 604 - "hal0 Hermes Integration Suite Design"
Cohesion: 0.13
...
### Community 606 - "test_route_collisions.py"
Cohesion: 0.19
...
### Community 608 - "upsert_env_value"
Cohesion: 0.21
...
### Community 610 - "create_chat_template"
Cohesion: 0.24
...
### Community 611 - "test_slots_policy.py"
Cohesion: 0.26
...
### Community 616 - "MetricsService"
Cohesion: 0.15
Nodes (7): MetricsAggregator, Path, Background task: aggregate the most recently completed hour, on interval., Aggregate the last fully-elapsed hour. Returns rows written., MetricsService, MetricsService -- the single object the app lifespan constructs + wires.  One in, Apply pending migrations + launch every background task.          Never raises:

### Community 617 - "models_health"
Cohesion: 0.23
Nodes (14): models_health(), _percentile(), Any, Connection, Path, Row, Read API (§21.3) -- thin queries over the OBS-1 tables.  Backs ``GET /api/stats`, ``GET /api/models/health`` payload -- one row per dispatchable slot.      ``slot (+6 more)

### Community 618 - "npu_columns.py"
Cohesion: 0.19
...
### Community 620 - "test_hermes_provision_kanban_db_init.py"
Cohesion: 0.20
...
### Community 621 - "test_persona_update.py"
Cohesion: 0.25
...
### Community 622 - "test_slots_npu_fields.py"
Cohesion: 0.20
...
### Community 623 - "test_brain_ctx_precheck.py"
Cohesion: 0.23
...
### Community 627 - "test_pool_bounds.py"
Cohesion: 0.15
...
### Community 628 - "test_device_profile_coherence.py"
Cohesion: 0.13
...
### Community 629 - "test_mtp_defuse.py"
Cohesion: 0.34
...
### Community 631 - "test_integrations.py"
Cohesion: 0.13
...
### Community 632 - "Contributing to hal0"
Cohesion: 0.14
...
### Community 633 - "Toolbox Repo Consolidation"
Cohesion: 0.14
...
### Community 634 - "obtain-models.mdx"
Cohesion: 0.14
...
### Community 635 - "PART 2 — DELIVERABLES"
Cohesion: 0.14
...
### Community 636 - "0. EXACT Honcho footprint (file:line)"
Cohesion: 0.14
...
### Community 637 - "P2-device: make `device` the sole truth, delete the `backend` dual-write"
Cohesion: 0.14
...
### Community 638 - "Handoff — R5 drive 2: put it back together (paste-in prompt, Fable orchestrator)"
Cohesion: 0.14
...
### Community 640 - "test_moonshine_server.py"
Cohesion: 0.22
...
### Community 648 - "MetricsRetention"
Cohesion: 0.18
...
### Community 650 - "argv.py"
Cohesion: 0.20
Nodes (13): _canon(), _dedup(), _deny_managed_flags(), _is_flag(), NormalizedArgv, _Pair, normalize_argv — the single dedup/last-wins pass for llama-server argv.  The lau, Result of :func:`normalize_argv`.      ``argv`` is the deduped token list. ``rem (+5 more)

### Community 651 - "heal_missing_llm_type"
Cohesion: 0.20
...
### Community 652 - "provider_requires_model"
Cohesion: 0.22
...
### Community 653 - "test_hermes_provision_context.py"
Cohesion: 0.14
Nodes (5): Linear-installer plumbing: InstallIO / _StepCtx / InstallReport.  Replaces the r, A brain-lane step is excluded from the convergence signal even if it wrote., Each brain-lane step is annotated for the concurrent relocation lane., test_brain_lane_steps_carry_relocate_markers(), test_brain_lane_steps_never_count_as_mutations()

### Community 654 - "test_middleware.py"
Cohesion: 0.21
...
### Community 655 - "test_services_health.py"
Cohesion: 0.27
...
### Community 657 - "test_brain_chat.py"
Cohesion: 0.23
...
### Community 658 - "test_memory_ops_commands.py"
Cohesion: 0.16
...
### Community 659 - "test_slot_verb_aliases.py"
Cohesion: 0.16
...
### Community 660 - "test_hal0_gpu_gate.py"
Cohesion: 0.22
...
### Community 661 - "test_image_pin.py"
Cohesion: 0.14
...
### Community 663 - "test_flm_store_link.py"
Cohesion: 0.26
...
### Community 665 - "test_adopted_slot_eviction.py"
Cohesion: 0.23
...
### Community 666 - "test_dispatchable_ready_set_single_source.py"
Cohesion: 0.14
...
### Community 667 - "test_restart_errored_slot.py"
Cohesion: 0.26
...
### Community 668 - "test_apply_commit.py"
Cohesion: 0.30
...
### Community 669 - "SecretsPage.jsx"
Cohesion: 0.19
Nodes (13): disable_cmd(), enable_cmd(), graph_disable_cmd(), provider_set_cmd(), Any, hal0 memory subcommands — graph-extraction gate.  Mirrors the slot / model CLI s, Enable the memory subsystem (persists [memory].enabled=true)., Disable the memory subsystem (persists [memory].enabled=false). (+5 more)

### Community 670 - "Contributor Covenant Code of Conduct"
Cohesion: 0.15
Nodes (12): 1. Correction, 2. Warning, 3. Temporary Ban, 4. Permanent Ban, Attribution, Contributor Covenant Code of Conduct, Enforcement, Enforcement Guidelines (+4 more)

### Community 671 - "3. Recommendation: how hal0 should support ONNX"
Cohesion: 0.15
...
### Community 672 - "Dispatch / runtime — routing, arbiter, lifecycle"
Cohesion: 0.15
...
### Community 675 - "pull-and-register-models.mdx"
Cohesion: 0.15
...
### Community 676 - "hal0 rework — handoff: single primary orchestrator (R3-B / R4 / R5 + finish line)"
Cohesion: 0.15
...
### Community 677 - "hal0 codebase map"
Cohesion: 0.15
...
### Community 678 - "hal0 service management"
Cohesion: 0.15
...
### Community 679 - "_phase_preflight"
Cohesion: 0.29
...
### Community 680 - "QueryStringScrubber"
Cohesion: 0.18
...
### Community 681 - "proxy_board_events"
Cohesion: 0.21
...
### Community 683 - "config_commands.py"
Cohesion: 0.08
Nodes (38): Enum, auth_require(), KeyTier, hal0 auth subcommands — thin HTTP client to /api/auth/*.  §5.2 of the R5 sync as, Persist the [security].require_auth posture (PUT /api/auth/require)., RequireToggle, config_edit(), config_migrate() (+30 more)
...
### Community 685 - "config_enrichment"
Cohesion: 0.35
...
### Community 686 - "image_pull.py"
Cohesion: 0.19
Nodes (10): ImagePullJob, inspect_image_state(), Any, Container-image pull orchestration for slots (extracted from routes/slots.py)., Return "present" | "missing" for ``image`` (fail-soft → "missing")., Lightweight job object for a container-image pull.      Tracks state (pulling |, Run the container pull in background, updating ``job`` per line.      Writes pro, Resolve slot ``name``'s container image via its profile, or None.      Fail-soft (+2 more)

### Community 687 - "rerender_slot_units"
Cohesion: 0.29
...
### Community 688 - "test_containers_apparmor.py"
Cohesion: 0.37
...
### Community 689 - "test_hermes_live_resolve_render.py"
Cohesion: 0.23
...
### Community 691 - "test_activity.py"
Cohesion: 0.31
...
### Community 692 - "test_activity_routes_instrumented.py"
Cohesion: 0.38
...
### Community 693 - "test_comfyui_fetch_route.py"
Cohesion: 0.15
...
### Community 694 - "test_install_apply.py"
Cohesion: 0.23
...
### Community 695 - "_FakeAgentManager"
Cohesion: 0.15
Nodes (11): _FakeAgentManager, Stand-in for :class:`hal0.agents.manager.AgentManager` — records     ``uninstall, A bare re-install of hermes itself (no other incumbent) is not a     single-pick, End-to-end: `hal0 agent install hermes` (no --switch) against an     existing pi, `--switch` clears the incumbent first, THEN provisioning proceeds —     same ato, test_enforce_single_pick_dies_on_incumbent_without_switch(), test_enforce_single_pick_noop_when_nothing_installed(), test_enforce_single_pick_noop_when_only_hermes_installed() (+3 more)

### Community 696 - "test_memory_graph_commands.py"
Cohesion: 0.15
...
### Community 704 - "Recently added endpoints"
Cohesion: 0.17
...
### Community 705 - "Design — 3-tier, deny-by-default, single classification source"
Cohesion: 0.17
...
### Community 706 - "hal0 UI/UX design brief — post-R3 surface rework"
Cohesion: 0.17
...
### Community 709 - "Release pipeline — prototype findings + blockers"
Cohesion: 0.17
...
### Community 712 - "_fetch_json"
Cohesion: 0.13
Nodes (22): _build_client(), _comfyui_base_url(), comfyui_invalid_workflow_launch(), comfyui_logs(), comfyui_preview(), comfyui_render_cancel(), comfyui_workflow_launch(), _fetch_json() (+14 more)

### Community 713 - "BundleManifest"
Cohesion: 0.21
...
### Community 714 - "MemoryDispatcher"
Cohesion: 0.21
...
### Community 716 - "ModelCapabilities"
Cohesion: 0.21
...
### Community 721 - "test_system_info.py"
Cohesion: 0.26
...
### Community 722 - "test_comfyui_scripts_shipped.py"
Cohesion: 0.17
...
### Community 723 - "useRuntimes.ts"
Cohesion: 0.07
Nodes (34): ADR-0022, parseImageRef(), RunnerState, RuntimeRow, SystemInfo, SystemInfoBackend, useRuntimes(), useSystemInfo() (+26 more)

### Community 724 - "`hal0-setup.yaml` — headless answer-file spec (2026-07-05)"
Cohesion: 0.18
...
### Community 725 - "Findings → fixes, by tier"
Cohesion: 0.18
...
### Community 726 - "Handoff: model-pipeline plan — finish-out pass"
Cohesion: 0.18
...
### Community 727 - "Hal0 Upstream Controls — Epic Plan (2026-07-06)"
Cohesion: 0.18
...
### Community 728 - "capabilities-and-profiles.mdx"
Cohesion: 0.18
...
### Community 729 - "Admin tools (`/mcp/admin`)"
Cohesion: 0.18
...
### Community 730 - "providers-profiles-devices.mdx"
Cohesion: 0.18
...
### Community 731 - "slot-lifecycle.mdx"
Cohesion: 0.18
...
### Community 732 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
...
### Community 733 - "Both-boxes deploy-validation runbook — rework-R4-stage"
Cohesion: 0.18
...
### Community 734 - "P3-brain — Implementation-Ready Spec: hal0-brain as a first-class module"
Cohesion: 0.18
...
### Community 735 - "PART D — Edit plan (files, order, delegators/shims)"
Cohesion: 0.18
...
### Community 736 - "hal0 Hermes Plugin Suite — BUILD Spec (verified vs code @ `rework/descar`)"
Cohesion: 0.18
...
### Community 737 - "Hermes Agent official integration research for the hal0 rework"
Cohesion: 0.18
...
### Community 738 - "2. Proposed hal0 plugin suite"
Cohesion: 0.18
...
### Community 739 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
Nodes (10): Board row = the machine-readable record, Checkpoint (R1–R5) → main, hal0 rework — board tracking protocol (paste-in prompt), Hard rules (never violate), Lifecycle of a lane (how a row moves), Migration-window lanes, Monitor, Reusable agent-dispatch prompt skeleton (+2 more)

### Community 740 - "_proxy_ws"
Cohesion: 0.25
...
### Community 748 - "test_hermes_provision_collect.py"
Cohesion: 0.25
...
### Community 749 - "test_config_model_roots.py"
Cohesion: 0.29
...
### Community 750 - "test_features_health.py"
Cohesion: 0.25
...
### Community 751 - "test_meta_enums.py"
Cohesion: 0.42
...
### Community 753 - "test_server_ab_helpers.py"
Cohesion: 0.22
...
### Community 754 - "test_serve_bind_host.py"
Cohesion: 0.31
...
### Community 755 - "test_fetch_scripts.py"
Cohesion: 0.18
...
### Community 756 - "hal0 test-harness — findings"
Cohesion: 0.18
...
### Community 759 - "test_npu_trio_reconcile.py"
Cohesion: 0.45
...
### Community 764 - "honcho-memory.mdx"
Cohesion: 0.20
...
### Community 765 - "7. Product-shaped reworks (from the six field notes)"
Cohesion: 0.20
...
### Community 766 - "FLAGS-own — llama.cpp flags stick to models; profiles become templates"
Cohesion: 0.20
...
### Community 767 - "hal0 SETTINGS rework — implementation-ready spec"
Cohesion: 0.20
...
### Community 768 - "Slot / Model / Profile / Flags / Image — reworked runtime model (R3)"
Cohesion: 0.20
...
### Community 769 - "Global Constraints"
Cohesion: 0.20
...
### Community 770 - "Dashboard Plugin JS Loading Internals"
Cohesion: 0.20
...
### Community 776 - "_list_workflow_names"
Cohesion: 0.22
...
### Community 780 - "GpuImageMode"
Cohesion: 0.19
Nodes (12): default_model_cache_check(), id_tokens(), leading_token_overlap(), looks_diffusion_or_nontext(), Any, Model-fallback heuristics — moved out of ``slots/manager.py`` (ML-2/ML-3, the P3, Split a model id / name / path into lower-case alphanumeric tokens.      ``gemma, Count of shared leading tokens between two token lists.      Used to rank fallba (+4 more)

### Community 781 - "logs.py"
Cohesion: 0.29
...
### Community 782 - "collect_port_claims"
Cohesion: 0.29
...
### Community 787 - "test_catalog_npu_stt.py"
Cohesion: 0.27
...
### Community 788 - "test_config_migrate.py"
Cohesion: 0.31
...
### Community 789 - "test_shared_auth.py"
Cohesion: 0.33
...
### Community 792 - "test_curated_pull_coords.py"
Cohesion: 0.18
...
### Community 794 - "buildBankSubgraphRoute"
Cohesion: 0.18
...
### Community 797 - "apply_capability"
Cohesion: 0.28
...
### Community 798 - "ROCmFPX bench — RESULTS + next-session handoff (2026-07-05)"
Cohesion: 0.22
...
### Community 800 - "connect-clients.mdx"
Cohesion: 0.22
...
### Community 801 - "connect-external-providers.mdx"
Cohesion: 0.22
...
### Community 802 - "realtime-voice.mdx"
Cohesion: 0.22
...
### Community 804 - "openai-compat.mdx"
Cohesion: 0.22
...
### Community 805 - "slot-as-model.mdx"
Cohesion: 0.22
...
### Community 806 - "env-vars.mdx"
Cohesion: 0.22
Nodes (8): Install & update, Memory & MCP, Models & providers, Paths, Runtime, See also, Server, Services

### Community 807 - "Handoff prompt — hal0-brain / template / profile changes on lxc105 (hal0, 10.0.1.142)"
Cohesion: 0.22
...
### Community 808 - "PART B — Target: Quadlet `.container` per slot (and per companion)"
Cohesion: 0.22
...
### Community 809 - "Dashboard plugin "Could not load this plugin's script""
Cohesion: 0.22
...
### Community 811 - "migrate_cognee_to_hindsight_dryrun"
Cohesion: 0.25
...
### Community 812 - "TestImageMismatch"
Cohesion: 0.33
...
### Community 813 - "TestLoopbackFenceCommand"
Cohesion: 0.33
...
### Community 816 - "test_hermes_stale_dropin_cleanup.py"
Cohesion: 0.47
...
### Community 817 - "isolated_client_with_root"
Cohesion: 0.33
...
### Community 818 - "test_catalog_flm_blacklist.py"
Cohesion: 0.28
...
### Community 819 - "test_config_show_edit_selector.py"
Cohesion: 0.50
...
### Community 820 - "test_slot_metrics_capacity.py"
Cohesion: 0.36
...
### Community 822 - "TestContainerRuntimeProbe"
Cohesion: 0.36
...
### Community 830 - "generate-images.mdx"
Cohesion: 0.25
...
### Community 831 - "update-and-rollback.mdx"
Cohesion: 0.25
...
### Community 832 - "voice-stt-tts.mdx"
Cohesion: 0.25
...
### Community 833 - "paths-and-files.mdx"
Cohesion: 0.25
...
### Community 834 - "13. Observability & metrics baseline (ships in every box)"
Cohesion: 0.25
...
### Community 835 - "15. Hermes plugin — standalone repo + native update path"
Cohesion: 0.25
...
### Community 836 - "PART C — Coordination contracts (cross-lane seams)"
Cohesion: 0.25
...
### Community 837 - "halo143 deploy-validation runbook — rework-R3"
Cohesion: 0.25
...
### Community 838 - "Podman on the hal0 slot substrate — findings & cleaner solutions"
Cohesion: 0.25
...
### Community 841 - "WorkspaceEscapeError"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 843 - "Strix Halo Benchmark Harness (hal0)"
Cohesion: 0.25
...
### Community 848 - "write_gateway_secrets_dropin"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 849 - "hermes_requirement_is_vetted"
Cohesion: 0.25
...
### Community 850 - "ToolNotPermittedError"
Cohesion: 0.22
...
### Community 851 - "_settings_apply.py"
Cohesion: 0.29
...
### Community 852 - "screen_extra_args_json"
Cohesion: 0.25
...
### Community 858 - "_BackendContract"
Cohesion: 0.25
...
### Community 861 - "test_transition_guard.py"
Cohesion: 0.25
...
### Community 862 - "useTweaksStore.ts"
Cohesion: 0.29
Nodes (5): APPEARANCE_KEYS, DEFAULTS, TweaksState, TweaksStore, useTweaksStore

### Community 863 - "board-chat-tool-use-v3.spec.ts"
Cohesion: 0.29
Nodes (3): GATED_FRAMES, mockChat(), sse()

### Community 864 - "Concurrency & continuous-batching optimization plan"
Cohesion: 0.29
...
### Community 865 - "ROCmFPX exploratory bench — RESULTS (2026-07-05)"
Cohesion: 0.29
...
### Community 871 - "P3-perms: declarative OwnershipStore as the single ownership authority"
Cohesion: 0.29
...
### Community 872 - "PART B — Target: OwnershipStore default `service_user="hal0"`"
Cohesion: 0.29
...
### Community 873 - "PART C — The LOAD-BEARING contract: born-owned"
Cohesion: 0.29
...
### Community 874 - "PART 0 — EXACT MAP (file:line)"
Cohesion: 0.29
...
### Community 875 - "P3-quadlet: migrate slot + companion units to Podman Quadlet `.container`"
Cohesion: 0.29
...
### Community 876 - "PART A — Current scars (in plain English)"
Cohesion: 0.29
...
### Community 877 - "4. Delivery plan and gates"
Cohesion: 0.29
...
### Community 881 - "Gateway connectivity quirks — hal0"
Cohesion: 0.29
...
### Community 882 - "get_hunyuan15.sh"
Cohesion: 0.43
Nodes (6): download_if_missing(), HF_HOME, HF_HUB_ENABLE_HF_TRANSFER, _require_hf(), get_hunyuan15.sh script, usage()

### Community 883 - "get_ltx2.sh"
Cohesion: 0.43
Nodes (6): download_if_missing(), HF_HOME, HF_HUB_ENABLE_HF_TRANSFER, _require_hf(), get_ltx2.sh script, usage()

### Community 884 - "get_wan22.sh"
Cohesion: 0.43
Nodes (6): download_if_missing(), HF_HOME, HF_HUB_ENABLE_HF_TRANSFER, _require_hf(), get_wan22.sh script, usage()

### Community 885 - "RuntimeError"
Cohesion: 0.29
Nodes (6): RuntimeError, Hal0SeamMissing, is_hal0_service_user(), SystemCtlSeam — the one narrow privileged seam hal0-api needs post-flip.  P3-per, Raised when the hal0-systemctl seam is required but not installed.      Distinct, True only when THIS process's euid is literally the ``hal0`` service     account

### Community 886 - "check_sunset.py"
Cohesion: 0.57
Nodes (6): current_version(), _fmt(), main(), overdue_markers(), _py_files(), scar_count()

### Community 887 - "deploy.sh"
Cohesion: 0.62
Nodes (6): die(), info(), reassert_group_share(), deploy.sh script, step(), warn()

### Community 888 - "hal0 on Proxmox VE"
Cohesion: 0.29
Nodes (6): Env-var overrides, hal0 on Proxmox VE, Interactive prompts, Quick start, Test plan, What the script does NOT do

### Community 889 - "hf_search"
Cohesion: 0.33
...
### Community 891 - "OrchestrationResult"
Cohesion: 0.29
...
### Community 892 - "resolve_chat_template"
Cohesion: 0.31
...
### Community 893 - "seed_chat_templates"
Cohesion: 0.38
...
### Community 895 - "_FakeSlotManager"
Cohesion: 0.38
...
### Community 896 - "test_config_hardware_probe.py"
Cohesion: 0.43
...
### Community 899 - "test_voice_roundtrip.py"
Cohesion: 0.43
...
### Community 900 - "10. Troubleshooting"
Cohesion: 0.29
...
### Community 901 - "test_owui_pin_consistency.py"
Cohesion: 0.43
...
### Community 918 - "24. Execution waves / rollout program (session 3, 2026-07-18)"
Cohesion: 0.33
...
### Community 920 - "Verification strategy"
Cohesion: 0.33
Nodes (6): Lifecycle and security, Live acceptance, Memory, Provider, Verification strategy, Voice

### Community 921 - "Dashboard permission mismatch (root vs hal0)"
Cohesion: 0.33
...
### Community 935 - "throughput_history"
Cohesion: 0.33
...
### Community 937 - "_guess_capability"
Cohesion: 0.33
...
### Community 940 - "samples_from_events"
Cohesion: 0.33
...
### Community 941 - "releases_url"
Cohesion: 0.17
Nodes (11): _is_newer(), Check for a newer version on the configured release channel.          Fetches th, Typed result of ``Updater.check()``.      Returned to the CLI / route layer so b, Return the release-manifest URL for ``channel``.      Resolution:       - ``HAL0, Parse a dotted version string into a sortable tuple.      Mirrors the route laye, Return True if PEP 440 version ``candidate`` is strictly newer than ``current``., ReleaseInfo, releases_url() (+3 more)

### Community 942 - "test_activity_instrumentation.py"
Cohesion: 0.60
...
### Community 945 - "test_services_comfyui.py"
Cohesion: 0.33
Nodes (3): TDD — Task 3.4: ComfyUI installer services step + repair.  Assertions:   (a) GET, Ensure comfyui repair returns 200, not 400 'unit not repairable'., test_comfyui_repair_not_blocked_by_unknown_unit_check()

### Community 946 - "cli-test.sh"
Cohesion: 0.60
Nodes (5): run_capabilities_migrate_dry_row(), run_doctor_row(), run_row(), run_update_check_row(), cli-test.sh script

### Community 948 - "test_now_iso.py"
Cohesion: 0.33
...
### Community 949 - "test_curation_drift.py"
Cohesion: 0.40
...
### Community 950 - "buildMemFactGraph"
Cohesion: 0.25
...
### Community 961 - "first-chat.mdx"
Cohesion: 0.40
Nodes (4): Beyond chat, Next, With curl, With OpenWebUI

### Community 962 - "setup.mdx"
Cohesion: 0.40
Nodes (4): Flags, Model suggestions, Next, The flow

### Community 963 - "let the content column fill the full pane width (page-scoped via head style)."
Cohesion: 0.40
...
### Community 964 - "14. Kanban board — ownership inversion + security hardening"
Cohesion: 0.40
...
### Community 965 - "16. Hermes Python library (`AIAgent`) for the brain — evaluated, rejected for core"
Cohesion: 0.40
...
### Community 966 - "21.A Mapping table — every candidate by disposition"
Cohesion: 0.40
...
### Community 967 - "8. SQLite adoption — setup plan"
Cohesion: 0.40
...
### Community 968 - "PART A — Current-state map (the scars, in plain English)"
Cohesion: 0.40
...
### Community 969 - "PART D — The one narrow privileged helper: `hal0-systemctl`"
Cohesion: 0.40
...
### Community 970 - "PART G — Sequencing: P3-perms BEFORE hermes-provision slim and P3-quadlet"
Cohesion: 0.40
...
### Community 971 - "PART 0 — Current-state map (the hand-rendered ExecStart scars, file:line)"
Cohesion: 0.40
...
### Community 985 - "TestRenderCancel"
Cohesion: 0.40
...
### Community 987 - "_fake_bundled_agent_manager"
Cohesion: 0.40
...
### Community 989 - "test_distro.sh"
Cohesion: 0.90
Nodes (4): bad(), ok(), test_distro.sh script, want()

### Community 991 - "MonkeyPatch"
Cohesion: 0.25
...
### Community 993 - "imagegen-v2.spec.ts"
Cohesion: 0.36
...
### Community 994 - "slot-card-container-v3.spec.ts"
Cohesion: 0.40
...
### Community 995 - "slot-edit-controls-v3.spec.ts"
Cohesion: 0.40
...
### Community 1012 - "PART E — `hal0-api` User flip + UMask removal"
Cohesion: 0.50
...
### Community 1013 - "PART F — Edit plan (files, order, delegators/shims)"
Cohesion: 0.50
...
### Community 1014 - "PART H — Risks + capped verification"
Cohesion: 0.50
...
### Community 1015 - "PART E — Migration of running units (the live-box transition)"
Cohesion: 0.50
...
### Community 1016 - "PART F — Risks + capped verification"
Cohesion: 0.50
...
### Community 1032 - "_delegate_fakes.py"
Cohesion: 0.50
...
### Community 1033 - "test_comfyui_path.py"
Cohesion: 0.50
...
### Community 1040 - "[0.9.4] — 2026-07-08"
Cohesion: 0.29
Nodes (4): Shared types for the hal0 Hermes transport., _install_stub(), Test fixtures for the hal0.mcp package.  The MCP server modules (:mod:`hal0.mcp., Insert a minimal ``mcp.server.fastmcp`` stub into sys.modules.      Installed at

### Community 1041 - "[v0.8.5b2] — 2026-07-04"
Cohesion: 0.43
Nodes (3): parse_json_object(), Best-effort JSON object parse. Returns None on any failure/non-dict., TestParseJsonObject

### Community 1042 - "[v0.8.0-beta.3] — 2026-06-23"
Cohesion: 0.67
Nodes (3): Breaking, Changed, [v0.8.0-beta.3] — 2026-06-23

### Community 1043 - "[v0.8.2b2] — 2026-06-24"
Cohesion: 0.67
Nodes (3): Changed, Fixed, [v0.8.2b2] — 2026-06-24

### Community 1059 - "_OtherEngineProvider"
Cohesion: 0.67
...
### Community 1067 - "diagnostics-panel-v3.spec.ts"
Cohesion: 0.38
Nodes (6): _from_container(), list_models(), Any, FLM (NPU) catalog probe for the slot drawer's model dropdowns.  Extracted from `, Probe the running FLM container's ``flm list`` (authoritative source).      Retu, Return the full FLM catalog for the drawer's NPU model dropdowns.      Container

### Community 1070 - "settings-v3.spec.ts"
Cohesion: 0.33
Nodes (3): _FakeResponse, Any, Minimal stand-in for the object urlopen's context manager yields.

### Community 1071 - "slots-wireup-v3.spec.ts"
Cohesion: 0.33
...
### Community 1146 - "test_sanitise_id_blocks_path_traversal"
Cohesion: 0.29
Nodes (7): buildBackends(), buildHardware(), buildModels(), buildNpuOccupancy(), buildSlots(), buildStatus(), data()

### Community 1206 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 1207 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 1208 - "PermRow"
Cohesion: 0.33
...
### Community 1209 - "test_dispatch_stt_raises_when_no_container_npu_slot"
Cohesion: 0.33
Nodes (6): npu slot without profile + without runtime=container → None., A non-container npu slot is NOT a trio backend — dispatch refuses., SlotManager mock for an npu slot that is NOT containerized., _slot_manager_with_noncontainer_npu(), test_dispatch_stt_raises_when_no_container_npu_slot(), test_noncontainer_npu_resolves_none()

### Community 1210 - "test_route_sync.py"
Cohesion: 0.40
Nodes (4): _live_routes(), Route-sync check: every REST target in ``hal0.mcp.admin._REST_MAP`` must resolve, (HTTP method, path template) pairs the live app registers., test_rest_map_targets_resolve_to_live_routes()

### Community 1211 - "Security Policy"
Cohesion: 0.40
Nodes (4): Reporting a Vulnerability, Security Policy, Supported Versions, What to Expect

### Community 1212 - "is_container_npu_cfg"
Cohesion: 0.40
...
### Community 1214 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1215 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1216 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1217 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1218 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1219 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1220 - "Roadmap"
Cohesion: 0.50
Nodes (4): Exploring (v1.x +), Roadmap, Shipped (v0.9 / public beta), Soon

### Community 1221 - "bench_commands.py"
Cohesion: 0.50
Nodes (3): bench(), Context, `hal0 bench` — benchmarking CLI (design §5), thin mount over hal0.bench.cli.  Th

### Community 1222 - "[0.9.2] — 2026-07-05"
Cohesion: 0.67
Nodes (3): [0.9.2] — 2026-07-05, Fixed, Highlights

### Community 1223 - "[0.9.4.1] — 2026-07-08"
Cohesion: 0.67
Nodes (3): [0.9.4.1] — 2026-07-08, Changed, Docs

## Knowledge Gaps
- **2894 isolated node(s):** `rocmfpx-build.sh script`, `rocmfpx-env.sh script`, `rocmfpx-pipeline.sh script`, `rocmfpx-quantize.sh script`, `check-service-env.sh script` (+2889 more)
...
- **Why does `create_app()` connect `create_app` to `EventBus`, `lifespan`, `test_settings_models_store.py`, `TestClient`, `test_models_preview.py`, `test_chat_proxy.py`, `test_chat_templates.py`, `Path`, `test_tts_request_defaults.py`, `conftest.py`, `conftest.py`, `ApprovalQueue`, `TestClient`, `test_slots_image_pull.py`, `test_auth_rotate.py`, `test_kb1_hardening_tail.py`, `MemoryConfig`, `test_mcp_transport_security.py`, `isolated_client_with_root`, `conftest.py`, `test_chat_proxy_auth.py`, `test_comfyui_fetch_route.py`, `_StubSlotManager`, `auth.py`, `test_route_sync.py`, `test_typed_errors.py`, `test_v1_npu_trio_routing.py`, `test_models_crud.py`, `test_updater_routes.py`, `test_models_default.py`, `test_event_contract.py`, `service_identity.py`, `MemoryDispatcher`, `test_exposure.py`, `test_installer_routes.py`, `FakeWsServer`, `test_v1_chat_slot_alias.py`, `test_slots_container_state.py`, `TestClient`, `_RecordingSlotManager`, `test_v1_slot_alias_models.py`, `test_redact.py`, `test_pull_routes.py`, `test_route_collisions.py`, `test_hf_routes.py`, `test_memory_admin_routes.py`, `test_slots_policy.py`, `test_stacks_routes.py`, `Hal0Config`, `test_dashboard_layout.py`, `test_models_add_from_path.py`, `test_auth_core.py`, `test_config_model_roots.py`, `test_profiles_crud.py`, `test_settings_routes.py`, `test_slots_npu_fields.py`, `Path`, `test_slots_routes.py`, `test_models_routes.py`, `seed_chat_templates`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `lifespan()` connect `lifespan` to `EventBus`, `hermes_provision.py`, `PortAuthority`, `FakeUpstreamRegistry`, `Model`, `test_probe.py`, `CapabilitySelection`, `Dispatcher`, `create_app`, `model-modals.jsx`, `OmniRouter`, `HardwareStats`, `SlotIdentityStore`, `Persona`, `paths.py`, `MemoryProvider`, `AuditStore`, `_Recorder`, `NpuTrioRouter`, `MetricsService`, `Hal0Config`, `seed_static_slots`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `SlotManager` connect `SlotManager` to `EventBus`, `Slot`, `RoutingHost`, `_write_slot`, `NpuExclusivityViolation`, `heal_missing_llm_type`, `test_model_fallback.py`, `SlotState`, `GpuArbiter`, `test_adopted_slot_eviction.py`, `v1.py`, `test_slot_aliases.py`, `CapabilityOrchestrator`, `rerender_slot_units`, `SlotIdentityStore`, `agents-overview.jsx`, `test_model_preferred_profile.py`, `get_runner`, `test_npu_trio_shadow.py`, `Path`, `test_manager_npu_container.py`, `test_pulling_serving_idle.py`, `compute_config_drift`, `manager.py`, `test_flm_container_spec.py`, `test_transition_guard.py`, `SlotReaper`, `SlotInterface`, `_write_slot`, `test_mtp_defuse.py`, `test_npu_trio_reconcile.py`, `test_gpu_arbiter.py`?**
  _High betweenness centrality (0.070) - this node is a cross-community bridge._
- **Are the 177 inferred relationships involving `SlotManager` (e.g. with `_build_offline_deps()` and `FLMProvider`) actually correct?**
  _`SlotManager` has 177 INFERRED edges - model-reasoned connections that need verification._
- **Are the 108 inferred relationships involving `connect()` (e.g. with `.__init__()` and `._read()`) actually correct?**
  _`connect()` has 108 INFERRED edges - model-reasoned connections that need verification._
- **Are the 76 inferred relationships involving `ContainerProvider` (e.g. with `HealthCheck` and `Mount`) actually correct?**
  _`ContainerProvider` has 76 INFERRED edges - model-reasoned connections that need verification._
- **What connects `rocmfpx-build.sh script`, `rocmfpx-env.sh script`, `rocmfpx-pipeline.sh script` to the rest of the system?**
