# Graph Report - registry-store-rows  (2026-07-30)

## Corpus Check
- 1605 files · ~2,025,439 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29035 nodes · 55094 edges · 1341 communities (1210 shown, 131 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 6721 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `34445a25`
...
- .handler
- test_config_accessor_defaults_when_absent
...
5. `create_app()` - 119 edges
6. `BadRequest` - 117 edges
7. `BoardStore` - 114 edges
8. `ContainerProvider` - 114 edges
9. `SlotState` - 111 edges
10. `apiGet()` - 103 edges
...
## Communities (1341 total, 131 thin omitted)
...
Cohesion: 0.03
Nodes (166): _current_symlink(), _parse_manifest(), Return ``<usr_lib>/hal0-<version>/`` — where this release's tree lives., Return ``<usr_lib>/current`` — the atomic-swap target., Release manifest is missing required fields or has the wrong shape., Atomic self-update with cosign-verified releases and one-step rollback.      All, Initialise the updater.          Args:             channel: Release channel — "s, Validate ``raw`` against ReleaseManifest, raising UpdateManifestInvalid. (+158 more)
...
Cohesion: 0.03
Nodes (117): ADR-0022, useModels(), usePullJob(), deviceBackend(), DEFAULT_METRICS, fetchSlotsUnion(), FlagProvenance, IMAGE_PULL_TERMINAL (+109 more)

### Community 4 - "Slot"
Cohesion: 0.03
Nodes (74): flm_id_to_tag(), Resolve a hal0 ``<tag>-FLM`` id back to FLM's native ``family:size`` tag.      I, _cfg_port(), _cfg_provider(), _cfg_to_dict(), _model_default(), Any, Tiny leaf-level slot-config accessors shared across the slots subtree.  These fo (+66 more)
...
### Community 8 - "test_memory_hindsight_plugin.py"
Cohesion: 0.02
...
### Community 9 - "die"
Cohesion: 0.04
Nodes (102): agent_install(), agent_peers(), approvals_approve(), approvals_deny(), _ensure_hermes_writable_or_die(), _install_hermes(), Approve a pending agent action., Deny a pending agent action. (+94 more)

### Community 10 - "useModels.ts"
Cohesion: 0.04
Nodes (90): ConfigUrls, useConfigUrls(), useMemoryEnabled(), AddFromPathRequest, fmtBytes(), fmtEta(), fmtSpeed(), HfSearchResponse (+82 more)

### Community 11 - "primitives.jsx"
Cohesion: 0.03
Nodes (79): COMFYUI_FALLBACK, ComfyuiArbiter, ComfyuiEngineState, ComfyuiMemory, ComfyuiMode, ComfyuiStatus, ComfyuiSwitchover, ComfyuiV2PaneData (+71 more)

### Community 12 - "ENDPOINTS"
Cohesion: 0.04
Nodes (93): apiDelete(), apiGet(), ApiOptions, apiPut(), serialiseBody(), ENDPOINTS, Backend, NOTE: there is no useBackendInstall — the backend exposes no generic (+85 more)

### Community 13 - "SettingsShell.jsx"
Cohesion: 0.05
Nodes (80): useBackends(), CapabilitiesBag, CapabilityRow, useCapabilities(), useCapabilityApply(), useCapabilityPatch(), useServiceRepair(), APPLY_PLAN_KEY (+72 more)

### Community 14 - "ConfigParseError"
Cohesion: 0.04
Nodes (79): Set the update channel.      Body::          {"channel": "stable"}   # or "previ, set_channel(), config_validate(), Validate all config files against the current schema., ConfigError, ConfigNotFound, ConfigParseError, list_agent_configs() (+71 more)

### Community 15 - "updater.py"
Cohesion: 0.04
...
### Community 16 - "SlotConfigError"
Cohesion: 0.04
Nodes (71): The model registry could not be consulted (outage, not a miss).      Raised by t, RegistryUnavailableError, admit(), CandidateSlot, _estimate_incoming_footprint_mb(), EvictionStep, _gather_candidates(), PreloadEvictHost (+63 more)

### Community 17 - "model-modals.jsx"
Cohesion: 0.05
Nodes (82): ChatTemplate, useChatTemplates(), useMeta(), useMetaEnums(), useAddModelFromPath(), useModelDuplicate(), useModelInspect(), useModelSetDefault() (+74 more)

### Community 18 - "HardwareInfo"
Cohesion: 0.04
Nodes (90): _background_revalidate(), _cached_snapshot(), _clear_in_flight(), _flatten_for_ui(), get_hardware(), _gpu_sample(), _local_image_repos(), _local_live_stats() (+82 more)

### Community 19 - "FLMProvider"
Cohesion: 0.04
...
### Community 20 - "test_registry_import.py"
Cohesion: 0.05
...
### Community 21 - "connect"
Cohesion: 0.05
Nodes (51): Path, connect(), db_path(), Connection, Path, SQLite connection + transaction helpers — the hal0 ``db/`` foundation.  One conn, Wrap a write in an explicit ``BEGIN IMMEDIATE`` … ``COMMIT``/``ROLLBACK``., Return the default hal0 SQLite database path.      Thin wrapper over :func:`hal0 (+43 more)

### Community 22 - "SqliteModelRegistry"
Cohesion: 0.04
...
### Community 25 - "StackConfig"
Cohesion: 0.06
Nodes (46): One ``[stack.<slug>]`` entry in stacks.toml.      A curated bundle of slots + em, StackConfig, Pre-apply sanity check: flag entries whose profile/model won't resolve., StackCapabilityRow, TestStackConfig, FakeSnap, _no_seed_stacks(), MonkeyPatch (+38 more)
...
### Community 33 - "test_hermes_provision.py"
Cohesion: 0.03
...
### Community 36 - "Model"
Cohesion: 0.05
Nodes (72): NamedTuple, FileSetEntry, FileSetPlan, One file of a planned file-set, ready for ``model_file`` insertion., The full set of files one model pull should download + register., Model, A model entry in the hal0 registry.      All fields are optional at construction, _dir_size() (+64 more)

### Community 37 - "test_orchestrate.py"
Cohesion: 0.05
...
### Community 51 - "errors.py"
Cohesion: 0.04
Nodes (66): RequestValidationError, activate_agent_persona(), get_agent_persona(), list_agent_personas(), _persona_detail(), _persona_summary(), PersonaUpdateBody, Any (+58 more)
...
### Community 53 - "ProfileCatalog"
Cohesion: 0.05
Nodes (52): RuntimeFamily, SlotType, create_profile(), delete_profile(), export_profile(), get_profile(), list_profiles(), ProfileBody (+44 more)

### Community 54 - "embed_references"
Cohesion: 0.06
Nodes (50): _checksum(), embed_references(), export_envelope(), import_stack(), ModelResolution, parse_envelope(), Any, ModelRegistry (+42 more)

### Community 55 - "slots.py"
Cohesion: 0.06
...
### Community 62 - "connections.jsx"
Cohesion: 0.06
Nodes (59): Hal0Error, _fetchServers(), McpServer, McpServerActivity, McpServerState, McpTool, MOCK_SERVERS, useMcpServers() (+51 more)

### Community 63 - "__init__.py"
Cohesion: 0.06
Nodes (66): AbstractEventLoop, _auto_resume_interrupted_pulls(), _boot_audit_store(), _boot_background_tasks(), _boot_brain_lane(), _boot_capabilities(), _boot_dispatcher(), _boot_mcp_memory_call() (+58 more)

### Community 64 - "Upstream"
Cohesion: 0.04
...
### Community 65 - "BadRequest"
Cohesion: 0.04
Nodes (46): import_profile_route(), Import a profile from an uploaded ``.hal0profile.json`` envelope.      Body::, BadRequest, 400 — the request was syntactically or semantically invalid.      Use this for c, Reject ``raw`` when a bare double-quoted JSON value was eaten by the shell., Validate the launch-affecting fields of a model create/update/validate body., screen_extra_args_json(), screen_model_write() (+38 more)
...
### Community 69 - "test_models_routes.py"
Cohesion: 0.06
...
### Community 70 - "RuntimeLaunchPlan"
Cohesion: 0.05
...
### Community 72 - "StackApplyEngine"
Cohesion: 0.06
Nodes (36): Any, Path, StackSlotEntry, Reconcile a StackConfig onto slot TOMLs as one ChangeSet., Project a stack slot entry onto the existing slot TOML dict.          Builds the, Commit ``plan.change_set`` to disk atomically.          Delegates to ``SlotConfi, The slot→after-dict projection a plan would write (keyed by slot name)., The slot→current-disk-dict projection for a stack's primary slots. (+28 more)

### Community 73 - "FakeSlotManager"
Cohesion: 0.06
...
### Community 77 - "SlotState"
Cohesion: 0.05
Nodes (41): ModelCacheCheck, PullRunner, container_provider(), Return the process-wide ContainerProvider singleton., ImagePullJob, inspect_image_state(), Any, Container-image pull orchestration for slots (extracted from routes/slots.py). (+33 more)

### Community 78 - "test_memory.py"
Cohesion: 0.07
...
### Community 83 - "v1.py"
Cohesion: 0.09
Nodes (58): DispatcherDep, _aggregate_models(), audio_speech(), audio_transcriptions(), chat_completions(), completions(), _dispatch_and_forward(), _dispatch_via_npu_trio() (+50 more)

### Community 84 - "paths.py"
Cohesion: 0.06
Nodes (57): activity_db(), agent_workspace_dir(), agents_config_dir(), bundle_chosen_marker(), _covers(), db_path(), default_flm_models_dir(), etc() (+49 more)

### Community 85 - "test_profiles_crud.py"
Cohesion: 0.05
...
### Community 86 - "ModelRegistry"
Cohesion: 0.07
Nodes (27): _model(), LogCaptureFixture, ModelRegistry, MonkeyPatch, Path, Unit tests for hal0.registry.store.ModelRegistry.  Covers:   * CRUD round-trips, Tier 1: parse failure logs a warning but doesn't blank the cache., N threads each add a unique model; final file has all of them. (+19 more)

### Community 87 - ".uninstall"
Cohesion: 0.06
...
### Community 90 - "hermes_provision.py"
Cohesion: 0.06
...
### Community 95 - "test_argv.py"
Cohesion: 0.06
Nodes (54): _canon(), _dedup(), _deny_managed_flags(), FlagProvenance, _is_flag(), normalize_argv(), NormalizedArgv, _Pair (+46 more)

### Community 96 - "test_board_chat.py"
Cohesion: 0.16
...
### Community 97 - "test_profile_derive.py"
Cohesion: 0.06
...
### Community 103 - "models_service.py"
Cohesion: 0.07
Nodes (54): Model ids referenced by any configured slot or any stack.      Union of: each sl, referenced_model_ids(), add_from_path(), auto_scan_and_register(), cascade_delete_model(), clear_slot_default(), comfyui_category(), commit_scan_rows() (+46 more)
...
### Community 105 - "test_providers_routes.py"
Cohesion: 0.10
...
### Community 108 - "HindsightProvider"
Cohesion: 0.07
Nodes (27): _agent_of(), HindsightProvider, _http_status(), namespace_to_bank(), _now(), _projects_of(), Any, Exception (+19 more)
...
### Community 111 - "test"
Cohesion: 0.04
Nodes (15): test, MOBILE, CURATED, ROWS, UPSTREAM_ROW, NO_UPDATE, A, B (+7 more)
...
### Community 114 - "resolve_profile_flags"
Cohesion: 0.09
Nodes (28): Return the full flag string for *profile*, expanding MTP when set.      When the, resolve_profile_flags(), _exec_line(), _moe_profile(), _mtp_profile(), Return the ``Exec=`` value (the in-container argv) from Quadlet unit text., §7.1a / ML-5: profile.mtp is informational only now — the caller         must pa, profile.mtp=True with NO explicit override no longer expands the         bundle (+20 more)
...
Cohesion: 0.05
Nodes (50): agent_list(), agent_log(), _agent_provision_state_file(), agent_reprovision(), agent_status(), agent_uninstall(), agent_upgrade(), _approval_summary() (+42 more)

### Community 123 - "pull_jobs.py"
Cohesion: 0.07
...
### Community 125 - "test_auth_core.py"
Cohesion: 0.07
...
### Community 129 - "build_auto_selections"
Cohesion: 0.07
...
### Community 130 - "migrate_slot_toml"
Cohesion: 0.07
...
### Community 138 - "test_comfyui_proxy.py"
Cohesion: 0.15
...
### Community 143 - "create_app"
Cohesion: 0.09
Nodes (43): create_app(), Lifespan wiring for the GpuArbiter idle-restore loop (Phase D, Task D6).  The ap, test_lifespan_starts_and_cancels_arbiter_idle_loop(), Cutover: app.state exposes memory_provider (P2)., test_app_state_has_memory_provider(), test_health_memory_enabled_reads_provider(), app(), client() (+35 more)
...
### Community 145 - "schema.py"
Cohesion: 0.04
Nodes (32): ActivityConfig, AgentConfig, NpuConfig, Pydantic v2 schema models for hal0 configuration.  All TOML files under /etc/hal, # NOTE: ``map_backend_to_device`` now lives in ``hal0.model_meta`` (imported, One (slot, child) capability selection carried by a stack slot entry.      Mirro, One slot's contribution to a stack: which model/profile/caps it carries.      Re, Optional [upstream.model_filters] table — curates /v1/models advertising.      A (+24 more)
...
### Community 147 - "container.py"
Cohesion: 0.06
Nodes (43): _best_effort_model_info(), _binary_runner(), _effective_backend_and_device_class(), _effective_parallel(), _effective_runner(), _native_ctx(), _profile_runtime_family(), Any (+35 more)
...
### Community 149 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.04
...
### Community 153 - "TestUpstreamEntry"
Cohesion: 0.05
...
### Community 155 - "Qwen3TTSProvider"
Cohesion: 0.07
...
### Community 157 - "AgentMetadataConfig"
Cohesion: 0.06
...
### Community 158 - "Path"
Cohesion: 0.07
Nodes (44): _comfyui_models_dir(), _final_path(), _final_path_for_entry(), pull_job_file(), _pull_jobs_dir(), _pull_root(), Path, Strip path-unsafe characters from a model id.      The id is used as a directory (+36 more)
...
### Community 161 - "Enum"
Cohesion: 0.07
Nodes (42): Enum, auth_require(), auth_rotate(), auth_status(), KeyTier, hal0 auth subcommands — thin HTTP client to /api/auth/*.  §5.2 of the R5 sync as, Persist the [security].require_auth posture (PUT /api/auth/require)., Show the current auth posture (GET /api/auth/status). (+34 more)

### Community 162 - "MemoryProvider"
Cohesion: 0.06
Nodes (27): AddResult, DeleteResult, GraphStatus, ListPage, MemoryItem, MemoryProvider, Mode, Any (+19 more)

### Community 163 - "test_model_fallback.py"
Cohesion: 0.10
...
### Community 164 - "test_chat_normalization.py"
Cohesion: 0.07
...
### Community 166 - "doctor_commands.py"
Cohesion: 0.08
...
### Community 167 - "CapabilitySelection"
Cohesion: 0.07
Nodes (28): Fire-and-forget trigger to refresh the Hermes live-context files.  Called from t, Spawn a detached ``hal0-agent <agent_id> render-context``. Never raises., spawn_context_refresh(), CapabilitySelection, One operator-facing selection for a (slot, child) tuple.      Mirrors the dashbo, CapabilityApplyFailed, child_to_slot(), legal_children() (+20 more)
...
### Community 169 - "api_get"
Cohesion: 0.08
Nodes (40): doctor_models(), Audit the model pipeline: registry paths, store/roots agreement, FLM dir.      C, bank_consolidate_cmd(), bank_delete_cmd(), bank_export_cmd(), bank_import_cmd(), bank_list_cmd(), bank_stats_cmd() (+32 more)

### Community 170 - "slot_instance_token"
Cohesion: 0.07
Nodes (30): CompletedProcess, Path, The systemd **service** name for a slot (``systemctl`` verbs target it)., The Quadlet ``.container`` source file this slot's unit is written to., Run a subprocess synchronously (load/unload are blocking ops anyway).          P, Write the Quadlet ``.container`` file, daemon-reload, start.          The Quadle, Render the desired Quadlet ``.container`` text for a slot — the ONE renderer., Write systemd unit, daemon-reload, enable, start (synchronous).          Called (+22 more)
...
### Community 172 - "Hal0MemoryProvider"
Cohesion: 0.08
...
### Community 190 - "test_hermes_provision_mcp_auth.py"
Cohesion: 0.10
...
### Community 191 - "TestClient"
Cohesion: 0.07
Nodes (40): Path, TestClient, Regression: the slot-edit Save's ``PATCH /defaults`` must not wipe the     model, #585: the dashboard writes ``ctx_size``; it must persist as the canonical     ``, When the NPU LLM anchor has a model bound, every trio slot gets coresident_group, GET /api/slots/{name} is enriched same shape as the list endpoint., #863: single-slot status includes argv drift without burdening list()., A failing container health probe doesn't break /api/slots.      The enrichment s (+32 more)
...
### Community 193 - "test_container.py"
Cohesion: 0.10
...
### Community 195 - "test_slot_aliases.py"
Cohesion: 0.05
...
### Community 204 - "StackChangePlan"
Cohesion: 0.08
Nodes (36): NpuExclusivityViolation, Two ``device=npu, type=llm, enabled=true`` slots cannot coexist.      The AMDXDN, ConvergeReport, StackApplyEngine — translate a StackConfig into an atomic slot-config change.  P, What converge() did, per slot. Failures are recorded, not raised., Compute the post-state for ``stack``. Writes NOTHING.          Only entries that, Read a TOML file as a raw dict; ``None`` when it doesn't exist.      Local mirro, The compute-only result of planning a stack apply.      ``change_set`` is consum (+28 more)

### Community 205 - "test_chat_proxy_auth.py"
Cohesion: 0.07
...
### Community 207 - "json"
Cohesion: 0.06
Nodes (15): json(), AuthOpts, installAuth(), LIVE_BOARD, HERMES_ACTORS, MOCK_MCP_SERVERS, routeHistory(), comfyV2Empty() (+7 more)

### Community 208 - "write_toml_atomic"
Cohesion: 0.09
Nodes (23): OSError, _find_manifest_path(), _flatten_slot_toml(), load_manifest(), manifest_image_ref(), Any, Normalise both slot-TOML shapes into the flat SlotConfig shape.      Two on-disk, Inverse of _flatten_slot_toml — produce the on-disk shape.      Writes only ``de (+15 more)

### Community 209 - "tui.py"
Cohesion: 0.08
...
### Community 210 - "test_doctor_json_diagnoses.py"
Cohesion: 0.09
...
### Community 215 - "test_typed_errors.py"
Cohesion: 0.10
...
### Community 217 - "BaseModel"
Cohesion: 0.09
Nodes (36): BaseModel, PersonaApprovalUpdate, Partial ``[persona.approval]`` patch. Omitted fields are unchanged., _client_ip(), exposure(), ExposureAllowlistEntry, ExposureResponse, ExposureRule (+28 more)
...
### Community 219 - "test_v1_chat_slot_alias.py"
Cohesion: 0.12
...
### Community 221 - "load_profiles_config"
Cohesion: 0.11
Nodes (17): load_profiles_config(), Load and validate /etc/hal0/profiles.toml.      Returns a :class:`ProfilesConfig, Path, Absent file → seed defaults; no fixture needed., Non-MTP profiles stay False; MTP-capable family profiles are True., Canonical GPU seeds do not pin a backend or runner image., spec-hw-slot-ownership §3: ``image`` is optional/inert now — a profile         w, extra='forbid' on ProfileConfig: typos in profile keys raise at load. (+9 more)

### Community 222 - "ProfileConfig"
Cohesion: 0.08
Nodes (16): ProfileConfig, One ``[profile.<name>]`` entry in profiles.toml.      A profile is a reusable ba, Unit tests for the profile catalog — schema, loader, and flag resolver.  Targete, §7.1a / ML-5: profile.mtp is informational only — resolve_profile_flags, profile.mtp=True alone (no explicit mtp_override) no longer         expands the, A profile that pins its own --spec-draft-* values keeps them; the MTP         bu, MTP_FLAG_BUNDLE constant is verbatim in the resolved string., Per spec §4.1: device_class defaults to None (device-agnostic). (+8 more)

### Community 223 - "admin.py"
Cohesion: 0.09
Nodes (33): _audit(), build_server(), _call_rest(), dispatch(), _execute_tool(), _format_url(), is_gated(), _matches() (+25 more)
...
### Community 238 - "hw_slot_ownership.py"
Cohesion: 0.10
...
### Community 240 - "test_route_to_chat.py"
Cohesion: 0.09
...
### Community 242 - "_resolve_image_ref"
Cohesion: 0.10
...
### Community 243 - "test_update_check.py"
Cohesion: 0.09
...
### Community 245 - "test_installer_routes.py"
Cohesion: 0.09
...
### Community 251 - "Hal0HermesClient"
Cohesion: 0.11
...
### Community 256 - "Hal0MemoryClient"
Cohesion: 0.09
...
### Community 258 - "test_upstream_dedup.py"
Cohesion: 0.10
...
### Community 260 - "test_agent_uninstall_memory.py"
Cohesion: 0.12
...
### Community 262 - "PgVectorProvider"
Cohesion: 0.08
...
### Community 277 - "resolve_bench_devices"
Cohesion: 0.13
...
### Community 278 - "test_tts_capability_switch.py"
Cohesion: 0.07
...
### Community 282 - "LlamaServerProvider"
Cohesion: 0.08
...
### Community 283 - "test_memory_admin_routes.py"
Cohesion: 0.17
...
### Community 284 - "test_brain_injection.py"
Cohesion: 0.17
...
### Community 285 - "test_crash_loop_breaker.py"
Cohesion: 0.15
...
### Community 290 - "secrets.py"
Cohesion: 0.11
Nodes (31): _api_env(), delete_secret(), _emit(), list_secrets(), Any, Path, Request, Response (+23 more)

### Community 291 - "BrainChatConfig"
Cohesion: 0.09
Nodes (18): BrainChatConfig, ``[brain_chat]`` — the dashboard's agent-chat steward (hal0-brain).      Guardra, _drive(), _FakeKanban, Any, Pre-flight context guard: a prompt over the resolved slot's context window emits, _RecordingLLM, _request() (+10 more)

### Community 292 - "SlotLoading"
Cohesion: 0.11
...
### Community 293 - "test_brain_resilience.py"
Cohesion: 0.16
...
### Community 294 - "test_admin_route_map_nested.py"
Cohesion: 0.09
...
### Community 295 - "mockFixtures.ts"
Cohesion: 0.06
Nodes (15): BIG_HUBS, BIG_LINK_TYPES, BIG_TOPICS, buildCapabilities(), Builder, capabilityRow(), MEM_ENTITIES, MEM_TOPIC_COLORS (+7 more)

### Community 296 - "test_exposure.py"
Cohesion: 0.09
...
### Community 302 - "import_toml_to_sqlite"
Cohesion: 0.12
...
Cohesion: 0.11
Nodes (29): board_move(), Move a task to a different lane (PATCH /api/board/tasks/{id})., Uninstall a user-installed MCP server. Bundled servers reject 409., uninstall_cmd(), _api_reachable(), api_delete(), api_get_bytes(), api_patch() (+21 more)
...
### Community 311 - "_spec_provider_for"
Cohesion: 0.10
...
### Community 312 - "test_agents_personas.py"
Cohesion: 0.15
...
### Community 320 - "_slot"
Cohesion: 0.17
Nodes (13): _agg(), FakeSlotManager, no_mem(), Any, MonkeyPatch, Slot, Unit tests for hal0.slot_view — SlotViewAggregator + per-concern functions.  Iss, Stub out the capacity probe so snapshot() never touches systemd. (+5 more)

### Community 321 - "FakeContainerProvider"
Cohesion: 0.08
...
### Community 324 - "SingleFlightGroup"
Cohesion: 0.08
...
### Community 325 - "P3-slots: Decomposition Spec for `slots/manager.py`"
Cohesion: 0.07
...
### Community 326 - "hal0_slot_alias_models"
Cohesion: 0.12
...
### Community 328 - "test_diagnosis.py"
Cohesion: 0.09
...
### Community 330 - "MetricsService"
Cohesion: 0.08
Nodes (16): MetricsAggregator, Path, Background task: aggregate the most recently completed hour, on interval., Aggregate the last fully-elapsed hour. Returns rows written., load_metrics_settings(), MetricsSettings, Metrics configuration -- a standalone reader, not part of ``Hal0Config``.  ``con, Operator-tunable knobs for the OBS-1 metrics core.      Every field has a shippe (+8 more)

### Community 331 - "resolve_chain"
Cohesion: 0.13
...
### Community 332 - "test_hal0_memory_client.py"
Cohesion: 0.10
...
### Community 333 - "test_config_urls.py"
Cohesion: 0.10
...
### Community 335 - "activity-log.spec.ts"
Cohesion: 0.10
Nodes (20): emitSse(), emitSseTyped(), installSseHarness(), waitForSse(), emitAndAwait(), ERR_REC, frame(), OK_REC (+12 more)

### Community 336 - "Tier 2 — medium (one PR each)"
Cohesion: 0.07
...
### Community 337 - "PART 0 — Current registry, mapped (file:line)"
Cohesion: 0.07
...
### Community 338 - "bootstrap.sh"
Cohesion: 0.17
Nodes (20): banner(), cosign_verify(), die(), ensure_cosign(), err(), fetch_and_hash_check(), fetch_manifest(), fetch_sidecar() (+12 more)

### Community 339 - "evaluate_model_fit"
Cohesion: 0.12
Nodes (21): Reject the merged selection if it's illegal against the catalog.          Two di, evaluate_model_fit(), ModelFit, Any, ModelFit — contextual model/slot/device/profile compatibility.  ``model_meta`` o, Compatibility verdict for one model candidate., Return whether a model can run in a slot/device/profile context.      The result, FakeSlotManager (+13 more)
...
### Community 345 - "test_v1_audio.py"
Cohesion: 0.13
...
### Community 346 - "_container_npu_cfg"
Cohesion: 0.10
...
### Community 347 - "test_pressure_eviction.py"
Cohesion: 0.20
...
### Community 349 - "Recommended hal0 ideas"
Cohesion: 0.07
...
### Community 350 - "hal0 Hermes Integration Suite Implementation Plan"
Cohesion: 0.07
...
### Community 355 - "test_discover.py"
Cohesion: 0.13
...
### Community 356 - "scan_and_register"
Cohesion: 0.11
...
### Community 362 - "_seed_slot_toml"
Cohesion: 0.07
Nodes (27): npu_trio_slot_root(), coresident_group must key off device==npu, not the legacy slot names.      Deplo, Lay down the NPU FLM trio (agent + stt-npu + embed-npu) on disk., A model-less NPU LLM anchor → no trio markers on the siblings (#1369).      This, A slot's [model].n_gpu_layers rides along in the payload., spec-hw-slot-ownership §1: a stray slot-level ``enable_thinking`` (pre-     migr, PUT /api/slots/{name}/config with model.rope_freq_base persists the value     an, A slot carries declared_backend (normalized token) derived from its     configur (+19 more)

### Community 363 - "test_stats_requests_route.py"
Cohesion: 0.13
Nodes (21): app(), _build_app(), client(), _FakeDispatcher, _FakeMetricsService, _FakeSingleFlight, _FakeWriter, _isolated_home() (+13 more)

### Community 364 - "test_router_loop.py"
Cohesion: 0.19
...
### Community 365 - "test_event_contract.py"
Cohesion: 0.15
...
### Community 366 - "test_migrate_haloai.py"
Cohesion: 0.15
...
### Community 367 - "test_memory_delete_auth.py"
Cohesion: 0.10
...
### Community 373 - "_probe_power"
Cohesion: 0.10
Nodes (21): _find_hwmon(), get_power_stats(), _parse_pp_dpm_sclk(), _probe_power(), Path, GET /api/stats/power — lightweight hwmon power/thermal snapshot.  Resolves hwmon, Return a lightweight hwmon power/thermal snapshot.      All fields are independe, Return the first hwmon directory whose ``name`` file matches *name*.      Return (+13 more)

### Community 374 - "suites.py"
Cohesion: 0.14
...
### Community 389 - "test_prewire_smoke.py"
Cohesion: 0.10
...
### Community 390 - "What You Must Do When Invoked"
Cohesion: 0.08
...
### Community 392 - "hal0 benchmarking system — full design (batch runs, rich run detail, display, auto-update)"
Cohesion: 0.08
...
### Community 395 - "read_gguf_header"
Cohesion: 0.18
...
### Community 397 - "Hal0MemoryClient"
Cohesion: 0.12
...
### Community 400 - "chat_commands.py"
Cohesion: 0.14
...
### Community 402 - "applied_versions"
Cohesion: 0.15
Nodes (23): applied_versions(), _discover_migrations(), _ensure_migrations_table(), migrate(), Connection, Path, Forward-only SQLite schema migration runner.  This is the concrete implementatio, Create the bookkeeping table if absent. Idempotent. (+15 more)
...
### Community 406 - "test_dashboard_layout.py"
Cohesion: 0.11
...
### Community 407 - "test_logs_routes.py"
Cohesion: 0.11
...
### Community 408 - "test_v1_models_filters.py"
Cohesion: 0.20
...
### Community 411 - "test_seeds_data.py"
Cohesion: 0.08
...
### Community 412 - "test_comfyui_container_spec.py"
Cohesion: 0.11
...
### Community 415 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.08
...
### Community 416 - "hal0 1.0 — Seeded profile rework"
Cohesion: 0.08
...
### Community 417 - "Hermes Python 3.12 Cross-Distro Installation Design"
Cohesion: 0.08
...
### Community 419 - "seed_static_slots"
Cohesion: 0.17
...
### Community 420 - "_container_cgroup_mem_bytes"
Cohesion: 0.13
...
### Community 421 - "test_run_as_hal0_guard.py"
Cohesion: 0.13
...
### Community 422 - "test_slot_config_validation.py"
Cohesion: 0.19
...
### Community 423 - "test_brain_self_auth.py"
Cohesion: 0.18
...
### Community 425 - "test_installed.py"
Cohesion: 0.13
...
### Community 426 - "test_npu_columns.py"
Cohesion: 0.15
...
Cohesion: 0.09
Nodes (22): [0.9.2] — 2026-07-05, [0.9.4.1] — 2026-07-08, [0.9.5.2] — 2026-07-09, Added, Added, Changed, Changed, Changelog (+14 more)

### Community 428 - "journal.py"
Cohesion: 0.17
Nodes (22): LevelFilter, _bus(), _collect(), get_journal(), _hal0_event_to_entry(), JournalEntry, _passes_filters(), Any (+14 more)

### Community 429 - "README.md"
Cohesion: 0.09
...
### Community 430 - "_phase_preflight"
Cohesion: 0.10
...
### Community 435 - "test_slot_migrate_id_keying.py"
Cohesion: 0.13
...
### Community 436 - "provision_comfyui_downloads"
Cohesion: 0.13
...
### Community 438 - "resolve_write_dataset"
Cohesion: 0.15
...
### Community 439 - "apply_thinking_policy"
Cohesion: 0.15
...
### Community 443 - "container_enrichment"
Cohesion: 0.22
...
### Community 444 - "test_agent_memory_stats_endpoint.py"
Cohesion: 0.16
...
### Community 445 - "test_backends_npu_canonical_fields.py"
Cohesion: 0.13
...
### Community 447 - "test_memory_subgraph.py"
Cohesion: 0.19
...
### Community 449 - "test_settings_models_store.py"
Cohesion: 0.17
...
### Community 450 - "test_brain_read_only.py"
Cohesion: 0.13
Nodes (18): _fake_request(), Any, Path, Read-only-default posture for the hal0-brain steward chat (KB-2/3 §4).  The ``[b, A gated tool is refused by read-only BEFORE it can enqueue — the     approval qu, Even a persona that auto-approves model_pull cannot beat read-only., An unrecognised tool is NOT a read — read-only refuses it., A hermes_kanban stand-in: records every request_json call, returns {}. (+10 more)

### Community 451 - "test_probes.py"
Cohesion: 0.15
...
### Community 452 - "test_unified_project_scope.py"
Cohesion: 0.17
...
### Community 456 - "UI drawers — slot/model/profile editors"
Cohesion: 0.09
...
### Community 457 - "hal0 Settings Menu — Wireframe / IA"
Cohesion: 0.09
...
### Community 459 - "test_hermes_upgrade.py"
Cohesion: 0.20
...
### Community 460 - "BootReport"
Cohesion: 0.12
Nodes (15): AuthEnforcementMiddleware, Deny-by-default gate wired into ``create_app()`` after ``log_scrub``.      A pur, BootPhaseRecord, BootReport, One boot phase's outcome — surfaced via ``app.state.boot_report``., Structured, additive record of what each boot phase did.      Attached to ``app., Run one boot phase, recording its outcome + timing on ``report``.      Re-raises, _run_boot_phase() (+7 more)

### Community 461 - "dashboard_layout.py"
Cohesion: 0.12
...
### Community 462 - "test_tts_request_defaults.py"
Cohesion: 0.15
...
### Community 465 - "config_enrichment"
Cohesion: 0.21
...
### Community 466 - "test_hermes_env_seam.py"
Cohesion: 0.15
...
### Community 468 - "test_providers.py"
Cohesion: 0.14
...
### Community 469 - "test_services_page.py"
Cohesion: 0.14
...
### Community 470 - "test_v1_proxy.py"
Cohesion: 0.14
...
### Community 471 - "test_virtual_models.py"
Cohesion: 0.17
...
### Community 472 - "test_brain_framing.py"
Cohesion: 0.23
...
### Community 473 - "test_trio_status_inheritance.py"
Cohesion: 0.18
...
### Community 474 - "test_doctor_verify.py"
Cohesion: 0.12
...
### Community 476 - "test_bootstrap_cosign_fetch.py"
Cohesion: 0.21
...
### Community 480 - "test_seam_agent_units.py"
Cohesion: 0.10
...
### Community 481 - "Dashboard Overhaul — FROZEN DATA CONTRACT (v1)"
Cohesion: 0.09
...
### Community 484 - "P2-config: Collapse capabilities.toml double-bookkeeping"
Cohesion: 0.10
...
### Community 488 - "slots_config_dir"
Cohesion: 0.18
...
### Community 489 - "upstream_commands.py"
Cohesion: 0.11
Nodes (20): advertise_upstream(), create_upstream(), credentials_set(), delete_upstream(), _filters_summary(), list_upstreams(), _print_json(), Any (+12 more)
...
### Community 493 - "migrate_slot_id_keying"
Cohesion: 0.17
...
### Community 494 - "read_stack_state"
Cohesion: 0.15
...
### Community 495 - "test_memory_admin_document_transfer.py"
Cohesion: 0.20
...
### Community 496 - "test_pull_shutdown.py"
Cohesion: 0.17
...
### Community 503 - "test_manager_npu_container.py"
Cohesion: 0.20
...
### Community 505 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.10
...
### Community 516 - "TestSlotHardwareSegment"
Cohesion: 0.14
...
### Community 520 - "test_journal_routes.py"
Cohesion: 0.22
...
### Community 521 - "Any"
Cohesion: 0.10
Nodes (19): container_stub(), Any, #1369: membership follows the anchor, with no per-sibling opt-out.      The shad, Slot with no [server] table → payload's llamacpp_args is null.      Mirror the e, rope_freq_base set on disk → exposed in /api/slots payload., A slot with no ``device`` in TOML carries no declared_backend key., The enriched body must be valid JSON (no exotic types leaked)., Loading a slot with no TOML returns the typed slot.not_found envelope. (+11 more)

### Community 522 - "FastAPI"
Cohesion: 0.10
...
### Community 530 - "test_curated_image_models.py"
Cohesion: 0.11
...
### Community 531 - "test_fail_watcher.py"
Cohesion: 0.18
...
### Community 532 - "profiles-crud-v3.spec.ts"
Cohesion: 0.10
...
### Community 537 - "is_activated"
Cohesion: 0.16
Nodes (17): _capability_slot_for_path(), Resolve a path-pinned capability slot name (embed/rerank/tts/img).      Mirrors, DR-1: wake an idle-EVICTED path-pinned capability slot before dispatch.      The, _wake_capability_slot(), claims_npu_anchor(), is_activated(), npu_anchor_config(), npu_modality_active() (+9 more)

### Community 538 - ".reindex"
Cohesion: 0.14
...
### Community 548 - "test_capabilities_commands.py"
Cohesion: 0.19
...
### Community 549 - "test_npu_swap_status.py"
Cohesion: 0.15
...
### Community 552 - "test_store_concurrency.py"
Cohesion: 0.19
...
### Community 554 - "test_load_converges_config.py"
Cohesion: 0.24
...
### Community 555 - "hal0 architecture & reference"
Cohesion: 0.11
...
### Community 556 - "FakeDelegateRunner"
Cohesion: 0.16
...
### Community 557 - "2. Bugs (correctness — ordered by impact)"
Cohesion: 0.11
...
### Community 558 - "manage-slots.mdx"
Cohesion: 0.11
...
### Community 560 - "spec-kb23 — hal0-brain chat tool-tier, approval-gate & injection-resistance"
Cohesion: 0.11
...
### Community 561 - "hal0-admin tools"
Cohesion: 0.11
...
### Community 562 - "kokoro_server.py"
Cohesion: 0.14
...
### Community 575 - "provider_from_config"
Cohesion: 0.19
...
### Community 577 - "test_modality.py"
Cohesion: 0.18
...
### Community 581 - "unknown_slot_config_keys"
Cohesion: 0.17
...
### Community 583 - "CapacityProbeError"
Cohesion: 0.13
...
### Community 587 - "test_models_preview.py"
Cohesion: 0.19
...
### Community 589 - "test_settings_apply.py"
Cohesion: 0.11
...
### Community 590 - "test_v1_dispatch.py"
Cohesion: 0.16
...
### Community 591 - "test_doctor_perms.py"
Cohesion: 0.19
...
### Community 594 - "FakeLocalBackend"
Cohesion: 0.17
...
### Community 595 - "test_logs_tail_redaction.py"
Cohesion: 0.11
...
### Community 597 - "3. Proposed seed catalog (one per type)"
Cohesion: 0.12
...
### Community 598 - "Slot config — capabilities ↔ slots reconciliation"
Cohesion: 0.12
...
### Community 599 - "hal0 Adoption Candidates — Lemonade + ODS (combined)"
Cohesion: 0.12
...
### Community 600 - "spec-hp-realtime — OpenAI Realtime WebSocket endpoint for hal0"
Cohesion: 0.12
...
### Community 601 - "P3-schema — `config/schema.py` decomposition: implementation-ready spec"
Cohesion: 0.12
...
### Community 602 - "Prerelease Preview Pipeline Hardening"
Cohesion: 0.12
...
### Community 608 - "apply_extraction_slot"
Cohesion: 0.18
...
### Community 610 - "normalize_system_messages"
Cohesion: 0.18
...
### Community 613 - "metrics_collect.py"
Cohesion: 0.15
...
### Community 614 - "test_mtp_defuse.py"
Cohesion: 0.29
...
### Community 615 - "test_hermes_state_render.py"
Cohesion: 0.12
...
### Community 616 - ".json"
Cohesion: 0.12
Nodes (16): idle_timeout_s / workers / llamacpp_args ride along on /api/slots.      The on-d, rope_freq_base absent on disk → payload carries null (not 0.0)., v0.1.x clients consuming /api/slots see every legacy key unchanged., PR-18: each entry carries ``type`` + ``model_default``.      The dashboard's per, PR-18: ``labels`` is lifted from ``[model] labels = [...]``.      The dashboard', Labels list is omitted (not empty) when the slot config has no     ``model.label, device=npu slots surface declared_backend='flm' (the FLM recipe)., An EXISTING slot with malformed TOML still surfaces 400 slot.config_error. (+8 more)

### Community 617 - "_StubSlotManager"
Cohesion: 0.26
...
### Community 618 - "test_cli_auth_streamtest.py"
Cohesion: 0.21
...
### Community 619 - "Findings from the 2026-05-16 hal0-test deep-probe round"
Cohesion: 0.12
...
### Community 620 - "DelegateTaskSpec"
Cohesion: 0.18
...
### Community 621 - "test_preflight_ports_own_service.py"
Cohesion: 0.29
...
### Community 622 - "agents-overview.jsx"
Cohesion: 0.20
...
### Community 623 - "test_npu_trio_shadow.py"
Cohesion: 0.17
...
### Community 624 - "test_ttft_samples.py"
Cohesion: 0.12
...
### Community 626 - "halo (LXC 150) — R3 deploy issues report"
Cohesion: 0.12
...
### Community 627 - "hal0_gpu_gate.py"
Cohesion: 0.16
...
### Community 628 - "qwen3tts_server.py"
Cohesion: 0.16
...
### Community 630 - "api_put"
Cohesion: 0.16
Nodes (15): disable_cmd(), enable_cmd(), graph_disable_cmd(), graph_enable_cmd(), graph_status_cmd(), hal0 memory subcommands — graph-extraction gate.  Mirrors the slot / model CLI s, Enable the memory subsystem (persists [memory].enabled=true)., Disable the memory subsystem (persists [memory].enabled=false). (+7 more)

### Community 631 - "system_info_command.py"
Cohesion: 0.18
...
### Community 635 - ".container_spec"
Cohesion: 0.14
Nodes (13): Build the GPU/llama-server :class:`RuntimeLaunchPlan` for a slot.          This, Return the freshly-rendered runtime command for drift checks.          This is t, _device_node_for_group(), gpu_visibility_env(), is_nvidia_gpu_device(), nvidia_cdi_devices(), _probed_gpu_group_gids(), Shared helpers for GPU device + group exposure to provider containers.  Lives he (+5 more)

### Community 636 - "RecordingSlotArtifactOps"
Cohesion: 0.22
...
### Community 637 - "test_hermes_provision_install_artifacts.py"
Cohesion: 0.17
...
### Community 640 - "FakeDockerBackend"
Cohesion: 0.16
...
### Community 641 - "test_v0_3_persona_activate.py"
Cohesion: 0.23
...
### Community 642 - "hal0 test harness — internal contributor guide"
Cohesion: 0.12
...
### Community 644 - "Model registry — registry, pulls, classification"
Cohesion: 0.13
...
### Community 645 - "Handoff: qwen3tts standalone → hal0-slot migration"
Cohesion: 0.13
...
### Community 646 - "Container Image System Overhaul"
Cohesion: 0.13
...
### Community 647 - "hal0 rework plan — de-scarring the launch"
Cohesion: 0.13
...
### Community 648 - "Handoff — brain + embed slot/agent cleanup on halo150"
Cohesion: 0.13
...
### Community 649 - "Handoff — γ-suite (chromium) persistently red on main (#1333)"
Cohesion: 0.13
...
### Community 650 - "Handoff — fold rework→main merge/meld/fix follow-ups into the R5 docs"
Cohesion: 0.13
...
### Community 651 - "Handoff — hal0 R5 endgame (paste-in brief for a new session)"
Cohesion: 0.13
...
### Community 652 - "Findings (O-series)"
Cohesion: 0.13
...
### Community 654 - "hal0 Hermes Integration Suite Design"
Cohesion: 0.13
...
### Community 655 - "PR #1330 CI Repair Design"
Cohesion: 0.13
...
### Community 658 - "test_route_collisions.py"
Cohesion: 0.19
...
### Community 659 - "test_hermes_live_resolve_render.py"
Cohesion: 0.19
...
### Community 660 - "upsert_env_value"
Cohesion: 0.21
...
### Community 661 - "create_chat_template"
Cohesion: 0.24
...
### Community 663 - "test_slots_policy.py"
Cohesion: 0.26
...
### Community 665 - "mcp_commands.py"
Cohesion: 0.16
Nodes (14): catalog_list_cmd(), catalog_refresh_cmd(), _find_server(), list_cmd(), Any, hal0 mcp subcommands — thin HTTP client to /api/mcp/*.  Issue #504: ``hal0 mcp {, Show detail for one MCP server., List installable MCP servers from the catalog. (+6 more)
...
### Community 667 - "write_openwebui_env"
Cohesion: 0.18
...
### Community 669 - "ModelCapabilities"
Cohesion: 0.16
...
### Community 670 - "test_hermes_provision_kanban_db_init.py"
Cohesion: 0.20
...
### Community 671 - "test_persona_update.py"
Cohesion: 0.25
...
### Community 672 - "test_slots_npu_fields.py"
Cohesion: 0.20
...
### Community 673 - "test_slots_routes.py"
Cohesion: 0.26
...
### Community 676 - "test_pool_bounds.py"
Cohesion: 0.15
...
### Community 678 - "test_api_restart_on_upgrade.py"
Cohesion: 0.28
...
### Community 679 - "test_admin_route_map.py"
Cohesion: 0.17
...
### Community 680 - "test_container_mmproj.py"
Cohesion: 0.31
...
### Community 681 - "test_release_check.py"
Cohesion: 0.37
...
### Community 682 - "MapContainerProvider"
Cohesion: 0.24
Nodes (8): MapContainerProvider, _npu_anchor_cfg(), Per-slot ``is_active`` — the trio anchor runs, shadows have no unit., #733: embed/stt shadow slots have no unit/container of their own —     the npu a, #1369: shadows carry placeholder models, so there is no per-shadow         opt-o, A model-less anchor isn't running FLM, so it can't serve shadows., _shadow_cfg(), TestShadowSlotStatusInheritance
...
### Community 684 - "test_preload_eviction.py"
Cohesion: 0.26
...
### Community 685 - "test_integrations.py"
Cohesion: 0.13
...
### Community 688 - "Toolbox Repo Consolidation"
Cohesion: 0.14
...
### Community 689 - "obtain-models.mdx"
Cohesion: 0.14
...
### Community 690 - "Deploy halves of the "CI here" scenarios"
Cohesion: 0.14
...
### Community 691 - "PART 2 — DELIVERABLES"
Cohesion: 0.14
...
### Community 692 - "0. EXACT Honcho footprint (file:line)"
Cohesion: 0.14
...
### Community 693 - "P2-device: make `device` the sole truth, delete the `backend` dual-write"
Cohesion: 0.14
...
### Community 694 - "Handoff — R5 drive 2: put it back together (paste-in prompt, Fable orchestrator)"
Cohesion: 0.14
...
### Community 695 - "hal0 1.0 Seeded Profile Rework — Implementation Plan"
Cohesion: 0.14
...
### Community 697 - "Phase 4 handoff — halo143 deploy window"
Cohesion: 0.14
...
### Community 698 - "test_ports_command.py"
Cohesion: 0.22
...
### Community 699 - "test_moonshine_server.py"
Cohesion: 0.22
...
### Community 705 - "MetricsRetention"
Cohesion: 0.18
...
### Community 708 - "heal_missing_llm_type"
Cohesion: 0.20
...
### Community 709 - "provider_requires_model"
Cohesion: 0.22
...
### Community 710 - "test_hermes_provision_context.py"
Cohesion: 0.14
...
### Community 711 - "test_middleware.py"
Cohesion: 0.21
...
### Community 712 - "test_services_health.py"
Cohesion: 0.27
...
### Community 715 - "test_board_etag.py"
Cohesion: 0.32
...
### Community 716 - "test_brain_chat.py"
Cohesion: 0.23
...
### Community 717 - "test_auth_commands.py"
Cohesion: 0.23
...
### Community 718 - "test_memory_ops_commands.py"
Cohesion: 0.16
...
### Community 719 - "test_slot_verb_aliases.py"
Cohesion: 0.16
...
### Community 720 - "test_hal0_gpu_gate.py"
Cohesion: 0.22
...
### Community 721 - "test_image_pin.py"
Cohesion: 0.14
...
### Community 722 - "test_flm_store_link.py"
Cohesion: 0.26
...
### Community 724 - "test_reinstall_into_venv_does_not_pass_no_deps"
Cohesion: 0.20
...
### Community 725 - "test_adopted_slot_eviction.py"
Cohesion: 0.23
...
### Community 726 - "test_dispatchable_ready_set_single_source.py"
Cohesion: 0.14
...
### Community 727 - "test_restart_errored_slot.py"
Cohesion: 0.26
...
### Community 728 - "dashboard-names-live-v3.spec.ts"
Cohesion: 0.14
Nodes (8): Any, CHAT_SLOT, EMBED_SLOT, gotoWithLiveSlots(), LIVE_SLOTS, OFFLINE_SLOT, gotoDashboard(), NO_UPDATE

### Community 729 - "Contributor Covenant Code of Conduct"
Cohesion: 0.15
Nodes (12): 1. Correction, 2. Warning, 3. Temporary Ban, 4. Permanent Ban, Attribution, Contributor Covenant Code of Conduct, Enforcement, Enforcement Guidelines (+4 more)

### Community 730 - "3. Recommendation: how hal0 should support ONNX"
Cohesion: 0.15
...
### Community 731 - "Dispatch / runtime — routing, arbiter, lifecycle"
Cohesion: 0.15
...
### Community 734 - "pull-and-register-models.mdx"
Cohesion: 0.15
...
### Community 735 - "hal0 rework — handoff: single primary orchestrator (R3-B / R4 / R5 + finish line)"
Cohesion: 0.15
...
### Community 736 - "Changes Applied (then rolled back)"
Cohesion: 0.15
...
### Community 737 - "hal0 codebase map"
Cohesion: 0.15
...
### Community 738 - "hal0 service management"
Cohesion: 0.15
...
### Community 739 - "QueryStringScrubber"
Cohesion: 0.18
...
### Community 740 - "proxy_board_events"
Cohesion: 0.21
...
### Community 742 - "_instrument_streaming_throughput"
Cohesion: 0.15
...
### Community 744 - "resolve_gpu_group_ids"
Cohesion: 0.24
Nodes (6): Return numeric GIDs for the host's GPU access groups (render, video).      ``nod, resolve_gpu_group_ids(), CI / no-GPU box: resolve_gpu_device_paths returns the legacy         directory f, A discovered node that can't be stat'd (raced away, permission         denied) m, halo143 regression: ``getgrnam("render")`` resolves the group NAMED     "render", TestResolveGpuGroupIds

### Community 745 - "test_containers_apparmor.py"
Cohesion: 0.37
...
### Community 747 - "test_activity.py"
Cohesion: 0.31
...
### Community 748 - "test_activity_routes_instrumented.py"
Cohesion: 0.38
...
### Community 749 - "test_comfyui_fetch_route.py"
Cohesion: 0.15
...
### Community 750 - "test_events_fixes.py"
Cohesion: 0.19
...
### Community 751 - "test_harness_matrix.py"
Cohesion: 0.21
...
### Community 752 - "TestSeamWhitelist"
Cohesion: 0.18
...
### Community 753 - "test_memory_graph_commands.py"
Cohesion: 0.15
...
### Community 754 - "test_model_verbs.py"
Cohesion: 0.26
...
### Community 757 - "_RecordingProvider"
Cohesion: 0.24
...
### Community 758 - "test_seed_profiles.py"
Cohesion: 0.24
...
### Community 762 - "Slot pin + drawer field-wiring audit — session handoff (2026-07-30)"
Cohesion: 0.17
...
### Community 763 - "Recently added endpoints"
Cohesion: 0.17
...
### Community 764 - "HW-slot-ownership — hardware sticks to slots, logical tune sticks to models"
Cohesion: 0.17
...
### Community 765 - "Design — 3-tier, deny-by-default, single classification source"
Cohesion: 0.17
...
### Community 766 - "hal0 UI/UX design brief — post-R3 surface rework"
Cohesion: 0.17
...
### Community 771 - "Release pipeline — prototype findings + blockers"
Cohesion: 0.17
...
### Community 776 - "test_board_ws.py"
Cohesion: 0.32
...
### Community 777 - "test_agent_status.py"
Cohesion: 0.23
...
### Community 779 - "test_comfyui_scripts_shipped.py"
Cohesion: 0.17
...
### Community 780 - "test_static_seeds.py"
Cohesion: 0.17
...
### Community 783 - "Findings → fixes, by tier"
Cohesion: 0.18
...
### Community 784 - "Handoff: model-pipeline plan — finish-out pass"
Cohesion: 0.18
...
### Community 785 - "Hal0 Upstream Controls — Epic Plan (2026-07-06)"
Cohesion: 0.18
...
### Community 786 - "capabilities-and-profiles.mdx"
Cohesion: 0.18
...
### Community 787 - "Admin tools (`/mcp/admin`)"
Cohesion: 0.18
...
### Community 788 - "providers-profiles-devices.mdx"
Cohesion: 0.18
...
### Community 789 - "slot-lifecycle.mdx"
Cohesion: 0.18
...
### Community 790 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
...
### Community 791 - "Both-boxes deploy-validation runbook — rework-R4-stage"
Cohesion: 0.18
...
### Community 792 - "P3-brain — Implementation-Ready Spec: hal0-brain as a first-class module"
Cohesion: 0.18
...
### Community 793 - "PART D — Edit plan (files, order, delegators/shims)"
Cohesion: 0.18
...
### Community 794 - "hal0 Hermes Plugin Suite — BUILD Spec (verified vs code @ `rework/descar`)"
Cohesion: 0.18
...
### Community 795 - "Hermes Agent official integration research for the hal0 rework"
Cohesion: 0.18
...
### Community 796 - "2. Proposed hal0 plugin suite"
Cohesion: 0.18
...
### Community 807 - "rerender_slot_units"
Cohesion: 0.38
...
### Community 809 - "test_hermes_provision_collect.py"
Cohesion: 0.25
...
### Community 810 - "test_config_model_roots.py"
Cohesion: 0.29
...
### Community 811 - "test_doctor_route.py"
Cohesion: 0.24
...
### Community 812 - "test_features_health.py"
Cohesion: 0.25
...
### Community 813 - "test_meta_enums.py"
Cohesion: 0.42
...
### Community 815 - "test_server_ab_helpers.py"
Cohesion: 0.22
...
### Community 816 - "test_board_commands.py"
Cohesion: 0.27
...
### Community 817 - "test_serve_bind_host.py"
Cohesion: 0.31
...
### Community 818 - "test_fetch_scripts.py"
Cohesion: 0.18
...
### Community 819 - "hal0 test-harness — findings"
Cohesion: 0.18
...
### Community 822 - "test_admin_stacks.py"
Cohesion: 0.24
...
### Community 823 - "test_api_wiring.py"
Cohesion: 0.24
...
### Community 825 - "test_npu_trio_reconcile.py"
Cohesion: 0.45
...
### Community 826 - "test_pin_semantics.py"
Cohesion: 0.18
...
### Community 827 - "useAgentMcpClients.ts"
Cohesion: 0.20
...
### Community 832 - "7. Product-shaped reworks (from the six field notes)"
Cohesion: 0.20
...
### Community 833 - "FLAGS-own — llama.cpp flags stick to models; profiles become templates"
Cohesion: 0.20
...
### Community 834 - "hal0 SETTINGS rework — implementation-ready spec"
Cohesion: 0.20
...
### Community 835 - "Slot / Model / Profile / Flags / Image — reworked runtime model (R3)"
Cohesion: 0.20
...
### Community 836 - "Global Constraints"
Cohesion: 0.20
...
### Community 838 - "Dashboard Plugin JS Loading Internals"
Cohesion: 0.20
...
### Community 846 - "get_agent_memory_stats"
Cohesion: 0.29
...
### Community 851 - "slot_migrate_caps"
Cohesion: 0.42
...
### Community 852 - "resolve_chat_template"
Cohesion: 0.27
...
### Community 853 - "_declared_path_args"
Cohesion: 0.22
Nodes (10): _declared_path_args(), _placeholders(), Catalog tools that forward over REST (exclude memory_* + host probes)., App-independent overlay coherence — safe to run before a map installs., Path args for ``tool`` — from the installed map, else its alias route., Full guard: overlay coherence + the installed route map (Gap 1/3)., Ordered ``{placeholder}`` names in a normalized path template., _routed_catalog() (+2 more)

### Community 854 - "resolve_gpu_device_paths"
Cohesion: 0.24
...
### Community 855 - "backfill_coordless"
Cohesion: 0.20
...
### Community 858 - "collect_port_claims"
Cohesion: 0.29
...
### Community 860 - "_brain_profile_state"
Cohesion: 0.20
...
### Community 861 - "TestStatusTelemetry"
Cohesion: 0.29
...
### Community 863 - "test_mcp_mount_health.py"
Cohesion: 0.24
...
### Community 865 - "test_startup_persona_seed.py"
Cohesion: 0.27
...
### Community 866 - "test_startup_slot_seed.py"
Cohesion: 0.24
...
### Community 868 - "test_catalog_npu_stt.py"
Cohesion: 0.27
...
### Community 869 - "test_shared_auth.py"
Cohesion: 0.33
...
### Community 871 - "test_validate_catalog.py"
Cohesion: 0.24
...
### Community 873 - "_configure_project"
Cohesion: 0.56
...
### Community 880 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 881 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 882 - "ROCmFPX bench — RESULTS + next-session handoff (2026-07-05)"
Cohesion: 0.22
...
### Community 883 - "architecture.mdx"
Cohesion: 0.22
...
### Community 885 - "connect-clients.mdx"
Cohesion: 0.22
...
### Community 886 - "connect-external-providers.mdx"
Cohesion: 0.22
...
### Community 887 - "realtime-voice.mdx"
Cohesion: 0.22
...
### Community 888 - "openai-compat.mdx"
Cohesion: 0.22
...
### Community 889 - "slot-as-model.mdx"
Cohesion: 0.22
...
### Community 890 - "env-vars.mdx"
Cohesion: 0.22
Nodes (8): Install & update, Memory & MCP, Models & providers, Paths, Runtime, See also, Server, Services

### Community 891 - "Handoff prompt — hal0-brain / template / profile changes on lxc105 (hal0, 10.0.1.142)"
Cohesion: 0.22
...
### Community 892 - "PART B — Target: Quadlet `.container` per slot (and per companion)"
Cohesion: 0.22
...
### Community 893 - "Slot-pin-lifecycle — the operator pin is the residency control, and the only one"
Cohesion: 0.22
...
### Community 894 - "SWEEP inventory — the overlooked surface (R5 release-prep)"
Cohesion: 0.22
...
### Community 897 - "Hindsight pi Extension Design"
Cohesion: 0.22
...
### Community 898 - "Dashboard plugin "Could not load this plugin's script""
Cohesion: 0.22
...
### Community 899 - "Strix Halo Benchmark Harness (hal0)"
Cohesion: 0.22
...
### Community 904 - "model_store_root"
Cohesion: 0.28
...
### Community 906 - "migrate_cognee_to_hindsight_dryrun"
Cohesion: 0.25
...
### Community 907 - "TestImageMismatch"
Cohesion: 0.33
...
### Community 916 - "_tool_mutation_case"
Cohesion: 0.22
...
### Community 917 - "test_catalog_flm_blacklist.py"
Cohesion: 0.28
...
### Community 919 - "test_config_show_edit_selector.py"
Cohesion: 0.50
...
### Community 920 - "test_slot_metrics_capacity.py"
Cohesion: 0.36
...
### Community 929 - "useBannerStore.ts"
Cohesion: 0.22
Nodes (8): BANNER_CATALOG, BannerAction, BannerEntry, BannerKind, BannerScope, BannerState, CATALOG_BY_ID, useBannerStore

### Community 930 - "Local-session prompt: run the profile re-tune bench matrix and apply the results"
Cohesion: 0.25
...
### Community 934 - "generate-images.mdx"
Cohesion: 0.25
...
### Community 935 - "update-and-rollback.mdx"
Cohesion: 0.25
...
### Community 936 - "voice-stt-tts.mdx"
Cohesion: 0.25
...
### Community 938 - "paths-and-files.mdx"
Cohesion: 0.25
...
### Community 940 - "13. Observability & metrics baseline (ships in every box)"
Cohesion: 0.25
...
### Community 941 - "15. Hermes plugin — standalone repo + native update path"
Cohesion: 0.25
...
### Community 942 - "PART C — Coordination contracts (cross-lane seams)"
Cohesion: 0.25
...
### Community 943 - "halo143 deploy-validation runbook — rework-R3"
Cohesion: 0.25
...
### Community 944 - "Handoff — R5 Phase 4: deploy window → release cut (paste-in prompt)"
Cohesion: 0.25
...
### Community 945 - "mock-prod-gate verification (Phase 0 launch-blocker #3)"
Cohesion: 0.25
...
### Community 946 - "Podman on the hal0 slot substrate — findings & cleaner solutions"
Cohesion: 0.25
...
### Community 957 - "_settings_apply.py"
Cohesion: 0.29
...
### Community 958 - "resolve_default_image"
Cohesion: 0.36
...
### Community 960 - "test_apply_selections.py"
Cohesion: 0.36
...
### Community 961 - "test_auth_exposure_route.py"
Cohesion: 0.32
...
### Community 964 - "test_app_list_uninstall.py"
Cohesion: 0.36
...
### Community 965 - "test_cli_docs_parity.py"
Cohesion: 0.36
...
### Community 969 - "test_slot_enabled_removed.py"
Cohesion: 0.25
...
### Community 971 - "_BackendContract"
Cohesion: 0.25
...
### Community 974 - "test_store_on_change.py"
Cohesion: 0.39
...
### Community 975 - "test_slot_create_conflict.py"
Cohesion: 0.29
...
### Community 976 - "test_slot_schema.py"
Cohesion: 0.32
...
### Community 977 - "test_transition_guard.py"
Cohesion: 0.25
...
### Community 978 - "useTweaksStore.ts"
Cohesion: 0.29
Nodes (5): APPEARANCE_KEYS, DEFAULTS, TweaksState, TweaksStore, useTweaksStore

### Community 979 - "board-chat-tool-use-v3.spec.ts"
Cohesion: 0.29
Nodes (3): GATED_FRAMES, mockChat(), sse()

### Community 980 - "Concurrency & continuous-batching optimization plan"
Cohesion: 0.29
...
### Community 981 - "ROCmFPX exploratory bench — RESULTS (2026-07-05)"
Cohesion: 0.29
...
### Community 987 - "P3-perms: declarative OwnershipStore as the single ownership authority"
Cohesion: 0.29
...
### Community 988 - "PART B — Target: OwnershipStore default `service_user="hal0"`"
Cohesion: 0.29
...
### Community 989 - "PART C — The LOAD-BEARING contract: born-owned"
Cohesion: 0.29
...
### Community 990 - "PART 0 — EXACT MAP (file:line)"
Cohesion: 0.29
...
### Community 991 - "P3-quadlet: migrate slot + companion units to Podman Quadlet `.container`"
Cohesion: 0.29
...
### Community 992 - "PART A — Current scars (in plain English)"
Cohesion: 0.29
...
### Community 993 - "4. Delivery plan and gates"
Cohesion: 0.29
...
### Community 997 - "Gateway connectivity quirks — hal0"
Cohesion: 0.29
...
### Community 1007 - "write_env_atomic"
Cohesion: 0.33
...
### Community 1009 - "_FakeSlotManager"
Cohesion: 0.38
...
### Community 1010 - "test_slot_logs_stream_redacts_secret_bearing_lines"
Cohesion: 0.33
...
### Community 1015 - "test_memory_mm_commands.py"
Cohesion: 0.29
Nodes (3): MonkeyPatch, Tests for ``hal0 memory mm {list,refresh,history}``., stub_api()

### Community 1016 - "test_slot_rename.py"
Cohesion: 0.33
...
### Community 1017 - "test_paths_stub.py"
Cohesion: 0.29
...
### Community 1018 - "_reject_privileged_systemctl"
Cohesion: 0.33
...
### Community 1019 - "test_voice_roundtrip.py"
Cohesion: 0.43
...
### Community 1020 - "10. Troubleshooting"
Cohesion: 0.29
...
### Community 1021 - "test_owui_pin_consistency.py"
Cohesion: 0.43
...
### Community 1022 - "test_extra_args_sanitize.py"
Cohesion: 0.38
...
### Community 1034 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 1035 - "Hal0 Installer Setup — Redesign Plan (2026-07-05)"
Cohesion: 0.33
...
### Community 1037 - "logs-and-activity.mdx"
Cohesion: 0.33
...
### Community 1042 - "24. Execution waves / rollout program (session 3, 2026-07-18)"
Cohesion: 0.33
...
### Community 1044 - "§4.4 addendum — MCP admin route-map autogen (the 3 gaps)"
Cohesion: 0.33
...
### Community 1045 - "Verification strategy"
Cohesion: 0.33
Nodes (6): Lifecycle and security, Live acceptance, Memory, Provider, Verification strategy, Voice

### Community 1046 - "Dashboard permission mismatch (root vs hal0)"
Cohesion: 0.33
...
### Community 1059 - "throughput_history"
Cohesion: 0.33
...
### Community 1062 - "_guess_capability"
Cohesion: 0.33
...
### Community 1063 - "ttft_samples.py"
Cohesion: 0.33
...
### Community 1064 - "avg_ttft_across"
Cohesion: 0.33
...
### Community 1065 - "samples_from_events"
Cohesion: 0.33
...
### Community 1066 - "test_activity_instrumentation.py"
Cohesion: 0.60
...
### Community 1067 - "test_models_catalogue.py"
Cohesion: 0.47
...
### Community 1071 - "test_now_iso.py"
Cohesion: 0.33
...
### Community 1072 - "test_curation_drift.py"
Cohesion: 0.40
...
### Community 1073 - "test_family_defaults_empty.py"
Cohesion: 0.33
...
### Community 1094 - "14. Kanban board — ownership inversion + security hardening"
Cohesion: 0.40
...
### Community 1095 - "16. Hermes Python library (`AIAgent`) for the brain — evaluated, rejected for core"
Cohesion: 0.40
...
### Community 1096 - "21.A Mapping table — every candidate by disposition"
Cohesion: 0.40
...
### Community 1097 - "8. SQLite adoption — setup plan"
Cohesion: 0.40
...
### Community 1098 - "PART A — Current-state map (the scars, in plain English)"
Cohesion: 0.40
...
### Community 1099 - "PART D — The one narrow privileged helper: `hal0-systemctl`"
Cohesion: 0.40
...
### Community 1100 - "PART G — Sequencing: P3-perms BEFORE hermes-provision slim and P3-quadlet"
Cohesion: 0.40
...
### Community 1101 - "PART 0 — Current-state map (the hand-rendered ExecStart scars, file:line)"
Cohesion: 0.40
...
### Community 1112 - "is_container_npu_cfg"
Cohesion: 0.40
...
### Community 1117 - "TestRenderCancel"
Cohesion: 0.40
...
### Community 1126 - "slot-edit-controls-v3.spec.ts"
Cohesion: 0.40
...
### Community 1148 - "PART E — `hal0-api` User flip + UMask removal"
Cohesion: 0.50
...
### Community 1149 - "PART F — Edit plan (files, order, delegators/shims)"
Cohesion: 0.50
...
### Community 1150 - "PART H — Risks + capped verification"
Cohesion: 0.50
...
### Community 1151 - "PART E — Migration of running units (the live-box transition)"
Cohesion: 0.50
...
### Community 1152 - "PART F — Risks + capped verification"
Cohesion: 0.50
...
### Community 1165 - "test_destructive_ops_land_audit_rows"
Cohesion: 0.67
Nodes (4): _build_app_with_audit(), Any, FastAPI, test_destructive_ops_land_audit_rows()

### Community 1166 - "test_store.py"
Cohesion: 0.67
...
### Community 1167 - "_delegate_fakes.py"
Cohesion: 0.50
...
### Community 1168 - "test_comfyui_path.py"
Cohesion: 0.50
...
### Community 1176 - "[0.9.4] — 2026-07-08"
Cohesion: 0.67
Nodes (3): [0.9.4] — 2026-07-08, Added, Fixed

### Community 1177 - "[v0.8.0-beta.3] — 2026-06-23"
Cohesion: 0.67
Nodes (3): Breaking, Changed, [v0.8.0-beta.3] — 2026-06-23

### Community 1178 - "[v0.8.2b2] — 2026-06-24"
Cohesion: 0.67
Nodes (3): Changed, Fixed, [v0.8.2b2] — 2026-06-24

### Community 1200 - "_OtherEngineProvider"
Cohesion: 0.67
...
### Community 1208 - "test_agent_unit_argv_defaults_to_real_euid"
Cohesion: 0.67
Nodes (3): MonkeyPatch, ``euid=None`` (the production call) reads the live euid., test_agent_unit_argv_defaults_to_real_euid()

## Knowledge Gaps
- **3290 isolated node(s):** `runlog.sh script`, `rocmfpx-build.sh script`, `rocmfpx-env.sh script`, `rocmfpx-pipeline.sh script`, `rocmfpx-quantize.sh script` (+3285 more)
...
- **Why does `create_app()` connect `create_app` to `migrate_slot_toml`, `ApprovalQueue`, `model_store_root`, `test_hf_routes.py`, `FastAPI`, `ConfigParseError`, `conftest.py`, `isolated_client_with_root`, `test_route_collisions.py`, `GpuImageMode`, `test_dashboard_layout.py`, `test_slots_policy.py`, `conftest.py`, `test_memory_admin_routes.py`, `test_slots_npu_fields.py`, `test_settings_routes.py`, `conftest.py`, `test_admin_route_map_nested.py`, `test_updater_routes.py`, `test_exposure.py`, `test_config_model_roots.py`, `MemoryConfig`, `mcp_mount.py`, `test_kb1_hardening_tail.py`, `TestClient`, `test_slots_image_pull.py`, `test_chat_proxy.py`, `test_chat_templates.py`, `test_models_crud.py`, `provider_from_config`, `__init__.py`, `test_settings_models_store.py`, `TestClient`, `test_v1_npu_trio_routing.py`, `test_models_routes.py`, `hal0_slot_alias_models`, `EventBus`, `test_models_preview.py`, `BootReport`, `test_chat_proxy_auth.py`, `test_tts_request_defaults.py`, `test_route_sync.py`, `conftest.py`, `test_profiles_crud.py`, `test_typed_errors.py`, `test_typed_bodies.py`, `test_v1_chat_slot_alias.py`, `test_mcp_mount_health.py`, `TestClient`, `test_startup_persona_seed.py`, `test_startup_slot_seed.py`, `test_models_add_from_path.py`, `test_models_default.py`, `test_redact.py`, `conftest.py`, `_StubSlotManager`, `test_cli_auth_streamtest.py`, `test_comfyui_fetch_route.py`, `test_events_fixes.py`, `test_pull_routes.py`, `test_pull_shutdown.py`, `test_event_contract.py`, `test_memory_delete_auth.py`, `test_installer_routes.py`, `test_slots_container_state.py`, `TestClient`, `test_auth_core.py`, `test_auth_rotate.py`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `SlotManager` connect `SlotManager` to `build_auto_selections`, `SlotInterface`, `Slot`, `SlotConfigError`, `FLMProvider`, `is_activated`, `FakeManager`, `test_model_preferred_profile.py`, `test_model_fallback.py`, `rerender_slot_units`, `_write_slot`, `test_load_converges_config.py`, `test_device_profile_coherence.py`, `test_preload_eviction.py`, `GpuArbiter`, `CapabilityOrchestrator`, `compute_config_drift`, `_write_slot`, `test_npu_trio_reconcile.py`, `manager.py`, `FakeContainerProvider`, `test_slot_aliases.py`, `heal_missing_llm_type`, `SlotIdentityStore`, `StackChangePlan`, `SlotState`, `test_slot_create_conflict.py`, `test_transition_guard.py`, `test_adopted_slot_eviction.py`, `RoutingHost`, `test_pulling_serving_idle.py`, `test_mtp_defuse.py`, `agents-overview.jsx`, `test_npu_trio_shadow.py`, `Path`, `SlotStateRecord`, `test_manager_npu_container.py`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `connect()` connect `connect` to `BoardStore`, `MetricsWriter`, `applied_versions`, `SqliteModelRegistry`, `Model`, `test_pull_refcount_rows.py`, `Path`, `ModelRegistry`, `import_toml_to_sqlite`, `useLogs.ts`, `aggregate_hour`, `useActivity.ts`, `SlotIdentityStore`, `Path`, `_safe_query`, `scan_and_register`, `models_service.py`, `store.py`, `test_stats_requests_route.py`, `hw_slot_ownership.py`, `PortAuthority`?**
...
- **Are the 116 inferred relationships involving `create_app()` (e.g. with `AuthEnforcementMiddleware` and `lifespan()`) actually correct?**
  _`create_app()` has 116 INFERRED edges - model-reasoned connections that need verification._