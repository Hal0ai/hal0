# Graph Report - hal0-wt-enabled-removal  (2026-07-29)

## Corpus Check
- 1595 files · ~2,006,315 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28899 nodes · 54785 edges · 1322 communities (1188 shown, 134 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 6718 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b81ab03`
...
- test_distro.sh
- test_cancel.py
- test_zero_window_from_toml_never_auto_restores
...
1. `SlotManager` - 285 edges
2. `ENDPOINTS` - 141 edges
3. `ApprovalQueue` - 124 edges
4. `connect()` - 123 edges
5. `create_app()` - 119 edges
6. `BadRequest` - 117 edges
7. `BoardStore` - 114 edges
8. `ContainerProvider` - 114 edges
9. `SlotState` - 110 edges
10. `apiGet()` - 107 edges

## Surprising Connections (you probably didn't know these)
- `store()` --calls--> `Store`  [INFERRED]
  tests/bench/test_planner.py → src/hal0/bench/store.py
- `test_attempt_handle_with_status_is_immutable()` --calls--> `AttemptHandle`  [INFERRED]
  tests/board/test_board_dispatch.py → src/hal0/board/dispatch.py
...
## Communities (1322 total, 134 thin omitted)

### Community 0 - "dashboard-redesign.jsx"
Cohesion: 0.03
Nodes (129): useActivityRecent(), CELL_DEFS, CELL_MAP, CellDef, CellId, DashLayout, DEFAULT_LAYOUT, LAYOUT_QUERY_KEY (+121 more)

### Community 1 - "useSlots.ts"
Cohesion: 0.03
Nodes (126): ADR-0022, useNpuOccupancy(), deviceBackend(), parseImageRef(), RunnerState, RuntimeRow, SystemInfo, SystemInfoBackend (+118 more)
...
### Community 4 - "Slot"
Cohesion: 0.03
Nodes (76): container_provider(), Return the process-wide ContainerProvider singleton., flm_id_to_tag(), Resolve a hal0 ``<tag>-FLM`` id back to FLM's native ``family:size`` tag.      I, _cfg_port(), _cfg_provider(), _cfg_to_dict(), _model_default() (+68 more)

### Community 5 - "test_updater.py"
Cohesion: 0.04
...
### Community 6 - "Model"
Cohesion: 0.03
Nodes (119): FileSetEntry, FileSetPlan, One file of a planned file-set, ready for ``model_file`` insertion., The full set of files one model pull should download + register., Model, A model entry in the hal0 registry.      All fields are optional at construction, _comfyui_models_dir(), _dir_size() (+111 more)

### Community 7 - "useModels.ts"
Cohesion: 0.04
Nodes (107): useLogsStream(), useMemoryEnabled(), AddFromPathRequest, fmtBytes(), fmtEta(), fmtSpeed(), HfSearchResponse, HfSearchResult (+99 more)

### Community 8 - "ApprovalQueue"
Cohesion: 0.03
Nodes (117): ApprovalQueue, Async-safe pending-approval queue with dedup + SSE fan-out.      One instance pe, list_transport(), mock_transport(), _policy(), Any, MonkeyPatch, queue() (+109 more)
...
### Community 11 - "slots.py"
Cohesion: 0.04
Nodes (108): _cache_slot_enrichment(), _config_field_enrichment(), _container_state_enrichment(), create_slot(), delete_slot(), _device_backend(), _fit_check_warning(), get_slot() (+100 more)

### Community 12 - "SettingsShell.jsx"
Cohesion: 0.05
Nodes (84): useBackends(), CapabilitiesBag, CapabilityRow, useCapabilities(), useCapabilityApply(), useCapabilityPatch(), useServiceRepair(), APPLY_PLAN_KEY (+76 more)

### Community 13 - "ContainerProvider"
Cohesion: 0.03
Nodes (75): _container_runtime(), ContainerProvider, CompletedProcess, Path, Podman-container-per-slot inference backend.      One instance is shared across, Not applicable — systemd starts the container., The systemd **service** name for a slot (``systemctl`` verbs target it)., The Quadlet ``.container`` source file this slot's unit is written to. (+67 more)
...
### Community 16 - "die"
Cohesion: 0.05
Nodes (98): agent_install(), agent_list(), agent_peers(), approvals_approve(), approvals_deny(), approvals_list(), _enforce_hermes_single_pick(), _install_hermes() (+90 more)

### Community 17 - "Dispatcher"
Cohesion: 0.05
Nodes (77): LegacyResolutionFailed, Raised when the capability/path heuristics find no slot to serve a request., Dispatcher, DispatchError, NoRouteFound, Request, Look up a registry binding for a model id.          Returns (upstream_name, upst, Forward client headers minus hop-by-hop, plus upstream auth slot.          # NOT (+69 more)

### Community 18 - "ModelDefaults"
Cohesion: 0.05
Nodes (45): ModelDefaults, Per-model default knobs surfaced as launcher defaults.      All fields optional., ModelAlreadyExists, add() called but the model id is already present., _model(), ModelRegistry, Path, Schema-migration tests for the Phase-1 Model additions.  Covers:   * New optiona (+37 more)

### Community 19 - "ProfileConfig"
Cohesion: 0.04
Nodes (47): ProfileConfig, One ``[profile.<name>]`` entry in profiles.toml.      A profile is a reusable ba, Return the full flag string for *profile*, expanding MTP when set.      When the, resolve_profile_flags(), test_vulkan_profile_drafts_on_vulkan_device(), Unit tests for the profile catalog — schema, loader, and flag resolver.  Targete, §7.1a / ML-5: profile.mtp is informational only — resolve_profile_flags, profile.mtp=True alone (no explicit mtp_override) no longer         expands the (+39 more)
...
### Community 23 - "hermes_provision.py"
Cohesion: 0.04
Nodes (90): BootstrapState, _brain_profile_config_path(), _build_brain_identity_card(), _build_brain_profile_mcp_servers(), _build_identity_card(), _fetch_model_contexts(), _generate_api_server_key(), _hal0_version_string() (+82 more)
...
### Community 26 - "comfyui-pane.jsx"
Cohesion: 0.03
Nodes (67): COMFYUI_FALLBACK, ComfyuiArbiter, ComfyuiEngineState, ComfyuiMemory, ComfyuiMode, ComfyuiStatus, ComfyuiSwitchover, ComfyuiV2PaneData (+59 more)
...
### Community 32 - "useBoard.ts"
Cohesion: 0.06
Nodes (77): apiPatch(), apiPost(), normaliseActor(), normaliseAssignee, normaliseProfile, pickName(), BoardAssignee, BoardConfig (+69 more)

### Community 33 - "container.py"
Cohesion: 0.04
Nodes (63): _best_effort_model_info(), _binary_runner(), _effective_backend_and_device_class(), _effective_parallel(), _effective_runner(), _image_mismatch(), _loopback_fence_command(), _native_ctx() (+55 more)

### Community 34 - "ConfigParseError"
Cohesion: 0.05
...
### Community 36 - "doctor_commands.py"
Cohesion: 0.04
Nodes (75): check_hermes_ownership(), check_tree_group_share(), _dangling_registry_entries(), _deepest_mountpoint(), detect_editable_root(), doctor_migrations(), doctor_models(), flm_mount_guard() (+67 more)

### Community 37 - "SlotState"
Cohesion: 0.06
Nodes (64): The chosen upstream couldn't be reached (timeout, connection refused, etc.)., The target slot is mid-swap — model is starting/loading/unloading.      Raised b, The target slot encountered a hard load failure (``SlotState.ERROR``).      Rais, SlotLoadFailed, SlotLoading, UpstreamUnavailable, See :meth:`hal0.slots.watchdog.SlotWatchdog.update`., is_dispatchable_state() (+56 more)

### Community 38 - "test_updater_routes.py"
Cohesion: 0.05
...
### Community 43 - "Any"
Cohesion: 0.05
Nodes (73): _active_persona_render(), _apply_config_set(), _atomic_write(), _atomic_write_if_changed(), _collect_capability_rollup(), _collect_chat_slots(), content_hash(), _deep_merge() (+65 more)
...
### Community 45 - "resolve_by_capability"
Cohesion: 0.05
...
### Community 47 - "test_discover.py"
Cohesion: 0.06
Nodes (73): backfill_coordless(), CandidateModel, find_candidates(), _maybe_register_shard_files(), prune_missing(), Model, ModelRegistry, One discovered file ready for registry registration. (+65 more)

### Community 48 - "ProfileCatalog"
Cohesion: 0.05
Nodes (54): RuntimeFamily, SlotType, create_profile(), delete_profile(), export_profile(), get_profile(), import_profile_route(), list_profiles() (+46 more)

### Community 49 - "stacks.jsx"
Cohesion: 0.06
Nodes (59): URL-safe lowercase identifier used by the REST surface., api(), ProfileBody, ProfileEnvelope, ProfileImportDryResult, useProfileCreate(), useProfileDelete(), useProfileExport() (+51 more)

### Community 50 - "CapabilityOrchestrator"
Cohesion: 0.07
...
### Community 54 - "chat.py"
Cohesion: 0.06
Nodes (69): _admin_tool_names(), _admin_tool_schemas(), _brain_chat_config(), _brain_tool_policy(), _chat_stream(), _compact_board(), _context_exceeded_error(), _dispatch_admin_tool() (+61 more)

### Community 55 - "test_models_crud.py"
Cohesion: 0.06
Nodes (69): container_stub(), crud_app(), crud_client(), crud_models_root(), _events_since(), _max_event_id(), Any, FastAPI (+61 more)

### Community 56 - "test_board_chat.py"
Cohesion: 0.12
...
### Community 60 - "connections.jsx"
Cohesion: 0.06
Nodes (60): Hal0Error, _fetchServers(), McpServer, McpServerActivity, McpServerState, McpTool, MOCK_SERVERS, useMcpServers() (+52 more)

### Community 61 - "plan_fileset"
Cohesion: 0.06
...
### Community 62 - "apiMock.ts"
Cohesion: 0.04
Nodes (21): Fixtures, HONCHO_STATS_DISABLED, HONCHO_STATS_ENABLED, HONCHO_SYNC_DEFAULT, installMemoryProviderMocks(), MEMORY_PROVIDER_DEFAULT, MemoryProviderMockOptions, MockState (+13 more)

### Community 63 - "NpuTrioRouter"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (55): active_tools_for(), chat_slot_has_tool_calling(), Any, Dynamic per-request tool filtering — plan §7.3.  Given the active chat slot and, The narrow SlotManager surface filter.py + dispatch.py need.      Stated as a Pr, Return True iff the chat slot's model is allowed to see tools.      Per plan §7., Return the filtered tool list for a chat slot, per plan §7.3.      Args:, SlotManagerLike (+47 more)
...
### Community 68 - "make_slot"
Cohesion: 0.09
Nodes (62): DispatchContext, Carrier for the per-loop dependencies a handler needs.      Bundled into one obj, make_http_client(), make_slot(), AsyncClient, Build a slot config dict for tests.      Pass ``model=""`` for an INACTIVE slot, Build an httpx.AsyncClient backed by ``httpx.MockTransport``.      The ``handler, _ctx() (+54 more)

### Community 69 - "MigrateState"
Cohesion: 0.07
...
### Community 71 - "ModelRegistry"
Cohesion: 0.06
Nodes (31): ModelNotFound, Base error for registry operations., The requested model id is not in the registry., RegistryError, _model(), LogCaptureFixture, ModelRegistry, MonkeyPatch (+23 more)
...
### Community 76 - "_ArbiterSlotManager"
Cohesion: 0.07
Nodes (52): GpuImageMode, GpuMode, LLM dispatch refused — the GPU is in exclusive image mode., _ArbiterContainerSlotManager, _ArbiterSlotManager, _arbitrated_cfgs(), _container_slot_call(), _dr2_cfgs() (+44 more)

### Community 77 - "build_per_slot"
Cohesion: 0.05
Nodes (44): build_per_slot(), CapacityProbeError, CapacitySnapshot, _container_cgroup_mem_bytes(), _ctx_tokens_for(), estimate_file_size_kv_mb(), _kv_estimate_mb(), Any (+36 more)
...
### Community 80 - "model-drawer.jsx"
Cohesion: 0.07
Nodes (52): ChatTemplate, useChatTemplates(), useMeta(), useMetaEnums(), useModelDuplicate(), useModelSetDefault(), useModelUpdate(), canonManaged() (+44 more)

### Community 81 - "test_redact.py"
Cohesion: 0.05
Nodes (57): is_sensitive_key(), Any, Shared config-echo redaction (issue #553).  A single helper that scrubs sensitiv, Replace Bearer / HAL0_BEARER_TOKEN / long client_id / ``*_KEY=``     secrets in, Recursively scrub sensitive-keyed values from a config tree.      - ``dict``: wa, True if ``key`` (the *name*, not the value) matches a sensitive pattern.      Ca, Project a sensitive *value* into the masked ``{value, set}`` shape.      ``set``, redact_config() (+49 more)
...
### Community 90 - "create_app"
Cohesion: 0.05
Nodes (51): create_app(), Lifespan wiring for the GpuArbiter idle-restore loop (Phase D, Task D6).  The ap, test_lifespan_starts_and_cancels_arbiter_idle_loop(), MonkeyPatch, TestClient, A failed MCP mount must be visible, not just logged and forgotten.  The fastapi-, A mount failure must flip /api/health/system to degraded and say why., create_app must stash the reason, not only log it. (+43 more)

### Community 91 - "test_argv.py"
Cohesion: 0.06
Nodes (55): _canon(), _dedup(), _deny_managed_flags(), _deny_slot_hardware_flags(), FlagProvenance, _is_flag(), normalize_argv(), NormalizedArgv (+47 more)
...
Cohesion: 0.07
Nodes (56): AbstractEventLoop, _auto_resume_interrupted_pulls(), _boot_audit_store(), _boot_background_tasks(), _boot_brain_lane(), _boot_capabilities(), _boot_dispatcher(), _boot_mcp_memory_call() (+48 more)
...
### Community 97 - "test_contract_compatibility.py"
Cohesion: 0.05
...
### Community 98 - "test_unified_bank.py"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (51): agent_activity(), install_agent(), list_agents(), list_skills(), _manager(), persona_enums(), Bundled-agent lifecycle endpoints (mounted under /api/agents).  Phase 8. Thin wr, Install a bundled agent. Body shape: ``{"name": str, "switch"?:     bool}``. (+43 more)

### Community 100 - "hardware.py"
Cohesion: 0.07
...
### Community 103 - "LlamaServerProvider"
Cohesion: 0.06
...
### Community 107 - "test_profile_derive.py"
Cohesion: 0.06
...
### Community 108 - "Any"
Cohesion: 0.06
Nodes (29): _agent_of(), bank_to_namespace(), _http_status(), namespace_to_bank(), _now(), _projects_of(), Any, Exception (+21 more)

### Community 109 - "SlotStateRecord"
Cohesion: 0.05
Nodes (47): Push a record onto every active SSE subscriber queue., Async generator yielding every slot state transition as it happens.          Use, is_transition_legal(), Any, Path, Return True if the transition from_state → to_state is allowed., Serialisable snapshot of a slot's lifecycle state on disk.      Stored as JSON a, Persist a SlotStateRecord atomically.      Tier 1 fix: matches the env-file patt (+39 more)

### Community 110 - "test_pull_routes.py"
Cohesion: 0.08
Nodes (53): app_isolated(), client_isolated(), fake_run_pull(), Any, FastAPI, MonkeyPatch, Path, TestClient (+45 more)

### Community 111 - "_FakeWrapper"
Cohesion: 0.08
Nodes (48): dispatcher(), _FakeWrapper, Any, Unit tests for :mod:`hal0.mcp.memory` schema + dispatcher.  Covers each tool's a, Per ADR-0005 §5, source is server-injected and clients cannot lie., Promoting to private:<client_id> requires an actual client_id., The standalone /mcp/memory server must surface MCP hints —     matching what the, A caller-supplied document_id reaches the wrapper (conversation upsert). (+40 more)
...
### Community 113 - "test_orchestrate.py"
Cohesion: 0.07
...
### Community 114 - "PgVectorProvider"
Cohesion: 0.06
...
### Community 115 - "models_service.py"
Cohesion: 0.07
...
### Community 116 - "FakeContainerProvider"
Cohesion: 0.06
...
### Community 119 - "load_profiles_config"
Cohesion: 0.07
Nodes (26): load_profiles_config(), Load and validate /etc/hal0/profiles.toml.      Returns a :class:`ProfilesConfig, Atomically write the operator (non-seed) profile catalog to profiles.toml., Look up a named profile in the profiles.toml catalog.      Shared by every provi, resolve_profile(), save_profiles_config(), ProfilesConfig, Parsed profiles.toml — top-level ``[profile]`` table.      Each key under ``[pro (+18 more)
...
### Community 124 - "test_auth_core.py"
Cohesion: 0.07
...
### Community 127 - "load_hal0_config"
Cohesion: 0.08
Nodes (42): MigrationPlan, _apply_store_change(), _config_to_dict(), ConfigInvalidError, _deep_merge(), get_apply_plan(), get_model_store(), get_settings() (+34 more)
...
### Community 130 - "build_auto_selections"
Cohesion: 0.07
...
### Community 131 - "migrate_slot_toml"
Cohesion: 0.07
...
### Community 132 - "UpstreamCall"
Cohesion: 0.06
Nodes (35): _default_fetch_models(), _default_is_online(), _filter_response_headers(), _join_url(), Any, AsyncClient, Response, StreamingResponse (+27 more)

### Community 133 - "SlotInterface"
Cohesion: 0.07
...
### Community 135 - "§21.4 `hal0 doctor` rework + support bundle — implementation spec"
Cohesion: 0.04
...
### Community 138 - "connect"
Cohesion: 0.08
Nodes (30): Path, connect(), db_path(), Connection, Path, SQLite connection + transaction helpers — the hal0 ``db/`` foundation.  One conn, Return the default hal0 SQLite database path.      Thin wrapper over :func:`hal0, Switch to WAL journal mode, retrying through transient contention.      The *fir (+22 more)

### Community 139 - "write_slot_toml"
Cohesion: 0.07
Nodes (34): ModelRegistry, Path, SlotManager, ChangeSet, FileState, _known_field_names(), Any, Path (+26 more)

### Community 140 - "BadRequest"
Cohesion: 0.06
...
### Community 143 - "test_board_chat_tool_use_e2e.py"
Cohesion: 0.13
...
### Community 146 - "_llama_launch_plan"
Cohesion: 0.06
...
### Community 148 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.04
...
### Community 150 - "Hal0MemoryProvider"
Cohesion: 0.08
...
### Community 151 - "TestUpstreamEntry"
Cohesion: 0.05
...
### Community 153 - "Qwen3TTSProvider"
Cohesion: 0.07
...
### Community 156 - "slot_flags_fold.py"
Cohesion: 0.07
Nodes (42): RuntimeError, list_slots(), Return all configured slot *stems* of /etc/hal0/slots/*.toml, sorted.      NAME-, apply_fold_plan(), _canon(), _chat_template_or_none(), collect_inputs(), compute_folded_tune() (+34 more)

### Community 157 - "agent_commands.py"
Cohesion: 0.05
Nodes (44): bootstrap_cli(), _detect_foreign_gateways(), CLI entry point — thin delegator to :func:`install_hermes`.      Returns a POSIX, Retired foreign-gateway scan — now a no-op shim.      hal0's single-managed-gate, agent_log(), _agent_provision_state_file(), agent_reprovision(), agent_status() (+36 more)

### Community 158 - "evalrun.py"
Cohesion: 0.09
...
### Community 159 - "schema.py"
Cohesion: 0.04
Nodes (30): ActivityConfig, AgentConfig, NpuConfig, Pydantic v2 schema models for hal0 configuration.  All TOML files under /etc/hal, # NOTE: ``map_backend_to_device`` now lives in ``hal0.model_meta`` (imported, One (slot, child) capability selection carried by a stack slot entry.      Mirro, One slot's contribution to a stack: which model/profile/caps it carries.      Re, Optional [upstream.model_filters] table — curates /v1/models advertising.      A (+22 more)

### Community 160 - "AgentMetadataConfig"
Cohesion: 0.06
...
### Community 168 - "test_container.py"
Cohesion: 0.08
Nodes (19): _model_info(), Any, Unit tests for ``hal0.providers.container.ContainerProvider``.  Issue #655 — tra, Regression guard for the 2026-06-15 chat@4096 incident: a slot whose     TOML pi, halo150/143 O8+O11: ONE render for every substrate — no version branch.      Nat, ``_container_runtime`` resolves podman wherever PATH puts it (snap,     /usr/loc, podman installed somewhere other than /usr/bin/ (snap, nix, ...)         must st, Docker is unsupported: even when only docker is on PATH, resolution         must (+11 more)

### Community 169 - "test_gpu_arbiter.py"
Cohesion: 0.10
Nodes (43): _fast_drain(), LogCaptureFixture, MonkeyPatch, Path, GpuArbiter — exclusive llm/img GPU group arbitration (Phase D, Task D4).  Spec §, load() succeeds but img slot never reaches READY within the timeout →     rollba, img is WARMING for first N polls then READY → ensure_img succeeds,     no rollba, img reaches ERROR state → rollback fires without burning the full     timeout; s (+35 more)

### Community 170 - "CapabilitySelection"
Cohesion: 0.06
...
### Community 174 - "_wire_stats"
Cohesion: 0.07
Nodes (29): _MinimalStatsStub, MonkeyPatch, TestClient, Tests for cpu_util field added to /api/stats/hardware (non-blocking psutil poll), If psutil.cpu_percent() raises, cpu_util is absent/None — no 500., HardwareStats stand-in returning a minimal snapshot (no GPU fields)., Attach the minimal stats stub to the app so _local_live_stats runs., psutil.cpu_percent(42.0) -> cpu_util == 0.42 in response. (+21 more)

### Community 175 - "json"
Cohesion: 0.06
Nodes (16): json(), AuthOpts, installAuth(), captureBulk(), LIVE_BOARD, HERMES_ACTORS, MOCK_MCP_SERVERS, routeHistory() (+8 more)

### Community 176 - "Hal0MemoryProvider"
Cohesion: 0.08
...
### Community 177 - "FakeMemoryProvider"
Cohesion: 0.06
...
### Community 179 - "Path"
Cohesion: 0.06
Nodes (42): _copy_plugin_tree(), _copy_wrapper(), _dirs_identical(), _ensure_hermes_config(), _ensure_honcho_sdk(), _hal0_service_home(), _hal0_subprocess_env(), _hermes_bin() (+34 more)

### Community 180 - "Persona"
Cohesion: 0.10
...
### Community 181 - "get_doctor"
Cohesion: 0.07
Nodes (33): get_capability_orchestrator(), get_dispatcher(), get_hardware(), get_registry(), get_slot_manager(), ModelRegistry, Request, SlotManager (+25 more)

### Community 182 - "_write_diagnostics_section"
Cohesion: 0.10
...
### Community 183 - "install_openwebui"
Cohesion: 0.08
...
### Community 193 - "test_agent_install_hermes.py"
Cohesion: 0.06
...
### Community 194 - "test_update_commands.py"
Cohesion: 0.07
...
### Community 197 - "Enum"
Cohesion: 0.08
Nodes (38): Enum, auth_require(), auth_rotate(), KeyTier, hal0 auth subcommands — thin HTTP client to /api/auth/*.  §5.2 of the R5 sync as, Persist the [security].require_auth posture (PUT /api/auth/require)., Rotate the admin or client box key (POST /api/auth/rotate).      Mints a fresh k, RequireToggle (+30 more)

### Community 198 - "Hal0Config"
Cohesion: 0.07
Nodes (28): BrainChatConfig, Hal0Config, ``[brain_chat]`` — the dashboard's agent-chat steward (hal0-brain).      Guardra, Top-level hal0.toml pydantic model.      Populated by hal0.config.loader.load_ha, No ApprovalQueue wired -> a gated admin call returns a typed error and     NOTHI, test_gated_call_fails_closed_without_queue(), _fake_request(), Any (+20 more)

### Community 199 - "HindsightProvider"
Cohesion: 0.10
...
### Community 200 - "test_hermes_provision_idempotency.py"
Cohesion: 0.09
...
### Community 201 - "test_hermes_provision_mcp_auth.py"
Cohesion: 0.10
...
### Community 202 - "TestClient"
Cohesion: 0.07
Nodes (40): Path, TestClient, Regression: the slot-edit Save's ``PATCH /defaults`` must not wipe the     model, When the NPU LLM anchor has a model bound, every trio slot gets coresident_group, GET /api/slots/{name} is enriched same shape as the list endpoint., #863: single-slot status includes argv drift without burdening list()., A failing container health probe doesn't break /api/slots.      The enrichment s, The slot HW grid (NGL / THREADS / BINARY / image_pin) is top-level slot     conf (+32 more)
...
### Community 204 - "test_unit_files.py"
Cohesion: 0.05
...
### Community 205 - "mock-data.ts"
Cohesion: 0.06
Nodes (17): installDefaultMocks(), BOARD_ASSIGNEES, BOARD_BOARDS, BOARD_CONFIG, BOARD_ORCH_DEFAULT, BOARD_PROFILES, BOARD_STATS, BOARD_TASKS (+9 more)

### Community 206 - "R5 sync assessment — how far every surface is from "back in sync" (2026-07-19)"
Cohesion: 0.05
...
### Community 208 - "resolve_gpu_group_ids"
Cohesion: 0.07
...
### Community 210 - "test_model_store.py"
Cohesion: 0.10
...
### Community 211 - "test_chat_proxy_auth.py"
Cohesion: 0.07
...
### Community 224 - "StackConfig"
Cohesion: 0.12
Nodes (22): One ``[stack.<slug>]`` entry in stacks.toml.      A curated bundle of slots + em, StackConfig, Pre-apply sanity check: flag entries whose profile/model won't resolve., StackCapabilityRow, Records capability apply() calls., RecordingOrchestrator, _engine(), PS-5: StackApplyEngine.validate flags unresolved profile/model refs.  A stack ca (+14 more)
...
### Community 229 - "SlotIdentityStore"
Cohesion: 0.13
...
### Community 230 - "test_memory_graph_route.py"
Cohesion: 0.13
...
### Community 236 - "resolve_role_slots"
Cohesion: 0.13
...
### Community 239 - "test_agent_uninstall_memory.py"
Cohesion: 0.11
...
### Community 241 - "plan_slot_flags_fold"
Cohesion: 0.10
Nodes (33): plan_slot_flags_fold(), A slot's identity + the flag surface it contributes to the fold., Compute the fold plan without touching disk or the registry.      Args:, SlotRef, _FakeRegistry, Tests for the FLAGS-own one-shot migrator (spec-flags-ownership §5).  Covers: so, Two slots sharing one model with conflicting templates → refuse, don't     silen, One slot with chat_template='auto' and one absent both normalize to None     → c (+25 more)
...
### Community 252 - "write_toml_atomic"
Cohesion: 0.10
...
### Community 260 - "hw_slot_ownership.py"
Cohesion: 0.11
...
### Community 267 - "browser_server.py"
Cohesion: 0.10
...
### Community 268 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.06
...
### Community 272 - "test_doctor_json_diagnoses.py"
Cohesion: 0.10
...
### Community 276 - "test_tts_capability_switch.py"
Cohesion: 0.07
...
### Community 278 - "portable.py"
Cohesion: 0.10
Nodes (30): _checksum(), export_envelope(), import_stack(), ModelResolution, parse_envelope(), Any, ModelRegistry, Path (+22 more)
...
### Community 281 - "test_aggregator.py"
Cohesion: 0.14
...
### Community 282 - "Platform-wide cron/automation management — design"
Cohesion: 0.06
...
### Community 284 - "hal0 ROCmFPX quantization"
Cohesion: 0.06
...
### Community 285 - "test_upstream_dedup.py"
Cohesion: 0.10
Nodes (29): _fetch_hal0_composite_models(), _hal0_model_cache_clear(), Punch the composite catalogue's cached model list.      Exposed so slot-swap / s, Aggregate every ready chat-capable slot's model id into one catalogue.      Dire, _FakeSlotManager, Any, R4 H2 regression + P2-composite rebuild — direct-read model catalogue.  The bug:, If ``hal0`` is already registered (operator override via     upstreams.toml) pri (+21 more)

### Community 286 - "secrets.py"
Cohesion: 0.11
Nodes (31): _api_env(), delete_secret(), _emit(), list_secrets(), Any, Path, Request, Response (+23 more)

### Community 287 - "api_get"
Cohesion: 0.09
Nodes (29): board_list(), board_show(), hal0 board subcommands — thin HTTP client to /api/board/* (§5.2).  A small opera, List tasks by lane (GET /api/board/board)., Show one task (GET /api/board/tasks/{id})., Sync Honcho conclusions → Hindsight (resumes from the saved watermark).      Equ, sync_graph_cmd(), _derived_tags() (+21 more)

### Community 288 - "test_slot_migrate_id_keying.py"
Cohesion: 0.10
...
### Community 291 - "memory.py"
Cohesion: 0.14
Nodes (31): build_server(), _iso_now(), make_dispatcher(), _memory_add(), _memory_delete(), _memory_list(), _memory_recall(), _memory_search() (+23 more)
...
### Community 294 - "test_slot_aliases.py"
Cohesion: 0.06
Nodes (25): mock_slot_manager(), Path, Tests for the slot back-compat alias system (issue #654 / #633, ADR-0023).  ADR-, _resolve_alias("agent-hermes") == "agent" and the agent TOML exists., list() enumerates TOMLs from disk — no alias appears in the result., iter_configs() is driven by disk TOMLs — aliases never appear., No alias map; hal0/primary is not a known virtual., ADR-0023: ``primary`` is no longer an alias — a body model=primary finds     no (+17 more)

### Community 295 - "BaseModel"
Cohesion: 0.12
Nodes (30): BaseModel, The supplied credential was rejected., Unauthorized, PersonaApprovalUpdate, Partial ``[persona.approval]`` patch. Omitted fields are unchanged., _client_ip(), exposure(), ExposureAllowlistEntry (+22 more)

### Community 296 - "ML-2 (file-set pulling) + ML-3 (unified store) — implementation spec"
Cohesion: 0.06
...
### Community 299 - "tx"
Cohesion: 0.12
Nodes (18): _null_model_hw_columns(), NULL the ``n_gpu_layers``/``preferred_runner`` columns for ``model_ids``.      B, Wrap a write in an explicit ``BEGIN IMMEDIATE`` … ``COMMIT``/``ROLLBACK``., tx(), _copy_model_files_refcounted(), Replicate ``source_id``'s ``model_file`` rows under ``new_id``, bumping     each, db_path(), Path (+10 more)

### Community 300 - "ModelsConfig"
Cohesion: 0.09
...
### Community 303 - "import_toml_to_sqlite"
Cohesion: 0.12
...
### Community 310 - "flm_served_models"
Cohesion: 0.09
...
### Community 311 - "test_agents_personas.py"
Cohesion: 0.15
...
### Community 314 - "test_journal_routes.py"
Cohesion: 0.13
...
### Community 315 - "test_board_chat_admin_tools.py"
Cohesion: 0.12
...
### Community 316 - "test_board_routes.py"
Cohesion: 0.10
...
### Community 317 - "test_uninstall.py"
Cohesion: 0.10
...
### Community 318 - "FakeUpstreamRegistry"
Cohesion: 0.12
...
### Community 320 - "test_degrade_live.py"
Cohesion: 0.11
...
### Community 326 - "P3-slots: Decomposition Spec for `slots/manager.py`"
Cohesion: 0.07
...
### Community 328 - "hal0_slot_alias_models"
Cohesion: 0.12
...
Cohesion: 0.09
Nodes (23): exit_code_for(), Diagnosis, ``hal0 doctor``'s CLI-side ``Diagnosis`` re-export + adapters (§21.4).  The data, The stable ``--json`` shape every doctor subcommand prints.      ``json.dumps(.., The §4.2 generic ``--json`` exit-code translation: critical->2,     fail/warn->1, render_json(), Evidence, One piece of proof backing a :class:`Diagnosis` — a probe result, a     file sta (+15 more)

### Community 331 - "MemoryConfig"
Cohesion: 0.10
Nodes (19): MemoryConfig, [memory] section of hal0.toml.      Container for the per-subsystem memory tunab, _build(), FastAPI, TestClient, Memory gate — ``[memory].enabled`` toggles the whole subsystem.  The memory engi, Build a fresh app + client with ``[memory].enabled`` set (or left at     its sch, No hal0.toml at all → the schema default (`enabled=True`) applies. (+11 more)

### Community 332 - "Conflict"
Cohesion: 0.11
...
### Community 335 - "test_hal0_memory_client.py"
Cohesion: 0.10
...
### Community 336 - "test_config_urls.py"
Cohesion: 0.10
...
### Community 337 - "test_workflow_contract.py"
Cohesion: 0.15
...
### Community 338 - "test_hindsight_boot_probe.py"
Cohesion: 0.10
...
### Community 339 - "Tier 2 — medium (one PR each)"
Cohesion: 0.07
...
### Community 340 - "PART 0 — Current registry, mapped (file:line)"
Cohesion: 0.07
...
### Community 345 - "merge_slot_config"
Cohesion: 0.11
...
### Community 347 - "test_v1_audio.py"
Cohesion: 0.13
...
### Community 348 - "_container_npu_cfg"
Cohesion: 0.10
...
### Community 349 - "test_pressure_eviction.py"
Cohesion: 0.20
...
### Community 351 - "Recommended hal0 ideas"
Cohesion: 0.07
...
### Community 352 - "hal0 Hermes Integration Suite Implementation Plan"
Cohesion: 0.07
...
### Community 354 - "_shared.py"
Cohesion: 0.12
Nodes (26): agent_uninstall(), Uninstall a bundled agent., _api_reachable(), api_delete(), api_get_bytes(), _api_request(), api_stream(), api_unreachable_exit() (+18 more)

### Community 355 - "installed.py"
Cohesion: 0.14
Nodes (25): get_installed(), _harden_registry_perms(), install(), InstalledServer, list_installed(), patch_config(), Any, Path (+17 more)

### Community 356 - "test_services_page.py"
Cohesion: 0.11
Nodes (20): Declarative catalog of hal0 companion services.  One ``ServiceDef`` per service,, Look up a service definition, or None for unknown ids., service_by_id(), TestClient, Tests for the services management surface (GET/POST /api/services…).  Covers the, Minimal app with only the services management router mounted., Patchers pinning every probe/systemd source to a neutral down state., _services_by_id() (+12 more)

### Community 357 - "test_agent_restart_endpoint.py"
Cohesion: 0.18
...
### Community 360 - "test_npu_occupancy.py"
Cohesion: 0.15
...
### Community 363 - "test_event_contract.py"
Cohesion: 0.15
...
### Community 364 - "test_migrate_haloai.py"
Cohesion: 0.15
...
### Community 365 - "test_npu_exclusivity.py"
Cohesion: 0.12
...
### Community 367 - "ML-4 (runner-image registry) + ML-5 (flag resolution) — implementation-ready spec"
Cohesion: 0.08
...
### Community 368 - "R5 — Surface + launch"
Cohesion: 0.08
...
### Community 369 - "journal.py"
Cohesion: 0.15
Nodes (25): LevelFilter, _bus(), _collect(), get_journal(), _hal0_event_to_entry(), JournalEntry, _passes_filters(), Any (+17 more)

### Community 370 - "types.py"
Cohesion: 0.11
Nodes (21): ModuleType, Shared types for the hal0 Hermes transport., _resolve_pull_capability — capability + comfyui_subdir for a pull (P3).  The hel, _Reg, _req(), test_body_capability_wins(), test_curated_capability_and_subdir_fallback(), test_registry_capability_used_when_no_body() (+13 more)
...
### Community 374 - "HermesBoardExecutor"
Cohesion: 0.15
...
### Community 375 - "upstream_commands.py"
Cohesion: 0.10
...
### Community 377 - "test_emit_answers.py"
Cohesion: 0.14
...
### Community 380 - "evaluate_model_fit"
Cohesion: 0.13
...
### Community 381 - "validate_delegation"
Cohesion: 0.11
Nodes (25): _build_delegation_messages(), build_delegation_messages_for_slot(), _is_chat_slot(), _model_of(), Any, ``route_to_chat`` dispatch — plan §7.4.  One-shot delegation: the calling LLM ha, Build the messages array for a delegation chat request.      Per plan §7.4 step, Build delegation messages from a typed ``LoadedSlot`` view. (+17 more)

### Community 382 - "OmniRouter"
Cohesion: 0.11
Nodes (17): OmniRouter, Any, AsyncClient, OmniRouter — the public surface.  Wires :mod:`hal0.omni_router.filter`, :mod:`ha, Drive the OpenAI tool-calling loop against ``/v1/chat/completions``.          Ar, Build a DispatchContext wired with a chat_completion callback.          The call, POST ``/v1/chat/completions`` and return the parsed body.          Errors are su, Drop hal0-specific knobs that must not reach the upstream. (+9 more)

### Community 383 - "discover.py"
Cohesion: 0.09
Nodes (24): _is_mmproj_sidecar(), _is_skippable(), _match_curated(), _normalise_id(), Path, Model discovery — scan filesystem roots and auto-register found models.  The sca, Turn a basename stem into a registry-friendly id., Return the curated entry whose ``hf_file`` equals ``filename``. (+16 more)
...
### Community 389 - "test_env_writer.py"
Cohesion: 0.13
...
### Community 391 - "test_flm_container_spec.py"
Cohesion: 0.17
...
### Community 392 - "test_id_keying.py"
Cohesion: 0.20
...
### Community 394 - "test_prewire_smoke.py"
Cohesion: 0.10
...
### Community 395 - "What You Must Do When Invoked"
Cohesion: 0.08
...
### Community 397 - "hal0 benchmarking system — full design (batch runs, rich run detail, display, auto-update)"
Cohesion: 0.08
...
### Community 403 - "_phase_preflight"
Cohesion: 0.09
Nodes (25): _ensure_supported_python(), path_is_writable(), _persist_hermes_python(), _phase_preflight(), _provision_python_via_uv(), _python_range_error(), Whether we can actually create a file at (or under) ``target``.      Walks up to, Hard-fail when the host can't host Hermes.      Documented blockers (plan §4): (+17 more)
...
### Community 409 - "unknown_slot_config_keys"
Cohesion: 0.12
...
### Community 410 - "test_dashboard_layout.py"
Cohesion: 0.11
...
### Community 411 - "test_logs_routes.py"
Cohesion: 0.11
...
### Community 412 - "_seed_slot_toml"
Cohesion: 0.08
Nodes (25): npu_trio_slot_root(), coresident_group must key off device==npu, not the legacy slot names.      Deplo, Lay down the NPU FLM trio (agent + stt-npu + embed-npu) on disk., A model-less NPU LLM anchor → no trio markers on the siblings (#1369).      This, spec-hw-slot-ownership §1: a stray slot-level ``enable_thinking`` (pre-     migr, rope_freq_base absent on disk → payload carries null (not 0.0)., PUT /api/slots/{name}/config with model.rope_freq_base persists the value     an, PR-18: ``labels`` is lifted from ``[model] labels = [...]``.      The dashboard' (+17 more)

### Community 413 - "test_v1_models_filters.py"
Cohesion: 0.20
...
### Community 416 - "test_seeds_data.py"
Cohesion: 0.08
...
### Community 417 - "test_memory_delete_auth.py"
Cohesion: 0.11
...
Cohesion: 0.08
Nodes (23): [0.9.4.1] — 2026-07-08, [0.9.4] — 2026-07-08, [0.9.5.2] — 2026-07-09, Added, Added, Added, Added, Changed (+15 more)

### Community 419 - "hal0 installer"
Cohesion: 0.08
...
### Community 421 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.08
...
### Community 422 - "hal0 1.0 — Seeded profile rework"
Cohesion: 0.08
...
### Community 423 - "Hermes Python 3.12 Cross-Distro Installation Design"
Cohesion: 0.08
...
### Community 424 - "comfyui.py"
Cohesion: 0.12
Nodes (23): aclose_client(), _comfyui_container(), _comfyui_models_dir(), comfyui_models_fetch(), comfyui_status(), _container_state(), _count_models(), _engine_state() (+15 more)
...
### Community 427 - "applied_versions"
Cohesion: 0.13
...
### Community 428 - "seed_static_slots"
Cohesion: 0.17
...
### Community 429 - "slot_write_lock"
Cohesion: 0.15
Nodes (19): device_to_backend(), Map hal0's ``device`` enum onto the recipe+backend pair.      Args:         devi, Hold the coarse cross-process lock for ALL slots/*.toml writes.      Historicall, slot_write_lock(), apply_preferred_profile(), defuse_stale_mtp_on_swap(), preferred_profile_for(), profile_fits_slot() (+11 more)

### Community 430 - "test_run_as_hal0_guard.py"
Cohesion: 0.13
...
### Community 431 - "test_brain_self_auth.py"
Cohesion: 0.18
...
### Community 433 - "test_npu_columns.py"
Cohesion: 0.15
...
### Community 438 - "map_backend_to_device"
Cohesion: 0.13
...
### Community 439 - "test_hw_slot_ownership_migration.py"
Cohesion: 0.23
...
### Community 440 - "MemoryNamespaceError"
Cohesion: 0.15
...
### Community 442 - "apply_thinking_policy"
Cohesion: 0.15
...
### Community 445 - "container_enrichment"
Cohesion: 0.22
...
### Community 446 - "test_agent_memory_stats_endpoint.py"
Cohesion: 0.16
...
### Community 447 - "test_backends_npu_canonical_fields.py"
Cohesion: 0.13
...
### Community 452 - "_RecordingSlotManager"
Cohesion: 0.15
...
### Community 455 - "test_unified_project_scope.py"
Cohesion: 0.17
...
### Community 458 - "UI drawers — slot/model/profile editors"
Cohesion: 0.09
...
### Community 459 - "hal0 Settings Menu — Wireframe / IA"
Cohesion: 0.09
...
### Community 463 - "services.py"
Cohesion: 0.14
Nodes (21): list_services(), mdns_apply(), mdns_status(), _mdns_url(), _probe(), _probe_http_env(), _public_url(), Any (+13 more)
...
### Community 465 - "test_slot_config_validation.py"
Cohesion: 0.20
...
### Community 471 - "_hermes_fakes.py"
Cohesion: 0.11
...
### Community 473 - "test_providers.py"
Cohesion: 0.14
...
### Community 489 - "hal0_llm_slot_views"
Cohesion: 0.13
...
### Community 491 - "slots_config_dir"
Cohesion: 0.18
...
### Community 493 - "test_fetch_ws_g.py"
Cohesion: 0.14
...
### Community 496 - "build_workflow"
Cohesion: 0.16
Nodes (20): build_workflow(), _coerce_float(), _coerce_int(), _load_template(), _parse_size(), Any, OpenAI ``/v1/images/generations`` → ComfyUI prompt-graph translator.  ComfyUI ex, Resolve a model_class string to a template stem.      Falls back to ``sdxl_turbo (+12 more)

### Community 497 - "backends.py"
Cohesion: 0.18
...
### Community 501 - "test_hermes_provision_honcho.py"
Cohesion: 0.16
...
### Community 503 - "test_pull_shutdown.py"
Cohesion: 0.17
...
### Community 504 - "test_throughput_history.py"
Cohesion: 0.19
...
### Community 505 - "test_eligibility.py"
Cohesion: 0.10
...
### Community 506 - "test_model_less_capability_slot_is_not_woken"
Cohesion: 0.20
...
### Community 507 - "Security review — v1.0 auth surface (2026-05-21)"
Cohesion: 0.10
...
### Community 508 - "_write_fake_python"
Cohesion: 0.20
...
### Community 511 - "activity-log.spec.ts"
Cohesion: 0.15
Nodes (17): emitSse(), emitSseTyped(), installSseHarness(), waitForSse(), emitWs(), emitAndAwait(), ERR_REC, frame() (+9 more)

### Community 512 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.10
...
### Community 517 - "test_board_dispatch.py"
Cohesion: 0.19
...
### Community 518 - "memory_commands.py"
Cohesion: 0.13
Nodes (19): disable_cmd(), enable_cmd(), graph_disable_cmd(), honcho_render_env_cmd(), provider_list_cmd(), provider_set_cmd(), Any, hal0 memory subcommands — graph-extraction gate.  Mirrors the slot / model CLI s (+11 more)
...
### Community 522 - "_reconcile_device_profile"
Cohesion: 0.20
...
### Community 527 - "test_memory_provider_commands.py"
Cohesion: 0.14
...
### Community 528 - "test_model_first_run_commands.py"
Cohesion: 0.17
...
### Community 529 - "test_model_store_root.py"
Cohesion: 0.14
...
### Community 531 - "TestEarlyHal0User"
Cohesion: 0.10
...
### Community 533 - "test_comfyui_workflows.py"
Cohesion: 0.15
Nodes (19): _baseline_body(), Any, Unit tests for the OpenAI → ComfyUI workflow translator.  The translator is a pu, Two calls without an explicit seed produce different seeds (probabilistically)., The CheckpointLoaderSimple node holds the actual model filename., The _meta block is template-only; ComfyUI's /prompt would 422 on it., Curated catalogue's image entries map to known templates., 64x absurd dimensions should be clamped before they crash the slot. (+11 more)

### Community 534 - "MapContainerProvider"
Cohesion: 0.17
...
### Community 536 - "0. Research-grounded findings that drive the matrix"
Cohesion: 0.11
...
### Community 543 - "build_admin_route_map"
Cohesion: 0.11
...
### Community 544 - "test_models_add_from_path.py"
Cohesion: 0.20
...
### Community 549 - ".json"
Cohesion: 0.11
Nodes (18): #585: the dashboard writes ``ctx_size``; it must persist as the canonical     ``, #1369: membership follows the anchor, with no per-sibling opt-out.      The shad, A slot's [model].n_gpu_layers rides along in the payload., idle_timeout_s / workers / llamacpp_args ride along on /api/slots.      The on-d, v0.1.x clients consuming /api/slots see every legacy key unchanged., PR-18: each entry carries ``type`` + ``model_default``.      The dashboard's per, Labels list is omitted (not empty) when the slot config has no     ``model.label, device=npu slots surface declared_backend='flm' (the FLM recipe). (+10 more)

### Community 550 - "FakeSlotManager"
Cohesion: 0.18
...
### Community 551 - "test_capabilities_commands.py"
Cohesion: 0.19
...
### Community 553 - "test_store_concurrency.py"
Cohesion: 0.19
...
### Community 555 - "test_load_converges_config.py"
Cohesion: 0.24
...
### Community 556 - "hal0 architecture & reference"
Cohesion: 0.11
...
### Community 557 - "FakeDelegateRunner"
Cohesion: 0.16
...
### Community 558 - "2. Bugs (correctness — ordered by impact)"
Cohesion: 0.11
...
### Community 559 - "manage-slots.mdx"
Cohesion: 0.11
...
### Community 565 - "ProgressCoalescer"
Cohesion: 0.14
...
### Community 570 - "fetch_npu_swap_status"
Cohesion: 0.14
...
### Community 576 - "test_hermes_security_deliverables.py"
Cohesion: 0.15
...
### Community 579 - "FakeUpstreamRegistry"
Cohesion: 0.18
...
### Community 580 - "test_models_preview.py"
Cohesion: 0.19
...
### Community 582 - "test_settings_apply.py"
Cohesion: 0.11
...
### Community 583 - "test_v1_dispatch.py"
Cohesion: 0.16
...
### Community 584 - "test_doctor_perms.py"
Cohesion: 0.19
...
### Community 587 - "FakeLocalBackend"
Cohesion: 0.17
...
### Community 589 - "_render_from_spec"
Cohesion: 0.22
...
### Community 591 - "3. Proposed seed catalog (one per type)"
Cohesion: 0.12
...
### Community 592 - "Slot config — capabilities ↔ slots reconciliation"
Cohesion: 0.12
...
### Community 593 - "hal0 Adoption Candidates — Lemonade + ODS (combined)"
Cohesion: 0.12
...
### Community 594 - "spec-hp-realtime — OpenAI Realtime WebSocket endpoint for hal0"
Cohesion: 0.12
...
### Community 595 - "P3-schema — `config/schema.py` decomposition: implementation-ready spec"
Cohesion: 0.12
...
### Community 596 - "Prerelease Preview Pipeline Hardening"
Cohesion: 0.12
...
### Community 598 - "comfyui_switchover"
Cohesion: 0.18
Nodes (17): _arbiter_unavailable(), comfyui_invalid_workflow_launch(), comfyui_logs(), comfyui_pin(), comfyui_restart(), comfyui_switchover(), _get_arbiter(), BackgroundTasks (+9 more)

### Community 599 - "test_schema.py"
Cohesion: 0.21
...
### Community 600 - "test_schema_seeds_c5.py"
Cohesion: 0.15
...
### Community 602 - "apply_extraction_slot"
Cohesion: 0.18
...
### Community 604 - "normalize_system_messages"
Cohesion: 0.18
...
### Community 606 - "FakeManager"
Cohesion: 0.15
Nodes (10): ArbiterPinned, Restore refused — image mode is manually pinned (force to override)., fake_mgr(), FakeManager, DR-2: a committed dispatch ticket keeps the drain alive until released.      ``s, Dict-driven SlotManager stub.      ``in_flight`` values may be an int (constant), Resident design default: an hour of UI time before auto-restore., test_arbiter_default_idle_window_is_60() (+2 more)

### Community 607 - "metrics_collect.py"
Cohesion: 0.15
...
### Community 608 - "snapshot_live_stack"
Cohesion: 0.30
...
### Community 609 - "test_hermes_state_render.py"
Cohesion: 0.12
...
### Community 610 - "_StubSlotManager"
Cohesion: 0.26
...
### Community 611 - "test_cli_auth_streamtest.py"
Cohesion: 0.21
...
### Community 612 - "Findings from the 2026-05-16 hal0-test deep-probe round"
Cohesion: 0.12
...
### Community 613 - "DelegateTaskSpec"
Cohesion: 0.18
...
### Community 614 - "test_preflight_ports_own_service.py"
Cohesion: 0.29
...
### Community 615 - "agents-overview.jsx"
Cohesion: 0.20
...
### Community 616 - "test_npu_trio_shadow.py"
Cohesion: 0.17
...
### Community 617 - "test_ttft_samples.py"
Cohesion: 0.12
...
### Community 622 - "hal0_gpu_gate.py"
Cohesion: 0.16
...
### Community 623 - "qwen3tts_server.py"
Cohesion: 0.16
...
### Community 625 - "hal0_chat_slot_alias_map"
Cohesion: 0.12
Nodes (15): hal0_chat_slot_alias_map(), Return ``{slot_alias: model_id}`` for model-bound llm slots.      The slot **ali, _capability_slot_for_path(), _ensure_backend_for_model(), #430: load a slot-backed model under its DECLARED backend before routing.      W, Resolve a path-pinned capability slot name (embed/rerank/tts/img).      Mirrors, DR-1: wake an idle-EVICTED path-pinned capability slot before dispatch.      The, _wake_capability_slot() (+7 more)

### Community 626 - "events.py"
Cohesion: 0.19
Nodes (15): _bus(), EventsInvalidQuery, EventsUnavailable, list_events(), _normalise_severity(), Any, Request, StreamingResponse (+7 more)

### Community 627 - "logs.py"
Cohesion: 0.19
...
### Community 629 - "system_info_command.py"
Cohesion: 0.18
...
### Community 633 - "RecordingSlotArtifactOps"
Cohesion: 0.22
...
### Community 634 - "test_hermes_provision_install_artifacts.py"
Cohesion: 0.17
...
### Community 635 - "test_agents_routes.py"
Cohesion: 0.21
...
### Community 636 - "test_mcp_identity.py"
Cohesion: 0.18
...
### Community 637 - "test_catalog_backends.py"
Cohesion: 0.19
...
### Community 638 - "FakeDockerBackend"
Cohesion: 0.16
...
### Community 639 - "hal0 test harness — internal contributor guide"
Cohesion: 0.12
...
### Community 641 - "Model registry — registry, pulls, classification"
Cohesion: 0.13
...
### Community 642 - "Handoff: qwen3tts standalone → hal0-slot migration"
Cohesion: 0.13
...
### Community 643 - "Container Image System Overhaul"
Cohesion: 0.13
...
### Community 644 - "hal0 rework plan — de-scarring the launch"
Cohesion: 0.13
...
### Community 645 - "Handoff — brain + embed slot/agent cleanup on halo150"
Cohesion: 0.13
...
### Community 646 - "Handoff — γ-suite (chromium) persistently red on main (#1333)"
Cohesion: 0.13
...
### Community 647 - "Handoff — fold rework→main merge/meld/fix follow-ups into the R5 docs"
Cohesion: 0.13
...
### Community 648 - "Handoff — hal0 R5 endgame (paste-in brief for a new session)"
Cohesion: 0.13
...
### Community 649 - "Findings (O-series)"
Cohesion: 0.13
...
### Community 651 - "hal0 Hermes Integration Suite Design"
Cohesion: 0.13
...
### Community 652 - "PR #1330 CI Repair Design"
Cohesion: 0.13
...
### Community 654 - "test_route_collisions.py"
Cohesion: 0.19
...
### Community 656 - "test_hermes_live_resolve_render.py"
Cohesion: 0.19
...
### Community 657 - "upsert_env_value"
Cohesion: 0.21
...
### Community 658 - "create_chat_template"
Cohesion: 0.24
...
### Community 659 - "test_slots_policy.py"
Cohesion: 0.26
...
### Community 663 - "model_commands.py"
Cohesion: 0.17
Nodes (14): _fmt_size(), model_list(), model_pull(), model_register(), model_show(), model_update(), _poll_pull_progress(), hal0 model subcommands — thin HTTP client to the hal0 API. (+6 more)

### Community 664 - "profiles_toml"
Cohesion: 0.29
...
### Community 665 - "write_openwebui_env"
Cohesion: 0.18
...
### Community 667 - "test_hermes_provision_kanban_db_init.py"
Cohesion: 0.20
...
### Community 668 - "test_persona_update.py"
Cohesion: 0.25
...
### Community 669 - "test_slots_routes.py"
Cohesion: 0.26
...
### Community 671 - "test_brain_ctx_precheck.py"
Cohesion: 0.23
...
### Community 674 - "test_pool_bounds.py"
Cohesion: 0.15
...
### Community 676 - "test_api_restart_on_upgrade.py"
Cohesion: 0.28
...
### Community 677 - "test_admin_route_map.py"
Cohesion: 0.17
...
### Community 678 - "test_container_mmproj.py"
Cohesion: 0.31
...
### Community 679 - "test_release_check.py"
Cohesion: 0.37
...
### Community 680 - "test_device_profile_coherence.py"
Cohesion: 0.18
...
### Community 681 - "test_mtp_defuse.py"
Cohesion: 0.34
...
### Community 682 - "test_preload_eviction.py"
Cohesion: 0.26
...
### Community 683 - "test_integrations.py"
Cohesion: 0.13
...
### Community 684 - "Contributing to hal0"
Cohesion: 0.14
...
### Community 685 - "Toolbox Repo Consolidation"
Cohesion: 0.14
...
### Community 686 - "obtain-models.mdx"
Cohesion: 0.14
...
### Community 687 - "Deploy halves of the "CI here" scenarios"
Cohesion: 0.14
...
### Community 688 - "PART 2 — DELIVERABLES"
Cohesion: 0.14
...
### Community 689 - "0. EXACT Honcho footprint (file:line)"
Cohesion: 0.14
...
### Community 690 - "P2-device: make `device` the sole truth, delete the `backend` dual-write"
Cohesion: 0.14
...
### Community 691 - "Handoff — R5 drive 2: put it back together (paste-in prompt, Fable orchestrator)"
Cohesion: 0.14
...
### Community 692 - "hal0 1.0 Seeded Profile Rework — Implementation Plan"
Cohesion: 0.14
...
### Community 694 - "Phase 4 handoff — halo143 deploy window"
Cohesion: 0.14
...
### Community 696 - "Any"
Cohesion: 0.16
Nodes (14): _arbiter_api_mode(), _as_pct(), _bytes_to_gb(), _gpu_telemetry(), _latest_output_image(), _mhz_to_ghz(), _parse_memory(), Any (+6 more)

### Community 697 - "_fetch_json"
Cohesion: 0.20
Nodes (14): _build_client(), _comfyui_base_url(), comfyui_preview(), comfyui_render_cancel(), comfyui_workflow_launch(), _fetch_json(), _get_client(), AsyncClient (+6 more)

### Community 698 - "services_health"
Cohesion: 0.19
Nodes (13): _queue_counts(), _openwebui_url(), _probe_comfyui(), _probe_hermes(), _probe_openwebui(), Any, GET /api/services/health — dashboard services health aggregator.  Returns a stab, Real reachability probe — GET <loopback>/health on OpenWebUI.      SpikeB §5.4 c (+5 more)
...
### Community 704 - "MetricsRetention"
Cohesion: 0.18
...
### Community 706 - "arbiter.py"
Cohesion: 0.16
Nodes (13): _comfyui_base_url(), _comfyui_free(), _comfyui_queue_counts(), GpuImgNotReady, GpuInferenceMode, GpuArbiter — exclusive llm/img GPU group arbitration (spec §7, Phase D).  Strix, Operational ComfyUI HTTP base (mirrors api/routes/comfyui.py).      Duplicated o, Best-effort ``POST /free`` — drop ComfyUI's models from GTT.      True on a 200; (+5 more)

### Community 707 - "heal_missing_llm_type"
Cohesion: 0.20
...
### Community 708 - "provider_requires_model"
Cohesion: 0.22
...
### Community 709 - "test_hermes_provision_context.py"
Cohesion: 0.14
...
### Community 710 - "test_mcp_client.py"
Cohesion: 0.23
...
### Community 714 - "test_brain_chat.py"
Cohesion: 0.23
...
### Community 715 - "test_auth_commands.py"
Cohesion: 0.23
...
### Community 716 - "test_memory_ops_commands.py"
Cohesion: 0.16
...
### Community 717 - "test_slot_verb_aliases.py"
Cohesion: 0.16
...
### Community 718 - "test_hal0_gpu_gate.py"
Cohesion: 0.22
...
### Community 719 - "test_image_pin.py"
Cohesion: 0.14
...
### Community 720 - "test_flm_store_link.py"
Cohesion: 0.26
...
### Community 722 - "test_adopted_slot_eviction.py"
Cohesion: 0.23
...
### Community 723 - "test_dispatchable_ready_set_single_source.py"
Cohesion: 0.14
...
### Community 724 - "test_restart_errored_slot.py"
Cohesion: 0.26
...
### Community 728 - "Contributor Covenant Code of Conduct"
Cohesion: 0.15
Nodes (12): 1. Correction, 2. Warning, 3. Temporary Ban, 4. Permanent Ban, Attribution, Contributor Covenant Code of Conduct, Enforcement, Enforcement Guidelines (+4 more)

### Community 729 - "3. Recommendation: how hal0 should support ONNX"
Cohesion: 0.15
...
### Community 730 - "Dispatch / runtime — routing, arbiter, lifecycle"
Cohesion: 0.15
...
### Community 733 - "pull-and-register-models.mdx"
Cohesion: 0.15
...
### Community 734 - "hal0 rework — handoff: single primary orchestrator (R3-B / R4 / R5 + finish line)"
Cohesion: 0.15
...
### Community 735 - "Changes Applied (then rolled back)"
Cohesion: 0.15
...
### Community 736 - "hal0 codebase map"
Cohesion: 0.15
...
### Community 737 - "hal0 service management"
Cohesion: 0.15
...
### Community 738 - "QueryStringScrubber"
Cohesion: 0.18
...
### Community 742 - "test_containers_apparmor.py"
Cohesion: 0.37
...
### Community 744 - "test_activity.py"
Cohesion: 0.31
...
### Community 745 - "test_activity_routes_instrumented.py"
Cohesion: 0.38
...
### Community 746 - "test_comfyui_fetch_route.py"
Cohesion: 0.15
...
### Community 747 - "test_events_fixes.py"
Cohesion: 0.19
...
### Community 749 - "test_memory_graph_commands.py"
Cohesion: 0.15
...
### Community 750 - "test_model_verbs.py"
Cohesion: 0.26
...
### Community 753 - "_RecordingProvider"
Cohesion: 0.24
...
### Community 758 - "Recently added endpoints"
Cohesion: 0.17
...
### Community 759 - "HW-slot-ownership — hardware sticks to slots, logical tune sticks to models"
Cohesion: 0.17
...
### Community 760 - "Design — 3-tier, deny-by-default, single classification source"
Cohesion: 0.17
...
### Community 761 - "hal0 UI/UX design brief — post-R3 surface rework"
Cohesion: 0.17
...
### Community 765 - "Release pipeline — prototype findings + blockers"
Cohesion: 0.17
...
### Community 772 - "test_board_ws.py"
Cohesion: 0.32
...
### Community 773 - "test_agent_status.py"
Cohesion: 0.23
...
### Community 775 - "test_system_info.py"
Cohesion: 0.26
...
### Community 776 - "test_comfyui_scripts_shipped.py"
Cohesion: 0.17
...
### Community 777 - "_img_mode_arbiter"
Cohesion: 0.20
...
### Community 778 - "test_static_seeds.py"
Cohesion: 0.17
...
### Community 780 - "`hal0-setup.yaml` — headless answer-file spec (2026-07-05)"
Cohesion: 0.18
...
### Community 781 - "Findings → fixes, by tier"
Cohesion: 0.18
...
### Community 782 - "Handoff: model-pipeline plan — finish-out pass"
Cohesion: 0.18
...
### Community 783 - "Hal0 Upstream Controls — Epic Plan (2026-07-06)"
Cohesion: 0.18
...
### Community 784 - "capabilities-and-profiles.mdx"
Cohesion: 0.18
...
### Community 785 - "Admin tools (`/mcp/admin`)"
Cohesion: 0.18
...
### Community 786 - "providers-profiles-devices.mdx"
Cohesion: 0.18
...
### Community 787 - "slot-lifecycle.mdx"
Cohesion: 0.18
...
### Community 788 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
...
### Community 789 - "Both-boxes deploy-validation runbook — rework-R4-stage"
Cohesion: 0.18
...
### Community 790 - "P3-brain — Implementation-Ready Spec: hal0-brain as a first-class module"
Cohesion: 0.18
...
### Community 791 - "PART D — Edit plan (files, order, delegators/shims)"
Cohesion: 0.18
...
### Community 792 - "hal0 Hermes Plugin Suite — BUILD Spec (verified vs code @ `rework/descar`)"
Cohesion: 0.18
...
### Community 793 - "Hermes Agent official integration research for the hal0 rework"
Cohesion: 0.18
...
### Community 794 - "2. Proposed hal0 plugin suite"
Cohesion: 0.18
...
### Community 795 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
Nodes (10): Board row = the machine-readable record, Checkpoint (R1–R5) → main, hal0 rework — board tracking protocol (paste-in prompt), Hard rules (never violate), Lifecycle of a lane (how a row moves), Migration-window lanes, Monitor, Reusable agent-dispatch prompt skeleton (+2 more)

### Community 796 - "check_sunset.py"
Cohesion: 0.38
Nodes (10): Match, current_version(), _fmt(), main(), overdue_markers(), ProjectVersion, _py_files(), Path (+2 more)

### Community 797 - "InstallReport"
Cohesion: 0.18
...
### Community 804 - "model_store_root"
Cohesion: 0.22
...
### Community 806 - "rerender_slot_units"
Cohesion: 0.38
...
### Community 807 - "test_hermes_provision_collect.py"
Cohesion: 0.25
...
### Community 808 - "test_config_model_roots.py"
Cohesion: 0.29
...
### Community 809 - "test_doctor_route.py"
Cohesion: 0.24
...
### Community 810 - "test_features_health.py"
Cohesion: 0.25
...
### Community 811 - "test_meta_enums.py"
Cohesion: 0.42
...
### Community 813 - "test_server_ab_helpers.py"
Cohesion: 0.22
...
### Community 814 - "test_board_commands.py"
Cohesion: 0.27
...
### Community 815 - "test_serve_bind_host.py"
Cohesion: 0.31
...
### Community 816 - "test_fetch_scripts.py"
Cohesion: 0.18
...
### Community 817 - "test_migrate_board.py"
Cohesion: 0.40
...
### Community 818 - "hal0 test-harness — findings"
Cohesion: 0.18
...
### Community 821 - "test_admin_stacks.py"
Cohesion: 0.24
...
### Community 822 - "test_api_wiring.py"
Cohesion: 0.24
...
### Community 824 - "test_npu_trio_reconcile.py"
Cohesion: 0.45
...
### Community 825 - "test_pin_semantics.py"
Cohesion: 0.18
...
### Community 826 - "test_seed_profiles.py"
Cohesion: 0.29
...
### Community 827 - "board-chat-v3.spec.ts"
Cohesion: 0.22
...
### Community 829 - "Profiles / stacks — profile/stack/bundle layering"
Cohesion: 0.20
...
### Community 831 - "honcho-memory.mdx"
Cohesion: 0.20
...
### Community 838 - "WorkspaceEscapeError"
Cohesion: 0.24
...
### Community 839 - "Dashboard Plugin JS Loading Internals"
Cohesion: 0.20
...
### Community 845 - "get_agent_memory_stats"
Cohesion: 0.29
...
### Community 846 - "_list_workflow_names"
Cohesion: 0.22
...
### Community 847 - "_normalize_chat_body"
Cohesion: 0.20
...
### Community 854 - "collect_port_claims"
Cohesion: 0.29
...
### Community 856 - "TestStatusTelemetry"
Cohesion: 0.29
...
### Community 860 - "test_catalog_npu_stt.py"
Cohesion: 0.27
...
### Community 861 - "test_shared_auth.py"
Cohesion: 0.33
...
### Community 863 - "test_validate_catalog.py"
Cohesion: 0.24
...
### Community 866 - "_configure_project"
Cohesion: 0.56
...
### Community 867 - "Any"
Cohesion: 0.22
Nodes (8): _base_configs(), comfyui_http(), Any, Stub the arbiter's ComfyUI HTTP seams (resident-container design).      ``free``, Raw slot-config dicts shaped like SlotManager._load_slot_config output., Renders queued straight into ComfyUI's web UI never pass through the     dispatc, test_idle_tick_defers_and_restamps_when_comfyui_queue_busy(), test_restore_llm_frees_comfyui_and_reloads_saved_set()

### Community 868 - "mock.ts"
Cohesion: 0.31
Nodes (8): AllowRow, buildMockPayload(), jsonResponse(), matchAllowlist(), MOCK_ALLOWLIST, mockFetch(), parsePath(), pathWithSearch()

### Community 869 - "buildBankSubgraphRoute"
Cohesion: 0.36
...
### Community 872 - "apply_capability"
Cohesion: 0.28
...
### Community 873 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 874 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 875 - "ROCmFPX bench — RESULTS + next-session handoff (2026-07-05)"
Cohesion: 0.22
...
### Community 876 - "architecture.mdx"
Cohesion: 0.22
...
### Community 878 - "connect-clients.mdx"
Cohesion: 0.22
...
### Community 879 - "connect-external-providers.mdx"
Cohesion: 0.22
...
### Community 880 - "realtime-voice.mdx"
Cohesion: 0.22
...
### Community 881 - "openai-compat.mdx"
Cohesion: 0.22
...
### Community 882 - "slot-as-model.mdx"
Cohesion: 0.22
...
### Community 883 - "env-vars.mdx"
Cohesion: 0.22
Nodes (8): Install & update, Memory & MCP, Models & providers, Paths, Runtime, See also, Server, Services

### Community 884 - "Handoff prompt — hal0-brain / template / profile changes on lxc105 (hal0, 10.0.1.142)"
Cohesion: 0.22
...
### Community 885 - "PART B — Target: Quadlet `.container` per slot (and per companion)"
Cohesion: 0.22
...
### Community 886 - "SWEEP inventory — the overlooked surface (R5 release-prep)"
Cohesion: 0.22
...
### Community 889 - "Hindsight pi Extension Design"
Cohesion: 0.22
...
### Community 890 - "Dashboard plugin "Could not load this plugin's script""
Cohesion: 0.22
...
### Community 891 - "Strix Halo Benchmark Harness (hal0)"
Cohesion: 0.22
...
### Community 898 - "migrate_cognee_to_hindsight_dryrun"
Cohesion: 0.25
...
### Community 899 - "test_hermes_stale_dropin_cleanup.py"
Cohesion: 0.47
...
### Community 901 - "isolated_client_with_root"
Cohesion: 0.33
...
### Community 903 - "TestHarnessConfig"
Cohesion: 0.22
...
### Community 904 - "test_catalog_flm_blacklist.py"
Cohesion: 0.28
...
### Community 906 - "test_config_show_edit_selector.py"
Cohesion: 0.50
...
### Community 907 - "test_slot_metrics_capacity.py"
Cohesion: 0.36
...
### Community 911 - "test_halo143_reboot_no_split_brain"
Cohesion: 0.36
...
### Community 912 - "test_model_preferred_profile.py"
Cohesion: 0.50
...
### Community 919 - "generate-images.mdx"
Cohesion: 0.25
...
### Community 920 - "update-and-rollback.mdx"
Cohesion: 0.25
...
### Community 921 - "voice-stt-tts.mdx"
Cohesion: 0.25
...
### Community 923 - "paths-and-files.mdx"
Cohesion: 0.25
...
### Community 925 - "13. Observability & metrics baseline (ships in every box)"
Cohesion: 0.25
...
### Community 926 - "15. Hermes plugin — standalone repo + native update path"
Cohesion: 0.25
...
### Community 927 - "PART C — Coordination contracts (cross-lane seams)"
Cohesion: 0.25
...
### Community 928 - "halo143 deploy-validation runbook — rework-R3"
Cohesion: 0.25
...
### Community 929 - "Handoff — R5 Phase 4: deploy window → release cut (paste-in prompt)"
Cohesion: 0.25
...
### Community 930 - "mock-prod-gate verification (Phase 0 launch-blocker #3)"
Cohesion: 0.25
...
### Community 931 - "Podman on the hal0 slot substrate — findings & cleaner solutions"
Cohesion: 0.25
...
### Community 945 - "screen_extra_args_json"
Cohesion: 0.25
...
### Community 947 - "test_auth_exposure_route.py"
Cohesion: 0.32
...
### Community 950 - "test_app_list_uninstall.py"
Cohesion: 0.36
...
### Community 951 - "test_cli_docs_parity.py"
Cohesion: 0.36
...
### Community 955 - "test_slot_enabled_removed.py"
Cohesion: 0.25
...
### Community 957 - "_BackendContract"
Cohesion: 0.25
...
### Community 960 - "test_store_on_change.py"
Cohesion: 0.39
...
### Community 961 - "test_slot_create_conflict.py"
Cohesion: 0.29
...
### Community 962 - "test_slot_schema.py"
Cohesion: 0.32
...
### Community 963 - "test_transition_guard.py"
Cohesion: 0.25
...
### Community 964 - "useTweaksStore.ts"
Cohesion: 0.29
Nodes (5): APPEARANCE_KEYS, DEFAULTS, TweaksState, TweaksStore, useTweaksStore

### Community 965 - "board-chat-tool-use-v3.spec.ts"
Cohesion: 0.29
Nodes (3): GATED_FRAMES, mockChat(), sse()

### Community 966 - "Concurrency & continuous-batching optimization plan"
Cohesion: 0.29
...
### Community 967 - "ROCmFPX exploratory bench — RESULTS (2026-07-05)"
Cohesion: 0.29
...
### Community 973 - "P3-perms: declarative OwnershipStore as the single ownership authority"
Cohesion: 0.29
...
### Community 974 - "PART B — Target: OwnershipStore default `service_user="hal0"`"
Cohesion: 0.29
...
### Community 975 - "PART C — The LOAD-BEARING contract: born-owned"
Cohesion: 0.29
...
### Community 976 - "PART 0 — EXACT MAP (file:line)"
Cohesion: 0.29
...
### Community 977 - "P3-quadlet: migrate slot + companion units to Podman Quadlet `.container`"
Cohesion: 0.29
...
### Community 978 - "PART A — Current scars (in plain English)"
Cohesion: 0.29
...
### Community 979 - "4. Delivery plan and gates"
Cohesion: 0.29
...
### Community 983 - "Gateway connectivity quirks — hal0"
Cohesion: 0.29
...
### Community 993 - "write_env_atomic"
Cohesion: 0.33
...
### Community 995 - "test_slot_logs_stream_redacts_secret_bearing_lines"
Cohesion: 0.33
...
### Community 1000 - "test_paths_stub.py"
Cohesion: 0.29
...
### Community 1001 - "_reject_privileged_systemctl"
Cohesion: 0.33
...
### Community 1002 - "test_voice_roundtrip.py"
Cohesion: 0.43
...
### Community 1003 - "10. Troubleshooting"
Cohesion: 0.29
...
### Community 1004 - "test_owui_pin_consistency.py"
Cohesion: 0.43
...
### Community 1012 - "[Unreleased]"
Cohesion: 0.33
Nodes (6): Breaking, Changed, Fixed, Migrations, Security, [Unreleased]

### Community 1013 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 1014 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 1015 - "Hal0 Installer Setup — Redesign Plan (2026-07-05)"
Cohesion: 0.33
...
### Community 1017 - "logs-and-activity.mdx"
Cohesion: 0.33
...
### Community 1022 - "24. Execution waves / rollout program (session 3, 2026-07-18)"
Cohesion: 0.33
...
### Community 1024 - "§4.4 addendum — MCP admin route-map autogen (the 3 gaps)"
Cohesion: 0.33
...
### Community 1025 - "Verification strategy"
Cohesion: 0.33
Nodes (6): Lifecycle and security, Live acceptance, Memory, Provider, Verification strategy, Voice

### Community 1026 - "Dashboard permission mismatch (root vs hal0)"
Cohesion: 0.33
...
### Community 1042 - "_guess_capability"
Cohesion: 0.33
...
### Community 1043 - "ttft_samples.py"
Cohesion: 0.33
...
### Community 1044 - "avg_ttft_across"
Cohesion: 0.33
...
### Community 1045 - "samples_from_events"
Cohesion: 0.33
...
### Community 1046 - "test_activity_instrumentation.py"
Cohesion: 0.60
...
### Community 1047 - "test_models_catalogue.py"
Cohesion: 0.47
...
### Community 1051 - "test_now_iso.py"
Cohesion: 0.33
...
### Community 1052 - "test_curation_drift.py"
Cohesion: 0.40
...
### Community 1053 - "test_family_defaults_empty.py"
Cohesion: 0.33
...
### Community 1071 - "14. Kanban board — ownership inversion + security hardening"
Cohesion: 0.40
...
### Community 1072 - "16. Hermes Python library (`AIAgent`) for the brain — evaluated, rejected for core"
Cohesion: 0.40
...
### Community 1073 - "21.A Mapping table — every candidate by disposition"
Cohesion: 0.40
...
### Community 1074 - "8. SQLite adoption — setup plan"
Cohesion: 0.40
...
### Community 1075 - "PART A — Current-state map (the scars, in plain English)"
Cohesion: 0.40
...
### Community 1076 - "PART D — The one narrow privileged helper: `hal0-systemctl`"
Cohesion: 0.40
...
### Community 1077 - "PART G — Sequencing: P3-perms BEFORE hermes-provision slim and P3-quadlet"
Cohesion: 0.40
...
### Community 1078 - "PART 0 — Current-state map (the hand-rendered ExecStart scars, file:line)"
Cohesion: 0.40
...
### Community 1086 - "prototype_ttft — TTFT + KV-cache % measurement and aggregation"
Cohesion: 0.40
Nodes (4): Files, prototype_ttft — TTFT + KV-cache % measurement and aggregation, Run, What it teaches

### Community 1087 - "hal0-provider (Hermes `ProviderProfile` plugin)"
Cohesion: 0.40
Nodes (4): Contract, hal0-provider (Hermes `ProviderProfile` plugin), Provisioning requirement, Two copies (source + seed)

### Community 1088 - "brain_chat"
Cohesion: 0.40
Nodes (4): brain_chat(), Request, hal0-brain chat surface — ``POST /api/brain/chat`` (SSE).  The PRIMARY route for, hal0-brain platform steward. SSE stream. SPEC §G / R4.      Delegates to :func:`

### Community 1089 - "is_container_npu_cfg"
Cohesion: 0.40
...
### Community 1095 - "TestRenderCancel"
Cohesion: 0.40
...
### Community 1096 - "test_distro.sh"
Cohesion: 0.90
Nodes (4): bad(), ok(), test_distro.sh script, want()

### Community 1098 - "test_zero_window_from_toml_never_auto_restores"
Cohesion: 0.40
Nodes (5): TOML ``[image].idle_restore_minutes = 0`` reaches the arbiter as 0     (manual-o, End-to-end #599 pin: the TOML-sourced 0 window feeds an arbiter whose     idle l, test_manager_arbiter_accepts_zero_window_from_toml(), test_zero_window_from_toml_never_auto_restores(), _write_img_toml()

### Community 1101 - "slot-card-container-v3.spec.ts"
Cohesion: 0.40
...
### Community 1102 - "slot-edit-controls-v3.spec.ts"
Cohesion: 0.40
...
### Community 1104 - "[0.9.5.1] — 2026-07-09"
Cohesion: 0.50
Nodes (4): [0.9.5.1] — 2026-07-09, Added, Fixed, Highlights

### Community 1105 - "[0.9.6.1] — 2026-07-11"
Cohesion: 0.50
...
### Community 1133 - "cleanup_stale_agent_dropins"
Cohesion: 0.50
...
### Community 1134 - "reconcile_ownership_on_repair"
Cohesion: 0.50
Nodes (4): OwnershipReconcileResult, Outcome of :func:`reconcile_ownership_on_repair`., Reconcile HERMES_HOME/agents + the venv to hal0:hal0 (repair path only).      ``, reconcile_ownership_on_repair()

### Community 1135 - "request_id.py"
Cohesion: 0.67
Nodes (3): install(), FastAPI, Per-request X-Request-ID middleware.

### Community 1136 - "bench_commands.py"
Cohesion: 0.50
Nodes (3): bench(), Context, `hal0 bench` — benchmarking CLI (design §5), thin mount over hal0.bench.cli.  Th

### Community 1137 - "__init__.py"
Cohesion: 0.50
...
### Community 1140 - "test_destructive_ops_land_audit_rows"
Cohesion: 0.67
Nodes (4): _build_app_with_audit(), Any, FastAPI, test_destructive_ops_land_audit_rows()

### Community 1141 - "test_store.py"
Cohesion: 0.67
...
### Community 1143 - "_delegate_fakes.py"
Cohesion: 0.50
...
### Community 1144 - "test_comfyui_path.py"
Cohesion: 0.50
...
### Community 1155 - "[0.9.2] — 2026-07-05"
Cohesion: 0.67
Nodes (3): [0.9.2] — 2026-07-05, Fixed, Highlights

### Community 1156 - "[v0.8.0-beta.3] — 2026-06-23"
Cohesion: 0.67
Nodes (3): Breaking, Changed, [v0.8.0-beta.3] — 2026-06-23

### Community 1157 - "[v0.8.2b4] — 2026-06-30"
Cohesion: 0.67
Nodes (3): Changed, Fixed, [v0.8.2b4] — 2026-06-30

### Community 1158 - "[v0.8.2b2] — 2026-06-24"
Cohesion: 0.67
Nodes (3): Changed, Fixed, [v0.8.2b2] — 2026-06-24

### Community 1181 - "_OtherEngineProvider"
Cohesion: 0.67
...
### Community 1187 - "test_agent_unit_argv_defaults_to_real_euid"
Cohesion: 0.67
Nodes (3): MonkeyPatch, ``euid=None`` (the production call) reads the live euid., test_agent_unit_argv_defaults_to_real_euid()

## Knowledge Gaps
- **3272 isolated node(s):** `runlog.sh script`, `rocmfpx-build.sh script`, `rocmfpx-env.sh script`, `rocmfpx-pipeline.sh script`, `rocmfpx-quantize.sh script` (+3267 more)
...
- **Why does `create_app()` connect `create_app` to `test_auth_rotate.py`, `TestClient`, `_build`, `test_slots_container_state.py`, `isolated_client_with_root`, `migrate_slot_toml`, `test_hf_routes.py`, `ApprovalQueue`, `test_stacks_routes.py`, `FastAPI`, `test_route_collisions.py`, `conftest.py`, `conftest.py`, `test_slots_policy.py`, `test_memory_admin_routes.py`, `test_dashboard_layout.py`, `test_models_add_from_path.py`, `test_memory_delete_auth.py`, `model_store_root`, `test_settings_routes.py`, `test_updater_routes.py`, `test_admin_route_map_nested.py`, `test_config_model_roots.py`, `mcp_mount.py`, `test_models_crud.py`, `test_chat_proxy.py`, `test_chat_templates.py`, `test_kb1_hardening_tail.py`, `TestClient`, `test_slots_image_pull.py`, `test_route_sync.py`, `test_settings_models_store.py`, `test_models_preview.py`, `_RecordingSlotManager`, `Hal0Config`, `BootReport`, `hal0_slot_alias_models`, `test_exposure.py`, `TestClient`, `MemoryConfig`, `test_v1_npu_trio_routing.py`, `EventBus`, `test_tts_request_defaults.py`, `test_redact.py`, `conftest.py`, `test_chat_proxy_auth.py`, `test_typed_errors.py`, `TestClient`, `test_typed_bodies.py`, `__init__.py`, `FakeWsServer`, `_StubSlotManager`, `test_pull_shutdown.py`, `test_cli_auth_streamtest.py`, `conftest.py`, `test_models_default.py`, `test_models_routes.py`, `test_comfyui_fetch_route.py`, `test_events_fixes.py`, `test_profiles_crud.py`, `test_event_contract.py`, `test_pull_routes.py`, `PgVectorProvider`, `test_installer_routes.py`, `test_auth_core.py`, `test_v1_chat_slot_alias.py`, `load_hal0_config`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `SlotManager` connect `SlotManager` to `build_auto_selections`, `Slot`, `SlotInterface`, `slots.py`, `SlotConfigError`, `test_model_preferred_profile.py`, `SlotState`, `test_model_fallback.py`, `test_slot_aliases.py`, `test_device_profile_coherence.py`, `test_gpu_arbiter.py`, `_write_slot`, `test_load_converges_config.py`, `test_mtp_defuse.py`, `test_preload_eviction.py`, `rerender_slot_units`, `manager.py`, `CapabilityOrchestrator`, `_write_slot`, `test_npu_trio_reconcile.py`, `GpuArbiter`, `RoutingHost`, `compute_config_drift`, `test_slot_create_conflict.py`, `FakeContainerProvider`, `test_transition_guard.py`, `heal_missing_llm_type`, `FLMProvider`, `test_zero_window_from_toml_never_auto_restores`, `test_adopted_slot_eviction.py`, `SlotIdentityStore`, `agents-overview.jsx`, `test_npu_trio_shadow.py`, `test_pulling_serving_idle.py`, `Path`, `SlotStateRecord`, `test_npu_exclusivity.py`, `SlotWatchdog`, `hal0_chat_slot_alias_map`, `orchestrate.py`, `test_manager_npu_container.py`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `SlotState` connect `SlotState` to `SlotManager`, `UpstreamCall`, `SlotInterface`, `Slot`, `test_metrics_prometheus_route.py`, `SlotConfigError`, `Dispatcher`, `MapContainerProvider`, `test_fail_watcher.py`, `test_aggregator.py`, `test_npu_swap_status.py`, `FakeSnap`, `GpuArbiter`, `fetch_npu_swap_status`, `container_enrichment`, `test_backends_npu_canonical_fields.py`, `arbiter.py`, `test_fail_watcher_warming.py`, `Enum`, `_ArbiterSlotManager`, `StackApplyEngine`, `Any`, `config_enrichment`, `test_drift.py`, `_FakeSM`, `FakeManager`, `StackConfig`, `_slot`, `test_npu_occupancy.py`, `orchestrate.py`, `SlotStateRecord`, `read_stack_state`, `SlotWatchdog`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Are the 181 inferred relationships involving `SlotManager` (e.g. with `_build_offline_deps()` and `FLMProvider`) actually correct?**
  _`SlotManager` has 181 INFERRED edges - model-reasoned connections that need verification._
