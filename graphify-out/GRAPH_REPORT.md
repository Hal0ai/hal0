...
## Summary
- 27522 nodes · 52248 edges · 1286 communities (1147 shown, 139 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 6388 edges (avg confidence: 0.73)
...
## Communities (1286 total, 139 thin omitted)

### Community 0 - "dashboard-redesign.jsx"
Cohesion: 0.03
Nodes (109): useActivityRecent(), CELL_DEFS, CELL_MAP, CellDef, CellId, DashLayout, DEFAULT_LAYOUT, LAYOUT_QUERY_KEY (+101 more)

### Community 1 - "useSlots.ts"
Cohesion: 0.03
Nodes (120): ADR-0022, useModels(), deviceBackend(), parseImageRef(), RunnerState, RuntimeRow, SystemInfo, SystemInfoBackend (+112 more)

### Community 2 - "Slot"
Cohesion: 0.02
Nodes (103): flm_id_to_tag(), Resolve a hal0 ``<tag>-FLM`` id back to FLM's native ``family:size`` tag.      I, Atomically write a slot TOML.      THE byte-level write path for ``/etc/hal0/slo, write_slot_toml(), _cfg_port(), _cfg_provider(), _cfg_to_dict(), _model_default() (+95 more)

### Community 3 - "BoardStore"
Cohesion: 0.03
...
Cohesion: 0.05
Nodes (81): Slot TOML missing or invalid for the requested operation., SlotConfigError, FakeContainerProvider, MonkeyPatch, Path, Tests for hal0.slots.manager.SlotManager (container-only dispatch).  Phase E (#6, Write an img-group (ComfyUI) slot TOML carrying [image].idle_restore_minutes., Editing [image].idle_restore_minutes pushes the new value into the     already-c (+73 more)

### Community 5 - "useModels.ts"
Cohesion: 0.05
Nodes (59): api(), serialiseBody(), ProfileBody, ProfileEnvelope, ProfileImportDryResult, useProfileCreate(), useProfileDelete(), useProfileExport() (+51 more)
...
### Community 8 - "stacks.jsx"
Cohesion: 0.04
Nodes (84): useLogsStream(), useMemoryEnabled(), useClearPullJob(), useHfSearch(), useModelUpdateAll(), useModelUpdateApply(), useModelUpdatesCheck(), useModelUpdatesForceCheck() (+76 more)

### Community 9 - "resolve_profile_flags"
Cohesion: 0.10
Nodes (22): _exec_line(), _moe_profile(), Return the ``Exec=`` value (the in-container argv) from Quadlet unit text., The Quadlet ``.container`` renderer produces correct declarative keys +     the, Model store mounted identical-path, read-only, SELinux-relabelled., A custom HAL0_MODEL_STORE is what the slot bind-mounts — so a model         dir, O25: when store != pull_root, BOTH roots render a Volume so a model         file, store == pull_root → exactly one model-store Volume (no dup). (+14 more)

### Community 10 - "ContainerProvider"
Cohesion: 0.04
Nodes (65): _container_runtime(), ContainerProvider, Podman-container-per-slot inference backend.      One instance is shared across, Informational env block (not written to disk — container is self-contained)., Not applicable — systemd starts the container., Direct inference passthrough (used by tests; dispatcher is primary path)., Probe GET /health on the container port.          For llama-server slots /health, Poll /health until 200 or HEALTH_TIMEOUT_S exceeded.          Raises: (+57 more)

### Community 11 - "ENDPOINTS"
Cohesion: 0.04
Nodes (106): apiDelete(), apiGet(), apiPatch(), apiPut(), ENDPOINTS, Backend, NOTE: there is no useBackendInstall — the backend exposes no generic, useBackendSnapshot() (+98 more)

### Community 12 - "SettingsShell.jsx"
Cohesion: 0.05
Nodes (84): useBackends(), useCapabilities(), useCapabilityApply(), NpuOccupancy, NpuOccupancySlot, useNpuOccupancy(), useServiceRepair(), APPLY_PLAN_KEY (+76 more)

### Community 13 - "ProfileConfig"
Cohesion: 0.04
Nodes (68): RuntimeFamily, SlotType, create_profile(), delete_profile(), export_profile(), get_profile(), import_profile_route(), list_profiles() (+60 more)

### Community 14 - "SlotState"
Cohesion: 0.04
Nodes (65): Async generator yielding every slot state transition as it happens.          Use, See :meth:`hal0.slots.watchdog.SlotWatchdog.update`., is_dispatchable_state(), is_transition_legal(), Any, Path, Slot lifecycle state machine.  Defines the canonical SlotState enum used by Slot, Return True if the transition from_state → to_state is allowed. (+57 more)

### Community 15 - "slots.py"
Cohesion: 0.04
Nodes (105): _cache_slot_enrichment(), _config_field_enrichment(), _container_state_enrichment(), create_slot(), delete_slot(), _device_backend(), _fit_check_warning(), get_slot() (+97 more)

### Community 16 - "test_updater.py"
Cohesion: 0.04
Nodes (120): _atomic_symlink_swap(), _current_symlink(), _parse_manifest(), Atomic self-update with cosign-verified releases and one-step rollback.      All, Initialise the updater.          Args:             channel: Release channel — "s, Schema-validated release-manifest payload.      Mirrors the on-disk JSON shape d, Return the release-manifest URL for ``channel``.      Resolution:       - ``HAL0, Validate ``raw`` against ReleaseManifest, raising UpdateManifestInvalid. (+112 more)

### Community 17 - "connect"
Cohesion: 0.03
Nodes (72): Path, _null_model_hw_columns(), NULL the ``n_gpu_layers``/``preferred_runner`` columns for ``model_ids``.      B, connect(), db_path(), Connection, Path, SQLite connection + transaction helpers — the hal0 ``db/`` foundation.  One conn (+64 more)

### Community 18 - "ApprovalQueue"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (60): BaseModel, _client_ip(), exposure(), ExposureAllowlistEntry, ExposureResponse, ExposureRule, login(), LoginRequest (+52 more)

### Community 22 - "SqliteModelRegistry"
Cohesion: 0.04
Nodes (66): Any, Connection, Model, Path, Row, SqliteModelRegistry — SQLite-backed model catalog (ML-1 pilot).  Drop-in replace, Resolved registry directory (override or paths.registry_dir())., Derived TOML export path.          ``registry.toml`` is no longer the source of (+58 more)

### Community 23 - "updater.py"
Cohesion: 0.05
Nodes (68): Die early on an editable/dev install — `hal0 update` can't swap the FHS tree., _refuse_if_editable(), _cache_dir(), _download(), _editable_install_path(), _extract_tarball(), _is_editable_install(), _is_git_install() (+60 more)

### Community 24 - "pull.py"
Cohesion: 0.03
Nodes (111): FileSetEntry, FileSetPlan, One file of a planned file-set, ready for ``model_file`` insertion., The full set of files one model pull should download + register., _comfyui_models_dir(), _dir_size(), _discard_partial(), _download_one() (+103 more)

### Community 25 - "SlotConfig"
Cohesion: 0.06
...
### Community 26 - "hardware.py"
Cohesion: 0.03
Nodes (106): _background_revalidate(), _cached_snapshot(), _clear_in_flight(), _flatten_for_ui(), get_hardware(), _gpu_sample(), _local_image_repos(), _local_live_stats() (+98 more)

### Community 27 - "ConfigParseError"
Cohesion: 0.03
Nodes (103): OSError, config_validate(), Validate all config files against the current schema., ConfigError, ConfigNotFound, ConfigParseError, _find_manifest_path(), _flatten_slot_toml() (+95 more)
...
### Community 32 - "hermes_provision.py"
Cohesion: 0.07
Nodes (17): react, CI(), Ic(), MemDocuments(), MemRecallConsole(), mtDocTitle(), mtDocWhen(), mtFactColor() (+9 more)

### Community 33 - "comfyui.py"
Cohesion: 0.10
Nodes (25): aclose_client(), _comfyui_container(), comfyui_logs(), _comfyui_models_dir(), comfyui_models_fetch(), comfyui_status(), _container_state(), _count_models() (+17 more)

### Community 34 - "useBoard.ts"
Cohesion: 0.06
Nodes (77): URL-safe lowercase identifier used by the REST surface., apiPost(), normaliseActor(), normaliseAssignee, normaliseProfile, pickName(), BoardAssignee, BoardConfig (+69 more)

### Community 35 - "chat.py"
Cohesion: 0.06
Nodes (66): AsyncClient, LlmFn, _admin_tool_names(), _admin_tool_schemas(), _brain_chat_config(), _brain_tool_policy(), _chat_stream(), _compact_board() (+58 more)

### Community 36 - "api"
Cohesion: 0.04
Nodes (91): ChatTemplate, useChatTemplates(), useMeta(), useMetaEnums(), AddFromPathRequest, fmtBytes(), fmtEta(), fmtSpeed() (+83 more)

### Community 37 - "test_hermes_provision.py"
Cohesion: 0.03
...
### Community 39 - "test_orchestrate.py"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (70): AbstractEventLoop, _auto_resume_interrupted_pulls(), _boot_audit_store(), _boot_background_tasks(), _boot_brain_lane(), _boot_capabilities(), _boot_dispatcher(), _boot_mcp_memory_call() (+62 more)
...
### Community 44 - "Upstream"
Cohesion: 0.04
Nodes (49): COMFYUI_FALLBACK, ComfyuiArbiter, ComfyuiEngineState, ComfyuiMemory, ComfyuiMode, ComfyuiStatus, ComfyuiSwitchover, ComfyuiV2PaneData (+41 more)

### Community 45 - "primitives.jsx"
Cohesion: 0.04
Nodes (52): useComfyui(), bundleNameOr(), InstallState, InstallStateBundle, useInstallState(), DEMO_MIGRATION_REPORT, EMPTY_MIGRATION_REPORT, MigrationFlagConflict (+44 more)

### Community 46 - "updater.py"
Cohesion: 0.06
...
### Community 48 - "_cfg_to_dict"
Cohesion: 0.07
Nodes (27): ModelCacheCheck, PullRunner, container_provider(), Return the process-wide ContainerProvider singleton., ImagePullJob, inspect_image_state(), Any, Container-image pull orchestration for slots (extracted from routes/slots.py). (+19 more)
...
### Community 52 - "doctor_commands.py"
Cohesion: 0.08
...
### Community 53 - "resolve_by_capability"
Cohesion: 0.05
Nodes (66): Any, Capability/path routing heuristics — dispatcher resolution Step 4.  Extracted fr, Resolve a request to a slot Upstream using path+name heuristics.      The last-r, resolve_by_capability(), A chat request that reaches the legacy fallback selects the ``chat``     default, test_resolve_by_capability_chat_default_raises_typed_legacy_error(), _container_remote_img(), _FakeModelRegistry (+58 more)

### Community 54 - "Model"
Cohesion: 0.04
Nodes (49): Model, ModelDefaults, Model — registry entry pydantic model.  The Model class is the typed representat, A model entry in the hal0 registry.      All fields are optional at construction, # NOTE: revisit in Phase 1 — extend as providers surface new capabilities., Per-model default knobs surfaced as launcher defaults.      All fields optional., ModelNotFound, Base error for registry operations. (+41 more)

### Community 55 - "Hal0MemoryProvider"
Cohesion: 0.10
...
Cohesion: 0.04
Nodes (29): MemoryEmbeddingConfig, Any, [memory.embedding] section of hal0.toml — Hindsight-era rerank knobs.      ADR-0, Pydantic model for a single slot's TOML config (slots/<name>.toml).      Fields, Pull a `[server]` TOML table out of the loader's `extra` catch-all.          ``h, Pull a `[npu]` TOML table out of the loader's `extra` catch-all.          Mirror, Pull an `[image]` TOML table out of the loader's `extra` catch-all.          Mir, Read-only promotion shim: derive ``device`` from a legacy         on-disk ``back (+21 more)

### Community 57 - "_api_base"
Cohesion: 0.04
Nodes (103): agent_install(), agent_list(), agent_peers(), approvals_approve(), approvals_deny(), _install_hermes(), Approve a pending agent action., Deny a pending agent action. (+95 more)
...
### Community 59 - "test_models_crud.py"
Cohesion: 0.06
...
### Community 68 - "test_updater_routes.py"
Cohesion: 0.06
...
### Community 70 - "unknown_slot_config_keys"
Cohesion: 0.06
Nodes (36): ChangeSet, FileState, fold_ctx_size_alias(), _known_field_names(), Any, Path, SlotConfigStore — one reconciled truth for capability + slot config (issue #697), Fold the legacy ``[model].ctx_size`` alias into the canonical     ``context_size (+28 more)

### Community 71 - "test_mcp_routes.py"
Cohesion: 0.06
Nodes (58): app(), _build_app(), client(), _FakeAnn, _FakeMcpServer, _FakeTool, _filesystem_manifest_dict(), Any (+50 more)

### Community 72 - "_FakeWrapper"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (49): _apply_selections_core(), _bundle_to_selections(), _container_active(), curated_models(), CuratedModelNotFound, _first_run_sentinel(), _has_default_slot(), install_apply() (+41 more)
...
### Community 79 - "HindsightProvider"
Cohesion: 0.09
Nodes (22): _agent_of(), bank_to_namespace(), HindsightProvider, _http_status(), namespace_to_bank(), _now(), Any, Exception (+14 more)

### Community 80 - "agent_commands.py"
Cohesion: 0.05
Nodes (46): agent_log(), _agent_provision_state_file(), agent_reprovision(), agent_status(), agent_uninstall(), agent_upgrade(), _approval_summary(), approvals_list() (+38 more)

### Community 81 - "ModelRegistry"
Cohesion: 0.07
...
### Community 82 - "_spec_provider_for"
Cohesion: 0.10
...
### Community 88 - "errors.py"
Cohesion: 0.05
Nodes (53): HttpFetcher, IPv4Address, IPv6Address, BadRequest, 400 — the request was syntactically or semantically invalid.      Use this for c, _coerce_int(), _default_fetcher(), _enforce_safe_url() (+45 more)

### Community 89 - "load_capabilities_config"
Cohesion: 0.06
...
### Community 90 - "Any"
Cohesion: 0.05
Nodes (61): _build_brain_identity_card(), _build_identity_card(), _collect_capability_rollup(), _collect_chat_slots(), _fetch_slots(), _find_named_ready_slot(), _find_slot(), _fmt_config_value() (+53 more)
...
### Community 92 - "HardwareInfo"
Cohesion: 0.18
Nodes (17): _build_offline_deps(), _confirm(), _existing_slot_names(), _prompt(), Console, `hal0 setup` — first-run configuration TUI (spec §6).  Hybrid execution: in-proc, Apply the auto-selected config. Routes hybrid (in-process at install     time wh, Text prompt: `rich.prompt.Prompt` on a real terminal, `input()` (or the     defa (+9 more)
...
Cohesion: 0.08
Nodes (26): HealthCheck, Mount, Provider abstract base class.  A Provider encapsulates the logic for a single in, Normalise a ``Mount`` or a legacy ``(src, dst)`` tuple to ``Mount``.          A, A podman ``--health-*`` override for a slot container.      The toolbox images b, Return the ``--health-*`` podman-run flags in a stable order., Return the Podman Quadlet ``Health*=`` keys in a stable order.          The decl, Typed launch plan for a container-per-slot Quadlet unit.      Carries everything (+18 more)

### Community 97 - "models_service.py"
Cohesion: 0.07
...
### Community 101 - "LlamaServerProvider"
Cohesion: 0.08
...
### Community 102 - "test_profiles_crud.py"
Cohesion: 0.06
...
### Community 104 - "test_providers_routes.py"
Cohesion: 0.12
...
Cohesion: 0.20
Nodes (29): load_answers(), Load a ``hal0-setup.yaml`` answer file and resolve it into a     :class:`~hal0.i, _hw(), WS-C (#1099): the network block is now APPLIED (bind_host → the coherent     HAL, A malformed network value is rejected, not silently ignored., Explicit slots[].device / profile on an answer-file entry ride onto the     resu, Omitted or ``auto`` device/profile leave the SlotSelection fields None so     ap, test_all_auto_matches_build_auto_selections() (+21 more)

### Community 107 - "test_pull_routes.py"
Cohesion: 0.08
Nodes (53): app_isolated(), client_isolated(), fake_run_pull(), Any, FastAPI, MonkeyPatch, Path, TestClient (+45 more)

### Community 108 - "record_action"
Cohesion: 0.14
...
### Community 109 - "test_registry_import.py"
Cohesion: 0.06
...
### Community 113 - "resolve_role_slots"
Cohesion: 0.13
...
### Community 117 - "portable.py"
Cohesion: 0.06
Nodes (51): _checksum(), embed_references(), export_envelope(), import_stack(), ModelResolution, parse_envelope(), Any, ModelRegistry (+43 more)
...
### Community 122 - "test_hermes_wrapper.py"
Cohesion: 0.07
...
### Community 123 - "_resolve_llama_scalars"
Cohesion: 0.05
Nodes (81): family_flags(), model_family(), Best-effort model family, preferring the registry's ``architecture``.      §7.1a, The :data:`FAMILY_DEFAULTS` flag string for the model's family, else ''., _best_effort_model_info(), _binary_runner(), _effective_backend_and_device_class(), _effective_parallel() (+73 more)

### Community 124 - "test_npu_swap_status.py"
Cohesion: 0.11
...
### Community 126 - "test_agent_install_hermes.py"
Cohesion: 0.05
...
### Community 127 - "hal0 rework plan — reader's copy"
Cohesion: 0.04
...
### Community 130 - "test_hermes_provision_idempotency.py"
Cohesion: 0.07
...
### Community 138 - "write_openwebui_env"
Cohesion: 0.13
...
### Community 139 - "StackApplyEngine"
Cohesion: 0.07
Nodes (33): Any, Path, StackSlotEntry, StackApplyEngine — translate a StackConfig into an atomic slot-config change.  P, Reconcile a StackConfig onto slot TOMLs as one ChangeSet., Compute the post-state for ``stack``. Writes NOTHING.          Only entries that, Pre-apply sanity check: flag entries whose profile/model won't resolve., Project a stack slot entry onto the existing slot TOML dict.          Builds the (+25 more)
...
Cohesion: 0.04
Nodes (68): ApiOptions, Hal0Error, ADR-0004, ADR-0013, ADR-0023, AgentMCPClientList, AgentMCPClientView, fetchOrMock() (+60 more)
...
### Community 146 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.04
...
### Community 147 - "Enum"
Cohesion: 0.08
Nodes (40): Enum, auth_require(), auth_rotate(), KeyTier, hal0 auth subcommands — thin HTTP client to /api/auth/*.  §5.2 of the R5 sync as, Persist the [security].require_auth posture (PUT /api/auth/require)., Rotate the admin or client box key (POST /api/auth/rotate).      Mints a fresh k, RequireToggle (+32 more)
...
### Community 152 - "TestUpstreamEntry"
Cohesion: 0.04
Nodes (38): BrainChatConfig, DispatcherConfig, MetaConfig, ModelConfig, ProviderEntry, [model] section in a slot TOML.      Specifies which model the slot loads by def, One [[upstream]] entry in upstreams.toml.      ``extra="forbid"`` (P3-schema Par, [meta] section in hal0.toml.  Tracks config schema version for migrations. (+30 more)
...
### Community 157 - "test_setup_install.py"
Cohesion: 0.07
...
### Community 158 - "test_profile_derive.py"
Cohesion: 0.05
Nodes (61): Return the TTS slot profile a device selection implies.      The engine switch:, tts_profile_for_device(), profile_name_for_fit(), Shared picker/apply profile-fit inference (device → runtime profile name).  Sing, Infer the runtime profile name implied by a picker/apply selection.      Keeps i, derive_device(), derive_profile(), npu_takes_utility() (+53 more)

### Community 159 - "MemoryProvider"
Cohesion: 0.06
Nodes (27): AddResult, DeleteResult, GraphStatus, ListPage, MemoryItem, MemoryProvider, Mode, Any (+19 more)

### Community 160 - "Qwen3TTSProvider"
Cohesion: 0.07
...
### Community 161 - "test_model_fallback.py"
Cohesion: 0.10
...
### Community 162 - "test_exposure.py"
Cohesion: 0.06
...
### Community 164 - "test_hal0_provider_plugin.py"
Cohesion: 0.09
...
### Community 166 - "Hal0MemoryProvider"
Cohesion: 0.08
...
### Community 168 - "install_openwebui"
Cohesion: 0.11
...
### Community 171 - "test_kb1_hardening_tail.py"
Cohesion: 0.07
...
### Community 172 - "test_personas.py"
Cohesion: 0.08
...
### Community 174 - "test_slots_image_pull.py"
Cohesion: 0.09
...
### Community 175 - "FakeMemoryProvider"
Cohesion: 0.06
...
### Community 178 - "test_mtp_override.py"
Cohesion: 0.11
Nodes (32): build_mtp_flag_bundle(), Return the full flag string for *profile*, expanding MTP when set.      When the, Bench-tuned MTP draft-speculation flag bundle, with the draft device     derived, resolve_profile_flags(), _effective_mtp(), Resolve whether MTP speculative decoding is on for this slot launch.      §7.1a, _mtp_model(), _plain_model() (+24 more)

### Community 179 - "test_hermes_provision_mcp_auth.py"
Cohesion: 0.10
...
### Community 180 - "test_slot_aliases.py"
Cohesion: 0.06
...
### Community 181 - "test_unit_files.py"
Cohesion: 0.05
...
### Community 182 - "Benchmarks.tsx"
Cohesion: 0.09
Nodes (36): BENCH_OPTIONS, Benchmarks(), BenchOption, CAP_ALIAS, CAP_COLOR, CAP_SVG, CellRow, cellTd (+28 more)

### Community 183 - "R5 sync assessment — how far every surface is from "back in sync" (2026-07-19)"
Cohesion: 0.05
...
### Community 184 - "test_doctor_json_diagnoses.py"
Cohesion: 0.08
...
### Community 187 - "test_hindsight_provider.py"
Cohesion: 0.09
...
### Community 189 - "test_model_store.py"
Cohesion: 0.10
...
### Community 190 - "SlotIdentityStore"
Cohesion: 0.12
...
### Community 191 - "test_chat_proxy_auth.py"
Cohesion: 0.07
...
### Community 192 - "FakeSnap"
Cohesion: 0.07
Nodes (37): One ``[stack.<slug>]`` entry in stacks.toml.      A curated bundle of slots + em, StackConfig, StackCapabilityRow, TestStackConfig, FakeSnap, _no_seed_stacks(), MonkeyPatch, Shared recording fakes for the Stacks convergence tests.  Mirrors the FakeSlotMa (+29 more)

### Community 193 - "tui.py"
Cohesion: 0.08
...
### Community 196 - "recommend_primary_slot"
Cohesion: 0.10
...
### Community 197 - "test_modality.py"
Cohesion: 0.10
...
### Community 198 - "test_contract_compatibility.py"
Cohesion: 0.06
...
### Community 199 - "test_v1_npu_trio_routing.py"
Cohesion: 0.09
...
### Community 202 - "Appendix: raw area reports"
Cohesion: 0.05
...
### Community 207 - "test_memory_graph_route.py"
Cohesion: 0.13
Nodes (31): _build_app(), client(), hal0_home(), _HindsightyWrapper, Any, FastAPI, MonkeyPatch, Path (+23 more)

### Community 208 - "test_typed_errors.py"
Cohesion: 0.10
Nodes (35): app(), app_with_slot(), client(), FastAPI, Hal0Error, TestClient, Tests for the typed 4xx ``Hal0Error`` subclasses and the ``RequestValidationErro, Passing ``code=`` to a subclass constructor overrides the class default. (+27 more)

### Community 209 - "test_unified_bank.py"
Cohesion: 0.06
...
### Community 211 - "test_pulling_serving_idle.py"
Cohesion: 0.11
...
### Community 213 - "HealthStatsPage.jsx"
Cohesion: 0.12
Nodes (11): Path, Absent file → seed defaults; no fixture needed., Non-MTP profiles stay False; MTP-capable family profiles are True., Canonical GPU seeds do not pin a backend or runner image., spec-hw-slot-ownership §3: ``image`` is optional/inert now — a profile         w, extra='forbid' on ProfileConfig: typos in profile keys raise at load., A profiles.toml with only one profile still exposes every seed., Seeds are virtual: a stale on-disk seed is replaced by the code definition. (+3 more)

### Community 214 - "§17 installer/setup overhaul — edit-plan (thin shell + thick Python, one profile authority, one slot roster)"
Cohesion: 0.06
...
### Community 215 - "P3 slot-identity + ports — implementation spec"
Cohesion: 0.06
...
### Community 218 - "HermesBoardExecutor"
Cohesion: 0.15
...
### Community 219 - "hw_slot_ownership.py"
Cohesion: 0.11
...
### Community 220 - "plan_slot_flags_fold"
Cohesion: 0.11
...
### Community 223 - "test_update_check.py"
Cohesion: 0.09
...
### Community 225 - "test_installer_routes.py"
Cohesion: 0.09
...
### Community 226 - "test_update_commands.py"
Cohesion: 0.08
...
### Community 228 - "test_hf_token_secrets.py"
Cohesion: 0.06
...
### Community 230 - "write_toml_atomic"
Cohesion: 0.05
Nodes (68): _apply_config_set(), _atomic_write(), _atomic_write_if_changed(), _build_config_overlay(), content_hash(), _copy_plugin_tree(), _copy_wrapper(), _dirs_identical() (+60 more)

### Community 231 - "test_v1_chat_slot_alias.py"
Cohesion: 0.12
Nodes (32): hal0_chat_slot_alias_map(), Return ``{slot_alias: model_id}`` for enabled llm slots.      The slot **alias**, Translate a chat-slot ALIAS in ``body["model"]`` to its model id.      hermes-ro, _rewrite_chat_slot_alias(), _FakeApp, _FakeRequest, _FakeSlotManager, _npu_flm_slot() (+24 more)

### Community 232 - "run_migrations"
Cohesion: 0.06
...
### Community 234 - "resolve_gpu_group_ids"
Cohesion: 0.08
...
### Community 235 - "test_chat_normalization.py"
Cohesion: 0.11
...
### Community 236 - "test_slots_container_state.py"
Cohesion: 0.09
...
### Community 240 - "Hal0MemoryClient"
Cohesion: 0.09
...
### Community 241 - "settings.py"
Cohesion: 0.06
Nodes (62): MigrationPlan, _apply_store_change(), _config_to_dict(), ConfigInvalidError, _deep_merge(), get_apply_plan(), get_model_store(), get_settings() (+54 more)

### Community 242 - "benchmarks.py"
Cohesion: 0.09
Nodes (33): _api_base(), delete_queue(), get_cells(), get_events(), get_history(), get_plan(), get_queue(), get_run() (+25 more)

### Community 243 - "memory_admin.py"
Cohesion: 0.13
...
### Community 244 - "test_agent_uninstall_memory.py"
Cohesion: 0.12
...
### Community 245 - "import_toml_to_sqlite"
Cohesion: 0.13
...
### Community 246 - "load_profiles_config"
Cohesion: 0.11
...
### Community 249 - "test_metrics_prometheus_route.py"
Cohesion: 0.09
...
### Community 250 - "test_hf_routes.py"
Cohesion: 0.13
Nodes (33): hf_app(), hf_client(), _hf_search_handler(), _patch_httpx_transport(), Any, Exception, FastAPI, MonkeyPatch (+25 more)

### Community 251 - "_fake_run"
Cohesion: 0.18
Nodes (23): AnswersError, _apply_network(), _check_top_level_keys(), _check_version(), gen_download_requested(), _load_yaml(), Any, SlotSelection (+15 more)

### Community 252 - "test_memory_admin_routes.py"
Cohesion: 0.16
...
### Community 253 - "test_stacks_routes.py"
Cohesion: 0.14
...
### Community 255 - "browser_server.py"
Cohesion: 0.10
...
### Community 256 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.06
...
### Community 262 - "profile.py"
Cohesion: 0.09
Nodes (21): hal0-provider — Hermes ``ProviderProfile`` plugin (canonical, shipped source)., Register the hal0 provider profile.      Prefers a ``PluginContext`` seam if one, register(), assemble_stream(), Hal0ProviderProfile, is_alias(), iter_sse_data(), parse_sse_chunks() (+13 more)

### Community 263 - "die"
Cohesion: 0.14
Nodes (26): doctor_models(), Audit the model pipeline: registry paths, store/roots agreement, FLM dir.      C, bank_consolidate_cmd(), bank_delete_cmd(), bank_export_cmd(), bank_import_cmd(), bank_list_cmd(), bank_stats_cmd() (+18 more)

### Community 264 - "test_brain_injection.py"
Cohesion: 0.17
...
### Community 267 - "Platform-wide cron/automation management — design"
Cohesion: 0.06
...
### Community 269 - "hal0 ROCmFPX quantization"
Cohesion: 0.06
...
### Community 270 - "test_board_chat_admin_tools.py"
Cohesion: 0.12
...
### Community 273 - "ML-2 (file-set pulling) + ML-3 (unified store) — implementation spec"
Cohesion: 0.06
...
### Community 274 - "chat_proxy.py"
Cohesion: 0.08
Nodes (40): Request, Verify a fresh session cookie on REST endpoints.      Raises 403 if absent / sig, require_browser_auth(), events_ws(), _hermes_base_url(), _hermes_host(), _hermes_port(), _hermes_rpc() (+32 more)

### Community 275 - "get_doctor"
Cohesion: 0.08
Nodes (23): DiagnosisOut, DoctorResponse, EvidenceOut, get_doctor(), NextStepOut, Diagnosis, Request, T (+15 more)

### Community 276 - "test_hermes_executor.py"
Cohesion: 0.18
...
### Community 278 - "repository.py"
Cohesion: 0.07
Nodes (37): blob_referents(), bump_blob_ref(), drop_blob_ref(), get_blob(), insert_blob(), insert_model_file(), list_model_files(), model_to_row() (+29 more)

### Community 279 - "slot_instance_token"
Cohesion: 0.12
...
### Community 282 - "test_doctor_all.py"
Cohesion: 0.08
...
### Community 283 - "test_preflight_gpu_gate.py"
Cohesion: 0.10
...
### Community 284 - "useLogs.ts"
Cohesion: 0.08
Nodes (40): CuratedModel, Every curated model must have a deployable source: either HF pull         coordi, One curated entry surfaced by the FirstRun wizard.      The wizard renders these, backfill_coordless(), CandidateModel, find_candidates(), _guess_capability(), _is_mmproj_sidecar() (+32 more)

### Community 285 - "mockFixtures.ts"
Cohesion: 0.06
Nodes (21): BIG_HUBS, BIG_LINK_TYPES, BIG_TOPICS, buildBackends(), buildCapabilities(), Builder, buildHardware(), buildModels() (+13 more)

### Community 286 - "KeyError"
Cohesion: 0.12
...
### Community 288 - "ModelsConfig"
Cohesion: 0.08
Nodes (15): ModelsConfig, [models] section of hal0.toml — discovery + auto-detect., Empty means "env var / FLM default cache"; non-empty must be absolute., Roots the discovery scan actually walks: declared ``roots`` plus the         eff, Reject relative paths — discovery walks must start from an absolute root., Empty means "use pull_root"; non-empty must be absolute., Return the resolved model-store path consumers should point at.          Precede, Tests for ModelsConfig — schema defaults + absolute-path validator. (+7 more)

### Community 289 - "memory.py"
Cohesion: 0.15
...
### Community 290 - "test_agents_personas.py"
Cohesion: 0.15
...
### Community 291 - "test_chat_proxy.py"
Cohesion: 0.11
Nodes (30): _authorise_client(), client(), fake_hermes(), FakeHermes, _free_port(), FastAPI, MonkeyPatch, Path (+22 more)

### Community 292 - "test_chat_templates.py"
Cohesion: 0.12
...
### Community 293 - "test_board_routes.py"
Cohesion: 0.10
...
### Community 295 - "test_uninstall.py"
Cohesion: 0.10
...
### Community 296 - "test_bootstrap_prereq_parity.py"
Cohesion: 0.11
...
### Community 299 - "P3-slots: Decomposition Spec for `slots/manager.py`"
Cohesion: 0.07
...
### Community 301 - "orchestrate_models"
Cohesion: 0.11
...
### Community 302 - "test_auth_rotate.py"
Cohesion: 0.09
...
### Community 308 - "Tier 2 — medium (one PR each)"
Cohesion: 0.07
...
### Community 309 - "PART 0 — Current registry, mapped (file:line)"
Cohesion: 0.07
...
### Community 315 - "scan_and_register"
Cohesion: 0.12
...
### Community 316 - "merge_slot_config"
Cohesion: 0.11
...
### Community 320 - "test_v1_audio.py"
Cohesion: 0.13
...
### Community 322 - "test_pressure_eviction.py"
Cohesion: 0.20
...
### Community 324 - "Recommended hal0 ideas"
Cohesion: 0.07
...
### Community 325 - "hal0 Hermes Integration Suite Implementation Plan"
Cohesion: 0.07
...
### Community 329 - "system_info_command.py"
Cohesion: 0.18
...
### Community 335 - "test_agent_restart_endpoint.py"
Cohesion: 0.18
...
### Community 336 - "test_memory_subgraph.py"
Cohesion: 0.07
...
### Community 339 - "test_models_routes.py"
Cohesion: 0.05
Nodes (62): activate_agent_persona(), get_agent_persona(), list_agent_personas(), _persona_detail(), _persona_summary(), PersonaApprovalUpdate, PersonaUpdateBody, Any (+54 more)

### Community 340 - "test_npu_occupancy.py"
Cohesion: 0.15
...
### Community 343 - "test_router_loop.py"
Cohesion: 0.19
...
### Community 344 - "test_event_contract.py"
Cohesion: 0.15
...
### Community 345 - "test_migrate_haloai.py"
Cohesion: 0.15
...
### Community 346 - "ML-4 (runner-image registry) + ML-5 (flag resolution) — implementation-ready spec"
Cohesion: 0.08
...
### Community 347 - "R5 — Surface + launch"
Cohesion: 0.08
...
### Community 350 - "test_doctor_profiles.py"
Cohesion: 0.10
...
### Community 353 - "evaluate_model_fit"
Cohesion: 0.47
...
### Community 355 - "test_v1_slot_alias_models.py"
Cohesion: 0.13
...
### Community 356 - "test_agent_approvals_list.py"
Cohesion: 0.09
...
### Community 357 - "test_slot_create_flags.py"
Cohesion: 0.11
...
### Community 359 - "test_comfyui_container_spec.py"
Cohesion: 0.16
...
### Community 360 - "test_container_assembler.py"
Cohesion: 0.07
...
### Community 363 - "test_id_keying.py"
Cohesion: 0.20
...
### Community 366 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 367 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 368 - "hal0 benchmarking system — full design (batch runs, rich run detail, display, auto-update)"
Cohesion: 0.08
...
### Community 370 - "read_gguf_header"
Cohesion: 0.18
...
### Community 371 - "migrate-haloai.py"
Cohesion: 0.17
Nodes (6): FAMILY_DEFAULTS — the per-family override layer (gemma → f16 KV)., Per spec-flags-ownership §2 + spec §1.2:         - profile.flags are NOT in argv, A qwen model has no FAMILY_DEFAULTS entry, so no family KV is forced.         FL, FLAGS-own: a slot [server].extra_args is INERT at launch         (per spec-flags, The vulkan seed ships minimal flags with NO forced KV quant.          The 2026-0, TestFamilyDefaults

### Community 372 - "test_profile_derivation_parity.py"
Cohesion: 0.22
Nodes (9): ModelRegistry, Path, Tests for stack export: reference embedding + envelope + checksum.  Targeted fil, A model that IS in the registry but with EMPTY coords, yet present in         th, A coord-less registry row with no curated match exports empty coords         (th, reg(), _stack(), TestEmbedReferences (+1 more)

### Community 373 - "chat_commands.py"
Cohesion: 0.14
...
### Community 378 - "migrate_slot_id_keying"
Cohesion: 0.13
...
### Community 379 - "read_stack_state"
Cohesion: 0.15
...
### Community 380 - "test_dashboard_layout.py"
Cohesion: 0.11
...
### Community 381 - "test_logs_routes.py"
Cohesion: 0.11
...
### Community 383 - "test_v1_models_filters.py"
Cohesion: 0.12
...
### Community 384 - "test_brain_read_only.py"
Cohesion: 0.14
...
### Community 391 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.08
...
### Community 393 - "HermesKanbanClient"
Cohesion: 0.21
...
### Community 395 - "snapshot_live_stack"
Cohesion: 0.17
...
### Community 396 - "applied_versions"
Cohesion: 0.15
Nodes (10): ContainerProvider, Path, Every shipped seed slot's `profile` must resolve to a live SEED_PROFILES key., Verify load_sync writes unit and calls systemctl correctly., load_sync bakes the slot ``context_size`` (base --ctx-size, still         slot-r, load_sync must pass the registry model id (model_info._model_key)         as --a, WS-J (#1103): install (``load_sync``) and update         (``rerender_unit_sync``, The displayed resolved_command must show --ctx-size so it matches         what a (+2 more)

### Community 397 - "seed_static_slots"
Cohesion: 0.18
Nodes (21): Collection, Static slot-config seeds shipped in ``installer/etc-hal0/slots/``.  ``install.sh, Copy any missing static seed TOML into the slots config dir.      Idempotent and, seed_static_slots(), _fake_installer_root(), Path, Unit tests for :mod:`hal0.install.static_seeds`.  Closes the same fresh-install-, Omitting existing_names keeps the pure file-existence behaviour. (+13 more)

### Community 398 - "write_slot_toml"
Cohesion: 0.12
...
### Community 401 - "_container_cgroup_mem_bytes"
Cohesion: 0.14
...
### Community 403 - "test_run_as_hal0_guard.py"
Cohesion: 0.13
...
### Community 404 - "test_brain_self_auth.py"
Cohesion: 0.18
...
### Community 405 - "test_seeds_data.py"
Cohesion: 0.08
...
### Community 406 - "test_installed.py"
Cohesion: 0.08
Nodes (35): _addon_path(), advertise(), advertised_ids(), mdns_hostname(), Path, mDNS / avahi discovery for companion services.  If something else drops ``/etc/a, Write one addon file per (id, name, port); prune stale addon files.      Atomic, Remove every hal0-addon-*.service file. (+27 more)

### Community 407 - "test_npu_columns.py"
Cohesion: 0.15
...
### Community 414 - "map_backend_to_device"
Cohesion: 0.13
...
### Community 415 - "test_slot_migrate_id_keying.py"
Cohesion: 0.13
...
### Community 416 - "provision_comfyui_downloads"
Cohesion: 0.13
...
### Community 417 - "test_hw_slot_ownership_migration.py"
Cohesion: 0.22
...
### Community 423 - "container_enrichment"
Cohesion: 0.19
Nodes (8): _image_mismatch(), Return True iff both image refs are known AND differ (#663).      The determinis, container_enrichment(), Per-slot live container state.      For each slot, probes two live sources:, _container_cfg(), FakeContainerProvider, Duck-typed stand-in for ContainerProvider (sync + async mix matches)., TestContainerEnrichment

### Community 424 - "test_config_drift_aliases.py"
Cohesion: 0.09
...
### Community 425 - "test_agent_memory_stats_endpoint.py"
Cohesion: 0.16
...
### Community 426 - "test_backends_npu_canonical_fields.py"
Cohesion: 0.13
...
### Community 429 - "test_settings_models_store.py"
Cohesion: 0.17
...
### Community 430 - "Path"
Cohesion: 0.19
Nodes (8): ProfileConfig, test_cloned_from_defaults_to_none_and_survives_update(), test_cloned_from_persists_and_round_trips(), test_create_update_delete_profile(), test_custom_profile_has_no_bench_and_round_trips_intent_quant(), test_delete_profile_in_use_raises_conflict(), test_used_by_lists_bound_slots(), test_used_by_lists_bound_slots_id_keyed()

### Community 431 - "test_probes.py"
Cohesion: 0.15
...
### Community 432 - "_honcho_cfg"
Cohesion: 0.17
Nodes (19): _arbiter_unavailable(), comfyui_invalid_workflow_launch(), comfyui_pin(), comfyui_restart(), comfyui_switchover(), comfyui_workflow_launch(), _get_arbiter(), BackgroundTasks (+11 more)

### Community 433 - "FakeContainerProvider"
Cohesion: 0.10
...
### Community 435 - "services.jsx"
Cohesion: 0.15
Nodes (14): capability_from_filename(), classify(), DeviceMeta, labels_of(), model_capabilities_of(), Any, model_meta — the one home for model classification + device→backend resolution., Return the primary modality bucket for a model.      Reads the model's ``capabil (+6 more)

### Community 436 - "CliRunner"
Cohesion: 0.16
...
### Community 437 - "UI drawers — slot/model/profile editors"
Cohesion: 0.09
...
### Community 438 - "hal0 Settings Menu — Wireframe / IA"
Cohesion: 0.09
...
### Community 439 - "service_identity.py"
Cohesion: 0.14
...
### Community 440 - "test_hermes_upgrade.py"
Cohesion: 0.20
...
### Community 441 - "dashboard_layout.py"
Cohesion: 0.12
...
### Community 442 - "test_tts_request_defaults.py"
Cohesion: 0.15
...
### Community 444 - "memory_commands.py"
Cohesion: 0.21
...
### Community 445 - "migrate_unify_cmd"
Cohesion: 0.09
Nodes (33): disable_cmd(), enable_cmd(), honcho_render_env_cmd(), provider_list_cmd(), Any, hal0 memory subcommands — graph-extraction gate.  Mirrors the slot / model CLI s, Enable the memory subsystem (persists [memory].enabled=true)., Disable the memory subsystem (persists [memory].enabled=false). (+25 more)

### Community 446 - "__init__.py"
Cohesion: 0.19
Nodes (20): claimed_by_other(), collect_claims(), _config_claims(), conflicts(), _listener_claims(), next_free(), _owners(), port_report() (+12 more)

### Community 447 - "test_hermes_env_seam.py"
Cohesion: 0.15
...
### Community 449 - "test_providers.py"
Cohesion: 0.13
...
### Community 450 - "test_services_page.py"
Cohesion: 0.11
...
### Community 451 - "test_v1_proxy.py"
Cohesion: 0.14
...
### Community 452 - "test_virtual_models.py"
Cohesion: 0.17
...
### Community 453 - "test_brain_framing.py"
Cohesion: 0.23
...
### Community 454 - "test_trio_status_inheritance.py"
Cohesion: 0.18
...
### Community 455 - "test_doctor_verify.py"
Cohesion: 0.12
...
### Community 461 - "P2-config: Collapse capabilities.toml double-bookkeeping"
Cohesion: 0.10
...
### Community 465 - "test_fetch_ws_g.py"
Cohesion: 0.14
...
### Community 470 - "embed_references"
Cohesion: 0.20
Nodes (14): apply_preferred_profile(), defuse_stale_mtp_on_swap(), preferred_profile_for(), profile_fits_slot(), ProfileAdoptHost, Any, Model-preferred-profile adoption + MTP defuse (P3-slots §1g).  Q1 (model profile, True when ``RUNNER_IMAGES[runner_key]`` is safe to adopt for this slot.      Mir (+6 more)

### Community 471 - "huggingface.py"
Cohesion: 0.13
...
### Community 472 - "test_memory_admin_document_transfer.py"
Cohesion: 0.20
...
### Community 473 - "test_pull_shutdown.py"
Cohesion: 0.16
...
### Community 476 - "test_eligibility.py"
Cohesion: 0.10
...
### Community 477 - "test_disabled_capability_slot_is_not_woken"
Cohesion: 0.20
...
### Community 478 - "Security review — v1.0 auth surface (2026-05-21)"
Cohesion: 0.10
...
### Community 479 - "_write_fake_python"
Cohesion: 0.20
...
### Community 480 - "test_approval_queue.py"
Cohesion: 0.10
...
### Community 481 - "test_manager_npu_container.py"
Cohesion: 0.20
...
### Community 482 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.10
...
### Community 485 - "_refresh_model_cache_on_ready"
Cohesion: 0.14
...
### Community 489 - "MemoryGraphConfig"
Cohesion: 0.13
...
### Community 493 - "_reconcile_device_profile"
Cohesion: 0.15
...
### Community 496 - "test_journal_routes.py"
Cohesion: 0.12
...
### Community 497 - "test_slot_config_validation.py"
Cohesion: 0.20
...
### Community 501 - "test_model_first_run_commands.py"
Cohesion: 0.17
...
### Community 502 - "test_model_store_root.py"
Cohesion: 0.14
...
### Community 503 - "TestEarlyHal0User"
Cohesion: 0.10
...
### Community 505 - "test_comfyui_workflows.py"
Cohesion: 0.20
...
### Community 506 - "test_curated_image_models.py"
Cohesion: 0.18
...
### Community 507 - "test_fail_watcher.py"
Cohesion: 0.18
...
### Community 508 - "profiles-crud-v3.spec.ts"
Cohesion: 0.10
...
### Community 509 - "0. Research-grounded findings that drive the matrix"
Cohesion: 0.11
...
### Community 513 - "health.py"
Cohesion: 0.15
Nodes (17): _disk_free_mb(), get_status(), health(), health_system(), _memory_degraded(), metrics_prometheus(), Any, Path (+9 more)

### Community 514 - ".reindex"
Cohesion: 0.08
...
### Community 515 - "test_board_dispatch.py"
Cohesion: 0.19
...
### Community 516 - "upstream_commands.py"
Cohesion: 0.11
...
### Community 524 - ".json"
Cohesion: 0.26
Nodes (9): Any, _model_info(), Unit tests for ``hal0.providers.container.ContainerProvider``.  Issue #655 — tra, #863: drift watches exact argv spellings, so renderer renames must fail., Registry-miss contract (Phase C final review): model_info without a     ``path``, Regression guard for the 2026-06-15 chat@4096 incident: a slot whose     TOML pi, _slot_cfg(), test_resolve_model_path_registry_miss_falls_back_to_bare_id() (+1 more)
...
### Community 529 - "test_manager_readiness_api.py"
Cohesion: 0.33
...
### Community 530 - "hal0 architecture & reference"
Cohesion: 0.11
...
### Community 531 - "FakeDelegateRunner"
Cohesion: 0.16
...
### Community 533 - "2. Bugs (correctness — ordered by impact)"
Cohesion: 0.11
...
### Community 534 - "manage-slots.mdx"
Cohesion: 0.11
...
### Community 535 - "spec-kb23 — hal0-brain chat tool-tier, approval-gate & injection-resistance"
Cohesion: 0.11
...
### Community 536 - "hal0-admin tools"
Cohesion: 0.11
...
### Community 537 - "kokoro_server.py"
Cohesion: 0.18
Nodes (15): _fetch_pve_resources(), _load_pve_config(), pop_transition(), project_slim(), pve_status(), pve_test(), Any, Blocking GET /api2/json/cluster/resources. Run via to_thread. (+7 more)

### Community 538 - "SlotView"
Cohesion: 0.15
...
### Community 540 - "ensure_podman_apparmor_usable"
Cohesion: 0.19
...
### Community 541 - "ProgressCoalescer"
Cohesion: 0.14
...
### Community 547 - "mdns.py"
Cohesion: 0.06
Nodes (59): model_root(), ModelRegistry, Path, Tests for hal0.registry.discover — filesystem scan + auto-register., End-to-end: a NON-curated reranker gguf under a scan root registers with     cap, A discovered file whose name matches a curated entry's hf_file     must surface, Files already in known_paths must not appear in the candidate list., A Model with no sidecar carries mmproj=None (the registry contract     the llama (+51 more)

### Community 548 - "arbiter.py"
Cohesion: 0.12
...
### Community 550 - "test_hermes_security_deliverables.py"
Cohesion: 0.15
...
### Community 551 - "test_mcp_client.py"
Cohesion: 0.18
...
### Community 553 - "test_comfyui_phase4.py"
Cohesion: 0.13
...
### Community 554 - "test_models_preview.py"
Cohesion: 0.19
...
### Community 556 - "test_settings_apply.py"
Cohesion: 0.11
...
### Community 557 - "test_v1_dispatch.py"
Cohesion: 0.16
...
### Community 558 - "test_doctor_perms.py"
Cohesion: 0.19
...
### Community 574 - "slots_config_dir"
Cohesion: 0.18
...
### Community 581 - "config_enrichment"
Cohesion: 0.29
...
### Community 583 - "metrics_collect.py"
Cohesion: 0.15
...
### Community 592 - "test_npu_trio_shadow.py"
Cohesion: 0.10
Nodes (24): is_npu_trio_shadow(), NpuTrioHost, Any, NPU FLM-trio shadow reconciler (P3-slots §1d).  The NPU runs a single ``flm serv, True if *cfg* is an NPU FLM trio **shadow** (stt/embed), not the anchor.      Th, Narrow seam :func:`reconcile_trio_slots` needs from ``SlotManager``., Startup pass: reconcile the FLM-trio shadow slots to canon.      The NPU runs on, reconcile_trio_slots() (+16 more)

### Community 593 - "test_ttft_samples.py"
Cohesion: 0.12
...
### Community 598 - "hal0_gpu_gate.py"
Cohesion: 0.16
...
### Community 604 - "route_to_chat.py"
Cohesion: 0.19
...
### Community 605 - "RecordingSlotArtifactOps"
Cohesion: 0.21
Nodes (15): build_auto_selections(), Non-interactive defaults for ``--auto`` (install.sh path): scaffold the     capa, npu_healthy(), True only when the NPU is present AND functionally healthy.      "Healthy" means, _hw(), `brain` rides the chat-capability device/profile derivation and, like     every, test_auto_selections_brain_scaffold_is_chat_capability(), test_auto_selections_default_keeps_extensions_and_agent_slot() (+7 more)

### Community 606 - "test_hermes_provision_install_artifacts.py"
Cohesion: 0.06
...
### Community 607 - "test_agents_routes.py"
Cohesion: 0.21
...
### Community 608 - "test_mcp_identity.py"
Cohesion: 0.18
...
### Community 609 - "FakeDockerBackend"
Cohesion: 0.16
...
### Community 610 - "hal0 test harness — internal contributor guide"
Cohesion: 0.12
...
### Community 611 - "Model registry — registry, pulls, classification"
Cohesion: 0.13
...
### Community 612 - "Handoff: qwen3tts standalone → hal0-slot migration"
Cohesion: 0.13
...
### Community 613 - "Container Image System Overhaul"
Cohesion: 0.13
...
### Community 614 - "hal0 rework plan — de-scarring the launch"
Cohesion: 0.13
...
### Community 615 - "Handoff — fold rework→main merge/meld/fix follow-ups into the R5 docs"
Cohesion: 0.13
...
### Community 616 - "Handoff — hal0 R5 endgame (paste-in brief for a new session)"
Cohesion: 0.13
...
### Community 617 - "Findings (O-series)"
Cohesion: 0.13
...
### Community 619 - "hal0 Hermes Integration Suite Design"
Cohesion: 0.13
...
### Community 621 - "test_route_collisions.py"
Cohesion: 0.19
...
### Community 622 - "upsert_env_value"
Cohesion: 0.28
Nodes (8): SlotConfig, _load_slot(), Every static seed slot TOML validates against SlotConfig and matches the spec-p3, Every static seed populates n_gpu_layers and threads (per spec §3.1 + §3.3)., brain.toml docstring recommends tool_model = hal0/agent per spec-p3-brain §5a, test_brain_slot_docstring_recommends_hal0_agent(), test_static_seed_slot_matches_mapping(), test_static_seed_slot_populates_hw_grid()

### Community 623 - "agents.py"
Cohesion: 0.09
Nodes (30): _profile(), SimpleNamespace, Unit tests for the slot image-resolution chain (spec-hw-slot-ownership §3).  The, The [image] image-gen table (#599) shares no key with image_pin, so it     can n, The launch renderer's (image, flags) tuple uses the slot image_pin., No image_pin, no binary → the HW-gated rocmfpx default., A device-agnostic profile stand-in. ``image`` is set only to prove it is     IGN, slot.image_pin overrides the BINARY-resolved default, verbatim. (+22 more)

### Community 624 - "create_chat_template"
Cohesion: 0.24
...
### Community 625 - "test_slots_policy.py"
Cohesion: 0.16
...
### Community 630 - "save_stacks_config"
Cohesion: 0.05
...
### Community 632 - ".snapshot"
Cohesion: 0.15
Nodes (5): Tests for the [npu] slot table and the flm seed profile (Phase A)., NpuConfig.chat defaults to True - chat-first FLM container shape., flm.toml is THE seeded NPU slot (install.sh seed loop); the old     npu.toml nea, test_npu_chat_default_on(), test_seed_flm_toml_validates()
...
### Community 635 - "test_hermes_provision_kanban_db_init.py"
Cohesion: 0.15
...
### Community 636 - "test_persona_update.py"
Cohesion: 0.25
...
### Community 637 - "test_brain_ctx_precheck.py"
Cohesion: 0.23
...
### Community 640 - "test_pool_bounds.py"
Cohesion: 0.15
...
### Community 642 - "test_admin_route_map.py"
Cohesion: 0.17
...
### Community 643 - "test_container_mmproj.py"
Cohesion: 0.16
...
### Community 644 - "test_device_profile_coherence.py"
Cohesion: 0.18
...
### Community 645 - "test_mtp_defuse.py"
Cohesion: 0.29
...
### Community 646 - "test_integrations.py"
Cohesion: 0.13
...
### Community 649 - "Toolbox Repo Consolidation"
Cohesion: 0.14
...
### Community 650 - "obtain-models.mdx"
Cohesion: 0.14
...
### Community 651 - "Deploy halves of the "CI here" scenarios"
Cohesion: 0.14
...
### Community 652 - "PART 2 — DELIVERABLES"
Cohesion: 0.14
...
### Community 653 - "0. EXACT Honcho footprint (file:line)"
Cohesion: 0.14
...
### Community 654 - "P2-device: make `device` the sole truth, delete the `backend` dual-write"
Cohesion: 0.14
...
### Community 655 - "Handoff — R5 drive 2: put it back together (paste-in prompt, Fable orchestrator)"
Cohesion: 0.14
...
### Community 657 - "test_ports_command.py"
Cohesion: 0.17
...
### Community 658 - "test_moonshine_server.py"
Cohesion: 0.22
...
### Community 663 - "MetricsRetention"
Cohesion: 0.17
...
### Community 665 - "heal_missing_llm_type"
Cohesion: 0.20
...
### Community 666 - "provider_requires_model"
Cohesion: 0.22
...
### Community 667 - "test_hermes_provision_context.py"
Cohesion: 0.14
...
### Community 668 - "test_middleware.py"
Cohesion: 0.21
...
### Community 669 - "test_services_health.py"
Cohesion: 0.27
...
Cohesion: 0.18
Nodes (10): RuntimeLaunchPlan, _exec_tokens(), shlex-split the rendered ``Exec=`` argv back into tokens., host-net ⇄ loopback-bind coupling (podman-unprivileged-findings.md, Issue 1)., THE invariant. A plan pinned network_mode=host binds loopback., A plan with empty network_mode picks up the [slots].network_mode=host         bo, Bridge (empty network_mode, no host default): the process binds         0.0.0.0, publish_host=0.0.0.0 widens the PUBLISH (bridge); the process bind is         un (+2 more)

### Community 687 - "test_drift.py"
Cohesion: 0.20
...
### Community 688 - "Contributor Covenant Code of Conduct"
Cohesion: 0.15
Nodes (12): 1. Correction, 2. Warning, 3. Temporary Ban, 4. Permanent Ban, Attribution, Contributor Covenant Code of Conduct, Enforcement, Enforcement Guidelines (+4 more)

### Community 689 - "3. Recommendation: how hal0 should support ONNX"
Cohesion: 0.15
...
### Community 690 - "Dispatch / runtime — routing, arbiter, lifecycle"
Cohesion: 0.15
...
### Community 693 - "pull-and-register-models.mdx"
Cohesion: 0.15
...
### Community 694 - "hal0 rework — handoff: single primary orchestrator (R3-B / R4 / R5 + finish line)"
Cohesion: 0.15
...
### Community 697 - "_phase_preflight"
Cohesion: 0.23
...
### Community 698 - "QueryStringScrubber"
Cohesion: 0.18
...
### Community 699 - "proxy_board_events"
Cohesion: 0.21
...
### Community 702 - "AgentMetadataConfig"
Cohesion: 0.19
...
### Community 705 - "test_containers_apparmor.py"
Cohesion: 0.37
...
### Community 706 - "test_hermes_live_resolve_render.py"
Cohesion: 0.26
...
Cohesion: 0.14
Nodes (8): Unit tests for the profile catalog — schema, loader, and flag resolver.  Targete, Per spec §4.1: device_class defaults to None (device-agnostic)., Generic profiles are device-agnostic (slot owns device per §4.1);     device-spe, PS-1: DEVICE_DEFAULT_PROFILES["cpu"] must name a chat-capable profile., test_cpu_default_profile_supports_llm(), test_profile_device_class_defaults_none(), test_seed_device_classes(), TestProfilesConfig

### Community 708 - "test_activity.py"
Cohesion: 0.31
...
### Community 709 - "test_activity_routes_instrumented.py"
Cohesion: 0.38
...
### Community 710 - "test_comfyui_fetch_route.py"
Cohesion: 0.15
...
### Community 711 - "test_events_fixes.py"
Cohesion: 0.21
...
### Community 712 - "test_memory_graph_commands.py"
Cohesion: 0.15
...
### Community 713 - "test_model_verbs.py"
Cohesion: 0.26
...
### Community 718 - "Recently added endpoints"
Cohesion: 0.17
...
### Community 719 - "HW-slot-ownership — hardware sticks to slots, logical tune sticks to models"
Cohesion: 0.17
...
### Community 720 - "Design — 3-tier, deny-by-default, single classification source"
Cohesion: 0.17
...
### Community 721 - "hal0 UI/UX design brief — post-R3 surface rework"
Cohesion: 0.17
...
### Community 724 - "Release pipeline — prototype findings + blockers"
Cohesion: 0.17
...
### Community 732 - "_derive_ns"
Cohesion: 0.14
Nodes (5): §7.1a / ML-5: profile.mtp is informational only — resolve_profile_flags, profile.mtp=True alone (no explicit mtp_override) no longer         expands the, A profile that pins its own --spec-draft-* values keeps them; the MTP         bu, MTP_FLAG_BUNDLE constant is verbatim in the resolved string., TestResolveProfileFlags

### Community 734 - "serialize_slot"
Cohesion: 0.29
Nodes (3): Serialise a real Slot snapshot into the API shape.      Adds ``kind="local"`` so, serialize_slot(), TestSerializeSlot

### Community 735 - "test_board_ws.py"
Cohesion: 0.32
...
### Community 736 - "test_agent_status.py"
Cohesion: 0.23
...
### Community 738 - "test_comfyui_scripts_shipped.py"
Cohesion: 0.17
...
### Community 739 - "graphForBank"
Cohesion: 0.13
Nodes (16): bankFrom(), buildBankOperations(), buildBankRecall(), buildBankStats(), buildBankTimeseries(), buildBigMemFactGraph(), buildDenseFactGraph(), buildMemEntityGraph() (+8 more)
...
### Community 758 - "deps.py"
Cohesion: 0.16
Nodes (7): Path, Tests for Phase D1 — comfyui seed profile, img slot seed, [image] section (#599), Seeds are virtual — the shipped installer file must NOT materialise any.      A, test_load_slot_config_populates_image_gen(), test_load_slot_config_string_image_survives_in_extra(), test_save_load_round_trip_preserves_image_gen(), test_seed_profiles_toml_materialises_no_seeds()

### Community 759 - "services_health"
Cohesion: 0.19
...
### Community 764 - "rerender_slot_units"
Cohesion: 0.07
...
### Community 765 - "test_hermes_provision_collect.py"
Cohesion: 0.25
...
### Community 767 - "test_config_model_roots.py"
Cohesion: 0.29
...
### Community 768 - "test_doctor_route.py"
Cohesion: 0.19
...
### Community 769 - "test_features_health.py"
Cohesion: 0.25
...
### Community 770 - "test_meta_enums.py"
Cohesion: 0.42
...
### Community 772 - "test_server_ab_helpers.py"
Cohesion: 0.22
...
### Community 773 - "test_board_commands.py"
Cohesion: 0.27
...
### Community 774 - "test_model_import_backup.py"
Cohesion: 0.29
...
### Community 784 - "Profiles / stacks — profile/stack/bundle layering"
Cohesion: 0.20
...
### Community 786 - "honcho-memory.mdx"
Cohesion: 0.20
...
### Community 787 - "7. Product-shaped reworks (from the six field notes)"
Cohesion: 0.20
...
### Community 788 - "FLAGS-own — llama.cpp flags stick to models; profiles become templates"
Cohesion: 0.20
...
### Community 789 - "hal0 SETTINGS rework — implementation-ready spec"
Cohesion: 0.20
...
### Community 790 - "Slot / Model / Profile / Flags / Image — reworked runtime model (R3)"
Cohesion: 0.20
...
### Community 791 - "Global Constraints"
Cohesion: 0.20
...
### Community 792 - "Dashboard Plugin JS Loading Internals"
Cohesion: 0.20
...
### Community 799 - "resolve_chat_template"
Cohesion: 0.27
...
### Community 801 - "collect_port_claims"
Cohesion: 0.29
...
### Community 803 - "_brain_profile_state"
Cohesion: 0.20
...
### Community 804 - "TestStatusTelemetry"
Cohesion: 0.38
...
### Community 806 - "TestClient"
Cohesion: 0.27
Nodes (11): _load_seed_profiles(), Seed profile catalog validation.  Per docs/superpowers/specs/2026-07-20-seeded-p, Catalog parses as TOML and contains [profile.*] tables., 1.0 catalog is exactly 16 profiles (11 kept + 5 new)., test_agnostic_profile_has_no_device_class(), test_all_profiles_have_intent(), test_all_profiles_have_no_hardware_flags(), test_all_profiles_have_no_operational_flags() (+3 more)

### Community 808 - "test_catalog_npu_stt.py"
Cohesion: 0.27
...
### Community 809 - "test_shared_auth.py"
Cohesion: 0.33
...
### Community 811 - "test_validate_catalog.py"
Cohesion: 0.24
...
### Community 813 - "TestSlotHardwareSegment"
Cohesion: 0.32
...
### Community 815 - "test_curated_pull_coords.py"
Cohesion: 0.20
...
### Community 816 - "mock.ts"
Cohesion: 0.20
Nodes (11): _FakeProbe, _gpu_hardware(), POST /api/install/apply — orchestrated multi-slot install (FirstRun v2 D3)., The Advanced-drawer overrides (model_id + profile + device) win over the     aut, WS-I (#1101): the /apply endpoint itself writes the first-run sentinel     on su, /apply is a thin tier→selections adapter over the same core that     /apply-sele, A ROCm-capable box so derive_device yields gpu-rocm (this CI VM has no GPU)., test_apply_delegates_to_apply_selections_core() (+3 more)

### Community 817 - "buildBankSubgraphRoute"
Cohesion: 0.36
...
### Community 821 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 822 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 823 - "ROCmFPX bench — RESULTS + next-session handoff (2026-07-05)"
Cohesion: 0.22
...
### Community 824 - "connect-clients.mdx"
Cohesion: 0.22
...
### Community 825 - "connect-external-providers.mdx"
Cohesion: 0.22
...
### Community 826 - "realtime-voice.mdx"
Cohesion: 0.22
...
### Community 828 - "openai-compat.mdx"
Cohesion: 0.22
...
### Community 829 - "slot-as-model.mdx"
Cohesion: 0.22
...
### Community 830 - "env-vars.mdx"
Cohesion: 0.22
Nodes (8): Install & update, Memory & MCP, Models & providers, Paths, Runtime, See also, Server, Services

### Community 831 - "Handoff prompt — hal0-brain / template / profile changes on lxc105 (hal0, 10.0.1.142)"
Cohesion: 0.22
...
### Community 832 - "PART B — Target: Quadlet `.container` per slot (and per companion)"
Cohesion: 0.22
...
### Community 833 - "SWEEP inventory — the overlooked surface (R5 release-prep)"
Cohesion: 0.22
...
### Community 834 - "Dashboard plugin "Could not load this plugin's script""
Cohesion: 0.22
...
### Community 837 - "migrate_cognee_to_hindsight_dryrun"
Cohesion: 0.25
...
### Community 838 - "ModelCapabilities"
Cohesion: 0.31
...
### Community 842 - "test_hermes_stale_dropin_cleanup.py"
Cohesion: 0.47
...
### Community 843 - "isolated_client_with_root"
Cohesion: 0.33
...
### Community 845 - "test_catalog_flm_blacklist.py"
Cohesion: 0.28
...
### Community 846 - "test_config_show_edit_selector.py"
Cohesion: 0.50
...
### Community 847 - "test_slot_metrics_capacity.py"
Cohesion: 0.36
...
### Community 849 - "conftest.py"
Cohesion: 0.24
Nodes (11): detect_proxmox_host(), _has_pve_kernel(), _is_lxc_init(), _lxc_via_cgroup_v1(), _lxc_via_cgroup_v2_marker(), PveDetectionState, Proxmox host-pressure probe.  Optional integration: on Strix Halo (and any other, Confidence that the current host is a Proxmox-managed LXC.      Used only when / (+3 more)

### Community 850 - "test_static_seeds.py"
Cohesion: 0.17
...
### Community 852 - "test_halo143_reboot_no_split_brain"
Cohesion: 0.39
...
### Community 853 - "test_model_preferred_profile.py"
Cohesion: 0.50
...
### Community 862 - "generate-images.mdx"
Cohesion: 0.25
...
### Community 863 - "update-and-rollback.mdx"
Cohesion: 0.25
...
### Community 864 - "voice-stt-tts.mdx"
Cohesion: 0.25
...
### Community 865 - "paths-and-files.mdx"
Cohesion: 0.25
...
### Community 866 - "13. Observability & metrics baseline (ships in every box)"
Cohesion: 0.25
...
### Community 867 - "15. Hermes plugin — standalone repo + native update path"
Cohesion: 0.25
...
### Community 868 - "PART C — Coordination contracts (cross-lane seams)"
Cohesion: 0.25
...
### Community 869 - "halo143 deploy-validation runbook — rework-R3"
Cohesion: 0.25
...
### Community 870 - "Handoff — R5 Phase 4: deploy window → release cut (paste-in prompt)"
Cohesion: 0.25
...
### Community 871 - "mock-prod-gate verification (Phase 0 launch-blocker #3)"
Cohesion: 0.25
...
### Community 872 - "Podman on the hal0 slot substrate — findings & cleaner solutions"
Cohesion: 0.25
...
### Community 875 - "WorkspaceEscapeError"
Cohesion: 0.25
...
### Community 877 - "Strix Halo Benchmark Harness (hal0)"
Cohesion: 0.25
...
### Community 878 - "install.sh"
Cohesion: 0.39
Nodes (5): _confirm_cpu_only(), _confirm_launch_setup(), _seed_bank(), install.sh script, wait_active()

### Community 879 - "hal0-benchctl"
Cohesion: 0.54
Nodes (6): hal0-benchctl script, die(), post(), validate_backend(), validate_extra(), validate_model()

### Community 880 - "fresh-test-ct.sh"
Cohesion: 0.50
Nodes (7): cleanup(), emit(), log(), PVE(), fresh-test-ct.sh script, SSH(), usage()

### Community 881 - "ensure_gateway_api_server_key"
Cohesion: 0.05
Nodes (60): _active_persona_render(), BootstrapState, _brain_profile_config_path(), _default_mcp_servers(), _fetch_model_contexts(), _generate_api_server_key(), _hal0_service_home(), _http_get() (+52 more)

### Community 882 - "write_gateway_secrets_dropin"
Cohesion: 0.23
...
### Community 883 - "get_agent_memory_stats"
Cohesion: 0.21
...
### Community 884 - "_settings_apply.py"
Cohesion: 0.29
...
### Community 886 - "screen_extra_args_json"
Cohesion: 0.35
...
### Community 888 - "test_apply_selections.py"
Cohesion: 0.36
...
### Community 889 - "test_auth_exposure_route.py"
Cohesion: 0.32
...
### Community 892 - "test_app_list_uninstall.py"
Cohesion: 0.36
...
### Community 893 - "test_cli_docs_parity.py"
Cohesion: 0.36
...
### Community 898 - "_BackendContract"
Cohesion: 0.25
...
### Community 901 - "test_store_on_change.py"
Cohesion: 0.39
...
### Community 902 - "test_slot_create_conflict.py"
Cohesion: 0.29
...
### Community 903 - "test_transition_guard.py"
Cohesion: 0.25
...
### Community 904 - "useTweaksStore.ts"
Cohesion: 0.29
Nodes (5): APPEARANCE_KEYS, DEFAULTS, TweaksState, TweaksStore, useTweaksStore

### Community 905 - "board-chat-tool-use-v3.spec.ts"
Cohesion: 0.29
Nodes (3): GATED_FRAMES, mockChat(), sse()

### Community 906 - "Concurrency & continuous-batching optimization plan"
Cohesion: 0.29
...
### Community 907 - "ROCmFPX exploratory bench — RESULTS (2026-07-05)"
Cohesion: 0.29
...
### Community 913 - "P3-perms: declarative OwnershipStore as the single ownership authority"
Cohesion: 0.29
...
### Community 914 - "PART B — Target: OwnershipStore default `service_user="hal0"`"
Cohesion: 0.29
...
### Community 915 - "PART C — The LOAD-BEARING contract: born-owned"
Cohesion: 0.29
...
### Community 916 - "PART 0 — EXACT MAP (file:line)"
Cohesion: 0.29
...
### Community 917 - "P3-quadlet: migrate slot + companion units to Podman Quadlet `.container`"
Cohesion: 0.29
...
### Community 918 - "PART A — Current scars (in plain English)"
Cohesion: 0.29
...
### Community 919 - "4. Delivery plan and gates"
Cohesion: 0.29
...
### Community 923 - "Gateway connectivity quirks — hal0"
Cohesion: 0.29
...
### Community 932 - "OrchestrationResult"
Cohesion: 0.29
...
### Community 936 - "test_slot_logs_stream_redacts_secret_bearing_lines"
Cohesion: 0.33
...
### Community 938 - "test_config_hardware_probe.py"
Cohesion: 0.43
...
### Community 941 - "TestLoopbackFenceCommand"
Cohesion: 0.22
...
### Community 942 - "test_paths_stub.py"
Cohesion: 0.29
...
### Community 943 - "test_voice_roundtrip.py"
Cohesion: 0.43
...
### Community 944 - "10. Troubleshooting"
Cohesion: 0.29
...
### Community 945 - "test_owui_pin_consistency.py"
Cohesion: 0.43
...
### Community 947 - "resolve_default_image"
Cohesion: 0.36
...
### Community 965 - "24. Execution waves / rollout program (session 3, 2026-07-18)"
Cohesion: 0.33
...
### Community 967 - "§4.4 addendum — MCP admin route-map autogen (the 3 gaps)"
Cohesion: 0.33
...
### Community 968 - "Verification strategy"
Cohesion: 0.33
Nodes (6): Lifecycle and security, Live acceptance, Memory, Provider, Verification strategy, Voice

### Community 969 - "Dashboard permission mismatch (root vs hal0)"
Cohesion: 0.33
...
### Community 989 - "samples_from_events"
Cohesion: 0.33
...
### Community 990 - "test_activity_instrumentation.py"
Cohesion: 0.60
...
### Community 991 - "test_models_catalogue.py"
Cohesion: 0.47
...
### Community 995 - "test_curation_drift.py"
Cohesion: 0.40
...
### Community 1010 - "14. Kanban board — ownership inversion + security hardening"
Cohesion: 0.40
...
### Community 1011 - "16. Hermes Python library (`AIAgent`) for the brain — evaluated, rejected for core"
Cohesion: 0.40
...
### Community 1012 - "21.A Mapping table — every candidate by disposition"
Cohesion: 0.40
...
### Community 1013 - "8. SQLite adoption — setup plan"
Cohesion: 0.40
...
### Community 1014 - "PART A — Current-state map (the scars, in plain English)"
Cohesion: 0.40
...
### Community 1015 - "PART D — The one narrow privileged helper: `hal0-systemctl`"
Cohesion: 0.40
...
### Community 1016 - "PART G — Sequencing: P3-perms BEFORE hermes-provision slim and P3-quadlet"
Cohesion: 0.40
...
### Community 1017 - "PART 0 — Current-state map (the hand-rendered ExecStart scars, file:line)"
Cohesion: 0.40
...
### Community 1023 - "fork-pi-mono.sh"
Cohesion: 0.70
Nodes (4): die(), info(), fork-pi-mono.sh script, warn()

### Community 1024 - "NOTES — answers from the prototype session"
Cohesion: 0.40
...
### Community 1032 - "TestRenderCancel"
Cohesion: 0.40
...
### Community 1034 - "test_distro.sh"
Cohesion: 0.90
Nodes (4): bad(), ok(), test_distro.sh script, want()

### Community 1036 - "agent-card.jsx"
Cohesion: 0.33
Nodes (4): Response, _PlatformRecorder, Request, Like _Recorder but for hal0-api's OWN routes (no kanban prefix).

### Community 1037 - "update_models_config"
Cohesion: 0.07
Nodes (25): Fire-and-forget trigger to refresh the Hermes live-context files.  Called from t, Spawn a detached ``hal0-agent <agent_id> render-context``. Never raises., spawn_context_refresh(), CapabilityApplyFailed, child_to_slot(), legal_children(), Any, CapabilityOrchestrator — bridge between capability children and slots.  The dash (+17 more)

### Community 1040 - "slot-card-container-v3.spec.ts"
Cohesion: 0.40
...
### Community 1041 - "slot-edit-controls-v3.spec.ts"
Cohesion: 0.40
...
### Community 1043 - "[0.9.5.1] — 2026-07-09"
Cohesion: 0.50
Nodes (4): [0.9.5.1] — 2026-07-09, Added, Fixed, Highlights

### Community 1044 - "[0.9.6.1] — 2026-07-11"
Cohesion: 0.50
Nodes (4): [0.9.6.1] — 2026-07-11, Added, Changed, Fixed

### Community 1045 - "[1.0.0] — unreleased (R5 · the rework release)"
Cohesion: 0.50
Nodes (4): [1.0.0] — unreleased (R5 · the rework release), Breaking, Highlights, Migrations

### Community 1046 - "[v0.8.2b3] — 2026-06-29"
Cohesion: 0.50
Nodes (4): Added, Docs, Fixed, [v0.8.2b3] — 2026-06-29

### Community 1047 - "[v0.8.0-beta.1] — 2026-06-21"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.0-beta.1] — 2026-06-21

### Community 1048 - "[v0.7.3-beta.2] — 2026-06-19"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.7.3-beta.2] — 2026-06-19

### Community 1049 - "[v0.5.1-alpha.1] — 2026-06-15"
Cohesion: 0.50
Nodes (4): Added, Changed, Removed, [v0.5.1-alpha.1] — 2026-06-15

### Community 1050 - "[v0.5.0-alpha.1] — 2026-06-14"
Cohesion: 0.50
Nodes (4): Added, Fixed, Internal, [v0.5.0-alpha.1] — 2026-06-14

### Community 1051 - "[v0.9.0] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.9.0] — 2026-07-04

### Community 1052 - "[v0.8.4b1] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.4b1] — 2026-07-04

### Community 1053 - "[v0.8.3b1] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.3b1] — 2026-07-04

### Community 1054 - "[v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)"
Cohesion: 0.50
Nodes (4): Internal contracts, Known follow-up, New / improved, [v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)

### Community 1055 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1056 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1057 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1058 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1059 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1060 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1061 - "benchmarks.mdx"
Cohesion: 0.50
Nodes (3): Scheduled runs are polite, What the installer sets up, Where results go

### Community 1062 - "hal0 docs"
Cohesion: 0.50
Nodes (3): `docs/internal/` — repo-only architecture docs, hal0 docs, Top-level `docs/*.mdx` — user docs

### Community 1063 - "streaming.mdx"
Cohesion: 0.50
Nodes (3): Client example, See also, Wire format

### Community 1064 - "11. Product reworks — round 2 (slot identity, ports, profile org)"
Cohesion: 0.50
...
### Community 1065 - "PART E — `hal0-api` User flip + UMask removal"
Cohesion: 0.50
...
### Community 1066 - "PART F — Edit plan (files, order, delegators/shims)"
Cohesion: 0.50
...
### Community 1067 - "PART H — Risks + capped verification"
Cohesion: 0.50
...
### Community 1068 - "PART E — Migration of running units (the live-box transition)"
Cohesion: 0.50
...
### Community 1069 - "PART F — Risks + capped verification"
Cohesion: 0.50
...
### Community 1070 - "`hal0-voice`"
Cohesion: 0.50
Nodes (4): Dynamic routing, Fallback and privacy, `hal0-voice`, Initial implementation

### Community 1072 - "config.sh"
Cohesion: 0.50
Nodes (3): BACKENDS, CTX_CONFIGS, config.sh script

### Community 1073 - "hal0-systemctl"
Cohesion: 1.00
Nodes (3): hal0-systemctl script, die(), validate_slot_id()

### Community 1074 - "Roadmap"
Cohesion: 0.50
Nodes (4): Exploring (v1.x +), Roadmap, Shipped (v0.9 / public beta), Soon

### Community 1077 - "register_mnt_ai_models.py"
Cohesion: 0.83
Nodes (3): _existing_ids(), main(), _post()

### Community 1078 - "model-drawer-stamp-diverge-v3.spec.ts"
Cohesion: 0.20
Nodes (10): model_is_mtp_eligible(), True when a model should speculate with MTP / NextN draft heads.      §7.1a / ML, §7.1a / ML-5: the old _MTP_NAME_RE path is REMOVED — an 'MTP' token     in the m, The explicit tri-state override wins in EITHER direction — even     suppressing, test_defaults_mtp_none_falls_back_to_tag(), test_eligible_by_registry_tag(), test_explicit_defaults_mtp_false_wins_over_present_tag(), test_explicit_defaults_mtp_true_wins_over_absent_tag() (+2 more)

### Community 1079 - "request_id.py"
Cohesion: 0.67
Nodes (3): install(), FastAPI, Per-request X-Request-ID middleware.

### Community 1080 - "isolated_client"
Cohesion: 0.67
...
### Community 1081 - "bench_commands.py"
Cohesion: 0.50
...
### Community 1087 - "_delegate_fakes.py"
Cohesion: 0.50
...
### Community 1088 - "test_comfyui_path.py"
Cohesion: 0.50
...
### Community 1092 - "ISO"
Cohesion: 0.28
Nodes (9): delete_pve_config(), invalidate_pve_cache(), pve_config_path(), Path, Remove /etc/hal0/proxmox.json. Returns True iff the file existed., Drop the cached pve_status result so the next call re-fetches., Return /etc/hal0/proxmox.json (or HAL0_HOME-rooted equivalent)., Atomically write /etc/hal0/proxmox.json from a flat payload.      Accepts the sa (+1 more)

### Community 1096 - "[0.9.4] — 2026-07-08"
Cohesion: 0.67
Nodes (3): [0.9.4] — 2026-07-08, Added, Fixed

### Community 1097 - "[v0.8.5b2] — 2026-07-04"
Cohesion: 0.67
Nodes (3): Added, Fixed, [v0.8.5b2] — 2026-07-04

### Community 1098 - "[v0.8.0-beta.3] — 2026-06-23"
Cohesion: 0.67
Nodes (3): Breaking, Changed, [v0.8.0-beta.3] — 2026-06-23

### Community 1119 - "_OtherEngineProvider"
Cohesion: 0.22
...
### Community 1127 - "footer-update-chip-v3.spec.ts"
Cohesion: 0.36
...
### Community 1182 - "_FakeCtx"
Cohesion: 0.25
Nodes (7): brain_chat(), Request, hal0-brain chat surface — ``POST /api/brain/chat`` (SSE).  The PRIMARY route for, hal0-brain platform steward. SSE stream. SPEC §G / R4.      Delegates to :func:`, Entry point invoked by the ``/api/brain/chat`` route (and its board alias)., run_brain_chat(), StreamingResponse

### Community 1183 - "truncate_client"
Cohesion: 0.46
...
### Community 1256 - "test_delete_forwards_force_query_param"
Cohesion: 0.38
Nodes (4): LiveAgentCard(), RESTART_LABELS, useFlip(), useTilt()

### Community 1259 - "test_is_newer_beta_across_patch_boundary"
Cohesion: 0.28
...
### Community 1260 - "_mtp_profile"
Cohesion: 0.29
Nodes (4): _mtp_profile(), §7.1a / ML-5: profile.mtp is informational only now — the caller         must pa, profile.mtp=True with NO explicit override no longer expands the         bundle, TestResolveProfileFlags

### Community 1261 - "get_enums"
Cohesion: 0.29
...
### Community 1263 - "_wake_capability_slot"
Cohesion: 0.29
...
### Community 1264 - "TestVenvRefreshIsCommitAgnostic"
Cohesion: 0.38
...
### Community 1267 - "_FakeResponse"
Cohesion: 0.33
Nodes (3): _FakeResponse, Any, Minimal stand-in for the object urlopen's context manager yields.

### Community 1268 - "_backend_state"
Cohesion: 0.33
Nodes (6): _backend_state(), _image_repo(), Strip the tag/digest → the bare ``registry/repo`` of an image ref.      Mirrors, ``"installed"`` / ``"installable"`` / ``"unavailable"`` for one runner.      Loc, test_backend_state_installed_vs_installable(), test_backend_state_unavailable_when_podman_absent()

### Community 1269 - "is_container_npu_cfg"
Cohesion: 0.40
...
### Community 1271 - "test_list_slots_no_coresident_group_when_npu_anchor_disabled"
Cohesion: 0.40
...
### Community 1272 - "test_list_slots_exposes_idle_timeout_workers_llamacpp_args"
Cohesion: 0.50
...
### Community 1273 - ".__init__"
Cohesion: 0.50
Nodes (3): ModelRegistry, Path, SlotManager

### Community 1274 - "FoldPlan"
Cohesion: 0.50
Nodes (3): FoldPlan, Result of :func:`plan_slot_flags_fold`., True when nothing was refused — safe to apply the whole plan.

## Knowledge Gaps
- **3013 isolated node(s):** `runlog.sh script`, `rocmfpx-build.sh script`, `rocmfpx-env.sh script`, `rocmfpx-pipeline.sh script`, `rocmfpx-quantize.sh script` (+3008 more)
...
- **Why does `create_app()` connect `create_app` to `test_models_add_from_path.py`, `test_v1_models_filters.py`, `snapshot_live_stack`, `test_settings_routes.py`, `ApprovalQueue`, `mcp_mount.py`, `test_exposure.py`, `test_chat_proxy.py`, `test_chat_templates.py`, `MemoryNamespaceError`, `HardwareStats`, `_FakeResponse`, `__init__.py`, `test_kb1_hardening_tail.py`, `test_models_preview.py`, `TestClient`, `test_auth_rotate.py`, `EventBus`, `test_settings_models_store.py`, `test_slots_image_pull.py`, `conftest.py`, `BootReport`, `MemoryConfig`, `test_tts_request_defaults.py`, `test_models_crud.py`, `stream_journal`, `test_chat_proxy_auth.py`, `test_hermes_live_resolve_render.py`, `test_updater_routes.py`, `test_comfyui_fetch_route.py`, `test_v1_npu_trio_routing.py`, `_StubSlotManager`, `isolated_client_with_root`, `test_cli_auth_streamtest.py`, `test_typed_errors.py`, `test_models_default.py`, `test_discover.py`, `test_route_sync.py`, `test_event_contract.py`, `auth.py`, `TestClient`, `__init__.py`, `test_typed_bodies.py`, `test_installer_routes.py`, `TestClient`, `test_v1_slot_alias_models.py`, `conftest.py`, `test_profiles_crud.py`, `test_redact.py`, `test_v1_chat_slot_alias.py`, `GpuImageMode`, `test_pull_routes.py`, `test_slots_container_state.py`, `test_route_collisions.py`, `PgVectorProvider`, `settings.py`, `test_memory_admin_routes.py`, `test_stacks_routes.py`, `test_hf_routes.py`, `test_dashboard_layout.py`, `test_auth_core.py`, `test_config_model_roots.py`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `SlotManager` connect `Slot` to `SlotInterface`, `SlotManager`, `test_device_profile_coherence.py`, `test_mtp_defuse.py`, `test_slot_create_conflict.py`, `test_transition_guard.py`, `test_npu_trio_reconcile.py`, `SlotState`, `slots.py`, `_write_slot`, `FLMProvider`, `RoutingHost`, `StackChangePlan`, `SlotConfig`, `heal_missing_llm_type`, `FakeManager`, `test_model_fallback.py`, `TestStatusTelemetry`, `test_config_drift_aliases.py`, `GpuArbiter`, `test_adopted_slot_eviction.py`, `_cfg_to_dict`, `test_slot_aliases.py`, `SlotIdentityStore`, `FakeSlotManager`, `discover.py`, `agents-overview.jsx`, `test_npu_trio_shadow.py`, `Path`, `test_pulling_serving_idle.py`, `test_model_preferred_profile.py`, `HardwareInfo`, `test_manager_npu_container.py`, `save_stacks_config`?**
  _High betweenness centrality (0.054) - this node is a cross-community bridge._
- **Why does `SlotState` connect `SlotState` to `SlotInterface`, `Slot`, `SlotManager`, `_make_slot`, `StackApplyEngine`, `slots.py`, `Dispatcher`, `Enum`, `StackChangePlan`, `SlotConfig`, `arbiter.py`, `_FakeSM`, `container_enrichment`, `GpuArbiter`, `test_backends_npu_canonical_fields.py`, `test_fail_watcher_warming.py`, `_cfg_to_dict`, `MapContainerProvider`, `Any`, `_RecordingSlotManager`, `FakeSnap`, `config_enrichment`, `ModelCapabilities`, `test_npu_occupancy.py`, `_ArbiterSlotManager`, `NpuSwapStatus`, `serialize_slot`, `GpuImageMode`, `_slot`, `read_stack_state`, `save_stacks_config`, `SlotLoading`, `test_metrics_prometheus_route.py`, `test_fail_watcher.py`?**
