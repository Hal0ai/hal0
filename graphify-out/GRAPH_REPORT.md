# Graph Report - memory-polish  (2026-07-30)

## Corpus Check
- 1616 files · ~2,046,002 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29316 nodes · 55768 edges · 1353 communities (1213 shown, 140 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 6875 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5c02c6aa`
...
- test_container_health_gating.py
- _build_spec
...
- test_tiers.py
- test_forward.py
- test_no_npu_slot_means_no_swap
- test_pool_bounds.py
- _by_target
...
## Communities (1353 total, 140 thin omitted)

### Community 0 - "dashboard-redesign.jsx"
Cohesion: 0.02
Nodes (141): useActivityRecent(), useBackends(), CELL_DEFS, CELL_MAP, CellDef, CellId, DashLayout, DEFAULT_LAYOUT (+133 more)

### Community 1 - "useSlots.ts"
Cohesion: 0.03
Nodes (139): ADR-0022, useModels(), usePullJob(), NpuOccupancy, NpuOccupancySlot, useNpuOccupancy(), deviceBackend(), parseImageRef() (+131 more)
...
### Community 3 - "Slot"
Cohesion: 0.03
Nodes (79): container_provider(), Return the process-wide ContainerProvider singleton., flm_id_to_tag(), Resolve a hal0 ``<tag>-FLM`` id back to FLM's native ``family:size`` tag.      I, _cfg_port(), _cfg_provider(), _cfg_to_dict(), _model_default() (+71 more)

### Community 4 - "ProfileConfig"
Cohesion: 0.03
Nodes (91): RuntimeFamily, SlotType, create_profile(), delete_profile(), export_profile(), get_profile(), import_profile_route(), list_profiles() (+83 more)
...
### Community 6 - "useModels.ts"
Cohesion: 0.03
Nodes (116): AgentList, AgentRecord, AgentRestartResult, AgentSkill, AgentSkillsResponse, ApprovalEntry, ApprovalList, BUNDLED_MCP_IDS (+108 more)

### Community 7 - "SlotState"
Cohesion: 0.03
Nodes (91): Push a record onto every active SSE subscriber queue., The model registry could not be consulted (outage, not a miss).      Raised by t, Async generator yielding every slot state transition as it happens.          Use, See :meth:`hal0.slots.watchdog.SlotWatchdog.update`., RegistryUnavailableError, admit(), CandidateSlot, _estimate_incoming_footprint_mb() (+83 more)

### Community 8 - "ApprovalQueue"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (109): apiDelete(), apiGet(), ApiOptions, apiPut(), Hal0Error, serialiseBody(), ENDPOINTS, AgentMCPClientList (+101 more)

### Community 11 - "connect"
Cohesion: 0.03
Nodes (70): Path, connect(), db_path(), Connection, Path, SQLite connection + transaction helpers — the hal0 ``db/`` foundation.  One conn, Wrap a write in an explicit ``BEGIN IMMEDIATE`` … ``COMMIT``/``ROLLBACK``., Return the default hal0 SQLite database path.      Thin wrapper over :func:`hal0 (+62 more)
...
Cohesion: 0.04
Nodes (95): Tag-based release-policy derivation — the single source of truth for classifying, Raised when a tag does not match any supported release pattern., Immutable policy derived from a parsed release tag., ReleasePolicy, ReleaseTagError, _atomic_symlink_swap(), _cache_dir(), clear_stale_mtp_overrides() (+87 more)

### Community 15 - "model-modals.jsx"
Cohesion: 0.05
Nodes (82): useChatTemplates(), useMeta(), useMetaEnums(), useAddModelFromPath(), useModelDuplicate(), useModelInspect(), useModelSetDefault(), useModelUpdate() (+74 more)
...
### Community 18 - "SettingsShell.jsx"
Cohesion: 0.05
...
### Community 19 - "ModelDefaults"
Cohesion: 0.05
Nodes (48): Reconstruct a ``Model`` from one `model` table row.      ``backends`` comes from, row_to_model(), Model, ModelCapabilities, ModelDefaults, Model — registry entry pydantic model.  The Model class is the typed representat, A model entry in the hal0 registry.      All fields are optional at construction, # NOTE: revisit in Phase 1 — extend as providers surface new capabilities. (+40 more)

### Community 20 - "stacks.jsx"
Cohesion: 0.04
Nodes (77): api(), ComfyuiArbiter, ComfyuiEngineState, ComfyuiMemory, ComfyuiMode, ComfyuiStatus, ComfyuiSwitchover, ComfyuiV2PaneData (+69 more)
...
### Community 23 - "test_registry_import.py"
Cohesion: 0.05
...
### Community 25 - "test_migrate_model_layout.py"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (78): URL-safe lowercase identifier used by the REST surface., apiPatch(), apiPost(), normaliseActor(), normaliseAssignee, normaliseProfile, pickName(), BoardAssignee (+70 more)

### Community 27 - "FakeManager"
Cohesion: 0.06
Nodes (75): _base_configs(), _cancel_loop(), comfyui_http(), fake_mgr(), FakeManager, _fast_drain(), _img_mode_arbiter(), Any (+67 more)

### Community 28 - "test_plugin_manifest_proxy.py"
Cohesion: 0.05
...
### Community 29 - "ConfigParseError"
Cohesion: 0.05
Nodes (65): config_validate(), Validate all config files against the current schema., ConfigError, ConfigNotFound, ConfigParseError, _find_manifest_path(), _flatten_slot_toml(), list_agent_configs() (+57 more)

### Community 30 - "HermesDriver"
Cohesion: 0.05
...
### Community 31 - "comfyui.py"
Cohesion: 0.05
Nodes (82): aclose_client(), _arbiter_api_mode(), _arbiter_unavailable(), _as_pct(), _build_client(), _bytes_to_gb(), _comfyui_base_url(), _comfyui_container() (+74 more)

### Community 32 - "ContainerProvider"
Cohesion: 0.05
Nodes (46): ContainerProvider, Podman-container-per-slot inference backend.      One instance is shared across, Not applicable — systemd starts the container., Probe GET /health on the container port.          For llama-server slots /health, Poll /health until 200 or HEALTH_TIMEOUT_S exceeded.          Raises:, Push-driven failure detector, against a narrow host seam., SlotWatchdog, _make_provider_with_tmp_unit() (+38 more)

### Community 33 - "probe.py"
Cohesion: 0.05
...
### Community 34 - "test_models_crud.py"
Cohesion: 0.05
Nodes (79): crud_app(), crud_client(), crud_models_root(), _events_since(), _max_event_id(), FastAPI, Path, TestClient (+71 more)
...
### Community 37 - "test_updater_routes.py"
Cohesion: 0.05
...
### Community 40 - "main.tsx"
Cohesion: 0.03
Nodes (34): LiveAgentCard(), RESTART_LABELS, useFlip(), useTilt(), AGENT_TAB_DEFS, _agentRoute(), _agentTabs(), AgentView() (+26 more)
...
### Community 42 - "UpstreamRegistry"
Cohesion: 0.06
Nodes (56): Registry of all routing targets (slots + remote upstreams).      Loaded at start, Remove an upstream by name.  Returns True if it was present., UpstreamAlreadyExists, UpstreamRegistry, _async_false(), _async_true(), Any, LogCaptureFixture (+48 more)
...
### Community 46 - "test_hermes_provision.py"
Cohesion: 0.03
...
Cohesion: 0.05
Nodes (71): brain_chat(), Request, hal0-brain chat surface — ``POST /api/brain/chat`` (SSE).  The PRIMARY route for, hal0-brain platform steward. SSE stream. SPEC §G / R4.      Delegates to :func:`, _admin_tool_names(), _admin_tool_schemas(), _brain_chat_config(), _brain_tool_policy() (+63 more)

### Community 48 - "hardware.py"
Cohesion: 0.05
Nodes (70): _backend_state(), _background_revalidate(), _cached_snapshot(), _clear_in_flight(), get_hardware(), _gpu_sample(), _image_repo(), _local_image_repos() (+62 more)

### Community 49 - "die"
Cohesion: 0.05
Nodes (71): agent_install(), agent_log(), agent_peers(), _agent_provision_state_file(), agent_reprovision(), agent_status(), agent_uninstall(), agent_upgrade() (+63 more)

### Community 50 - "Upstream"
Cohesion: 0.04
...
### Community 53 - "_api_base"
Cohesion: 0.05
Nodes (69): board_add(), board_list(), board_move(), board_show(), hal0 board subcommands — thin HTTP client to /api/board/* (§5.2).  A small opera, Create a task (POST /api/board/tasks)., Move a task to a different lane (PATCH /api/board/tasks/{id})., List tasks by lane (GET /api/board/board). (+61 more)
...
### Community 55 - "ModelRegistry"
Cohesion: 0.06
Nodes (30): ModelAlreadyExists, Base error for registry operations., add() called but the model id is already present., RegistryError, test_duplicate_conflicting_new_id_raises(), _model(), ModelRegistry, Path (+22 more)
...
### Community 58 - "test_models_routes.py"
Cohesion: 0.05
...
### Community 60 - "test_board_chat.py"
Cohesion: 0.12
Nodes (59): _final_response(), _make_app(), _multi_tool_response(), _PlatformRecorder, Any, Tests for the board chat orchestrator — src/hal0/api/routes/board_chat.py.  The, Like _Recorder but for hal0-api's OWN routes (no kanban prefix)., Attach a Hal0Config carrying a [brain_chat] override to app.state. (+51 more)

### Community 61 - "FakeSlotManager"
Cohesion: 0.06
Nodes (57): _anchor_npu_writes(), drifted_state(), FakeSlotManager, npu_orchestrator(), orchestrator(), Any, MonkeyPatch, Path (+49 more)

### Community 62 - "resolve_profile_flags"
Cohesion: 0.06
...
### Community 65 - "_RecordingSlotManager"
Cohesion: 0.07
...
### Community 68 - "slots.py"
Cohesion: 0.06
Nodes (65): delete_slot(), get_slot_by_id(), get_slot_by_name(), get_slot_config(), _get_slot_manager(), get_slot_resolved(), get_slot_voices(), list_flm_models() (+57 more)
...
### Community 75 - "SlotConfig"
Cohesion: 0.05
Nodes (24): Any, Pydantic model for a single slot's TOML config (slots/<name>.toml).      Fields, Pull a `[server]` TOML table out of the loader's `extra` catch-all.          ``h, Pull a `[npu]` TOML table out of the loader's `extra` catch-all.          Mirror, Pull an `[image]` TOML table out of the loader's `extra` catch-all.          Mir, Read-only promotion shim: derive ``device`` from a legacy         on-disk ``back, Inverse of `_hoist_server_from_extra` for round-trip dumps.          ``hal0.conf, SlotConfig (+16 more)

### Community 76 - "models_service.py"
Cohesion: 0.06
Nodes (62): Model ids referenced by any configured slot or any stack.      Union of: each sl, referenced_model_ids(), add_from_path(), auto_scan_and_register(), cascade_delete_model(), clear_slot_default(), comfyui_category(), commit_scan_rows() (+54 more)

### Community 77 - "test_memory.py"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (58): _apply_selections_core(), _bundle_to_selections(), _container_active(), curated_models(), CuratedModelNotFound, _first_run_sentinel(), _has_default_slot(), install_apply() (+50 more)

### Community 79 - "_ArbiterSlotManager"
Cohesion: 0.07
...
Cohesion: 0.05
Nodes (49): Provider for a slot, or None for the GPU/llama-server default.      The runtime, _spec_provider_for(), KokoroProvider, Any, ContainerSpec, Informational env block (container is self-contained)., Not applicable — systemd starts the container., Build a ContainerSpec for the Kokoro TTS slot.          The toolbox image ENTRYP (+41 more)

### Community 82 - "errors.py"
Cohesion: 0.05
Nodes (54): RequestValidationError, activate_agent_persona(), get_agent_persona(), list_agent_personas(), _persona_detail(), _persona_summary(), PersonaUpdateBody, Any (+46 more)

### Community 83 - "paths.py"
Cohesion: 0.06
Nodes (58): activity_db(), agent_workspace_dir(), agents_config_dir(), bundle_chosen_marker(), _covers(), db_path(), default_flm_models_dir(), etc() (+50 more)

### Community 84 - "test_profiles_crud.py"
Cohesion: 0.05
...
### Community 94 - "test_unified_bank.py"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (51): derive_device(), derive_profile(), npu_takes_utility(), Auto-derive a slot's device + profile from the hardware probe (design D4).  Maps, Return a ``SEED_PROFILES`` name for a (capability, device) pair.      Reads the, True when the NPU claims the ``utility`` role on this box.      When True, the f, Return a ``DeviceLiteral`` for the capability, or None to skip it.      None mea, Parity/regression lock for the device→profile derivations (finding PS-4).  The p (+43 more)

### Community 99 - "test_update_cosign_pin.py"
Cohesion: 0.13
...
### Community 100 - "test"
Cohesion: 0.04
Nodes (14): test, MOBILE, CURATED, UPSTREAM_ROW, A, B, Indicator, LEGACY_LIVE_STATES (+6 more)
...
### Community 102 - "schema.py"
Cohesion: 0.04
Nodes (36): ActivityConfig, AgentConfig, family_flags(), model_family(), NpuConfig, Pydantic v2 schema models for hal0 configuration.  All TOML files under /etc/hal, Best-effort model family, preferring the registry's ``architecture``.      §7.1a, The :data:`FAMILY_DEFAULTS` flag string for the model's family, else ''. (+28 more)

### Community 103 - "test_orchestrate.py"
Cohesion: 0.07
...
### Community 105 - "test_setup_install.py"
Cohesion: 0.06
...
### Community 106 - "PgVectorProvider"
Cohesion: 0.06
...
### Community 110 - "endpoints.ts"
Cohesion: 0.06
Nodes (38): ADR-0004, ADR-0013, ADR-0023, KeyTier, RequireAuthResponse, RotateKeyResponse, useLogout(), useRotateKey() (+30 more)

### Community 111 - "run_migrations"
Cohesion: 0.06
Nodes (39): Migration, _deep_copy_dict(), latest_version(), MigrationError, Any, hal0.config.migrations — versioned config migration transforms.  # TIER3: config, # NOTE: downgrade migrations are explicitly unsupported in v1., Read ``meta.schema_version`` from a raw config dict, defaulting to 1. (+31 more)
...
### Community 115 - "StackApplyEngine"
Cohesion: 0.08
Nodes (25): Any, Path, StackSlotEntry, Reconcile a StackConfig onto slot TOMLs as one ChangeSet., Project a stack slot entry onto the existing slot TOML dict.          Builds the, Commit ``plan.change_set`` to disk atomically.          Delegates to ``SlotConfi, The slot→after-dict projection a plan would write (keyed by slot name)., The slot→current-disk-dict projection for a stack's primary slots. (+17 more)

### Community 116 - "test_auth_core.py"
Cohesion: 0.07
...
### Community 117 - "hal0 rework plan — reader's copy"
Cohesion: 0.04
...
### Community 118 - "test_auth_rotate.py"
Cohesion: 0.09
...
### Community 119 - "build_auto_selections"
Cohesion: 0.07
...
### Community 122 - "test_exposure.py"
Cohesion: 0.06
...
### Community 123 - "§21.4 `hal0 doctor` rework + support bundle — implementation spec"
Cohesion: 0.04
...
### Community 128 - "install_openwebui"
Cohesion: 0.06
...
### Community 129 - "RuntimeLaunchPlan"
Cohesion: 0.07
Nodes (28): Typed launch plan for a container-per-slot Quadlet unit.      Carries everything, RuntimeLaunchPlan, _loopback_fence_command(), Flip any ``0.0.0.0`` bind in *command* to loopback (host-net fence).      THE si, Render a Podman Quadlet ``.container`` unit from a launch plan.      The ONE ren, _render_quadlet_from_plan(), _exec_tokens(), halo150/143 O8+O11: ONE render for every substrate — no version branch.      Nat (+20 more)

### Community 130 - "test_comfyui_proxy.py"
Cohesion: 0.15
...
### Community 131 - "test_providers_routes.py"
Cohesion: 0.12
...
### Community 132 - "test_board_chat_tool_use_e2e.py"
Cohesion: 0.13
Nodes (42): _collect(), _collect_with_payload(), _fake_request(), _fast_approval_wait(), _final(), _parse(), _persona_root(), Any (+34 more)

### Community 133 - "PART 0 — current-state map of scattered metrics (file:line)"
Cohesion: 0.04
...
### Community 136 - "_llama_launch_plan"
Cohesion: 0.06
...
### Community 138 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.04
...
### Community 144 - "pull_jobs.py"
Cohesion: 0.08
Nodes (45): build_stream_response(), cancel(), delete(), emit_terminal_pull_event(), enqueue(), enqueue_update(), eta_s(), list_all() (+37 more)

### Community 145 - "json"
Cohesion: 0.05
Nodes (17): json(), AuthOpts, installAuth(), captureBulk(), LIVE_BOARD, HERMES_ACTORS, CAPS_MOCK, MOCK_MCP_SERVERS (+9 more)

### Community 146 - "Hal0Error"
Cohesion: 0.11
...
### Community 147 - "CapabilityOrchestrator"
Cohesion: 0.07
...
### Community 150 - "_resolve_llama_scalars"
Cohesion: 0.10
...
### Community 151 - "hal0 R5 live install-validation — findings (stamp r5v1)"
Cohesion: 0.05
...
### Community 152 - "§7.1d — Capability / Modality Taxonomy untangle (ML-6)"
Cohesion: 0.05
...
### Community 153 - "Hal0MemoryProvider"
Cohesion: 0.08
...
### Community 154 - "WatchdogHost"
Cohesion: 0.06
Nodes (22): Protocol, The non-filesystem side effects of the migration.      Split behind a protocol s, SlotArtifactOps, NpuTrioHost, Any, NPU FLM-trio shadow reconciler (P3-slots §1d).  The NPU runs a single ``flm serv, Narrow seam :func:`reconcile_trio_slots` needs from ``SlotManager``., Startup pass: reconcile the FLM-trio shadow slots to canon.      The NPU runs on (+14 more)
...
### Community 156 - "HardwareInfo"
Cohesion: 0.08
Nodes (36): _flatten_for_ui(), _platform_label(), Project HardwareInfo into the fields the Vue Hardware view expects.      The das, Pretty label for the probed platform string.      Promotes the GPU model into th, HardwareInfo, NPUInfo, One detected NPU (AMD XDNA / future vendors)., Pydantic model for /etc/hal0/hardware.json.      Written by `hal0 probe` (hal0.h (+28 more)

### Community 157 - "MemoryProvider"
Cohesion: 0.06
Nodes (27): AddResult, DeleteResult, GraphStatus, ListPage, MemoryItem, MemoryProvider, Mode, Any (+19 more)

### Community 158 - "test_model_fallback.py"
Cohesion: 0.10
...
### Community 160 - "FakeContainerProvider"
Cohesion: 0.08
...
Cohesion: 0.08
Nodes (42): NextStep, check_hermes_ownership(), check_tree_group_share(), _dangling_registry_entries(), _deepest_mountpoint(), detect_editable_root(), _ghcr_anon_token(), _ghcr_manifest_digest() (+34 more)

### Community 164 - "stacks.py"
Cohesion: 0.09
...
Cohesion: 0.07
Nodes (40): agent_list(), List installed bundled agents., auth_status(), Show the current auth posture (GET /api/auth/status)., list_capabilities(), List capability-slot selections (embed/voice/img/vision) from the live API., Show system and slot summary., status() (+32 more)
...
### Community 167 - "test_hal0_provider_plugin.py"
Cohesion: 0.09
...
### Community 169 - "FakeMemoryProvider"
Cohesion: 0.06
...
### Community 172 - "_write_diagnostics_section"
Cohesion: 0.10
...
### Community 173 - "Hal0Config"
Cohesion: 0.07
Nodes (30): BrainChatConfig, Hal0Config, ``[brain_chat]`` — the dashboard's agent-chat steward (hal0-brain).      Guardra, Top-level hal0.toml pydantic model.      Populated by hal0.config.loader.load_ha, No ApprovalQueue wired -> a gated admin call returns a typed error and     NOTHI, test_gated_call_fails_closed_without_queue(), _fake_request(), Any (+22 more)
...
### Community 176 - "UpdateManifestInvalid"
Cohesion: 0.06
...
### Community 186 - "test_agent_install_hermes.py"
Cohesion: 0.06
...
### Community 187 - "test_update_commands.py"
Cohesion: 0.07
...
### Community 188 - "services.jsx"
Cohesion: 0.07
Nodes (32): COMFYUI_FALLBACK, useComfyui(), fetchServices(), ManagedService, MdnsStatus, ServiceActionResult, ServicesPayload, ServiceUnitState (+24 more)

### Community 189 - "hal0 — Official prerelease release channel"
Cohesion: 0.05
...
### Community 190 - "v1.py"
Cohesion: 0.08
Nodes (39): _aggregate_models(), _capability_slot_for_path(), _dispatch_via_npu_trio(), _extract_multipart_model(), _extract_port_from_upstream_url(), _forward_multipart(), get_model(), _instrument_streaming_throughput() (+31 more)

### Community 191 - "suites.py"
Cohesion: 0.10
...
### Community 193 - "test_hermes_provision_idempotency.py"
Cohesion: 0.09
Nodes (39): install_io(), Redirect every host path constant under ``tmp_path``; return (home, venv)., A deterministic :class:`hp.InstallIO` for hermetic ``install_hermes`` runs., sandbox_hermes_paths(), _config(), _install(), MonkeyPatch, Path (+31 more)
...
### Community 202 - "load_profiles_config"
Cohesion: 0.10
Nodes (19): load_profiles_config(), Load and validate /etc/hal0/profiles.toml.      Returns a :class:`ProfilesConfig, Look up a named profile in the profiles.toml catalog.      Shared by every provi, resolve_profile(), Path, Absent file → seed defaults; no fixture needed., Non-MTP profiles stay False; MTP-capable family profiles are True., Canonical GPU seeds do not pin a backend or runner image. (+11 more)

### Community 203 - "migrate_slot_toml"
Cohesion: 0.09
...
### Community 209 - "BaseModel"
Cohesion: 0.09
Nodes (37): BaseModel, The supplied credential was rejected., Unauthorized, PersonaApprovalUpdate, Partial ``[persona.approval]`` patch. Omitted fields are unchanged., _client_ip(), exposure(), ExposureAllowlistEntry (+29 more)

### Community 210 - "tui.py"
Cohesion: 0.08
...
### Community 212 - "test_doctor_json_diagnoses.py"
Cohesion: 0.09
...
### Community 213 - "slot_flags_fold.py"
Cohesion: 0.08
...
### Community 214 - "plan_slot_flags_fold"
Cohesion: 0.10
...
### Community 215 - "test_mtp_override.py"
Cohesion: 0.09
...
### Community 217 - "test_npu_swap_status.py"
Cohesion: 0.11
Nodes (37): fetch_npu_swap_status(), Return the swap snapshot from the npu container slot's state.      Transitional, _container_npu_cfg(), npu_swap_status: container slot lifecycle state drives the swap signal.  ``fetch, SlotState.STARTING → in_progress=True (container restarting for model swap)., SlotState.PULLING → in_progress=True., SlotState.WARMING → in_progress=True., SlotState.UNLOADING → in_progress=True (transition still in flight). (+29 more)

### Community 218 - "recommend_primary_slot"
Cohesion: 0.10
...
### Community 219 - "test_modality.py"
Cohesion: 0.10
...
### Community 220 - "SlotIdentityStore"
Cohesion: 0.12
...
### Community 221 - "test_contract_compatibility.py"
Cohesion: 0.06
...
### Community 224 - "Appendix: raw area reports"
Cohesion: 0.05
...
### Community 226 - "test_openrouter_auth_loopback.py"
Cohesion: 0.09
...
### Community 227 - "test_model_meta.py"
Cohesion: 0.06
...
### Community 229 - "migrate_slot_id_keying"
Cohesion: 0.10
Nodes (31): migrate_slot_id_keying(), _migrate_state(), MigrationReport, Any, Collection, Path, One-shot M5 migration: name-keyed slot artefacts → id-keyed (rework §3.1).  Incr, One slot that was migrated name → id in this run. (+23 more)

### Community 230 - "test_chat_templates.py"
Cohesion: 0.09
Nodes (35): bundled_templates_dir(), Path, hal0 chat-template library.  Bundled templates live under :data:`bundled_templat, Return the directory containing the package-bundled ``.jinja`` templates., Copy bundled chat templates into the operator model-store (absent-only).      Sk, seed_chat_templates(), FastAPI, MonkeyPatch (+27 more)

### Community 231 - "test_memory_graph_route.py"
Cohesion: 0.13
Nodes (31): _build_app(), client(), hal0_home(), _HindsightyWrapper, Any, FastAPI, MonkeyPatch, Path (+23 more)

### Community 232 - "test_pulling_serving_idle.py"
Cohesion: 0.11
...
### Community 240 - "orchestrate_models"
Cohesion: 0.09
...
### Community 241 - "hw_slot_ownership.py"
Cohesion: 0.10
...
### Community 242 - "TestUpstreamEntry"
Cohesion: 0.07
...
### Community 246 - "test_discover.py"
Cohesion: 0.09
...
### Community 247 - "test_update_check.py"
Cohesion: 0.09
...
### Community 257 - "write_toml_atomic"
Cohesion: 0.10
...
### Community 258 - "test_v1_chat_slot_alias.py"
Cohesion: 0.13
...
### Community 259 - "test_slots_container_state.py"
Cohesion: 0.09
...
### Community 263 - "test_upstream_dedup.py"
Cohesion: 0.10
...
### Community 268 - "test_metrics_prometheus_route.py"
Cohesion: 0.09
...
### Community 273 - "browser_server.py"
Cohesion: 0.10
...
### Community 274 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.06
...
### Community 279 - "Hal0HermesClient"
Cohesion: 0.12
...
### Community 280 - "Hal0MemoryProvider"
Cohesion: 0.11
...
### Community 282 - "test_tts_capability_switch.py"
Cohesion: 0.07
...
### Community 284 - "LlamaServerProvider"
Cohesion: 0.08
...
### Community 285 - "test_memory_admin_routes.py"
Cohesion: 0.17
...
### Community 287 - "test_crash_loop_breaker.py"
Cohesion: 0.15
...
### Community 294 - "import_toml_to_sqlite"
Cohesion: 0.11
Nodes (22): model_import_backup(), Path, Restore ``registry.toml`` from a v0.1.x disaster-recovery backup.      v0.1.x →, _import_into(), import_toml_to_sqlite(), ImportReport, _load_toml_models(), Connection (+14 more)

### Community 295 - "test_slot_migrate_id_keying.py"
Cohesion: 0.10
...
### Community 298 - "test_chat_normalization.py"
Cohesion: 0.10
...
### Community 305 - "build_request_metric_row"
Cohesion: 0.10
...
### Community 307 - "test_board_routes.py"
Cohesion: 0.10
...
### Community 313 - "config_commands.py"
Cohesion: 0.09
...
### Community 317 - "test_board_chat_admin_tools.py"
Cohesion: 0.12
...
### Community 319 - "FakeUpstreamRegistry"
Cohesion: 0.12
...
### Community 322 - "_render_from_spec"
Cohesion: 0.11
Nodes (20): _flm_spec(), Any, ContainerSpec, ContainerProvider NPU branch: spec-rendered units + FLM health fallback (Phase A, PublishPort is rendered declaratively from spec.port, not extra_args., FLM has no /health; 404 on /health + 200 on /v1/models → healthy., Connection-refused (no container) stays unhealthy even with fallback., Existing /health→200 path still works (GPU slots use it). (+12 more)

### Community 323 - "FakeContainerProvider"
Cohesion: 0.09
...
### Community 325 - "activity-log.spec.ts"
Cohesion: 0.09
Nodes (21): emitSse(), emitSseTyped(), installSseHarness(), waitForSse(), emitAndAwait(), ERR_REC, frame(), OK_REC (+13 more)

### Community 326 - "test_hindsight_boot_probe.py"
Cohesion: 0.10
...
### Community 327 - "SingleFlightGroup"
Cohesion: 0.08
...
### Community 329 - "P3-slots: Decomposition Spec for `slots/manager.py`"
Cohesion: 0.07
...
### Community 330 - "Enum"
Cohesion: 0.10
Nodes (28): Enum, auth_require(), auth_rotate(), KeyTier, hal0 auth subcommands — thin HTTP client to /api/auth/*.  §5.2 of the R5 sync as, Persist the [security].require_auth posture (PUT /api/auth/require)., Rotate the admin or client box key (POST /api/auth/rotate).      Mints a fresh k, RequireToggle (+20 more)
...
### Community 333 - "test_diagnosis.py"
Cohesion: 0.09
...
### Community 337 - "test_npu_exclusivity.py"
Cohesion: 0.11
...
### Community 338 - "test_hal0_memory_client.py"
Cohesion: 0.10
...
### Community 339 - "test_config_urls.py"
Cohesion: 0.10
...
### Community 340 - "test_admin_route_map_nested.py"
Cohesion: 0.10
...
### Community 341 - "test_workflow_contract.py"
Cohesion: 0.15
...
### Community 342 - "Request"
Cohesion: 0.16
Nodes (27): DispatcherDep, audio_speech(), audio_transcriptions(), chat_completions(), completions(), _dispatch_and_forward(), embeddings(), _ensure_backend_for_model() (+19 more)

### Community 343 - "Tier 2 — medium (one PR each)"
Cohesion: 0.07
...
### Community 344 - "PART 0 — Current registry, mapped (file:line)"
Cohesion: 0.07
...
Cohesion: 0.18
Nodes (16): Captures one ``request_metric`` row per request through the v1 seam., RequestSeam, test_seam_module_exports(), _FakeCall, _FakeClient, _FakeRequest, _FakeWriter, Any (+8 more)

### Community 349 - "merge_slot_config"
Cohesion: 0.11
...
Cohesion: 0.07
Nodes (26): [0.9.4.1] — 2026-07-08, [0.9.4] — 2026-07-08, [0.9.5.2] — 2026-07-09, Added, Added, Added, Breaking, Changed (+18 more)
...
### Community 355 - "Hal0MemoryClient"
Cohesion: 0.12
...
### Community 366 - "test_router_loop.py"
Cohesion: 0.19
...
### Community 367 - "test_event_contract.py"
Cohesion: 0.15
...
### Community 368 - "test_migrate_haloai.py"
Cohesion: 0.15
...
### Community 370 - "ML-4 (runner-image registry) + ML-5 (flag resolution) — implementation-ready spec"
Cohesion: 0.08
...
### Community 371 - "R5 — Surface + launch"
Cohesion: 0.08
...
### Community 375 - "HermesBoardExecutor"
Cohesion: 0.15
...
### Community 376 - "test_doctor_profiles.py"
Cohesion: 0.10
...
### Community 377 - "test_doctor_models.py"
Cohesion: 0.11
...
### Community 378 - "test_emit_answers.py"
Cohesion: 0.14
...
### Community 391 - "test_comfyui_container_spec.py"
Cohesion: 0.11
...
### Community 410 - "resolve_gpu_group_ids"
Cohesion: 0.11
...
### Community 411 - "ModelRegistry"
Cohesion: 0.11
Nodes (25): backfill_coordless(), CandidateModel, _maybe_register_shard_files(), Model, ModelRegistry, One discovered file ready for registry registration., Build a :class:`Model` from ``candidate`` and add it to ``registry``., Best-effort ``model_file`` rows for a discovered shard group.      Only applies (+17 more)

### Community 412 - "unknown_slot_config_keys"
Cohesion: 0.12
...
### Community 414 - "write_state_atomic"
Cohesion: 0.10
Nodes (24): is_transition_legal(), Path, Return True if the transition from_state → to_state is allowed., Persist a SlotStateRecord atomically.      Tier 1 fix: matches the env-file patt, write_state_atomic(), Path, Tests for hal0.slots.state — state machine + persistence helpers.  Covers PLAN.m, write_state_atomic → read_state preserves all fields. (+16 more)
...
### Community 419 - "test_v1_models_filters.py"
Cohesion: 0.20
...
### Community 422 - "test_seeds_data.py"
Cohesion: 0.08
...
### Community 424 - "test_memory_delete_auth.py"
Cohesion: 0.11
...
### Community 427 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.08
...
### Community 428 - "hal0 1.0 — Seeded profile rework"
Cohesion: 0.08
...
### Community 429 - "Hermes Python 3.12 Cross-Distro Installation Design"
Cohesion: 0.08
...
### Community 431 - "write_gateway_secrets_dropin"
Cohesion: 0.08
...
### Community 433 - "test_slots_routes.py"
Cohesion: 0.13
...
### Community 434 - "seed_static_slots"
Cohesion: 0.17
...
### Community 435 - "_container_cgroup_mem_bytes"
Cohesion: 0.13
...
### Community 436 - "test_run_as_hal0_guard.py"
Cohesion: 0.13
...
### Community 437 - "test_slot_config_validation.py"
Cohesion: 0.19
...
### Community 438 - "test_brain_self_auth.py"
Cohesion: 0.18
...
### Community 440 - "test_npu_columns.py"
Cohesion: 0.15
...
### Community 447 - "map_backend_to_device"
Cohesion: 0.13
...
### Community 448 - "test_hw_slot_ownership_migration.py"
Cohesion: 0.23
...
### Community 449 - "HardwareStats"
Cohesion: 0.16
Nodes (18): HardwareStats, _port_in_use(), Hardware runtime stats — GPU utilisation, RAM usage, slot port occupancy.  Hardw, Return {port: in_use} for every port in the slot pool.          Used by SlotsCon, Return the sorted list of slot ports currently bound.          See :meth:`slot_p, Return True if anything is listening on (host, port).      We try a non-blocking, Live hardware metrics reader.      Reads from sysfs and /proc/meminfo; nvidia-sm, _mk_amd_drm() (+10 more)

### Community 450 - "resolve_write_dataset"
Cohesion: 0.15
...
### Community 451 - "apply_thinking_policy"
Cohesion: 0.15
...
### Community 454 - "read_stack_state"
Cohesion: 0.14
...
### Community 455 - "embed_references"
Cohesion: 0.18
...
### Community 456 - "test_agent_memory_stats_endpoint.py"
Cohesion: 0.16
...
### Community 457 - "test_backends_npu_canonical_fields.py"
Cohesion: 0.13
...
### Community 459 - "test_memory_subgraph.py"
Cohesion: 0.19
...
### Community 461 - "test_settings_models_store.py"
Cohesion: 0.17
...
### Community 464 - "test_unified_project_scope.py"
Cohesion: 0.17
...
### Community 468 - "UI drawers — slot/model/profile editors"
Cohesion: 0.09
...
### Community 469 - "hal0 Settings Menu — Wireframe / IA"
Cohesion: 0.09
...
### Community 470 - "test_hermes_upgrade.py"
Cohesion: 0.20
...
### Community 471 - "dashboard_layout.py"
Cohesion: 0.12
...
### Community 472 - "test_tts_request_defaults.py"
Cohesion: 0.15
...
### Community 473 - "resolve_bench_devices"
Cohesion: 0.17
Nodes (10): BenchDeviceError, _override_group_ids(), A benchmark device setting could not be resolved into a usable node., Resolve the GPU passthrough for a benchmark container.      See the module docst, resolve_bench_devices(), A CPU-tier run must not demand a DRI device — no raise, no flags., No /dev/dri at all (a plain CPU box / CI runner) is still fine., ``resolve_gpu_device_paths`` degrades to ``["/dev/kfd", "/dev/dri"]``         on (+2 more)

### Community 474 - "api_put"
Cohesion: 0.11
...
### Community 477 - "config_enrichment"
Cohesion: 0.21
...
### Community 478 - "_hermes_fakes.py"
Cohesion: 0.11
...
### Community 479 - "test_hermes_env_seam.py"
Cohesion: 0.15
...
### Community 481 - "test_providers.py"
Cohesion: 0.14
...
### Community 482 - "test_services_page.py"
Cohesion: 0.14
...
### Community 483 - "test_v1_proxy.py"
Cohesion: 0.14
...
### Community 484 - "test_virtual_models.py"
Cohesion: 0.17
...
### Community 485 - "test_brain_framing.py"
Cohesion: 0.23
...
### Community 486 - "test_trio_status_inheritance.py"
Cohesion: 0.18
...
### Community 487 - "test_doctor_verify.py"
Cohesion: 0.12
...
### Community 488 - "test_bootstrap_cosign_fetch.py"
Cohesion: 0.21
...
### Community 492 - "test_seam_agent_units.py"
Cohesion: 0.10
...
### Community 493 - "Dashboard Overhaul — FROZEN DATA CONTRACT (v1)"
Cohesion: 0.09
...
### Community 496 - "P2-config: Collapse capabilities.toml double-bookkeeping"
Cohesion: 0.10
...
### Community 500 - "Any"
Cohesion: 0.13
Nodes (19): _cache_slot_enrichment(), _config_field_enrichment(), _container_state_enrichment(), get_slot(), list_slots(), _local_slot_metrics(), Any, Build per-slot config-derived fields for slot snapshots.      Request-bound adap (+11 more)

### Community 501 - "api_post"
Cohesion: 0.12
Nodes (19): Apply a partial capability selection update.      Thin client over ``POST /api/c, set_capability(), _all_bank_ids(), _list_bank_ops(), ops_list_cmd(), ops_retry_cmd(), Any, ``hal0 memory ops`` — cross-bank async-operation admin.  Hindsight's operations (+11 more)

### Community 502 - "ModelVariant"
Cohesion: 0.13
...
### Community 503 - "test_fetch_ws_g.py"
Cohesion: 0.14
...
### Community 507 - "container_enrichment"
Cohesion: 0.25
...
### Community 508 - "capacity.py"
Cohesion: 0.13
Nodes (17): CapacityProbeError, CapacitySnapshot, _ctx_tokens_for(), estimate_file_size_kv_mb(), _kv_estimate_mb(), Any, Slot capacity snapshot.  CapacitySnapshot is the single-source view of available, Best-effort KV-cache size in MiB for a given context window. (+9 more)

### Community 509 - "_FakeHttpClient"
Cohesion: 0.14
...
### Community 510 - "test_memory_admin_document_transfer.py"
Cohesion: 0.20
...
### Community 511 - "test_throughput_history.py"
Cohesion: 0.19
...
### Community 512 - "test_eligibility.py"
Cohesion: 0.10
...
### Community 513 - "test_model_less_capability_slot_is_not_woken"
Cohesion: 0.20
...
### Community 514 - "Security review — v1.0 auth surface (2026-05-21)"
Cohesion: 0.10
...
### Community 515 - "_write_fake_python"
Cohesion: 0.20
...
### Community 517 - "test_manager_npu_container.py"
Cohesion: 0.20
...
### Community 518 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.10
...
### Community 534 - "test_journal_routes.py"
Cohesion: 0.22
...
### Community 536 - "test_capabilities_commands.py"
Cohesion: 0.18
...
### Community 539 - "test_model_store_root.py"
Cohesion: 0.14
...
### Community 541 - "TestEarlyHal0User"
Cohesion: 0.10
...
### Community 543 - "test_fail_watcher.py"
Cohesion: 0.18
...
### Community 544 - "0. Research-grounded findings that drive the matrix"
Cohesion: 0.11
...
### Community 550 - "find_candidates"
Cohesion: 0.16
Nodes (18): find_candidates(), _is_mmproj_sidecar(), _is_skippable(), _normalise_id(), Path, Model discovery — scan filesystem roots and auto-register found models.  The sca, Turn a basename stem into a registry-friendly id., True for a multimodal-projector (mmproj) sidecar file.      Matched by filename (+10 more)
...
### Community 556 - "test_devices.py"
Cohesion: 0.12
Nodes (11): _no_host_hardware_json(), Tests for benchmark GPU device-node resolution (issue #1303).  The harness used, CDI injects nodes + permissions itself; --group-add would be wrong., So a run is never mislabelled with another tier's GPU string., Never read the developer box's real /etc/hal0/hardware.json., Pin the render/video GIDs so assertions don't depend on /etc/group., _stub_group_ids(), TestNvidiaTier (+3 more)

### Community 557 - "_stub_bin"
Cohesion: 0.23
...
### Community 574 - "ensure_podman_apparmor_usable"
Cohesion: 0.19
...
### Community 575 - "Hal0MemoryClient"
Cohesion: 0.18
...
### Community 576 - "ProgressCoalescer"
Cohesion: 0.14
...
### Community 577 - "test_board_dispatch.py"
Cohesion: 0.24
...
### Community 579 - "slot_migrate_flags"
Cohesion: 0.32
...
### Community 581 - "test_schema_seeds_c5.py"
Cohesion: 0.14
...
### Community 582 - "is_activated"
Cohesion: 0.17
Nodes (16): is_container_npu_cfg(), Any, Shared NPU-slot helpers for dispatcher modules (Phase A container cutover)., True when this slot config describes a live containerized NPU slot.      Detecti, claims_npu_anchor(), is_activated(), npu_anchor_config(), npu_modality_active() (+8 more)
...
### Community 588 - "test_hermes_security_deliverables.py"
Cohesion: 0.15
...
### Community 589 - "test_mcp_client.py"
Cohesion: 0.18
...
### Community 593 - "test_models_preview.py"
Cohesion: 0.19
...
### Community 595 - "test_settings_apply.py"
Cohesion: 0.11
...
### Community 596 - "test_v1_dispatch.py"
Cohesion: 0.16
...
### Community 597 - "test_doctor_perms.py"
Cohesion: 0.19
...
### Community 600 - "FakeLocalBackend"
Cohesion: 0.17
...
### Community 601 - "test_logs_tail_redaction.py"
Cohesion: 0.11
...
### Community 602 - "3. Proposed seed catalog (one per type)"
Cohesion: 0.12
...
### Community 603 - "Slot config — capabilities ↔ slots reconciliation"
Cohesion: 0.12
...
### Community 604 - "hal0 Adoption Candidates — Lemonade + ODS (combined)"
Cohesion: 0.12
...
### Community 605 - "spec-hp-realtime — OpenAI Realtime WebSocket endpoint for hal0"
Cohesion: 0.12
...
### Community 606 - "P3-schema — `config/schema.py` decomposition: implementation-ready spec"
Cohesion: 0.12
...
### Community 607 - "Prerelease Preview Pipeline Hardening"
Cohesion: 0.12
...
### Community 609 - "resolve_hermes_python"
Cohesion: 0.14
...
### Community 612 - "mcp_commands.py"
Cohesion: 0.14
Nodes (16): catalog_refresh_cmd(), _find_server(), install_cmd(), list_cmd(), Any, hal0 mcp subcommands — thin HTTP client to /api/mcp/*.  Issue #504: ``hal0 mcp {, Show detail for one MCP server., Install a user MCP server from a URL / spec. (+8 more)

### Community 613 - "seeds.py"
Cohesion: 0.17
...
### Community 615 - "apply_extraction_slot"
Cohesion: 0.18
...
### Community 617 - "normalize_system_messages"
Cohesion: 0.18
...
### Community 620 - "metrics_collect.py"
Cohesion: 0.15
...
### Community 621 - "snapshot_live_stack"
Cohesion: 0.30
...
### Community 622 - "test_hermes_state_render.py"
Cohesion: 0.12
...
### Community 624 - "_StubSlotManager"
Cohesion: 0.26
...
### Community 635 - "hal0_gpu_gate.py"
Cohesion: 0.16
...
### Community 636 - "qwen3tts_server.py"
Cohesion: 0.16
...
### Community 640 - "system_info_command.py"
Cohesion: 0.18
...
### Community 643 - "build_admin_route_map"
Cohesion: 0.13
...
### Community 647 - "test_hermes_provision_install_artifacts.py"
Cohesion: 0.17
...
### Community 648 - "test_agents_routes.py"
Cohesion: 0.21
...
### Community 649 - "test_mcp_identity.py"
Cohesion: 0.18
...
### Community 650 - "test_catalog_backends.py"
Cohesion: 0.19
...
### Community 651 - "FakeDockerBackend"
Cohesion: 0.16
...
### Community 652 - "hal0 test harness — internal contributor guide"
Cohesion: 0.12
...
### Community 653 - "test_container_health_gating.py"
Cohesion: 0.23
Nodes (15): _json_resp(), _mock_client(), _non_json_resp(), Any, ContainerProvider.health gates on model_loaded when the /health body reports it., 404 on /health + 200 on /v1/models (FLM) → ok True (fallback regression)., 200 + {"model_loaded": false} (kokoro loading) → ok False., 200 + {"model_loaded": true} (kokoro ready) → ok True. (+7 more)

### Community 654 - "_build_spec"
Cohesion: 0.28
...
### Community 655 - "Model registry — registry, pulls, classification"
Cohesion: 0.13
...
### Community 656 - "Handoff: qwen3tts standalone → hal0-slot migration"
Cohesion: 0.13
...
### Community 657 - "Container Image System Overhaul"
Cohesion: 0.13
...
### Community 658 - "hal0 rework plan — de-scarring the launch"
Cohesion: 0.13
...
### Community 659 - "Handoff — brain + embed slot/agent cleanup on halo150"
Cohesion: 0.13
...
### Community 660 - "Handoff — γ-suite (chromium) persistently red on main (#1333)"
Cohesion: 0.13
...
### Community 661 - "Handoff — fold rework→main merge/meld/fix follow-ups into the R5 docs"
Cohesion: 0.13
...
### Community 662 - "Handoff — hal0 R5 endgame (paste-in brief for a new session)"
Cohesion: 0.13
...
### Community 663 - "Findings (O-series)"
Cohesion: 0.13
...
### Community 665 - "hal0 Hermes Integration Suite Design"
Cohesion: 0.13
...
### Community 666 - "PR #1330 CI Repair Design"
Cohesion: 0.13
...
### Community 668 - "test_route_collisions.py"
Cohesion: 0.19
...
### Community 669 - "test_hermes_live_resolve_render.py"
Cohesion: 0.19
...
### Community 670 - "upsert_env_value"
Cohesion: 0.21
...
### Community 672 - "create_chat_template"
Cohesion: 0.24
...
### Community 673 - "test_slots_policy.py"
Cohesion: 0.26
...
### Community 675 - "load_stacks_config"
Cohesion: 0.21
Nodes (8): load_stacks_config(), Load and validate /etc/hal0/stacks.toml.      Returns the built-in seed stacks (, Parsed stacks.toml — top-level ``[stack]`` table, keyed by slug., StacksConfig, Path, Unit tests for the stacks.toml loader/saver.  Targeted file run:     ~/dev/hal0/, TestLoadStacksConfig, TestStacksConfig

### Community 676 - "profiles_toml"
Cohesion: 0.29
...
### Community 677 - ".snapshot"
Cohesion: 0.19
Nodes (8): Any, Path, Return the active GPU shader clock in MHz, or None.          AMD: parses ``pp_dp, Return the GPU temperature in °C, or None.          AMD: reads the first hwmon `, Return current system RAM used in GiB (MemTotal - MemAvailable)., Return current system RAM available in GiB (MemAvailable)., Return a JSON-safe dict of all available stats.          Field shape mirrors the, Detect GPU vendor exactly once and cache it.          On an AMD box (DRM sysfs p

### Community 678 - "write_openwebui_env"
Cohesion: 0.18
...
### Community 681 - "test_hermes_provision_kanban_db_init.py"
Cohesion: 0.20
...
### Community 682 - "test_persona_update.py"
Cohesion: 0.25
...
### Community 683 - "test_slots_npu_fields.py"
Cohesion: 0.20
...
### Community 684 - "test_brain_ctx_precheck.py"
Cohesion: 0.23
...
### Community 687 - "test_no_npu_slot_means_no_swap"
Cohesion: 0.13
Nodes (15): _gpu_slot(), _make_slot(), _noncontainer_npu_cfg(), Any, MonkeyPatch, Legacy/unmigrated NPU record → no live container to observe.      The snapshot i, Build a Slot-like mock whose .state is a real SlotState enum value., GET /api/npu/swap-status returns the shape even with no NPU configured. (+7 more)

### Community 688 - "test_pool_bounds.py"
Cohesion: 0.15
...
### Community 690 - "test_api_restart_on_upgrade.py"
Cohesion: 0.28
...
### Community 691 - "test_admin_route_map.py"
Cohesion: 0.17
...
### Community 692 - "test_container_mmproj.py"
Cohesion: 0.31
...
### Community 693 - "test_release_check.py"
Cohesion: 0.37
...
### Community 694 - "test_device_profile_coherence.py"
Cohesion: 0.18
...
### Community 695 - "test_mtp_defuse.py"
Cohesion: 0.34
...
### Community 696 - "test_preload_eviction.py"
Cohesion: 0.26
...
### Community 697 - "test_integrations.py"
Cohesion: 0.13
...
### Community 700 - "Toolbox Repo Consolidation"
Cohesion: 0.14
...
### Community 701 - "obtain-models.mdx"
Cohesion: 0.14
...
### Community 702 - "Deploy halves of the "CI here" scenarios"
Cohesion: 0.14
...
### Community 703 - "PART 2 — DELIVERABLES"
Cohesion: 0.14
...
### Community 704 - "0. EXACT Honcho footprint (file:line)"
Cohesion: 0.14
...
### Community 705 - "P2-device: make `device` the sole truth, delete the `backend` dual-write"
Cohesion: 0.14
...
### Community 706 - "Handoff — R5 drive 2: put it back together (paste-in prompt, Fable orchestrator)"
Cohesion: 0.14
...
### Community 707 - "hal0 1.0 Seeded Profile Rework — Implementation Plan"
Cohesion: 0.14
...
### Community 709 - "Phase 4 handoff — halo143 deploy window"
Cohesion: 0.14
...
### Community 710 - "test_moonshine_server.py"
Cohesion: 0.22
...
### Community 716 - ".gpu_sample"
Cohesion: 0.15
Nodes (10): Take a typed GPU memory + utilization sample (issue #703).          Delegates to, Return current GPU compute utilisation as a fraction [0.0, 1.0].          AMD: r, Return current GPU VRAM usage in MiB.          On AMD UMA (Strix Halo) returns m, Return total GPU VRAM in MiB (or GTT pool on UMA)., Return (total_mib, available_mib) from /proc/meminfo.      Raises CapacityProbeE, _read_meminfo(), probe_host_free_mb(), probe_host_total_mb() (+2 more)
...
### Community 718 - "MetricsRetention"
Cohesion: 0.18
...
### Community 719 - "test_model_fit_validation.py"
Cohesion: 0.25
...
### Community 720 - "heal_missing_llm_type"
Cohesion: 0.20
...
### Community 721 - "provider_requires_model"
Cohesion: 0.22
...
### Community 722 - "test_hermes_provision_context.py"
Cohesion: 0.14
...
### Community 723 - "test_middleware.py"
Cohesion: 0.21
...
### Community 724 - "test_services_health.py"
Cohesion: 0.27
...
### Community 726 - "test_board_etag.py"
Cohesion: 0.32
...
### Community 727 - "test_brain_chat.py"
Cohesion: 0.23
...
### Community 728 - "test_auth_commands.py"
Cohesion: 0.23
...
### Community 729 - "test_memory_ops_commands.py"
Cohesion: 0.16
...
### Community 730 - "test_slot_verb_aliases.py"
Cohesion: 0.16
...
### Community 731 - "test_hal0_gpu_gate.py"
Cohesion: 0.22
...
### Community 732 - "test_image_pin.py"
Cohesion: 0.14
...
### Community 733 - "test_flm_store_link.py"
Cohesion: 0.26
...
### Community 735 - "test_reinstall_into_venv_does_not_pass_no_deps"
Cohesion: 0.20
...
### Community 736 - "test_adopted_slot_eviction.py"
Cohesion: 0.23
...
### Community 737 - "test_dispatchable_ready_set_single_source.py"
Cohesion: 0.14
...
### Community 738 - "test_restart_errored_slot.py"
Cohesion: 0.26
...
### Community 742 - "Contributor Covenant Code of Conduct"
Cohesion: 0.15
Nodes (12): 1. Correction, 2. Warning, 3. Temporary Ban, 4. Permanent Ban, Attribution, Contributor Covenant Code of Conduct, Enforcement, Enforcement Guidelines (+4 more)

### Community 743 - "3. Recommendation: how hal0 should support ONNX"
Cohesion: 0.15
...
### Community 744 - "Dispatch / runtime — routing, arbiter, lifecycle"
Cohesion: 0.15
...
### Community 747 - "pull-and-register-models.mdx"
Cohesion: 0.15
...
### Community 748 - "hal0 rework — handoff: single primary orchestrator (R3-B / R4 / R5 + finish line)"
Cohesion: 0.15
...
### Community 749 - "Changes Applied (then rolled back)"
Cohesion: 0.15
...
### Community 750 - "hal0 codebase map"
Cohesion: 0.15
...
### Community 751 - "hal0 service management"
Cohesion: 0.15
...
### Community 752 - "QueryStringScrubber"
Cohesion: 0.18
...
### Community 755 - "migrate_unify_cmd"
Cohesion: 0.21
...
### Community 758 - "rerender_slot_units"
Cohesion: 0.29
...
### Community 759 - "test_containers_apparmor.py"
Cohesion: 0.37
...
### Community 761 - "test_activity.py"
Cohesion: 0.31
...
### Community 762 - "test_activity_routes_instrumented.py"
Cohesion: 0.38
...
### Community 763 - "test_comfyui_fetch_route.py"
Cohesion: 0.15
...
### Community 765 - "test_harness_matrix.py"
Cohesion: 0.21
...
### Community 766 - "TestSeamWhitelist"
Cohesion: 0.18
...
### Community 767 - "test_memory_graph_commands.py"
Cohesion: 0.15
...
### Community 768 - "test_model_verbs.py"
Cohesion: 0.26
...
### Community 771 - "_RecordingProvider"
Cohesion: 0.24
...
### Community 772 - "test_seed_profiles.py"
Cohesion: 0.24
...
### Community 777 - "Slot pin + drawer field-wiring audit — session handoff (2026-07-30)"
Cohesion: 0.17
...
### Community 778 - "Recently added endpoints"
Cohesion: 0.17
...
### Community 779 - "HW-slot-ownership — hardware sticks to slots, logical tune sticks to models"
Cohesion: 0.17
...
### Community 780 - "Design — 3-tier, deny-by-default, single classification source"
Cohesion: 0.17
...
### Community 781 - "hal0 UI/UX design brief — post-R3 surface rework"
Cohesion: 0.17
...
### Community 785 - "Release pipeline — prototype findings + blockers"
Cohesion: 0.17
...
### Community 792 - "NpuSwapStatus"
Cohesion: 0.18
Nodes (10): _npu_llm_anchor(), NpuSwapStatus, Any, NPU trio chat-model swap-in-progress detection.  When the operator picks a new N, Snapshot of the NPU trio swap state.      Attributes:         in_progress: True, Return the (at most one) model-bound NPU LLM slot config, or None.      The NPU-, No slot_manager wired → all-None settled snapshot (test bypass)., NpuSwapStatus.to_dict matches the wire shape. (+2 more)

### Community 793 - "_declared_path_args"
Cohesion: 0.18
...
### Community 795 - "TestTelemetrySampler"
Cohesion: 0.17
...
### Community 796 - "test_board_ws.py"
Cohesion: 0.32
...
### Community 797 - "test_agent_status.py"
Cohesion: 0.23
...
### Community 799 - "test_comfyui_scripts_shipped.py"
Cohesion: 0.17
...
### Community 800 - "test_static_seeds.py"
Cohesion: 0.17
...
### Community 802 - "board-chat-v3.spec.ts"
Cohesion: 0.21
Nodes (4): emitWs(), installWsHarness(), waitForWs(), NOTE: addInitScript serialises the function — it must not close over

### Community 803 - "[Unreleased]"
Cohesion: 0.18
Nodes (11): Added, Added, Breaking, Changed, Fixed, Fixed, Fixed, Fixed (+3 more)

### Community 804 - "`hal0-setup.yaml` — headless answer-file spec (2026-07-05)"
Cohesion: 0.18
...
### Community 805 - "Findings → fixes, by tier"
Cohesion: 0.18
...
### Community 806 - "Handoff: model-pipeline plan — finish-out pass"
Cohesion: 0.18
...
### Community 807 - "Hal0 Upstream Controls — Epic Plan (2026-07-06)"
Cohesion: 0.18
...
### Community 808 - "capabilities-and-profiles.mdx"
Cohesion: 0.18
...
### Community 809 - "Admin tools (`/mcp/admin`)"
Cohesion: 0.18
...
### Community 810 - "providers-profiles-devices.mdx"
Cohesion: 0.18
...
### Community 811 - "slot-lifecycle.mdx"
Cohesion: 0.18
...
### Community 812 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
...
### Community 813 - "Both-boxes deploy-validation runbook — rework-R4-stage"
Cohesion: 0.18
...
### Community 814 - "P3-brain — Implementation-Ready Spec: hal0-brain as a first-class module"
Cohesion: 0.18
...
### Community 815 - "PART D — Edit plan (files, order, delegators/shims)"
Cohesion: 0.18
...
### Community 816 - "hal0 Hermes Plugin Suite — BUILD Spec (verified vs code @ `rework/descar`)"
Cohesion: 0.18
...
### Community 817 - "Hermes Agent official integration research for the hal0 rework"
Cohesion: 0.18
...
### Community 818 - "2. Proposed hal0 plugin suite"
Cohesion: 0.18
...
### Community 830 - "test_hermes_provision_collect.py"
Cohesion: 0.25
...
### Community 831 - "test_config_model_roots.py"
Cohesion: 0.29
...
### Community 832 - "test_doctor_route.py"
Cohesion: 0.24
...
### Community 833 - "test_features_health.py"
Cohesion: 0.25
...
### Community 834 - "test_meta_enums.py"
Cohesion: 0.42
...
### Community 836 - "test_server_ab_helpers.py"
Cohesion: 0.22
...
### Community 837 - "test_board_commands.py"
Cohesion: 0.27
...
### Community 838 - "test_serve_bind_host.py"
Cohesion: 0.31
...
### Community 839 - "test_fetch_scripts.py"
Cohesion: 0.18
...
### Community 840 - "hal0 test-harness — findings"
Cohesion: 0.18
...
### Community 843 - "test_admin_stacks.py"
Cohesion: 0.24
...
### Community 844 - "test_api_wiring.py"
Cohesion: 0.24
...
### Community 846 - "test_npu_trio_reconcile.py"
Cohesion: 0.45
...
### Community 847 - "test_pin_semantics.py"
Cohesion: 0.18
...
### Community 864 - "get_agent_memory_stats"
Cohesion: 0.29
...
### Community 865 - "_normalize_chat_body"
Cohesion: 0.20
...
### Community 868 - "slot_migrate_caps"
Cohesion: 0.42
...
### Community 869 - "slot_migrate_enabled_removal"
Cohesion: 0.42
...
### Community 870 - "ProviderEntry"
Cohesion: 0.24
Nodes (4): ProviderEntry, One [[provider]] entry in providers.toml.      ``extra="forbid"`` (P3-schema Par, TestProviderEntry, TestProvidersConfig

### Community 871 - "resolve_chat_template"
Cohesion: 0.27
...
### Community 872 - "resolve_gpu_device_paths"
Cohesion: 0.24
...
### Community 875 - "collect_port_claims"
Cohesion: 0.29
...
### Community 877 - "TestStatusTelemetry"
Cohesion: 0.29
...
### Community 881 - "test_catalog_npu_stt.py"
Cohesion: 0.27
...
### Community 882 - "test_shared_auth.py"
Cohesion: 0.33
...
### Community 884 - "test_validate_catalog.py"
Cohesion: 0.24
...
### Community 890 - "memory-view-v3.spec.ts"
Cohesion: 0.20
...
### Community 896 - "ROCmFPX bench — RESULTS + next-session handoff (2026-07-05)"
Cohesion: 0.22
...
### Community 897 - "architecture.mdx"
Cohesion: 0.22
...
### Community 899 - "connect-clients.mdx"
Cohesion: 0.22
...
### Community 900 - "connect-external-providers.mdx"
Cohesion: 0.22
...
### Community 901 - "realtime-voice.mdx"
Cohesion: 0.22
...
### Community 902 - "openai-compat.mdx"
Cohesion: 0.22
...
### Community 903 - "slot-as-model.mdx"
Cohesion: 0.22
...
### Community 904 - "env-vars.mdx"
Cohesion: 0.22
Nodes (8): Install & update, Memory & MCP, Models & providers, Paths, Runtime, See also, Server, Services

### Community 905 - "Handoff prompt — hal0-brain / template / profile changes on lxc105 (hal0, 10.0.1.142)"
Cohesion: 0.22
...
### Community 906 - "PART B — Target: Quadlet `.container` per slot (and per companion)"
Cohesion: 0.22
...
### Community 907 - "Slot-pin-lifecycle — the operator pin is the residency control, and the only one"
Cohesion: 0.22
...
### Community 908 - "SWEEP inventory — the overlooked surface (R5 release-prep)"
Cohesion: 0.22
...
### Community 911 - "Hindsight pi Extension Design"
Cohesion: 0.22
...
### Community 912 - "Dashboard plugin "Could not load this plugin's script""
Cohesion: 0.22
...
### Community 913 - "Strix Halo Benchmark Harness (hal0)"
Cohesion: 0.22
...
### Community 919 - "migrate_cognee_to_hindsight_dryrun"
Cohesion: 0.25
...
### Community 920 - "MetricsAggregator"
Cohesion: 0.28
...
### Community 921 - "TestImageMismatch"
Cohesion: 0.33
...
### Community 923 - "test_hermes_stale_dropin_cleanup.py"
Cohesion: 0.47
...
### Community 924 - "isolated_client_with_root"
Cohesion: 0.33
...
### Community 926 - "TestHarnessConfig"
Cohesion: 0.22
...
### Community 929 - "test_config_show_edit_selector.py"
Cohesion: 0.50
...
### Community 931 - "test_slot_metrics_capacity.py"
Cohesion: 0.36
...
### Community 933 - "test_gp15_no_hermes.py"
Cohesion: 0.22
...
### Community 935 - "test_browser_server.py"
Cohesion: 0.25
...
### Community 936 - "TestContainerRuntimeProbe"
Cohesion: 0.22
...
### Community 938 - "test_halo143_reboot_no_split_brain"
Cohesion: 0.36
...
### Community 939 - "test_model_preferred_profile.py"
Cohesion: 0.50
...
### Community 942 - "useBannerStore.ts"
Cohesion: 0.22
Nodes (8): BANNER_CATALOG, BannerAction, BannerEntry, BannerKind, BannerScope, BannerState, CATALOG_BY_ID, useBannerStore

### Community 943 - "Local-session prompt: run the profile re-tune bench matrix and apply the results"
Cohesion: 0.25
...
### Community 947 - "generate-images.mdx"
Cohesion: 0.25
...
### Community 948 - "update-and-rollback.mdx"
Cohesion: 0.25
...
### Community 949 - "voice-stt-tts.mdx"
Cohesion: 0.25
...
### Community 951 - "paths-and-files.mdx"
Cohesion: 0.25
...
### Community 953 - "13. Observability & metrics baseline (ships in every box)"
Cohesion: 0.25
...
### Community 954 - "15. Hermes plugin — standalone repo + native update path"
Cohesion: 0.25
...
### Community 955 - "PART C — Coordination contracts (cross-lane seams)"
Cohesion: 0.25
...
### Community 956 - "halo143 deploy-validation runbook — rework-R3"
Cohesion: 0.25
...
### Community 957 - "Handoff — R5 Phase 4: deploy window → release cut (paste-in prompt)"
Cohesion: 0.25
...
### Community 958 - "mock-prod-gate verification (Phase 0 launch-blocker #3)"
Cohesion: 0.25
...
### Community 959 - "Podman on the hal0 slot substrate — findings & cleaner solutions"
Cohesion: 0.25
...
### Community 965 - "WorkspaceEscapeError"
Cohesion: 0.32
...
### Community 973 - "test_auth_exposure_route.py"
Cohesion: 0.32
...
### Community 977 - "test_app_list_uninstall.py"
Cohesion: 0.36
...
### Community 978 - "test_cli_docs_parity.py"
Cohesion: 0.36
...
### Community 982 - "test_slot_enabled_removed.py"
Cohesion: 0.25
...
### Community 984 - "_BackendContract"
Cohesion: 0.25
...
### Community 987 - "test_slot_create_conflict.py"
Cohesion: 0.29
...
### Community 988 - "test_slot_schema.py"
Cohesion: 0.32
...
### Community 989 - "test_transition_guard.py"
Cohesion: 0.25
...
### Community 990 - "useTweaksStore.ts"
Cohesion: 0.29
Nodes (5): APPEARANCE_KEYS, DEFAULTS, TweaksState, TweaksStore, useTweaksStore

### Community 991 - "board-chat-tool-use-v3.spec.ts"
Cohesion: 0.29
Nodes (3): GATED_FRAMES, mockChat(), sse()

### Community 992 - "Concurrency & continuous-batching optimization plan"
Cohesion: 0.29
...
### Community 993 - "ROCmFPX exploratory bench — RESULTS (2026-07-05)"
Cohesion: 0.29
...
### Community 999 - "P3-perms: declarative OwnershipStore as the single ownership authority"
Cohesion: 0.29
...
### Community 1000 - "PART B — Target: OwnershipStore default `service_user="hal0"`"
Cohesion: 0.29
...
### Community 1001 - "PART C — The LOAD-BEARING contract: born-owned"
Cohesion: 0.29
...
### Community 1002 - "PART 0 — EXACT MAP (file:line)"
Cohesion: 0.29
...
### Community 1003 - "P3-quadlet: migrate slot + companion units to Podman Quadlet `.container`"
Cohesion: 0.29
...
### Community 1004 - "PART A — Current scars (in plain English)"
Cohesion: 0.29
...
### Community 1005 - "4. Delivery plan and gates"
Cohesion: 0.29
...
### Community 1009 - "Gateway connectivity quirks — hal0"
Cohesion: 0.29
...
### Community 1019 - "write_env_atomic"
Cohesion: 0.33
...
### Community 1025 - "test_memory_mm_commands.py"
Cohesion: 0.29
Nodes (3): MonkeyPatch, Tests for ``hal0 memory mm {list,refresh,history}``., stub_api()

### Community 1026 - "test_slot_rename.py"
Cohesion: 0.33
...
### Community 1027 - "test_paths_stub.py"
Cohesion: 0.29
...
### Community 1028 - "_reject_privileged_systemctl"
Cohesion: 0.33
...
### Community 1029 - "test_voice_roundtrip.py"
Cohesion: 0.43
...
### Community 1030 - "10. Troubleshooting"
Cohesion: 0.29
...
### Community 1031 - "test_owui_pin_consistency.py"
Cohesion: 0.43
...
### Community 1032 - "test_extra_args_sanitize.py"
Cohesion: 0.38
...
### Community 1046 - "logs-and-activity.mdx"
Cohesion: 0.33
...
### Community 1051 - "24. Execution waves / rollout program (session 3, 2026-07-18)"
Cohesion: 0.33
...
### Community 1053 - "§4.4 addendum — MCP admin route-map autogen (the 3 gaps)"
Cohesion: 0.33
...
### Community 1054 - "Verification strategy"
Cohesion: 0.33
Nodes (6): Lifecycle and security, Live acceptance, Memory, Provider, Verification strategy, Voice

### Community 1055 - "Dashboard permission mismatch (root vs hal0)"
Cohesion: 0.33
...
### Community 1068 - "throughput_history"
Cohesion: 0.33
...
### Community 1073 - "ttft_samples.py"
Cohesion: 0.33
...
### Community 1074 - "avg_ttft_across"
Cohesion: 0.33
...
### Community 1075 - "samples_from_events"
Cohesion: 0.33
...
### Community 1076 - "test_activity_instrumentation.py"
Cohesion: 0.60
...
### Community 1077 - "test_models_catalogue.py"
Cohesion: 0.47
...
### Community 1081 - "test_curation_drift.py"
Cohesion: 0.40
...
### Community 1082 - "test_family_defaults_empty.py"
Cohesion: 0.33
...
### Community 1101 - "14. Kanban board — ownership inversion + security hardening"
Cohesion: 0.40
...
### Community 1102 - "16. Hermes Python library (`AIAgent`) for the brain — evaluated, rejected for core"
Cohesion: 0.40
...
### Community 1103 - "21.A Mapping table — every candidate by disposition"
Cohesion: 0.40
...
### Community 1104 - "8. SQLite adoption — setup plan"
Cohesion: 0.40
...
### Community 1105 - "PART A — Current-state map (the scars, in plain English)"
Cohesion: 0.40
...
### Community 1106 - "PART D — The one narrow privileged helper: `hal0-systemctl`"
Cohesion: 0.40
...
### Community 1107 - "PART G — Sequencing: P3-perms BEFORE hermes-provision slim and P3-quadlet"
Cohesion: 0.40
...
### Community 1108 - "PART 0 — Current-state map (the hand-rendered ExecStart scars, file:line)"
Cohesion: 0.40
...
Cohesion: 0.40
Nodes (4): probe_slot_name(), Any, Shared helper for ContainerProvider probe doubles (#1417).  Production hands the, The slot name a probe argument refers to (config mapping or bare token).

### Community 1125 - "test_distro.sh"
Cohesion: 0.90
Nodes (4): bad(), ok(), test_distro.sh script, want()

### Community 1129 - "slot-card-container-v3.spec.ts"
Cohesion: 0.40
...
### Community 1130 - "slot-edit-controls-v3.spec.ts"
Cohesion: 0.40
...
### Community 1132 - "[0.9.5.1] — 2026-07-09"
Cohesion: 0.50
Nodes (4): [0.9.5.1] — 2026-07-09, Added, Fixed, Highlights

### Community 1133 - "[0.9.6.1] — 2026-07-11"
Cohesion: 0.50
Nodes (4): [0.9.6.1] — 2026-07-11, Added, Changed, Fixed

### Community 1134 - "[v0.8.3b1] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.3b1] — 2026-07-04

### Community 1135 - "[v0.8.2b3] — 2026-06-29"
Cohesion: 0.50
Nodes (4): Added, Docs, Fixed, [v0.8.2b3] — 2026-06-29

### Community 1136 - "[v0.8.0-beta.1] — 2026-06-21"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.0-beta.1] — 2026-06-21

### Community 1137 - "[v0.7.3-beta.2] — 2026-06-19"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.7.3-beta.2] — 2026-06-19

### Community 1138 - "[v0.5.1-alpha.1] — 2026-06-15"
Cohesion: 0.50
Nodes (4): Added, Changed, Removed, [v0.5.1-alpha.1] — 2026-06-15

### Community 1139 - "[v0.5.0-alpha.1] — 2026-06-14"
Cohesion: 0.50
Nodes (4): Added, Fixed, Internal, [v0.5.0-alpha.1] — 2026-06-14

### Community 1140 - "[v0.9.0] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.9.0] — 2026-07-04

### Community 1141 - "[v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)"
Cohesion: 0.50
Nodes (4): Internal contracts, Known follow-up, New / improved, [v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)

### Community 1142 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1143 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1144 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1145 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1146 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1147 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1148 - "hal0 docs"
Cohesion: 0.50
Nodes (3): `docs/internal/` — repo-only architecture docs, hal0 docs, Top-level `docs/*.mdx` — user docs

### Community 1149 - "streaming.mdx"
Cohesion: 0.50
Nodes (3): Client example, See also, Wire format

### Community 1150 - "11. Product reworks — round 2 (slot identity, ports, profile org)"
Cohesion: 0.50
...
### Community 1151 - "PART E — `hal0-api` User flip + UMask removal"
Cohesion: 0.50
...
### Community 1152 - "PART F — Edit plan (files, order, delegators/shims)"
Cohesion: 0.50
...
### Community 1153 - "PART H — Risks + capped verification"
Cohesion: 0.50
...
### Community 1154 - "PART E — Migration of running units (the live-box transition)"
Cohesion: 0.50
...
### Community 1155 - "PART F — Risks + capped verification"
Cohesion: 0.50
...
### Community 1172 - "_delegate_fakes.py"
Cohesion: 0.50
...
### Community 1173 - "test_comfyui_path.py"
Cohesion: 0.50
...
### Community 1180 - "[0.9.2] — 2026-07-05"
Cohesion: 0.67
Nodes (3): [0.9.2] — 2026-07-05, Fixed, Highlights

### Community 1181 - "[v0.8.5b2] — 2026-07-04"
Cohesion: 0.67
Nodes (3): Added, Fixed, [v0.8.5b2] — 2026-07-04

### Community 1182 - "[v0.8.2b2] — 2026-06-24"
Cohesion: 0.67
Nodes (3): Changed, Fixed, [v0.8.2b2] — 2026-06-24

### Community 1204 - "_OtherEngineProvider"
Cohesion: 0.67
...
### Community 1210 - "test_agent_unit_argv_defaults_to_real_euid"
Cohesion: 0.67
Nodes (3): MonkeyPatch, ``euid=None`` (the production call) reads the live euid., test_agent_unit_argv_defaults_to_real_euid()

## Knowledge Gaps
- **3298 isolated node(s):** `runlog.sh script`, `rocmfpx-build.sh script`, `rocmfpx-env.sh script`, `rocmfpx-pipeline.sh script`, `rocmfpx-quantize.sh script` (+3293 more)
...
- **Why does `SlotManager` connect `SlotManager` to `Slot`, `test_manager_npu_container.py`, `.__init__`, `SlotState`, `FLMProvider`, `Dispatcher`, `FakeManager`, `test_model_fallback.py`, `ContainerProvider`, `test_model_preferred_profile.py`, `GpuArbiter`, `RoutingHost`, `_write_slot`, `test_load_converges_config.py`, `compute_config_drift`, `test_device_profile_coherence.py`, `test_mtp_defuse.py`, `test_preload_eviction.py`, `FakeSlotManager`, `FakeContainerProvider`, `test_slot_aliases.py`, `manager.py`, `_write_slot`, `test_npu_trio_reconcile.py`, `heal_missing_llm_type`, `test_npu_exclusivity.py`, `Request`, `test_slot_create_conflict.py`, `SlotIdentityStore`, `test_transition_guard.py`, `test_adopted_slot_eviction.py`, `test_pulling_serving_idle.py`, `Path`, `agents-overview.jsx`, `test_npu_trio_shadow.py`, `build_auto_selections`, `SlotInterface`, `rerender_slot_units`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `create_app()` connect `create_app` to `TestClient`, `test_v1_chat_slot_alias.py`, `test_slots_container_state.py`, `ApprovalQueue`, `test_hf_routes.py`, `test_stacks_routes.py`, `_build`, `isolated_client_with_root`, `ConfigParseError`, `test_memory_admin_routes.py`, `test_route_collisions.py`, `test_dashboard_layout.py`, `test_slots_policy.py`, `test_models_crud.py`, `GpuImageMode`, `conftest.py`, `test_updater_routes.py`, `conftest.py`, `test_memory_delete_auth.py`, `test_settings_routes.py`, `test_pull_routes.py`, `test_slots_npu_fields.py`, `Hal0Config`, `test_slots_routes.py`, `test_kb1_hardening_tail.py`, `mcp_mount.py`, `TestClient`, `test_models_routes.py`, `test_slots_image_pull.py`, `test_chat_proxy.py`, `test_config_model_roots.py`, `test_v1_npu_trio_routing.py`, `migrate_slot_toml`, `test_settings_models_store.py`, `test_chat_proxy_auth.py`, `EventBus`, `_build`, `test_models_preview.py`, `Path`, `auth.py`, `test_profiles_crud.py`, `test_admin_route_map_nested.py`, `test_tts_request_defaults.py`, `test_typed_bodies.py`, `FakeWsServer`, `test_typed_errors.py`, `conftest.py`, `test_redact.py`, `test_chat_templates.py`, `test_exposure.py`, `MemoryConfig`, `test_models_add_from_path.py`, `PgVectorProvider`, `test_models_default.py`, `test_v1_slot_alias_models.py`, `TestClient`, `_StubSlotManager`, `test_cli_auth_streamtest.py`, `__init__.py`, `test_event_contract.py`, `test_auth_core.py`, `BootReport`, `test_auth_rotate.py`, `conftest.py`, `test_installer_routes.py`, `test_comfyui_fetch_route.py`?**
  _High betweenness centrality (0.064) - this node is a cross-community bridge._
- **Why does `connect()` connect `connect` to `BoardStore`, `pull.py`, `gc.py`, `MetricsWriter`, `PortAuthority`, `SqliteModelRegistry`, `ModelRegistry`, `import_toml_to_sqlite`, `test_pull_refcount_rows.py`, `useLogs.ts`, `ModelRegistry`, `aggregate_hour`, `models_service.py`, `useActivity.ts`, `Path`, `SlotIdentityStore`, `_safe_query`, `test_stats_requests_route.py`, `hw_slot_ownership.py`, `_iso`?**
