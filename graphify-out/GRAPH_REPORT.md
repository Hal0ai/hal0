# Graph Report - C-chrome-diag-layout  (2026-07-30)

## Corpus Check
- 1628 files · ~2,061,787 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29502 nodes · 56072 edges · 1385 communities (1226 shown, 159 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 6893 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6fc0793a`
...
- container_stub
- test_get_slot_includes_config_drift_when_requested
- test_store.py
- .handler
- _delegate_fakes.py
...
- test_import.py
- eslint.config.js
- footer-health-tooltip-v3.spec.ts
...
- capability-catalog-pickers-v3.spec.ts
...
## Communities (1385 total, 159 thin omitted)

### Community 0 - "dashboard-redesign.jsx"
Cohesion: 0.03
Nodes (128): useActivityRecent(), CELL_DEFS, CELL_MAP, CellDef, CellId, DashLayout, DEFAULT_LAYOUT, LAYOUT_QUERY_KEY (+120 more)

### Community 1 - "useSlots.ts"
Cohesion: 0.03
Nodes (122): ADR-0022, NpuOccupancy, NpuOccupancySlot, useNpuOccupancy(), deviceBackend(), parseImageRef(), RunnerState, RuntimeRow (+114 more)

### Community 2 - "Slot"
Cohesion: 0.03
Nodes (76): flm_id_to_tag(), Resolve a hal0 ``<tag>-FLM`` id back to FLM's native ``family:size`` tag.      I, _cfg_port(), _cfg_provider(), _cfg_to_dict(), _model_default(), Any, Tiny leaf-level slot-config accessors shared across the slots subtree.  These fo (+68 more)
...
### Community 5 - "stacks.jsx"
Cohesion: 0.05
Nodes (68): URL-safe lowercase identifier used by the REST surface., api(), serialiseBody(), useComfyuiPin(), useComfyuiSwitchover(), useComfyuiWorkflowLaunch(), ProfileBody, ProfileEnvelope (+60 more)

### Community 6 - "SqliteModelRegistry"
Cohesion: 0.07
Nodes (49): One normalised row of an HF repo tree listing., RawTreeEntry, SqliteModelRegistry — SQLite-backed model catalog (ML-1 pilot).  Drop-in replace, No-op: SQLite has no mtime cache to invalidate.          Kept as a method so the, SQLite-backed model registry — the ML-1 pilot store.      Thread/process-safety:, SqliteModelRegistry, db_path(), Path (+41 more)

### Community 7 - "connect"
Cohesion: 0.07
Nodes (33): Path, connect(), db_path(), Connection, Path, SQLite connection + transaction helpers — the hal0 ``db/`` foundation.  One conn, Return the default hal0 SQLite database path.      Thin wrapper over :func:`hal0, Switch to WAL journal mode, retrying through transient contention.      The *fir (+25 more)
...
### Community 9 - "ConfigParseError"
Cohesion: 0.04
Nodes (54): list_slot_layout(), load_slot_config(), load_slot_config_by_id(), Load and validate /etc/hal0/slots/<slot_name>.toml.      The on-disk shape (per, Load and validate an id-keyed slot TOML (``slots/<slot_id>.toml``).      The id-, Atomically write a slot config TOML.      The pydantic SlotConfig is flat; we re, Classify every slots/*.toml stem as ``"id"`` or ``"name"``.      The bilingual e, save_slot_config() (+46 more)

### Community 10 - "test_memory_hindsight_plugin.py"
Cohesion: 0.02
Nodes (12): MonkeyPatch, hal0-memory Hermes plugin (canonical src copy) — hermetic unit coverage.  ``src/, test_backup_paths_includes_spool_when_configured(), test_initialize_builds_client_from_env_defaults(), test_initialize_reads_default_visibility_from_env(), test_initialize_respects_env_overrides(), test_resolve_agent_id_default(), test_resolve_agent_id_falls_back_to_env() (+4 more)

### Community 11 - "SlotConfigError"
Cohesion: 0.05
Nodes (67): The model registry could not be consulted (outage, not a miss).      Raised by t, RegistryUnavailableError, admit(), CandidateSlot, _estimate_incoming_footprint_mb(), EvictionStep, _gather_candidates(), PreloadEvictHost (+59 more)

### Community 12 - "Model"
Cohesion: 0.05
Nodes (72): NamedTuple, FileSetEntry, FileSetPlan, One file of a planned file-set, ready for ``model_file`` insertion., The full set of files one model pull should download + register., _dir_size(), _discard_partial(), _download_one() (+64 more)

### Community 13 - "ENDPOINTS"
Cohesion: 0.04
Nodes (94): ChatTemplate, useChatTemplates(), useMeta(), useMetaEnums(), AddFromPathRequest, fmtBytes(), fmtEta(), fmtSpeed() (+86 more)

### Community 14 - "Any"
Cohesion: 0.03
Nodes (88): _artefact_token(), _best_effort_model_info(), _binary_runner(), _container_runtime(), _effective_backend_and_device_class(), _effective_parallel(), _effective_runner(), _llama_argv_segments() (+80 more)

### Community 15 - "useModels.ts"
Cohesion: 0.05
Nodes (69): useMemoryEnabled(), useClearPullJob(), useHfSearch(), useModels(), useModelUpdateAll(), useModelUpdatesCheck(), useModelUpdatesForceCheck(), usePullsList() (+61 more)

### Community 16 - "die"
Cohesion: 0.04
Nodes (126): agent_install(), agent_list(), agent_peers(), approvals_approve(), approvals_deny(), approvals_list(), List installed bundled agents., List pending agent approval requests. (+118 more)

### Community 17 - "ApprovalQueue"
Cohesion: 0.03
...
### Community 20 - "useSlots"
Cohesion: 0.05
Nodes (78): useBackends(), CapabilitiesBag, CapabilityBackend, CapabilityCatalogItem, CapabilityRow, CapabilitySelection, useCapabilities(), useCapability() (+70 more)

### Community 21 - "FLMProvider"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (121): _current_symlink(), Return ``<usr_lib>/hal0-<version>/`` — where this release's tree lives., Return ``<usr_lib>/current`` — the atomic-swap target., Atomic self-update with cosign-verified releases and one-step rollback.      All, Updater, _versioned_install_dir(), _build_release_tarball(), cosign_skip() (+113 more)
...
### Community 27 - "Dispatcher"
Cohesion: 0.05
Nodes (83): LegacyResolutionFailed, Raised when the capability/path heuristics find no slot to serve a request., Dispatcher, DispatchError, NoRouteFound, Request, Look up a registry binding for a model id.          Returns (upstream_name, upst, Forward client headers minus hop-by-hop, plus upstream auth slot.          # NOT (+75 more)

### Community 28 - "test_probe.py"
Cohesion: 0.05
...
### Community 35 - "schema.py"
Cohesion: 0.06
Nodes (67): cmd_eval(), cmd_import_v1(), _compact_ts_to_iso(), _eval_run_id(), _eval_table(), _import_v1_index(), _import_v1_server_ab(), _load_window() (+59 more)
...
Cohesion: 0.04
Nodes (84): AbstractEventLoop, _auto_resume_interrupted_pulls(), _boot_audit_store(), _boot_background_tasks(), _boot_capabilities(), _boot_dispatcher(), _boot_mcp_memory_call(), _boot_memory_dispatch() (+76 more)

### Community 40 - "ModelRegistry"
Cohesion: 0.06
Nodes (37): Model, ModelCapabilities, ModelDefaults, Model — registry entry pydantic model.  The Model class is the typed representat, A model entry in the hal0 registry.      All fields are optional at construction, # NOTE: revisit in Phase 1 — extend as providers surface new capabilities., Launch/runtime typed flags — §7.1d / ML-6.      Distinct from :attr:`Model.capab, Per-model default knobs surfaced as launcher defaults.      All fields optional. (+29 more)

### Community 41 - "comfyui-pane.jsx"
Cohesion: 0.03
Nodes (72): ADR-0004, ADR-0013, ADR-0023, COMFYUI_FALLBACK, ComfyuiArbiter, ComfyuiEngineState, ComfyuiMemory, ComfyuiMode (+64 more)

### Community 42 - "test_models_crud.py"
Cohesion: 0.09
...
### Community 43 - "test_updater_routes.py"
Cohesion: 0.05
...
### Community 44 - "SlotConfig"
Cohesion: 0.03
Nodes (47): MemoryEmbeddingConfig, Any, [memory.embedding] section of hal0.toml — Hindsight-era rerank knobs.      ADR-0, Pydantic model for a single slot's TOML config (slots/<name>.toml).      Fields, Pull a `[server]` TOML table out of the loader's `extra` catch-all.          ``h, Pull a `[npu]` TOML table out of the loader's `extra` catch-all.          Mirror, Pull an `[image]` TOML table out of the loader's `extra` catch-all.          Mir, Read-only promotion shim: derive ``device`` from a legacy         on-disk ``back (+39 more)

### Community 45 - "UpstreamCall"
Cohesion: 0.06
Nodes (34): _default_fetch_models(), _default_is_online(), _filter_response_headers(), _join_url(), Any, AsyncClient, Response, StreamingResponse (+26 more)

### Community 46 - "ProfileCatalog"
Cohesion: 0.03
Nodes (92): RuntimeFamily, SlotType, create_profile(), delete_profile(), export_profile(), get_profile(), import_profile_route(), list_profiles() (+84 more)
...
### Community 49 - "test_hermes_provision.py"
Cohesion: 0.03
Nodes (56): _Runner, _build_overlay_keys(), Unit tests for :mod:`hal0.agents.hermes_provision`.  Pins the linear ``install_h, display.show_reasoning: true is required for thinking-model TUI visibility     (, display.streaming: true is required alongside show_reasoning — without it     th, model.max_tokens must be a positive int — Qwen3 thinking models silently     dra, model.base_url is always set. Hermes's bare ``provider: custom`` requires     it, Delegation → `agent` MoE slot (thinking-off); chat stays on main model.      Thi (+48 more)

### Community 50 - "primitives.jsx"
Cohesion: 0.04
...
### Community 52 - "resolve_by_capability"
Cohesion: 0.05
...
### Community 55 - "Path"
Cohesion: 0.07
Nodes (62): InstallIO, Injectable IO seams :func:`install_hermes` touches.      Defaults bind the real, fake_hermes_run(), A stand-in for ``subprocess.run`` that applies hermes config verbs., _patch_dropin_to_tmp(), MonkeyPatch, Path, First-run posture: no ready slot + no mcp_wire checkpoint → both     fallback si (+54 more)

### Community 56 - "ModelDefaults"
Cohesion: 0.06
...
### Community 58 - "hardware.py"
Cohesion: 0.05
Nodes (67): _background_revalidate(), _cached_snapshot(), _clear_in_flight(), get_hardware(), _gpu_sample(), _local_image_repos(), _local_live_stats(), models_health_endpoint() (+59 more)
...
Cohesion: 0.12
Nodes (56): _final_response(), _make_app(), _multi_tool_response(), _PlatformRecorder, Any, Tests for the board chat orchestrator — src/hal0/api/routes/board_chat.py.  The, Like _Recorder but for hal0-api's OWN routes (no kanban prefix)., Attach a Hal0Config carrying a [brain_chat] override to app.state. (+48 more)

### Community 63 - "slots.py"
Cohesion: 0.05
Nodes (91): _cache_slot_enrichment(), _config_field_enrichment(), _container_state_enrichment(), create_slot(), delete_slot(), get_slot(), get_slot_by_id(), get_slot_by_name() (+83 more)

### Community 64 - "SlotWatchdog"
Cohesion: 0.11
...
### Community 65 - "load_profiles_config"
Cohesion: 0.08
Nodes (21): _model_info(), Any, Unit tests for ``hal0.providers.container.ContainerProvider``.  Issue #655 — tra, Registry-miss contract (Phase C final review): model_info without a     ``path``, Regression guard for the 2026-06-15 chat@4096 incident: a slot whose     TOML pi, halo150/143 O8+O11: ONE render for every substrate — no version branch.      Nat, spec-hw-slot-ownership §2: the slot owns NGL + THREADS; the model no     longer, Test shim: render a plan to Quadlet ``.container`` text (was ``_render_unit_from (+13 more)

### Community 66 - "NpuTrioRouter"
Cohesion: 0.07
...
### Community 67 - "test_models_routes.py"
Cohesion: 0.05
Nodes (70): _derive_ns(), Return ``"blessed"`` if ``model.path`` sits under a recipe/capability     direct, _hf_handler(), inspect_app(), inspect_client(), _patch_httpx_transport(), Any, Exception (+62 more)

### Community 68 - "connections.jsx"
Cohesion: 0.07
Nodes (47): _fetchServers(), McpServer, McpServerActivity, McpServerState, McpTool, MOCK_SERVERS, useMcpServers(), isManagedRemote() (+39 more)
...
### Community 73 - "Path"
Cohesion: 0.07
Nodes (42): _deep_merge(), _default_mcp_servers(), _live_resolve_enabled(), _merge_config_yaml_layers(), _phase_brain_profile_mcp_wire(), _phase_brain_profile_seed(), _phase_config_write(), _phase_env_probe() (+34 more)

### Community 74 - "HardwareStats"
Cohesion: 0.06
...
### Community 77 - "HindsightProvider"
Cohesion: 0.04
...
### Community 78 - "_spec_provider_for"
Cohesion: 0.03
Nodes (68): Provider, Any, ContainerSpec, Abstract base for a hal0 inference backend.      Concrete implementations: Conta, Compute the EnvironmentFile contents for a slot.          Returns a mapping of H, Return the argv list for spawning this backend outside systemd.          Mirrors, Run a health check against the backend on *port*.          Returns {"ok": bool,, Passthrough inference against the provider's OpenAI-compatible API.          Thi (+60 more)

### Community 79 - "SlotState"
Cohesion: 0.09
...
### Community 80 - "hermes_provision.py"
Cohesion: 0.04
Nodes (97): _active_persona_render(), _apply_config_set(), BootstrapState, _brain_profile_config_path(), _build_identity_card(), _copy_plugin_tree(), _copy_wrapper(), _dirs_identical() (+89 more)

### Community 81 - "Any"
Cohesion: 0.06
Nodes (54): _build_brain_identity_card(), _collect_capability_rollup(), _collect_chat_slots(), _fetch_slots(), _find_named_ready_slot(), _find_slot(), _hal0_version_string(), hermes_pinned_ref() (+46 more)

### Community 82 - "_RecordingSlotManager"
Cohesion: 0.07
...
Cohesion: 0.05
Nodes (46): Any, Path, StackSlotEntry, StackApplyEngine — translate a StackConfig into an atomic slot-config change.  P, Reconcile a StackConfig onto slot TOMLs as one ChangeSet., Compute the post-state for ``stack``. Writes NOTHING.          Only entries that, Pre-apply sanity check: flag entries whose profile/model won't resolve., Project a stack slot entry onto the existing slot TOML dict.          Builds the (+38 more)

### Community 87 - "load_hal0_config"
Cohesion: 0.06
Nodes (57): MigrationPlan, _apply_store_change(), _config_to_dict(), ConfigInvalidError, _deep_merge(), get_apply_plan(), get_model_store(), get_settings() (+49 more)

### Community 88 - "BoardStore"
Cohesion: 0.32
...
Cohesion: 0.07
Nodes (54): activity_db(), agent_workspace_dir(), agents_config_dir(), bundle_chosen_marker(), _covers(), db_path(), default_flm_models_dir(), etc() (+46 more)
...
### Community 92 - "test_profile_derive.py"
Cohesion: 0.06
...
### Community 95 - "models_service.py"
Cohesion: 0.06
...
### Community 98 - "SlotStateRecord"
Cohesion: 0.03
Nodes (71): container_provider(), Return the process-wide ContainerProvider singleton., Push a record onto every active SSE subscriber queue., Async generator yielding every slot state transition as it happens.          Use, See :meth:`hal0.slots.watchdog.SlotWatchdog.update`., is_dispatchable_state(), is_transition_legal(), Any (+63 more)

### Community 99 - "test_contract_compatibility.py"
Cohesion: 0.06
...
### Community 103 - "cli.py"
Cohesion: 0.06
Nodes (45): build_parser(), cmd_devices(), cmd_history(), cmd_plan(), cmd_publish(), cmd_reindex(), cmd_results(), cmd_run() (+37 more)

### Community 104 - "load_answers"
Cohesion: 0.11
...
### Community 108 - "test_orchestrate.py"
Cohesion: 0.07
...
### Community 109 - "PgVectorProvider"
Cohesion: 0.06
...
### Community 110 - "test"
Cohesion: 0.04
Nodes (12): test, MOBILE, ROWS, UPSTREAM_ROW, NO_UPDATE, Indicator, LEGACY_LIVE_STATES, NPU (+4 more)

### Community 111 - "errors.py"
Cohesion: 0.04
Nodes (71): RequestValidationError, Request, Restart endpoint for bundled agents (v0.3 PR-11).  ``POST /api/agents/{agent_id}, Identify the caller for the audit log.      There is no Bearer token store (auth, Restart the systemd unit backing ``agent_id``.      Returns ``{status, detail}``, Resolve ``systemctl`` on PATH.      Returns ``None`` on hosts that don't have sy, Compose the unit name for an agent id.      Matches ``installer/systemd/hal0-age, Probe ``systemctl is-active hal0-agent@{agent_id}.service``.      The liveness h (+63 more)

### Community 112 - "HardwareInfo"
Cohesion: 0.07
Nodes (37): _flatten_for_ui(), Project HardwareInfo into the fields the Vue Hardware view expects.      The das, load_hardware_info(), Load /etc/hal0/hardware.json and return a validated HardwareInfo.      Returns t, Atomically write hardware.json.      Uses the same tmpfile+fsync+rename pattern, save_hardware_info(), HardwareInfo, NPUInfo (+29 more)

### Community 113 - "providers.py"
Cohesion: 0.09
Nodes (42): create_upstream(), delete_upstream(), get_upstream(), list_providers(), list_upstreams(), patch_upstream(), ProviderCredentialBody, ProviderCredentialError (+34 more)

### Community 114 - "test_setup_install.py"
Cohesion: 0.06
...
### Community 120 - "__init__.py"
Cohesion: 0.04
Nodes (48): ModelRegistry, Path, SlotManager, NpuConfig, [npu] table in a slot TOML — FLM trio modality toggles.      Maps to ``flm serve, ChangeSet, FileState, fold_ctx_size_alias() (+40 more)

### Community 121 - "BadRequest"
Cohesion: 0.04
Nodes (61): HttpFetcher, IPv4Address, IPv6Address, BadRequest, 400 — the request was syntactically or semantically invalid.      Use this for c, _coerce_int(), _default_fetcher(), _enforce_safe_url() (+53 more)

### Community 122 - "test_agent_install_hermes.py"
Cohesion: 0.05
...
### Community 123 - "hal0 rework plan — reader's copy"
Cohesion: 0.04
...
### Community 125 - "migrate_slot_toml"
Cohesion: 0.07
...
### Community 128 - "§21.4 `hal0 doctor` rework + support bundle — implementation spec"
Cohesion: 0.04
...
### Community 135 - "test_comfyui_proxy.py"
Cohesion: 0.15
...
### Community 136 - "test_providers_routes.py"
Cohesion: 0.10
...
### Community 137 - "test_board_chat_tool_use_e2e.py"
Cohesion: 0.13
Nodes (42): _collect(), _collect_with_payload(), _fake_request(), _fast_approval_wait(), _final(), _parse(), _persona_root(), Any (+34 more)

### Community 138 - "test_gpu_arbiter.py"
Cohesion: 0.06
Nodes (75): _base_configs(), _cancel_loop(), comfyui_http(), fake_mgr(), FakeManager, _fast_drain(), _img_mode_arbiter(), Any (+67 more)

### Community 139 - "SecurityPage.jsx"
Cohesion: 0.05
Nodes (50): ApiOptions, apiPut(), KeyTier, RequireAuthResponse, RotateKeyResponse, useLogout(), useRotateKey(), useSetRequireAuth() (+42 more)
...
### Community 142 - "slot_flags_fold.py"
Cohesion: 0.08
...
### Community 143 - "CapabilityOrchestrator"
Cohesion: 0.07
Nodes (23): Fire-and-forget trigger to refresh the Hermes live-context files.  Called from t, Spawn a detached ``hal0-agent <agent_id> render-context``. Never raises., spawn_context_refresh(), child_to_slot(), legal_children(), Any, CapabilitySelection, CapabilityOrchestrator — bridge between capability children and slots.  The dash (+15 more)

### Community 144 - "mcp.py"
Cohesion: 0.07
...
### Community 145 - "runner.py"
Cohesion: 0.08
Nodes (47): Cell, One planned unit of work: a fully-resolved identity + the suite context     the, _assemble(), _classify(), _clear_stale_sweep(), describe_worklist(), _friendly_gpu(), _get_json() (+39 more)
...
Cohesion: 0.03
Nodes (74): BaseModel, The supplied credential was rejected., Unauthorized, PersonaApprovalUpdate, Partial ``[persona.approval]`` patch. Omitted fields are unchanged., exposure(), ExposureAllowlistEntry, ExposureResponse (+66 more)

### Community 148 - "GPUMemorySample"
Cohesion: 0.09
...
### Community 149 - "_llama_launch_plan"
Cohesion: 0.06
...
### Community 151 - "test_auth_core.py"
Cohesion: 0.07
...
Cohesion: 0.11
Nodes (8): Hal0MemoryProvider, _hindsight_config_path(), Any, Hal0MemoryClient, Resolve ``<hermes_home>/hindsight/config.json`` (upstream layout).      ``hermes, REST-backed memory provider — wraps hal0-memory (private + shared banks)., Stable idempotency key so server-side dedup drops duplicate captures., One ranked, provenance-annotated bullet. Recalled text stays verbatim.

### Community 157 - "TestUpstreamEntry"
Cohesion: 0.07
...
### Community 159 - "RuntimeLaunchPlan"
Cohesion: 0.06
Nodes (32): HealthCheck, Provider abstract base class.  A Provider encapsulates the logic for a single in, A podman ``--health-*`` override for a slot container.      The toolbox images b, Return the ``--health-*`` podman-run flags in a stable order., Return the Podman Quadlet ``Health*=`` keys in a stable order.          The decl, Typed launch plan for a container-per-slot Quadlet unit.      Carries everything, # NOTE: unit rendering is owned by the single Quadlet adapter, RuntimeLaunchPlan (+24 more)

### Community 160 - "RoutingHost"
Cohesion: 0.08
...
### Community 161 - "agent_commands.py"
Cohesion: 0.06
Nodes (46): agent_log(), _agent_provision_state_file(), agent_reprovision(), agent_status(), agent_uninstall(), agent_upgrade(), _approval_summary(), bootstrap_hermes() (+38 more)
...
### Community 164 - "_resolve_llama_scalars"
Cohesion: 0.10
...
### Community 165 - "json"
Cohesion: 0.04
Nodes (25): json(), hermes(), IDLE_PRIMARY, mockAgents(), AuthOpts, installAuth(), LIVE_BOARD, HERMES_ACTORS (+17 more)

### Community 166 - "hal0 R5 live install-validation — findings (stamp r5v1)"
Cohesion: 0.05
...
### Community 167 - "§7.1d — Capability / Modality Taxonomy untangle (ML-6)"
Cohesion: 0.05
...
### Community 169 - "doctor_commands.py"
Cohesion: 0.07
...
### Community 172 - "test_model_fallback.py"
Cohesion: 0.10
...
### Community 173 - "test_chat_normalization.py"
Cohesion: 0.07
...
### Community 174 - "AgentMetadataConfig"
Cohesion: 0.12
...
### Community 176 - "test_hal0_provider_plugin.py"
Cohesion: 0.09
...
### Community 177 - "_write_fixture"
Cohesion: 0.13
Nodes (18): Unit tests for hal0.registry.detect.detect()., ROCmFPX-family quant detection (ciru-ai/ROCmFPX custom GGUF formats).      These, TestGgufChat, TestGgufEmbed, TestRocmfpxQuant, _build_gguf(), _enc_kv(), _enc_str() (+10 more)

### Community 178 - "Hal0MemoryProvider"
Cohesion: 0.08
...
### Community 179 - "FakeMemoryProvider"
Cohesion: 0.06
...
### Community 180 - "_write_diagnostics_section"
Cohesion: 0.10
...
### Community 181 - "install_openwebui"
Cohesion: 0.11
...
### Community 191 - "test_update_commands.py"
Cohesion: 0.07
...
### Community 192 - "hal0 — Official prerelease release channel"
Cohesion: 0.05
...
### Community 195 - "test_hermes_provision_idempotency.py"
Cohesion: 0.09
...
### Community 198 - "test_unit_files.py"
Cohesion: 0.05
...
### Community 202 - "R5 sync assessment — how far every surface is from "back in sync" (2026-07-19)"
Cohesion: 0.05
...
### Community 203 - "test_doctor_json_diagnoses.py"
Cohesion: 0.09
...
### Community 206 - "test_chat_proxy_auth.py"
Cohesion: 0.07
...
### Community 213 - "recommend_primary_slot"
Cohesion: 0.10
...
### Community 215 - "test_hindsight_provider.py"
Cohesion: 0.08
...
### Community 220 - "FakeSnap"
Cohesion: 0.06
Nodes (44): One ``[stack.<slug>]`` entry in stacks.toml.      A curated bundle of slots + em, StackConfig, StackCapabilityRow, FakeSnap, _no_seed_stacks(), MonkeyPatch, Shared recording fakes for the Stacks convergence tests.  Mirrors the FakeSlotMa, Isolate the engine unit tests from the shipped seed catalog (PR-6).      These t (+36 more)
...
### Community 222 - "test_openrouter_auth_loopback.py"
Cohesion: 0.09
...
### Community 224 - "test_mtp_override.py"
Cohesion: 0.09
...
### Community 225 - "test_model_meta.py"
Cohesion: 0.06
...
### Community 228 - "test_chat_templates.py"
Cohesion: 0.12
...
### Community 237 - "Persona"
Cohesion: 0.11
Nodes (36): activate(), build_prompt_addendum(), get_active(), hermes_reload(), list_personas(), load_persona(), Persona, PersonaApproval (+28 more)

### Community 238 - "resolve_role_slots"
Cohesion: 0.13
...
### Community 239 - "provision_comfyui_downloads"
Cohesion: 0.08
...
### Community 240 - "test_agent_uninstall_memory.py"
Cohesion: 0.12
...
### Community 241 - "orchestrate_models"
Cohesion: 0.09
...
### Community 242 - "hw_slot_ownership.py"
Cohesion: 0.11
Nodes (31): _apply_slot_fold(), apply_unfold_plan(), collect_inputs(), DeployWindowRequired, _ngl_set(), plan_unfold(), ProfileAction, Any (+23 more)

### Community 243 - "pve.py"
Cohesion: 0.09
...
### Community 244 - "test_route_to_chat.py"
Cohesion: 0.09
...
### Community 245 - "_resolve_image_ref"
Cohesion: 0.10
...
### Community 246 - "test_update_check.py"
Cohesion: 0.09
...
### Community 248 - "test_installer_routes.py"
Cohesion: 0.09
...
### Community 251 - "test_hf_token_secrets.py"
Cohesion: 0.06
...
### Community 252 - "test_v1_chat_slot_alias.py"
Cohesion: 0.13
...
### Community 254 - "test_slots_container_state.py"
Cohesion: 0.09
...
### Community 256 - "board-chat-v3.spec.ts"
Cohesion: 0.10
Nodes (13): emitSseTyped(), body(), engine(), pane(), NOTE: the old hero band (`.infer-hero-top`) was replaced by the telemetry, capturePuts(), captureDuplicate(), confirmBtn() (+5 more)

### Community 257 - "MemoryProvider"
Cohesion: 0.07
...
### Community 258 - "Hal0MemoryClient"
Cohesion: 0.12
Nodes (14): Hal0MemoryClient, Hal0MemoryClientError, Any, Client, Thin synchronous REST client for the hal0-memory REST surface.  Design notes: (1, POST /api/memory/add. ``private=True`` → hermes-private, else shared., POST /api/memory/search — semantic retrieval (union of both banks)., POST /api/memory/recall — token-budgeted consolidated recall (union). (+6 more)

### Community 259 - "benchmarks.py"
Cohesion: 0.09
Nodes (33): _api_base(), delete_queue(), get_cells(), get_events(), get_history(), get_plan(), get_queue(), get_run() (+25 more)

### Community 260 - "_shared.py"
Cohesion: 0.10
Nodes (30): board_move(), hal0 board subcommands — thin HTTP client to /api/board/* (§5.2).  A small opera, Move a task to a different lane (PATCH /api/board/tasks/{id})., Uninstall a user-installed MCP server. Bundled servers reject 409., uninstall_cmd(), _api_reachable(), api_delete(), api_get_bytes() (+22 more)

### Community 261 - "ModelsConfig"
Cohesion: 0.08
...
### Community 264 - "test_metrics_prometheus_route.py"
Cohesion: 0.09
...
### Community 270 - "browser_server.py"
Cohesion: 0.10
...
### Community 271 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.06
...
### Community 275 - "Hal0HermesClient"
Cohesion: 0.12
...
Cohesion: 0.08
Nodes (34): _comfyui_models_dir(), _final_path(), _final_path_for_entry(), pull_job_file(), _pull_jobs_dir(), _pull_root(), Strip path-unsafe characters from a model id.      The id is used as a directory, Return the configured pull destination root.      ML-3: thin delegator to :func: (+26 more)

### Community 280 - "build_request_metric_row"
Cohesion: 0.10
...
### Community 281 - "LlamaServerProvider"
Cohesion: 0.08
...
### Community 282 - "test_memory_admin_routes.py"
Cohesion: 0.17
...
### Community 283 - "test_brain_injection.py"
Cohesion: 0.17
...
### Community 284 - "test_crash_loop_breaker.py"
Cohesion: 0.15
...
### Community 286 - "Platform-wide cron/automation management — design"
Cohesion: 0.06
...
### Community 288 - "hal0 ROCmFPX quantization"
Cohesion: 0.06
...
### Community 289 - "write_toml_atomic"
Cohesion: 0.04
Nodes (64): OSError, config_validate(), Validate all config files against the current schema., ConfigError, ConfigNotFound, _drop_dead_keys(), _find_manifest_path(), _flatten_slot_toml() (+56 more)

### Community 290 - "test_board_chat_admin_tools.py"
Cohesion: 0.12
...
### Community 294 - "test_slot_migrate_id_keying.py"
Cohesion: 0.10
...
### Community 297 - "test_brain_resilience.py"
Cohesion: 0.16
...
### Community 298 - "test_admin_route_map_nested.py"
Cohesion: 0.10
...
### Community 300 - "ML-2 (file-set pulling) + ML-3 (unified store) — implementation spec"
Cohesion: 0.06
...
### Community 304 - "Table"
Cohesion: 0.16
Nodes (14): _fmt_size(), model_add(), model_assign(), model_pull(), model_register(), model_rm(), _poll_pull_progress(), hal0 model subcommands — thin HTTP client to the hal0 API. (+6 more)

### Community 305 - "repository.py"
Cohesion: 0.10
...
### Community 310 - "test_doctor_all.py"
Cohesion: 0.08
...
### Community 314 - "useLogs.ts"
Cohesion: 0.13
Nodes (19): _import_into(), import_toml_to_sqlite(), ImportReport, _load_toml_models(), Connection, Model, Path, One-shot, idempotent import: ``registry.toml`` → the SQLite ``model`` table.  Tw (+11 more)

### Community 315 - "KeyError"
Cohesion: 0.10
...
### Community 318 - "test_agents_personas.py"
Cohesion: 0.15
...
### Community 321 - "test_board_routes.py"
Cohesion: 0.10
...
### Community 322 - "test_uninstall.py"
Cohesion: 0.10
...
### Community 323 - "FakeUpstreamRegistry"
Cohesion: 0.12
...
### Community 324 - "test_bootstrap_prereq_parity.py"
Cohesion: 0.11
...
### Community 325 - "test_degrade_live.py"
Cohesion: 0.11
...
### Community 326 - "FakeContainerProvider"
Cohesion: 0.08
...
### Community 328 - "test_exposure.py"
Cohesion: 0.09
Nodes (30): BaseRoute, app_routes(), _classify_method(), _enumerate_routes(), _iter_effective(), FastAPI, MonkeyPatch, Path (+22 more)
...
### Community 331 - "P3-slots: Decomposition Spec for `slots/manager.py`"
Cohesion: 0.07
...
### Community 332 - "hal0_slot_alias_models"
Cohesion: 0.12
...
### Community 335 - "test_tts_capability_switch.py"
Cohesion: 0.12
...
### Community 336 - "test_diagnosis.py"
Cohesion: 0.09
...
### Community 339 - "test_npu_exclusivity.py"
Cohesion: 0.10
Nodes (30): NpuExclusivityViolation, Two ``device=npu, type=llm, enabled=true`` slots cannot coexist.      The AMDXDN, ConvergeReport, What converge() did, per slot. Failures are recorded, not raised., Path, NPU exclusivity validation in SlotManager (PR-11, plan §5.3, ADR-0008 §5).  The, The operator-facing text must describe the real remedy: clear the model., A model-less second NPU LLM slot may coexist with the bound anchor. (+22 more)

### Community 340 - "test_hal0_memory_client.py"
Cohesion: 0.10
...
### Community 341 - "test_config_urls.py"
Cohesion: 0.10
...
### Community 342 - "test_workflow_contract.py"
Cohesion: 0.15
...
### Community 343 - "test_hindsight_boot_probe.py"
Cohesion: 0.10
...
### Community 344 - "Tier 2 — medium (one PR each)"
Cohesion: 0.07
...
### Community 345 - "PART 0 — Current registry, mapped (file:line)"
Cohesion: 0.07
...
### Community 349 - "test_v1_audio.py"
Cohesion: 0.13
...
### Community 350 - "_container_npu_cfg"
Cohesion: 0.08
...
Cohesion: 0.07
Nodes (26): [0.9.2] — 2026-07-05, [0.9.4.1] — 2026-07-08, [0.9.5.1] — 2026-07-09, [0.9.5.2] — 2026-07-09, Added, Added, Breaking, Changed (+18 more)
...
### Community 355 - "Enum"
Cohesion: 0.09
Nodes (34): Enum, auth_require(), auth_rotate(), KeyTier, hal0 auth subcommands — thin HTTP client to /api/auth/*.  §5.2 of the R5 sync as, Persist the [security].require_auth posture (PUT /api/auth/require)., Rotate the admin or client box key (POST /api/auth/rotate).      Mints a fresh k, RequireToggle (+26 more)

### Community 356 - "installed.py"
Cohesion: 0.14
Nodes (25): get_installed(), _harden_registry_perms(), install(), InstalledServer, list_installed(), patch_config(), Any, Path (+17 more)

### Community 357 - "RequestSeam"
Cohesion: 0.19
...
### Community 360 - "test_agent_restart_endpoint.py"
Cohesion: 0.18
...
### Community 361 - "test_models_add_from_path.py"
Cohesion: 0.14
...
### Community 362 - "test_models_default.py"
Cohesion: 0.15
...
### Community 363 - "test_npu_occupancy.py"
Cohesion: 0.15
...
### Community 364 - "Path"
Cohesion: 0.07
Nodes (42): Path, TestClient, Regression: the slot-edit Save's ``PATCH /defaults`` must not wipe the     model, #585: the dashboard writes ``ctx_size``; it must persist as the canonical     ``, When the NPU LLM anchor has a model bound, every trio slot gets coresident_group, GET /api/slots/{name} is enriched same shape as the list endpoint., A failing container health probe doesn't break /api/slots.      The enrichment s, device=npu slots surface declared_backend='flm' (the FLM recipe). (+34 more)

### Community 365 - "test_stats_requests_route.py"
Cohesion: 0.13
Nodes (21): app(), _build_app(), client(), _FakeDispatcher, _FakeMetricsService, _FakeSingleFlight, _FakeWriter, _isolated_home() (+13 more)

### Community 366 - "test_upstream_dedup.py"
Cohesion: 0.11
...
### Community 370 - "test_slot_aliases.py"
Cohesion: 0.06
Nodes (31): hal0_chat_slot_alias_map(), Return ``{slot_alias: model_id}`` for model-bound llm slots.      The slot **ali, mock_slot_manager(), Path, Tests for the slot back-compat alias system (issue #654 / #633, ADR-0023).  ADR-, _resolve_alias("agent-hermes") == "agent" and the agent TOML exists., list() enumerates TOMLs from disk — no alias appears in the result., iter_configs() is driven by disk TOMLs — aliases never appear. (+23 more)
...
### Community 378 - "put_dashboard_layout"
Cohesion: 0.11
...
### Community 379 - "HermesBoardExecutor"
Cohesion: 0.15
...
### Community 380 - "upstream_commands.py"
Cohesion: 0.14
Nodes (16): advertise_upstream(), create_upstream(), credentials_set(), delete_upstream(), _filters_summary(), _print_json(), Any, hal0 upstream subcommands — thin HTTP client to the hal0 API.  Provides ``hal0 u (+8 more)

### Community 381 - "test_doctor_profiles.py"
Cohesion: 0.10
...
### Community 382 - "test_doctor_models.py"
Cohesion: 0.11
...
### Community 383 - "test_emit_answers.py"
Cohesion: 0.14
...
### Community 386 - "evaluate_model_fit"
Cohesion: 0.13
...
### Community 389 - "test_hermes_executor.py"
Cohesion: 0.18
...
### Community 390 - "test_agent_approvals_list.py"
Cohesion: 0.09
...
### Community 391 - "test_slot_create_flags.py"
Cohesion: 0.11
...
### Community 393 - "test_env_writer.py"
Cohesion: 0.13
...
### Community 394 - "test_comfyui_container_spec.py"
Cohesion: 0.11
...
### Community 397 - "test_id_keying.py"
Cohesion: 0.20
...
### Community 399 - "test_prewire_smoke.py"
Cohesion: 0.10
...
### Community 400 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 401 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 402 - "hal0 benchmarking system — full design (batch runs, rich run detail, display, auto-update)"
Cohesion: 0.08
...
### Community 405 - "read_gguf_header"
Cohesion: 0.18
...
### Community 406 - "migrate-haloai.py"
Cohesion: 0.16
Nodes (24): AllowEntry, build_model(), _build_parser(), _ensure_empty_or_force(), _hub_dirname(), load_allowlist(), main(), migrate() (+16 more)

### Community 407 - "Hal0MemoryClient"
Cohesion: 0.18
Nodes (8): Hal0MemoryClient, Any, POST /api/memory/add. ``private=True`` → hermes-private, else shared., POST /api/memory/search — semantic retrieval (union of both banks)., POST /api/memory/recall — token-budgeted consolidated recall (union)., GET /api/memory/list — page through stored items., POST /api/memory/delete — remove memory items by id., Synchronous REST client for hal0-memory.      Instantiated once per ``initialize
...
### Community 409 - "chat_commands.py"
Cohesion: 0.14
...
### Community 411 - "TestHal0Config"
Cohesion: 0.10
Nodes (19): lane_slot_pin(), preferred_slot(), Any, rank_slot_name(), Which slot a request actually asked for, and how to choose between slots (#1418), Record that this request resolved to the ``slot_name`` lane., The lane-pinned slot name for this request, or ``""``.      Never raises and nev, Selection key for one slot — lower sorts first.      ``(lane-miss, health-rank)` (+11 more)

### Community 412 - "probes.py"
Cohesion: 0.20
...
### Community 415 - "parse_text_tool_calls"
Cohesion: 0.13
...
### Community 416 - "test_dashboard_layout.py"
Cohesion: 0.11
...
### Community 417 - "test_logs_routes.py"
Cohesion: 0.11
...
### Community 418 - "test_v1_models_filters.py"
Cohesion: 0.20
...
### Community 421 - "test_seeds_data.py"
Cohesion: 0.08
...
### Community 422 - "test_memory_delete_auth.py"
Cohesion: 0.10
Nodes (25): armed_client(), memory_routes(), MonkeyPatch, TempPathFactory, TestClient, Issues #1024 / #1302 (1): the memory delete surface is ADMIN, provably.  #1024's, Not ADMIN-by-generic-prefix, and not ADMIN-by-silent-fallback.      ``match_rule, The threat the pinning exists for, simulated.      #1024's follow-up comment pro (+17 more)

### Community 423 - "hal0 installer"
Cohesion: 0.08
...
### Community 425 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.08
...
### Community 426 - "hal0 1.0 — Seeded profile rework"
Cohesion: 0.08
...
### Community 427 - "Hermes Python 3.12 Cross-Distro Installation Design"
Cohesion: 0.08
...
### Community 429 - "test_hermes_upgrade.py"
Cohesion: 0.20
...
### Community 430 - "resolved_command_for_slot"
Cohesion: 0.10
...
### Community 431 - "seed_static_slots"
Cohesion: 0.17
...
### Community 436 - "Any"
Cohesion: 0.11
Nodes (19): container_stub(), Any, #863: single-slot status includes argv drift without burdening list()., v0.1.x clients consuming /api/slots see every legacy key unchanged., PR-18: each entry carries ``type`` + ``model_default``.      The dashboard's per, Labels list is omitted (not empty) when the slot config has no     ``model.label, An explicit upstreams.toml entry for ``hal0`` survives startup unchanged.      O, Loading a slot with no TOML returns the typed slot.not_found envelope. (+11 more)
...
### Community 443 - "map_backend_to_device"
Cohesion: 0.13
...
### Community 444 - "test_hw_slot_ownership_migration.py"
Cohesion: 0.23
...
### Community 445 - "resolve_write_dataset"
Cohesion: 0.15
...
### Community 453 - "test_memory_subgraph.py"
Cohesion: 0.19
...
### Community 455 - "test_settings_models_store.py"
Cohesion: 0.17
...
### Community 457 - "test_unified_project_scope.py"
Cohesion: 0.17
...
### Community 458 - "Dashboard Overhaul — FROZEN DATA CONTRACT (v1)"
Cohesion: 0.09
...
### Community 463 - "test_tts_request_defaults.py"
Cohesion: 0.15
...
### Community 467 - "config_enrichment"
Cohesion: 0.21
...
### Community 468 - "_hermes_fakes.py"
Cohesion: 0.11
Nodes (19): apply_hermes_config_cli(), apply_kanban_db_init_cli(), _coerce(), _Completed, default_fake_slots(), Any, Shared test fakes for the hermes_provision config-set redesign.  ``apply_hermes_, Ready chat/agent/utility slots + an embed slot that must never alias. (+11 more)

### Community 469 - "test_hermes_env_seam.py"
Cohesion: 0.15
...
### Community 471 - "test_providers.py"
Cohesion: 0.14
...
### Community 472 - "test_services_page.py"
Cohesion: 0.14
...
### Community 473 - "test_v1_proxy.py"
Cohesion: 0.14
...
### Community 474 - "test_virtual_models.py"
Cohesion: 0.17
...
### Community 475 - "test_brain_framing.py"
Cohesion: 0.23
...
### Community 476 - "test_trio_status_inheritance.py"
Cohesion: 0.18
...
### Community 477 - "test_doctor_verify.py"
Cohesion: 0.12
...
### Community 478 - "test_bootstrap_cosign_fetch.py"
Cohesion: 0.21
...
### Community 482 - "test_seam_agent_units.py"
Cohesion: 0.10
...
### Community 485 - "P2-config: Collapse capabilities.toml double-bookkeeping"
Cohesion: 0.10
...
### Community 489 - "slots_config_dir"
Cohesion: 0.18
...
### Community 491 - "test_fetch_ws_g.py"
Cohesion: 0.14
...
### Community 494 - "migrate_slot_id_keying"
Cohesion: 0.17
...
### Community 495 - "read_stack_state"
Cohesion: 0.17
...
### Community 496 - "test_memory_admin_document_transfer.py"
Cohesion: 0.20
...
### Community 497 - "test_throughput_history.py"
Cohesion: 0.19
...
### Community 498 - "test_eligibility.py"
Cohesion: 0.10
...
### Community 499 - "test_model_less_capability_slot_is_not_woken"
Cohesion: 0.20
...
### Community 500 - "Security review — v1.0 auth surface (2026-05-21)"
Cohesion: 0.10
...
### Community 501 - "_write_fake_python"
Cohesion: 0.20
...
### Community 502 - "test_approval_queue.py"
Cohesion: 0.08
Nodes (29): mock_transport(), Any, MonkeyPatch, queue(), MCP admin coverage for the Stacks tools (PR-4).  The stack tools are REST passth, test_approved_stack_apply_posts_to_apply_url(), test_stack_apply_gates_for_approval(), test_stack_list_dispatches_get() (+21 more)

### Community 503 - "_CtxToken"
Cohesion: 0.12
...
### Community 504 - "test_manager_npu_container.py"
Cohesion: 0.20
...
### Community 506 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.10
...
### Community 510 - "_memory_subgraph.py"
Cohesion: 0.24
Nodes (14): adjacency(), _edge_ends(), ego_bfs(), GraphCache, induce_subgraph(), _neg_ts(), _nid(), Any (+6 more)

### Community 511 - "proxmox.py"
Cohesion: 0.12
Nodes (21): _FakeHttpClient, _FakeResponse, Any, Exception, Duck-typed stand-in for ``httpx.Response`` — no network involved., Duck-typed stand-in for ``httpx.Client`` — records calls, no sockets., test_client_add_omits_tags_and_metadata_when_none(), test_client_add_posts_expected_payload_and_headers() (+13 more)

### Community 512 - "run_verify"
Cohesion: 0.16
...
### Community 513 - "MemoryGraphConfig"
Cohesion: 0.14
...
### Community 514 - "StackModelMeta"
Cohesion: 0.10
Nodes (8): Transport-safe metadata subset of a registry ``Model``.      Embedded in a stack, StackModelMeta, Unit tests for the Stack schema models.  Targeted file run:     ~/dev/hal0/.venv, TestSeedStacks, TestStackCapabilityRow, TestStackConfig, TestStackModelMeta, TestStackSlotEntry

### Community 515 - "network.py"
Cohesion: 0.15
...
### Community 517 - "_reconcile_device_profile"
Cohesion: 0.20
...
### Community 521 - "_RecordingSlotManager"
Cohesion: 0.14
...
### Community 523 - "test_capabilities_commands.py"
Cohesion: 0.18
...
### Community 526 - "test_model_store_root.py"
Cohesion: 0.14
...
### Community 528 - "TestEarlyHal0User"
Cohesion: 0.10
...
### Community 530 - "test_fail_watcher.py"
Cohesion: 0.18
...
### Community 531 - "profiles-crud-v3.spec.ts"
Cohesion: 0.10
...
### Community 533 - "0. Research-grounded findings that drive the matrix"
Cohesion: 0.11
...
### Community 540 - "test_board_dispatch.py"
Cohesion: 0.22
...
### Community 541 - "build_admin_route_map"
Cohesion: 0.13
...
### Community 543 - "test_port_registry.py"
Cohesion: 0.23
...
### Community 545 - "test_settings_routes.py"
Cohesion: 0.15
...
### Community 548 - "test_npu_swap_status.py"
Cohesion: 0.40
...
### Community 549 - "test_pull_refcount_rows.py"
Cohesion: 0.20
...
### Community 550 - "test_store_concurrency.py"
Cohesion: 0.19
...
### Community 552 - "test_load_converges_config.py"
Cohesion: 0.24
...
### Community 553 - "test_agents_unit_liveness.py"
Cohesion: 0.21
...
### Community 554 - "hal0 architecture & reference"
Cohesion: 0.11
...
### Community 555 - "FakeDelegateRunner"
Cohesion: 0.16
...
### Community 556 - "2. Bugs (correctness — ordered by impact)"
Cohesion: 0.11
...
### Community 557 - "manage-slots.mdx"
Cohesion: 0.11
...
### Community 559 - "spec-kb23 — hal0-brain chat tool-tier, approval-gate & injection-resistance"
Cohesion: 0.11
...
### Community 560 - "hal0-admin tools"
Cohesion: 0.11
...
### Community 561 - "kokoro_server.py"
Cohesion: 0.14
...
### Community 564 - "ensure_podman_apparmor_usable"
Cohesion: 0.19
...
### Community 565 - "write_gateway_secrets_dropin"
Cohesion: 0.10
Nodes (22): _atomic_write(), _atomic_write_if_changed(), content_hash(), _detect_foreign_gateways(), _disable_honcho_hermes_host(), _gateway_dropin_body(), GatewayDropinResult, _privileged_systemctl() (+14 more)

### Community 566 - "ProgressCoalescer"
Cohesion: 0.14
...
### Community 573 - "fetch_npu_swap_status"
Cohesion: 0.22
...
### Community 576 - "unknown_slot_config_keys"
Cohesion: 0.12
Nodes (11): Hal0MemoryClientError, Client, Thin synchronous REST client for the hal0-memory REST surface.  Design notes: (1, Raised when a hal0-memory REST call fails.      Wraps the upstream status code +, _resolve_agent_id(), _resolve_base_url(), hal0-memory — Hermes ``MemoryProvider`` plugin (canonical, shipped source).  Imp, Plugin entry point — register the provider with the loader. (+3 more)

### Community 577 - "arbiter.py"
Cohesion: 0.12
...
### Community 578 - "test_hermes_security_deliverables.py"
Cohesion: 0.15
...
### Community 579 - "test_mcp_client.py"
Cohesion: 0.18
...
### Community 583 - "test_models_preview.py"
Cohesion: 0.19
...
### Community 591 - "FakeContainerProvider"
Cohesion: 0.15
...
### Community 592 - "FakeLocalBackend"
Cohesion: 0.17
...
### Community 593 - "test_logs_tail_redaction.py"
Cohesion: 0.11
...
### Community 594 - "test_curated_image_models.py"
Cohesion: 0.10
...
### Community 595 - "3. Proposed seed catalog (one per type)"
Cohesion: 0.12
...
### Community 596 - "Slot config — capabilities ↔ slots reconciliation"
Cohesion: 0.12
...
### Community 597 - "hal0 Adoption Candidates — Lemonade + ODS (combined)"
Cohesion: 0.12
...
### Community 598 - "spec-hp-realtime — OpenAI Realtime WebSocket endpoint for hal0"
Cohesion: 0.12
...
### Community 599 - "P3-schema — `config/schema.py` decomposition: implementation-ready spec"
Cohesion: 0.12
...
### Community 600 - "Prerelease Preview Pipeline Hardening"
Cohesion: 0.12
...
### Community 601 - "resolve_hermes_python"
Cohesion: 0.14
...
### Community 602 - "agents.py"
Cohesion: 0.19
Nodes (16): canonical_json(), cell_key(), Any, Plain-dict JSON shape for the store. ``outcome`` is flattened to its         str, Deterministic JSON: sorted keys, no insignificant whitespace. This is the     ca, The dedup/staleness key: ``sha256:`` + hex of the canonical-JSON identity     bl, _identity(), test_schema.py — cell_key stability, canonicalization, and the identity/host spl (+8 more)

### Community 603 - "test_install_apply.py"
Cohesion: 0.16
...
### Community 607 - "apply_extraction_slot"
Cohesion: 0.18
...
### Community 609 - "normalize_system_messages"
Cohesion: 0.18
...
### Community 612 - "metrics_collect.py"
Cohesion: 0.15
...
### Community 613 - "snapshot_live_stack"
Cohesion: 0.30
...
### Community 614 - "test_hermes_state_render.py"
Cohesion: 0.12
...
### Community 615 - "test_slots_routes.py"
Cohesion: 0.23
...
### Community 616 - "_StubSlotManager"
Cohesion: 0.26
...
### Community 617 - "test_cli_auth_streamtest.py"
Cohesion: 0.21
...
### Community 618 - "Findings from the 2026-05-16 hal0-test deep-probe round"
Cohesion: 0.12
...
### Community 619 - "DelegateTaskSpec"
Cohesion: 0.18
...
### Community 620 - "test_preflight_ports_own_service.py"
Cohesion: 0.29
...
### Community 621 - "agents-overview.jsx"
Cohesion: 0.20
...
### Community 622 - "test_npu_trio_shadow.py"
Cohesion: 0.17
...
### Community 623 - "test_ttft_samples.py"
Cohesion: 0.12
...
### Community 625 - "halo (LXC 150) — R3 deploy issues report"
Cohesion: 0.12
...
### Community 626 - "hal0_gpu_gate.py"
Cohesion: 0.16
...
### Community 627 - "qwen3tts_server.py"
Cohesion: 0.16
...
### Community 632 - "system_info_command.py"
Cohesion: 0.18
...
### Community 639 - "RecordingSlotArtifactOps"
Cohesion: 0.22
...
### Community 640 - "test_hermes_provision_install_artifacts.py"
Cohesion: 0.17
...
### Community 641 - "test_agents_routes.py"
Cohesion: 0.21
...
### Community 642 - "test_mcp_identity.py"
Cohesion: 0.18
...
### Community 643 - "test_pull_shutdown.py"
Cohesion: 0.17
...
### Community 644 - "test_catalog_backends.py"
Cohesion: 0.21
...
### Community 645 - "FakeDockerBackend"
Cohesion: 0.16
...
### Community 646 - "hal0 test harness — internal contributor guide"
Cohesion: 0.12
...
### Community 648 - "Model registry — registry, pulls, classification"
Cohesion: 0.13
...
### Community 649 - "Handoff: qwen3tts standalone → hal0-slot migration"
Cohesion: 0.13
...
### Community 650 - "Container Image System Overhaul"
Cohesion: 0.13
...
### Community 651 - "hal0 rework plan — de-scarring the launch"
Cohesion: 0.13
...
### Community 652 - "Handoff — brain + embed slot/agent cleanup on halo150"
Cohesion: 0.13
...
### Community 653 - "Handoff — γ-suite (chromium) persistently red on main (#1333)"
Cohesion: 0.13
...
### Community 654 - "Handoff — fold rework→main merge/meld/fix follow-ups into the R5 docs"
Cohesion: 0.13
...
### Community 655 - "Handoff — hal0 R5 endgame (paste-in brief for a new session)"
Cohesion: 0.13
...
### Community 656 - "Findings (O-series)"
Cohesion: 0.13
...
### Community 658 - "hal0 Hermes Integration Suite Design"
Cohesion: 0.13
...
### Community 659 - "PR #1330 CI Repair Design"
Cohesion: 0.13
...
### Community 661 - "test_route_collisions.py"
Cohesion: 0.19
...
### Community 663 - "upsert_env_value"
Cohesion: 0.21
...
### Community 664 - "create_chat_template"
Cohesion: 0.24
...
### Community 669 - "write_openwebui_env"
Cohesion: 0.18
...
### Community 672 - "test_hermes_provision_kanban_db_init.py"
Cohesion: 0.20
...
### Community 673 - "test_persona_update.py"
Cohesion: 0.25
...
### Community 675 - "test_brain_ctx_precheck.py"
Cohesion: 0.23
...
### Community 678 - "test_pool_bounds.py"
Cohesion: 0.15
...
### Community 680 - "test_api_restart_on_upgrade.py"
Cohesion: 0.28
...
### Community 681 - "test_admin_route_map.py"
Cohesion: 0.17
...
### Community 682 - "test_container_mmproj.py"
Cohesion: 0.31
...
### Community 683 - "test_release_check.py"
Cohesion: 0.37
...
### Community 684 - "test_device_profile_coherence.py"
Cohesion: 0.18
...
### Community 685 - "test_mtp_defuse.py"
Cohesion: 0.34
...
### Community 709 - "MetricsRetention"
Cohesion: 0.18
...
### Community 710 - "heal_missing_llm_type"
Cohesion: 0.20
...
### Community 711 - "provider_requires_model"
Cohesion: 0.22
...
### Community 712 - "test_hermes_provision_context.py"
Cohesion: 0.14
...
### Community 713 - "test_dashboard_layout_v3.py"
Cohesion: 0.22
...
### Community 715 - "test_middleware.py"
Cohesion: 0.21
...
### Community 716 - "test_services_health.py"
Cohesion: 0.27
...
### Community 717 - "test_brain_chat.py"
Cohesion: 0.23
...
### Community 718 - "test_auth_commands.py"
Cohesion: 0.23
...
### Community 719 - "test_memory_ops_commands.py"
Cohesion: 0.16
...
### Community 720 - "test_slot_verb_aliases.py"
Cohesion: 0.16
...
### Community 721 - "test_hal0_gpu_gate.py"
Cohesion: 0.22
...
### Community 722 - "test_image_pin.py"
Cohesion: 0.14
...
### Community 723 - "test_flm_store_link.py"
Cohesion: 0.26
...
### Community 725 - "test_reinstall_into_venv_does_not_pass_no_deps"
Cohesion: 0.20
...
### Community 726 - "test_adopted_slot_eviction.py"
Cohesion: 0.23
...
### Community 727 - "test_dispatchable_ready_set_single_source.py"
Cohesion: 0.14
...
### Community 728 - "test_restart_errored_slot.py"
Cohesion: 0.26
...
### Community 731 - "Contributor Covenant Code of Conduct"
Cohesion: 0.15
Nodes (12): 1. Correction, 2. Warning, 3. Temporary Ban, 4. Permanent Ban, Attribution, Contributor Covenant Code of Conduct, Enforcement, Enforcement Guidelines (+4 more)

### Community 732 - "3. Recommendation: how hal0 should support ONNX"
Cohesion: 0.15
...
### Community 733 - "Dispatch / runtime — routing, arbiter, lifecycle"
Cohesion: 0.15
...
### Community 736 - "pull-and-register-models.mdx"
Cohesion: 0.15
...
### Community 737 - "hal0 rework — handoff: single primary orchestrator (R3-B / R4 / R5 + finish line)"
Cohesion: 0.15
...
### Community 738 - "Changes Applied (then rolled back)"
Cohesion: 0.15
...
### Community 739 - "hal0 codebase map"
Cohesion: 0.15
...
### Community 740 - "hal0 service management"
Cohesion: 0.15
...
### Community 741 - "QueryStringScrubber"
Cohesion: 0.18
...
### Community 743 - "_instrument_streaming_throughput"
Cohesion: 0.15
...
### Community 750 - "rerender_slot_units"
Cohesion: 0.23
...
### Community 751 - "test_containers_apparmor.py"
Cohesion: 0.37
...
### Community 752 - "test_hermes_live_resolve_render.py"
Cohesion: 0.11
Nodes (22): _build_brain_profile_mcp_servers(), _build_config_overlay(), _mcp_memory_call(), _probe_mcp_server(), Ordered ``(dotted_key, value)`` overlay applied via ``hermes config set``., List the tools an MCP server advertises. Returns shape:     ``{"ok": bool, "tool, Call the hal0-memory surface. Returns ``{ok, result?, error?}``.      **Was** a, The hal0-owned MCP servers the hal0-brain profile is wired to.      Mirrors the (+14 more)

### Community 753 - "conftest.py"
Cohesion: 0.18
...
### Community 754 - "test_activity.py"
Cohesion: 0.31
...
### Community 755 - "test_activity_routes_instrumented.py"
Cohesion: 0.38
...
### Community 756 - "test_comfyui_fetch_route.py"
Cohesion: 0.15
...
### Community 757 - "test_events_fixes.py"
Cohesion: 0.19
...
### Community 771 - "Slot pin + drawer field-wiring audit — session handoff (2026-07-30)"
Cohesion: 0.17
...
### Community 772 - "Recently added endpoints"
Cohesion: 0.17
...
### Community 773 - "HW-slot-ownership — hardware sticks to slots, logical tune sticks to models"
Cohesion: 0.17
...
### Community 774 - "Design — 3-tier, deny-by-default, single classification source"
Cohesion: 0.17
...
### Community 775 - "hal0 UI/UX design brief — post-R3 surface rework"
Cohesion: 0.17
...
### Community 786 - "test_board_ws.py"
Cohesion: 0.32
...
### Community 787 - "test_agent_status.py"
Cohesion: 0.23
...
### Community 789 - "test_system_info.py"
Cohesion: 0.13
Nodes (12): Return the TTS slot profile a device selection implies.      The engine switch:, tts_profile_for_device(), Reject the merged selection if it's illegal against the catalog.          Two di, Infer the runtime profile implied by a capability selection.          The capabi, profile_name_for_fit(), Shared picker/apply profile-fit inference (device → runtime profile name).  Sing, Infer the runtime profile name implied by a picker/apply selection.      Keeps i, test_tts_profile_for_device_mapping() (+4 more)

### Community 790 - "test_comfyui_scripts_shipped.py"
Cohesion: 0.17
...
### Community 791 - "test_static_seeds.py"
Cohesion: 0.17
...
### Community 792 - "[Unreleased]"
Cohesion: 0.17
Nodes (12): Added, Added, Breaking, Changed, Fixed, Fixed, Fixed, Fixed (+4 more)

### Community 793 - "`hal0-setup.yaml` — headless answer-file spec (2026-07-05)"
Cohesion: 0.18
...
### Community 794 - "Findings → fixes, by tier"
Cohesion: 0.18
...
### Community 795 - "Handoff: model-pipeline plan — finish-out pass"
Cohesion: 0.18
...
### Community 796 - "Hal0 Upstream Controls — Epic Plan (2026-07-06)"
Cohesion: 0.18
...
### Community 797 - "capabilities-and-profiles.mdx"
Cohesion: 0.18
...
### Community 798 - "Admin tools (`/mcp/admin`)"
Cohesion: 0.18
...
### Community 799 - "providers-profiles-devices.mdx"
Cohesion: 0.18
...
### Community 800 - "slot-lifecycle.mdx"
Cohesion: 0.18
...
### Community 801 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
...
### Community 802 - "Both-boxes deploy-validation runbook — rework-R4-stage"
Cohesion: 0.18
...
### Community 803 - "P3-brain — Implementation-Ready Spec: hal0-brain as a first-class module"
Cohesion: 0.18
...
### Community 804 - "PART D — Edit plan (files, order, delegators/shims)"
Cohesion: 0.18
...
### Community 805 - "hal0 Hermes Plugin Suite — BUILD Spec (verified vs code @ `rework/descar`)"
Cohesion: 0.18
...
### Community 806 - "Hermes Agent official integration research for the hal0 rework"
Cohesion: 0.18
...
### Community 807 - "2. Proposed hal0 plugin suite"
Cohesion: 0.18
...
### Community 815 - "memory_commands.py"
Cohesion: 0.21
Nodes (11): _add_write_rows(), disable_cmd(), enable_cmd(), graph_disable_cmd(), hal0 memory subcommands — graph-extraction gate.  Mirrors the slot / model CLI s, Render the retain-pipeline rows for ``hal0 memory status`` (#1420)., Enable the memory subsystem (persists [memory].enabled=true)., Disable the memory subsystem (persists [memory].enabled=false). (+3 more)
...
### Community 818 - "test_hermes_provision_collect.py"
Cohesion: 0.25
...
### Community 819 - "test_config_model_roots.py"
Cohesion: 0.29
...
### Community 820 - "test_doctor_route.py"
Cohesion: 0.24
...
### Community 821 - "test_features_health.py"
Cohesion: 0.25
...
### Community 822 - "test_meta_enums.py"
Cohesion: 0.42
...
### Community 824 - "test_server_ab_helpers.py"
Cohesion: 0.22
...
### Community 825 - "test_board_commands.py"
Cohesion: 0.27
...
### Community 826 - "test_serve_bind_host.py"
Cohesion: 0.31
...
### Community 827 - "test_fetch_scripts.py"
Cohesion: 0.18
...
### Community 828 - "hal0 test-harness — findings"
Cohesion: 0.18
...
### Community 831 - "test_admin_stacks.py"
Cohesion: 0.18
...
### Community 832 - "test_api_wiring.py"
Cohesion: 0.24
...
### Community 834 - "test_npu_trio_reconcile.py"
Cohesion: 0.45
...
### Community 835 - "test_pin_semantics.py"
Cohesion: 0.18
...
### Community 839 - "7. Product-shaped reworks (from the six field notes)"
Cohesion: 0.20
...
### Community 840 - "FLAGS-own — llama.cpp flags stick to models; profiles become templates"
Cohesion: 0.20
...
### Community 841 - "hal0 SETTINGS rework — implementation-ready spec"
Cohesion: 0.20
...
### Community 842 - "Slot / Model / Profile / Flags / Image — reworked runtime model (R3)"
Cohesion: 0.20
...
### Community 843 - "Global Constraints"
Cohesion: 0.20
...
### Community 845 - "Dashboard Plugin JS Loading Internals"
Cohesion: 0.20
...
### Community 855 - "_normalize_chat_body"
Cohesion: 0.21
...
### Community 859 - "slot_migrate_caps"
Cohesion: 0.42
...
### Community 860 - "resolve_chat_template"
Cohesion: 0.27
...
### Community 863 - "collect_port_claims"
Cohesion: 0.29
...
### Community 865 - "TestStatusTelemetry"
Cohesion: 0.29
...
### Community 867 - "test_startup_slot_seed.py"
Cohesion: 0.24
...
### Community 869 - "test_catalog_npu_stt.py"
Cohesion: 0.27
...
### Community 870 - "test_shared_auth.py"
Cohesion: 0.33
...
### Community 872 - "test_validate_catalog.py"
Cohesion: 0.24
...
### Community 874 - "test_curated_pull_coords.py"
Cohesion: 0.12
...
### Community 875 - "_configure_project"
Cohesion: 0.56
...
### Community 878 - "memory-view-v3.spec.ts"
Cohesion: 0.18
...
### Community 882 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 883 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 884 - "ROCmFPX bench — RESULTS + next-session handoff (2026-07-05)"
Cohesion: 0.22
...
### Community 887 - "connect-clients.mdx"
Cohesion: 0.22
...
### Community 888 - "connect-external-providers.mdx"
Cohesion: 0.22
...
### Community 889 - "realtime-voice.mdx"
Cohesion: 0.22
...
### Community 890 - "openai-compat.mdx"
Cohesion: 0.22
...
### Community 891 - "slot-as-model.mdx"
Cohesion: 0.22
...
### Community 892 - "env-vars.mdx"
Cohesion: 0.22
Nodes (8): Install & update, Memory & MCP, Models & providers, Paths, Runtime, See also, Server, Services

### Community 893 - "Handoff prompt — hal0-brain / template / profile changes on lxc105 (hal0, 10.0.1.142)"
Cohesion: 0.22
...
### Community 894 - "PART B — Target: Quadlet `.container` per slot (and per companion)"
Cohesion: 0.22
...
### Community 895 - "Slot-pin-lifecycle — the operator pin is the residency control, and the only one"
Cohesion: 0.22
...
### Community 896 - "SWEEP inventory — the overlooked surface (R5 release-prep)"
Cohesion: 0.22
...
### Community 899 - "Hindsight pi Extension Design"
Cohesion: 0.22
...
### Community 900 - "Dashboard plugin "Could not load this plugin's script""
Cohesion: 0.22
...
### Community 901 - "Strix Halo Benchmark Harness (hal0)"
Cohesion: 0.22
...
### Community 908 - "migrate_cognee_to_hindsight_dryrun"
Cohesion: 0.25
...
### Community 909 - "MetricsAggregator"
Cohesion: 0.28
...
### Community 910 - "TestImageMismatch"
Cohesion: 0.33
...
### Community 911 - "test_hermes_stale_dropin_cleanup.py"
Cohesion: 0.47
...
### Community 913 - "isolated_client_with_root"
Cohesion: 0.33
...
### Community 915 - "TestHarnessConfig"
Cohesion: 0.22
...
### Community 916 - "test_catalog_flm_blacklist.py"
Cohesion: 0.28
...
### Community 917 - "test_config_show_edit_selector.py"
Cohesion: 0.50
...
### Community 919 - "test_slot_metrics_capacity.py"
Cohesion: 0.36
...
### Community 921 - "test_installer_slot_load_save_load_is_stable"
Cohesion: 0.22
Nodes (10): model_mount_roots(), model_store_root(), Resolve the model-store directory that slot containers bind-mount.      THIN SHI, Model-store roots a slot container must bind-mount, deduped.      The renderer h, bundled_templates_dir(), Path, hal0 chat-template library.  Bundled templates live under :data:`bundled_templat, Return the directory containing the package-bundled ``.jinja`` templates. (+2 more)

### Community 922 - "test_gp15_no_hermes.py"
Cohesion: 0.22
...
### Community 923 - "test_browser_server.py"
Cohesion: 0.25
...
### Community 924 - "TestContainerRuntimeProbe"
Cohesion: 0.22
...
### Community 926 - "test_halo143_reboot_no_split_brain"
Cohesion: 0.36
...
### Community 927 - "test_model_preferred_profile.py"
Cohesion: 0.50
...
### Community 930 - "useBannerStore.ts"
Cohesion: 0.22
Nodes (8): BANNER_CATALOG, BannerAction, BannerEntry, BannerKind, BannerScope, BannerState, CATALOG_BY_ID, useBannerStore

### Community 931 - "Local-session prompt: run the profile re-tune bench matrix and apply the results"
Cohesion: 0.25
...
### Community 935 - "generate-images.mdx"
Cohesion: 0.25
...
### Community 936 - "update-and-rollback.mdx"
Cohesion: 0.25
...
### Community 937 - "voice-stt-tts.mdx"
Cohesion: 0.25
...
### Community 939 - "paths-and-files.mdx"
Cohesion: 0.25
...
### Community 941 - "13. Observability & metrics baseline (ships in every box)"
Cohesion: 0.25
...
### Community 942 - "15. Hermes plugin — standalone repo + native update path"
Cohesion: 0.25
...
### Community 943 - "PART C — Coordination contracts (cross-lane seams)"
Cohesion: 0.25
...
### Community 944 - "halo143 deploy-validation runbook — rework-R3"
Cohesion: 0.25
...
### Community 945 - "Handoff — R5 Phase 4: deploy window → release cut (paste-in prompt)"
Cohesion: 0.25
...
### Community 946 - "mock-prod-gate verification (Phase 0 launch-blocker #3)"
Cohesion: 0.25
...
### Community 947 - "Podman on the hal0 slot substrate — findings & cleaner solutions"
Cohesion: 0.25
...
### Community 953 - "WorkspaceEscapeError"
Cohesion: 0.32
...
### Community 955 - "TASK_0002.md"
Cohesion: 0.25
Nodes (7): grill Q&A, phase timings, raw prompt, refined prompt, research, spec, verified tooling

### Community 956 - "fresh-test-ct.sh"
Cohesion: 0.50
Nodes (7): cleanup(), emit(), log(), PVE(), fresh-test-ct.sh script, SSH(), usage()

### Community 957 - "ToolNotPermittedError"
Cohesion: 0.18
Nodes (7): Write the ``store_blob`` + ``model_file`` accounting for a single-file     (or m, _register_installed_files(), Path, Resolved registry directory (override or paths.registry_dir())., Derived TOML export path.          ``registry.toml`` is no longer the source of, Resolved SQLite database path for this instance., Initialise the registry.          Args:             registry_dir: Kept for signa

### Community 958 - "hal0_chat_slot_alias_map"
Cohesion: 0.40
...
### Community 959 - "_settings_apply.py"
Cohesion: 0.29
...
### Community 960 - "resolve_default_image"
Cohesion: 0.20
...
### Community 961 - "screen_extra_args_json"
Cohesion: 0.20
...
### Community 963 - "test_auth_exposure_route.py"
Cohesion: 0.32
...
### Community 966 - "TestCpuCellEndToEnd"
Cohesion: 0.25
...
### Community 967 - "test_app_list_uninstall.py"
Cohesion: 0.36
...
### Community 968 - "test_cli_docs_parity.py"
Cohesion: 0.12
...
### Community 972 - "test_slot_enabled_removed.py"
Cohesion: 0.24
...
### Community 974 - "_BackendContract"
Cohesion: 0.25
...
### Community 977 - "test_store_on_change.py"
Cohesion: 0.39
...
### Community 978 - "test_slot_create_conflict.py"
Cohesion: 0.29
...
### Community 979 - "test_slot_schema.py"
Cohesion: 0.32
...
### Community 980 - "test_transition_guard.py"
Cohesion: 0.25
...
### Community 981 - "useTweaksStore.ts"
Cohesion: 0.29
Nodes (5): APPEARANCE_KEYS, DEFAULTS, TweaksState, TweaksStore, useTweaksStore

### Community 982 - "board-chat-tool-use-v3.spec.ts"
Cohesion: 0.29
Nodes (3): GATED_FRAMES, mockChat(), sse()

### Community 983 - "Concurrency & continuous-batching optimization plan"
Cohesion: 0.29
...
### Community 984 - "ROCmFPX exploratory bench — RESULTS (2026-07-05)"
Cohesion: 0.29
...
### Community 990 - "P3-perms: declarative OwnershipStore as the single ownership authority"
Cohesion: 0.29
...
### Community 991 - "PART B — Target: OwnershipStore default `service_user="hal0"`"
Cohesion: 0.29
...
### Community 992 - "PART C — The LOAD-BEARING contract: born-owned"
Cohesion: 0.29
...
### Community 993 - "PART 0 — EXACT MAP (file:line)"
Cohesion: 0.29
...
### Community 994 - "P3-quadlet: migrate slot + companion units to Podman Quadlet `.container`"
Cohesion: 0.29
...
### Community 995 - "PART A — Current scars (in plain English)"
Cohesion: 0.29
...
### Community 996 - "4. Delivery plan and gates"
Cohesion: 0.29
...
### Community 1000 - "Gateway connectivity quirks — hal0"
Cohesion: 0.29
...
### Community 1010 - "write_env_atomic"
Cohesion: 0.33
...
### Community 1012 - "isolated_client"
Cohesion: 0.31
...
### Community 1013 - "test_slot_logs_stream_redacts_secret_bearing_lines"
Cohesion: 0.33
...
### Community 1016 - "test_memory_mm_commands.py"
Cohesion: 0.29
Nodes (3): MonkeyPatch, Tests for ``hal0 memory mm {list,refresh,history}``., stub_api()

### Community 1017 - "test_slot_rename.py"
Cohesion: 0.33
...
### Community 1018 - "test_paths_stub.py"
Cohesion: 0.29
...
### Community 1019 - "_reject_privileged_systemctl"
Cohesion: 0.33
...
### Community 1020 - "test_voice_roundtrip.py"
Cohesion: 0.43
...
### Community 1021 - "10. Troubleshooting"
Cohesion: 0.29
...
### Community 1022 - "test_owui_pin_consistency.py"
Cohesion: 0.43
...
### Community 1023 - "test_extra_args_sanitize.py"
Cohesion: 0.38
...
### Community 1036 - "logs-and-activity.mdx"
Cohesion: 0.33
...
### Community 1041 - "24. Execution waves / rollout program (session 3, 2026-07-18)"
Cohesion: 0.33
...
### Community 1043 - "§4.4 addendum — MCP admin route-map autogen (the 3 gaps)"
Cohesion: 0.33
...
### Community 1044 - "Verification strategy"
Cohesion: 0.33
Nodes (6): Lifecycle and security, Live acceptance, Memory, Provider, Verification strategy, Voice

### Community 1045 - "Dashboard permission mismatch (root vs hal0)"
Cohesion: 0.33
...
### Community 1058 - "throughput_history"
Cohesion: 0.33
...
### Community 1061 - "_guess_capability"
Cohesion: 0.33
...
### Community 1062 - "ttft_samples.py"
Cohesion: 0.33
...
### Community 1063 - "avg_ttft_across"
Cohesion: 0.33
...
### Community 1064 - "samples_from_events"
Cohesion: 0.33
...
### Community 1065 - "test_activity_instrumentation.py"
Cohesion: 0.60
...
### Community 1066 - "test_models_catalogue.py"
Cohesion: 0.47
...
### Community 1070 - "test_now_iso.py"
Cohesion: 0.33
...
### Community 1071 - "test_curation_drift.py"
Cohesion: 0.40
...
### Community 1072 - "test_family_defaults_empty.py"
Cohesion: 0.33
...
### Community 1091 - "14. Kanban board — ownership inversion + security hardening"
Cohesion: 0.40
...
### Community 1092 - "16. Hermes Python library (`AIAgent`) for the brain — evaluated, rejected for core"
Cohesion: 0.40
...
### Community 1093 - "21.A Mapping table — every candidate by disposition"
Cohesion: 0.40
...
### Community 1094 - "8. SQLite adoption — setup plan"
Cohesion: 0.40
...
### Community 1095 - "PART A — Current-state map (the scars, in plain English)"
Cohesion: 0.40
...
### Community 1096 - "PART D — The one narrow privileged helper: `hal0-systemctl`"
Cohesion: 0.40
...
### Community 1097 - "PART G — Sequencing: P3-perms BEFORE hermes-provision slim and P3-quadlet"
Cohesion: 0.40
...
### Community 1098 - "PART 0 — Current-state map (the hand-rendered ExecStart scars, file:line)"
Cohesion: 0.40
...
### Community 1099 - "hal0-bench-autopilot"
Cohesion: 0.40
Nodes (4): Commands, hal0-bench-autopilot, Output, Regression Detection

### Community 1100 - "Architecture"
Cohesion: 0.40
Nodes (5): Architecture, Plugin API endpoint, Plugin discovery (server-side), Plugin rescan, Static asset serving

### Community 1101 - "profile-matrix.sh"
Cohesion: 0.70
Nodes (4): has_cell(), run_sweep(), profile-matrix.sh script, usage()

### Community 1102 - "hal0-systemctl"
Cohesion: 0.90
Nodes (4): hal0-systemctl script, die(), validate_agent_id(), validate_slot_id()

### Community 1103 - "10. Test strategy"
Cohesion: 0.20
Nodes (5): Tests for ``ModelCapabilities`` + the ``Model`` §7.1d field additions.  Covers:, test_model_capabilities_defaults_all_none(), test_model_capabilities_forbids_extra_fields(), test_model_capabilities_tri_state(), test_model_capability_flags_round_trips_through_model_dump()

### Community 1104 - "fork-pi-mono.sh"
Cohesion: 0.70
Nodes (4): die(), info(), fork-pi-mono.sh script, warn()

### Community 1105 - "NOTES — answers from the prototype session"
Cohesion: 0.40
...
### Community 1109 - "is_container_npu_cfg"
Cohesion: 0.14
...
### Community 1114 - "TestRenderCancel"
Cohesion: 0.40
...
### Community 1123 - "slot-edit-controls-v3.spec.ts"
Cohesion: 0.40
...
### Community 1125 - "[0.9.5.1] — 2026-07-09"
Cohesion: 0.24
Nodes (7): queryClient, installToastGlobal(), timers, Toast, ToastKind, ToastState, useToastStore

### Community 1126 - "[0.9.6.1] — 2026-07-11"
Cohesion: 0.50
Nodes (4): [0.9.6.1] — 2026-07-11, Added, Changed, Fixed

### Community 1127 - "[v0.8.3b1] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.3b1] — 2026-07-04

### Community 1128 - "[v0.8.2b3] — 2026-06-29"
Cohesion: 0.50
Nodes (4): Added, Docs, Fixed, [v0.8.2b3] — 2026-06-29

### Community 1129 - "[v0.8.0-beta.1] — 2026-06-21"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.0-beta.1] — 2026-06-21

### Community 1130 - "[v0.7.3-beta.2] — 2026-06-19"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.7.3-beta.2] — 2026-06-19

### Community 1131 - "[v0.5.1-alpha.1] — 2026-06-15"
Cohesion: 0.50
Nodes (4): Added, Changed, Removed, [v0.5.1-alpha.1] — 2026-06-15

### Community 1132 - "[v0.5.0-alpha.1] — 2026-06-14"
Cohesion: 0.50
Nodes (4): Added, Fixed, Internal, [v0.5.0-alpha.1] — 2026-06-14

### Community 1133 - "[v0.9.0] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.9.0] — 2026-07-04

### Community 1134 - "[v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)"
Cohesion: 0.50
Nodes (4): Internal contracts, Known follow-up, New / improved, [v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)

### Community 1135 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1136 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1137 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1138 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1139 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1140 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1141 - "hal0 docs"
Cohesion: 0.50
Nodes (3): `docs/internal/` — repo-only architecture docs, hal0 docs, Top-level `docs/*.mdx` — user docs

### Community 1142 - "streaming.mdx"
Cohesion: 0.50
Nodes (3): Client example, See also, Wire format

### Community 1143 - "11. Product reworks — round 2 (slot identity, ports, profile org)"
Cohesion: 0.50
...
### Community 1144 - "PART E — `hal0-api` User flip + UMask removal"
Cohesion: 0.50
...
### Community 1145 - "PART F — Edit plan (files, order, delegators/shims)"
Cohesion: 0.50
...
### Community 1146 - "PART H — Risks + capped verification"
Cohesion: 0.50
...
### Community 1147 - "PART E — Migration of running units (the live-box transition)"
Cohesion: 0.50
...
### Community 1148 - "PART F — Risks + capped verification"
Cohesion: 0.50
...
### Community 1160 - "test_destructive_ops_land_audit_rows"
Cohesion: 0.67
Nodes (4): _build_app_with_audit(), Any, FastAPI, test_destructive_ops_land_audit_rows()

### Community 1161 - "container_stub"
Cohesion: 0.33
...
### Community 1162 - "test_get_slot_includes_config_drift_when_requested"
Cohesion: 0.22
...
### Community 1163 - "test_store.py"
Cohesion: 0.25
Nodes (8): RuntimeError, apply_fold_plan(), DeployWindowRequired, FoldPlan, Result of :func:`plan_slot_flags_fold`., True when nothing was refused — safe to apply the whole plan., Raised when a write is attempted without the deploy-window ack., Apply a :class:`FoldPlan` to the model registry.      Args:         plan: the pl

### Community 1165 - "_delegate_fakes.py"
Cohesion: 0.50
...
### Community 1166 - "test_comfyui_path.py"
Cohesion: 0.50
...
### Community 1171 - "footer-health-tooltip-v3.spec.ts"
Cohesion: 0.31
...
### Community 1173 - "model-drawer-stamp-diverge-v3.spec.ts"
Cohesion: 0.28
...
### Community 1178 - "[0.9.2] — 2026-07-05"
Cohesion: 0.22
Nodes (8): get_catalog_entry(), list_catalog_ids(), Any, Catalog of well-known external AI providers.  _CATALOG is the built-in provider, Return a single catalog entry by id, or None if not found., Return all known catalog ids., Return a list of validation problems with the static catalog.      Empty list me, validate_catalog()

### Community 1179 - "[v0.8.5b2] — 2026-07-04"
Cohesion: 0.67
Nodes (3): Added, Fixed, [v0.8.5b2] — 2026-07-04

### Community 1180 - "[v0.8.2b2] — 2026-06-24"
Cohesion: 0.67
Nodes (3): Changed, Fixed, [v0.8.2b2] — 2026-06-24

### Community 1181 - "CLAUDE.md"
Cohesion: 0.29
Nodes (6): Agent skills, Domain docs, graphify, hindsight, Issue tracker, Triage labels

### Community 1202 - "_OtherEngineProvider"
Cohesion: 0.67
...
### Community 1213 - "memory-tools-v3.spec.ts"
Cohesion: 0.25
...
### Community 1214 - "notification-bell-v3.spec.ts"
Cohesion: 0.25
...
### Community 1215 - "runtimes-page-v3.spec.ts"
Cohesion: 0.25
Nodes (8): Delete stale ``*.part`` staging files left by SIGKILL/OOM mid-pull.      Best-ef, sweep_orphaned_partials(), Aged *.part files are reaped; fresh partials and installed files survive., No .tmp directory present → returns 0 and never raises (fail-soft)., A stale .part.json resume sidecar is reaped too, not left to linger., test_sweep_orphaned_partials_missing_tmp_dir_is_noop(), test_sweep_orphaned_partials_reaps_old_but_keeps_fresh_and_final(), test_sweep_orphaned_partials_reaps_stale_resume_sidecars()

### Community 1216 - "warm-color-tones.spec.ts"
Cohesion: 0.29
...
### Community 1351 - "imagegen-v2.spec.ts"
Cohesion: 0.60
Nodes (3): comfyV2Empty(), comfyV2Status(), gotoImageTab()

### Community 1352 - "[v0.8.4b1] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.4b1] — 2026-07-04

### Community 1353 - "get_executor"
Cohesion: 0.67
Nodes (4): get_executor(), MonkeyPatch, test_register_active_when_configured(), test_register_inert_without_config()

### Community 1354 - "[0.9.4] — 2026-07-08"
Cohesion: 0.67
Nodes (3): [0.9.4] — 2026-07-08, Added, Fixed

## Knowledge Gaps
- **3322 isolated node(s):** `runlog.sh script`, `rocmfpx-build.sh script`, `rocmfpx-env.sh script`, `rocmfpx-pipeline.sh script`, `rocmfpx-quantize.sh script` (+3317 more)
...
- **Why does `create_app()` connect `test_v1_npu_trio_routing.py` to `test_pull_shutdown.py`, `TestClient`, `create_app`, `FastAPI`, `test_hf_routes.py`, `test_stacks_routes.py`, `_RecordingSlotManager`, `conftest.py`, `ApprovalQueue`, `isolated_client_with_root`, `test_route_collisions.py`, `MemoryConfig`, `test_auth_core.py`, `test_installer_slot_load_save_load_is_stable`, `test_memory_admin_routes.py`, `redact_config`, `test_slots_policy.py`, `test_dashboard_layout.py`, `test_settings_routes.py`, `test_memory_delete_auth.py`, `__init__.py`, `test_admin_route_map_nested.py`, `test_updater_routes.py`, `_engine`, `test_config_model_roots.py`, `Any`, `test_kb1_hardening_tail.py`, `mcp_mount.py`, `TestClient`, `test_slots_image_pull.py`, `test_chat_proxy.py`, `capability-catalog-pickers-v3.spec.ts`, `test_models_routes.py`, `EventBus`, `_build`, `test_models_preview.py`, `test_dashboard_layout_v3.py`, `test_settings_models_store.py`, `test_exposure.py`, `test_slot_enabled_removed.py`, `hal0_slot_alias_models`, `test_chat_proxy_auth.py`, `test_tts_request_defaults.py`, `test_route_sync.py`, `auth.py`, `conftest.py`, `load_hal0_config`, `test_profiles_crud.py`, `test_typed_errors.py`, `test_typed_bodies.py`, `test_schema_seeds_c5.py`, `TestClient`, `test_startup_slot_seed.py`, `test_chat_templates.py`, `_StubSlotManager`, `test_models_add_from_path.py`, `test_models_default.py`, `test_pull_routes.py`, `test_cli_auth_streamtest.py`, `PgVectorProvider`, `redact_log_line`, `test_event_contract.py`, `conftest.py`, `test_comfyui_fetch_route.py`, `test_events_fixes.py`, `test_v1_chat_slot_alias.py`, `test_installer_routes.py`, `BootReport`, `test_auth_rotate.py`, `migrate_slot_toml`, `test_slots_container_state.py`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `SlotManager` connect `SlotManager` to `Slot`, `test_gpu_arbiter.py`, `SlotConfigError`, `Any`, `build_auto_selections`, `FLMProvider`, `SlotInterface`, `Dispatcher`, `test_model_preferred_profile.py`, `RoutingHost`, `_write_slot`, `test_load_converges_config.py`, `test_device_profile_coherence.py`, `UpstreamCall`, `test_model_fallback.py`, `GpuArbiter`, `test_mtp_defuse.py`, `FakeSlotManager`, `compute_config_drift`, `_write_slot`, `manager.py`, `test_npu_trio_reconcile.py`, `heal_missing_llm_type`, `FakeContainerProvider`, `test_slot_create_conflict.py`, `test_npu_exclusivity.py`, `test_transition_guard.py`, `test_adopted_slot_eviction.py`, `SlotIdentityStore`, `SlotStateRecord`, `test_pulling_serving_idle.py`, `agents-overview.jsx`, `test_npu_trio_shadow.py`, `Path`, `test_slot_aliases.py`, `test_manager_npu_container.py`, `.__init__`?**
  _High betweenness centrality (0.068) - this node is a cross-community bridge._
- **Why does `SlotState` connect `SlotStateRecord` to `Slot`, `SlotManager`, `test_metrics_prometheus_route.py`, `_RecordingSlotManager`, `SlotConfigError`, `_slot`, `serialize_slot`, `test_fail_watcher.py`, `SlotInterface`, `TestHal0Config`, `Dispatcher`, `test_crash_loop_breaker.py`, `test_npu_swap_status.py`, `UpstreamCall`, `GpuArbiter`, `container_enrichment`, `fetch_npu_swap_status`, `arbiter.py`, `test_backends_npu_canonical_fields.py`, `test_fail_watcher_warming.py`, `_FakeSM`, `SlotState`, `_RecordingSlotManager`, `test_npu_exclusivity.py`, `config_enrichment`, `_ArbiterSlotManager`, `StackApplyEngine`, `Any`, `FakeSnap`, `Enum`, `test_npu_occupancy.py`, `.__init__`?**
