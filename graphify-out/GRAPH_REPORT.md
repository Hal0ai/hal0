# Graph Report - A-chat-error-surfacing  (2026-07-30)

## Corpus Check
- 1615 files · ~2,042,090 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29280 nodes · 55705 edges · 1348 communities (1216 shown, 132 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 6871 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c101596a`
...
## Communities (1348 total, 132 thin omitted)

### Community 0 - "useSlots.ts"
Cohesion: 0.03
Nodes (128): ADR-0022, useModels(), usePullJob(), deviceBackend(), parseImageRef(), RunnerState, RuntimeRow, SystemInfo (+120 more)

### Community 1 - "SlotManager"
Cohesion: 0.02
Nodes (116): Return the current :class:`SlotState` for *name*.          Locked public interfa, Return ``True`` when *name* is in the dispatchable ready-set.          Ready set, See :meth:`hal0.slots.watchdog.SlotWatchdog._fail_watch_loop`., See :meth:`hal0.slots.watchdog.SlotWatchdog.probe_health`., See :meth:`hal0.slots.watchdog.SlotWatchdog.readiness_check`., Return snapshots for all configured slots, concurrently., See :func:`hal0.slots.routing.default_slot_for`., See :func:`hal0.slots.routing.route_for_request`. (+108 more)

### Community 2 - "UpstreamRegistry"
Cohesion: 0.03
...
### Community 3 - "test_hermes_provision.py"
Cohesion: 0.03
Nodes (124): InstallIO, Injectable IO seams :func:`install_hermes` touches.      Defaults bind the real, _Runner, fake_hermes_run(), A stand-in for ``subprocess.run`` that applies hermes config verbs., _brain_profile_state(), _build_overlay_keys(), install_target() (+116 more)
...
### Community 5 - "ConfigParseError"
Cohesion: 0.03
Nodes (135): ConfigParseError, A config file is present but contains invalid TOML or fails validation., Tag-based release-policy derivation — the single source of truth for classifying, Raised when a tag does not match any supported release pattern., Immutable policy derived from a parsed release tag., ReleasePolicy, ReleaseTagError, _atomic_symlink_swap() (+127 more)

### Community 6 - "test_updater.py"
Cohesion: 0.04
Nodes (138): _current_symlink(), Return ``<usr_lib>/hal0-<version>/`` — where this release's tree lives., Return ``<usr_lib>/current`` — the atomic-swap target., Atomic self-update with cosign-verified releases and one-step rollback.      All, Initialise the updater.          Args:             channel: Release channel — "s, Updater, _versioned_install_dir(), _build_release_tarball() (+130 more)

### Community 7 - "dashboard-redesign.jsx"
Cohesion: 0.03
Nodes (112): useActivityRecent(), CELL_DEFS, CELL_MAP, CellDef, CellId, DashLayout, DEFAULT_LAYOUT, LAYOUT_QUERY_KEY (+104 more)

### Community 8 - "ENDPOINTS"
Cohesion: 0.03
Nodes (122): apiDelete(), apiGet(), ApiOptions, apiPatch(), apiPut(), Hal0Error, serialiseBody(), ENDPOINTS (+114 more)

### Community 9 - "Path"
Cohesion: 0.03
Nodes (121): _active_persona_render(), _apply_config_set(), _atomic_write(), _atomic_write_if_changed(), _build_config_overlay(), cleanup_stale_agent_dropins(), _collect_capability_rollup(), _collect_chat_slots() (+113 more)

### Community 10 - "hermes_provision.py"
Cohesion: 0.03
Nodes (119): ApiServerKeyResult, bootstrap_cli(), BootstrapState, _brain_profile_config_path(), _build_brain_identity_card(), _build_brain_profile_mcp_servers(), _build_identity_card(), ensure_gateway_api_server_key() (+111 more)
...
### Community 12 - "model-modals.jsx"
Cohesion: 0.05
Nodes (85): ChatTemplate, useChatTemplates(), useMeta(), useMetaEnums(), useAddModelFromPath(), useModelDuplicate(), useModelInspect(), useModelSetDefault() (+77 more)

### Community 13 - "die"
Cohesion: 0.05
Nodes (98): agent_install(), agent_peers(), approvals_approve(), approvals_deny(), _install_hermes(), Approve a pending agent action., Deny a pending agent action., List discoverable agent identity cards.      Thin wrapper over ``memory_search`` (+90 more)

### Community 14 - "connect"
Cohesion: 0.04
Nodes (60): _QueueItem, Path, connect(), db_path(), Connection, Path, SQLite connection + transaction helpers — the hal0 ``db/`` foundation.  One conn, Wrap a write in an explicit ``BEGIN IMMEDIATE`` … ``COMMIT``/``ROLLBACK``. (+52 more)

### Community 15 - "SlotConfigError"
Cohesion: 0.04
Nodes (69): The model registry could not be consulted (outage, not a miss).      Raised by t, RegistryUnavailableError, admit(), CandidateSlot, _estimate_incoming_footprint_mb(), EvictionStep, _gather_candidates(), PreloadEvictHost (+61 more)

### Community 16 - "FLMProvider"
Cohesion: 0.04
...
### Community 17 - "SettingsShell.jsx"
Cohesion: 0.05
Nodes (75): useBackends(), useCapabilities(), useCapabilityApply(), useNpuOccupancy(), useServiceRepair(), APPLY_PLAN_KEY, ApplyPlanEntry, ApplyPlanRegistry (+67 more)
...
### Community 19 - "SqliteModelRegistry"
Cohesion: 0.04
...
### Community 20 - "Model"
Cohesion: 0.05
Nodes (46): Reconstruct a ``Model`` from one `model` table row.      ``backends`` comes from, row_to_model(), _derive_ns(), Model, ModelCapabilities, ModelDefaults, Model — registry entry pydantic model.  The Model class is the typed representat, A model entry in the hal0 registry.      All fields are optional at construction (+38 more)

### Community 21 - "Dispatcher"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (80): useApproveApproval(), useDenyApproval(), useMemoryEnabled(), AddFromPathRequest, fmtBytes(), fmtEta(), fmtSpeed(), HfSearchResponse (+72 more)
...
Cohesion: 0.04
Nodes (85): ApprovalQueue, Async-safe pending-approval queue with dedup + SSE fan-out.      One instance pe, _policy(), Any, queue(), Unit tests for :mod:`hal0.mcp.admin` tool catalog + dispatch.  * Tool registrati, EXCLUDED_TOOLS documents deliberate non-exposure (tier b, §4.3) —     a label la, Diagnosis #8: a single-id delete stays autonomous with no dataset or     a known (+77 more)

### Community 27 - "ContainerProvider"
Cohesion: 0.04
...
### Community 28 - "ProfileCatalog"
Cohesion: 0.04
Nodes (65): RuntimeFamily, SlotType, create_profile(), delete_profile(), export_profile(), get_profile(), import_profile_route(), list_profiles() (+57 more)

### Community 29 - "test_migrate_model_layout.py"
Cohesion: 0.06
...
### Community 35 - "useBoard.ts"
Cohesion: 0.06
Nodes (77): apiPost(), readErrorEnvelope(), normaliseActor(), normaliseAssignee, normaliseProfile, pickName(), BoardAssignee, BoardConfig (+69 more)
...
### Community 37 - "load_slot_config"
Cohesion: 0.04
Nodes (59): ConfigNotFound, _flatten_slot_toml(), load_slot_config(), load_slot_config_by_id(), Load and validate /etc/hal0/slots/<slot_name>.toml.      The on-disk shape (per, Load and validate an id-keyed slot TOML (``slots/<slot_id>.toml``).      The id-, Atomically write a slot config TOML.      The pydantic SlotConfig is flat; we re, Normalise both slot-TOML shapes into the flat SlotConfig shape.      Two on-disk (+51 more)
...
### Community 40 - "primitives.jsx"
Cohesion: 0.04
Nodes (54): useComfyui(), bundleNameOr(), InstallState, InstallStateBundle, useInstallState(), DEMO_MIGRATION_REPORT, EMPTY_MIGRATION_REPORT, MigrationFlagConflict (+46 more)

### Community 41 - "UpstreamCall"
Cohesion: 0.04
Nodes (55): lane_slot_pin(), preferred_slot(), Any, rank_slot_name(), Which slot a request actually asked for, and how to choose between slots (#1418), Record that this request resolved to the ``slot_name`` lane., The lane-pinned slot name for this request, or ``""``.      Never raises and nev, Selection key for one slot — lower sorts first.      ``(lane-miss, health-rank)` (+47 more)

### Community 42 - "test_updater_routes.py"
Cohesion: 0.05
...
### Community 43 - "resolve_by_capability"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (33): ModelAlreadyExists, ModelNotFound, Base error for registry operations., The requested model id is not in the registry., add() called but the model id is already present., RegistryError, test_duplicate_unknown_source_raises(), _model() (+25 more)
...
### Community 46 - "pull.py"
Cohesion: 0.05
Nodes (69): NamedTuple, FileSetEntry, FileSetPlan, One file of a planned file-set, ready for ``model_file`` insertion., The full set of files one model pull should download + register., _dir_size(), _discard_partial(), _download_one() (+61 more)

### Community 47 - "AgentManager"
Cohesion: 0.07
...
### Community 50 - "AgentMCPClient"
Cohesion: 0.05
Nodes (37): ClassificationLiteral, Exception, AgentMCPClient, classify_many(), AgentConfig, Path, MCP client surface for bundled agents.  Reads ``/etc/hal0/agents/<name>.toml``,, Load + validate the on-disk TOML, return a ready client. (+29 more)
...
### Community 53 - "test_board_chat.py"
Cohesion: 0.12
Nodes (60): _FakeRequest, _final_response(), _make_app(), _multi_tool_response(), _PlatformRecorder, Any, Tests for the board chat orchestrator — src/hal0/api/routes/board_chat.py.  The, Like _Recorder but for hal0-api's OWN routes (no kanban prefix). (+52 more)

### Community 54 - "planner.py"
Cohesion: 0.06
...
### Community 55 - "doctor_commands.py"
Cohesion: 0.05
Nodes (68): check_hermes_ownership(), check_tree_group_share(), _dangling_registry_entries(), _deepest_mountpoint(), detect_editable_root(), doctor_models(), flm_mount_guard(), flm_store_divergence() (+60 more)

### Community 56 - "_spec_provider_for"
Cohesion: 0.04
...
### Community 62 - "test_argv.py"
Cohesion: 0.05
Nodes (65): Reject hal0-owned flags in a profile's freeform ``flags`` text.      spec-hw-slo, _screen_profile_flags(), _canon(), _dedup(), _deny_managed_flags(), _deny_slot_hardware_flags(), FlagProvenance, _is_flag() (+57 more)

### Community 63 - "RuntimeLaunchPlan"
Cohesion: 0.05
...
Cohesion: 0.03
Nodes (38): ActivityConfig, AgentConfig, DispatcherConfig, MetaConfig, Pydantic v2 schema models for hal0 configuration.  All TOML files under /etc/hal, # NOTE: ``map_backend_to_device`` now lives in ``hal0.model_meta`` (imported, One (slot, child) capability selection carried by a stack slot entry.      Mirro, One slot's contribution to a stack: which model/profile/caps it carries.      Re (+30 more)
...
### Community 66 - "load_profiles_config"
Cohesion: 0.05
Nodes (33): load_profiles_config(), Load and validate /etc/hal0/profiles.toml.      Returns a :class:`ProfilesConfig, Strip hal0-managed flags (§21.7) from non-seed profiles, healing disk.      Olde, _sanitize_custom_profile_flags(), ProfilesConfig, Parsed profiles.toml — top-level ``[profile]`` table.      Each key under ``[pro, Path, Tests for save_profiles_config — round-trip + atomicity.  Targeted file run: (+25 more)

### Community 67 - "test_mcp_routes.py"
Cohesion: 0.06
Nodes (58): app(), _build_app(), client(), _FakeAnn, _FakeMcpServer, _FakeTool, _filesystem_manifest_dict(), Any (+50 more)

### Community 68 - "test_models_routes.py"
Cohesion: 0.06
Nodes (64): _hf_handler(), inspect_app(), inspect_client(), _patch_httpx_transport(), Any, Exception, FastAPI, MonkeyPatch (+56 more)

### Community 69 - "useLogs.ts"
Cohesion: 0.04
...
### Community 73 - "HindsightProvider"
Cohesion: 0.06
Nodes (33): _agent_of(), bank_to_namespace(), HindsightProvider, _http_status(), namespace_to_bank(), _now(), _projects_of(), Any (+25 more)
...
### Community 75 - "_RecordingSlotManager"
Cohesion: 0.08
...
### Community 77 - "get_doctor"
Cohesion: 0.04
Nodes (48): DiagnosisOut, DoctorResponse, EvidenceOut, get_doctor(), NextStepOut, Diagnosis, Request, T (+40 more)

### Community 78 - "SlotState"
Cohesion: 0.06
Nodes (35): See :meth:`hal0.slots.watchdog.SlotWatchdog.update`., is_dispatchable_state(), Return True when *state* is in the dispatchable ready-set.      Accepts a :class, Rank a slot state for candidate selection — lower is more preferred.      Accept, Lifecycle states for a hal0 inference slot.      Each value is also its JSON/SSE, slot_selection_rank(), SlotState, _container_upstream() (+27 more)

### Community 79 - "StackApplyEngine"
Cohesion: 0.07
Nodes (35): NpuExclusivityViolation, Two ``device=npu, type=llm, enabled=true`` slots cannot coexist.      The AMDXDN, ConvergeReport, Any, Path, StackSlotEntry, StackApplyEngine — translate a StackConfig into an atomic slot-config change.  P, What converge() did, per slot. Failures are recorded, not raised. (+27 more)

### Community 80 - "_ArbiterSlotManager"
Cohesion: 0.07
...
Cohesion: 0.05
Nodes (59): add_model_from_path(), check_model_updates(), create_model(), delete_model(), delete_pull(), duplicate_model(), _DuplicateModelBody, get_model() (+51 more)

### Community 82 - "load_capabilities_config"
Cohesion: 0.07
Nodes (45): auto_migrate_capabilities_file(), capabilities_toml_path(), capabilities_toml_payload(), capabilities_v1_backup_path(), CapabilityConfig, load_capabilities_config(), Path, Pydantic models + atomic read/write for ``/etc/hal0/capabilities.toml``.  The ov (+37 more)

### Community 83 - "FakeSlotManager"
Cohesion: 0.07
...
### Community 84 - "resolve_profile_flags"
Cohesion: 0.08
Nodes (31): Return the full flag string for *profile*, expanding MTP when set.      When the, resolve_profile_flags(), _exec_line(), _moe_profile(), _mtp_profile(), Unit tests for ``hal0.providers.container.ContainerProvider``.  Issue #655 — tra, Return the ``Exec=`` value (the in-container argv) from Quadlet unit text., halo150/143 O8+O11: ONE render for every substrate — no version branch.      Nat (+23 more)

### Community 85 - "_client"
Cohesion: 0.08
...
### Community 86 - "models_service.py"
Cohesion: 0.06
...
### Community 94 - "comfyui-pane.jsx"
Cohesion: 0.05
Nodes (43): ComfyuiArbiter, ComfyuiEngineState, ComfyuiMemory, ComfyuiMode, ComfyuiStatus, ComfyuiSwitchover, ComfyuiV2PaneData, ComfyuiV2QueueJob (+35 more)

### Community 95 - "TomlModelRegistry"
Cohesion: 0.07
...
### Community 97 - "api_get"
Cohesion: 0.05
Nodes (51): agent_list(), List installed bundled agents., auth_status(), Show the current auth posture (GET /api/auth/status)., board_list(), board_show(), hal0 board subcommands — thin HTTP client to /api/board/* (§5.2).  A small opera, List tasks by lane (GET /api/board/board). (+43 more)

### Community 98 - "make_slot"
Cohesion: 0.11
...
### Community 103 - "Any"
Cohesion: 0.05
Nodes (46): _artefact_token(), _best_effort_model_info(), _binary_runner(), _container_runtime(), _effective_backend_and_device_class(), _effective_parallel(), _effective_runner(), _native_ctx() (+38 more)

### Community 104 - "pull_jobs.py"
Cohesion: 0.07
Nodes (54): build_stream_response(), cancel(), delete(), emit_terminal_pull_event(), enqueue(), enqueue_update(), eta_s(), list_all() (+46 more)

### Community 105 - "test"
Cohesion: 0.04
Nodes (17): test, MOBILE, CURATED, ROWS, UPSTREAM_ROW, NPU_SERVING_SLOT, SECTIONS, ADR-0012 (+9 more)

### Community 106 - "test_redact.py"
Cohesion: 0.05
...
### Community 107 - "HardwareInfo"
Cohesion: 0.07
Nodes (44): _flatten_for_ui(), Project HardwareInfo into the fields the Vue Hardware view expects.      The das, HardwareInfo, NPUInfo, One detected NPU (AMD XDNA / future vendors)., Pydantic model for /etc/hal0/hardware.json.      Written by `hal0 probe` (hal0.h, Async wrapper that runs probe() in a threadpool executor., _is_coder() (+36 more)
...
### Community 113 - "test_setup_install.py"
Cohesion: 0.06
...
### Community 118 - "test_hermes_provision_idempotency.py"
Cohesion: 0.07
Nodes (48): apply_hermes_config_cli(), apply_kanban_db_init_cli(), _coerce(), default_fake_slots(), install_io(), Any, Shared test fakes for the hermes_provision config-set redesign.  ``apply_hermes_, Redirect every host path constant under ``tmp_path``; return (home, venv). (+40 more)

### Community 119 - "test_agent_install_hermes.py"
Cohesion: 0.05
...
### Community 120 - "hal0 rework plan — reader's copy"
Cohesion: 0.04
...
### Community 121 - "agent_commands.py"
Cohesion: 0.05
Nodes (48): agent_log(), _agent_provision_state_file(), agent_reprovision(), agent_status(), agent_uninstall(), agent_upgrade(), _approval_summary(), approvals_list() (+40 more)

### Community 122 - "migrate_slot_toml"
Cohesion: 0.07
...
### Community 123 - "NpuTrioRouter"
Cohesion: 0.08
Nodes (48): NpuTrioRouter, Resolves the npu container's static port and dispatches STT/embed to it.      He, _mock_transport(), Any, AsyncClient, NpuTrioRouter: container-only static-port dispatch (Phase E).  Covers:   - ready, SERVING (inference in flight) still resolves — a concurrent STT/embed     reques, IDLE npu container → static port.      IDLE = "warm but quiet" (no in-flight inf (+40 more)

### Community 124 - "get_runner"
Cohesion: 0.07
Nodes (39): Return the FLM toolbox image reference.          Resolution (§7.1b / ML-4): ``sl, Return the Kokoro toolbox image reference.          Resolution (§7.1b / ML-4): `, Return the Qwen3-TTS toolbox image reference.          Resolution (§7.1b / ML-4), get_runner(), RUNNER_IMAGES — the runner-image registry (plan §7.1b / ML-4).  Before this modu, Look up a runner by key, or raise :class:`~hal0.errors.NotFound`., Resolve ``runner`` to a pull-ready image ref.      Precedence: ``HAL0_TOOLBOX_IM, The HW-gated llama-server runner for a ``(backend, device_class)`` pair.      Re (+31 more)

### Community 125 - "json"
Cohesion: 0.05
Nodes (23): json(), AuthOpts, installAuth(), LIVE_BOARD, HERMES_ACTORS, MOCK_MCP_SERVERS, routeHistory(), comfyV2Empty() (+15 more)

### Community 126 - "Glossary"
Cohesion: 0.04
...
### Community 127 - "§21.4 `hal0 doctor` rework + support bundle — implementation spec"
Cohesion: 0.04
...
### Community 132 - "install_openwebui"
Cohesion: 0.06
...
### Community 135 - "test_auth_core.py"
Cohesion: 0.07
Nodes (41): auth_client(), isolate_secret(), MonkeyPatch, Path, Unit tests for hal0.api.auth (KB-1 / §1): principal resolution + posture.  Cover, Priority is cookie -> bearer -> api_key; a valid cookie wins outright., ``resolve_principal_from_scope`` unwraps a Request/WebSocket-like object., Configuring a key no longer arms enforcement — explicit-enable only. (+33 more)

### Community 136 - "test_comfyui_proxy.py"
Cohesion: 0.15
...
### Community 137 - "test_providers_routes.py"
Cohesion: 0.12
...
### Community 138 - "PART 0 — current-state map of scattered metrics (file:line)"
Cohesion: 0.04
...
### Community 140 - "slot_flags_fold.py"
Cohesion: 0.06
...
### Community 141 - "CapabilitySelection"
Cohesion: 0.06
Nodes (30): Fire-and-forget trigger to refresh the Hermes live-context files.  Called from t, Spawn a detached ``hal0-agent <agent_id> render-context``. Never raises., spawn_context_refresh(), CapabilitySelection, One operator-facing selection for a (slot, child) tuple.      Mirrors the dashbo, CapabilityApplyFailed, child_to_slot(), legal_children() (+22 more)

### Community 142 - "mcp.py"
Cohesion: 0.07
...
### Community 144 - "admin.py"
Cohesion: 0.07
Nodes (43): _audit(), build_server(), _call_rest(), _declared_path_args(), dispatch(), _execute_tool(), _format_url(), is_gated() (+35 more)
...
### Community 152 - "test_profile_derive.py"
Cohesion: 0.08
Nodes (44): derive_device(), derive_profile(), npu_healthy(), npu_takes_utility(), Auto-derive a slot's device + profile from the hardware probe (design D4).  Maps, Return a ``SEED_PROFILES`` name for a (capability, device) pair.      Reads the, True only when the NPU is present AND functionally healthy.      "Healthy" means, True when the NPU claims the ``utility`` role on this box.      When True, the f (+36 more)

### Community 153 - "test_board_chat_tool_use_e2e.py"
Cohesion: 0.14
Nodes (40): _collect(), _collect_with_payload(), _fake_request(), _fast_approval_wait(), _final(), _parse(), Any, E2E tests for the sidebar Brain's tool-use loop (2026-07-11 hardening).  Pins th (+32 more)

### Community 154 - "evalrun.py"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (41): build_auto_selections(), _build_offline_deps(), _confirm(), _existing_slot_names(), _prompt(), Console, `hal0 setup` — first-run configuration TUI (spec §6).  Hybrid execution: in-proc, Apply the auto-selected config. Routes hybrid (in-process at install     time wh (+33 more)

### Community 156 - "AgentMetadataConfig"
Cohesion: 0.06
...
### Community 158 - "slot_instance_token"
Cohesion: 0.06
...
### Community 159 - "hal0 R5 live install-validation — findings (stamp r5v1)"
Cohesion: 0.05
...
### Community 160 - "§7.1d — Capability / Modality Taxonomy untangle (ML-6)"
Cohesion: 0.05
...
### Community 168 - "SecurityPage.jsx"
Cohesion: 0.08
Nodes (32): KeyTier, RequireAuthResponse, RotateKeyResponse, useLogout(), useRotateKey(), useSetRequireAuth(), useAuthExposure(), AuthStatus (+24 more)
...
### Community 170 - "loader.py"
Cohesion: 0.07
Nodes (34): config_validate(), Validate all config files against the current schema., ConfigError, _find_manifest_path(), list_agent_configs(), load_agent_config(), load_hardware_info(), load_upstreams_config() (+26 more)
...
### Community 172 - "apiMock.ts"
Cohesion: 0.08
Nodes (18): Fixtures, installDefaultMocks(), MockState, BOARD_ASSIGNEES, BOARD_BOARDS, BOARD_CONFIG, BOARD_ORCH_DEFAULT, BOARD_PROFILES (+10 more)
...
### Community 175 - "Persona"
Cohesion: 0.11
Nodes (39): activate(), build_prompt_addendum(), get_active(), hermes_reload(), list_personas(), load_persona(), Persona, PersonaApproval (+31 more)

### Community 176 - "stacks.jsx"
Cohesion: 0.09
Nodes (36): URL-safe lowercase identifier used by the REST surface., api(), Stack, StackApplyResult, StackBody, StackCapabilityRow, StackConvergeReport, StackDiffRow (+28 more)
...
### Community 180 - "HealthStatsPage.jsx"
Cohesion: 0.07
Nodes (35): COMFYUI_FALLBACK, fetchRequestsRollup(), RequestsEndpointCount, RequestsRollup, useRequestsRollup(), failingChecks(), HealthCheck, HealthSystem (+27 more)
...
### Community 182 - "test_agent_uninstall_memory.py"
Cohesion: 0.09
...
### Community 185 - "compute_config_drift"
Cohesion: 0.08
...
### Community 186 - "test_personas.py"
Cohesion: 0.08
...
### Community 188 - "test_slots_image_pull.py"
Cohesion: 0.09
...
### Community 189 - "test_update_commands.py"
Cohesion: 0.07
...
### Community 192 - "test_hindsight_provider.py"
Cohesion: 0.09
...
### Community 196 - "test_unit_files.py"
Cohesion: 0.05
...
### Community 197 - "Benchmarks.tsx"
Cohesion: 0.09
Nodes (36): BENCH_OPTIONS, Benchmarks(), BenchOption, CAP_ALIAS, CAP_COLOR, CAP_SVG, CellRow, cellTd (+28 more)

### Community 198 - "BaseModel"
Cohesion: 0.09
Nodes (38): BaseModel, The supplied credential was rejected., Unauthorized, PersonaApprovalUpdate, Partial ``[persona.approval]`` patch. Omitted fields are unchanged., _client_ip(), exposure(), ExposureAllowlistEntry (+30 more)
...
### Community 200 - "slot_write_lock"
Cohesion: 0.08
Nodes (28): Protocol, device_to_backend(), Map hal0's ``device`` enum onto the recipe+backend pair.      Args:         devi, Hold the coarse cross-process lock for ALL slots/*.toml writes.      Historicall, slot_write_lock(), The non-filesystem side effects of the migration.      Split behind a protocol s, SlotArtifactOps, NpuTrioHost (+20 more)
...
### Community 202 - "test_model_meta.py"
Cohesion: 0.06
...
### Community 204 - "test_discover.py"
Cohesion: 0.09
...
### Community 206 - "SlotIdentityStore"
Cohesion: 0.12
...
### Community 212 - "test_mtp_override.py"
Cohesion: 0.09
...
### Community 213 - "test_npu_swap_status.py"
Cohesion: 0.11
...
### Community 214 - "recommend_primary_slot"
Cohesion: 0.10
...
### Community 215 - "test_modality.py"
Cohesion: 0.10
...
### Community 218 - "Appendix: raw area reports"
Cohesion: 0.05
...
### Community 222 - "_resolve_llama_scalars"
Cohesion: 0.13
...
### Community 225 - "_RecordingProvider"
Cohesion: 0.11
...
### Community 227 - "§17 installer/setup overhaul — edit-plan (thin shell + thick Python, one profile authority, one slot roster)"
Cohesion: 0.06
...
### Community 228 - "P3 slot-identity + ports — implementation spec"
Cohesion: 0.06
...
### Community 230 - "test_doctor_json_diagnoses.py"
Cohesion: 0.09
Nodes (35): NextStep, _diagnose_audit_rows(), _diagnose_migration(), _diagnose_models(), _diagnose_profiles(), perms(), Diagnosis, Assemble the §21.4 ``HAL0-MODEL-*`` Diagnosis rows from the evidence     ``docto (+27 more)

### Community 231 - "hal0 — Plan"
Cohesion: 0.06
...
### Community 232 - "resolve_role_slots"
Cohesion: 0.13
...
### Community 235 - "provision_comfyui_downloads"
Cohesion: 0.08
...
### Community 236 - "orchestrate_models"
Cohesion: 0.09
...
### Community 237 - "hw_slot_ownership.py"
Cohesion: 0.10
...
### Community 239 - "test_route_to_chat.py"
Cohesion: 0.09
...
### Community 240 - "_resolve_image_ref"
Cohesion: 0.10
...
### Community 242 - "test_update_check.py"
Cohesion: 0.09
...
### Community 244 - "test_installer_routes.py"
Cohesion: 0.09
...
### Community 248 - "test_hf_token_secrets.py"
Cohesion: 0.06
...
### Community 252 - "portable.py"
Cohesion: 0.09
Nodes (32): import_stack_route(), Import a stack from an uploaded ``.hal0stack.json`` envelope.      Body::, _checksum(), export_envelope(), import_stack(), ModelResolution, parse_envelope(), Any (+24 more)

### Community 253 - "test_v1_chat_slot_alias.py"
Cohesion: 0.13
...
### Community 259 - "TestUpstreamEntry"
Cohesion: 0.07
Nodes (11): ModelConfig, [model] section in a slot TOML.      Specifies which model the slot loads by def, _declared_provider(), Path, Unit tests for hal0.config.schema pydantic models.  Each validator gets exercise, Pull the provider a seeded slot TOML declares, if any.      Container slots (e.g, Regression guard for #650.      Every provider a seeded slot TOML declares must, Every shipped seed slot's `profile` must resolve to a live SEED_PROFILES key. (+3 more)
...
### Community 261 - "PgVectorProvider"
Cohesion: 0.08
Nodes (22): True when the Hindsight daemon is NOT answering.          The BOOT-time degrade, _now(), PgVectorProvider, PgVectorProvider — the documented boot fallback (spec P1 degrade ladder).  Minim, _cfg(), #613 — PgVectorProvider degrade-safety: warn on writes, expose degraded flag.  V, Subsequent add() calls must NOT repeat the write warning (log-once throttle)., The warning must not prevent the write — data IS stored in memory. (+14 more)

### Community 262 - ".from_tag"
Cohesion: 0.08
...
### Community 263 - "test_metrics_prometheus_route.py"
Cohesion: 0.09
...
### Community 272 - "write_toml_atomic"
Cohesion: 0.11
...
### Community 277 - "build_request_metric_row"
Cohesion: 0.10
...
### Community 278 - "LlamaServerProvider"
Cohesion: 0.08
...
### Community 279 - "test_memory_admin_routes.py"
Cohesion: 0.17
...
### Community 280 - "test_brain_injection.py"
Cohesion: 0.17
...
### Community 281 - "TestContainerSpec"
Cohesion: 0.13
...
### Community 286 - "Hal0MemoryClient"
Cohesion: 0.09
Nodes (17): Hal0MemoryClient, Hal0MemoryClientError, Any, Client, Thin synchronous REST client for the hal0-memory REST surface.  Design notes: (1, POST /api/memory/add. ``private=True`` → hermes-private, else shared., POST /api/memory/search — semantic retrieval (union of both banks)., POST /api/memory/recall — token-budgeted consolidated recall (union). (+9 more)

### Community 287 - "memory_admin.py"
Cohesion: 0.14
...
### Community 290 - "test_container_gate.py"
Cohesion: 0.11
...
### Community 291 - "test_chat_normalization.py"
Cohesion: 0.10
...
### Community 293 - "test_admin_route_map_nested.py"
Cohesion: 0.09
...
### Community 298 - "import_toml_to_sqlite"
Cohesion: 0.12
...
### Community 300 - "test_doctor_all.py"
Cohesion: 0.08
...
### Community 301 - "test_preflight_gpu_gate.py"
Cohesion: 0.10
...
Cohesion: 0.11
Nodes (29): Uninstall a user-installed MCP server. Bundled servers reject 409., uninstall_cmd(), graph_disable_cmd(), Turn graph extraction OFF; cancels any in-flight build., _api_reachable(), api_delete(), api_get_bytes(), api_put() (+21 more)

### Community 305 - "update"
Cohesion: 0.10
Nodes (29): _dev_mode(), _fetch_slot_drift(), _interactive(), _poll_job(), _print_check(), _print_drift_banner(), Context, Path (+21 more)

### Community 306 - "test_agents_personas.py"
Cohesion: 0.15
...
### Community 309 - "test_journal_routes.py"
Cohesion: 0.13
...
### Community 310 - "test_board_chat_admin_tools.py"
Cohesion: 0.12
...
### Community 311 - "test_board_routes.py"
Cohesion: 0.10
...
### Community 312 - "test_uninstall.py"
Cohesion: 0.10
...
### Community 313 - "test_bootstrap_prereq_parity.py"
Cohesion: 0.11
...
### Community 314 - "test_degrade_live.py"
Cohesion: 0.11
...
### Community 318 - "SingleFlightGroup"
Cohesion: 0.08
...
### Community 320 - "P3-slots: Decomposition Spec for `slots/manager.py`"
Cohesion: 0.07
...
### Community 321 - "Hal0MemoryClient"
Cohesion: 0.11
...
### Community 324 - "run_migrations"
Cohesion: 0.11
Nodes (20): config_migrate(), Migrate hal0.toml forward to the latest config schema version.      Reads ``meta, _deep_copy_dict(), latest_version(), MigrationError, Any, hal0.config.migrations — versioned config migration transforms.  # TIER3: config, # NOTE: downgrade migrations are explicitly unsupported in v1. (+12 more)

### Community 325 - "test_auth_rotate.py"
Cohesion: 0.18
...
### Community 330 - "test_hal0_memory_client.py"
Cohesion: 0.10
...
### Community 333 - "test_workflow_contract.py"
Cohesion: 0.15
...
### Community 334 - "Tier 2 — medium (one PR each)"
Cohesion: 0.07
...
### Community 335 - "PART 0 — Current registry, mapped (file:line)"
Cohesion: 0.07
...
### Community 336 - "Enum"
Cohesion: 0.11
Nodes (26): Enum, PhaseStatus, Per-step outcome.      ``ok``   — step completed.     ``skip`` — step didn't app, auth_require(), auth_rotate(), KeyTier, hal0 auth subcommands — thin HTTP client to /api/auth/*.  §5.2 of the R5 sync as, Persist the [security].require_auth posture (PUT /api/auth/require). (+18 more)
...
### Community 340 - "ProfileConfig"
Cohesion: 0.11
Nodes (11): Look up a named profile in the profiles.toml catalog.      Shared by every provi, resolve_profile(), ProfileConfig, One ``[profile.<name>]`` entry in profiles.toml.      A profile is a reusable ba, §7.1a / ML-5: profile.mtp is informational only — resolve_profile_flags, profile.mtp=True alone (no explicit mtp_override) no longer         expands the, A profile that pins its own --spec-draft-* values keeps them; the MTP         bu, MTP_FLAG_BUNDLE constant is verbatim in the resolved string. (+3 more)

### Community 341 - "get_curated"
Cohesion: 0.09
...
### Community 342 - "merge_slot_config"
Cohesion: 0.11
...
### Community 346 - "Recommended hal0 ideas"
Cohesion: 0.07
...
### Community 347 - "hal0 Hermes Integration Suite Implementation Plan"
Cohesion: 0.07
...
### Community 351 - "read_gguf_header"
Cohesion: 0.19
Nodes (15): Any, Path, Parse the GGUF header and return a dict of interesting KV pairs.      Returns ``, read_gguf_header(), _enc_kv(), _enc_str(), Path, Unit tests for hal0.registry.gguf_header.  We fabricate minimal GGUF headers in- (+7 more)

### Community 352 - "test_agent_restart_endpoint.py"
Cohesion: 0.18
...
### Community 353 - "test_models_add_from_path.py"
Cohesion: 0.14
...
### Community 354 - "test_models_default.py"
Cohesion: 0.15
...
### Community 355 - "test_npu_occupancy.py"
Cohesion: 0.15
...
Cohesion: 0.13
Nodes (4): MonkeyPatch, TestDeriveAllowedOrigins, TestDetectLanIps, TestHostname

### Community 359 - "test_installed.py"
Cohesion: 0.11
...
### Community 363 - "test_npu_exclusivity.py"
Cohesion: 0.12
...
### Community 365 - "Changelog"
Cohesion: 0.08
Nodes (25): [0.9.2] — 2026-07-05, [0.9.4.1] — 2026-07-08, [0.9.5.2] — 2026-07-09, Added, Added, Breaking, Changed, Changed (+17 more)

### Community 366 - "ML-4 (runner-image registry) + ML-5 (flag resolution) — implementation-ready spec"
Cohesion: 0.08
...
### Community 367 - "R5 — Surface + launch"
Cohesion: 0.08
...
### Community 368 - "journal.py"
Cohesion: 0.15
Nodes (25): LevelFilter, _bus(), _collect(), get_journal(), _hal0_event_to_entry(), JournalEntry, _passes_filters(), Any (+17 more)

### Community 369 - "moonshine_server.py"
Cohesion: 0.10
Nodes (22): _decode_audio(), _detect_local_format(), _load_model(), main(), JSONResponse, ndarray, Path, WebSocket (+14 more)

### Community 370 - "hal0_slot_alias_models"
Cohesion: 0.12
Nodes (23): _coerce_ctx(), hal0_apply_registry_detail(), hal0_chat_slot_model_ids(), hal0_llm_slot_views(), hal0_slot_alias_models(), _model_recipe(), Any, ModelRegistry (+15 more)

### Community 371 - "__init__.py"
Cohesion: 0.15
...
### Community 372 - "HermesBoardExecutor"
Cohesion: 0.15
...
### Community 373 - "upstream_commands.py"
Cohesion: 0.10
Nodes (25): board_move(), Move a task to a different lane (PATCH /api/board/tasks/{id})., api_patch(), advertise_upstream(), create_upstream(), credentials_set(), delete_upstream(), _do_set_credentials() (+17 more)
...
### Community 375 - "test_emit_answers.py"
Cohesion: 0.14
...
### Community 379 - "test_hermes_executor.py"
Cohesion: 0.18
...
### Community 380 - "test_agent_approvals_list.py"
Cohesion: 0.09
...
### Community 381 - "test_slot_create_flags.py"
Cohesion: 0.11
...
### Community 383 - "test_env_writer.py"
Cohesion: 0.13
...
### Community 384 - "test_comfyui_container_spec.py"
Cohesion: 0.11
...
### Community 387 - "test_id_keying.py"
Cohesion: 0.20
...
### Community 388 - "board-chat-v3.spec.ts"
Cohesion: 0.09
Nodes (12): emitSseTyped(), emitWs(), installWsHarness(), waitForWs(), NOTE: addInitScript serialises the function — it must not close over, body(), engine(), pane() (+4 more)

### Community 389 - "compilerOptions"
Cohesion: 0.08
Nodes (25): compilerOptions, allowImportingTsExtensions, allowJs, baseUrl, checkJs, isolatedModules, jsx, lib (+17 more)

### Community 390 - "test_prewire_smoke.py"
Cohesion: 0.10
...
### Community 391 - "What You Must Do When Invoked"
Cohesion: 0.08
...
### Community 393 - "hal0 benchmarking system — full design (batch runs, rich run detail, display, auto-update)"
Cohesion: 0.08
...
### Community 398 - "test_profile_derivation_parity.py"
Cohesion: 0.08
...
### Community 399 - "chat_commands.py"
Cohesion: 0.14
...
### Community 403 - "scan_and_register"
Cohesion: 0.11
...
### Community 404 - "unknown_slot_config_keys"
Cohesion: 0.12
...
### Community 413 - "test_seeds_data.py"
Cohesion: 0.08
...
### Community 414 - "test_memory_delete_auth.py"
Cohesion: 0.11
...
### Community 415 - "FakeContainerProvider"
Cohesion: 0.11
...
### Community 418 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.08
...
### Community 419 - "hal0 1.0 — Seeded profile rework"
Cohesion: 0.08
...
### Community 420 - "Hermes Python 3.12 Cross-Distro Installation Design"
Cohesion: 0.08
...
### Community 421 - "AgentConfig"
Cohesion: 0.13
Nodes (21): Popen, AgentConfig, _build_hermes_argv(), _build_hermes_env(), cmd_serve(), cmd_status(), _is_ready(), Path (+13 more)

### Community 422 - "test_slots_routes.py"
Cohesion: 0.13
...
### Community 423 - "resolved_command_for_slot"
Cohesion: 0.10
...
### Community 424 - "seed_static_slots"
Cohesion: 0.17
...
### Community 426 - "_tmp_dir"
Cohesion: 0.11
Nodes (24): _comfyui_models_dir(), _final_path(), _final_path_for_entry(), _pull_root(), Strip path-unsafe characters from a model id.      The id is used as a directory, Return the configured pull destination root.      ML-3: thin delegator to :func:, Resolve the final on-disk path: <pull_root>/<id>/<file>., ComfyUI checkpoints/loras/vae directory under the model store.      ComfyUI mode (+16 more)

### Community 427 - "_container_cgroup_mem_bytes"
Cohesion: 0.13
...
### Community 428 - "test_run_as_hal0_guard.py"
Cohesion: 0.13
...
### Community 429 - "test_slot_config_validation.py"
Cohesion: 0.19
...
### Community 434 - "types.py"
Cohesion: 0.11
Nodes (18): Shared types for the hal0 Hermes transport., _fake_hw(), MonkeyPatch, SimpleNamespace, Tests for ``hal0 system-info`` (§21.3 host/GPU/NPU/runtime evidence).  The assem, test_build_full_shape(), test_build_is_json_serialisable(), test_command_human_exits_zero() (+10 more)

### Community 435 - "_auth.py"
Cohesion: 0.12
...
### Community 441 - "classify_layout"
Cohesion: 0.13
Nodes (21): list_slot_layout(), Classify every slots/*.toml stem as ``"id"`` or ``"name"``.      The bilingual e, classify_layout(), is_id_stem(), Path, Slot on-disk layout primitives — the bilingual (name-or-id) key seam.  A slot's, True when *stem* is an id-key (all ASCII digits), else a name-key.      ``"143"`, The ``<key>.toml`` config path under *config_dir* for a name-or-id key. (+13 more)

### Community 442 - "test_hw_slot_ownership_migration.py"
Cohesion: 0.23
...
### Community 443 - "resolve_write_dataset"
Cohesion: 0.15
...
### Community 444 - "apply_thinking_policy"
Cohesion: 0.15
...
### Community 447 - "read_stack_state"
Cohesion: 0.14
...
### Community 448 - "test_agent_memory_stats_endpoint.py"
Cohesion: 0.16
...
### Community 449 - "test_backends_npu_canonical_fields.py"
Cohesion: 0.13
...
### Community 451 - "test_memory_subgraph.py"
Cohesion: 0.19
...
### Community 453 - "test_settings_models_store.py"
Cohesion: 0.17
...
### Community 455 - "test_brain_read_only.py"
Cohesion: 0.12
...
### Community 464 - "dashboard_layout.py"
Cohesion: 0.12
...
### Community 478 - "test_tts_capability_switch.py"
Cohesion: 0.12
...
### Community 483 - "test_kb1_hardening_tail.py"
Cohesion: 0.15
...
### Community 486 - "Dashboard Overhaul — FROZEN DATA CONTRACT (v1)"
Cohesion: 0.09
...
### Community 489 - "P2-config: Collapse capabilities.toml double-bookkeeping"
Cohesion: 0.10
...
### Community 494 - "test_fetch_ws_g.py"
Cohesion: 0.14
...
### Community 497 - "container_enrichment"
Cohesion: 0.25
...
### Community 498 - "migrate_slot_id_keying"
Cohesion: 0.17
...
### Community 499 - "embed_references"
Cohesion: 0.20
Nodes (11): embed_references(), Return a copy of ``stack`` with ``models``/``profiles`` populated.      Model me, ModelRegistry, Path, Tests for stack export: reference embedding + envelope + checksum.  Targeted fil, A model that IS in the registry but with EMPTY coords, yet present in         th, A coord-less registry row with no curated match exports empty coords         (th, reg() (+3 more)
...
### Community 518 - "MemoryGraphConfig"
Cohesion: 0.13
...
### Community 521 - "TestSlotHardwareSegment"
Cohesion: 0.14
...
### Community 528 - "test_model_store_root.py"
Cohesion: 0.14
...
### Community 530 - "TestEarlyHal0User"
Cohesion: 0.10
...
### Community 532 - "test_curated_image_models.py"
Cohesion: 0.11
...
### Community 543 - "ProvidersConfig"
Cohesion: 0.15
Nodes (11): load_providers_config(), Load and validate providers.toml.      Returns an empty ProvidersConfig if the f, Atomically write providers.toml., save_providers_config(), ProviderEntry, ProvidersConfig, One [[provider]] entry in providers.toml.      ``extra="forbid"`` (P3-schema Par, Parsed providers.toml. (+3 more)
...
### Community 545 - "SlidingWindowRateLimiter"
Cohesion: 0.13
...
### Community 553 - "test_capabilities_commands.py"
Cohesion: 0.19
...
### Community 554 - "test_pull_refcount_rows.py"
Cohesion: 0.20
...
### Community 555 - "test_store_concurrency.py"
Cohesion: 0.19
...
### Community 557 - "test_load_converges_config.py"
Cohesion: 0.24
...
### Community 571 - "resolve_bench_devices"
Cohesion: 0.22
...
### Community 573 - "slot_migrate_flags"
Cohesion: 0.32
...
### Community 575 - "test_schema_seeds_c5.py"
Cohesion: 0.14
...
### Community 577 - "._post"
Cohesion: 0.16
Nodes (11): NpuTrioNotAvailable, Any, AsyncClient, Response, NPU trio direct-port dispatch.  A single ``flm serve`` process inside the contai, Forward an STT request to the npu container's ``/v1/audio/transcriptions``., Forward an embeddings request to the npu container's ``/v1/embeddings``., Build the outbound header dict.          We always set ``content-type`` (callers (+3 more)
...
### Community 579 - "provider_from_config"
Cohesion: 0.19
Nodes (16): _build_hindsight_client(), provider_from_config(), Any, MemoryProvider, hal0 memory subsystem (brain-redesign P0-P2).  Public contract for ``/mcp/memory, Construct the Hindsight REST client from config + env, or raise.      ``from_env, Construct the active MemoryProvider from the loaded hal0 config.      ADR-0023:, _cfg() (+8 more)

### Community 580 - "aggregate_hour"
Cohesion: 0.20
...
### Community 581 - "Provider"
Cohesion: 0.14
Nodes (12): Provider, Any, ContainerSpec, Abstract base for a hal0 inference backend.      Concrete implementations: Conta, Compute the EnvironmentFile contents for a slot.          Returns a mapping of H, Return the argv list for spawning this backend outside systemd.          Mirrors, Run a health check against the backend on *port*.          Returns {"ok": bool,, Passthrough inference against the provider's OpenAI-compatible API.          Thi (+4 more)

### Community 582 - "audio.py"
Cohesion: 0.12
...
### Community 586 - "CapacityProbeError"
Cohesion: 0.13
...
### Community 592 - "FakeUpstreamRegistry"
Cohesion: 0.18
...
### Community 603 - "3. Proposed seed catalog (one per type)"
Cohesion: 0.12
...
### Community 604 - "Slot config — capabilities ↔ slots reconciliation"
Cohesion: 0.12
...
### Community 605 - "hal0 Adoption Candidates — Lemonade + ODS (combined)"
Cohesion: 0.12
...
### Community 606 - "spec-hp-realtime — OpenAI Realtime WebSocket endpoint for hal0"
Cohesion: 0.12
...
### Community 607 - "P3-schema — `config/schema.py` decomposition: implementation-ready spec"
Cohesion: 0.12
...
### Community 608 - "Prerelease Preview Pipeline Hardening"
Cohesion: 0.12
...
### Community 609 - "_Reader"
Cohesion: 0.26
Nodes (10): mmap, GGUFParseError, GGUF header parser — read-only metadata extraction.  Parses the GGUF v1-v3 magic, Raised on a truncated / malformed GGUF header.      Callers usually convert this, Cursor over a bytes-like blob with bounds-checked reads., Read and return a GGUF value of ``vtype``. Used for keys we want., Skip a GGUF value of ``vtype`` without materialising it., _read_value() (+2 more)

### Community 610 - ".uninstall"
Cohesion: 0.16
...
### Community 613 - "agent_shim.py"
Cohesion: 0.15
Nodes (16): _build_parser(), cmd_render_context(), cmd_reprovision(), _die(), _load_agent_config(), main(), ArgumentParser, ``hal0-agent`` CLI shim — invoked by ``hal0-agent@<id>.service``.  This is a del (+8 more)

### Community 614 - "slots_config_dir"
Cohesion: 0.25
...
### Community 625 - "_StubSlotManager"
Cohesion: 0.26
...
### Community 626 - "test_cli_auth_streamtest.py"
Cohesion: 0.21
...
### Community 627 - "Findings from the 2026-05-16 hal0-test deep-probe round"
Cohesion: 0.12
...
### Community 628 - "DelegateTaskSpec"
Cohesion: 0.18
...
### Community 629 - "test_preflight_ports_own_service.py"
Cohesion: 0.29
...
### Community 630 - "agents-overview.jsx"
Cohesion: 0.20
...
### Community 631 - "test_npu_trio_shadow.py"
Cohesion: 0.17
...
### Community 632 - "test_ttft_samples.py"
Cohesion: 0.12
...
### Community 636 - "hal0_gpu_gate.py"
Cohesion: 0.16
...
### Community 637 - "qwen3tts_server.py"
Cohesion: 0.16
...
### Community 647 - "FakeDockerBackend"
Cohesion: 0.16
...
### Community 648 - "hal0 test harness — internal contributor guide"
Cohesion: 0.12
...
### Community 649 - "MonkeyPatch"
Cohesion: 0.12
Nodes (16): list_transport(), mock_transport(), MonkeyPatch, A TOOL_PARAM_HINTS entry naming a non-catalog tool must fail import     validati, Patch httpx.AsyncClient so REST calls are observable + no network., Patch httpx.AsyncClient so GET returns a bare JSON *list*.      Mirrors the real, A classified tool losing its _REST_MAP row must fail at import     validation, n, _PATH_ARGS must mirror the {placeholders} in each route template. (+8 more)
...
### Community 665 - "upsert_env_value"
Cohesion: 0.21
...
### Community 668 - "test_slots_policy.py"
Cohesion: 0.26
...
### Community 670 - "model_commands.py"
Cohesion: 0.17
Nodes (14): _fmt_size(), model_assign(), model_list(), model_pull(), model_register(), model_update(), _poll_pull_progress(), hal0 model subcommands — thin HTTP client to the hal0 API. (+6 more)
...
### Community 672 - "BrainChatConfig"
Cohesion: 0.16
Nodes (8): BrainChatConfig, ``[brain_chat]`` — the dashboard's agent-chat steward (hal0-brain).      Guardra, No ApprovalQueue wired -> a gated admin call returns a typed error and     NOTHI, test_gated_call_fails_closed_without_queue(), Per spec-p3-brain.final.md §5a + spec §5.3: BrainChatConfig.tool_model default i, Default tool_model is 'hal0/agent' per spec-p3-brain §5a., test_brain_chat_tool_model_default_is_hal0_agent(), TestBrainChatConfig

### Community 673 - "write_openwebui_env"
Cohesion: 0.18
...
### Community 675 - "test_pull_store.py"
Cohesion: 0.17
Nodes (14): list_persisted_jobs(), _pull_jobs_dir(), Return ``<var_lib>/model-pull-jobs`` (HAL0_HOME-aware via config paths)., Garbage-collect stale terminal pull-job snapshots (#MR-8).      Reap on-disk sna, Read all ``.json`` files from the pull-jobs directory and return a list of dicts, sweep_pull_jobs(), Test that ``_pull_root`` honours [models].store with pull_root fallback., Drop a snapshot for ``model_id`` in ``state`` with an aged mtime. (+6 more)

### Community 676 - "systemd.py"
Cohesion: 0.21
...
### Community 677 - "test_hermes_provision_kanban_db_init.py"
Cohesion: 0.20
...
### Community 678 - "test_persona_update.py"
Cohesion: 0.25
...
### Community 680 - "test_brain_ctx_precheck.py"
Cohesion: 0.23
...
### Community 683 - "test_no_npu_slot_means_no_swap"
Cohesion: 0.13
...
### Community 684 - "test_pool_bounds.py"
Cohesion: 0.15
...
### Community 686 - "test_api_restart_on_upgrade.py"
Cohesion: 0.28
...
### Community 687 - "test_admin_route_map.py"
Cohesion: 0.17
...
### Community 688 - "test_container_mmproj.py"
Cohesion: 0.31
...
### Community 689 - "test_release_check.py"
Cohesion: 0.37
...
### Community 690 - "test_device_profile_coherence.py"
Cohesion: 0.18
...
### Community 691 - "test_mtp_defuse.py"
Cohesion: 0.34
...
### Community 692 - "test_preload_eviction.py"
Cohesion: 0.26
...
### Community 693 - "test_integrations.py"
Cohesion: 0.13
...
### Community 697 - "Toolbox Repo Consolidation"
Cohesion: 0.14
...
### Community 698 - "obtain-models.mdx"
Cohesion: 0.14
...
### Community 699 - "Deploy halves of the "CI here" scenarios"
Cohesion: 0.14
...
### Community 700 - "PART 2 — DELIVERABLES"
Cohesion: 0.14
...
### Community 701 - "0. EXACT Honcho footprint (file:line)"
Cohesion: 0.14
...
### Community 702 - "P2-device: make `device` the sole truth, delete the `backend` dual-write"
Cohesion: 0.14
...
### Community 703 - "Handoff — R5 drive 2: put it back together (paste-in prompt, Fable orchestrator)"
Cohesion: 0.14
...
### Community 704 - "hal0 1.0 Seeded Profile Rework — Implementation Plan"
Cohesion: 0.14
...
### Community 706 - "Phase 4 handoff — halo143 deploy window"
Cohesion: 0.14
...
### Community 707 - "test_ports_command.py"
Cohesion: 0.22
...
### Community 708 - "test_moonshine_server.py"
Cohesion: 0.22
...
### Community 716 - "MetricsRetention"
Cohesion: 0.18
...
### Community 718 - "service_identity.py"
Cohesion: 0.18
...
### Community 719 - "heal_missing_llm_type"
Cohesion: 0.20
...
### Community 720 - "provider_requires_model"
Cohesion: 0.22
...
### Community 721 - "test_hermes_provision_context.py"
Cohesion: 0.14
...
### Community 722 - "test_middleware.py"
Cohesion: 0.21
...
### Community 723 - "test_services_health.py"
Cohesion: 0.27
...
### Community 725 - "test_board_etag.py"
Cohesion: 0.32
...
### Community 726 - "test_brain_chat.py"
Cohesion: 0.23
...
### Community 727 - "test_catalog_backends.py"
Cohesion: 0.21
Nodes (13): _npu_only_hw(), Any, MonkeyPatch, SC-2 — the NPU picker probe must honour a podman-only runtime.  ``available_back, A HardwareInfo-shaped stub: NPU present, no GPUs., Ensure each test starts and ends with a clean image-present cache., NPU is advertised when podman (not docker) reports the image present., Runtime resolves but the image inspect fails → no NPU backend. (+5 more)
...
### Community 754 - "_instrument_streaming_throughput"
Cohesion: 0.15
...
### Community 757 - "test_containers_apparmor.py"
Cohesion: 0.37
...
### Community 758 - "test_hermes_live_resolve_render.py"
Cohesion: 0.23
...
### Community 760 - "test_activity.py"
Cohesion: 0.31
...
### Community 761 - "test_activity_routes_instrumented.py"
Cohesion: 0.38
...
### Community 762 - "test_comfyui_fetch_route.py"
Cohesion: 0.15
...
### Community 764 - "test_harness_matrix.py"
Cohesion: 0.21
...
### Community 765 - "TestSeamWhitelist"
Cohesion: 0.18
...
### Community 766 - "test_memory_graph_commands.py"
Cohesion: 0.15
...
### Community 767 - "test_model_verbs.py"
Cohesion: 0.26
...
### Community 770 - "_RecordingProvider"
Cohesion: 0.24
...
### Community 771 - "test_seed_profiles.py"
Cohesion: 0.24
...
### Community 775 - "Slot pin + drawer field-wiring audit — session handoff (2026-07-30)"
Cohesion: 0.17
...
### Community 776 - "Recently added endpoints"
Cohesion: 0.17
...
### Community 777 - "HW-slot-ownership — hardware sticks to slots, logical tune sticks to models"
Cohesion: 0.17
...
### Community 778 - "Design — 3-tier, deny-by-default, single classification source"
Cohesion: 0.17
...
### Community 779 - "hal0 UI/UX design brief — post-R3 surface rework"
Cohesion: 0.17
...
### Community 783 - "Release pipeline — prototype findings + blockers"
Cohesion: 0.17
...
### Community 791 - "TestTelemetrySampler"
Cohesion: 0.17
...
### Community 792 - "test_board_ws.py"
Cohesion: 0.32
...
### Community 793 - "test_agent_status.py"
Cohesion: 0.23
...
### Community 796 - "test_static_seeds.py"
Cohesion: 0.17
...
### Community 798 - "`hal0-setup.yaml` — headless answer-file spec (2026-07-05)"
Cohesion: 0.18
...
### Community 799 - "Findings → fixes, by tier"
Cohesion: 0.18
...
### Community 800 - "Handoff: model-pipeline plan — finish-out pass"
Cohesion: 0.18
...
### Community 801 - "Hal0 Upstream Controls — Epic Plan (2026-07-06)"
Cohesion: 0.18
...
### Community 802 - "capabilities-and-profiles.mdx"
Cohesion: 0.18
...
### Community 803 - "Admin tools (`/mcp/admin`)"
Cohesion: 0.18
...
### Community 804 - "providers-profiles-devices.mdx"
Cohesion: 0.18
...
### Community 805 - "slot-lifecycle.mdx"
Cohesion: 0.18
...
### Community 806 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
...
### Community 807 - "Both-boxes deploy-validation runbook — rework-R4-stage"
Cohesion: 0.18
...
### Community 808 - "P3-brain — Implementation-Ready Spec: hal0-brain as a first-class module"
Cohesion: 0.18
...
### Community 809 - "PART D — Edit plan (files, order, delegators/shims)"
Cohesion: 0.18
...
### Community 810 - "hal0 Hermes Plugin Suite — BUILD Spec (verified vs code @ `rework/descar`)"
Cohesion: 0.18
...
### Community 811 - "Hermes Agent official integration research for the hal0 rework"
Cohesion: 0.18
...
### Community 812 - "2. Proposed hal0 plugin suite"
Cohesion: 0.18
...
### Community 823 - "memory_commands.py"
Cohesion: 0.24
...
### Community 826 - "rerender_slot_units"
Cohesion: 0.38
...
### Community 827 - "test_hermes_provision_collect.py"
Cohesion: 0.25
...
### Community 828 - "test_config_model_roots.py"
Cohesion: 0.29
...
### Community 829 - "test_doctor_route.py"
Cohesion: 0.24
...
### Community 830 - "test_features_health.py"
Cohesion: 0.25
...
### Community 831 - "test_meta_enums.py"
Cohesion: 0.42
...
### Community 833 - "test_server_ab_helpers.py"
Cohesion: 0.22
...
### Community 834 - "test_board_commands.py"
Cohesion: 0.27
...
### Community 835 - "test_serve_bind_host.py"
Cohesion: 0.31
...
### Community 836 - "test_fetch_scripts.py"
Cohesion: 0.18
...
### Community 837 - "test_network.py"
Cohesion: 0.18
Nodes (4): _hermetic_network_env(), Tests for hal0.config.network — the HAL0_BIND_HOST-derived network shape.  Cover, Clear the module's env vars and pin gethostname() for every test., TestBindHost
...
### Community 846 - "compilerOptions"
Cohesion: 0.18
Nodes (10): compilerOptions, allowSyntheticDefaultImports, lib, module, moduleResolution, noEmit, skipLibCheck, strict (+2 more)

### Community 847 - "[Unreleased]"
Cohesion: 0.20
Nodes (10): Added, Added, Breaking, Changed, Fixed, Fixed, Fixed, Migrations (+2 more)

### Community 848 - "Profiles / stacks — profile/stack/bundle layering"
Cohesion: 0.20
...
### Community 850 - "7. Product-shaped reworks (from the six field notes)"
Cohesion: 0.20
...
### Community 851 - "FLAGS-own — llama.cpp flags stick to models; profiles become templates"
Cohesion: 0.20
...
### Community 852 - "hal0 SETTINGS rework — implementation-ready spec"
Cohesion: 0.20
...
### Community 853 - "Slot / Model / Profile / Flags / Image — reworked runtime model (R3)"
Cohesion: 0.20
...
### Community 856 - "Dashboard Plugin JS Loading Internals"
Cohesion: 0.20
...
### Community 869 - "resolve_chat_template"
Cohesion: 0.27
...
### Community 873 - "TestStatusTelemetry"
Cohesion: 0.29
...
### Community 875 - "test_mcp_mount_health.py"
Cohesion: 0.24
...
### Community 876 - "test_models_pull_capability.py"
Cohesion: 0.31
Nodes (7): _resolve_pull_capability — capability + comfyui_subdir for a pull (P3).  The hel, _Reg, _req(), test_body_capability_wins(), test_curated_capability_and_subdir_fallback(), test_registry_capability_used_when_no_body(), test_unknown_model_returns_none()
...
### Community 878 - "test_startup_slot_seed.py"
Cohesion: 0.24
...
### Community 881 - "test_config_migrate.py"
Cohesion: 0.31
...
### Community 889 - "useToastStore.ts"
Cohesion: 0.24
...
### Community 916 - "model_store_root"
Cohesion: 0.28
...
### Community 924 - "test_hermes_stale_dropin_cleanup.py"
Cohesion: 0.47
...
### Community 925 - "isolated_client_with_root"
Cohesion: 0.33
...
### Community 927 - "TestHarnessConfig"
Cohesion: 0.22
...
### Community 928 - "test_catalog_flm_blacklist.py"
Cohesion: 0.28
...
### Community 929 - "test_model_fit_validation.py"
Cohesion: 0.47
...
### Community 930 - "test_config_show_edit_selector.py"
Cohesion: 0.50
...
### Community 932 - "test_slot_metrics_capacity.py"
Cohesion: 0.36
...
### Community 934 - "test_gp15_no_hermes.py"
Cohesion: 0.22
...
### Community 969 - "resolve_default_image"
Cohesion: 0.36
...
### Community 970 - "screen_extra_args_json"
Cohesion: 0.25
...
### Community 972 - "test_auth_exposure_route.py"
Cohesion: 0.32
...
### Community 986 - "test_route_sync.py"
Cohesion: 0.32
...
### Community 987 - "test_store_on_change.py"
Cohesion: 0.39
...
### Community 988 - "test_slot_create_conflict.py"
Cohesion: 0.29
...
### Community 989 - "test_slot_schema.py"
Cohesion: 0.32
...
### Community 990 - "test_transition_guard.py"
Cohesion: 0.25
...
### Community 991 - "useTweaksStore.ts"
Cohesion: 0.29
Nodes (5): APPEARANCE_KEYS, DEFAULTS, TweaksState, TweaksStore, useTweaksStore

### Community 992 - "board-chat-tool-use-v3.spec.ts"
Cohesion: 0.29
Nodes (3): GATED_FRAMES, mockChat(), sse()

### Community 993 - "Concurrency & continuous-batching optimization plan"
Cohesion: 0.29
...
### Community 994 - "ROCmFPX exploratory bench — RESULTS (2026-07-05)"
Cohesion: 0.29
...
### Community 1000 - "P3-perms: declarative OwnershipStore as the single ownership authority"
Cohesion: 0.29
...
### Community 1001 - "PART B — Target: OwnershipStore default `service_user="hal0"`"
Cohesion: 0.29
...
### Community 1002 - "PART C — The LOAD-BEARING contract: born-owned"
Cohesion: 0.29
...
### Community 1003 - "PART 0 — EXACT MAP (file:line)"
Cohesion: 0.29
...
### Community 1004 - "P3-quadlet: migrate slot + companion units to Podman Quadlet `.container`"
Cohesion: 0.29
...
### Community 1005 - "PART A — Current scars (in plain English)"
Cohesion: 0.29
...
### Community 1006 - "4. Delivery plan and gates"
Cohesion: 0.29
...
### Community 1010 - "Gateway connectivity quirks — hal0"
Cohesion: 0.29
...
### Community 1021 - "test_slot_logs_stream_redacts_secret_bearing_lines"
Cohesion: 0.33
...
### Community 1030 - "test_extra_args_sanitize.py"
Cohesion: 0.38
...
### Community 1043 - "Hal0 Installer Setup — Redesign Plan (2026-07-05)"
Cohesion: 0.33
...
### Community 1045 - "logs-and-activity.mdx"
Cohesion: 0.33
...
### Community 1050 - "24. Execution waves / rollout program (session 3, 2026-07-18)"
Cohesion: 0.33
...
### Community 1052 - "§4.4 addendum — MCP admin route-map autogen (the 3 gaps)"
Cohesion: 0.33
...
### Community 1053 - "Verification strategy"
Cohesion: 0.33
Nodes (6): Lifecycle and security, Live acceptance, Memory, Provider, Verification strategy, Voice

### Community 1054 - "Dashboard permission mismatch (root vs hal0)"
Cohesion: 0.33
...
### Community 1060 - "push-dev.sh"
Cohesion: 0.60
Nodes (5): die(), info(), push-dev.sh script, step(), warn()

### Community 1061 - "verify-roundtrip.sh"
Cohesion: 0.60
Nodes (5): fail(), info(), verify-roundtrip.sh script, step(), warn()

### Community 1062 - "update-toolbox-digests.sh"
Cohesion: 0.47
Nodes (3): patch_digest(), update-toolbox-digests.sh script, sync_version()

### Community 1063 - "hal0-memory"
Cohesion: 0.33
Nodes (5): ABC surface implemented, Contract summary, hal0-memory, Settings, Why no `dataset` field

### Community 1064 - "service_key"
Cohesion: 0.33
Nodes (6): _mcp_memory_call(), _probe_mcp_server(), List the tools an MCP server advertises. Returns shape:     ``{"ok": bool, "tool, Call the hal0-memory surface. Returns ``{ok, result?, error?}``.      **Was** a, Resolve the box service key, preferring the ``prefer`` tier.      Order: env[pre, service_key()
...
### Community 1071 - "_guess_capability"
Cohesion: 0.33
...
### Community 1072 - "ttft_samples.py"
Cohesion: 0.33
...
### Community 1073 - "avg_ttft_across"
Cohesion: 0.33
...
### Community 1074 - "samples_from_events"
Cohesion: 0.33
...
### Community 1122 - "TestRenderCancel"
Cohesion: 0.40
...
### Community 1123 - "probe_slot_name"
Cohesion: 0.40
...
### Community 1126 - "test_load_survives_concurrent_fail_watch"
Cohesion: 0.40
...
### Community 1131 - "slot-card-container-v3.spec.ts"
Cohesion: 0.40
...
### Community 1132 - "slot-edit-controls-v3.spec.ts"
Cohesion: 0.40
...
### Community 1148 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1149 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1150 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1151 - "hal0 docs"
Cohesion: 0.50
Nodes (3): `docs/internal/` — repo-only architecture docs, hal0 docs, Top-level `docs/*.mdx` — user docs

### Community 1152 - "streaming.mdx"
Cohesion: 0.50
Nodes (3): Client example, See also, Wire format

### Community 1153 - "11. Product reworks — round 2 (slot identity, ports, profile org)"
Cohesion: 0.50
...
### Community 1154 - "PART E — `hal0-api` User flip + UMask removal"
Cohesion: 0.50
...
### Community 1155 - "PART F — Edit plan (files, order, delegators/shims)"
Cohesion: 0.50
...
### Community 1156 - "PART H — Risks + capped verification"
Cohesion: 0.50
...
### Community 1157 - "PART E — Migration of running units (the live-box transition)"
Cohesion: 0.50
...
### Community 1158 - "PART F — Risks + capped verification"
Cohesion: 0.50
...
### Community 1159 - "`hal0-voice`"
Cohesion: 0.50
Nodes (4): Dynamic routing, Fallback and privacy, `hal0-voice`, Initial implementation

### Community 1163 - "register_mnt_ai_models.py"
Cohesion: 0.83
Nodes (3): _existing_ids(), main(), _post()

### Community 1164 - "request_id.py"
Cohesion: 0.67
Nodes (3): install(), FastAPI, Per-request X-Request-ID middleware.

### Community 1165 - "cmd_stop"
Cohesion: 0.50
Nodes (4): cmd_stop(), _find_child_pids(), SIGTERM any running ``hermes dashboard`` PTY for this agent id.      Invoked by, Scan /proc for processes matching ``needle`` AND ``agent_id``.      Pure-stdlib

### Community 1166 - "bench_commands.py"
Cohesion: 0.50
Nodes (3): bench(), Context, `hal0 bench` — benchmarking CLI (design §5), thin mount over hal0.bench.cli.  Th

### Community 1167 - "__init__.py"
Cohesion: 0.50
...
### Community 1175 - "test_comfyui_path.py"
Cohesion: 0.50
...
### Community 1183 - "[0.9.4] — 2026-07-08"
Cohesion: 0.67
Nodes (3): [0.9.4] — 2026-07-08, Added, Fixed

### Community 1184 - "[v0.8.2b4] — 2026-06-30"
Cohesion: 0.67
Nodes (3): Changed, Fixed, [v0.8.2b4] — 2026-06-30

### Community 1203 - "_runas_popen_extras"
Cohesion: 0.67
Nodes (3): Any, Popen kwargs that drop the child to ``user`` when we're running as root.      Th, _runas_popen_extras()
...
### Community 1213 - "test_agent_unit_argv_defaults_to_real_euid"
Cohesion: 0.67
Nodes (3): MonkeyPatch, ``euid=None`` (the production call) reads the live euid., test_agent_unit_argv_defaults_to_real_euid()

## Knowledge Gaps
- **3294 isolated node(s):** `runlog.sh script`, `rocmfpx-build.sh script`, `rocmfpx-env.sh script`, `rocmfpx-pipeline.sh script`, `rocmfpx-quantize.sh script` (+3289 more)
...
- **Why does `create_app()` connect `create_app` to `test_auth_core.py`, `test_hf_routes.py`, `test_stacks_routes.py`, `conftest.py`, `model_store_root`, `GpuImageMode`, `_build`, `test_dashboard_layout.py`, `test_memory_admin_routes.py`, `test_route_collisions.py`, `ApprovalQueue`, `test_slots_policy.py`, `isolated_client_with_root`, `test_memory_delete_auth.py`, `SlidingWindowRateLimiter`, `test_settings_routes.py`, `test_models_crud.py`, `test_slots_routes.py`, `test_admin_route_map_nested.py`, `test_updater_routes.py`, `mcp_mount.py`, `types.py`, `test_chat_proxy.py`, `test_chat_templates.py`, `TestClient`, `test_config_model_roots.py`, `test_slots_image_pull.py`, `test_exposure.py`, `provider_from_config`, `test_models_routes.py`, `test_auth_rotate.py`, `test_settings_models_store.py`, `EventBus`, `Path`, `test_v1_npu_trio_routing.py`, `test_chat_proxy_auth.py`, `_build`, `test_models_preview.py`, `BootReport`, `test_tts_request_defaults.py`, `test_profiles_crud.py`, `load_hal0_config`, `test_typed_errors.py`, `test_route_sync.py`, `test_typed_bodies.py`, `conftest.py`, `FakeWsServer`, `test_models_add_from_path.py`, `test_models_default.py`, `test_kb1_hardening_tail.py`, `test_v1_slot_alias_models.py`, `migrate_slot_toml`, `test_event_contract.py`, `test_redact.py`, `test_mcp_mount_health.py`, `test_pull_routes.py`, `TestClient`, `MemoryConfig`, `TestClient`, `test_startup_slot_seed.py`, `_StubSlotManager`, `test_cli_auth_streamtest.py`, `test_installer_routes.py`, `__init__.py`, `test_pull_shutdown.py`, `conftest.py`, `test_comfyui_fetch_route.py`, `test_v1_chat_slot_alias.py`, `test_slots_container_state.py`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `SlotManager` connect `SlotManager` to `Slot`, `SlotConfigError`, `FLMProvider`, `SlotInterface`, `Dispatcher`, `build_auto_selections`, `FakeManager`, `test_model_fallback.py`, `UpstreamCall`, `test_model_preferred_profile.py`, `_write_slot`, `test_load_converges_config.py`, `GpuArbiter`, `RoutingHost`, `CapabilityOrchestrator`, `test_device_profile_coherence.py`, `test_mtp_defuse.py`, `test_preload_eviction.py`, `compute_config_drift`, `rerender_slot_units`, `manager.py`, `_write_slot`, `test_npu_trio_reconcile.py`, `SlotIdentityStore`, `SlotState`, `heal_missing_llm_type`, `test_slot_aliases.py`, `test_slot_create_conflict.py`, `test_transition_guard.py`, `test_adopted_slot_eviction.py`, `test_pulling_serving_idle.py`, `SlotStateRecord`, `test_load_survives_concurrent_fail_watch`, `test_npu_exclusivity.py`, `agents-overview.jsx`, `test_npu_trio_shadow.py`, `Path`, `SlotWatchdog`, `test_manager_npu_container.py`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `connect()` connect `connect` to `Path`, `gc.py`, `SqliteModelRegistry`, `NotFound`, `PortAuthority`, `MetricsWriter`, `discover.py`, `import_toml_to_sqlite`, `test_pull_refcount_rows.py`, `ModelRegistry`, `pull.py`, `aggregate_hour`, `useLogs.ts`, `useActivity.ts`, `test_discover.py`, `SlotIdentityStore`, `models_service.py`, `Path`, `test_stats_requests_route.py`, `_safe_query`, `hw_slot_ownership.py`?**
