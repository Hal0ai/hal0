# Graph Report - mock-harness  (2026-07-30)

## Corpus Check
- 1648 files · ~2,090,152 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29907 nodes · 56883 edges · 1367 communities (1224 shown, 143 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 7024 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `090bfd11`
...
- test_network.py
- test_comfyui_container_spec.py
- _build_spec
- ModelRegistry
- test_id_keying.py
- compilerOptions
...
- .test_loaders_respect_hal0_home
...
- _stub_reachable
- test_system_info.py
- TestPackagedSlotsPortsMigration
...
- __init__.py
- __init__.py
- test_gateway_secrets_wire_refuses_real_etc_dropin_under_pytest
- test_home_init_converges_on_second_run
...
- `test_qwen3_row_offers_gpu_rocm_backend()` --calls--> `models_for_capability()`  [INFERRED]
  tests/capabilities/test_tts_capability_switch.py → src/hal0/capabilities/catalog.py
- `test_voice_tts_catalog_enumerates_both_engines()` --calls--> `models_for_capability()`  [INFERRED]
  tests/capabilities/test_tts_capability_switch.py → src/hal0/capabilities/catalog.py

## Import Cycles
- None detected.

## Communities (1367 total, 143 thin omitted)

### Community 0 - "dashboard-redesign.jsx"
Cohesion: 0.02
Nodes (148): Hal0Error, useActivityRecent(), useBackends(), CELL_DEFS, CELL_MAP, CellDef, CellId, DashLayout (+140 more)

### Community 1 - "test_updater.py"
Cohesion: 0.03
Nodes (176): _current_symlink(), _parse_manifest(), Return ``<usr_lib>/hal0-<version>/`` — where this release's tree lives., Return ``<usr_lib>/current`` — the atomic-swap target., Release manifest is missing required fields or has the wrong shape., Atomic self-update with cosign-verified releases and one-step rollback.      All, Initialise the updater.          Args:             channel: Release channel — "s, Schema-validated release-manifest payload.      Mirrors the on-disk JSON shape d (+168 more)

### Community 2 - "updater.py"
Cohesion: 0.02
Nodes (155): Preflight: hard-refuse an update on an editable/dev install (audit 4.1).      Th, _refuse_if_editable(), Die early on an editable/dev install — `hal0 update` can't swap the FHS tree., _refuse_if_editable(), Tag-based release-policy derivation — the single source of truth for classifying, Raised when a tag does not match any supported release pattern., Immutable policy derived from a parsed release tag., ReleasePolicy (+147 more)

### Community 3 - "useSlots.ts"
Cohesion: 0.03
Nodes (128): ADR-0022, useModels(), deviceBackend(), parseImageRef(), RunnerState, RuntimeRow, SystemInfo, SystemInfoBackend (+120 more)

### Community 4 - "SlotManager"
Cohesion: 0.02
Nodes (115): Return ``True`` when *name* is in the dispatchable ready-set.          Ready set, See :meth:`hal0.slots.watchdog.SlotWatchdog._fail_watch_loop`., See :meth:`hal0.slots.watchdog.SlotWatchdog.probe_health`., See :meth:`hal0.slots.watchdog.SlotWatchdog.readiness_check`., Return snapshots for all configured slots, concurrently., See :func:`hal0.slots.routing.default_slot_for`., See :func:`hal0.slots.routing.route_for_request`., See :func:`hal0.slots.routing.add_slot`. (+107 more)

### Community 5 - "Slot"
Cohesion: 0.03
Nodes (76): container_provider(), Return the process-wide ContainerProvider singleton., Atomically write a slot TOML.      THE byte-level write path for ``/etc/hal0/slo, write_slot_toml(), _cfg_port(), _cfg_provider(), _cfg_to_dict(), _model_default() (+68 more)

### Community 6 - "BoardStore"
Cohesion: 0.03
Nodes (88): BoardStore, _coerce_board_list(), _coerce_card_list(), _new_card_id(), _now(), Any, Connection, Row (+80 more)

### Community 7 - "die"
Cohesion: 0.04
Nodes (136): agent_list(), agent_peers(), agent_uninstall(), approvals_approve(), approvals_deny(), approvals_list(), List installed bundled agents., List pending agent approval requests. (+128 more)

### Community 8 - "useModels.ts"
Cohesion: 0.03
Nodes (119): ChatTemplate, useChatTemplates(), useMeta(), useMetaEnums(), AddFromPathRequest, fmtBytes(), fmtEta(), fmtSpeed() (+111 more)

### Community 9 - "SlotState"
Cohesion: 0.03
Nodes (82): The model registry could not be consulted (outage, not a miss).      Raised by t, See :meth:`hal0.slots.watchdog.SlotWatchdog.update`., RegistryUnavailableError, admit(), CandidateSlot, _estimate_incoming_footprint_mb(), EvictionStep, _gather_candidates() (+74 more)
...
### Community 11 - "ConfigParseError"
Cohesion: 0.04
Nodes (75): ConfigError, ConfigNotFound, ConfigParseError, _drop_dead_keys(), _find_manifest_path(), _flatten_slot_toml(), list_agent_configs(), load_agent_config() (+67 more)

### Community 12 - "HardwareInfo"
Cohesion: 0.03
Nodes (99): _backend_state(), _background_revalidate(), _cached_snapshot(), _clear_in_flight(), _flatten_for_ui(), get_hardware(), _gpu_sample(), _image_repo() (+91 more)

### Community 13 - "pull.py"
Cohesion: 0.04
Nodes (101): NamedTuple, FileSetEntry, FileSetPlan, One file of a planned file-set, ready for ``model_file`` insertion., The full set of files one model pull should download + register., _comfyui_models_dir(), _dir_size(), _discard_partial() (+93 more)

### Community 14 - "BaseModel"
Cohesion: 0.03
Nodes (75): BaseModel, The supplied credential was rejected., Unauthorized, PersonaApprovalUpdate, Partial ``[persona.approval]`` patch. Omitted fields are unchanged., exposure(), ExposureAllowlistEntry, ExposureResponse (+67 more)

### Community 15 - "ApprovalQueue"
Cohesion: 0.03
Nodes (101): ApprovalQueue, Async-safe pending-approval queue with dedup + SSE fan-out.      One instance pe, list_transport(), mock_transport(), _policy(), Any, MonkeyPatch, queue() (+93 more)

### Community 16 - "SettingsShell.jsx"
Cohesion: 0.05
Nodes (81): CapabilitiesBag, CapabilityBackend, CapabilityCatalogItem, CapabilityRow, CapabilitySelection, useCapabilities(), useCapabilityApply(), useCapabilityPatch() (+73 more)

### Community 17 - "FLMProvider"
Cohesion: 0.03
Nodes (94): FLMProvider, Provider for the AMD NPU FLM backend.      Two-tier readiness (Option A — NPU do, Cheap liveness probe — non-empty ``/v1/models``, NO NPU work.          This is t, One-shot real-inference gate — a single ``/v1/chat/completions``.          Run E, One-shot embeddings gate — a single ``/v1/embeddings`` call.          The warm→r, _model_info(), Any, FLM container_spec: [npu] toggles + model-cache default (Phase A). (+86 more)

### Community 18 - "client.ts"
Cohesion: 0.03
Nodes (84): api(), ApiOptions, serialiseBody(), COMFYUI_FALLBACK, ComfyuiArbiter, ComfyuiEngineState, ComfyuiMemory, ComfyuiMode (+76 more)

### Community 19 - "test_registry_import.py"
Cohesion: 0.05
...
### Community 21 - "ContainerProvider"
Cohesion: 0.04
Nodes (55): ContainerProvider, Podman-container-per-slot inference backend.      One instance is shared across, Not applicable — systemd starts the container., _make_provider_with_tmp_unit(), Path, Tests for stale legacy drop-in cleanup in _write_and_start_unit (closes #694)., Removing a stale drop-in emits a container.stale_dropin_removed log record., Return (provider, unit_path, calls_made) with _unit_path redirected into tmp_pat (+47 more)

### Community 22 - "slots.py"
Cohesion: 0.05
Nodes (89): _cache_slot_enrichment(), _config_field_enrichment(), _container_state_enrichment(), create_slot(), delete_slot(), get_slot(), get_slot_by_id(), get_slot_by_name() (+81 more)
...
Cohesion: 0.03
Nodes (38): LiveAgentCard(), RESTART_LABELS, useFlip(), useTilt(), AGENT_TAB_DEFS, _agentRoute(), _agentTabs(), AgentView() (+30 more)

### Community 25 - "ProfileConfig"
Cohesion: 0.04
Nodes (59): RuntimeFamily, SlotType, create_profile(), delete_profile(), export_profile(), get_profile(), import_profile_route(), list_profiles() (+51 more)

### Community 26 - "useBoard.ts"
Cohesion: 0.05
Nodes (79): URL-safe lowercase identifier used by the REST surface., apiPatch(), apiPost(), readErrorEnvelope(), normaliseActor(), normaliseAssignee, normaliseProfile, pickName() (+71 more)
...
### Community 28 - "apiMock.ts"
Cohesion: 0.03
Nodes (25): Fixtures, MockState, test, LIVE_BOARD, HERMES_ACTORS, MOCK_MCP_SERVERS, ADR-0023, MOBILE (+17 more)

### Community 29 - "SlotConfig"
Cohesion: 0.04
...
### Community 30 - "ModelDefaults"
Cohesion: 0.05
Nodes (41): Reconstruct a ``Model`` from one `model` table row.      ``backends`` comes from, row_to_model(), ModelCapabilities, ModelDefaults, Model — registry entry pydantic model.  The Model class is the typed representat, # NOTE: revisit in Phase 1 — extend as providers surface new capabilities., Launch/runtime typed flags — §7.1d / ML-6.      Distinct from :attr:`Model.capab, Per-model default knobs surfaced as launcher defaults.      All fields optional. (+33 more)

### Community 31 - "run_pull"
Cohesion: 0.06
Nodes (84): hf_download_url(), make_job(), Build the canonical HuggingFace download URL.      ``resolve/main`` (not ``raw/m, Create a fresh job record for ``model_id``., Background-task body: stream the file(s), hash, install, register.      ML-2/ML-, run_pull(), End-to-end: a pull with comfyui_subdir lands under the right tree., A pull without comfyui_subdir keeps the legacy models/<id>/ layout. (+76 more)
...
### Community 34 - "test_plugin_manifest_proxy.py"
Cohesion: 0.05
...
### Community 36 - "Dispatcher"
Cohesion: 0.06
Nodes (70): LegacyResolutionFailed, Raised when the capability/path heuristics find no slot to serve a request., Dispatcher, DispatchError, NoRouteFound, Look up a registry binding for a model id.          Returns (upstream_name, upst, Base for any failure the dispatcher itself raises.      All subclasses use the `, No upstream could be found for the requested model id. (+62 more)

### Community 37 - "load_hal0_config"
Cohesion: 0.05
Nodes (67): MigrationPlan, _apply_store_change(), _config_to_dict(), ConfigInvalidError, _deep_merge(), get_apply_plan(), get_model_store(), get_settings() (+59 more)

### Community 38 - "PgVectorProvider"
Cohesion: 0.04
Nodes (64): BaseTransport, HindsightUnreachable, probe_health(), _probe_timeout(), Async REST client for the shared hindsight-api (brain-redesign P1).  Talks to ``, The Hindsight daemon did not answer a health probe.      Raised by :func:`probe_, Synchronously confirm the daemon answers, or raise.      Deliberately synchronou, True when the Hindsight daemon is NOT answering.          The BOOT-time degrade (+56 more)

### Community 39 - "HermesDriver"
Cohesion: 0.05
Nodes (75): HermesDriver, Driver for the Hermes-Agent bundled agent., driver(), _FakeCompleted, _FakeRunner, _prober_ok(), MonkeyPatch, Path (+67 more)

### Community 40 - "hermes_provision.py"
Cohesion: 0.04
Nodes (80): _active_persona_render(), bootstrap_cli(), BootstrapState, _brain_profile_config_path(), _build_brain_profile_mcp_servers(), _default_mcp_servers(), _fetch_model_contexts(), _generate_api_server_key() (+72 more)

### Community 41 - "HindsightProvider"
Cohesion: 0.05
Nodes (47): _agent_of(), bank_to_namespace(), _decode_cursor(), _encode_cursor(), HindsightProvider, _http_status(), namespace_to_bank(), _now() (+39 more)

### Community 42 - "test_orchestrate.py"
Cohesion: 0.05
Nodes (59): dump_answers(), Serialize a resolved :class:`~hal0.install.orchestrate.Selections` back     into, Write ``dump_answers(sel)`` to *path* as ``hal0-setup.yaml``.      Prefixes a he, write_answers(), The full set of first-run choices to apply., Selections, _forbid_apply(), _hw() (+51 more)

### Community 43 - "Model"
Cohesion: 0.06
Nodes (35): Model, A model entry in the hal0 registry.      All fields are optional at construction, ModelAlreadyExists, ModelNotFound, Base error for registry operations., The requested model id is not in the registry., add() called but the model id is already present., RegistryError (+27 more)

### Community 44 - "test_unified_bank.py"
Cohesion: 0.05
Nodes (72): Unified-bank memory model — [memory] unified_bank.  Pins the unified routing con, The ``agents`` federated registry is NOT chat memory — unified mode must     lea, An explicit multi-scope read (agents + a chat namespace) keeps agents as     its, Captures the full retain/recall payload for assertions., Directly-constructed providers default to legacy multi-bank so existing     call, A ``visibility:private`` doc in the shared bank is recall-visible to its     own, Two agents' private docs coexist in the shared bank; each recalls only     its o, Non-private (shared) docs remain unified-readable by every caller,     including (+64 more)

### Community 45 - "Upstream"
Cohesion: 0.04
Nodes (46): _fields_for_dataclass(), _fields_for_entry(), _filters_to_config(), _filters_to_runtime(), Any, AsyncClient, Lock, Path (+38 more)

### Community 46 - "test_updater_routes.py"
Cohesion: 0.05
...
### Community 47 - "chrome.jsx"
Cohesion: 0.05
Nodes (61): useApproveApproval(), useDenyApproval(), ConfigUrls, useConfigUrls(), useMemoryEnabled(), useClearPullJob(), useHfSearch(), useModelUpdateAll() (+53 more)

### Community 48 - "v1.py"
Cohesion: 0.06
Nodes (75): DispatcherDep, _aggregate_models(), audio_speech(), audio_transcriptions(), _capability_slot_for_path(), chat_completions(), completions(), _dispatch_and_forward() (+67 more)

### Community 49 - "primitives.jsx"
Cohesion: 0.04
Nodes (51): bundleNameOr(), InstallState, InstallStateBundle, useInstallState(), DEMO_MIGRATION_REPORT, EMPTY_MIGRATION_REPORT, MigrationFlagConflict, MigrationReport (+43 more)

### Community 50 - "chat.py"
Cohesion: 0.05
...
### Community 51 - "test_models_routes.py"
Cohesion: 0.05
...
### Community 52 - "ENDPOINTS"
Cohesion: 0.06
Nodes (70): apiDelete(), apiGet(), ENDPOINTS, useBackendSnapshot(), useBackendUninstall(), useCapability(), Features, useFeatures() (+62 more)

### Community 53 - "test_doctor.py"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (36): Return the full flag string for *profile*, expanding MTP when set.      When the, resolve_profile_flags(), §7.1a / ML-5: profile.mtp is informational only — resolve_profile_flags, profile.mtp=True alone (no explicit mtp_override) no longer         expands the, A profile that pins its own --spec-draft-* values keeps them; the MTP         bu, MTP_FLAG_BUNDLE constant is verbatim in the resolved string., TestResolveProfileFlags, _exec_line() (+28 more)

### Community 56 - "UpstreamRegistry"
Cohesion: 0.07
Nodes (55): Registry of all routing targets (slots + remote upstreams).      Loaded at start, UpstreamAlreadyExists, UpstreamRegistry, _async_false(), _async_true(), Any, LogCaptureFixture, MonkeyPatch (+47 more)

### Community 57 - "updater.py"
Cohesion: 0.06
...
### Community 58 - "cli.py"
Cohesion: 0.05
Nodes (69): build_parser(), cmd_devices(), cmd_eval(), cmd_history(), cmd_import_v1(), cmd_plan(), cmd_reindex(), cmd_results() (+61 more)

### Community 59 - "doctor_commands.py"
Cohesion: 0.05
Nodes (69): NextStep, check_hermes_ownership(), check_tree_group_share(), _dangling_registry_entries(), _deepest_mountpoint(), detect_editable_root(), doctor_migrations(), doctor_models() (+61 more)

### Community 60 - "resolve_by_capability"
Cohesion: 0.05
...
### Community 61 - "planner.py"
Cohesion: 0.06
Nodes (67): get_roster(), Per-model current decode/prefill/acc + config chip data.      The core is the ro, _compact_ts_to_iso(), _import_v1_index(), Convert generate_results_json.py's index.json records to schema-2., One server_ab timed run → a schema-2 Rep. Returns None for an errored run     (n, server-ab stamps are compact UTC (``20260704T212506Z``); normalise to the     IS, _sa_generative_record() (+59 more)

### Community 62 - "load_slot_config"
Cohesion: 0.04
...
### Community 63 - "UpstreamCall"
Cohesion: 0.04
Nodes (49): _default_fetch_models(), _default_is_online(), _filter_response_headers(), _join_url(), Any, AsyncClient, Request, Response (+41 more)

### Community 64 - "plan_fileset"
Cohesion: 0.06
Nodes (42): quant_from_filename(), Quant label from a filename token, or ``None`` when nothing matches.      Matche, _dirname(), _entry_bytes(), enumerate_repo(), FilesetEmpty, FilesetError, FilesetVariantNotFound (+34 more)

### Community 65 - "SqliteModelRegistry"
Cohesion: 0.06
Nodes (53): One normalised row of an HF repo tree listing., RawTreeEntry, Path, SqliteModelRegistry — SQLite-backed model catalog (ML-1 pilot).  Drop-in replace, Resolved registry directory (override or paths.registry_dir())., Derived TOML export path.          ``registry.toml`` is no longer the source of, No-op: SQLite has no mtime cache to invalidate.          Kept as a method so the, SQLite-backed model registry — the ML-1 pilot store.      Thread/process-safety: (+45 more)

### Community 66 - "FakeSlotManager"
Cohesion: 0.06
...
### Community 70 - "test_board_chat.py"
Cohesion: 0.12
Nodes (57): _FakeRequest, _final_response(), _make_app(), _multi_tool_response(), _PlatformRecorder, Any, Tests for the board chat orchestrator — src/hal0/api/routes/board_chat.py.  The, Like _Recorder but for hal0-api's OWN routes (no kanban prefix). (+49 more)

### Community 71 - "test_seam_check.py"
Cohesion: 0.06
Nodes (60): check_seams(), The privileged sudo seams every slot op and self-update runs through (#1465)., _check_file(), _default_stat(), grant_probe_argv(), probe_seam(), probe_seams(), Path (+52 more)

### Community 72 - "_RecordingSlotManager"
Cohesion: 0.07
...
### Community 74 - "load_capabilities_config"
Cohesion: 0.06
...
### Community 75 - "test_argv.py"
Cohesion: 0.05
Nodes (63): _canon(), _dedup(), _deny_managed_flags(), _deny_slot_hardware_flags(), FlagProvenance, _is_flag(), normalize_argv(), NormalizedArgv (+55 more)

### Community 76 - "connections.jsx"
Cohesion: 0.06
...
### Community 77 - "connect"
Cohesion: 0.06
Nodes (41): _QueueItem, Path, connect(), db_path(), Connection, Path, SQLite connection + transaction helpers — the hal0 ``db/`` foundation.  One conn, Wrap a write in an explicit ``BEGIN IMMEDIATE`` … ``COMMIT``/``ROLLBACK``. (+33 more)

### Community 78 - "Path"
Cohesion: 0.04
Nodes (65): _apply_config_set(), _copy_plugin_tree(), _copy_wrapper(), _dirs_identical(), _ensure_hermes_config(), _ensure_supported_python(), _fmt_config_value(), _hal0_service_home() (+57 more)

### Community 79 - "FakeSlotManager"
Cohesion: 0.06
Nodes (56): active_tools_for(), chat_slot_has_tool_calling(), Dynamic per-request tool filtering — plan §7.3.  Given the active chat slot and, Return True iff the chat slot's model is allowed to see tools.      Per plan §7., Return the filtered tool list for a chat slot, per plan §7.3.      Args:, FakeSlotManager, _loaded_slot_from_config(), _model_id_of() (+48 more)

### Community 80 - "test_mcp_routes.py"
Cohesion: 0.06
Nodes (58): app(), _build_app(), client(), _FakeAnn, _FakeMcpServer, _FakeTool, _filesystem_manifest_dict(), Any (+50 more)

### Community 81 - "useLogs.ts"
Cohesion: 0.04
Nodes (39): react, appendEntry(), entryKey(), parseRawLevel(), buildJournalQuery(), JournalEntry, JournalLevel, JournalSource (+31 more)

### Community 82 - "__init__.py"
Cohesion: 0.06
Nodes (58): AbstractEventLoop, _auto_resume_interrupted_pulls(), _boot_audit_store(), _boot_background_tasks(), _boot_brain_lane(), _boot_capabilities(), _boot_dispatcher(), _boot_mcp_memory_call() (+50 more)

### Community 83 - "installer.py"
Cohesion: 0.05
...
### Community 85 - "test_discover.py"
Cohesion: 0.06
Nodes (63): prune_missing(), Remove registry rows whose backing path no longer exists on disk.      A row is, Discover candidates under ``cfg.roots`` and register the new ones.      Returns, scan_and_register(), model_root(), ModelRegistry, Path, Tests for hal0.registry.discover — filesystem scan + auto-register. (+55 more)

### Community 86 - "StackApplyEngine"
Cohesion: 0.07
...
### Community 87 - "errors.py"
Cohesion: 0.05
Nodes (58): RequestValidationError, activate_agent_persona(), get_agent_persona(), list_agent_personas(), _persona_detail(), _persona_summary(), PersonaUpdateBody, Any (+50 more)

### Community 88 - "test_memory.py"
Cohesion: 0.07
...
### Community 90 - "Any"
Cohesion: 0.05
Nodes (61): _build_brain_identity_card(), _build_identity_card(), _collect_capability_rollup(), _collect_chat_slots(), _detect_foreign_gateways(), _fetch_slots(), _find_named_ready_slot(), _find_slot() (+53 more)

### Community 91 - "_ArbiterSlotManager"
Cohesion: 0.07
...
### Community 92 - "Check"
Cohesion: 0.06
Nodes (59): build_all_checks(), check_auth_posture(), check_hal0_target(), check_migrations(), check_model_store(), check_ports(), doctor_all_cmd(), _exit_code() (+51 more)

### Community 93 - "paths.py"
Cohesion: 0.06
...
### Community 94 - "models_service.py"
Cohesion: 0.06
Nodes (60): Model ids referenced by any configured slot or any stack.      Union of: each sl, referenced_model_ids(), add_from_path(), auto_scan_and_register(), cascade_delete_model(), clear_slot_default(), comfyui_category(), commit_scan_rows() (+52 more)

### Community 95 - "_client"
Cohesion: 0.08
...
Cohesion: 0.06
Nodes (34): HealthCheck, Mount, Provider abstract base class.  A Provider encapsulates the logic for a single in, Normalise a ``Mount`` or a legacy ``(src, dst)`` tuple to ``Mount``.          A, A podman ``--health-*`` override for a slot container.      The toolbox images b, Return the ``--health-*`` podman-run flags in a stable order., Return the Podman Quadlet ``Health*=`` keys in a stable order.          The decl, Typed launch plan for a container-per-slot Quadlet unit.      Carries everything (+26 more)

### Community 97 - "run_tool_loop"
Cohesion: 0.06
Nodes (51): DispatchFn, OnEvent, chat_command(), _handle_think_command(), _iter_brain_sse_events(), _iter_stream_events(), _post_completions(), Any (+43 more)

### Community 98 - ".uninstall"
Cohesion: 0.06
...
### Community 99 - "HardwareStats"
Cohesion: 0.06
Nodes (44): HardwareStats, _port_in_use(), Path, Return current GPU compute utilisation as a fraction [0.0, 1.0].          AMD: r, Return current GPU VRAM usage in MiB.          On AMD UMA (Strix Halo) returns m, Return total GPU VRAM in MiB (or GTT pool on UMA)., Return current system RAM used in GiB (MemTotal - MemAvailable)., Return current system RAM available in GiB (MemAvailable). (+36 more)

### Community 100 - "test_hermes_provision.py"
Cohesion: 0.04
...
### Community 105 - "test_profile_derive.py"
Cohesion: 0.06
...
### Community 107 - "Any"
Cohesion: 0.05
Nodes (47): _artefact_token(), _best_effort_model_info(), _binary_runner(), _container_runtime(), _effective_backend_and_device_class(), _effective_parallel(), _effective_runner(), _llama_argv_segments() (+39 more)

### Community 108 - "test_contract_compatibility.py"
Cohesion: 0.05
Nodes (18): test_frozen_provider_profile_shape_matches_our_fields(), test_profile_round_trips_through_frozen_registration_seam(), Compatibility freeze for the supported official Hermes release.  Every assertion, test_memory_loader_layout_and_registration_collector(), test_provider_profile_discovery_fields_are_frozen(), test_provider_registration_name_override(), test_provider_registration_seam_signatures(), test_provider_uses_chat_completions_contract() (+10 more)

### Community 109 - "flm.py"
Cohesion: 0.05
Nodes (50): _classify_flm_model(), _ensure_flm_models_dir(), ensure_host_flm_store_link(), _extract_json_object(), flm_host_async_spawn(), flm_host_spawn_kwargs(), flm_id_to_tag(), flm_pull_command() (+42 more)

### Community 110 - "LlamaServerProvider"
Cohesion: 0.06
...
### Community 111 - "test_pull_routes.py"
Cohesion: 0.08
Nodes (54): app_isolated(), client_isolated(), Any, FastAPI, Path, TestClient, Route tests for /api/models/{id}/pull*.  The real ``run_pull`` body is patched s, Add-by-HF-coords flow — POST a body with hf_repo + hf_filename and     the pull (+46 more)

### Community 112 - "test_redact.py"
Cohesion: 0.05
...
### Community 115 - "test_update_cosign_pin.py"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (36): ModelRegistry, Path, SlotManager, ChangeSet, FileState, fold_ctx_size_alias(), _known_field_names(), Any (+28 more)

### Community 117 - "test_providers_routes.py"
Cohesion: 0.10
...
### Community 119 - "ComfyUIProvider"
Cohesion: 0.07
Nodes (42): ComfyUIInferError, ComfyUIProvider, Any, AsyncClient, ContainerSpec, ComfyUIProvider — Stable-Diffusion-family image generation backend.  ComfyUI is, ComfyUI inference call failed., Provider for ComfyUI (Stable Diffusion family) image generation.      Health pro (+34 more)

### Community 120 - "FakeContainerProvider"
Cohesion: 0.06
...
### Community 122 - "test_setup_install.py"
Cohesion: 0.06
...
### Community 123 - "test_hindsight_provider.py"
Cohesion: 0.07
Nodes (40): Hal0Reranker, Async reranker over hal0-api's OpenAI surface (Cohere-style ``/v1/rerankings``)., Fake404HindsightClient, FakeHindsightClient, FakeReranker, HindsightProvider unit tests — bank mapping + fan-out (P1)., Reverses input order so we can prove the merge re-ranked the union., Records calls; returns canned recall/retain/delete results. (+32 more)

### Community 124 - "SlotStateRecord"
Cohesion: 0.06
Nodes (45): Push a record onto every active SSE subscriber queue., Async generator yielding every slot state transition as it happens.          Use, Any, Path, Serialisable snapshot of a slot's lifecycle state on disk.      Stored as JSON a, Persist a SlotStateRecord atomically.      Tier 1 fix: matches the env-file patt, Read a state.json file.  Returns None when the file does not exist.      A malfo, read_state() (+37 more)

### Community 125 - "portable.py"
Cohesion: 0.07
Nodes (38): _checksum(), export_envelope(), import_stack(), ModelResolution, parse_envelope(), Any, ModelRegistry, Path (+30 more)

### Community 126 - "test_pve.py"
Cohesion: 0.07
...
### Community 127 - "agent_commands.py"
Cohesion: 0.05
Nodes (50): agent_install(), agent_log(), _agent_provision_state_file(), agent_reprovision(), agent_status(), agent_upgrade(), _approval_summary(), bootstrap_hermes() (+42 more)

### Community 128 - "test_npu_swap_status.py"
Cohesion: 0.08
...
### Community 129 - "get_runner"
Cohesion: 0.07
Nodes (40): Return the FLM toolbox image reference.          Resolution (§7.1b / ML-4): ``sl, Return the Kokoro toolbox image reference.          Resolution (§7.1b / ML-4): `, Return the Qwen3-TTS toolbox image reference.          Resolution (§7.1b / ML-4), get_runner(), RUNNER_IMAGES — the runner-image registry (plan §7.1b / ML-4).  Before this modu, Look up a runner by key, or raise :class:`~hal0.errors.NotFound`., Resolve ``runner`` to a pull-ready image ref.      Precedence: ``HAL0_TOOLBOX_IM, The HW-gated llama-server runner for a ``(backend, device_class)`` pair.      Re (+32 more)
...
### Community 131 - "test_v1_audio.py"
Cohesion: 0.07
Nodes (48): _api_env_path(), client(), FastAPI, MonkeyPatch, Path, TestClient, Tests for the /api/providers credential write route (Phase 8 closeout).  Covers, Upstream declares auth_value_env=OPENROUTER_API_KEY; the writer     refuses to l (+40 more)

### Community 132 - "test_agent_install_hermes.py"
Cohesion: 0.05
...
### Community 133 - "._cfg"
Cohesion: 0.09
Nodes (13): _cfg(), AgentConfig, MonkeyPatch, Path, ``_is_ready`` accepts 2xx AND any HTTP error response as 'reachable'.      The h, test_render_context_dispatch_calls_render(), TestAgentConfig, TestCmdReprovision (+5 more)

### Community 134 - "hal0 rework plan — reader's copy"
Cohesion: 0.04
...
### Community 135 - "run_migrations"
Cohesion: 0.06
Nodes (37): Migration, _deep_copy_dict(), latest_version(), MigrationError, Any, hal0.config.migrations — versioned config migration transforms.  # TIER3: config, # NOTE: downgrade migrations are explicitly unsupported in v1., Read ``meta.schema_version`` from a raw config dict, defaulting to 1. (+29 more)

### Community 136 - "test_auth_rotate.py"
Cohesion: 0.09
...
### Community 137 - "migrate_slot_toml"
Cohesion: 0.07
...
### Community 140 - "test_exposure.py"
Cohesion: 0.06
Nodes (45): BaseRoute, Matcher, classify(), _exact(), match_rule(), _outside_api_v1_mcp(), _prefix(), Route -> :class:`AuthClass` classification table (KB-1 / §1, seam S9).  Single s (+37 more)

### Community 141 - "§21.4 `hal0 doctor` rework + support bundle — implementation spec"
Cohesion: 0.04
...
### Community 146 - "write_openwebui_env"
Cohesion: 0.07
Nodes (45): Path, _quote_value(), Atomic environment file writer.  write_env_atomic() is the only correct way to w, Quote a value if it contains shell-special characters.      Uses double-quotes a, Write an environment file atomically.      Writes the key=value pairs in env_dic, write_env_atomic(), default_openwebui_env(), _default_path() (+37 more)

### Community 147 - "BadRequest"
Cohesion: 0.06
Nodes (27): BadRequest, 400 — the request was syntactically or semantically invalid.      Use this for c, 400 when a slot-config write body carries a MODEL-owned key.      ``mtp`` / ``en, reject_model_owned_slot_keys(), MonkeyPatch, Unit tests for :mod:`hal0.mcp.manifest` — #224 install-from-URL resolver., Loopback hostnames + 127.0.0.1 literals must short-circuit pre-fetch., RFC 1918 ranges (10/8, 172.16/12, 192.168/16) must reject pre-fetch. (+19 more)

### Community 148 - "pull_jobs.py"
Cohesion: 0.08
Nodes (47): build_stream_response(), cancel(), delete(), emit_terminal_pull_event(), enqueue(), enqueue_update(), eta_s(), list_all() (+39 more)

### Community 149 - "test_comfyui_proxy.py"
Cohesion: 0.15
...
### Community 150 - "test_board_chat_tool_use_e2e.py"
Cohesion: 0.13
Nodes (42): _collect(), _collect_with_payload(), _fake_request(), _fast_approval_wait(), _final(), _parse(), _persona_root(), Any (+34 more)

### Community 151 - "useAgents.ts"
Cohesion: 0.07
Nodes (41): apiPut(), AgentList, AgentRecord, AgentRestartResult, AgentSkill, AgentSkillsResponse, ApprovalEntry, ApprovalList (+33 more)

### Community 152 - "PART 0 — current-state map of scattered metrics (file:line)"
Cohesion: 0.04
...
### Community 153 - "slot_flags_fold.py"
Cohesion: 0.06
...
### Community 155 - "build_auto_selections"
Cohesion: 0.07
...
### Community 156 - "StacksCatalog"
Cohesion: 0.08
Nodes (19): load_stacks_config(), Load and validate /etc/hal0/stacks.toml.      Returns the built-in seed stacks (, Path, StacksCatalog — read and mutate the stack catalog through one interface.  A stac, A stack plus derived fields (slug + seed flag) for API/UI consumption., Read and mutate the stack catalog through one interface., Replace the stack body wholesale (PUT semantics)., ResolvedStack (+11 more)

### Community 157 - "slot_instance_token"
Cohesion: 0.06
Nodes (34): CompletedProcess, Path, The systemd **service** name for a slot (``systemctl`` verbs target it)., The Quadlet ``.container`` source file this slot's unit is written to., Run a subprocess synchronously (load/unload are blocking ops anyway).          P, Write the Quadlet ``.container`` file, daemon-reload, start.          The Quadle, Render the desired Quadlet ``.container`` text for a slot — the ONE renderer., Write systemd unit, daemon-reload, enable, start (synchronous).          Called (+26 more)

### Community 158 - "_llama_launch_plan"
Cohesion: 0.06
...
### Community 160 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.04
...
### Community 161 - "Hal0MemoryProvider"
Cohesion: 0.08
...
### Community 162 - "orchestrate.py"
Cohesion: 0.07
Nodes (45): _activate_slot_model(), apply_setup(), _build_slot_cfg(), _clamp_context_size(), _colocated_flm_store(), _ensure_registry_entry(), _free_space_gib(), install_extension() (+37 more)

### Community 163 - "Qwen3TTSProvider"
Cohesion: 0.07
...
### Community 166 - "CapabilityOrchestrator"
Cohesion: 0.07
Nodes (30): Fire-and-forget trigger to refresh the Hermes live-context files.  Called from t, Spawn a detached ``hal0-agent <agent_id> render-context``. Never raises., spawn_context_refresh(), CapabilityApplyFailed, CapabilityOrchestrator, child_to_slot(), legal_children(), Any (+22 more)

### Community 167 - "evalrun.py"
Cohesion: 0.09
...
### Community 168 - "AgentMetadataConfig"
Cohesion: 0.06
...
### Community 169 - "TestUpstreamEntry"
Cohesion: 0.05
Nodes (16): ModelConfig, [model] section in a slot TOML.      Specifies which model the slot loads by def, [server] section in a slot TOML.      Currently carries only ``extra_args`` — a, Reject non-env-var-name keys and multi-line values.          A stray newline in, ServerConfig, _declared_provider(), Path, Unit tests for hal0.config.schema pydantic models.  Each validator gets exercise (+8 more)

### Community 170 - "PortAuthority"
Cohesion: 0.09
...
### Community 171 - "json"
Cohesion: 0.06
Nodes (17): json(), hermes(), IDLE_PRIMARY, mockAgents(), AuthOpts, installAuth(), captureBulk(), CAPS_MOCK (+9 more)

### Community 172 - "hal0 R5 live install-validation — findings (stamp r5v1)"
Cohesion: 0.05
...
### Community 173 - "§7.1d — Capability / Modality Taxonomy untangle (ML-6)"
Cohesion: 0.05
...
### Community 174 - "Hal0MemoryProvider"
Cohesion: 0.08
...
### Community 175 - "driver.py"
Cohesion: 0.06
Nodes (31): _as_text(), _probe_hermes_provisioned(), _probe_systemd_unit_active(), _probe_tcp_port(), _probe_wrapper_installed(), Any, Path, Hermes-Agent driver.  Hermes is user-owned upstream — and crucially, the user ca (+23 more)

### Community 176 - "memory.py"
Cohesion: 0.11
Nodes (43): _agent_id(), _augment_build_counters(), _bank_failed_op_ids(), _enabled_llm_slots(), graph_status(), _is_private(), memory_add(), memory_delete() (+35 more)

### Community 177 - "runner.py"
Cohesion: 0.08
Nodes (42): _assemble(), _classify(), _clear_stale_sweep(), describe_worklist(), fetch_host(), _friendly_gpu(), _get_json(), _gpu_slot_serving() (+34 more)

### Community 178 - "GPUMemorySample"
Cohesion: 0.10
Nodes (42): _empty(), GPUMemorySample, _max_pool(), _nvidia_query_mb(), _parse_pct(), Path, GPU memory view — one typed sample owning the live GPU memory surface.  Issue #7, Take a point-in-time GPU memory + utilization sample.      With no arguments, de (+34 more)

### Community 179 - "MemoryProvider"
Cohesion: 0.06
Nodes (27): AddResult, DeleteResult, GraphStatus, ListPage, MemoryItem, MemoryProvider, Mode, Any (+19 more)

### Community 180 - "test_model_fallback.py"
Cohesion: 0.10
...
### Community 182 - "test_hal0_provider_plugin.py"
Cohesion: 0.09
...
### Community 183 - "_dispatcher"
Cohesion: 0.09
Nodes (25): _container_upstream(), _dispatcher(), _FakeModels, _FakeUpstreams, _patch_alias_map(), Any, MonkeyPatch, Two slots, one model id — selection must prefer a healthy slot (#1418).  On lxc1 (+17 more)

### Community 184 - "_write_fixture"
Cohesion: 0.12
...
### Community 185 - "Enum"
Cohesion: 0.07
Nodes (40): Enum, auth_require(), KeyTier, hal0 auth subcommands — thin HTTP client to /api/auth/*.  §5.2 of the R5 sync as, Persist the [security].require_auth posture (PUT /api/auth/require)., RequireToggle, config_edit(), config_migrate() (+32 more)

### Community 186 - "FakeMemoryProvider"
Cohesion: 0.06
...
### Community 187 - "_write_diagnostics_section"
Cohesion: 0.10
...
### Community 188 - "images"
Cohesion: 0.08
Nodes (35): images(), _parse_repos(), PodmanImagesResult, CompletedProcess, _RunFn, podman_introspect — read-only podman introspection through the ROOTFUL context s, The local ``registry/repo`` set, from root's store when reachable.      Only ATT, ``podman images`` output + which store it actually came from. (+27 more)

### Community 189 - "GpuArbiter"
Cohesion: 0.09
...
### Community 190 - "test_agent_uninstall_memory.py"
Cohesion: 0.09
...
### Community 192 - "StackConfig"
Cohesion: 0.10
Nodes (23): One ``[stack.<slug>]`` entry in stacks.toml.      A curated bundle of slots + em, StackConfig, Pre-apply sanity check: flag entries whose profile/model won't resolve., StackCapabilityRow, TestStackConfig, Records capability apply() calls., RecordingOrchestrator, _engine() (+15 more)

### Community 193 - "test_kb1_hardening_tail.py"
Cohesion: 0.07
...
### Community 194 - "container_enrichment"
Cohesion: 0.12
...
### Community 195 - "test_personas.py"
Cohesion: 0.08
...
### Community 197 - "test_slots_image_pull.py"
Cohesion: 0.09
...
### Community 198 - "test_update_commands.py"
Cohesion: 0.07
...
### Community 199 - "hal0 — Official prerelease release channel"
Cohesion: 0.05
...
### Community 202 - "test_hermes_provision_mcp_auth.py"
Cohesion: 0.10
...
### Community 203 - "test_v1_npu_trio_routing.py"
Cohesion: 0.09
...
### Community 204 - "test_slot_aliases.py"
Cohesion: 0.05
...
### Community 205 - "test_unit_files.py"
Cohesion: 0.05
...
### Community 206 - "Benchmarks.tsx"
Cohesion: 0.09
Nodes (36): BENCH_OPTIONS, Benchmarks(), BenchOption, CAP_ALIAS, CAP_COLOR, CAP_SVG, CellRow, cellTd (+28 more)

### Community 207 - "R5 sync assessment — how far every surface is from "back in sync" (2026-07-19)"
Cohesion: 0.05
...
### Community 210 - "resolve_gpu_group_ids"
Cohesion: 0.07
Nodes (25): Build the GPU/llama-server :class:`RuntimeLaunchPlan` for a slot.          This, Return the freshly-rendered runtime command for drift checks.          This is t, _device_node_for_group(), gpu_visibility_env(), is_nvidia_gpu_device(), nvidia_cdi_devices(), _probed_gpu_group_gids(), Shared helpers for GPU device + group exposure to provider containers.  Lives he (+17 more)

### Community 211 - "test_model_store.py"
Cohesion: 0.10
...
### Community 213 - "test_chat_proxy_auth.py"
Cohesion: 0.07
...
### Community 216 - "_shared.py"
Cohesion: 0.08
Nodes (36): board_move(), Move a task to a different lane (PATCH /api/board/tasks/{id})., _add_write_rows(), disable_cmd(), enable_cmd(), graph_disable_cmd(), hal0 memory subcommands — graph-extraction gate.  Mirrors the slot / model CLI s, Render the retain-pipeline rows for ``hal0 memory status`` (#1420). (+28 more)

### Community 217 - "plan_slot_flags_fold"
Cohesion: 0.10
...
### Community 219 - "recommend_primary_slot"
Cohesion: 0.10
...
### Community 220 - "test_modality.py"
Cohesion: 0.10
...
### Community 221 - "find_candidates"
Cohesion: 0.08
Nodes (36): CuratedModel, Every curated model must have a deployable source: either HF pull         coordi, One curated entry surfaced by the FirstRun wizard.      The wizard renders these, backfill_coordless(), CandidateModel, find_candidates(), _guess_capability(), _is_mmproj_sidecar() (+28 more)

### Community 222 - "RoutingHost"
Cohesion: 0.10
Nodes (28): See :func:`hal0.slots.routing.loaded_slot_from_config`., See :func:`hal0.slots.routing.loaded_slot`., See :func:`hal0.slots.routing.resolve_for_request`., add_slot(), default_slot_for(), loaded_slot(), loaded_slot_from_config(), LoadedSlot (+20 more)

### Community 223 - "test_typed_errors.py"
Cohesion: 0.10
Nodes (37): app(), app_with_slot(), client(), _Color, FastAPI, Hal0Error, MonkeyPatch, TestClient (+29 more)

### Community 224 - "_Client"
Cohesion: 0.08
...
### Community 226 - "Appendix: raw area reports"
Cohesion: 0.05
...
### Community 227 - "_refresh_model_cache_on_ready"
Cohesion: 0.09
Nodes (34): _fetch_hal0_composite_models(), _hal0_model_cache_clear(), _prime_hal0_composite_cache(), SlotManager, Punch the composite catalogue's cached model list.      Exposed so slot-swap / s, Aggregate every ready chat-capable slot's model id into one catalogue.      Dire, Warm the ``model_cache["hal0"]`` bucket via a direct slot-config read.      No p, Re-fetch ``model_cache[slot]`` whenever a slot transitions to ready.      The ca (+26 more)

### Community 228 - "test_v1_chat_slot_alias.py"
Cohesion: 0.12
Nodes (32): hal0_chat_slot_alias_map(), Return ``{slot_alias: model_id}`` for model-bound llm slots.      The slot **ali, Translate a chat-slot ALIAS in ``body["model"]`` to its model id.      hermes-ro, _rewrite_chat_slot_alias(), _FakeApp, _FakeRequest, _FakeSlotManager, _npu_flm_slot() (+24 more)

### Community 229 - "test_openrouter_auth_loopback.py"
Cohesion: 0.09
...
### Community 230 - "test_model_meta.py"
Cohesion: 0.06
...
### Community 231 - "_resolve_llama_scalars"
Cohesion: 0.13
Nodes (35): Resolve every llama-server launch scalar for a slot+model+profile.      SINGLE S, _resolve_llama_scalars(), _cuda_profile(), _extra_args(), _mtp_tagged_model(), _plain_model(), §7.1a / ML-5: mtp/jinja as RUNNER-gated capabilities injected by ``_resolve_llam, profile.mtp is inert; AUTO fires via the registry tag AND     runner.supports.mt (+27 more)

### Community 232 - ".from_tag"
Cohesion: 0.08
Nodes (31): base_matches(), base_version(), channel_for_tag(), nightlies_to_prune(), nightly_tag(), nightly_version(), Release-channel helpers shared by the release + nightly workflows.  Pure functio, Return the release channel implied by a git tag.      Delegates to :class:`hal0. (+23 more)

### Community 233 - "test_memory_graph_route.py"
Cohesion: 0.13
...
### Community 235 - "test_pulling_serving_idle.py"
Cohesion: 0.11
...
### Community 237 - "§17 installer/setup overhaul — edit-plan (thin shell + thick Python, one profile authority, one slot roster)"
Cohesion: 0.06
...
### Community 238 - "P3 slot-identity + ports — implementation spec"
Cohesion: 0.06
...
### Community 239 - "Hal0Error"
Cohesion: 0.13
Nodes (34): Hal0Error, bank_document_transfer_export(), bank_document_transfer_import(), bank_subgraph(), _client(), delete_bank(), _delete_preview(), engine_status() (+26 more)

### Community 240 - "hal0 — Plan"
Cohesion: 0.06
...
### Community 246 - "test_slot_migrate_id_keying.py"
Cohesion: 0.10
Nodes (34): _active_hal0_units(), _backup_slot_state(), _migrate_id_keying_dry_run_plan(), Any, CompletedProcess, Path, One-shot: unwind the flags-fold — hardware sticks to SLOTS (spec-hw-slot-ownersh, Every hal0-owned systemd unit currently active: ``hal0-api.service``     plus an (+26 more)

### Community 247 - "pve.py"
Cohesion: 0.09
...
### Community 248 - "test_route_to_chat.py"
Cohesion: 0.09
...
### Community 249 - "_resolve_image_ref"
Cohesion: 0.10
...
### Community 250 - "test_update_check.py"
Cohesion: 0.09
...
### Community 251 - "SlotIdentityStore"
Cohesion: 0.13
Nodes (19): Connection, Row, Slot identity store — the id ⇄ name bridge (rework §11.1).  Every slot gets a st, Insert a new slot row and return it (id assigned by SQLite).          ``slot.ena, Change a slot's display label. References key off id, so this is         the *en, Drop the slot row. ``slot_link`` children cascade; ``port_claim``         rows k, ``name → id`` or raise :class:`SlotNotFound`., Record a parent→child edge (idempotent on ``(parent, child, kind)``). (+11 more)

### Community 252 - "test_installer_routes.py"
Cohesion: 0.09
...
### Community 255 - "test_hf_token_secrets.py"
Cohesion: 0.06
...
### Community 257 - "SlotWatchdog"
Cohesion: 0.09
Nodes (18): ModelCacheCheck, PullRunner, Lock, Any, Lock, Slot, Push-driven failure detector (P3-slots §1b-watchdog).  ``SlotWatchdog`` polls a, Push-driven failure detector, against a narrow host seam. (+10 more)

### Community 258 - "AuditStore"
Cohesion: 0.10
...
### Community 259 - "hw_slot_ownership.py"
Cohesion: 0.10
...
### Community 261 - "SlotCrashLooping"
Cohesion: 0.14
Nodes (32): Load refused by the crash-loop breaker (issue i4).      A slot in ERROR is re-lo, SlotCrashLooping, _BusStub, _fail_load_once(), _pairs(), Any, FakeContainerProvider, Path (+24 more)

### Community 262 - "test_slots_container_state.py"
Cohesion: 0.09
...
### Community 264 - "FakeContainerProvider"
Cohesion: 0.08
...
### Community 268 - "test_doctor_json_diagnoses.py"
Cohesion: 0.10
Nodes (33): _diagnose_audit_rows(), _diagnose_migration(), _diagnose_models(), _diagnose_profiles(), Diagnosis, Assemble the §21.4 ``HAL0-MODEL-*`` Diagnosis rows from the evidence     ``docto, One ``HAL0-MIGRATION-PENDING`` row (always ``warn`` — operator-initiated),     o, §2.4: dangling slot→profile refs (fail) + un-pulled images (warn). (+25 more)

### Community 269 - "SlotLoading"
Cohesion: 0.11
...
### Community 271 - "test_metrics_prometheus_route.py"
Cohesion: 0.09
...
### Community 275 - "test_privileged_seam.py"
Cohesion: 0.11
Nodes (31): _envelope(), FakeRun, _install_root(), Any, CompletedProcess, Path, #1464 — self-update must work on the shipped ``User=hal0`` posture.  On a v1.0 b, The sudoers grant is pinned to the binary; the verb list is the allow-list. (+23 more)

### Community 276 - "types.py"
Cohesion: 0.09
Nodes (26): BaseException, Shared types for the hal0 Hermes transport., _resolve_pull_capability — capability + comfyui_subdir for a pull (P3).  The hel, _Reg, _req(), test_body_capability_wins(), test_curated_capability_and_subdir_fallback(), test_registry_capability_used_when_no_body() (+18 more)

### Community 277 - "browser_server.py"
Cohesion: 0.10
...
### Community 278 - "P3-routers: Thin the Mega-Routers Into Request→Service→Envelope Shells"
Cohesion: 0.06
...
### Community 282 - "profile.py"
Cohesion: 0.09
Nodes (21): hal0-provider — Hermes ``ProviderProfile`` plugin (canonical, shipped source)., Register the hal0 provider profile.      Prefers a ``PluginContext`` seam if one, register(), assemble_stream(), Hal0ProviderProfile, is_alias(), iter_sse_data(), parse_sse_chunks() (+13 more)

### Community 283 - "test_tts_capability_switch.py"
Cohesion: 0.07
Nodes (29): Return the TTS slot profile a device selection implies.      The engine switch:, tts_profile_for_device(), profile_name_for_fit(), Shared picker/apply profile-fit inference (device → runtime profile name).  Sing, Infer the runtime profile name implied by a picker/apply selection.      Keeps i, Any, voice.tts capability switch — Kokoro (CPU) vs Qwen3-TTS (GPU/ROCm).  The deferre, Write the canonical single ``tts`` slot in a known engine state. (+21 more)

### Community 284 - "build_request_metric_row"
Cohesion: 0.10
...
### Community 285 - "_spec_provider_for"
Cohesion: 0.09
Nodes (25): Probe GET /health on the container port.          For llama-server slots /health, Poll /health until 200 or HEALTH_TIMEOUT_S exceeded.          Raises:, Provider for a slot, or None for the GPU/llama-server default.      The runtime, _spec_provider_for(), _exec_argv(), Any, load_sync routes slots to their spec provider (FLM/NPU, Kokoro/TTS)., type=tts without explicit profile still routes through Kokoro.      The test sup (+17 more)

### Community 286 - "KokoroProvider"
Cohesion: 0.10
Nodes (27): KokoroProvider, Any, ContainerSpec, Informational env block (container is self-contained)., Not applicable — systemd starts the container., Build a ContainerSpec for the Kokoro TTS slot.          The toolbox image ENTRYP, Probe GET /health on the kokoro-server port.          NOTE: dead code in the con, Passthrough /v1/audio/speech to kokoro-server. (+19 more)

### Community 287 - "test_memory_admin_routes.py"
Cohesion: 0.17
Nodes (30): client(), TestClient, Tests for the Hindsight admin surface — /api/memory/engine + /api/memory/banks/*, #1024: an unconfirmed bank delete surfaces a dry-run item-count preview., Captures upstream requests; serves canned responses by (method, path)., _Recorder, test_bank_create_put_and_delete_forward(), test_bank_id_with_invalid_chars_400() (+22 more)

### Community 288 - "test_brain_injection.py"
Cohesion: 0.17
...
### Community 289 - "TestContainerSpec"
Cohesion: 0.13
...
### Community 290 - "Platform-wide cron/automation management — design"
Cohesion: 0.06
...
### Community 292 - "hal0 ROCmFPX quantization"
Cohesion: 0.06
...
### Community 293 - "write_toml_atomic"
Cohesion: 0.11
Nodes (17): OSError, load_manifest(), manifest_image_ref(), Write a TOML file atomically.      Mirrors hal0.config.env.write_env_atomic but, Load the release manifest.      `scripts/update-toolbox-digests.sh` patches `too, Return the pinned image reference for a toolbox image, if any.      Resolution:, write_toml_atomic(), Path (+9 more)

### Community 294 - "test_board_chat_admin_tools.py"
Cohesion: 0.12
...
### Community 295 - "detect"
Cohesion: 0.11
Nodes (22): detect(), DetectionResult, _filename_capability(), _heuristic_only(), _hf_repo_name_from_path(), Any, Path, quant_from_file_type() (+14 more)

### Community 296 - "test_hermes_provision_idempotency.py"
Cohesion: 0.11
...
### Community 297 - "_render_from_spec"
Cohesion: 0.10
Nodes (22): _exec(), _flm_spec(), Any, ContainerSpec, ContainerProvider NPU branch: spec-rendered units + FLM health fallback (Phase A, PublishPort is rendered declaratively from spec.port, not extra_args., FLM has no /health; 404 on /health + 200 on /v1/models → healthy., Connection-refused (no container) stays unhealthy even with fallback. (+14 more)

### Community 298 - "mockFixtures.ts"
Cohesion: 0.06
Nodes (15): BIG_HUBS, BIG_LINK_TYPES, BIG_TOPICS, buildCapabilities(), Builder, capabilityRow(), CONFIG_ENRICHMENT_KEYS, MEM_ENTITIES (+7 more)
...
### Community 301 - "Hal0MemoryClient"
Cohesion: 0.10
...
### Community 304 - "get_doctor"
Cohesion: 0.08
Nodes (23): DiagnosisOut, DoctorResponse, EvidenceOut, get_doctor(), NextStepOut, Diagnosis, Request, T (+15 more)

### Community 305 - "test_api_env_mode.py"
Cohesion: 0.08
Nodes (28): check_secret_file_modes(), Secret-bearing config files must not be group- or world-readable.      An indepe, MonkeyPatch, Path, Issue #1466: one mode for ``api.env``, honoured by every writer.  The live box c, The FIXME(phase4) row. While it said 0644 the engine reverted every     fix the, install.sh:919 ``chmod 0644 "${API_ENV_TMP}"`` — on the refresh branch     that, Both branches — the initial write and the idempotent refresh — must     land the (+20 more)

### Community 306 - "EventBus"
Cohesion: 0.10
...
### Community 307 - "ModelsConfig"
Cohesion: 0.09
Nodes (13): ModelsConfig, [models] section of hal0.toml — discovery + auto-detect., Empty means "env var / FLM default cache"; non-empty must be absolute., Roots the discovery scan actually walks: declared ``roots`` plus the         eff, Reject relative paths — discovery walks must start from an absolute root., Empty means "use pull_root"; non-empty must be absolute., Return the resolved model-store path consumers should point at.          Precede, MonkeyPatch (+5 more)

### Community 308 - "MetricsWriter"
Cohesion: 0.09
...
### Community 309 - "import_toml_to_sqlite"
Cohesion: 0.12
...
### Community 311 - "test_chat_normalization.py"
Cohesion: 0.10
Nodes (30): _make_request(), The loaded set is read from the cached upstream catalogs only —     no live /v1/, Build a minimal request stand-in.      ``loaded`` materialises as a container-ba, The loaded set derives from container-backed upstreams (``slot_name``     set):, O21 regression: SlotManager registers LOCAL container slots as     kind="slot" (, End-to-end O21 repro: [brain_chat] model="hal0/brain" with the brain     slot lo, Container slots register as kind='remote' (with slot_name) but are LOCAL —     t, The dashboard bug repro: a system message mid-array used to leave     `_normaliz (+22 more)

### Community 312 - "test_board_routes.py"
Cohesion: 0.10
Nodes (24): app_client(), audit(), _audit_actions(), _build_app(), FastAPI, TestClient, Tests for the /api/board/* router — src/hal0/api/routes/board.py.  hal0 now OWNS, No app.state.board_store pre-injected and hermes_kanban=None: the router     laz (+16 more)

### Community 313 - "test_doctor_all.py"
Cohesion: 0.08
...
### Community 314 - "test_preflight_gpu_gate.py"
Cohesion: 0.10
...
### Community 317 - "install_openwebui"
Cohesion: 0.11
...
### Community 318 - "update"
Cohesion: 0.10
Nodes (29): _dev_mode(), _fetch_slot_drift(), _interactive(), _poll_job(), _print_check(), _print_drift_banner(), Context, Path (+21 more)

### Community 319 - "Provider"
Cohesion: 0.08
Nodes (22): Provider, Any, ContainerSpec, Abstract base for a hal0 inference backend.      Concrete implementations: Conta, Compute the EnvironmentFile contents for a slot.          Returns a mapping of H, Return the argv list for spawning this backend outside systemd.          Mirrors, Run a health check against the backend on *port*.          Returns {"ok": bool,, Passthrough inference against the provider's OpenAI-compatible API.          Thi (+14 more)

### Community 320 - "test_agents_personas.py"
Cohesion: 0.15
...
### Community 323 - "test_brain_resilience.py"
Cohesion: 0.17
...
### Community 324 - "test_uninstall.py"
Cohesion: 0.10
...
### Community 325 - "test_bootstrap_prereq_parity.py"
Cohesion: 0.11
...
### Community 326 - "test_degrade_live.py"
Cohesion: 0.11
...
### Community 327 - "test_fail_watcher_warming.py"
Cohesion: 0.15
Nodes (28): _await_state(), fast_fail_watch(), _load_into_warming(), Any, FakeContainerProvider, MonkeyPatch, Path, SlotManager (+20 more)

### Community 328 - "board-chat-v3.spec.ts"
Cohesion: 0.08
Nodes (15): emitSseTyped(), emitWs(), installWsHarness(), waitForWs(), NOTE: addInitScript serialises the function — it must not close over, body(), engine(), pane() (+7 more)

### Community 329 - "SingleFlightGroup"
Cohesion: 0.08
...
### Community 330 - "P3-slots: Decomposition Spec for `slots/manager.py`"
Cohesion: 0.07
...
### Community 332 - "repository.py"
Cohesion: 0.10
Nodes (28): blob_referents(), bump_blob_ref(), drop_blob_ref(), get_blob(), insert_blob(), insert_model_file(), list_model_files(), model_to_row() (+20 more)

### Community 333 - "slot_write_lock"
Cohesion: 0.12
Nodes (21): device_to_backend(), Map hal0's ``device`` enum onto the recipe+backend pair.      Args:         devi, Hold the coarse cross-process lock for ALL slots/*.toml writes.      Historicall, slot_write_lock(), apply_preferred_profile(), defuse_stale_mtp_on_swap(), preferred_profile_for(), profile_fits_slot() (+13 more)
...
### Community 336 - "test_hal0_memory_client.py"
Cohesion: 0.10
...
### Community 337 - "test_config_urls.py"
Cohesion: 0.10
...
### Community 338 - "FakeUpstreamRegistry"
Cohesion: 0.13
...
### Community 339 - "test_admin_route_map_nested.py"
Cohesion: 0.10
Nodes (28): _FakeIncludedRouter, _FakeLeaf, _OpaqueRoute, The route-map walker must survive FastAPI's include_router restructuring.  Found, An unknown wrapper shape degrades to "not a tool", never to a crash., Depth-bounded: a cycle must not hang the boot path., Gap-2 excludes must not be bypassed just because a route was wrapped., Version-agnostic end-to-end: a genuinely included router must be found     which (+20 more)
...
### Community 344 - "merge_slot_config"
Cohesion: 0.11
...
### Community 345 - "test_pressure_eviction.py"
Cohesion: 0.20
...
### Community 346 - "useDiagnoses.ts"
Cohesion: 0.11
Nodes (23): Confidence, CONFIDENCES, Diagnosis, DoctorFeed, Evidence, hardwareEvidence(), mb(), NextStep (+15 more)

### Community 347 - "Recommended hal0 ideas"
Cohesion: 0.07
...
### Community 348 - "hal0 Hermes Integration Suite Implementation Plan"
Cohesion: 0.07
...
### Community 354 - "test_config_drift_aliases.py"
Cohesion: 0.12
Nodes (26): _argv_values(), Return the last value for each flag key in argv, alias-aware.      Both the requ, FakeContainerProvider, MonkeyPatch, Path, Config-drift comparison is flag-alias aware.  ``_argv_values`` used to compare r, O25 follow-up: a running container serving a STALE --ctx-size (e.g. 4096)     wh, #1226: a slot created with a registry id must not permanently warn.      The ren (+18 more)

### Community 355 - "test_agent_restart_endpoint.py"
Cohesion: 0.18
...
### Community 356 - "TestClient"
Cohesion: 0.17
Nodes (11): MonkeyPatch, Path, TestClient, Happy path: workflow file found, POSTed to /prompt, 202 returned., If primary dir has no match, fall back to user/default/workflows/., Ensure /status fields needed by the pane are present and well-formed., gpu_busy_percent is forced-high artifact — util must be 0/None when idle., it/s, eta, step require a future ComfyUI websocket subscription. (+3 more)

### Community 357 - "test_models_add_from_path.py"
Cohesion: 0.14
...
### Community 358 - "test_models_default.py"
Cohesion: 0.15
...
### Community 359 - "test_npu_occupancy.py"
Cohesion: 0.15
...
### Community 363 - "test_router_loop.py"
Cohesion: 0.19
...
### Community 364 - "test_event_contract.py"
Cohesion: 0.15
...
### Community 365 - "test_migrate_haloai.py"
Cohesion: 0.15
...
### Community 366 - "test_npu_exclusivity.py"
Cohesion: 0.12
Nodes (26): Path, NPU exclusivity validation in SlotManager (PR-11, plan §5.3, ADR-0008 §5).  The, The operator-facing text must describe the real remedy: clear the model., A model-less second NPU LLM slot may coexist with the bound anchor., A model-less peer isn't an anchor, so it can't be the conflicting slot.      The, device=gpu-rocm slots are unaffected by NPU exclusivity., Only ``type=llm`` slots claim the AMDXDNA chat context.      The FLM trio (stt-n, Updating the lone NPU LLM slot's own fields does NOT trip the guard.      The gu (+18 more)

### Community 367 - "agents.mdx"
Cohesion: 0.08
...
### Community 369 - "ML-4 (runner-image registry) + ML-5 (flag resolution) — implementation-ready spec"
Cohesion: 0.08
...
### Community 370 - "R5 — Surface + launch"
Cohesion: 0.08
...
### Community 371 - "put_dashboard_layout"
Cohesion: 0.11
...
### Community 372 - "test_secrets_protected_keys.py"
Cohesion: 0.12
...
### Community 373 - "ChatSession"
Cohesion: 0.14
Nodes (23): ChatSession, In-memory REPL state: the running ``messages`` history + knobs.      Kept as a p, _FakeClient, MonkeyPatch, Tests for ``hal0 chat`` (§21.14) — the terminal REPL over /v1/chat/completions., The context-bloat guarantee: after N turns with reasoning on, history     holds, Stand-in for httpx.Client — the turn helpers only need a placeholder     object, The brain SSE frame shape (``{"type": ...}``) is distinct from the     OpenAI `` (+15 more)

### Community 374 - "test_doctor_profiles.py"
Cohesion: 0.10
...
### Community 375 - "perms.py"
Cohesion: 0.12
Nodes (22): _apply_one(), audit_rows(), _child_mode_for(), commit(), _expand_row(), _group_name(), observe(), _owner_name() (+14 more)

### Community 376 - "admin.py"
Cohesion: 0.13
Nodes (25): _audit(), build_server(), _call_rest(), dispatch(), _execute_tool(), _format_url(), is_gated(), Any (+17 more)

### Community 377 - "HindsightRestClient"
Cohesion: 0.10
Nodes (12): HindsightRestClient, Any, AsyncClient, The resolved daemon root — read-only; callers must not retarget         a live c, Generic authenticated forward to any Hindsight REST path.          The admin sur, _HindsightStubProvider, HindsightRestClient REST-path tests against a MockTransport (P1)., A deterministic ``<agent>:<session_id>`` document id (colon) must be     percent (+4 more)

### Community 378 - "MemoryNamespaceError"
Cohesion: 0.14
...
### Community 379 - "evaluate_model_fit"
Cohesion: 0.13
...
### Community 382 - "test_hermes_executor.py"
Cohesion: 0.18
...
### Community 383 - "test_agent_approvals_list.py"
Cohesion: 0.09
...
### Community 384 - "test_slot_create_flags.py"
Cohesion: 0.11
...
### Community 386 - "test_comfyui_container_spec.py"
Cohesion: 0.11
...
### Community 389 - "test_id_keying.py"
Cohesion: 0.20
...
### Community 392 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 393 - "What You Must Do When Invoked"
Cohesion: 0.08
Nodes (24): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+16 more)

### Community 394 - "hal0 benchmarking system — full design (batch runs, rich run detail, display, auto-update)"
Cohesion: 0.08
...
### Community 396 - "read_gguf_header"
Cohesion: 0.18
...
### Community 397 - "migrate-haloai.py"
Cohesion: 0.16
Nodes (24): AllowEntry, build_model(), _build_parser(), _ensure_empty_or_force(), _hub_dirname(), load_allowlist(), main(), migrate() (+16 more)

### Community 398 - "hal0_slot_alias_models"
Cohesion: 0.12
Nodes (22): _coerce_ctx(), hal0_apply_registry_detail(), hal0_chat_slot_model_ids(), hal0_llm_slot_views(), hal0_slot_alias_models(), _model_recipe(), Any, ModelRegistry (+14 more)

### Community 399 - "health.py"
Cohesion: 0.12
Nodes (23): _disk_free_mb(), get_status(), health(), health_system(), list_features(), _memory_degraded(), _memory_write_health(), metrics_prometheus() (+15 more)

### Community 400 - "parse_llama_bench"
Cohesion: 0.13
Nodes (24): llama_bench_row_kind(), _med(), parse_llama_bench(), parse_server_ab(), Pick the row for this cell's kind. A sweep can emit several same-kind rows     (, Parse a llama-bench ``-o json`` array + ``.meta.json`` into one cell's     resul, Parse one server_ab.py session JSON into a cell's results (DESIGN §3.2).      ``, Classify a llama-bench row: a pp test has n_gen==0 (n_prompt>0), a tg test     h (+16 more)

### Community 401 - "StackModelMeta"
Cohesion: 0.09
Nodes (10): Transport-safe metadata subset of a registry ``Model``.      Embedded in a stack, Parsed stacks.toml — top-level ``[stack]`` table, keyed by slug., StackModelMeta, StacksConfig, Unit tests for the Stack schema models.  Targeted file run:     ~/dev/hal0/.venv, TestSeedStacks, TestStackCapabilityRow, TestStackModelMeta (+2 more)

### Community 402 - "probes.py"
Cohesion: 0.20
...
### Community 405 - "migrate_slot_id_keying"
Cohesion: 0.14
...
### Community 406 - "parse_text_tool_calls"
Cohesion: 0.13
...
### Community 407 - "test_dashboard_layout.py"
Cohesion: 0.11
...
### Community 408 - "test_logs_routes.py"
Cohesion: 0.11
...
### Community 411 - "test_brain_read_only.py"
Cohesion: 0.12
...
### Community 412 - "test_brain_unrouteable_model.py"
Cohesion: 0.19
Nodes (22): _client_class(), _collect_frames(), _ExplodingClient, _parse(), Any, Exception, MonkeyPatch, Response (+14 more)

### Community 413 - "test_agent_shim.py"
Cohesion: 0.10
Nodes (13): _fake_pw(), _make_parser_allowing_only_status(), Any, Tests for ``hal0-agent`` — the systemd-unit shim.  Most coverage is at the unit, Spawn a sleeping subprocess with controlled env + cmdline so we can     assert a, Yield a (pid, cmdline_needle) for a long-running child with         ``HAL0_AGENT, test_runas_extras_drops_to_hal0_when_root(), test_runas_extras_noop_when_not_root() (+5 more)

### Community 414 - "test_upstream_commands.py"
Cohesion: 0.15
...
### Community 415 - "test_seeds_data.py"
Cohesion: 0.08
...
### Community 416 - "test_memory_delete_auth.py"
Cohesion: 0.11
...
### Community 417 - "Changelog"
Cohesion: 0.08
Nodes (23): [0.9.2] — 2026-07-05, [0.9.4.1] — 2026-07-08, [0.9.5.2] — 2026-07-09, Added, Added, Changed, Changed, Changed (+15 more)

### Community 418 - "hal0 installer"
Cohesion: 0.08
...
### Community 420 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.08
...
### Community 421 - "hal0 1.0 — Seeded profile rework"
Cohesion: 0.08
...
### Community 422 - "Hermes Python 3.12 Cross-Distro Installation Design"
Cohesion: 0.08
...
### Community 423 - "Hal0MemoryClient"
Cohesion: 0.13
...
### Community 424 - "test_hw_slot_ownership_migration.py"
Cohesion: 0.22
...
### Community 425 - "resolved_command_for_slot"
Cohesion: 0.10
...
### Community 426 - "applied_versions"
Cohesion: 0.13
...
### Community 427 - "seed_static_slots"
Cohesion: 0.17
...
### Community 428 - "_container_cgroup_mem_bytes"
Cohesion: 0.13
...
### Community 429 - "test_run_as_hal0_guard.py"
Cohesion: 0.13
...
### Community 430 - "test_pull_shutdown.py"
Cohesion: 0.14
...
### Community 431 - "test_slot_config_validation.py"
Cohesion: 0.19
Nodes (23): Path, TestClient, Boundary validation on slot-config writes (PUT config / PATCH defaults / POST cr, ``""`` persists an empty override — the reason #1372 clears with null., default_voice (voice settings) and string image override keep working., The auto-allocation pool deliberately ends at 8099 (#1036).      The pool defaul, [server].env (schema-derived, not hardcoded) + extra_args pass., ``chat_template: null`` REMOVES a persisted per-slot override (#1372).      The (+15 more)

### Community 432 - "test_brain_self_auth.py"
Cohesion: 0.18
...
### Community 434 - "test_installed.py"
Cohesion: 0.13
...
### Community 436 - "test_npu_columns.py"
Cohesion: 0.15
...
### Community 437 - "test_cli_docs_parity.py"
Cohesion: 0.12
...
### Community 438 - "journal.py"
Cohesion: 0.17
Nodes (22): LevelFilter, _bus(), _collect(), get_journal(), _hal0_event_to_entry(), JournalEntry, _passes_filters(), Any (+14 more)

### Community 439 - "moonshine_server.py"
Cohesion: 0.12
Nodes (20): _decode_audio(), _detect_local_format(), _load_model(), main(), JSONResponse, ndarray, Path, WebSocket (+12 more)

### Community 440 - "README.md"
Cohesion: 0.09
...
### Community 444 - "map_backend_to_device"
Cohesion: 0.13
...
### Community 445 - "provision_comfyui_downloads"
Cohesion: 0.13
...
### Community 446 - "apply_thinking_policy"
Cohesion: 0.15
...
### Community 449 - "embed_references"
Cohesion: 0.18
...
### Community 450 - "test_agent_memory_stats_endpoint.py"
Cohesion: 0.16
...
### Community 451 - "test_backends_npu_canonical_fields.py"
Cohesion: 0.13
...
### Community 452 - "test_memory_subgraph.py"
Cohesion: 0.19
Nodes (15): _build_app(), _HindsightStubProvider, The preview degrades gracefully when the stats probe fails — still 400., Duck-typed provider exposing the hindsight client like HindsightProvider., test_unconfirmed_bank_delete_preview_failsoft_when_stats_unreachable(), _client_for(), Any, Tests for the composed memory subgraph endpoint + its pure graph-math.  Two laye (+7 more)

### Community 453 - "test_secrets.py"
Cohesion: 0.15
...
### Community 454 - "test_settings_models_store.py"
Cohesion: 0.17
...
### Community 455 - "Path"
Cohesion: 0.09
Nodes (23): Path, #585: the dashboard writes ``ctx_size``; it must persist as the canonical     ``, GET /api/slots/{name} is enriched same shape as the list endpoint., #863: single-slot status includes argv drift without burdening list()., PR-18: each entry carries ``type`` + ``model_default``.      The dashboard's per, Verifies the /unload lifecycle route reaches the SlotManager., A legacy ``{"enabled": ...}`` write is refused loudly, not silently kept.      A, ?force=true bypasses the pin guard and actually stops the container. (+15 more)

### Community 456 - "test_probes.py"
Cohesion: 0.15
...
### Community 457 - "Dashboard Overhaul — FROZEN DATA CONTRACT (v1)"
Cohesion: 0.09
...
### Community 459 - "services.jsx"
Cohesion: 0.13
Nodes (18): fetchServices(), ManagedService, MdnsStatus, ServiceActionResult, ServicesPayload, ServiceUnitState, UnitLogs, useMdnsAdvertise() (+10 more)

### Community 460 - "CliRunner"
Cohesion: 0.16
...
### Community 461 - "UI drawers — slot/model/profile editors"
Cohesion: 0.09
...
### Community 462 - "hal0 Settings Menu — Wireframe / IA"
Cohesion: 0.09
...
### Community 463 - "test_hermes_upgrade.py"
Cohesion: 0.20
...
### Community 465 - "test_tts_request_defaults.py"
Cohesion: 0.15
...
### Community 466 - ".test_loaders_respect_hal0_home"
Cohesion: 0.13
...
### Community 467 - "memory_bank_commands.py"
Cohesion: 0.17
Nodes (21): bank_consolidate_cmd(), bank_delete_cmd(), bank_export_cmd(), bank_import_cmd(), bank_list_cmd(), bank_stats_cmd(), _emit(), profile_get_cmd() (+13 more)

### Community 468 - "__init__.py"
Cohesion: 0.19
Nodes (20): claimed_by_other(), collect_claims(), _config_claims(), conflicts(), _listener_claims(), next_free(), _owners(), port_report() (+12 more)

### Community 469 - "config_enrichment"
Cohesion: 0.21
...
### Community 470 - "test_hermes_env_seam.py"
Cohesion: 0.15
...
### Community 474 - "test_services_page.py"
Cohesion: 0.14
...
### Community 475 - "test_v1_proxy.py"
Cohesion: 0.14
...
### Community 476 - "test_virtual_models.py"
Cohesion: 0.17
...
### Community 477 - "test_brain_framing.py"
Cohesion: 0.23
...
### Community 478 - "test_trio_status_inheritance.py"
Cohesion: 0.18
...
### Community 479 - "test_doctor_verify.py"
Cohesion: 0.12
...
### Community 480 - "test_bootstrap_cosign_fetch.py"
Cohesion: 0.21
...
### Community 485 - "test_seam_agent_units.py"
Cohesion: 0.10
...
### Community 488 - "P2-config: Collapse capabilities.toml double-bookkeeping"
Cohesion: 0.10
...
### Community 492 - "slots_config_dir"
Cohesion: 0.18
...
### Community 493 - "Host"
Cohesion: 0.17
Nodes (18): canonical_json(), cell_key(), Host, Any, The box + software environment. ``hal0_version`` is required (DESIGN §3.2     ho, Plain-dict JSON shape for the store. ``outcome`` is flattened to its         str, Deterministic JSON: sorted keys, no insignificant whitespace. This is the     ca, The dedup/staleness key: ``sha256:`` + hex of the canonical-JSON identity     bl (+10 more)

### Community 494 - "ModelVariant"
Cohesion: 0.13
...
### Community 495 - "test_fetch_ws_g.py"
Cohesion: 0.14
...
### Community 498 - "read_stack_state"
Cohesion: 0.15
...
### Community 499 - "model-drawer-dirty-baseline-v3.spec.ts"
Cohesion: 0.10
...
### Community 500 - "test_memory_admin_document_transfer.py"
Cohesion: 0.20
...
### Community 501 - "test_throughput_history.py"
Cohesion: 0.19
...
### Community 502 - "test_eligibility.py"
Cohesion: 0.10
...
### Community 503 - "test_model_less_capability_slot_is_not_woken"
Cohesion: 0.20
...
### Community 504 - "Security review — v1.0 auth surface (2026-05-21)"
Cohesion: 0.10
...
### Community 505 - "_write_fake_python"
Cohesion: 0.20
...
### Community 506 - "test_seam_verification.py"
Cohesion: 0.17
...
### Community 507 - "test_approval_queue.py"
Cohesion: 0.13
...
### Community 509 - "test_manager_npu_container.py"
Cohesion: 0.20
...
### Community 510 - "21. Adoption integration (Lemonade + ODS)"
Cohesion: 0.10
...
### Community 514 - "write_gateway_secrets_dropin"
Cohesion: 0.11
Nodes (20): _atomic_write(), _atomic_write_if_changed(), content_hash(), _deep_merge(), _disable_honcho_hermes_host(), _gateway_dropin_body(), GatewayDropinResult, _merge_config_yaml_layers() (+12 more)

### Community 515 - "approvals.py"
Cohesion: 0.18
...
### Community 519 - "run_verify"
Cohesion: 0.16
Nodes (19): doctor_verify_cmd(), Render the post-setup report card (checks + live URLs + doc links).      First-c, gather_payloads(), _lan_ip(), Any, Console, ``hal0 doctor --verify`` — the post-setup report card (WS-K, issue #1114).  A si, Live URLs block — computed dashboard/chat + mDNS + LAN IP. (+11 more)

### Community 520 - "file_lock"
Cohesion: 0.16
...
### Community 521 - "MemoryGraphConfig"
Cohesion: 0.13
...
### Community 526 - "test_journal_routes.py"
Cohesion: 0.22
...
### Community 527 - "Any"
Cohesion: 0.10
Nodes (19): container_stub(), Any, When the NPU LLM anchor has a model bound, every trio slot gets coresident_group, rope_freq_base set on disk → exposed in /api/slots payload., PR-18: ``labels`` is lifted from ``[model] labels = [...]``.      The dashboard', A slot with no ``device`` in TOML carries no declared_backend key., The enriched body must be valid JSON (no exotic types leaked)., Loading a slot with no TOML returns the typed slot.not_found envelope. (+11 more)

### Community 528 - "FastAPI"
Cohesion: 0.10
Nodes (20): isolated_app(), isolated_client(), FastAPI, The synthetic composite ``hal0`` slot must derive ``status`` from     the live l, Counterpart to the offline case: when a dispatchable slot holds the     catalogu, A FastAPI app whose lifespan resolves paths under tmp_hal0_home.      The shared, Real SlotManager entries appear alongside synthetic upstream-backed ones., When a real slot and a synthetic share a name, the real one wins. (+12 more)

### Community 529 - "_source_config"
Cohesion: 0.14
...
### Community 530 - "test_capabilities_commands.py"
Cohesion: 0.18
...
### Community 533 - "test_model_store_root.py"
Cohesion: 0.14
...
### Community 535 - "TestEarlyHal0User"
Cohesion: 0.10
...
### Community 537 - "test_fail_watcher.py"
Cohesion: 0.18
...
### Community 538 - "0. Research-grounded findings that drive the matrix"
Cohesion: 0.11
...
### Community 542 - "test_board_dispatch.py"
Cohesion: 0.22
...
### Community 543 - "test_diagnosis.py"
Cohesion: 0.13
Nodes (13): exit_code_for(), Diagnosis, ``hal0 doctor``'s CLI-side ``Diagnosis`` re-export + adapters (§21.4).  The data, The stable ``--json`` shape every doctor subcommand prints.      ``json.dumps(.., The §4.2 generic ``--json`` exit-code translation: critical->2,     fail/warn->1, render_json(), Tests for the §21.4 ``Diagnosis`` retrofit backbone.  Covers: dataclass immutabi, Pin the §1.2 ID table exactly. Changing this set is a breaking change —     see (+5 more)

### Community 544 - "._post"
Cohesion: 0.14
Nodes (12): is_container_npu_cfg(), Any, Shared NPU-slot helpers for dispatcher modules (Phase A container cutover)., True when this slot config describes a live containerized NPU slot.      Detecti, Any, AsyncClient, Response, Forward an STT request to the npu container's ``/v1/audio/transcriptions``. (+4 more)

### Community 545 - "_register"
Cohesion: 0.25
...
### Community 546 - "test_port_registry.py"
Cohesion: 0.23
...
### Community 548 - "test_settings_routes.py"
Cohesion: 0.15
...
### Community 549 - ".json"
Cohesion: 0.11
Nodes (18): idle_timeout_s / workers / llamacpp_args ride along on /api/slots.      The on-d, v0.1.x clients consuming /api/slots see every legacy key unchanged., Labels list is omitted (not empty) when the slot config has no     ``model.label, A failing container health probe doesn't break /api/slots.      The enrichment s, The slot HW grid (NGL / THREADS / BINARY / image_pin) is top-level slot     conf, POST /api/slots/chat/load goes through ContainerProvider.load_sync., ADR-0023: POST /api/slots/agent-hermes/load resolves via the surviving     hidde, DELETE ?force=true binds + forwards to the manager and echoes ``forced``.      ' (+10 more)

### Community 550 - "_stub_bin"
Cohesion: 0.23
...
### Community 552 - "test_hal0_update_wrapper.py"
Cohesion: 0.20
...
### Community 553 - "test_pull_refcount_rows.py"
Cohesion: 0.20
...
### Community 554 - "test_store_concurrency.py"
Cohesion: 0.19
...
### Community 556 - "test_load_converges_config.py"
Cohesion: 0.24
...
### Community 557 - "test_agents_unit_liveness.py"
Cohesion: 0.21
...
### Community 558 - "hal0 architecture & reference"
Cohesion: 0.11
...
### Community 559 - "FakeDelegateRunner"
Cohesion: 0.16
...
### Community 560 - "2. Bugs (correctness — ordered by impact)"
Cohesion: 0.11
...
### Community 561 - "manage-slots.mdx"
Cohesion: 0.11
...
### Community 563 - "spec-kb23 — hal0-brain chat tool-tier, approval-gate & injection-resistance"
Cohesion: 0.11
...
### Community 564 - "hal0-admin tools"
Cohesion: 0.11
...
### Community 565 - "kokoro_server.py"
Cohesion: 0.14
...
### Community 567 - "ensure_podman_apparmor_usable"
Cohesion: 0.19
...
### Community 568 - "ProgressCoalescer"
Cohesion: 0.14
...
### Community 569 - "resolve_bench_devices"
Cohesion: 0.22
Nodes (7): BenchDeviceError, _override_group_ids(), A benchmark device setting could not be resolved into a usable node., Resolve the GPU passthrough for a benchmark container.      See the module docst, resolve_bench_devices(), TestOverrides, TestRender

### Community 570 - "Bundle"
Cohesion: 0.15
...
### Community 571 - "slot_migrate_flags"
Cohesion: 0.32
...
### Community 577 - "unknown_slot_config_keys"
Cohesion: 0.17
Nodes (7): Dotted paths of payload keys the slot-config schema does not know.      ``SlotCo, unknown_slot_config_keys(), Unit tests for the slot-config write helpers added in the guarded-writes wave: `, #1369: ``enabled`` is no longer a declared field, so the boundary         must f, Every declared ServerConfig field passes without a hardcoded list —         this, mtp/enable_thinking/vision are no longer declared SlotConfig         fields (spe, TestUnknownKeys

### Community 578 - "arbiter.py"
Cohesion: 0.12
...
### Community 579 - "test_hermes_security_deliverables.py"
Cohesion: 0.15
...
### Community 583 - "FakeUpstreamRegistry"
Cohesion: 0.18
...
### Community 584 - "test_models_preview.py"
Cohesion: 0.19
...
### Community 586 - "test_settings_apply.py"
Cohesion: 0.11
...
### Community 587 - "test_v1_dispatch.py"
Cohesion: 0.16
...
### Community 588 - "test_doctor_perms.py"
Cohesion: 0.19
...
### Community 591 - "FakeLocalBackend"
Cohesion: 0.17
...
### Community 592 - "test_logs_tail_redaction.py"
Cohesion: 0.11
...
### Community 593 - "3. Proposed seed catalog (one per type)"
Cohesion: 0.12
...
### Community 594 - "Slot config — capabilities ↔ slots reconciliation"
Cohesion: 0.12
...
### Community 595 - "hal0 Adoption Candidates — Lemonade + ODS (combined)"
Cohesion: 0.12
...
### Community 596 - "spec-hp-realtime — OpenAI Realtime WebSocket endpoint for hal0"
Cohesion: 0.12
...
### Community 597 - "P3-schema — `config/schema.py` decomposition: implementation-ready spec"
Cohesion: 0.12
...
### Community 598 - "Prerelease Preview Pipeline Hardening"
Cohesion: 0.12
...
### Community 599 - "activity.py"
Cohesion: 0.24
Nodes (16): ActivityInvalidQuery, ActivityUnavailable, _epoch(), export_activity(), list_activity(), Any, Request, Response (+8 more)

### Community 600 - "publish.py"
Cohesion: 0.21
Nodes (16): cmd_publish(), build_roster(), _date(), _default_host(), _detail_from_record(), emit_site_ts(), Any, Path (+8 more)

### Community 601 - "test_schema.py"
Cohesion: 0.21
...
Cohesion: 0.16
Nodes (16): create_upstream(), credentials_set(), _do_set_credentials(), _filters_summary(), list_upstreams(), _print_json(), Any, hal0 upstream subcommands — thin HTTP client to the hal0 API.  Provides ``hal0 u (+8 more)

### Community 603 - "seeds.py"
Cohesion: 0.17
...
### Community 605 - "apply_extraction_slot"
Cohesion: 0.18
...
### Community 607 - "normalize_system_messages"
Cohesion: 0.18
...
### Community 610 - "metrics_collect.py"
Cohesion: 0.15
...
### Community 611 - "snapshot_live_stack"
Cohesion: 0.30
...
### Community 612 - "test_hermes_state_render.py"
Cohesion: 0.12
...
### Community 613 - "_Headers"
Cohesion: 0.12
Nodes (10): _FakeDispatcher, _Headers, _NonChatRequest, _OmniRequest, Request that flows through chat_completions -> _read_json_body -> omni branch., The omni branch returns before _dispatch_and_forward, so chat_completions     mu, _dispatch_and_forward must NOT invoke _normalize_chat_body — that would     rewr, test_dispatch_and_forward_does_not_normalize_non_chat() (+2 more)

### Community 614 - "TestClient"
Cohesion: 0.12
Nodes (17): TestClient, Regression: the slot-edit Save's ``PATCH /defaults`` must not wipe the     model, A slot's [model].n_gpu_layers rides along in the payload., rope_freq_base absent on disk → payload carries null (not 0.0)., device=npu slots surface declared_backend='flm' (the FLM recipe)., An explicit upstreams.toml entry for ``hal0`` survives startup unchanged.      O, GET /api/slots/doesntexist/config → 404 slot.not_found.      Pre-issue-#35 the r, An EXISTING slot with malformed TOML still surfaces 400 slot.config_error. (+9 more)

### Community 615 - "test_cli_auth_streamtest.py"
Cohesion: 0.21
...
### Community 616 - "Findings from the 2026-05-16 hal0-test deep-probe round"
Cohesion: 0.12
...
### Community 617 - "DelegateTaskSpec"
Cohesion: 0.18
...
### Community 618 - "test_preflight_ports_own_service.py"
Cohesion: 0.29
...
### Community 619 - "agents-overview.jsx"
Cohesion: 0.20
...
### Community 620 - "test_npu_trio_shadow.py"
Cohesion: 0.17
Nodes (16): _anchor(), _gpu_slot(), patched_spawn(), MonkeyPatch, Path, NPU FLM trio *shadow* handling in SlotManager (shape-consolidation Unit 0).  The, Loading an stt/embed shadow must NOT spawn a child (would 500 on NPU)., The chat anchor (device=npu type=llm) is NOT a shadow — it must spawn. (+8 more)

### Community 621 - "test_ttft_samples.py"
Cohesion: 0.12
...
### Community 623 - "halo (LXC 150) — R3 deploy issues report"
Cohesion: 0.12
...
### Community 624 - "hal0_gpu_gate.py"
Cohesion: 0.16
...
### Community 625 - "qwen3tts_server.py"
Cohesion: 0.16
...
### Community 632 - "build_admin_route_map"
Cohesion: 0.13
Nodes (16): _apply_route_map(), build_admin_route_map(), install_admin_route_map(), _is_spa_catchall(), _is_transport_excluded(), _normalize_path(), Strip Starlette path-converter suffixes (``{id:path}`` -> ``{id}``).      route_, The Vue SPA fallback (``/{full_path:path}``) — a root-level catch-all. (+8 more)

### Community 633 - ".record_error"
Cohesion: 0.20
...
### Community 634 - "RecordingSlotArtifactOps"
Cohesion: 0.22
...
### Community 635 - "_hermes_fakes.py"
Cohesion: 0.16
...
### Community 636 - "test_hermes_provision_install_artifacts.py"
Cohesion: 0.17
...
### Community 637 - "test_mcp_client.py"
Cohesion: 0.19
...
### Community 638 - "test_agents_routes.py"
Cohesion: 0.21
...
### Community 639 - "test_mcp_identity.py"
Cohesion: 0.18
...
### Community 640 - "test_models_crud.py"
Cohesion: 0.15
...
### Community 642 - "_StubSlotManager"
Cohesion: 0.28
...
### Community 643 - "test_catalog_backends.py"
Cohesion: 0.19
...
### Community 644 - "FakeDockerBackend"
Cohesion: 0.16
...
### Community 645 - "hal0 test harness — internal contributor guide"
Cohesion: 0.12
...
### Community 647 - "Model registry — registry, pulls, classification"
Cohesion: 0.13
...
### Community 648 - "Handoff: qwen3tts standalone → hal0-slot migration"
Cohesion: 0.13
...
### Community 649 - "Container Image System Overhaul"
Cohesion: 0.13
...
### Community 650 - "hal0 rework plan — de-scarring the launch"
Cohesion: 0.13
...
### Community 651 - "Handoff — brain + embed slot/agent cleanup on halo150"
Cohesion: 0.13
...
### Community 652 - "Handoff — γ-suite (chromium) persistently red on main (#1333)"
Cohesion: 0.13
...
### Community 653 - "Handoff — fold rework→main merge/meld/fix follow-ups into the R5 docs"
Cohesion: 0.13
...
### Community 654 - "Handoff — hal0 R5 endgame (paste-in brief for a new session)"
Cohesion: 0.13
...
### Community 655 - "Findings (O-series)"
Cohesion: 0.13
...
### Community 657 - "hal0 Hermes Integration Suite Design"
Cohesion: 0.13
...
### Community 658 - "PR #1330 CI Repair Design"
Cohesion: 0.13
...
### Community 660 - "test_route_collisions.py"
Cohesion: 0.19
...
### Community 661 - "test_hermes_live_resolve_render.py"
Cohesion: 0.19
...
### Community 662 - "upsert_env_value"
Cohesion: 0.21
...
### Community 663 - "create_chat_template"
Cohesion: 0.24
...
### Community 664 - "test_slots_policy.py"
Cohesion: 0.26
...
### Community 669 - "test_hermes_provision_kanban_db_init.py"
Cohesion: 0.20
...
### Community 670 - "test_persona_update.py"
Cohesion: 0.25
...
### Community 671 - "test_slots_npu_fields.py"
Cohesion: 0.20
...
### Community 672 - "test_slots_routes.py"
Cohesion: 0.26
Nodes (14): _patch_httpx(), MonkeyPatch, Tests for the /api/slots route surface (container runtime).  Covers:   - list-me, n_prompt_tokens can briefly exceed n_ctx during shift; clamp the     synthesised, Minimal httpx.Response stand-in for the scrape tests.      Implements just the s, Patch httpx.AsyncClient used inside slots._scrape_llama_metrics.      Routes the, Newer llama-server (b9279+) drops kv_cache_usage_ratio from     /metrics but sti, If a future llama.cpp reintroduces ``llamacpp:kv_cache_usage_ratio``     we use (+6 more)

### Community 673 - "test_devices.py"
Cohesion: 0.16
...
### Community 674 - "test_brain_ctx_precheck.py"
Cohesion: 0.23
...
### Community 677 - "test_pool_bounds.py"
Cohesion: 0.15
...
### Community 679 - "test_api_restart_on_upgrade.py"
Cohesion: 0.28
...
### Community 680 - "test_admin_route_map.py"
Cohesion: 0.17
...
### Community 681 - "test_container_mmproj.py"
Cohesion: 0.31
...
### Community 682 - "test_release_check.py"
Cohesion: 0.37
...
### Community 683 - "test_device_profile_coherence.py"
Cohesion: 0.18
...
### Community 684 - "test_mtp_defuse.py"
Cohesion: 0.34
...
### Community 685 - "test_preload_eviction.py"
Cohesion: 0.26
Nodes (14): Any, FakeContainerProvider, MonkeyPatch, Path, Tests for pre-load eviction (§O26): freeing memory synchronously before a load,, Fake SlotManager._resolve_model_info returning a fixed file size., A load that wouldn't otherwise fit evicts the idle lru-eligible slot     first,, No eligible (non-lru) candidate exists: the load fails with a clear,     actiona (+6 more)

### Community 686 - "test_integrations.py"
Cohesion: 0.13
...
### Community 690 - "Toolbox Repo Consolidation"
Cohesion: 0.14
...
### Community 691 - "obtain-models.mdx"
Cohesion: 0.14
...
### Community 692 - "Deploy halves of the "CI here" scenarios"
Cohesion: 0.14
...
### Community 693 - "PART 2 — DELIVERABLES"
Cohesion: 0.14
...
### Community 694 - "0. EXACT Honcho footprint (file:line)"
Cohesion: 0.14
...
### Community 695 - "P2-device: make `device` the sole truth, delete the `backend` dual-write"
Cohesion: 0.14
...
### Community 696 - "Handoff — R5 drive 2: put it back together (paste-in prompt, Fable orchestrator)"
Cohesion: 0.14
...
### Community 697 - "hal0 1.0 Seeded Profile Rework — Implementation Plan"
Cohesion: 0.14
...
### Community 699 - "Phase 4 handoff — halo143 deploy window"
Cohesion: 0.14
...
### Community 700 - "test_moonshine_server.py"
Cohesion: 0.22
...
### Community 703 - "devices.py"
Cohesion: 0.18
Nodes (13): _is_char_device(), main(), _node_allowed(), _override_devices(), _probe_snapshot(), _probed_gpu(), GPU device-node resolution for the benchmark harness (issue #1303).  Why this mo, True when ``node`` is inside one of the permitted device roots.      The roots a (+5 more)

### Community 704 - "BenchDeviceSpec"
Cohesion: 0.21
...
### Community 708 - "MetricsRetention"
Cohesion: 0.18
...
### Community 709 - "comfyui_workflows.py"
Cohesion: 0.20
...
### Community 711 - "heal_missing_llm_type"
Cohesion: 0.20
...
### Community 712 - "compute_config_drift"
Cohesion: 0.25
Nodes (9): compute_config_drift(), _config_drift_values_equal(), DriftHost, Any, Config-drift comparator (P3-slots §1c).  Compares a slot's *live* container argv, Canonicalize the id-bearing drift flags the way the renderer does.      ``--mode, Compare live container argv to the command a restart would render.      Returns, Narrow seam :func:`compute_config_drift` needs from ``SlotManager``. (+1 more)

### Community 713 - "provider_requires_model"
Cohesion: 0.22
...
### Community 714 - "test_hermes_provision_context.py"
Cohesion: 0.14
...
### Community 715 - "test_dashboard_layout_v3.py"
Cohesion: 0.22
...
### Community 717 - "test_middleware.py"
Cohesion: 0.21
...
### Community 718 - "test_services_health.py"
Cohesion: 0.27
...
### Community 719 - "test_board_etag.py"
Cohesion: 0.32
...
### Community 720 - "test_brain_chat.py"
Cohesion: 0.23
...
### Community 721 - "test_auth_commands.py"
Cohesion: 0.23
...
### Community 722 - "test_memory_ops_commands.py"
Cohesion: 0.16
...
### Community 723 - "test_slot_verb_aliases.py"
Cohesion: 0.16
...
### Community 724 - "test_hal0_gpu_gate.py"
Cohesion: 0.22
...
### Community 725 - "test_image_pin.py"
Cohesion: 0.14
...
### Community 726 - "test_flm_store_link.py"
Cohesion: 0.26
...
### Community 728 - "test_reinstall_into_venv_does_not_pass_no_deps"
Cohesion: 0.20
...
### Community 729 - "test_adopted_slot_eviction.py"
Cohesion: 0.23
...
### Community 730 - "test_dispatchable_ready_set_single_source.py"
Cohesion: 0.14
...
### Community 731 - "test_restart_errored_slot.py"
Cohesion: 0.26
...
### Community 735 - "SecretsPage.jsx"
Cohesion: 0.33
Nodes (11): SecretEntry, useSecretDelete(), useSecrets(), useSecretSet(), AddSecretModal(), SECRET_PRESETS, HfTokenField(), isProtected() (+3 more)

### Community 736 - "Contributor Covenant Code of Conduct"
Cohesion: 0.15
Nodes (12): 1. Correction, 2. Warning, 3. Temporary Ban, 4. Permanent Ban, Attribution, Contributor Covenant Code of Conduct, Enforcement, Enforcement Guidelines (+4 more)

### Community 737 - "3. Recommendation: how hal0 should support ONNX"
Cohesion: 0.15
...
### Community 738 - "Dispatch / runtime — routing, arbiter, lifecycle"
Cohesion: 0.15
...
### Community 741 - "pull-and-register-models.mdx"
Cohesion: 0.15
...
### Community 742 - "hal0 rework — handoff: single primary orchestrator (R3-B / R4 / R5 + finish line)"
Cohesion: 0.15
...
### Community 743 - "Changes Applied (then rolled back)"
Cohesion: 0.15
...
### Community 744 - "hal0 codebase map"
Cohesion: 0.15
...
### Community 745 - "hal0 service management"
Cohesion: 0.15
...
### Community 747 - "QueryStringScrubber"
Cohesion: 0.18
...
### Community 748 - "proxy_board_events"
Cohesion: 0.21
...
### Community 751 - "migrate_unify_cmd"
Cohesion: 0.21
...
### Community 755 - "rerender_slot_units"
Cohesion: 0.29
...
### Community 756 - "test_containers_apparmor.py"
Cohesion: 0.37
...
### Community 758 - "test_activity.py"
Cohesion: 0.31
...
### Community 759 - "test_activity_routes_instrumented.py"
Cohesion: 0.38
...
### Community 760 - "test_comfyui_fetch_route.py"
Cohesion: 0.15
...
### Community 761 - "test_events_fixes.py"
Cohesion: 0.19
...
### Community 762 - "_lxc_dri"
Cohesion: 0.22
Nodes (8): _lxc_dri(), Path, Subdirectories and regular files under /dev/dri are never passed., The shared slot resolver is handed the nodes we resolved, so bench         and s, The #1303 reproduction shape: /dev/kfd + card1 + renderD128 only.      Notably N, Regression fixture: an LXC exposing only card1 + renderD128., The acceptance criterion: the generated argv carries the DISCOVERED         node, TestDiscovery

### Community 763 - "test_harness_matrix.py"
Cohesion: 0.21
...
### Community 764 - "TestSeamWhitelist"
Cohesion: 0.18
...
### Community 765 - "test_memory_graph_commands.py"
Cohesion: 0.15
...
### Community 766 - "test_model_verbs.py"
Cohesion: 0.26
...
### Community 769 - "_RecordingProvider"
Cohesion: 0.24
...
### Community 770 - "test_seed_profiles.py"
Cohesion: 0.24
...
### Community 772 - "react-hooks-order.test.mjs"
Cohesion: 0.23
Nodes (12): checkFile(), DASH_DIR, fail(), files, HERE, HOOK_NAMES, LOOP_METHODS, loopCallbackDepth() (+4 more)

### Community 773 - "Slot pin + drawer field-wiring audit — session handoff (2026-07-30)"
Cohesion: 0.17
...
### Community 774 - "Recently added endpoints"
Cohesion: 0.17
...
### Community 775 - "HW-slot-ownership — hardware sticks to slots, logical tune sticks to models"
Cohesion: 0.17
...
### Community 776 - "Design — 3-tier, deny-by-default, single classification source"
Cohesion: 0.17
...
### Community 777 - "hal0 UI/UX design brief — post-R3 surface rework"
Cohesion: 0.17
...
### Community 781 - "Release pipeline — prototype findings + blockers"
Cohesion: 0.17
...
### Community 785 - "MemoryDispatcher"
Cohesion: 0.21
...
### Community 786 - "ExtensionOutcome"
Cohesion: 0.21
...
### Community 787 - "_declared_path_args"
Cohesion: 0.18
Nodes (12): _declared_path_args(), _placeholders(), Catalog tools that forward over REST (exclude memory_* + host probes)., App-independent overlay coherence — safe to run before a map installs., Path args for ``tool`` — from the installed map, else its alias route., Full guard: overlay coherence + the installed route map (Gap 1/3)., Ordered ``{placeholder}`` names in a normalized path template., The flat JSON-Schema for one tool's call args — shared by both surfaces.      Pa (+4 more)

### Community 788 - "test_startup_slot_seed.py"
Cohesion: 0.20
...
### Community 789 - "TestTelemetrySampler"
Cohesion: 0.17
...
### Community 790 - "test_board_ws.py"
Cohesion: 0.32
...
### Community 791 - "test_agent_status.py"
Cohesion: 0.23
...
### Community 793 - "test_system_info.py"
Cohesion: 0.26
...
### Community 794 - "TestPackagedSlotsPortsMigration"
Cohesion: 0.26
Nodes (4): Path, Packaged migration 004_slots_ports.sql (rework §11.1 + §11.2).  Applies cleanly, AUTOINCREMENT never reuses an id, even after a delete — the         stable-ident, TestPackagedSlotsPortsMigration

### Community 795 - "test_comfyui_scripts_shipped.py"
Cohesion: 0.17
...
### Community 796 - "test_pull_store.py"
Cohesion: 0.18
Nodes (11): MonkeyPatch, Test that ``_pull_root`` honours [models].store with pull_root fallback., persist_pull_job fsyncs the snapshot's parent dir after os.replace., Backward compat — PR-#313 installs without `store` keep working., Drop a snapshot for ``model_id`` in ``state`` with an aged mtime., Old terminal snapshot is reaped; fresh terminal + old running survive., test_effective_store_picks_pull_root_fallback(), test_effective_store_prefers_explicit_store() (+3 more)

### Community 797 - "test_static_seeds.py"
Cohesion: 0.17
...
### Community 798 - "test_post_activation_migrations.py"
Cohesion: 0.26
...
### Community 800 - "`hal0-setup.yaml` — headless answer-file spec (2026-07-05)"
Cohesion: 0.18
...
### Community 801 - "Findings → fixes, by tier"
Cohesion: 0.18
...
### Community 802 - "Handoff: model-pipeline plan — finish-out pass"
Cohesion: 0.18
...
### Community 803 - "Hal0 Upstream Controls — Epic Plan (2026-07-06)"
Cohesion: 0.18
...
### Community 804 - "capabilities-and-profiles.mdx"
Cohesion: 0.18
...
### Community 805 - "Admin tools (`/mcp/admin`)"
Cohesion: 0.18
...
### Community 806 - "providers-profiles-devices.mdx"
Cohesion: 0.18
...
### Community 807 - "slot-lifecycle.mdx"
Cohesion: 0.18
...
### Community 808 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
...
### Community 809 - "Both-boxes deploy-validation runbook — rework-R4-stage"
Cohesion: 0.18
...
### Community 810 - "P3-brain — Implementation-Ready Spec: hal0-brain as a first-class module"
Cohesion: 0.18
...
### Community 811 - "PART D — Edit plan (files, order, delegators/shims)"
Cohesion: 0.18
...
### Community 812 - "hal0 Hermes Plugin Suite — BUILD Spec (verified vs code @ `rework/descar`)"
Cohesion: 0.18
...
### Community 813 - "Hermes Agent official integration research for the hal0 rework"
Cohesion: 0.18
...
### Community 814 - "2. Proposed hal0 plugin suite"
Cohesion: 0.18
...
### Community 815 - "hal0 rework — board tracking protocol (paste-in prompt)"
Cohesion: 0.18
Nodes (10): Board row = the machine-readable record, Checkpoint (R1–R5) → main, hal0 rework — board tracking protocol (paste-in prompt), Hard rules (never violate), Lifecycle of a lane (how a row moves), Migration-window lanes, Monitor, Reusable agent-dispatch prompt skeleton (+2 more)

### Community 816 - "check_sunset.py"
Cohesion: 0.38
Nodes (10): Match, current_version(), _fmt(), main(), overdue_markers(), ProjectVersion, _py_files(), Path (+2 more)

### Community 817 - "Protocol"
Cohesion: 0.27
Nodes (7): Protocol, NpuTrioHost, Any, NPU FLM-trio shadow reconciler (P3-slots §1d).  The NPU runs a single ``flm serv, Narrow seam :func:`reconcile_trio_slots` needs from ``SlotManager``., Startup pass: reconcile the FLM-trio shadow slots to canon.      The NPU runs on, reconcile_trio_slots()

### Community 818 - "update-cosign-pin.sh"
Cohesion: 0.36
Nodes (9): checksum_for_asset(), ensure_verifier(), err(), info(), is_release_tag(), is_sha256(), read_pin(), resolve_latest_version() (+1 more)

### Community 819 - "_proxy_ws"
Cohesion: 0.25
...
### Community 825 - "rank_slot_name"
Cohesion: 0.25
Nodes (10): lane_slot_pin(), preferred_slot(), Any, rank_slot_name(), Which slot a request actually asked for, and how to choose between slots (#1418), Record that this request resolved to the ``slot_name`` lane., The lane-pinned slot name for this request, or ``""``.      Never raises and nev, Selection key for one slot — lower sorts first.      ``(lane-miss, health-rank)` (+2 more)

### Community 826 - "test_hermes_provision_collect.py"
Cohesion: 0.25
...
### Community 827 - "test_config_model_roots.py"
Cohesion: 0.29
...
### Community 828 - "test_doctor_route.py"
Cohesion: 0.24
...
### Community 829 - "test_features_health.py"
Cohesion: 0.25
...
### Community 830 - "test_meta_enums.py"
Cohesion: 0.42
...
### Community 832 - "test_server_ab_helpers.py"
Cohesion: 0.22
...
### Community 833 - "test_board_commands.py"
Cohesion: 0.27
...
### Community 834 - "test_serve_bind_host.py"
Cohesion: 0.31
...
### Community 835 - "test_fetch_scripts.py"
Cohesion: 0.18
...
### Community 836 - "test_profiles.py"
Cohesion: 0.18
Nodes (7): Unit tests for the profile catalog — schema, loader, and flag resolver.  Targete, Per spec §4.1: device_class defaults to None (device-agnostic)., Every 1.0 seed is device-agnostic; the slot owns the device., PS-1: DEVICE_DEFAULT_PROFILES["cpu"] must name a chat-capable profile., test_cpu_default_profile_supports_llm(), test_profile_device_class_defaults_none(), test_seed_device_classes()

### Community 837 - "test_migrate_board.py"
Cohesion: 0.40
...
### Community 838 - "hal0 test-harness — findings"
Cohesion: 0.18
...
### Community 841 - "test_admin_stacks.py"
Cohesion: 0.24
...
### Community 842 - "test_api_wiring.py"
Cohesion: 0.24
...
### Community 844 - "test_npu_trio_reconcile.py"
Cohesion: 0.45
...
### Community 845 - "test_pin_semantics.py"
Cohesion: 0.18
...
### Community 851 - "7. Product-shaped reworks (from the six field notes)"
Cohesion: 0.20
...
### Community 852 - "FLAGS-own — llama.cpp flags stick to models; profiles become templates"
Cohesion: 0.20
...
### Community 853 - "hal0 SETTINGS rework — implementation-ready spec"
Cohesion: 0.20
...
### Community 854 - "Slot / Model / Profile / Flags / Image — reworked runtime model (R3)"
Cohesion: 0.20
...
### Community 855 - "Global Constraints"
Cohesion: 0.20
...
### Community 857 - "Dashboard Plugin JS Loading Internals"
Cohesion: 0.20
...
### Community 865 - "get_agent_memory_stats"
Cohesion: 0.29
...
### Community 869 - "slot_migrate_caps"
Cohesion: 0.42
...
### Community 870 - "resolve_chat_template"
Cohesion: 0.27
...
### Community 871 - "NpuSwapStatus"
Cohesion: 0.22
Nodes (8): _npu_llm_anchor(), NpuSwapStatus, Any, NPU trio chat-model swap-in-progress detection.  When the operator picks a new N, Snapshot of the NPU trio swap state.      Attributes:         in_progress: True, Return the (at most one) model-bound NPU LLM slot config, or None.      The NPU-, NpuSwapStatus.to_dict matches the wire shape., test_to_dict_shape()

### Community 872 - "logs.py"
Cohesion: 0.29
...
### Community 873 - "collect_port_claims"
Cohesion: 0.29
...
### Community 875 - "_brain_profile_state"
Cohesion: 0.20
...
### Community 876 - "test_mcp_mount_health.py"
Cohesion: 0.24
...
### Community 878 - "test_startup_persona_seed.py"
Cohesion: 0.27
...
### Community 880 - "test_catalog_npu_stt.py"
Cohesion: 0.27
...
### Community 882 - "test_validate_catalog.py"
Cohesion: 0.24
...
### Community 885 - "test_curated_pull_coords.py"
Cohesion: 0.20
Nodes (9): Tests for the custom-GGUF curated coords added in fix/stack-model-pull-coords., The new ids do not collide with any existing curated id., Each new id resolves via get_curated() to the EXACT hf_repo/hf_file.      This i, The on-disk filename resolves back to the curated entry (scan-backfill)., The three seed-stack files match their curated entries by filename., test_get_curated_resolves_exact_coords(), test_match_curated_by_filename(), test_match_curated_seed_stack_files() (+1 more)

### Community 886 - "_configure_project"
Cohesion: 0.56
...
### Community 887 - "buildBankSubgraphRoute"
Cohesion: 0.36
...
### Community 893 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 894 - "graphify reference: extra exports and benchmark"
Cohesion: 0.22
Nodes (8): graphify reference: extra exports and benchmark, Step 6b - Wiki (only if --wiki flag), Step 7 - Neo4j export (only if --neo4j or --neo4j-push flag), Step 7a - FalkorDB export (only if --falkordb or --falkordb-push flag), Step 7b - SVG export (only if --svg flag), Step 7c - GraphML export (only if --graphml flag), Step 7d - MCP server (only if --mcp flag), Step 8 - Token reduction benchmark (only if total_words > 5000)

### Community 895 - "ROCmFPX bench — RESULTS + next-session handoff (2026-07-05)"
Cohesion: 0.22
...
### Community 896 - "architecture.mdx"
Cohesion: 0.22
...
### Community 898 - "connect-clients.mdx"
Cohesion: 0.22
...
### Community 899 - "connect-external-providers.mdx"
Cohesion: 0.22
...
### Community 900 - "realtime-voice.mdx"
Cohesion: 0.22
...
### Community 901 - "openai-compat.mdx"
Cohesion: 0.22
...
### Community 902 - "slot-as-model.mdx"
Cohesion: 0.22
...
### Community 903 - "env-vars.mdx"
Cohesion: 0.22
Nodes (8): Install & update, Memory & MCP, Models & providers, Paths, Runtime, See also, Server, Services

### Community 904 - "Handoff prompt — hal0-brain / template / profile changes on lxc105 (hal0, 10.0.1.142)"
Cohesion: 0.22
...
### Community 905 - "PART B — Target: Quadlet `.container` per slot (and per companion)"
Cohesion: 0.22
...
### Community 906 - "Slot-pin-lifecycle — the operator pin is the residency control, and the only one"
Cohesion: 0.22
...
### Community 907 - "SWEEP inventory — the overlooked surface (R5 release-prep)"
Cohesion: 0.22
...
### Community 910 - "Hindsight pi Extension Design"
Cohesion: 0.22
...
### Community 911 - "Dashboard plugin "Could not load this plugin's script""
Cohesion: 0.22
...
### Community 912 - "Strix Halo Benchmark Harness (hal0)"
Cohesion: 0.22
...
### Community 918 - "migrate_cognee_to_hindsight_dryrun"
Cohesion: 0.25
...
### Community 919 - "MetricsAggregator"
Cohesion: 0.28
...
### Community 920 - "TestImageMismatch"
Cohesion: 0.33
...
### Community 921 - "TestLoopbackFenceCommand"
Cohesion: 0.33
Nodes (4): _loopback_fence_command(), Flip any ``0.0.0.0`` bind in *command* to loopback (host-net fence).      THE si, Unit coverage for the fence helper across every bind-flag shape., TestLoopbackFenceCommand

### Community 922 - "test_hermes_stale_dropin_cleanup.py"
Cohesion: 0.47
...
### Community 923 - "isolated_client_with_root"
Cohesion: 0.33
...
### Community 925 - "TestHarnessConfig"
Cohesion: 0.22
...
### Community 927 - "test_catalog_flm_blacklist.py"
Cohesion: 0.28
...
### Community 928 - "test_config_show_edit_selector.py"
Cohesion: 0.50
...
### Community 930 - "test_slot_metrics_capacity.py"
Cohesion: 0.36
...
### Community 932 - "test_browser_server.py"
Cohesion: 0.25
...
### Community 934 - "TestContainerRuntimeProbe"
Cohesion: 0.22
...
### Community 936 - "test_halo143_reboot_no_split_brain"
Cohesion: 0.36
...
### Community 937 - "test_model_preferred_profile.py"
Cohesion: 0.50
...
### Community 942 - "Local-session prompt: run the profile re-tune bench matrix and apply the results"
Cohesion: 0.25
...
### Community 946 - "generate-images.mdx"
Cohesion: 0.25
...
### Community 947 - "update-and-rollback.mdx"
Cohesion: 0.25
...
### Community 948 - "voice-stt-tts.mdx"
Cohesion: 0.25
...
### Community 950 - "paths-and-files.mdx"
Cohesion: 0.25
...
### Community 952 - "13. Observability & metrics baseline (ships in every box)"
Cohesion: 0.25
...
### Community 953 - "15. Hermes plugin — standalone repo + native update path"
Cohesion: 0.25
...
### Community 954 - "PART C — Coordination contracts (cross-lane seams)"
Cohesion: 0.25
...
### Community 955 - "halo143 deploy-validation runbook — rework-R3"
Cohesion: 0.25
...
### Community 956 - "Handoff — R5 Phase 4: deploy window → release cut (paste-in prompt)"
Cohesion: 0.25
...
### Community 957 - "mock-prod-gate verification (Phase 0 launch-blocker #3)"
Cohesion: 0.25
...
### Community 958 - "Podman on the hal0 slot substrate — findings & cleaner solutions"
Cohesion: 0.25
...
### Community 968 - "hermes_requirement_is_vetted"
Cohesion: 0.25
...
### Community 971 - "resolve_default_image"
Cohesion: 0.36
...
### Community 973 - "test_apply_selections.py"
Cohesion: 0.36
Nodes (6): _FakeProbe, _gpu_hardware(), POST /api/install/apply-selections — tier-less orchestrated install.  Mirrors th, WS-I (#1101): the apply-selections endpoint itself writes the     first-run sent, test_apply_selections_creates_only_selected_slots(), test_apply_selections_writes_first_run_sentinel()

### Community 974 - "test_auth_exposure_route.py"
Cohesion: 0.32
...
### Community 978 - "TestCpuCellEndToEnd"
Cohesion: 0.25
...
### Community 979 - "test_app_list_uninstall.py"
Cohesion: 0.36
...
### Community 983 - "test_slot_enabled_removed.py"
Cohesion: 0.25
...
### Community 984 - "test_gp05_stamped_launch_layering.py"
Cohesion: 0.29
Nodes (7): _FakeProfile, Golden path #5 (pull→assign→infer) — launch-time profile-read invariant.  spec-f, FLAGS-own: even handed the (now-inert) profile/slot flag params, the argv     bu, spec §8: assert the profile flag resolver is NOT called on the launch     path —, Minimal stand-in for a resolved profile (image/device axis only)., test_launch_builder_emits_no_profile_or_slot_flag_segment(), test_stamped_launch_does_not_consult_the_profile_flag_resolver()

### Community 985 - "FINDINGS.md"
Cohesion: 0.25
...
### Community 986 - "_BackendContract"
Cohesion: 0.25
...
### Community 989 - "test_store_on_change.py"
Cohesion: 0.39
...
### Community 990 - "test_slot_create_conflict.py"
Cohesion: 0.29
...
### Community 991 - "test_slot_schema.py"
Cohesion: 0.32
...
### Community 992 - "test_transition_guard.py"
Cohesion: 0.25
...
### Community 997 - "ROCmFPX exploratory bench — RESULTS (2026-07-05)"
Cohesion: 0.29
...
### Community 1003 - "P3-perms: declarative OwnershipStore as the single ownership authority"
Cohesion: 0.29
...
### Community 1004 - "PART B — Target: OwnershipStore default `service_user="hal0"`"
Cohesion: 0.29
...
### Community 1005 - "PART C — The LOAD-BEARING contract: born-owned"
Cohesion: 0.29
...
### Community 1006 - "PART 0 — EXACT MAP (file:line)"
Cohesion: 0.29
...
### Community 1007 - "P3-quadlet: migrate slot + companion units to Podman Quadlet `.container`"
Cohesion: 0.29
...
### Community 1008 - "PART A — Current scars (in plain English)"
Cohesion: 0.29
...
### Community 1009 - "4. Delivery plan and gates"
Cohesion: 0.29
...
### Community 1013 - "Gateway connectivity quirks — hal0"
Cohesion: 0.29
...
### Community 1024 - "seed_chat_templates"
Cohesion: 0.38
...
### Community 1026 - "test_slot_logs_stream_redacts_secret_bearing_lines"
Cohesion: 0.33
...
### Community 1027 - "test_config_hardware_probe.py"
Cohesion: 0.43
...
### Community 1028 - "test_memory_mm_commands.py"
Cohesion: 0.29
Nodes (3): MonkeyPatch, Tests for ``hal0 memory mm {list,refresh,history}``., stub_api()

### Community 1029 - "test_slot_rename.py"
Cohesion: 0.33
...
### Community 1030 - "test_paths_stub.py"
Cohesion: 0.29
...
### Community 1031 - "_reject_privileged_systemctl"
Cohesion: 0.33
...
### Community 1032 - "test_voice_roundtrip.py"
Cohesion: 0.43
...
### Community 1033 - "10. Troubleshooting"
Cohesion: 0.29
...
### Community 1034 - "test_owui_pin_consistency.py"
Cohesion: 0.43
...
### Community 1035 - "FakeUpstreams"
Cohesion: 0.48
Nodes (3): FakeUpstreams, SimpleNamespace, TestSyntheticEntries

### Community 1036 - "test_extra_args_sanitize.py"
Cohesion: 0.38
Nodes (6): sanitize_model_extra_args — the managed-flag registry-heal migration.  ``default, --model_path/--threads-batch are not --model/--threads; --threads itself     is, _register(), test_empty_registry_is_noop(), test_leaves_lookalike_and_hardware_flags_alone(), test_strips_managed_flags_and_persists()

### Community 1038 - "slot-create-default-v3.spec.ts"
Cohesion: 0.29
Nodes (3): CHAT_DEFAULT, CHAT_OTHER, EMBED_MODEL

### Community 1039 - "[0.9.1] — 2026-07-05"
Cohesion: 0.33
Nodes (6): [0.9.1] — 2026-07-05, Added, Changed, Highlights, Migrations, Removed

### Community 1040 - "[0.9.5] — 2026-07-08"
Cohesion: 0.33
Nodes (6): [0.9.5] — 2026-07-08, Added, Breaking, Changed, Highlights, Migrations

### Community 1041 - "[0.9.7.1] — 2026-07-11"
Cohesion: 0.33
Nodes (6): [0.9.7.1] — 2026-07-11, Added, Changed, Fixed, Highlights, Migrations

### Community 1042 - "[0.9.7] — 2026-07-11"
Cohesion: 0.33
Nodes (6): [0.9.7] — 2026-07-11, Added, Changed, Fixed, Highlights, Migrations

### Community 1043 - "[0.9.8] — 2026-07-13"
Cohesion: 0.33
Nodes (6): [0.9.8] — 2026-07-13, Added, Changed, Fixed, Highlights, Migrations

### Community 1044 - "[v0.3.2-alpha.1] — 2026-05-29"
Cohesion: 0.33
Nodes (6): Added, Deferred, Docs, Fixed, Tests, [v0.3.2-alpha.1] — 2026-05-29

### Community 1045 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 1046 - "graphify reference: query, path, explain"
Cohesion: 0.33
Nodes (5): For /graphify explain, For /graphify path, graphify reference: query, path, explain, Step 0 — Constrained query expansion (REQUIRED before traversal), Step 1 — Traversal

### Community 1047 - "Domain Docs"
Cohesion: 0.33
Nodes (5): Before exploring, read these, Domain Docs, File structure, Flag ADR conflicts, Use the glossary's vocabulary

### Community 1048 - "Hal0 Installer Setup — Redesign Plan (2026-07-05)"
Cohesion: 0.33
...
### Community 1050 - "logs-and-activity.mdx"
Cohesion: 0.33
...
### Community 1055 - "24. Execution waves / rollout program (session 3, 2026-07-18)"
Cohesion: 0.33
...
### Community 1057 - "§4.4 addendum — MCP admin route-map autogen (the 3 gaps)"
Cohesion: 0.33
...
### Community 1058 - "Verification strategy"
Cohesion: 0.33
Nodes (6): Lifecycle and security, Live acceptance, Memory, Provider, Verification strategy, Voice

### Community 1059 - "Exception"
Cohesion: 0.33
Nodes (5): Exception, ffmpeg refused to decode the upload.      Raised by ``_decode_audio`` instead of, UnsupportedAudioFormat, PortAuthorityError, Base class for port-authority errors.

### Community 1060 - "Dashboard permission mismatch (root vs hal0)"
Cohesion: 0.33
...
### Community 1074 - "_fit_check_warning"
Cohesion: 0.33
...
### Community 1075 - "_synthesize_slots_from_upstreams"
Cohesion: 0.33
Nodes (4): ``.list()``-only view of ``upstreams`` plus a stand-in ``hal0`` entry.      The, Build virtual slot entries from configured upstreams.      Until every upstream, _synthesize_slots_from_upstreams(), _UpstreamsWithHal0Composite

### Community 1076 - "throughput_history"
Cohesion: 0.33
...
### Community 1079 - "_iter_leaf_routes"
Cohesion: 0.33
Nodes (3): _iter_leaf_routes(), Yield every route object that carries a concrete ``path`` + ``methods``.      A, Any

### Community 1080 - "ttft_samples.py"
Cohesion: 0.33
...
### Community 1081 - "avg_ttft_across"
Cohesion: 0.33
...
### Community 1082 - "samples_from_events"
Cohesion: 0.33
...
### Community 1083 - "test_activity_instrumentation.py"
Cohesion: 0.60
...
### Community 1084 - "TestPreview"
Cohesion: 0.33
Nodes (3): When history has output, the image bytes are proxied back., History entry with empty outputs → 404., TestPreview

### Community 1085 - "test_models_catalogue.py"
Cohesion: 0.47
...
### Community 1086 - "test_delete_cascade_clears_slot_default_and_emits_model_deleted_last"
Cohesion: 0.33
...
### Community 1090 - "test_now_iso.py"
Cohesion: 0.33
...
### Community 1091 - "test_curation_drift.py"
Cohesion: 0.40
...
### Community 1092 - "test_family_defaults_empty.py"
Cohesion: 0.33
...
### Community 1111 - "14. Kanban board — ownership inversion + security hardening"
Cohesion: 0.40
...
### Community 1112 - "16. Hermes Python library (`AIAgent`) for the brain — evaluated, rejected for core"
Cohesion: 0.40
...
### Community 1113 - "21.A Mapping table — every candidate by disposition"
Cohesion: 0.40
...
### Community 1114 - "8. SQLite adoption — setup plan"
Cohesion: 0.40
...
### Community 1115 - "PART A — Current-state map (the scars, in plain English)"
Cohesion: 0.40
...
### Community 1116 - "PART D — The one narrow privileged helper: `hal0-systemctl`"
Cohesion: 0.40
...
### Community 1117 - "PART G — Sequencing: P3-perms BEFORE hermes-provision slim and P3-quadlet"
Cohesion: 0.40
...
### Community 1118 - "PART 0 — Current-state map (the hand-rendered ExecStart scars, file:line)"
Cohesion: 0.40
...
### Community 1132 - "TestRenderCancel"
Cohesion: 0.40
...
### Community 1134 - "test_distro.sh"
Cohesion: 0.90
Nodes (4): bad(), ok(), test_distro.sh script, want()

### Community 1135 - "test_migration_convergence.py"
Cohesion: 0.40
...
### Community 1140 - "slot-card-container-v3.spec.ts"
Cohesion: 0.40
...
### Community 1141 - "slot-edit-controls-v3.spec.ts"
Cohesion: 0.40
...
### Community 1143 - "[0.9.5.1] — 2026-07-09"
Cohesion: 0.50
Nodes (4): [0.9.5.1] — 2026-07-09, Added, Fixed, Highlights

### Community 1144 - "[0.9.6.1] — 2026-07-11"
Cohesion: 0.50
Nodes (4): [0.9.6.1] — 2026-07-11, Added, Changed, Fixed

### Community 1145 - "[v0.8.3b1] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.3b1] — 2026-07-04

### Community 1146 - "[v0.8.2b3] — 2026-06-29"
Cohesion: 0.50
Nodes (4): Added, Docs, Fixed, [v0.8.2b3] — 2026-06-29

### Community 1147 - "[v0.8.0-beta.1] — 2026-06-21"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.8.0-beta.1] — 2026-06-21

### Community 1148 - "[v0.7.3-beta.2] — 2026-06-19"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.7.3-beta.2] — 2026-06-19

### Community 1149 - "[v0.5.1-alpha.1] — 2026-06-15"
Cohesion: 0.50
Nodes (4): Added, Changed, Removed, [v0.5.1-alpha.1] — 2026-06-15

### Community 1150 - "[v0.5.0-alpha.1] — 2026-06-14"
Cohesion: 0.50
Nodes (4): Added, Fixed, Internal, [v0.5.0-alpha.1] — 2026-06-14

### Community 1151 - "[v0.9.0] — 2026-07-04"
Cohesion: 0.50
Nodes (4): Added, Changed, Fixed, [v0.9.0] — 2026-07-04

### Community 1152 - "[v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)"
Cohesion: 0.50
Nodes (4): Internal contracts, Known follow-up, New / improved, [v0.3.0-alpha.2] — 2026-05-28 (Hermes integration sweep)

### Community 1153 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1154 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1155 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1156 - "graphify reference: add a URL and watch a folder"
Cohesion: 0.50
Nodes (3): For /graphify add, For --watch, graphify reference: add a URL and watch a folder

### Community 1157 - "graphify reference: commit hook and native CLAUDE.md integration"
Cohesion: 0.50
Nodes (3): For git commit hook, For native CLAUDE.md integration, graphify reference: commit hook and native CLAUDE.md integration

### Community 1158 - "graphify reference: incremental update and cluster-only"
Cohesion: 0.50
Nodes (3): For --cluster-only, For --update (incremental re-extraction), graphify reference: incremental update and cluster-only

### Community 1159 - "hal0 docs"
Cohesion: 0.50
Nodes (3): `docs/internal/` — repo-only architecture docs, hal0 docs, Top-level `docs/*.mdx` — user docs

### Community 1160 - "streaming.mdx"
Cohesion: 0.50
Nodes (3): Client example, See also, Wire format

### Community 1161 - "11. Product reworks — round 2 (slot identity, ports, profile org)"
Cohesion: 0.50
...
### Community 1162 - "PART E — `hal0-api` User flip + UMask removal"
Cohesion: 0.50
...
### Community 1163 - "PART F — Edit plan (files, order, delegators/shims)"
Cohesion: 0.50
...
### Community 1164 - "PART H — Risks + capped verification"
Cohesion: 0.50
...
### Community 1165 - "PART E — Migration of running units (the live-box transition)"
Cohesion: 0.50
...
### Community 1166 - "PART F — Risks + capped verification"
Cohesion: 0.50
...
### Community 1167 - "`hal0-voice`"
Cohesion: 0.50
Nodes (4): Dynamic routing, Fallback and privacy, `hal0-voice`, Initial implementation

### Community 1171 - "register_mnt_ai_models.py"
Cohesion: 0.83
Nodes (3): _existing_ids(), main(), _post()

### Community 1172 - "cleanup_stale_agent_dropins"
Cohesion: 0.50
Nodes (4): cleanup_stale_agent_dropins(), Outcome of :func:`cleanup_stale_agent_dropins`., Remove stale hal0-agent@ drop-in fragments the template doesn't ship.      Scans, StaleDropinCleanupResult

### Community 1173 - "_mirror_bundled_skills"
Cohesion: 0.50
Nodes (4): _mirror_bundled_skills(), Create ``link`` -> ``target`` only when the link doesn't already     resolve the, Symlink every immediate child of ``src_root`` into ``dst_root``.      Returns ``, _safe_symlink()

### Community 1174 - "request_id.py"
Cohesion: 0.67
Nodes (3): install(), FastAPI, Per-request X-Request-ID middleware.

### Community 1175 - "bench_commands.py"
Cohesion: 0.50
Nodes (3): bench(), Context, `hal0 bench` — benchmarking CLI (design §5), thin mount over hal0.bench.cli.  Th

### Community 1176 - "__init__.py"
Cohesion: 0.50
...
### Community 1179 - "test_destructive_ops_land_audit_rows"
Cohesion: 0.67
Nodes (4): _build_app_with_audit(), Any, FastAPI, test_destructive_ops_land_audit_rows()

### Community 1181 - "_delegate_fakes.py"
Cohesion: 0.50
...
### Community 1182 - "test_comfyui_path.py"
Cohesion: 0.50
...
### Community 1194 - "[0.9.4] — 2026-07-08"
Cohesion: 0.67
Nodes (3): [0.9.4] — 2026-07-08, Added, Fixed

### Community 1195 - "[v0.8.5b2] — 2026-07-04"
Cohesion: 0.67
Nodes (3): Added, Fixed, [v0.8.5b2] — 2026-07-04

### Community 1196 - "[v0.8.0-beta.3] — 2026-06-23"
Cohesion: 0.67
Nodes (3): Breaking, Changed, [v0.8.0-beta.3] — 2026-06-23

### Community 1197 - "[v0.8.2b2] — 2026-06-24"
Cohesion: 0.67
Nodes (3): Changed, Fixed, [v0.8.2b2] — 2026-06-24

### Community 1215 - "_find_server"
Cohesion: 0.67
Nodes (3): _find_server(), Any, Case-insensitive server-id lookup in the servers list.

### Community 1218 - "_OtherEngineProvider"
Cohesion: 0.67
...
### Community 1225 - "test_agent_unit_argv_defaults_to_real_euid"
Cohesion: 0.67
Nodes (3): MonkeyPatch, ``euid=None`` (the production call) reads the live euid., test_agent_unit_argv_defaults_to_real_euid()

## Knowledge Gaps
- **3328 isolated node(s):** `runlog.sh script`, `rocmfpx-build.sh script`, `rocmfpx-env.sh script`, `rocmfpx-pipeline.sh script`, `rocmfpx-quantize.sh script` (+3323 more)
...
- **Why does `create_app()` connect `create_app` to `seed_chat_templates`, `test_models_crud.py`, `test_auth_core.py`, `_StubSlotManager`, `test_slots_container_state.py`, `FakeWsServer`, `test_auth_rotate.py`, `migrate_slot_toml`, `test_exposure.py`, `ApprovalQueue`, `test_hf_routes.py`, `MemoryDispatcher`, `FastAPI`, `test_stacks_routes.py`, `test_route_collisions.py`, `test_startup_slot_seed.py`, `GpuImageMode`, `test_dashboard_layout.py`, `test_slots_policy.py`, `conftest.py`, `types.py`, `isolated_client_with_root`, `test_memory_admin_routes.py`, `test_slots_npu_fields.py`, `test_memory_delete_auth.py`, `test_settings_routes.py`, `load_hal0_config`, `PgVectorProvider`, `test_pull_shutdown.py`, `test_updater_routes.py`, `EventBus`, `test_models_routes.py`, `test_config_model_roots.py`, `mcp_mount.py`, `test_kb1_hardening_tail.py`, `test_chat_proxy.py`, `test_chat_templates.py`, `TestClient`, `test_slots_image_pull.py`, `_build`, `test_settings_models_store.py`, `test_models_preview.py`, `test_dashboard_layout_v3.py`, `test_v1_npu_trio_routing.py`, `test_tts_request_defaults.py`, `__init__.py`, `test_admin_route_map_nested.py`, `test_chat_proxy_auth.py`, `conftest.py`, `test_route_sync.py`, `test_typed_errors.py`, `test_v1_chat_slot_alias.py`, `test_models_add_from_path.py`, `test_models_default.py`, `TestClient`, `test_typed_bodies.py`, `test_v1_slot_alias_models.py`, `TestClient`, `test_cli_auth_streamtest.py`, `test_mcp_mount_health.py`, `TestClient`, `test_startup_persona_seed.py`, `test_pull_routes.py`, `MemoryConfig`, `test_redact.py`, `test_event_contract.py`, `auth.py`, `conftest.py`, `test_comfyui_fetch_route.py`, `test_events_fixes.py`, `test_installer_routes.py`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `SlotManager` connect `SlotManager` to `SlotWatchdog`, `Slot`, `SlotCrashLooping`, `FakeContainerProvider`, `SlotState`, `SlotInterface`, `FLMProvider`, `FakeManager`, `test_model_preferred_profile.py`, `_write_slot`, `test_device_profile_coherence.py`, `test_load_converges_config.py`, `test_mtp_defuse.py`, `test_preload_eviction.py`, `EventBus`, `test_model_fallback.py`, `GpuArbiter`, `UpstreamCall`, `FakeSlotManager`, `heal_missing_llm_type`, `_write_slot`, `manager.py`, `test_npu_trio_reconcile.py`, `test_slot_aliases.py`, `test_adopted_slot_eviction.py`, `RoutingHost`, `test_slot_create_conflict.py`, `test_transition_guard.py`, `test_config_drift_aliases.py`, `agents-overview.jsx`, `test_npu_trio_shadow.py`, `test_pulling_serving_idle.py`, `test_npu_exclusivity.py`, `Path`, `rerender_slot_units`, `SlotIdentityStore`, `SlotStateRecord`, `test_manager_npu_container.py`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `SlotState` connect `SlotState` to `SlotWatchdog`, `SlotManager`, `Slot`, `SlotCrashLooping`, `SlotInterface`, `FakeUpstreams`, `SlotLoading`, `test_metrics_prometheus_route.py`, `GpuImageMode`, `test_fail_watcher.py`, `Dispatcher`, `_dispatcher`, `Enum`, `FakeSnap`, `GpuArbiter`, `UpstreamCall`, `StackConfig`, `arbiter.py`, `test_backends_npu_canonical_fields.py`, `container_enrichment`, `test_fail_watcher_warming.py`, `_RecordingSlotManager`, `_FakeSM`, `Any`, `_slot`, `config_enrichment`, `StackApplyEngine`, `_ArbiterSlotManager`, `test_drift.py`, `NpuSwapStatus`, `test_npu_occupancy.py`, `_make_slot`, `read_stack_state`, `SlotStateRecord`?**
