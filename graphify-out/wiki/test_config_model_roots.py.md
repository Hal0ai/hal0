...
- **test_config_model_roots.py** (7 connections) — `tests/api/test_config_model_roots.py`
...
- **Per-test app whose lifespan resolves paths under tmp_hal0_home.** (1 connections) — `tests/api/test_config_model_roots.py`
