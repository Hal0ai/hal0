...
- **Best-effort extraction of text-embedded tool calls.      Returns ``(calls, clean** (1 connections) — `src/hal0/toolloop/engine.py`
- **Drive the tool-calling loop against ``llm_fn``; yield structured events.      ``** (1 connections) — `src/hal0/toolloop/engine.py`
