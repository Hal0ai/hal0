...
- **child_to_slot()** (3 connections) — `src/hal0/capabilities/orchestrator.py`
...
- **Resolve a (slot, child) tuple to its underlying slot name.      Raises :class:`B** (1 connections) — `src/hal0/capabilities/orchestrator.py`
...
- [apply_capability](apply_capability.md) (1 shared connections)
