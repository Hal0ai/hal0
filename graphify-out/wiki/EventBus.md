...
- **Any** (1 connections)
- **Tests for the footer event bus + /api/events surface.  Covers:   * ``EventBus.em** (1 connections) — `tests/api/test_events.py`
- *... and 4 more nodes in this community*

## Relationships

- [realtime_ws](realtime_ws.md) (6 shared connections)
