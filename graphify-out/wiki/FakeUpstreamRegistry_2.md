...
- **A kind='remote' container upstream registered as 'rerank'.** (1 connections) — `tests/dispatcher/test_rerank_path_routing.py`
- **Legacy fallback Rule 2: /v1/rerankings in path → rerank slot.      Phase C: /v1/** (1 connections) — `tests/dispatcher/test_rerank_path_routing.py`
...
- [resolve_by_capability](resolve_by_capability.md) (4 shared connections)
