...
- **_seed_openrouter_in_toml()** (17 connections) — `tests/api/test_providers_routes.py`
...
- **test_patch_upstream_does_not_touch_other_rows()** (7 connections) — `tests/api/test_providers_routes.py`
...
- **test_list_upstreams_returns_registered_entries()** (3 connections) — `tests/api/test_providers_routes.py`
- **test_get_upstream_by_name()** (3 connections) — `tests/api/test_providers_routes.py`
- **test_get_upstream_404()** (3 connections) — `tests/api/test_providers_routes.py`
- **test_providers_excludes_slot_kind()** (3 connections) — `tests/api/test_providers_routes.py`
