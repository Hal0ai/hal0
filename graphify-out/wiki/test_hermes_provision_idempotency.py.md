...
- **Sandbox every host path constant under tmp_path; return (hermes_home, venv).** (1 connections) — `tests/agents/test_hermes_provision.py`
- *... and 16 more nodes in this community*

## Relationships

- [_hermes_fakes.py](_hermes_fakes.py.md) (4 shared connections)
- [test_hermes_provision.py](test_hermes_provision.py.md) (4 shared connections)
