...
- **ModelRegistry** (32 connections)
- **_model()** (19 connections) — `tests/registry/test_store.py`
- **test_store.py** (14 connections) — `tests/registry/test_store.py`
- **TestEmptyRegistry** (7 connections) — `tests/registry/test_store.py`
- **TestUpdate** (7 connections) — `tests/registry/test_store.py`
- **TestAdd** (6 connections) — `tests/registry/test_store.py`
- **.test_add_writes_atomically()** (6 connections) — `tests/registry/test_store.py`
- **Path** (5 connections)
