...
- **FakeSlotManager** (13 connections) — `tests/capabilities/test_npu_phase2_integration.py`
- **_StubSlot** (10 connections) — `tests/capabilities/test_npu_phase2_integration.py`
