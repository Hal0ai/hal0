...
- **test_probe_default_does_not_validate_npu()** (4 connections) — `tests/hardware/test_probe.py`
...
- [HardwareInfo](HardwareInfo.md) (13 shared connections)
...
- [suggest_models](suggest_models.md) (1 shared connections)
