...
- **.test_returns_list()** (2 connections) — `tests/api/test_profiles_route.py`
- **.test_seed_names_present()** (2 connections) — `tests/api/test_profiles_route.py`
...
- **.test_vulkan_std_image_is_rocmfpx_default()** (2 connections) — `tests/api/test_profiles_route.py`
