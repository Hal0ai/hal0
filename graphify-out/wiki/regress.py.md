...
- **regress.py** (9 connections) — `src/hal0/bench/regress.py`
- **check()** (9 connections) — `src/hal0/bench/regress.py`
...
- **Scan every cell_key's ok history and return the flagged regressions     (DESIGN** (1 connections) — `src/hal0/bench/regress.py`

## Relationships

- [cli.py](cli.py.md) (6 shared connections)
