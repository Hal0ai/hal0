...
- **test_img_never_ready_rolls_back_on_timeout()** (8 connections) — `tests/slots/test_gpu_arbiter.py`
- **test_img_terminal_error_rolls_back_immediately()** (8 connections) — `tests/slots/test_gpu_arbiter.py`
- **Any** (7 connections)
...
- **test_restore_llm_frees_comfyui_and_reloads_saved_set()** (6 connections) — `tests/slots/test_gpu_arbiter.py`
