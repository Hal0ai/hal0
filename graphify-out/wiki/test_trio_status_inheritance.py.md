...
- **test_trio_status_inheritance.py** (12 connections) — `tests/capabilities/test_trio_status_inheritance.py`
- **_orch()** (10 connections) — `tests/capabilities/test_trio_status_inheritance.py`
