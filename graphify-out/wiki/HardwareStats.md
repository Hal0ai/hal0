...
- **test_unknown_vendor_returns_none()** (4 connections) — `tests/hardware/test_stats.py`
- **test_slot_port_occupancy_still_available()** (4 connections) — `tests/hardware/test_stats.py`
- **_port_in_use()** (3 connections) — `src/hal0/hardware/stats.py`
- **.gpu_util()** (3 connections) — `src/hal0/hardware/stats.py`
- *... and 27 more nodes in this community*

## Relationships

- [probe.py](probe.py.md) (12 shared connections)
- [socket](socket.md) (2 shared connections)
