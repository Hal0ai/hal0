...
- **Bounded-queue async writer shared by every metrics producer.      Construction n** (1 connections) — `src/hal0/metrics/writer.py`
- *... and 6 more nodes in this community*

## Relationships

- [connect](connect.md) (7 shared connections)
