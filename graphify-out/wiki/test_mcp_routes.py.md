...
- **test_mcp_routes.py** (43 connections) — `tests/api/test_mcp_routes.py`
- **TestClient** (34 connections)
- **_filesystem_manifest_dict()** (12 connections) — `tests/api/test_mcp_routes.py`
- **Any** (9 connections)
