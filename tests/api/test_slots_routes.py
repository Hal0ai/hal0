...
def container_stub() -> Iterator[dict[str, Any]]:
    ...
    # The probes take the slot CONFIG in production (#1417 — the provider
    # derives the id-keyed instance token from it); this stub keys by name.
    ...
    provider.running_argv = MagicMock(side_effect=lambda slot: state.get("running_argv"))
