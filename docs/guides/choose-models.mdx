...
A profile's create/edit form has an optional **Runtime** select — "— any
(flags-only tune) —" to leave it unset, or one of the llama-server-family
runtimes (Standard, PromptForge, Strix, CUDA, CPU) to pin one. A profile
