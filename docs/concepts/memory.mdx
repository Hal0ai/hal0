...
<CardGrid>
  ...
  <Card title="Mental models" icon="brain">
    ...
    as an async operation, and later refreshes are triggered manually with
    `memory_mental_model_refresh`; a mental model can be marked `is_stale`, surfaced in the
