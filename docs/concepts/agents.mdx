---
title: Agents
description: "hal0's agent model: Hermes runs as a sandboxed systemd service, shaped by personas that gate its tools, with an approval queue and per-persona spending budgets."
sidebar:
  order: 60
---
