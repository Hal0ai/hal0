...
**Closed:** O12 (live), O14, O16, O17, O18, O23 (verified+fixed on box), Phase 4, Phase 7, 143 host-net, UI rebuild both boxes. **Open/follow-up:** O13 nested-state, O19, O20, O22 (build-an-image), O24 (installer gate), seed `type=llm` (O23 lane), brain-model context size, Phase 5 full liveness.
