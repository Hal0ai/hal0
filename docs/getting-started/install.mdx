...
- **curl** and **ca-certificates** — the bootstrap one-liner needs them to
  fetch and verify the release manifest. Minimal cloud/LXC images often
  ship without either: `apt-get install -y curl ca-certificates` (or the
