---
title: Install hal0
description: Install hal0 with one command — the bootstrap verifies the release with SHA-256 (and cosign, when available), then hands off to a 16-step, idempotent installer that seeds config and starts the API.
sidebar:
  order: 10
---
